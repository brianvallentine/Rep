...
using Dclgens;
using Copies;
using Sias.Bilhetes.DB2.BI6016B;

namespace Code
{
    public class BI6016B
    {
        ...
        /*"      *                        *** ACIDENTES PESSOAIS ***              *      */
        /*"      * OBSERVACAO...........:                                         *      */
        /*"      * ESTE PGM ESTA USUANDO A DATA DO SISTEMA CO- PORQUE ESTE        *      */
        ...
        public FileBasis _BI6016B1 { get; set; } = new FileBasis(new PIC("X", "0", "X(0)"));

        public FileBasis BI6016B1
        {
            get
            {
                _.Move(BI6016B1_RECORD, _BI6016B1); VarBasis.RedefinePassValue(BI6016B1_RECORD, _BI6016B1, BI6016B1_RECORD); return _BI6016B1;
            }
        }
        public FileBasis _BI6016B2 { get; set; } = new FileBasis(new PIC("X", "132", "X(132)"));

        public FileBasis BI6016B2
        {
            get
            {
                _.Move(BI6016B2_RECORD, _BI6016B2); VarBasis.RedefinePassValue(BI6016B2_RECORD, _BI6016B2, BI6016B2_RECORD); return _BI6016B2;
            }
        }
        public SortBasis<BI6016B_REG_SBI6016B> SBI6016B { get; set; } = new SortBasis<BI6016B_REG_SBI6016B>(new BI6016B_REG_SBI6016B());
        /*"01            BI6016B1-RECORD.*/
        public BI6016B_BI6016B1_RECORD BI6016B1_RECORD { get; set; } = new BI6016B_BI6016B1_RECORD();
        public class BI6016B_BI6016B1_RECORD : VarBasis
        {
            /*"    05          REG-CEP.*/
            public BI6016B_REG_CEP REG_CEP { get; set; } = new BI6016B_REG_CEP();
            public class BI6016B_REG_CEP : VarBasis
            {
            ...
            /*"01            BI6016B2-RECORD     PIC X(132).*/
        }
        public StringBasis BI6016B2_RECORD { get; set; } = new StringBasis(new PIC("X", "132", "X(132)."), @"");
        /*"01            REG-SBI6016B.*/
        public BI6016B_REG_SBI6016B REG_SBI6016B { get; set; } = new BI6016B_REG_SBI6016B();
        public class BI6016B_REG_SBI6016B : VarBasis
        {
            /*"    05        SBI-CEP-G           PIC  9(010).*/
            public IntBasis SBI_CEP_G { get; set; } = new IntBasis(new PIC("9", "10", "9(010)."));
            /*"    05        SBI-NUM-CEP.*/
            public BI6016B_SBI_NUM_CEP SBI_NUM_CEP { get; set; } = new BI6016B_SBI_NUM_CEP();
            public class BI6016B_SBI_NUM_CEP : VarBasis
            {
            ...
            /*"    05        SBI-NUM-CEP-FTE.*/
            public BI6016B_SBI_NUM_CEP_FTE SBI_NUM_CEP_FTE { get; set; } = new BI6016B_SBI_NUM_CEP_FTE();
            public class BI6016B_SBI_NUM_CEP_FTE : VarBasis
            {
        ...
        /*"01           AREA-DE-WORK.*/
        public BI6016B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new BI6016B_AREA_DE_WORK();
        public class BI6016B_AREA_DE_WORK : VarBasis
        {
            /*"    05        LC01-LINHA01.*/
            public BI6016B_LC01_LINHA01 LC01_LINHA01 { get; set; } = new BI6016B_LC01_LINHA01();
            public class BI6016B_LC01_LINHA01 : VarBasis
            {
                ...
                /*"      10      FILLER              PIC  X(070)    VALUE             '$DJDE$ JDE=SF05,JDL=SF,FEED=MAIN,END;'.*/
                public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "70", "X(070)"), @"$DJDE$ JDE=SF05,JDL=SF,FEED=MAIN,END;");
                /*"    05        LC01-LINHA01-G.*/
            }
            public BI6016B_LC01_LINHA01_G LC01_LINHA01_G { get; set; } = new BI6016B_LC01_LINHA01_G();
            public class BI6016B_LC01_LINHA01_G : VarBasis
            {
                ...
                /*"      10      FILLER              PIC  X(070)    VALUE             '$DJDE$ JDE=SF05,JDL=SF,FEED=MAIN,END;'.*/
                public StringBasis FILLER_1 { get; set; } = new StringBasis(new PIC("X", "70", "X(070)"), @"$DJDE$ JDE=SF05,JDL=SF,FEED=MAIN,END;");
                /*"    05        LC02-LINHA02.*/
            }
            public BI6016B_LC02_LINHA02 LC02_LINHA02 { get; set; } = new BI6016B_LC02_LINHA02();
            public class BI6016B_LC02_LINHA02 : VarBasis
            {
            ...
            public BI6016B_LC03_LINHA03 LC03_LINHA03 { get; set; } = new BI6016B_LC03_LINHA03();
            public class BI6016B_LC03_LINHA03 : VarBasis
            {
            ...
            public BI6016B_LC88_LINHA88 LC88_LINHA88 { get; set; } = new BI6016B_LC88_LINHA88();
            public class BI6016B_LC88_LINHA88 : VarBasis
            {
                /*"      10      LC88-CANAL          PIC  X(001)    VALUE '1'.*/
                public StringBasis LC88_CANAL { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"1");
                /*"    05        LC99-LINHA99.*/
            }
            public BI6016B_LC99_LINHA99 LC99_LINHA99 { get; set; } = new BI6016B_LC99_LINHA99();
            public class BI6016B_LC99_LINHA99 : VarBasis
            {
            ...
            public BI6016B_LE00_LINHA00 LE00_LINHA00 { get; set; } = new BI6016B_LE00_LINHA00();
            public class BI6016B_LE00_LINHA00 : VarBasis
            {
            ...
            public BI6016B_LE01_LINHA01 LE01_LINHA01 { get; set; } = new BI6016B_LE01_LINHA01();
            public class BI6016B_LE01_LINHA01 : VarBasis
            {
            ...
            public BI6016B_LE02_LINHA02 LE02_LINHA02 { get; set; } = new BI6016B_LE02_LINHA02();
            public class BI6016B_LE02_LINHA02 : VarBasis
            {
            ...
            public BI6016B_LE03_LINHA03 LE03_LINHA03 { get; set; } = new BI6016B_LE03_LINHA03();
            public class BI6016B_LE03_LINHA03 : VarBasis
            {
            ...
            public BI6016B_LE04_LINHA04 LE04_LINHA04 { get; set; } = new BI6016B_LE04_LINHA04();
            public class BI6016B_LE04_LINHA04 : VarBasis
            {
            ...
            public BI6016B_LE05_LINHA05 LE05_LINHA05 { get; set; } = new BI6016B_LE05_LINHA05();
            public class BI6016B_LE05_LINHA05 : VarBasis
            {
                ...
                /*"      10      LE05-CEP.*/
                public BI6016B_LE05_CEP LE05_CEP { get; set; } = new BI6016B_LE05_CEP();
                public class BI6016B_LE05_CEP : VarBasis
                {
            ...
            public BI6016B_LF01_LINHA01 LF01_LINHA01 { get; set; } = new BI6016B_LF01_LINHA01();
            public class BI6016B_LF01_LINHA01 : VarBasis
            {
            ...
            public BI6016B_LF02_LINHA02 LF02_LINHA02 { get; set; } = new BI6016B_LF02_LINHA02();
            public class BI6016B_LF02_LINHA02 : VarBasis
            {
            ...
            public BI6016B_LF03_LINHA03 LF03_LINHA03 { get; set; } = new BI6016B_LF03_LINHA03();
            public class BI6016B_LF03_LINHA03 : VarBasis
            {
            ...
            public BI6016B_LF04_LINHA04 LF04_LINHA04 { get; set; } = new BI6016B_LF04_LINHA04();
            public class BI6016B_LF04_LINHA04 : VarBasis
            {
            ...
            public BI6016B_LF05_LINHA05 LF05_LINHA05 { get; set; } = new BI6016B_LF05_LINHA05();
            public class BI6016B_LF05_LINHA05 : VarBasis
            {
            ...
            public BI6016B_LR01_LINHA01 LR01_LINHA01 { get; set; } = new BI6016B_LR01_LINHA01();
            public class BI6016B_LR01_LINHA01 : VarBasis
            {
            ...
            public BI6016B_LR02_LINHA02 LR02_LINHA02 { get; set; } = new BI6016B_LR02_LINHA02();
            public class BI6016B_LR02_LINHA02 : VarBasis
            {
            ...
            public BI6016B_LR03_LINHA03 LR03_LINHA03 { get; set; } = new BI6016B_LR03_LINHA03();
            public class BI6016B_LR03_LINHA03 : VarBasis
            {
            ...
            public BI6016B_LR04_LINHA04 LR04_LINHA04 { get; set; } = new BI6016B_LR04_LINHA04();
            public class BI6016B_LR04_LINHA04 : VarBasis
            {
            ...
            public BI6016B_LR05_LINHA05 LR05_LINHA05 { get; set; } = new BI6016B_LR05_LINHA05();
            public class BI6016B_LR05_LINHA05 : VarBasis
            {
            ...
            public BI6016B_LR06_LINHA06 LR06_LINHA06 { get; set; } = new BI6016B_LR06_LINHA06();
            public class BI6016B_LR06_LINHA06 : VarBasis
            {
            ...
            /*"    05        WWORK-QTDE01.*/
            public BI6016B_WWORK_QTDE01 WWORK_QTDE01 { get; set; } = new BI6016B_WWORK_QTDE01();
            public class BI6016B_WWORK_QTDE01 : VarBasis
            {
            ...
            /*"    05        WS-NOME-COR-ANT.*/
            public BI6016B_WS_NOME_COR_ANT WS_NOME_COR_ANT { get; set; } = new BI6016B_WS_NOME_COR_ANT();
            public class BI6016B_WS_NOME_COR_ANT : VarBasis
            {
            ...
            private _REDEF_BI6016B_WS_CPF_R _ws_cpf_r { get; set; }
            public _REDEF_BI6016B_WS_CPF_R WS_CPF_R
            {
                get { _ws_cpf_r = new _REDEF_BI6016B_WS_CPF_R(); _.Move(WS_CPF, _ws_cpf_r); VarBasis.RedefinePassValue(WS_CPF, _ws_cpf_r, WS_CPF); _ws_cpf_r.ValueChanged += () => { _.Move(_ws_cpf_r, WS_CPF); }; return _ws_cpf_r; }
                set { VarBasis.RedefinePassValue(value, _ws_cpf_r, WS_CPF); }
            }  //Redefines
            public class _REDEF_BI6016B_WS_CPF_R : VarBasis
            {
                ...
                public _REDEF_BI6016B_WS_CPF_R()
                {
            ...
            public BI6016B_WS_DATA_SQL WS_DATA_SQL { get; set; } = new BI6016B_WS_DATA_SQL();
            public class BI6016B_WS_DATA_SQL : VarBasis
            {
            ...
            public BI6016B_WS_DATA_I WS_DATA_I { get; set; } = new BI6016B_WS_DATA_I();
            public class BI6016B_WS_DATA_I : VarBasis
            {
            ...
            private _REDEF_BI6016B_FILLER_60 _filler_60 { get; set; }
            public _REDEF_BI6016B_FILLER_60 FILLER_60
            {
                get { _filler_60 = new _REDEF_BI6016B_FILLER_60(); _.Move(WWORK_DATA_DB2, _filler_60); VarBasis.RedefinePassValue(WWORK_DATA_DB2, _filler_60, WWORK_DATA_DB2); _filler_60.ValueChanged += () => { _.Move(_filler_60, WWORK_DATA_DB2); }; return _filler_60; }
                set { VarBasis.RedefinePassValue(value, _filler_60, WWORK_DATA_DB2); }
            }  //Redefines
            public class _REDEF_BI6016B_FILLER_60 : VarBasis
            {
                ...
                public _REDEF_BI6016B_FILLER_60()
                {
            ...
            private _REDEF_BI6016B_FILLER_63 _filler_63 { get; set; }
            public _REDEF_BI6016B_FILLER_63 FILLER_63
            {
                get { _filler_63 = new _REDEF_BI6016B_FILLER_63(); _.Move(WWORK_DATA_VIG, _filler_63); VarBasis.RedefinePassValue(WWORK_DATA_VIG, _filler_63, WWORK_DATA_VIG); _filler_63.ValueChanged += () => { _.Move(_filler_63, WWORK_DATA_VIG); }; return _filler_63; }
                set { VarBasis.RedefinePassValue(value, _filler_63, WWORK_DATA_VIG); }
            }  //Redefines
            public class _REDEF_BI6016B_FILLER_63 : VarBasis
            {
                ...
                public _REDEF_BI6016B_FILLER_63()
                {
            ...
            private _REDEF_BI6016B_FILLER_64 _filler_64 { get; set; }
            public _REDEF_BI6016B_FILLER_64 FILLER_64
            {
                get { _filler_64 = new _REDEF_BI6016B_FILLER_64(); _.Move(WWORK_VIGENCIA, _filler_64); VarBasis.RedefinePassValue(WWORK_VIGENCIA, _filler_64, WWORK_VIGENCIA); _filler_64.ValueChanged += () => { _.Move(_filler_64, WWORK_VIGENCIA); }; return _filler_64; }
                set { VarBasis.RedefinePassValue(value, _filler_64, WWORK_VIGENCIA); }
            }  //Redefines
            public class _REDEF_BI6016B_FILLER_64 : VarBasis
            {
                ...
                public _REDEF_BI6016B_FILLER_64()
                {
            ...
            /*"    05        WS-NOME-RAZAO.*/
            public BI6016B_WS_NOME_RAZAO WS_NOME_RAZAO { get; set; } = new BI6016B_WS_NOME_RAZAO();
            public class BI6016B_WS_NOME_RAZAO : VarBasis
            {
            ...
            private _REDEF_BI6016B_WS_NUM_CEP_AUX_R _ws_num_cep_aux_r { get; set; }
            public _REDEF_BI6016B_WS_NUM_CEP_AUX_R WS_NUM_CEP_AUX_R
            {
                get { _ws_num_cep_aux_r = new _REDEF_BI6016B_WS_NUM_CEP_AUX_R(); _.Move(WS_NUM_CEP_AUX, _ws_num_cep_aux_r); VarBasis.RedefinePassValue(WS_NUM_CEP_AUX, _ws_num_cep_aux_r, WS_NUM_CEP_AUX); _ws_num_cep_aux_r.ValueChanged += () => { _.Move(_ws_num_cep_aux_r, WS_NUM_CEP_AUX); }; return _ws_num_cep_aux_r; }
                set { VarBasis.RedefinePassValue(value, _ws_num_cep_aux_r, WS_NUM_CEP_AUX); }
            }  //Redefines
            public class _REDEF_BI6016B_WS_NUM_CEP_AUX_R : VarBasis
            {
                ...
                public _REDEF_BI6016B_WS_NUM_CEP_AUX_R()
                {
            ...
            private _REDEF_BI6016B_WS_NUM_CEP_AUX_R1 _ws_num_cep_aux_r1 { get; set; }
            public _REDEF_BI6016B_WS_NUM_CEP_AUX_R1 WS_NUM_CEP_AUX_R1
            {
                get { _ws_num_cep_aux_r1 = new _REDEF_BI6016B_WS_NUM_CEP_AUX_R1(); _.Move(WS_NUM_CEP_AUX, _ws_num_cep_aux_r1); VarBasis.RedefinePassValue(WS_NUM_CEP_AUX, _ws_num_cep_aux_r1, WS_NUM_CEP_AUX); _ws_num_cep_aux_r1.ValueChanged += () => { _.Move(_ws_num_cep_aux_r1, WS_NUM_CEP_AUX); }; return _ws_num_cep_aux_r1; }
                set { VarBasis.RedefinePassValue(value, _ws_num_cep_aux_r1, WS_NUM_CEP_AUX); }
            }  //Redefines
            public class _REDEF_BI6016B_WS_NUM_CEP_AUX_R1 : VarBasis
            {
                ...
                public _REDEF_BI6016B_WS_NUM_CEP_AUX_R1()
                {
            ...
            private _REDEF_BI6016B_FILLER_65 _filler_65 { get; set; }
            public _REDEF_BI6016B_FILLER_65 FILLER_65
            {
                get { _filler_65 = new _REDEF_BI6016B_FILLER_65(); _.Move(WORK_CEP, _filler_65); VarBasis.RedefinePassValue(WORK_CEP, _filler_65, WORK_CEP); _filler_65.ValueChanged += () => { _.Move(_filler_65, WORK_CEP); }; return _filler_65; }
                set { VarBasis.RedefinePassValue(value, _filler_65, WORK_CEP); }
            }  //Redefines
            public class _REDEF_BI6016B_FILLER_65 : VarBasis
            {
                ...
                public _REDEF_BI6016B_FILLER_65()
                {
            ...
            public BI6016B_WS_NOME_FONTE WS_NOME_FONTE { get; set; } = new BI6016B_WS_NOME_FONTE();
            public class BI6016B_WS_NOME_FONTE : VarBasis
            {
            ...
            private ListBasis<_REDEF_BI6016B_FILLER_66> _filler_66 { get; set; }
            public ListBasis<_REDEF_BI6016B_FILLER_66> FILLER_66
            {
                get { _filler_66 = new ListBasis<_REDEF_BI6016B_FILLER_66>(50); _.Move(WW_INPUT, _filler_66); VarBasis.RedefinePassValue(WW_INPUT, _filler_66, WW_INPUT); _filler_66.ValueChanged += () => { _.Move(_filler_66, WW_INPUT); }; return _filler_66; }
                set { VarBasis.RedefinePassValue(value, _filler_66, WW_INPUT); }
            }  //Redefines
            public class _REDEF_BI6016B_FILLER_66 : VarBasis
            {
                ...
                public _REDEF_BI6016B_FILLER_66()
                {
            ...
            private ListBasis<_REDEF_BI6016B_FILLER_67> _filler_67 { get; set; }
            public ListBasis<_REDEF_BI6016B_FILLER_67> FILLER_67
            {
                get { _filler_67 = new ListBasis<_REDEF_BI6016B_FILLER_67>(50); _.Move(WW_OUTPUT, _filler_67); VarBasis.RedefinePassValue(WW_OUTPUT, _filler_67, WW_OUTPUT); _filler_67.ValueChanged += () => { _.Move(_filler_67, WW_OUTPUT); }; return _filler_67; }
                set { VarBasis.RedefinePassValue(value, _filler_67, WW_OUTPUT); }
            }  //Redefines
            public class _REDEF_BI6016B_FILLER_67 : VarBasis
            {
                /*"      10        WW-CCC-O            PIC  X(001).*/
                public StringBasis WW_CCC_O { get; set; } = new StringBasis(new PIC("X", "1", "X(001)."), @"");
                /*"    05        LK-PROSOMU1.*/

                public _REDEF_BI6016B_FILLER_67()
                {
                    WW_CCC_O.ValueChanged += OnValueChanged;
                }

            }
            public BI6016B_LK_PROSOMU1 LK_PROSOMU1 { get; set; } = new BI6016B_LK_PROSOMU1();
            public class BI6016B_LK_PROSOMU1 : VarBasis
            {
                ...
                private _REDEF_BI6016B_LK_DATA_SOM_R _lk_data_som_r { get; set; }
                public _REDEF_BI6016B_LK_DATA_SOM_R LK_DATA_SOM_R
                {
                    get { _lk_data_som_r = new _REDEF_BI6016B_LK_DATA_SOM_R(); _.Move(LK_DATA_SOM, _lk_data_som_r); VarBasis.RedefinePassValue(LK_DATA_SOM, _lk_data_som_r, LK_DATA_SOM); _lk_data_som_r.ValueChanged += () => { _.Move(_lk_data_som_r, LK_DATA_SOM); }; return _lk_data_som_r; }
                    set { VarBasis.RedefinePassValue(value, _lk_data_som_r, LK_DATA_SOM); }
                }  //Redefines
                public class _REDEF_BI6016B_LK_DATA_SOM_R : VarBasis
                {
                    ...
                    public _REDEF_BI6016B_LK_DATA_SOM_R()
                    {
                ...
                private _REDEF_BI6016B_LK_DATA_CALC_R _lk_data_calc_r { get; set; }
                public _REDEF_BI6016B_LK_DATA_CALC_R LK_DATA_CALC_R
                {
                    get { _lk_data_calc_r = new _REDEF_BI6016B_LK_DATA_CALC_R(); _.Move(LK_DATA_CALC, _lk_data_calc_r); VarBasis.RedefinePassValue(LK_DATA_CALC, _lk_data_calc_r, LK_DATA_CALC); _lk_data_calc_r.ValueChanged += () => { _.Move(_lk_data_calc_r, LK_DATA_CALC); }; return _lk_data_calc_r; }
                    set { VarBasis.RedefinePassValue(value, _lk_data_calc_r, LK_DATA_CALC); }
                }  //Redefines
                public class _REDEF_BI6016B_LK_DATA_CALC_R : VarBasis
                {
                    ...
                    public _REDEF_BI6016B_LK_DATA_CALC_R()
                    {
        ...
        public BI6016B_TABELA_CEP TABELA_CEP { get; set; } = new BI6016B_TABELA_CEP();
        public class BI6016B_TABELA_CEP : VarBasis
        {
            /*"    05        CEP                 OCCURS 2000 TIMES.*/
            public ListBasis<BI6016B_CEP> CEP { get; set; } = new ListBasis<BI6016B_CEP>(2000);
            public class BI6016B_CEP : VarBasis
            {
                /*"      10      TAB-FX-CEP-G        PIC  9(004).*/
                public IntBasis TAB_FX_CEP_G { get; set; } = new IntBasis(new PIC("9", "4", "9(004)."));
                /*"      10      TAB-FAIXAS.*/
                public BI6016B_TAB_FAIXAS TAB_FAIXAS { get; set; } = new BI6016B_TAB_FAIXAS();
                public class BI6016B_TAB_FAIXAS : VarBasis
                {
        ...
        public BI6016B_TABELA_TOTAIS TABELA_TOTAIS { get; set; } = new BI6016B_TABELA_TOTAIS();
        public class BI6016B_TABELA_TOTAIS : VarBasis
        {
            /*"    05        TAB-TOTAIS          OCCURS  2000 TIMES.*/
            public ListBasis<BI6016B_TAB_TOTAIS> TAB_TOTAIS { get; set; } = new ListBasis<BI6016B_TAB_TOTAIS>(2000);
            public class BI6016B_TAB_TOTAIS : VarBasis
            {
        ...
        public BI6016B_TABELA_MESES TABELA_MESES { get; set; } = new BI6016B_TABELA_MESES();
        public class BI6016B_TABELA_MESES : VarBasis
        {
            /*"    05        TAB-MESES.*/
            public BI6016B_TAB_MESES TAB_MESES { get; set; } = new BI6016B_TAB_MESES();
            public class BI6016B_TAB_MESES : VarBasis
            {
            ...
            private _REDEF_BI6016B_TAB_MESES_R _tab_meses_r { get; set; }
            public _REDEF_BI6016B_TAB_MESES_R TAB_MESES_R
            {
                get { _tab_meses_r = new _REDEF_BI6016B_TAB_MESES_R(); _.Move(TAB_MESES, _tab_meses_r); VarBasis.RedefinePassValue(TAB_MESES, _tab_meses_r, TAB_MESES); _tab_meses_r.ValueChanged += () => { _.Move(_tab_meses_r, TAB_MESES); }; return _tab_meses_r; }
                set { VarBasis.RedefinePassValue(value, _tab_meses_r, TAB_MESES); }
            }  //Redefines
            public class _REDEF_BI6016B_TAB_MESES_R : VarBasis
            {
                ...
                public _REDEF_BI6016B_TAB_MESES_R()
                {
        ...
        public BI6016B_TABELA_REGISTROS TABELA_REGISTROS { get; set; } = new BI6016B_TABELA_REGISTROS();
        public class BI6016B_TABELA_REGISTROS : VarBasis
        {
            /*"  03          TAB-REG             OCCURS 2 TIMES.*/
            public ListBasis<BI6016B_TAB_REG> TAB_REG { get; set; } = new ListBasis<BI6016B_TAB_REG>(2);
            public class BI6016B_TAB_REG : VarBasis
            {
                /*"    05        TBI-NUM-CEP.*/
                public BI6016B_TBI_NUM_CEP TBI_NUM_CEP { get; set; } = new BI6016B_TBI_NUM_CEP();
                public class BI6016B_TBI_NUM_CEP : VarBasis
                {
                ...
                /*"    05        TBI-NUM-CEP-FTE.*/
                public BI6016B_TBI_NUM_CEP_FTE TBI_NUM_CEP_FTE { get; set; } = new BI6016B_TBI_NUM_CEP_FTE();
                public class BI6016B_TBI_NUM_CEP_FTE : VarBasis
                {
        ...
        public BI6016B_IMPRESSAO_SAM IMPRESSAO_SAM { get; set; } = new BI6016B_IMPRESSAO_SAM();
        public class BI6016B_IMPRESSAO_SAM : VarBasis
        {
            /*"    05        SF05-HEADER.*/
            public BI6016B_SF05_HEADER SF05_HEADER { get; set; } = new BI6016B_SF05_HEADER();
            public class BI6016B_SF05_HEADER : VarBasis
            {
                ...
                public StringBasis FILLER_80 { get; set; } = new StringBasis(new PIC("X", "104", "X(104)"), @"SEGURADO|BILHETE|DTVIGENCIA|REMETENTE|REMET_ENDERECO|           ");
                /*"      10    FILLER              PIC  X(104)      VALUE           'AGEM|NUMOBJETO|DESTINATARIO|ENDERECO|BAIRRO|CIDADE|UF           '|CEP|POSTNET|CODIGO-CIF                            '*/
                public StringBasis FILLER_81 { get; set; } = new StringBasis(new PIC("X", "104", "X(104)"), @"AGEM|NUMOBJETO|DESTINATARIO|ENDERECO|BAIRRO|CIDADE|UF           ");
                /*"    05        SF05-REGISTRO.*/
            }
            public BI6016B_SF05_REGISTRO SF05_REGISTRO { get; set; } = new BI6016B_SF05_REGISTRO();
            public class BI6016B_SF05_REGISTRO : VarBasis
            {
                /*"      10      SF05-SEGURADO       PIC  X(040)      VALUE  SPACES*/
                public StringBasis SF05_SEGURADO { get; set; } = new StringBasis(new PIC("X", "40", "X(040)"), @"");
                /*"      10      SF05-SEPARA-001     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_001 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-BILHETE        PIC  X(013)      VALUE  SPACES*/
                public StringBasis SF05_BILHETE { get; set; } = new StringBasis(new PIC("X", "13", "X(013)"), @"");
                /*"      10      SF05-SEPARA-002     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_002 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-VIGENCIA       PIC  X(050)      VALUE  SPACES*/
                public StringBasis SF05_VIGENCIA { get; set; } = new StringBasis(new PIC("X", "50", "X(050)"), @"");
                /*"      10      SF05-SEPARA-003     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_003 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-REMETENTE      PIC  X(040)      VALUE  SPACES*/
                public StringBasis SF05_REMETENTE { get; set; } = new StringBasis(new PIC("X", "40", "X(040)"), @"");
                /*"      10      SF05-SEPARA-004     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_004 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-REM-ENDEREC    PIC  X(040)      VALUE  SPACES*/
                public StringBasis SF05_REM_ENDEREC { get; set; } = new StringBasis(new PIC("X", "40", "X(040)"), @"");
                /*"      10      SF05-SEPARA-005     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_005 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-REM-BAIRRO     PIC  X(020)      VALUE  SPACES*/
                public StringBasis SF05_REM_BAIRRO { get; set; } = new StringBasis(new PIC("X", "20", "X(020)"), @"");
                /*"      10      SF05-SEPARA-006     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_006 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-REM-CIDADE     PIC  X(020)      VALUE  SPACES*/
                public StringBasis SF05_REM_CIDADE { get; set; } = new StringBasis(new PIC("X", "20", "X(020)"), @"");
                /*"      10      SF05-SEPARA-007     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_007 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-REM-ESTADO     PIC  X(002)      VALUE  SPACES*/
                public StringBasis SF05_REM_ESTADO { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"      10      SF05-SEPARA-008     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_008 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-REM-CEP        PIC  X(009)      VALUE  SPACES*/
                public StringBasis SF05_REM_CEP { get; set; } = new StringBasis(new PIC("X", "9", "X(009)"), @"");
                /*"      10      SF05-SEPARA-009     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_009 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-DPOSTAGEM      PIC  X(010)      VALUE  SPACES*/
                public StringBasis SF05_DPOSTAGEM { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"");
                /*"      10      SF05-SEPARA-010     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_010 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-NUMOBJETO      PIC  X(007)      VALUE  SPACES*/
                public StringBasis SF05_NUMOBJETO { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"");
                /*"      10      SF05-SEPARA-011     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_011 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-DESTINATAR     PIC  X(040)      VALUE  SPACES*/
                public StringBasis SF05_DESTINATAR { get; set; } = new StringBasis(new PIC("X", "40", "X(040)"), @"");
                /*"      10      SF05-SEPARA-012     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_012 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-ENDERECO       PIC  X(072)      VALUE  SPACES*/
                public StringBasis SF05_ENDERECO { get; set; } = new StringBasis(new PIC("X", "72", "X(072)"), @"");
                /*"      10      SF05-SEPARA-013     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_013 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-BAIRRO         PIC  X(072)      VALUE  SPACES*/
                public StringBasis SF05_BAIRRO { get; set; } = new StringBasis(new PIC("X", "72", "X(072)"), @"");
                /*"      10      SF05-SEPARA-014     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_014 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-CIDADE         PIC  X(072)      VALUE  SPACES*/
                public StringBasis SF05_CIDADE { get; set; } = new StringBasis(new PIC("X", "72", "X(072)"), @"");
                /*"      10      SF05-SEPARA-015     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_015 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-UF             PIC  X(002)      VALUE  SPACES*/
                public StringBasis SF05_UF { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"      10      SF05-SEPARA-016     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_016 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-CEP            PIC  X(009)      VALUE  SPACES*/
                public StringBasis SF05_CEP { get; set; } = new StringBasis(new PIC("X", "9", "X(009)"), @"");
                /*"      10      SF05-SEPARA-017     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_017 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-POSTNET        PIC  X(011)      VALUE  SPACES*/
                public StringBasis SF05_POSTNET { get; set; } = new StringBasis(new PIC("X", "11", "X(011)"), @"");
                /*"      10      SF05-SEPARA-018     PIC  X(001)      VALUE  SPACES*/
                public StringBasis SF05_SEPARA_018 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
                /*"      10      SF05-CODIGO-CIF     PIC  X(034)      VALUE  SPACES*/
                public StringBasis SF05_CODIGO_CIF { get; set; } = new StringBasis(new PIC("X", "34", "X(034)"), @"");
                /*"    05        SF05-EOF            PIC  X(007)      VALUE '%%EOF'*/
            }
            public StringBasis SF05_EOF { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"%%EOF");
            ...
            public BI6016B_ATRIBUTOS_REGISTRO ATRIBUTOS_REGISTRO { get; set; } = new BI6016B_ATRIBUTOS_REGISTRO();
            public class BI6016B_ATRIBUTOS_REGISTRO : VarBasis
            {
        ...
        public BI6016B_WABEND WABEND { get; set; } = new BI6016B_WABEND();
        public class BI6016B_WABEND : VarBasis
        {
            /*"    05    FILLER              PIC  X(010) VALUE         ' BI6016B'.*/
            public StringBasis FILLER_82 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" BI6016B");
            /*"    05    FILLER              PIC  X(026) VALUE         ' *** ERRO EXEC SQL NUMERO '.*/
            public StringBasis FILLER_83 { get; set; } = new StringBasis(new PIC("X", "26", "X(026)"), @" *** ERRO EXEC SQL NUMERO ");
            /*"    05    WNR-EXEC-SQL        PIC  X(003) VALUE '000'.*/
            public StringBasis WNR_EXEC_SQL { get; set; } = new StringBasis(new PIC("X", "3", "X(003)"), @"000");
            /*"    05    FILLER              PIC  X(013) VALUE         ' *** SQLCODE '.*/
            public StringBasis FILLER_84 { get; set; } = new StringBasis(new PIC("X", "13", "X(013)"), @" *** SQLCODE ");
        ...
        public BI6016B_CFAIXACEP CFAIXACEP { get; set; } = new BI6016B_CFAIXACEP();
        public BI6016B_MOVDEBCC MOVDEBCC { get; set; } = new BI6016B_MOVDEBCC();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string SBI6016B_FILE_NAME_P, string BI6016B1_FILE_NAME_P, string BI6016B2_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                SBI6016B.SetFile(SBI6016B_FILE_NAME_P);
                BI6016B1.SetFile(BI6016B1_FILE_NAME_P);
                BI6016B2.SetFile(BI6016B2_FILE_NAME_P);

                /*" -699- MOVE '001' TO WNR-EXEC-SQL. */
                _.Move("001", WABEND.WNR_EXEC_SQL);

                /*" -700- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

                /*" -703- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

                /*" -706- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

                /*" -706- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        {
            /*" -716- PERFORM R0100-00-SELECT-SISTEMAS */

            R0100_00_SELECT_SISTEMAS_SECTION();

            /*" -717- IF WFIM-SISTEMAS NOT EQUAL SPACES */
            ...
            /*" -720- PERFORM R0900-00-DECLARE-MOVDEBCC. */

            R0900_00_DECLARE_MOVDEBCC_SECTION();

            /*" -722- PERFORM R0910-00-FETCH-MOVDEBCC. */

            R0910_00_FETCH_MOVDEBCC_SECTION();

            /*" -723- IF WFIM-MOVDEBCC EQUAL 'S' */

            if (AREA_DE_WORK.WFIM_MOVDEBCC == "S")
            {

                /*" -724- PERFORM R9800-00-ENCERRA-SEM-MOVTO */

                R9800_00_ENCERRA_SEM_MOVTO_SECTION();

                /*" -725- MOVE ZEROS TO RETURN-CODE */
            ...
            /*" -729- MOVE ZEROS TO TABELA-TOTAIS. */
            _.Move(0, TABELA_TOTAIS);

            /*" -731- PERFORM R0200-00-CARREGA-FAIXA-CEP. */

            R0200_00_CARREGA_FAIXA_CEP_SECTION();

            /*" -733- MOVE +200000 TO SORT-FILE-SIZE. */
            _.Move(+200000, SORT_FILE_SIZE);

            /*" -736- SORT SBI6016B ON ASCENDING KEY SBI-CEP-G SBI-NUM-CEP INPUT PROCEDURE R0010-00-SELECIONA THRU R0010-FIM OUTPUT PROCEDURE R0020-00-IMPRIME THRU R0020-FIM. */
            SORT_RETURN.Value = SBI6016B.Sort("SBI-CEP-G,SBI-NUM-CEP", () => R0010_00_SELECIONA_SECTION(), () => R0020_00_IMPRIME_SECTION());

            /*" -739- IF SORT-RETURN NOT EQUAL ZEROS */

            if (SORT_RETURN != 00)
            {

                /*" -740- DISPLAY '*** BI6016B *** PROBLEMAS NO SORT ' */
                _.Display($"*** BI6016B *** PROBLEMAS NO SORT ");

                /*" -741- DISPLAY '*** BI6016B *** SORT-RETURN = ' SORT-RETURN */
                _.Display($"*** BI6016B *** SORT-RETURN = {SORT_RETURN}");
        ...
        {
            /*" -747- MOVE ZEROS TO RETURN-CODE. */
            _.Move(0, RETURN_CODE);

            /*" -747- EXEC SQL COMMIT WORK END-EXEC. */
            ...
            /*" -751- DISPLAY 'LIDOS RELATORIOS         ' AC-LIDOS. */
            _.Display($"LIDOS RELATORIOS         {AREA_DE_WORK.AC_LIDOS}");

            /*" -753- DISPLAY 'CARTAS IMPRESSAS         ' AC-IMPRESSOS. */
            _.Display($"CARTAS IMPRESSAS         {AREA_DE_WORK.AC_IMPRESSOS}");

            /*" -754- DISPLAY '*** BI6016B - TERMINO NORMAL ***' */
            _.Display($"*** BI6016B - TERMINO NORMAL ***");
        ...
        {
            /*" -766- PERFORM R1000-00-PROCESSA-INPUT UNTIL WFIM-MOVDEBCC EQUAL 'S' . */
        ...
        {
            /*" -779- MOVE ZEROS TO WIND. */
            _.Move(0, AREA_DE_WORK.WIND);

            /*" -781- PERFORM R8000-00-OPEN-ARQUIVOS. */

            R8000_00_OPEN_ARQUIVOS_SECTION();

            /*" -782- MOVE SPACES TO BI6016B1-RECORD */
            _.Move("", BI6016B1_RECORD);

            /*" -783- MOVE SPACES TO ATRIBUTOS-REGISTRO */
            _.Move("", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO);

            /*" -784- MOVE '%!' TO ATRIBUTOS-CONTROLE */
            _.Move("%!", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_CONTROLE);

            /*" -785- MOVE '100134700-6' TO ATRIBUTOS-CONTRATO */
            _.Move("100134700-6", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_CONTRATO);

            /*" -786- MOVE 133 TO ATRIBUTOS-POSICAO */
            _.Move(133, IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_POSICAO);

            /*" -788- MOVE 'SASSE - CIA NACIONAL DE SEGUROS GERAIS' TO ATRIBUTOS-EMPRESA */
            _.Move("SASSE - CIA NACIONAL DE SEGUROS GERAIS", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_EMPRESA);

            /*" -790- MOVE 'SCN Q 01 - Bl A - Ed. Number One, 17 and' TO ATRIBUTOS-ENDERECO */
            _.Move("SCN Q 01 - Bl A - Ed. Number One, 17 and", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_ENDERECO);

            /*" -792- MOVE 'RENOVACAO DE BILHETE AP E RD' TO ATRIBUTOS-PRODUTO */
            _.Move("RENOVACAO DE BILHETE AP E RD", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_PRODUTO);

            /*" -793- MOVE 'BI6016B ' TO ATRIBUTOS-PROGRAMA */
            _.Move("BI6016B ", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_PROGRAMA);

            /*" -794- MOVE 'SF05    ' TO ATRIBUTOS-FORMULAR */
            _.Move("SF05    ", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_FORMULAR);

            /*" -795- MOVE '01' TO ATRIBUTOS-QTDIAS */
            _.Move("01", IMPRESSAO_SAM.ATRIBUTOS_REGISTRO.ATRIBUTOS_QTDIAS);

            /*" -797- MOVE ATRIBUTOS-REGISTRO TO REG-ATRIBUTOS */
            _.Move(IMPRESSAO_SAM.ATRIBUTOS_REGISTRO, BI6016B1_RECORD.REG_ATRIBUTOS);

            /*" -798- MOVE ZEROS TO REG-CEP */
            _.Move(0, BI6016B1_RECORD.REG_CEP);

            /*" -799- MOVE ZEROS TO REG-REGISTRO */
            _.Move(0, BI6016B1_RECORD.REG_REGISTRO);

            /*" -800- MOVE 1 TO REG-LINHANR */
            _.Move(1, BI6016B1_RECORD.REG_LINHANR);

            /*" -801- MOVE ZEROS TO REG-PRODUTO */
            _.Move(0, BI6016B1_RECORD.REG_PRODUTO);

            /*" -802- MOVE SPACES TO REG-BRANCO */
            _.Move("", BI6016B1_RECORD.REG_BRANCO);

            /*" -804- WRITE BI6016B1-RECORD */
            BI6016B1.Write(BI6016B1_RECORD.GetMoveValues().ToString());

            /*" -805- MOVE ZEROS TO REG-CEP */
            _.Move(0, BI6016B1_RECORD.REG_CEP);

            /*" -806- MOVE ZEROS TO REG-REGISTRO */
            _.Move(0, BI6016B1_RECORD.REG_REGISTRO);

            /*" -807- MOVE ZEROS TO REG-PRODUTO */
            _.Move(0, BI6016B1_RECORD.REG_PRODUTO);

            /*" -808- MOVE 2 TO REG-LINHANR */
            _.Move(2, BI6016B1_RECORD.REG_LINHANR);

            /*" -809- MOVE SPACES TO REG-ATRIBUTOS */
            _.Move("", BI6016B1_RECORD.REG_ATRIBUTOS);

            /*" -810- MOVE '(|) SETDBSEP' TO REG-ATRIBUTOS */
            _.Move("(|) SETDBSEP", BI6016B1_RECORD.REG_ATRIBUTOS);

            /*" -812- WRITE BI6016B1-RECORD */
            BI6016B1.Write(BI6016B1_RECORD.GetMoveValues().ToString());

            /*" -813- MOVE ZEROS TO REG-CEP */
            _.Move(0, BI6016B1_RECORD.REG_CEP);

            /*" -814- MOVE ZEROS TO REG-REGISTRO */
            _.Move(0, BI6016B1_RECORD.REG_REGISTRO);

            /*" -815- MOVE ZEROS TO REG-PRODUTO */
            _.Move(0, BI6016B1_RECORD.REG_PRODUTO);

            /*" -816- MOVE 3 TO REG-LINHANR */
            _.Move(3, BI6016B1_RECORD.REG_LINHANR);

            /*" -817- MOVE '(sf05.dbm) STARTDBM' TO REG-ATRIBUTOS */
            _.Move("(sf05.dbm) STARTDBM", BI6016B1_RECORD.REG_ATRIBUTOS);

            /*" -819- WRITE BI6016B1-RECORD */
            BI6016B1.Write(BI6016B1_RECORD.GetMoveValues().ToString());

            /*" -820- MOVE ZEROS TO REG-CEP */
            _.Move(0, BI6016B1_RECORD.REG_CEP);

            /*" -821- MOVE ZEROS TO REG-REGISTRO */
            _.Move(0, BI6016B1_RECORD.REG_REGISTRO);

            /*" -822- MOVE ZEROS TO REG-PRODUTO */
            _.Move(0, BI6016B1_RECORD.REG_PRODUTO);

            /*" -823- MOVE 4 TO REG-LINHANR */
            _.Move(4, BI6016B1_RECORD.REG_LINHANR);

            /*" -824- MOVE SF05-HEADER TO REG-ATRIBUTOS */
            _.Move(IMPRESSAO_SAM.SF05_HEADER, BI6016B1_RECORD.REG_ATRIBUTOS);

            /*" -826- WRITE BI6016B1-RECORD */
            BI6016B1.Write(BI6016B1_RECORD.GetMoveValues().ToString());

            /*" -828- PERFORM R2400-00-LE-SORT. */

            R2400_00_LE_SORT_SECTION();

            /*" -831- PERFORM R2000-00-PROCESSA-OUTPUT UNTIL WFIM-SORT EQUAL 'S' */
            ...
            /*" -832- MOVE SPACES TO BI6016B1-RECORD */
            _.Move("", BI6016B1_RECORD);

            /*" -833- MOVE 99999999 TO REG-CEP */
            _.Move(99999999, BI6016B1_RECORD.REG_CEP);

            /*" -834- MOVE ZEROS TO REG-REGISTRO */
            _.Move(0, BI6016B1_RECORD.REG_REGISTRO);

            /*" -835- MOVE ZEROS TO REG-PRODUTO */
            _.Move(0, BI6016B1_RECORD.REG_PRODUTO);

            /*" -836- MOVE 9 TO REG-LINHANR */
            _.Move(9, BI6016B1_RECORD.REG_LINHANR);

            /*" -837- MOVE SF05-EOF TO REG-ATRIBUTOS */
            _.Move(IMPRESSAO_SAM.SF05_EOF, BI6016B1_RECORD.REG_ATRIBUTOS);

            /*" -841- WRITE BI6016B1-RECORD. */
            BI6016B1.Write(BI6016B1_RECORD.GetMoveValues().ToString());

            /*" -841- PERFORM R9000-00-CLOSE-ARQUIVOS. */
        ...
        {
            /*" -863- EXEC SQL SELECT DATA_MOV_ABERTO, MONTH(DATA_MOV_ABERTO), YEAR(DATA_MOV_ABERTO) INTO :SISTEMAS-DATA-MOV-ABERTO, :SISTEMAS-MESREFER, :SISTEMAS-ANOREFER FROM SEGUROS.SISTEMAS WHERE IDE_SISTEMA = 'CO' END-EXEC. */
        ...
        {
            /*" -901- MOVE '020' TO WNR-EXEC-SQL. */
            _.Move("020", WABEND.WNR_EXEC_SQL);

            /*" -911- PERFORM R0200_00_CARREGA_FAIXA_CEP_DB_DECLARE_1 */

            R0200_00_CARREGA_FAIXA_CEP_DB_DECLARE_1();

            /*" -913- PERFORM R0200_00_CARREGA_FAIXA_CEP_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -917- DISPLAY 'BI6016B - PROBLEMAS NO OPEN FAIXA_CEP' */
                _.Display($"BI6016B - PROBLEMAS NO OPEN FAIXA_CEP");
            ...
            /*" -920- PERFORM R0210-00-FETCH-FAIXACEP UNTIL WFIM-FAIXACEP EQUAL 'S' . */
        ...
        {
            /*" -911- EXEC SQL DECLARE CFAIXACEP CURSOR FOR SELECT FAIXA, CEP_INICIAL, CEP_FINAL, DESCRICAO_FAIXA, CENTRALIZADOR FROM SEGUROS.GE_FAIXA_CEP WHERE DATA_INIVIGENCIA <= :SISTEMAS-DATA-MOV-ABERTO AND DATA_TERVIGENCIA >= :SISTEMAS-DATA-MOV-ABERTO ORDER BY FAIXA END-EXEC. */
            CFAIXACEP = new BI6016B_CFAIXACEP(true);
        ...
        {
            /*" -913- EXEC SQL OPEN CFAIXACEP END-EXEC. */
        ...
        {
            /*" -1094- EXEC SQL DECLARE MOVDEBCC CURSOR FOR SELECT NUM_APOLICE FROM SEGUROS.MOVTO_DEBITOCC_CEF WHERE SITUACAO_COBRANCA = '3' AND DATA_MOVIMENTO = :SISTEMAS-DATA-MOV-ABERTO AND COD_CONVENIO = 6114 AND COD_RETORNO_CEF <> 0 END-EXEC. */
            MOVDEBCC = new BI6016B_MOVDEBCC(true);
        ...
        {
            /*" -942- PERFORM R0210_10_FETCH_DB_FETCH_1 */
            ...
            /*" -958- MOVE GEFAICEP-CEP-FINAL TO TAB-FX-FIM (GEFAICEP-FAIXA). */
            ...
            /*" -960- MOVE GEFAICEP-DESCRICAO-FAIXA TO TAB-FX-NOME (GEFAICEP-FAIXA). */
            ...
            /*" -963- MOVE GEFAICEP-CENTRALIZADOR TO TAB-FX-CENTR (GEFAICEP-FAIXA). */
        ...
        {
            /*" -942- EXEC SQL FETCH CFAIXACEP INTO :GEFAICEP-FAIXA, :GEFAICEP-CEP-INICIAL, :GEFAICEP-CEP-FINAL, :GEFAICEP-DESCRICAO-FAIXA, :GEFAICEP-CENTRALIZADOR END-EXEC. */
        ...
        {
            /*" -948- EXEC SQL CLOSE CFAIXACEP END-EXEC */
        ...
        {
            /*" -976- MOVE '030' TO WNR-EXEC-SQL. */
            _.Move("030", WABEND.WNR_EXEC_SQL);

            /*" -977- DISPLAY 'DATA DO SISTEMA ' SISTEMAS-DATA-MOV-ABERTO */
            _.Display($"DATA DO SISTEMA {SISTEMAS.DCLSISTEMAS.SISTEMAS_DATA_MOV_ABERTO}");

            /*" -978- DISPLAY 'MES REFER =     ' SISTEMAS-MESREFER */
            _.Display($"MES REFER =     {SISTEMAS_MESREFER}");

            /*" -980- DISPLAY 'ANO REFER =     ' SISTEMAS-ANOREFER. */
            _.Display($"ANO REFER =     {SISTEMAS_ANOREFER}");

            /*" -987- PERFORM R0300_00_OBTEM_NUMERACAO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -992- MOVE ZEROS TO RELATORI-NUM-COPIAS */
                ...
                else
                {
                    ...
                    /*" -994- DISPLAY 'EM0600B - PROBLEMAS SELECT RELATORIOS' */
            ...
            /*" -997- IF VIND-NRCOPIAS LESS ZEROS */

            if (VIND_NRCOPIAS < 00)
            {

                /*" -999- MOVE ZEROS TO RELATORI-NUM-COPIAS. */
                _.Move(0, RELATORI.DCLRELATORIOS.RELATORI_NUM_COPIAS);
            }


            /*" -999- DISPLAY ' NRCOPIAS = ' RELATORI-NUM-COPIAS. */
        ...
        {
            /*" -987- EXEC SQL SELECT MAX(NUM_COPIAS) INTO :RELATORI-NUM-COPIAS:VIND-NRCOPIAS FROM SEGUROS.RELATORIOS WHERE COD_RELATORIO = 'CARTAECT' AND MES_REFERENCIA = :SISTEMAS-MESREFER AND ANO_REFERENCIA = :SISTEMAS-ANOREFER END-EXEC. */
        ...
        {
            /*" -1005- MOVE '031' TO WNR-EXEC-SQL. */
            _.Move("031", WABEND.WNR_EXEC_SQL);

            /*" -1005- ADD 1 TO RELATORI-NUM-COPIAS. */
        ...
        {
            /*" -1085- MOVE '090' TO WNR-EXEC-SQL */
            _.Move("090", WABEND.WNR_EXEC_SQL);

            /*" -1087- DISPLAY 'INICIO DO DECLARE' */
            _.Display($"INICIO DO DECLARE");

            /*" -1094- PERFORM R0900_00_DECLARE_MOVDEBCC_DB_DECLARE_1 */

            R0900_00_DECLARE_MOVDEBCC_DB_DECLARE_1();

            /*" -1096- PERFORM R0900_00_DECLARE_MOVDEBCC_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1100- DISPLAY 'BI6016B - ERRO NO OPEN (MOVDEBCC)' */
                _.Display($"BI6016B - ERRO NO OPEN (MOVDEBCC)");
        ...
        {
            /*" -1096- EXEC SQL OPEN MOVDEBCC END-EXEC. */
        ...
        {
            /*" -1115- MOVE '091' TO WNR-EXEC-SQL */
            _.Move("091", WABEND.WNR_EXEC_SQL);

            /*" -1117- PERFORM R0910_00_FETCH_MOVDEBCC_DB_FETCH_1 */

            R0910_00_FETCH_MOVDEBCC_DB_FETCH_1();

            /*" -1120- IF SQLCODE EQUAL 100 */

            if (DB.SQLCODE == 100)
            {

                /*" -1121- MOVE 'S' TO WFIM-MOVDEBCC */
                _.Move("S", AREA_DE_WORK.WFIM_MOVDEBCC);

                /*" -1123- MOVE ZEROS TO AC-CONTA AC-LIDOS */
                _.Move(0, AREA_DE_WORK.AC_CONTA, AREA_DE_WORK.AC_LIDOS);

                /*" -1123- PERFORM R0910_00_FETCH_MOVDEBCC_DB_CLOSE_1 */

                R0910_00_FETCH_MOVDEBCC_DB_CLOSE_1();

                /*" -1126- GO TO R0910-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R0910_99_SAIDA*/ //GOTO
                return;
            }


            /*" -1129- ADD 1 TO AC-CONTA AC-LIDOS. */
            ...
            if (AREA_DE_WORK.AC_CONTA > 99)
            {
                ...
                /*" -1131- MOVE ZEROS TO AC-CONTA */
                _.Move(0, AREA_DE_WORK.AC_CONTA);

                /*" -1132- ACCEPT WHORA-CURR FROM TIME */
                _.Move(_.AcceptDate("TIME"), AREA_DE_WORK.WHORA_CURR);

                /*" -1132- DISPLAY '**** LIDOS MOVDEBCC   ' AC-LIDOS ' ' WHORA-CURR. */
        ...
        {
            /*" -1117- EXEC SQL FETCH MOVDEBCC INTO :MOVDEBCE-NUM-APOLICE END-EXEC. */
        ...
        {
            /*" -1123- EXEC SQL CLOSE MOVDEBCC END-EXEC */
        ...
        {
            /*" -1146- MOVE '100' TO WNR-EXEC-SQL. */
            _.Move("100", WABEND.WNR_EXEC_SQL);

            /*" -1147- PERFORM R1100-00-SELECT-BILHETE */

            R1100_00_SELECT_BILHETE_SECTION();

            /*" -1148- IF WTEM-BILHETE EQUAL 'N' */

            if (AREA_DE_WORK.WTEM_BILHETE == "N")
            {

                /*" -1149- GO TO R1000-10-NEXT */
            ...
            else
            {
                ...
                /*" -1151- IF BILHETE-RAMO NOT EQUAL 82 */

                if (BILHETE.DCLBILHETE.BILHETE_RAMO != 82)
                {

                    /*" -1153- GO TO R1000-10-NEXT. */
            ...
            /*" -1154- PERFORM R1200-00-SELECT-CLIENTES */

            R1200_00_SELECT_CLIENTES_SECTION();

            /*" -1155- IF WTEM-CLIENTE EQUAL 'N' */

            if (AREA_DE_WORK.WTEM_CLIENTE == "N")
            {

                /*" -1157- GO TO R1000-10-NEXT. */
            ...
            /*" -1158- PERFORM R1300-00-SELECT-ENDERECOS */

            R1300_00_SELECT_ENDERECOS_SECTION();

            /*" -1159- IF WTEM-ENDERECO EQUAL 'N' */

            if (AREA_DE_WORK.WTEM_ENDERECO == "N")
            {

                /*" -1161- GO TO R1000-10-NEXT. */
            ...
            /*" -1162- PERFORM R1400-00-SELECT-FONTES */

            R1400_00_SELECT_FONTES_SECTION();

            /*" -1163- IF WTEM-FONTES EQUAL 'N' */

            if (AREA_DE_WORK.WTEM_FONTES == "N")
            {

                /*" -1165- GO TO R1000-10-NEXT. */
            ...
            /*" -1166- PERFORM R1500-00-SELECT-ENDOSSOS */

            R1500_00_SELECT_ENDOSSOS_SECTION();

            /*" -1167- IF WTEM-ENDOSSOS EQUAL 'N' */

            if (AREA_DE_WORK.WTEM_ENDOSSOS == "N")
            {

                /*" -1169- GO TO R1000-10-NEXT. */
            ...
            /*" -1170- MOVE ENDERECO-ENDERECO TO SBI-ENDERECO. */
            _.Move(ENDERECO.DCLENDERECOS.ENDERECO_ENDERECO, REG_SBI6016B.SBI_ENDERECO);

            /*" -1171- MOVE ENDERECO-BAIRRO TO SBI-BAIRRO. */
            _.Move(ENDERECO.DCLENDERECOS.ENDERECO_BAIRRO, REG_SBI6016B.SBI_BAIRRO);

            /*" -1172- MOVE ENDERECO-CIDADE TO SBI-CIDADE. */
            _.Move(ENDERECO.DCLENDERECOS.ENDERECO_CIDADE, REG_SBI6016B.SBI_CIDADE);

            /*" -1173- MOVE ENDERECO-SIGLA-UF TO SBI-UF. */
            _.Move(ENDERECO.DCLENDERECOS.ENDERECO_SIGLA_UF, REG_SBI6016B.SBI_UF);

            /*" -1179- MOVE ENDERECO-CEP TO WS-NUM-CEP-AUX. */
            _.Move(ENDERECO.DCLENDERECOS.ENDERECO_CEP, AREA_DE_WORK.WS_NUM_CEP_AUX);

            /*" -1180- MOVE WS-CEP-AUX TO SBI-CEP */
            _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_AUX, REG_SBI6016B.SBI_NUM_CEP.SBI_CEP);

            /*" -1182- MOVE WS-CEP-COMPL-AUX TO SBI-CEP-COMPL. */
            _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_COMPL_AUX, REG_SBI6016B.SBI_NUM_CEP.SBI_CEP_COMPL);

            /*" -1183- MOVE CLIENTES-NOME-RAZAO TO SBI-NOME-RAZAO */
            _.Move(CLIENTES.DCLCLIENTES.CLIENTES_NOME_RAZAO, REG_SBI6016B.SBI_NOME_RAZAO);

            /*" -1184- MOVE BILHETE-NUM-BILHETE TO SBI-NUMBIL */
            _.Move(BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE, REG_SBI6016B.SBI_NUMBIL);

            /*" -1186- MOVE APOLICES-COD-PRODUTO TO SBI-PRODUTO */
            _.Move(APOLICES.DCLAPOLICES.APOLICES_COD_PRODUTO, REG_SBI6016B.SBI_PRODUTO);

            /*" -1187- MOVE FONTES-NOME-FONTE TO WS-NOMEFTE */
            _.Move(FONTES.DCLFONTES.FONTES_NOME_FONTE, AREA_DE_WORK.WS_NOME_FONTE.WS_NOMEFTE);

            /*" -1188- MOVE WS-NOME-FONTE TO SBI-NOMEFTE */
            _.Move(AREA_DE_WORK.WS_NOME_FONTE, REG_SBI6016B.SBI_NOMEFTE);

            /*" -1189- MOVE FONTES-ENDERECO TO SBI-ENDERFTE */
            _.Move(FONTES.DCLFONTES.FONTES_ENDERECO, REG_SBI6016B.SBI_ENDERFTE);

            /*" -1190- MOVE FONTES-BAIRRO TO SBI-BAIRRO-FTE */
            _.Move(FONTES.DCLFONTES.FONTES_BAIRRO, REG_SBI6016B.SBI_BAIRRO_FTE);

            /*" -1191- MOVE FONTES-CIDADE TO SBI-CIDADE-FTE */
            _.Move(FONTES.DCLFONTES.FONTES_CIDADE, REG_SBI6016B.SBI_CIDADE_FTE);

            /*" -1192- MOVE FONTES-SIGLA-UF TO SBI-UF-FTE */
            _.Move(FONTES.DCLFONTES.FONTES_SIGLA_UF, REG_SBI6016B.SBI_UF_FTE);

            /*" -1194- MOVE FONTES-CEP TO WS-NUM-CEP-AUX. */
            _.Move(FONTES.DCLFONTES.FONTES_CEP, AREA_DE_WORK.WS_NUM_CEP_AUX);

            /*" -1195- IF WS-CEP-COMPL-AUX1 EQUAL ZEROS */

            if (AREA_DE_WORK.WS_NUM_CEP_AUX_R1.WS_CEP_COMPL_AUX1 == 00)
            {

                /*" -1196- MOVE WS-CEP-COMPL-AUX1 TO SBI-COMP-FTE */
                _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R1.WS_CEP_COMPL_AUX1, REG_SBI6016B.SBI_NUM_CEP_FTE.SBI_COMP_FTE);

                /*" -1197- MOVE WS-CEP-AUX1 TO SBI-CEP-FTE */
                _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R1.WS_CEP_AUX1, REG_SBI6016B.SBI_NUM_CEP_FTE.SBI_CEP_FTE);
            ...
            else
            {
                ...
                /*" -1199- MOVE WS-CEP-AUX TO SBI-CEP-FTE */
                _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_AUX, REG_SBI6016B.SBI_NUM_CEP_FTE.SBI_CEP_FTE);

                /*" -1207- MOVE WS-CEP-COMPL-AUX TO SBI-COMP-FTE. */
                _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_COMPL_AUX, REG_SBI6016B.SBI_NUM_CEP_FTE.SBI_COMP_FTE);
            }


            /*" -1208- MOVE SPACES TO SBI-NOME-CORREIO */
            _.Move("", REG_SBI6016B.SBI_NOME_CORREIO);

            /*" -1209- MOVE ENDOSSOS-DATA-INIVIGENCIA TO WWORK-DATA-DB2 */
            _.Move(ENDOSSOS.DCLENDOSSOS.ENDOSSOS_DATA_INIVIGENCIA, AREA_DE_WORK.WWORK_DATA_DB2);

            /*" -1210- MOVE WWORK-DIA-DB2 TO WWORK-DIA-VIG */
            _.Move(AREA_DE_WORK.FILLER_60.WWORK_DIA_DB2, AREA_DE_WORK.FILLER_63.WWORK_DIA_VIG);

            /*" -1211- MOVE ' DE ' TO WWORK-LITERA1 */
            _.Move(" DE ", AREA_DE_WORK.FILLER_63.WWORK_LITERA1);

            /*" -1212- MOVE TAB-MES(WWORK-MES-DB2) TO WWORK-MES-VIG */
            _.Move(TABELA_MESES.TAB_MESES_R.TAB_MES[AREA_DE_WORK.FILLER_60.WWORK_MES_DB2], AREA_DE_WORK.FILLER_63.WWORK_MES_VIG);

            /*" -1213- MOVE ' DE ' TO WWORK-LITERA2 */
            _.Move(" DE ", AREA_DE_WORK.FILLER_63.WWORK_LITERA2);

            /*" -1214- MOVE WWORK-ANO-DB2 TO WWORK-ANO-VIG */
            _.Move(AREA_DE_WORK.FILLER_60.WWORK_ANO_DB2, AREA_DE_WORK.FILLER_63.WWORK_ANO_VIG);

            /*" -1216- MOVE WWORK-DATA-VIG TO WWORK-INI-VIG */
            _.Move(AREA_DE_WORK.WWORK_DATA_VIG, AREA_DE_WORK.FILLER_64.WWORK_INI_VIG);

            /*" -1217- MOVE ENDOSSOS-DATA-TERVIGENCIA TO WWORK-DATA-DB2 */
            _.Move(ENDOSSOS.DCLENDOSSOS.ENDOSSOS_DATA_TERVIGENCIA, AREA_DE_WORK.WWORK_DATA_DB2);

            /*" -1218- MOVE WWORK-DIA-DB2 TO WWORK-DIA-VIG */
            _.Move(AREA_DE_WORK.FILLER_60.WWORK_DIA_DB2, AREA_DE_WORK.FILLER_63.WWORK_DIA_VIG);

            /*" -1219- MOVE TAB-MES(WWORK-MES-DB2) TO WWORK-MES-VIG */
            _.Move(TABELA_MESES.TAB_MESES_R.TAB_MES[AREA_DE_WORK.FILLER_60.WWORK_MES_DB2], AREA_DE_WORK.FILLER_63.WWORK_MES_VIG);

            /*" -1220- MOVE WWORK-ANO-DB2 TO WWORK-ANO-VIG */
            _.Move(AREA_DE_WORK.FILLER_60.WWORK_ANO_DB2, AREA_DE_WORK.FILLER_63.WWORK_ANO_VIG);

            /*" -1222- MOVE WWORK-DATA-VIG TO WWORK-TER-VIG */
            _.Move(AREA_DE_WORK.WWORK_DATA_VIG, AREA_DE_WORK.FILLER_64.WWORK_TER_VIG);

            /*" -1223- MOVE ' A ' TO WWORK-LITERA3 */
            _.Move(" A ", AREA_DE_WORK.FILLER_64.WWORK_LITERA3);

            /*" -1225- MOVE '.' TO WWORK-LITERA4 */
            _.Move(".", AREA_DE_WORK.FILLER_64.WWORK_LITERA4);

            /*" -1226- MOVE WWORK-VIGENCIA TO WW-INPUT */
            _.Move(AREA_DE_WORK.WWORK_VIGENCIA, AREA_DE_WORK.WW_INPUT);

            /*" -1227- PERFORM R1600-00-SUPRIME-BRANCOS */

            R1600_00_SUPRIME_BRANCOS_SECTION();

            /*" -1229- MOVE WW-OUTPUT TO SBI-VIGENCIA. */
            _.Move(AREA_DE_WORK.WW_OUTPUT, REG_SBI6016B.SBI_VIGENCIA);

            /*" -1229- RELEASE REG-SBI6016B. */
            SBI6016B.Release(REG_SBI6016B);
        ...
        {
            /*" -1233- PERFORM R0910-00-FETCH-MOVDEBCC. */
        ...
        private void R1100_00_SELECT_BILHETE_SECTION()
        {
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                else
                {
                    ...
                    /*" -1278- DISPLAY '*** BI6016B - PROBLEMAS NO ACESSO A BILHETE' */
                    _.Display($"*** BI6016B - PROBLEMAS NO ACESSO A BILHETE");

                    /*" -1279- DISPLAY 'BILHETE     ' BILHETE-NUM-BILHETE */
        ...
        {
            /*" -1266- EXEC SQL SELECT A.COD_CLIENTE , A.FONTE , A.RAMO , A.OCORR_ENDERECO, A.NUM_APOLICE, B.COD_PRODUTO INTO :BILHETE-COD-CLIENTE , :BILHETE-FONTE , :BILHETE-RAMO , :BILHETE-OCORR-ENDERECO, :BILHETE-NUM-APOLICE, :APOLICES-COD-PRODUTO FROM SEGUROS.BILHETE A, SEGUROS.APOLICES B WHERE A.NUM_BILHETE = :BILHETE-NUM-BILHETE AND A.NUM_APOLICE = B.NUM_APOLICE END-EXEC. */
        ...
        {
            /*" -1291- MOVE '120' TO WNR-EXEC-SQL. */
            _.Move("120", WABEND.WNR_EXEC_SQL);

            /*" -1293- MOVE 'S' TO WTEM-CLIENTE. */
            _.Move("S", AREA_DE_WORK.WTEM_CLIENTE);

            /*" -1300- PERFORM R1200_00_SELECT_CLIENTES_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1304- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1310- MOVE 'N' TO WTEM-CLIENTE */
                ...
                else
                {
                    ...
                    /*" -1313- DISPLAY '*** BI6016B - PROBLEMAS NO ACESSO A CLIENTES' */
                    _.Display($"*** BI6016B - PROBLEMAS NO ACESSO A CLIENTES");

                    /*" -1314- DISPLAY 'BILHETE     ' BILHETE-NUM-BILHETE */
                    _.Display($"BILHETE     {BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE}");

                    /*" -1315- DISPLAY 'CLIENTE     ' BILHETE-COD-CLIENTE */
        ...
        {
            /*" -1300- EXEC SQL SELECT NOME_RAZAO, CGCCPF INTO :CLIENTES-NOME-RAZAO, :CLIENTES-CGCCPF FROM SEGUROS.CLIENTES WHERE COD_CLIENTE = :BILHETE-COD-CLIENTE END-EXEC. */
        ...
        {
            /*" -1327- MOVE '130' TO WNR-EXEC-SQL. */
            _.Move("130", WABEND.WNR_EXEC_SQL);

            /*" -1329- MOVE 'S' TO WTEM-ENDERECO. */
            _.Move("S", AREA_DE_WORK.WTEM_ENDERECO);

            /*" -1343- PERFORM R1300_00_SELECT_ENDERECOS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1347- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1354- MOVE 'N' TO WTEM-ENDERECO */
                ...
                else
                {
                    ...
                    /*" -1357- DISPLAY '*** BI6016B - PROBLEMAS NO ACESSO A ENDERECOS' */
                    _.Display($"*** BI6016B - PROBLEMAS NO ACESSO A ENDERECOS");

                    /*" -1358- DISPLAY 'BILHETE     ' BILHETE-NUM-BILHETE */
                    _.Display($"BILHETE     {BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE}");

                    /*" -1359- DISPLAY 'CLIENTE     ' BILHETE-COD-CLIENTE */
                    _.Display($"CLIENTE     {BILHETE.DCLBILHETE.BILHETE_COD_CLIENTE}");

                    /*" -1360- DISPLAY 'OCORR ENDER ' BILHETE-OCORR-ENDERECO */
            ...
            else
            {
                ...
                /*" -1363- IF ENDERECO-CEP EQUAL ZEROS */

                if (ENDERECO.DCLENDERECOS.ENDERECO_CEP == 00)
                {

                    /*" -1363- MOVE 'N' TO WTEM-ENDERECO. */
                    _.Move("N", AREA_DE_WORK.WTEM_ENDERECO);
                }
        ...
        {
            /*" -1343- EXEC SQL SELECT ENDERECO, BAIRRO, CIDADE, SIGLA_UF, CEP INTO :ENDERECO-ENDERECO, :ENDERECO-BAIRRO, :ENDERECO-CIDADE, :ENDERECO-SIGLA-UF, :ENDERECO-CEP FROM SEGUROS.ENDERECOS WHERE COD_CLIENTE = :BILHETE-COD-CLIENTE AND OCORR_ENDERECO = :BILHETE-OCORR-ENDERECO END-EXEC. */
        ...
        {
            /*" -1381- MOVE '140' TO WNR-EXEC-SQL. */
            _.Move("140", WABEND.WNR_EXEC_SQL);

            /*" -1383- MOVE 'S' TO WTEM-FONTES. */
            _.Move("S", AREA_DE_WORK.WTEM_FONTES);

            /*" -1398- PERFORM R1400_00_SELECT_FONTES_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                else
                {
                    ...
                    /*" -1411- DISPLAY '*** BI6016B - PROBLEMAS NO ACESSO A FONTES' */
                    _.Display($"*** BI6016B - PROBLEMAS NO ACESSO A FONTES");

                    /*" -1412- DISPLAY 'BILHETE     ' BILHETE-NUM-BILHETE */
                    _.Display($"BILHETE     {BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE}");

                    /*" -1413- DISPLAY 'FONTE       ' BILHETE-FONTE */
        ...
        {
            /*" -1398- EXEC SQL SELECT NOME_FONTE, ENDERECO, BAIRRO, CIDADE, SIGLA_UF, CEP INTO :FONTES-NOME-FONTE, :FONTES-ENDERECO, :FONTES-BAIRRO, :FONTES-CIDADE, :FONTES-SIGLA-UF, :FONTES-CEP FROM SEGUROS.FONTES WHERE COD_FONTE = :BILHETE-FONTE END-EXEC. */
        ...
        {
            /*" -1425- MOVE '150' TO WNR-EXEC-SQL. */
            _.Move("150", WABEND.WNR_EXEC_SQL);

            /*" -1426- MOVE 'S' TO WTEM-ENDOSSOS. */
            _.Move("S", AREA_DE_WORK.WTEM_ENDOSSOS);

            /*" -1428- MOVE ZEROS TO ENDOSSOS-NUM-ENDOSSO. */
            _.Move(0, ENDOSSOS.DCLENDOSSOS.ENDOSSOS_NUM_ENDOSSO);

            /*" -1436- PERFORM R1500_00_SELECT_ENDOSSOS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                else
                {
                    ...
                    /*" -1449- DISPLAY '*** BI6016B - PROBLEMAS NO ACESSO A ENDOSSOS' */
                    _.Display($"*** BI6016B - PROBLEMAS NO ACESSO A ENDOSSOS");

                    /*" -1450- DISPLAY 'BILHETE     ' BILHETE-NUM-BILHETE */
                    _.Display($"BILHETE     {BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE}");

                    /*" -1451- DISPLAY 'APOLICE     ' BILHETE-NUM-APOLICE */
        ...
        {
            /*" -1436- EXEC SQL SELECT DATA_INIVIGENCIA , DATA_TERVIGENCIA INTO :ENDOSSOS-DATA-INIVIGENCIA , :ENDOSSOS-DATA-TERVIGENCIA FROM SEGUROS.ENDOSSOS WHERE NUM_APOLICE = :BILHETE-NUM-APOLICE AND NUM_ENDOSSO = :ENDOSSOS-NUM-ENDOSSO END-EXEC. */
        ...
        {
            /*" -1463- MOVE SPACES TO WW-OUTPUT */
            _.Move("", AREA_DE_WORK.WW_OUTPUT);

            /*" -1464- SET WWO1 TO WZEROS. */
            WWO1.Value = AREA_DE_WORK.WZEROS;

            /*" -1464- SET WWI1 TO WZEROS. */
        ...
        {
            /*" -1469- SET WWI1 UP BY +1 */
            WWI1.Value += +1;

            /*" -1470- IF WWI1 GREATER +50 */

            if (WWI1 > +50)
            {

                /*" -1472- GO TO R1600-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R1600_99_SAIDA*/ //GOTO
                return;
            }


            /*" -1473- IF WW-CCC-I(WWI1) NOT EQUAL SPACES */

            if (AREA_DE_WORK.FILLER_66[WWI1].WW_CCC_I != string.Empty)
            {

                /*" -1474- SET WWO1 UP BY +1 */
                WWO1.Value += +1;

                /*" -1475- MOVE WW-CCC-I(WWI1) TO WW-CCC-O(WWO1) */
            ...
            else
            {
                ...
                /*" -1477- MOVE WWI1 TO INDEX-AUX */
                _.Move(WWI1, INDEX_AUX);

                /*" -1478- SET INDEX-AUX UP BY +1 */
                INDEX_AUX.Value += +1;

                /*" -1480- IF WW-CCC-I(INDEX-AUX) EQUAL SPACES NEXT SENTENCE */
                ...
                else
                {
                    ...
                    /*" -1482- SET WWO1 UP BY +1 */
                    WWO1.Value += +1;

                    /*" -1484- MOVE WW-CCC-I(WWI1) TO WW-CCC-O(WWO1). */
                    _.Move(AREA_DE_WORK.FILLER_66[WWI1].WW_CCC_I, AREA_DE_WORK.FILLER_67[WWO1].WW_CCC_O);
                }
        ...
        {
            /*" -1500- IF WIND GREATER 2000 */

            if (AREA_DE_WORK.WIND > 2000)
            {

                /*" -1503- DISPLAY '*** BI6016B CEP NAO ENCONTRADO ' BILHETE-NUM-BILHETE ' ' ENDERECO-CEP */

                $"*** BI6016B CEP NAO ENCONTRADO {BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE} {ENDERECO.DCLENDERECOS.ENDERECO_CEP}"
                .Display();

                /*" -1504- MOVE 01 TO SBI-CEP-G */
                _.Move(01, REG_SBI6016B.SBI_CEP_G);

                /*" -1505- MOVE TAB-FAIXAS (01) TO SBI-NOME-CORREIO */
                _.Move(TABELA_CEP.CEP[01].TAB_FAIXAS, REG_SBI6016B.SBI_NOME_CORREIO);

                /*" -1507- GO TO R1900-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R1900_99_SAIDA*/ //GOTO
                return;
            }


            /*" -1508- MOVE TAB-FX-FIM (WIND) TO WS-SUP. */
            _.Move(TABELA_CEP.CEP[AREA_DE_WORK.WIND].TAB_FAIXAS.TAB_FX_FIM, AREA_DE_WORK.WS_SUP);

            /*" -1510- MOVE TAB-FX-INI (WIND) TO WS-INF. */
            _.Move(TABELA_CEP.CEP[AREA_DE_WORK.WIND].TAB_FAIXAS.TAB_FX_INI, AREA_DE_WORK.WS_INF);

            /*" -1511- ADD 1 TO WS-SUP. */
            AREA_DE_WORK.WS_SUP.Value = AREA_DE_WORK.WS_SUP + 1;

            /*" -1513- SUBTRACT 1 FROM WS-INF. */
            AREA_DE_WORK.WS_INF.Value = AREA_DE_WORK.WS_INF - 1;

            /*" -1515- IF ENDERECO-CEP GREATER WS-INF AND ENDERECO-CEP LESS WS-SUP */

            if (ENDERECO.DCLENDERECOS.ENDERECO_CEP > AREA_DE_WORK.WS_INF && ENDERECO.DCLENDERECOS.ENDERECO_CEP < AREA_DE_WORK.WS_SUP)
            {

                /*" -1516- MOVE TAB-FX-CEP-G (WIND) TO SBI-CEP-G */
                _.Move(TABELA_CEP.CEP[AREA_DE_WORK.WIND].TAB_FX_CEP_G, REG_SBI6016B.SBI_CEP_G);

                /*" -1517- MOVE TAB-FAIXAS (WIND) TO SBI-NOME-CORREIO */
                _.Move(TABELA_CEP.CEP[AREA_DE_WORK.WIND].TAB_FAIXAS, REG_SBI6016B.SBI_NOME_CORREIO);
        ...
        {
            /*" -1532- MOVE SBI-CEP-G TO WS-CEP-G-ANT. */
            _.Move(REG_SBI6016B.SBI_CEP_G, AREA_DE_WORK.WS_CEP_G_ANT);

            /*" -1533- MOVE SBI-NOME-CORREIO TO WS-NOME-COR-ANT. */
            _.Move(REG_SBI6016B.SBI_NOME_CORREIO, AREA_DE_WORK.WS_NOME_COR_ANT);

            /*" -1536- MOVE ZEROS TO WS-CONTR-AMAR WS-CONTR-OBJ. */
            _.Move(0, AREA_DE_WORK.WS_CONTR_AMAR, AREA_DE_WORK.WS_CONTR_OBJ);

            /*" -1537- MOVE TAB-FX-INI (SBI-CEP-G) TO WS-NUM-CEP-AUX. */
            _.Move(TABELA_CEP.CEP[REG_SBI6016B.SBI_CEP_G].TAB_FAIXAS.TAB_FX_INI, AREA_DE_WORK.WS_NUM_CEP_AUX);

            /*" -1538- MOVE WS-CEP-AUX TO LF03-FAIXA1. */
            _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_AUX, AREA_DE_WORK.LF03_LINHA03.LF03_FAIXA1);

            /*" -1539- MOVE WS-CEP-COMPL-AUX TO LF03-FAIXA1C. */
            _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_COMPL_AUX, AREA_DE_WORK.LF03_LINHA03.LF03_FAIXA1C);

            /*" -1540- MOVE TAB-FX-FIM (SBI-CEP-G) TO WS-NUM-CEP-AUX. */
            _.Move(TABELA_CEP.CEP[REG_SBI6016B.SBI_CEP_G].TAB_FAIXAS.TAB_FX_FIM, AREA_DE_WORK.WS_NUM_CEP_AUX);

            /*" -1541- MOVE WS-CEP-AUX TO LF03-FAIXA2. */
            _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_AUX, AREA_DE_WORK.LF03_LINHA03.LF03_FAIXA2);

            /*" -1544- MOVE WS-CEP-COMPL-AUX TO LF03-FAIXA2C. */
            _.Move(AREA_DE_WORK.WS_NUM_CEP_AUX_R.WS_CEP_COMPL_AUX, AREA_DE_WORK.LF03_LINHA03.LF03_FAIXA2C);

            /*" -1548- PERFORM R2100-00-PROCESSA-CEP UNTIL ((SBI-CEP-G NOT EQUAL WS-CEP-G-ANT) OR WFIM-SORT EQUAL 'S' ). */

            while (!(((REG_SBI6016B.SBI_CEP_G != AREA_DE_WORK.WS_CEP_G_ANT) || AREA_DE_WORK.WFIM_SORT == "S")))
            {

                R2100_00_PROCESSA_CEP_SECTION();
            }

            /*" -1549- MOVE WS-AMARRADO TO TAB1-AMARF(WS-CEP-G-ANT). */
            _.Move(AREA_DE_WORK.WS_AMARRADO, TABELA_TOTAIS.TAB_TOTAIS[AREA_DE_WORK.WS_CEP_G_ANT].TAB1_AMARF);

            /*" -1549- MOVE WS-SEQ TO TAB1-OBJF (WS-CEP-G-ANT). */
        ...
        {
            /*" -1564- MOVE ZEROS TO AC-CONTA1 AC-QTD-OBJ WS-CONTR-200. */
            _.Move(0, AREA_DE_WORK.AC_CONTA1, AREA_DE_WORK.AC_QTD_OBJ, AREA_DE_WORK.WS_CONTR_200);

            /*" -1569- PERFORM R2200-00-PROCESSA-FAC UNTIL ((SBI-CEP-G NOT EQUAL WS-CEP-G-ANT) OR WFIM-SORT EQUAL 'S' OR AC-CONTA1 > 199). */

            while (!(((REG_SBI6016B.SBI_CEP_G != AREA_DE_WORK.WS_CEP_G_ANT) || AREA_DE_WORK.WFIM_SORT == "S" || AREA_DE_WORK.AC_CONTA1 > 199)))
            {

                R2200_00_PROCESSA_FAC_SECTION();
            }

            /*" -1572- ADD 1 TO WS-AMARRADO TAB1-QTD-AMAR (WS-CEP-G-ANT). */
        ...
        {
            /*" -1615- MOVE ZEROS TO TABELA-REGISTROS. */
            _.Move(0, TABELA_REGISTROS);

            /*" -1621- PERFORM R2300-00-MONTA-LINHAS UNTIL ((SBI-CEP-G NOT EQUAL WS-CEP-G-ANT) OR WFIM-SORT EQUAL 'S' OR AC-CONTA1 GREATER 199 OR WIND GREATER 1). */

            while (!(((REG_SBI6016B.SBI_CEP_G != AREA_DE_WORK.WS_CEP_G_ANT) || AREA_DE_WORK.WFIM_SORT == "S" || AREA_DE_WORK.AC_CONTA1 > 199 || AREA_DE_WORK.WIND > 1)))
            {

                R2300_00_MONTA_LINHAS_SECTION();
            }

            /*" -1623- PERFORM R2500-00-IMPRIME */

            R2500_00_IMPRIME_SECTION();

            /*" -1623- MOVE ZEROS TO WIND. */
            _.Move(0, AREA_DE_WORK.WIND);
        ...
        private void R2300_00_MONTA_LINHAS_SECTION()
        {
            ...
            /*" -1636- MOVE SBI-CEP TO TBI-CEP (WIND). */
            _.Move(REG_SBI6016B.SBI_NUM_CEP.SBI_CEP, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_NUM_CEP.TBI_CEP);

            /*" -1637- MOVE SBI-CEP-COMPL TO TBI-CEP-COMPL (WIND). */
            _.Move(REG_SBI6016B.SBI_NUM_CEP.SBI_CEP_COMPL, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_NUM_CEP.TBI_CEP_COMPL);

            /*" -1638- MOVE SBI-NOME-RAZAO TO TBI-NOME-RAZAO (WIND). */
            _.Move(REG_SBI6016B.SBI_NOME_RAZAO, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_NOME_RAZAO);

            /*" -1639- MOVE SBI-NUMBIL TO TBI-NUMBIL (WIND). */
            _.Move(REG_SBI6016B.SBI_NUMBIL, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_NUMBIL);

            /*" -1640- MOVE SBI-PRODUTO TO TBI-PRODUTO (WIND). */
            _.Move(REG_SBI6016B.SBI_PRODUTO, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_PRODUTO);

            /*" -1641- MOVE SBI-ENDERECO TO TBI-ENDERECO (WIND). */
            _.Move(REG_SBI6016B.SBI_ENDERECO, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_ENDERECO);

            /*" -1642- MOVE SBI-BAIRRO TO TBI-BAIRRO (WIND). */
            _.Move(REG_SBI6016B.SBI_BAIRRO, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_BAIRRO);

            /*" -1643- MOVE SBI-CIDADE TO TBI-CIDADE (WIND). */
            _.Move(REG_SBI6016B.SBI_CIDADE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_CIDADE);

            /*" -1644- MOVE SBI-UF TO TBI-UF (WIND). */
            _.Move(REG_SBI6016B.SBI_UF, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_UF);

            /*" -1645- MOVE SBI-NOMEFTE TO TBI-NOMEFTE (WIND). */
            _.Move(REG_SBI6016B.SBI_NOMEFTE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_NOMEFTE);

            /*" -1646- MOVE SBI-ENDERFTE TO TBI-ENDERFTE (WIND). */
            _.Move(REG_SBI6016B.SBI_ENDERFTE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_ENDERFTE);

            /*" -1647- MOVE SBI-BAIRRO-FTE TO TBI-BAIRRO-FTE (WIND). */
            _.Move(REG_SBI6016B.SBI_BAIRRO_FTE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_BAIRRO_FTE);

            /*" -1648- MOVE SBI-CIDADE-FTE TO TBI-CIDADE-FTE (WIND). */
            _.Move(REG_SBI6016B.SBI_CIDADE_FTE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_CIDADE_FTE);

            /*" -1649- MOVE SBI-UF-FTE TO TBI-UF-FTE (WIND). */
            _.Move(REG_SBI6016B.SBI_UF_FTE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_UF_FTE);

            /*" -1650- MOVE SBI-CEP-FTE TO TBI-CEP-FTE (WIND). */
            _.Move(REG_SBI6016B.SBI_NUM_CEP_FTE.SBI_CEP_FTE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_NUM_CEP_FTE.TBI_CEP_FTE);

            /*" -1652- MOVE SBI-COMP-FTE TO TBI-COMP-FTE (WIND). */
            _.Move(REG_SBI6016B.SBI_NUM_CEP_FTE.SBI_COMP_FTE, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_NUM_CEP_FTE.TBI_COMP_FTE);

            /*" -1654- MOVE SBI-VIGENCIA TO TBI-VIGENCIA (WIND). */
            _.Move(REG_SBI6016B.SBI_VIGENCIA, TABELA_REGISTROS.TAB_REG[AREA_DE_WORK.WIND].TBI_VIGENCIA);

            /*" -1657- ADD 1 TO TAB1-QTD-OBJ (SBI-CEP-G) AC-QTD-OBJ WS-OBJ */
            TABELA_TOTAIS.TAB_TOTAIS[REG_SBI6016B.SBI_CEP_G].TAB1_QTD_OBJ.Value = TABELA_TOTAIS.TAB_TOTAIS[REG_SBI6016B.SBI_CEP_G].TAB1_QTD_OBJ + 1;
            AREA_DE_WORK.AC_QTD_OBJ.Value = AREA_DE_WORK.AC_QTD_OBJ + 1;
            AREA_DE_WORK.WS_OBJ.Value = AREA_DE_WORK.WS_OBJ + 1;

            /*" -1658- IF WS-CONTR-OBJ EQUAL ZEROS */

            if (AREA_DE_WORK.WS_CONTR_OBJ == 00)
            {

                /*" -1659- MOVE 1 TO WS-CONTR-OBJ */
                _.Move(1, AREA_DE_WORK.WS_CONTR_OBJ);

                /*" -1661- MOVE WS-OBJ TO TAB1-OBJI (SBI-CEP-G) */
                _.Move(AREA_DE_WORK.WS_OBJ, TABELA_TOTAIS.TAB_TOTAIS[REG_SBI6016B.SBI_CEP_G].TAB1_OBJI);

                /*" -1662- END-IF */
            }


            /*" -1663- IF WS-CONTR-200 EQUAL ZEROS */

            if (AREA_DE_WORK.WS_CONTR_200 == 00)
            {

                /*" -1664- MOVE 1 TO WS-CONTR-200 */
                _.Move(1, AREA_DE_WORK.WS_CONTR_200);

                /*" -1665- MOVE WS-SEQ TO WS-SEQ-INICIAL */
        ...
        {
            /*" -1680- RETURN SBI6016B AT END */
            try
            {
                SBI6016B.Return(REG_SBI6016B, () =>
                {

                    /*" -1681- MOVE 'S' TO WFIM-SORT */
                    _.Move("S", AREA_DE_WORK.WFIM_SORT);

                    /*" -1683- GO TO R2400-99-SAIDA. */
            ...
            /*" -1686- ADD 1 TO AC-LIDOS AC-CONTA. */
            AREA_DE_WORK.AC_LIDOS.Value = AREA_DE_WORK.AC_LIDOS + 1;
            AREA_DE_WORK.AC_CONTA.Value = AREA_DE_WORK.AC_CONTA + 1;

            /*" -1687- IF AC-CONTA GREATER 99 */

            if (AREA_DE_WORK.AC_CONTA > 99)
            {

                /*" -1688- MOVE ZEROS TO AC-CONTA */
                _.Move(0, AREA_DE_WORK.AC_CONTA);

                /*" -1689- ACCEPT WHORA-CURR FROM TIME */
                _.Move(_.AcceptDate("TIME"), AREA_DE_WORK.WHORA_CURR);

                /*" -1689- DISPLAY '*** LIDOS SORT    ' AC-LIDOS ' ' WHORA-CURR. */
        ...
        {
            /*" -1703- MOVE SPACES TO LC02-NOME-RAZAO LC03-NOMEFTE. */
            _.Move("", AREA_DE_WORK.LC02_LINHA02.LC02_NOME_RAZAO, AREA_DE_WORK.LC03_LINHA03.LC03_NOMEFTE);

            /*" -1704- MOVE SPACES TO SF05-REGISTRO. */
            _.Move("", IMPRESSAO_SAM.SF05_REGISTRO);

            /*" -1715- MOVE '|' TO SF05-SEPARA-001 SF05-SEPARA-002 SF05-SEPARA-003 SF05-SEPARA-004 SF05-SEPARA-005 SF05-SEPARA-006 SF05-SEPARA-007 SF05-SEPARA-008 SF05-SEPARA-009 SF05-SEPARA-010 SF05-SEPARA-011 SF05-SEPARA-012 SF05-SEPARA-013 SF05-SEPARA-014 SF05-SEPARA-015 SF05-SEPARA-016 SF05-SEPARA-017 SF05-SEPARA-018 */
            _.Move("|", IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_001, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_002, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_003, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_004, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_005, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_006, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_007, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_008, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_009, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_010, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_011, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_012, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_013, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_014, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_015, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_016, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_017, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEPARA_018);

            /*" -1716- IF TAB-REG (1) NOT EQUAL ZEROS */

            if (TABELA_REGISTROS.TAB_REG[1] != 00)
            {

                /*" -1717- MOVE TBI-NUM-CEP-FTE(1) TO REG-NUMCEP */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP_FTE, BI6016B1_RECORD.REG_CEP.REG_NUMCEP);

                /*" -1718- MOVE TBI-COMP-FTE (1) TO REG-CMPCEP */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP_FTE.TBI_COMP_FTE, BI6016B1_RECORD.REG_CEP.REG_CMPCEP);

                /*" -1719- ADD 1 TO ACC-REGISTRO */
                IMPRESSAO_SAM.ACC_REGISTRO.Value = IMPRESSAO_SAM.ACC_REGISTRO + 1;

                /*" -1720- MOVE ACC-REGISTRO TO REG-REGISTRO */
                _.Move(IMPRESSAO_SAM.ACC_REGISTRO, BI6016B1_RECORD.REG_REGISTRO);

                /*" -1721- MOVE 5 TO REG-LINHANR */
                _.Move(5, BI6016B1_RECORD.REG_LINHANR);

                /*" -1722- MOVE TBI-PRODUTO (1) TO REG-PRODUTO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_PRODUTO, BI6016B1_RECORD.REG_PRODUTO);

                /*" -1723- MOVE SPACES TO REG-BRANCO */
                _.Move("", BI6016B1_RECORD.REG_BRANCO);

                /*" -1724- MOVE SPACES TO REG-ATRIBUTOS */
                _.Move("", BI6016B1_RECORD.REG_ATRIBUTOS);

                /*" -1725- MOVE TBI-NOME-RAZAO(1) TO WS-NOME-RAZAO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NOME_RAZAO, AREA_DE_WORK.WS_NOME_RAZAO);

                /*" -1726- PERFORM R2900-00-FORMATA-NOME-RAZAO */

                R2900_00_FORMATA_NOME_RAZAO_SECTION();

                /*" -1727- MOVE WS-NOME-RAZAO TO LC02-NOME-RAZAO */
                _.Move(AREA_DE_WORK.WS_NOME_RAZAO, AREA_DE_WORK.LC02_LINHA02.LC02_NOME_RAZAO);

                /*" -1728- MOVE LC02-NOME-RAZAO TO SF05-SEGURADO */
                _.Move(AREA_DE_WORK.LC02_LINHA02.LC02_NOME_RAZAO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEGURADO);

                /*" -1729- MOVE TBI-NUMBIL (1) TO LC02-NUMBIL */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUMBIL, AREA_DE_WORK.LC02_LINHA02.LC02_NUMBIL);

                /*" -1730- MOVE LC02-NUMBIL TO SF05-BILHETE */
                _.Move(AREA_DE_WORK.LC02_LINHA02.LC02_NUMBIL, IMPRESSAO_SAM.SF05_REGISTRO.SF05_BILHETE);

                /*" -1731- MOVE TBI-NOMEFTE (1) TO LC03-NOMEFTE */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NOMEFTE, AREA_DE_WORK.LC03_LINHA03.LC03_NOMEFTE);

                /*" -1732- MOVE LC03-NOMEFTE TO SF05-REMETENTE */
                _.Move(AREA_DE_WORK.LC03_LINHA03.LC03_NOMEFTE, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REMETENTE);

                /*" -1733- MOVE TBI-NOMEFTE (1) TO LE02-NOME-RAZAO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NOMEFTE, AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO);

                /*" -1734- MOVE TBI-NUM-CEP-FTE(1) TO LE05-CEP-NRO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP_FTE, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_NRO);

                /*" -1735- MOVE TBI-COMP-FTE (1) TO LE05-CEP-COMPL */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP_FTE.TBI_COMP_FTE, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_COMPL);

                /*" -1736- MOVE LE05-CEP TO SF05-REM-CEP */
                _.Move(AREA_DE_WORK.LE05_LINHA05.LE05_CEP, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_CEP);

                /*" -1737- MOVE TBI-ENDERFTE (1) TO LE03-ENDERECO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_ENDERFTE, AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO);

                /*" -1738- MOVE LE03-ENDERECO TO SF05-REM-ENDEREC */
                _.Move(AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_ENDEREC);

                /*" -1739- MOVE TBI-CIDADE-FTE (1) TO LE04-CIDADE */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_CIDADE_FTE, AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE);

                /*" -1740- MOVE LE04-CIDADE TO SF05-REM-CIDADE */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_CIDADE);

                /*" -1741- MOVE TBI-BAIRRO-FTE (1) TO LE04-BAIRRO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_BAIRRO_FTE, AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO);

                /*" -1742- MOVE LE04-BAIRRO TO SF05-REM-BAIRRO */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_BAIRRO);

                /*" -1743- MOVE TBI-UF-FTE (1) TO LE04-UF */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_UF_FTE, AREA_DE_WORK.LE04_LINHA04.LE04_UF);

                /*" -1744- MOVE LE04-UF TO SF05-REM-ESTADO */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_UF, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_ESTADO);

                /*" -1745- MOVE TBI-NOME-RAZAO(1) TO LE02-NOME-RAZAO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NOME_RAZAO, AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO);

                /*" -1746- MOVE LE02-NOME-RAZAO TO SF05-DESTINATAR */
                _.Move(AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_DESTINATAR);

                /*" -1747- MOVE TBI-CEP (1) TO LE05-CEP-NRO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP.TBI_CEP, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_NRO);

                /*" -1748- MOVE TBI-CEP-COMPL (1) TO LE05-CEP-COMPL */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP.TBI_CEP_COMPL, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_COMPL);

                /*" -1749- MOVE LE05-CEP TO SF05-CEP */
                _.Move(AREA_DE_WORK.LE05_LINHA05.LE05_CEP, IMPRESSAO_SAM.SF05_REGISTRO.SF05_CEP);

                /*" -1750- MOVE TBI-ENDERECO (1) TO LE03-ENDERECO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_ENDERECO, AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO);

                /*" -1751- MOVE LE03-ENDERECO TO SF05-ENDERECO */
                _.Move(AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_ENDERECO);

                /*" -1752- MOVE TBI-CIDADE (1) TO LE04-CIDADE */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_CIDADE, AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE);

                /*" -1753- MOVE LE04-CIDADE TO SF05-CIDADE */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE, IMPRESSAO_SAM.SF05_REGISTRO.SF05_CIDADE);

                /*" -1754- MOVE TBI-BAIRRO (1) TO LE04-BAIRRO */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_BAIRRO, AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO);

                /*" -1755- MOVE LE04-BAIRRO TO SF05-BAIRRO */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_BAIRRO);

                /*" -1756- MOVE TBI-UF (1) TO LE04-UF */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_UF, AREA_DE_WORK.LE04_LINHA04.LE04_UF);

                /*" -1757- MOVE LE04-UF TO SF05-UF */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_UF, IMPRESSAO_SAM.SF05_REGISTRO.SF05_UF);

                /*" -1758- MOVE TBI-VIGENCIA (1) TO SF05-VIGENCIA */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_VIGENCIA, IMPRESSAO_SAM.SF05_REGISTRO.SF05_VIGENCIA);

                /*" -1759- MOVE 'XXX.XXX' TO LE01-SEQUENCIA */
                _.Move("XXX.XXX", AREA_DE_WORK.LE01_LINHA01.LE01_SEQUENCIA);

                /*" -1760- MOVE LE01-SEQUENCIA TO SF05-NUMOBJETO */
                _.Move(AREA_DE_WORK.LE01_LINHA01.LE01_SEQUENCIA, IMPRESSAO_SAM.SF05_REGISTRO.SF05_NUMOBJETO);

                /*" -1761- MOVE 'XX/XX/XXXX' TO SF05-DPOSTAGEM */
                _.Move("XX/XX/XXXX", IMPRESSAO_SAM.SF05_REGISTRO.SF05_DPOSTAGEM);

                /*" -1762- MOVE ALL '@' TO SF05-CODIGO-CIF */
                _.MoveAll("@", IMPRESSAO_SAM.SF05_REGISTRO.SF05_CODIGO_CIF);

                /*" -1763- MOVE ALL '#' TO SF05-POSTNET */
                _.MoveAll("#", IMPRESSAO_SAM.SF05_REGISTRO.SF05_POSTNET);

                /*" -1764- ADD 1 TO AC-CONTA */
                AREA_DE_WORK.AC_CONTA.Value = AREA_DE_WORK.AC_CONTA + 1;

                /*" -1765- ADD 1 TO AC-IMPRESSOS */
                AREA_DE_WORK.AC_IMPRESSOS.Value = AREA_DE_WORK.AC_IMPRESSOS + 1;

                /*" -1766- MOVE SF05-REGISTRO TO REG-ATRIBUTOS */
                _.Move(IMPRESSAO_SAM.SF05_REGISTRO, BI6016B1_RECORD.REG_ATRIBUTOS);

                /*" -1767- MOVE TBI-CEP (1) TO WORK-CEP-NUM */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP.TBI_CEP, AREA_DE_WORK.FILLER_65.WORK_CEP_NUM);

                /*" -1768- MOVE TBI-CEP-COMPL (1) TO WORK-CEP-CPL */
                _.Move(TABELA_REGISTROS.TAB_REG[1].TBI_NUM_CEP.TBI_CEP_COMPL, AREA_DE_WORK.FILLER_65.WORK_CEP_CPL);

                /*" -1769- PERFORM R9900-00-GRAVA-OBJETO */

                R9900_00_GRAVA_OBJETO_SECTION();

                /*" -1771- WRITE BI6016B1-RECORD. */
                BI6016B1.Write(BI6016B1_RECORD.GetMoveValues().ToString());
            }


            /*" -1772- IF TAB-REG (2) NOT EQUAL ZEROS */

            if (TABELA_REGISTROS.TAB_REG[2] != 00)
            {

                /*" -1773- MOVE TBI-NUM-CEP-FTE(2) TO REG-NUMCEP */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP_FTE, BI6016B1_RECORD.REG_CEP.REG_NUMCEP);

                /*" -1774- MOVE TBI-COMP-FTE (2) TO REG-CMPCEP */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP_FTE.TBI_COMP_FTE, BI6016B1_RECORD.REG_CEP.REG_CMPCEP);

                /*" -1775- ADD 1 TO ACC-REGISTRO */
                IMPRESSAO_SAM.ACC_REGISTRO.Value = IMPRESSAO_SAM.ACC_REGISTRO + 1;

                /*" -1776- MOVE ACC-REGISTRO TO REG-REGISTRO */
                _.Move(IMPRESSAO_SAM.ACC_REGISTRO, BI6016B1_RECORD.REG_REGISTRO);

                /*" -1777- MOVE 5 TO REG-LINHANR */
                _.Move(5, BI6016B1_RECORD.REG_LINHANR);

                /*" -1778- MOVE TBI-PRODUTO (2) TO REG-PRODUTO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_PRODUTO, BI6016B1_RECORD.REG_PRODUTO);

                /*" -1779- MOVE SPACES TO REG-BRANCO */
                _.Move("", BI6016B1_RECORD.REG_BRANCO);

                /*" -1780- MOVE SPACES TO REG-ATRIBUTOS */
                _.Move("", BI6016B1_RECORD.REG_ATRIBUTOS);

                /*" -1781- MOVE TBI-NOME-RAZAO(2) TO WS-NOME-RAZAO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NOME_RAZAO, AREA_DE_WORK.WS_NOME_RAZAO);

                /*" -1782- PERFORM R2900-00-FORMATA-NOME-RAZAO */

                R2900_00_FORMATA_NOME_RAZAO_SECTION();

                /*" -1783- MOVE WS-NOME-RAZAO TO LC02-NOME-RAZAO */
                _.Move(AREA_DE_WORK.WS_NOME_RAZAO, AREA_DE_WORK.LC02_LINHA02.LC02_NOME_RAZAO);

                /*" -1784- MOVE LC02-NOME-RAZAO TO SF05-SEGURADO */
                _.Move(AREA_DE_WORK.LC02_LINHA02.LC02_NOME_RAZAO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_SEGURADO);

                /*" -1785- MOVE TBI-NUMBIL (2) TO LC02-NUMBIL */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUMBIL, AREA_DE_WORK.LC02_LINHA02.LC02_NUMBIL);

                /*" -1786- MOVE LC02-NUMBIL TO SF05-BILHETE */
                _.Move(AREA_DE_WORK.LC02_LINHA02.LC02_NUMBIL, IMPRESSAO_SAM.SF05_REGISTRO.SF05_BILHETE);

                /*" -1787- MOVE TBI-NOMEFTE (2) TO LC03-NOMEFTE */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NOMEFTE, AREA_DE_WORK.LC03_LINHA03.LC03_NOMEFTE);

                /*" -1788- MOVE LC03-NOMEFTE TO SF05-REMETENTE */
                _.Move(AREA_DE_WORK.LC03_LINHA03.LC03_NOMEFTE, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REMETENTE);

                /*" -1789- MOVE TBI-NOMEFTE (2) TO LE02-NOME-RAZAO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NOMEFTE, AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO);

                /*" -1790- MOVE TBI-NUM-CEP-FTE(2) TO LE05-CEP-NRO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP_FTE, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_NRO);

                /*" -1791- MOVE TBI-COMP-FTE (2) TO LE05-CEP-COMPL */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP_FTE.TBI_COMP_FTE, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_COMPL);

                /*" -1792- MOVE LE05-CEP TO SF05-REM-CEP */
                _.Move(AREA_DE_WORK.LE05_LINHA05.LE05_CEP, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_CEP);

                /*" -1793- MOVE TBI-ENDERFTE (2) TO LE03-ENDERECO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_ENDERFTE, AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO);

                /*" -1794- MOVE LE03-ENDERECO TO SF05-REM-ENDEREC */
                _.Move(AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_ENDEREC);

                /*" -1795- MOVE TBI-CIDADE-FTE (2) TO LE04-CIDADE */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_CIDADE_FTE, AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE);

                /*" -1796- MOVE LE04-CIDADE TO SF05-REM-CIDADE */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_CIDADE);

                /*" -1797- MOVE TBI-BAIRRO-FTE (2) TO LE04-BAIRRO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_BAIRRO_FTE, AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO);

                /*" -1798- MOVE LE04-BAIRRO TO SF05-REM-BAIRRO */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_BAIRRO);

                /*" -1799- MOVE TBI-UF-FTE (2) TO LE04-UF */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_UF_FTE, AREA_DE_WORK.LE04_LINHA04.LE04_UF);

                /*" -1800- MOVE LE04-UF TO SF05-REM-ESTADO */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_UF, IMPRESSAO_SAM.SF05_REGISTRO.SF05_REM_ESTADO);

                /*" -1801- MOVE TBI-NOME-RAZAO(2) TO LE02-NOME-RAZAO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NOME_RAZAO, AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO);

                /*" -1802- MOVE LE02-NOME-RAZAO TO SF05-DESTINATAR */
                _.Move(AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_DESTINATAR);

                /*" -1803- MOVE TBI-CEP (2) TO LE05-CEP-NRO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP.TBI_CEP, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_NRO);

                /*" -1804- MOVE TBI-CEP-COMPL (2) TO LE05-CEP-COMPL */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP.TBI_CEP_COMPL, AREA_DE_WORK.LE05_LINHA05.LE05_CEP.LE05_CEP_COMPL);

                /*" -1805- MOVE LE05-CEP TO SF05-CEP */
                _.Move(AREA_DE_WORK.LE05_LINHA05.LE05_CEP, IMPRESSAO_SAM.SF05_REGISTRO.SF05_CEP);

                /*" -1806- MOVE TBI-ENDERECO (2) TO LE03-ENDERECO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_ENDERECO, AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO);

                /*" -1807- MOVE LE03-ENDERECO TO SF05-ENDERECO */
                _.Move(AREA_DE_WORK.LE03_LINHA03.LE03_ENDERECO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_ENDERECO);

                /*" -1808- MOVE TBI-CIDADE (2) TO LE04-CIDADE */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_CIDADE, AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE);

                /*" -1809- MOVE LE04-CIDADE TO SF05-CIDADE */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_CIDADE, IMPRESSAO_SAM.SF05_REGISTRO.SF05_CIDADE);

                /*" -1810- MOVE TBI-BAIRRO (2) TO LE04-BAIRRO */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_BAIRRO, AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO);

                /*" -1811- MOVE LE04-BAIRRO TO SF05-BAIRRO */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_BAIRRO, IMPRESSAO_SAM.SF05_REGISTRO.SF05_BAIRRO);

                /*" -1812- MOVE TBI-UF (2) TO LE04-UF */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_UF, AREA_DE_WORK.LE04_LINHA04.LE04_UF);

                /*" -1813- MOVE LE04-UF TO SF05-UF */
                _.Move(AREA_DE_WORK.LE04_LINHA04.LE04_UF, IMPRESSAO_SAM.SF05_REGISTRO.SF05_UF);

                /*" -1814- MOVE TBI-VIGENCIA (2) TO SF05-VIGENCIA */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_VIGENCIA, IMPRESSAO_SAM.SF05_REGISTRO.SF05_VIGENCIA);

                /*" -1815- MOVE 'XXX.XXX' TO LE01-SEQUENCIA */
                _.Move("XXX.XXX", AREA_DE_WORK.LE01_LINHA01.LE01_SEQUENCIA);

                /*" -1816- MOVE LE01-SEQUENCIA TO SF05-NUMOBJETO */
                _.Move(AREA_DE_WORK.LE01_LINHA01.LE01_SEQUENCIA, IMPRESSAO_SAM.SF05_REGISTRO.SF05_NUMOBJETO);

                /*" -1817- MOVE 'XX/XX/XXXX' TO SF05-DPOSTAGEM */
                _.Move("XX/XX/XXXX", IMPRESSAO_SAM.SF05_REGISTRO.SF05_DPOSTAGEM);

                /*" -1818- MOVE ALL '@' TO SF05-CODIGO-CIF */
                _.MoveAll("@", IMPRESSAO_SAM.SF05_REGISTRO.SF05_CODIGO_CIF);

                /*" -1819- MOVE ALL '#' TO SF05-POSTNET */
                _.MoveAll("#", IMPRESSAO_SAM.SF05_REGISTRO.SF05_POSTNET);

                /*" -1820- ADD 1 TO AC-CONTA */
                AREA_DE_WORK.AC_CONTA.Value = AREA_DE_WORK.AC_CONTA + 1;

                /*" -1821- ADD 1 TO AC-IMPRESSOS */
                AREA_DE_WORK.AC_IMPRESSOS.Value = AREA_DE_WORK.AC_IMPRESSOS + 1;

                /*" -1822- MOVE SF05-REGISTRO TO REG-ATRIBUTOS */
                _.Move(IMPRESSAO_SAM.SF05_REGISTRO, BI6016B1_RECORD.REG_ATRIBUTOS);

                /*" -1823- MOVE TBI-CEP (2) TO WORK-CEP-NUM */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP.TBI_CEP, AREA_DE_WORK.FILLER_65.WORK_CEP_NUM);

                /*" -1824- MOVE TBI-CEP-COMPL (2) TO WORK-CEP-CPL */
                _.Move(TABELA_REGISTROS.TAB_REG[2].TBI_NUM_CEP.TBI_CEP_COMPL, AREA_DE_WORK.FILLER_65.WORK_CEP_CPL);

                /*" -1825- PERFORM R9900-00-GRAVA-OBJETO */

                R9900_00_GRAVA_OBJETO_SECTION();

                /*" -1825- WRITE BI6016B1-RECORD. */
                BI6016B1.Write(BI6016B1_RECORD.GetMoveValues().ToString());
            }
        ...
        {
            /*" -1849- SUBTRACT 1 FROM WIND1. */
            AREA_DE_WORK.WIND1.Value = AREA_DE_WORK.WIND1 - 1;

            /*" -1850- IF WIND1 LESS 1 */

            if (AREA_DE_WORK.WIND1 < 1)
            {

                /*" -1852- MOVE SPACES TO LC02-NOME-RAZAO LE02-NOME-RAZAO */
                _.Move("", AREA_DE_WORK.LC02_LINHA02.LC02_NOME_RAZAO, AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO);

                /*" -1854- GO TO R2900-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R2900_99_SAIDA*/ //GOTO
                return;
            }


            /*" -1855- IF WS-LETRA-NOME(WIND1) NOT EQUAL SPACES */
            ...
            if (AREA_DE_WORK.WS_NOME_RAZAO.WS_LETRA_NOME[AREA_DE_WORK.WIND1] != string.Empty)
            {
                ...
                /*" -1857- MOVE ',' TO WS-LETRA-NOME(WIND1) */
                _.Move(",", AREA_DE_WORK.WS_NOME_RAZAO.WS_LETRA_NOME[AREA_DE_WORK.WIND1]);

                /*" -1858- MOVE WS-NOME-RAZAO TO LC02-NOME-RAZAO */
                _.Move(AREA_DE_WORK.WS_NOME_RAZAO, AREA_DE_WORK.LC02_LINHA02.LC02_NOME_RAZAO);

                /*" -1859- MOVE ' ' TO WS-LETRA-NOME(WIND1) */
                _.Move(" ", AREA_DE_WORK.WS_NOME_RAZAO.WS_LETRA_NOME[AREA_DE_WORK.WIND1]);

                /*" -1860- MOVE WS-NOME-RAZAO TO LE02-NOME-RAZAO */
                _.Move(AREA_DE_WORK.WS_NOME_RAZAO, AREA_DE_WORK.LE02_LINHA02.LE02_NOME_RAZAO);

                /*" -1862- GO TO R2900-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R2900_99_SAIDA*/ //GOTO
                return;
            }


            /*" -1862- GO TO R2900-10-LOOP. */
        ...
        private void R3000_10_LOOP_OCORR(bool isPerform = false)
        {
            ...
            if (AREA_DE_WORK.WIND > 2000)
            {
                ...
                /*" -1880- WRITE BI6016B2-RECORD FROM LR01-LINHA01 */
                _.Move(AREA_DE_WORK.LR01_LINHA01.GetMoveValues(), BI6016B2_RECORD);

                BI6016B2.Write(BI6016B2_RECORD.GetMoveValues().ToString());

                /*" -1882- GO TO R3000-20-INT. */
            ...
            /*" -1883- IF TAB1-QTD-OBJ (WIND) NOT EQUAL ZEROS */

            if (TABELA_TOTAIS.TAB_TOTAIS[AREA_DE_WORK.WIND].TAB1_QTD_OBJ != 00)
            {

                /*" -1885- ADD 1 TO WS-OCORR. */
            ...
            /*" -1886- GO TO R3000-10-LOOP-OCORR. */
        ...
        private void R3000_30_LOOP_CABEC(bool isPerform = false)
        {
            ...
            if (AREA_DE_WORK.WIND > 2000)
            {
                ...
                /*" -1920- WRITE BI6016B2-RECORD FROM LC99-LINHA99 */
                _.Move(AREA_DE_WORK.LC99_LINHA99.GetMoveValues(), BI6016B2_RECORD);

                BI6016B2.Write(BI6016B2_RECORD.GetMoveValues().ToString());

                /*" -1921- MOVE 80 TO AC-LINHAS */
                _.Move(80, AREA_DE_WORK.AC_LINHAS);

                /*" -1923- GO TO R3000-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R3000_99_SAIDA*/ //GOTO
                return;
            }


            /*" -1924- IF TAB1-QTD-OBJ (WIND) = ZEROS */
        ...
        private void R3000_40_LOOP_DET(bool isPerform = false)
        {
            ...
            if (AREA_DE_WORK.AC_LINHAS > 17)
            {
                ...
                /*" -1980- GO TO R3000-30-LOOP-CABEC */
        ...
        {
            /*" -1993- OPEN OUTPUT BI6016B1. */
            BI6016B1.Open(BI6016B1_RECORD);

            /*" -1993- OPEN OUTPUT BI6016B2. */
            BI6016B2.Open(BI6016B2_RECORD);
        ...
        private void R9800_00_ENCERRA_SEM_MOVTO_SECTION()
        {
            ...
            /*" -2021- DISPLAY '*   BI6016B - CARTA AVISO DE CANCELAMENTO  *' */
            _.Display($"*   BI6016B - CARTA AVISO DE CANCELAMENTO  *");
            ...
            /*" -2024- DISPLAY '*   NAO HOUVE MOVIMENTACAO PARA EMISSAO DE *' */
            _.Display($"*   NAO HOUVE MOVIMENTACAO PARA EMISSAO DE *");

            /*" -2025- DISPLAY '*   CARTA AVISO DE CANCELAMENTO.           *' */
        ...
        {
            /*" -2038- MOVE 'SF05' TO GEOBJECT-COD-FORMULARIO. */
            _.Move("SF05", GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_COD_FORMULARIO);

            /*" -2048- PERFORM R9900_00_GRAVA_OBJETO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -2052- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -2053- PERFORM R9900-01-MONTA-HEADER */

                    R9900_01_MONTA_HEADER_SECTION();

                    /*" -2054- PERFORM R9900-03-INSERT-OBJETO */
                ...
                else
                {
                    ...
                    /*" -2056- DISPLAY 'ERRO DE ACESSO A TABELA GE_OBJETO_ECT.' */
                    _.Display($"ERRO DE ACESSO A TABELA GE_OBJETO_ECT.");

                    /*" -2057- DISPLAY 'SQLCODE............... ' SQLCODE */
            ...
            /*" -2060- PERFORM R9900-02-MONTA-DETALHE */

            R9900_02_MONTA_DETALHE_SECTION();

            /*" -2060- PERFORM R9900-03-INSERT-OBJETO. */
        ...
        {
            /*" -2048- EXEC SQL SELECT DISTINCT STA_REGISTRO INTO :GEOBJECT-STA-REGISTRO FROM SEGUROS.GE_OBJETO_ECT WHERE NUM_CEP = 0 AND NOM_PROGRAMA = 'BI6016B' AND COD_FORMULARIO = :GEOBJECT-COD-FORMULARIO AND STA_REGISTRO = 'H' AND DATE(DTH_TIMESTAMP) <> '9999-12-31' ORDER BY STA_REGISTRO END-EXEC. */
        ...
        {
            /*" -2068- MOVE 0 TO GEOBJECT-NUM-CEP */
            _.Move(0, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_NUM_CEP);

            /*" -2069- MOVE 'H' TO GEOBJECT-STA-REGISTRO */
            _.Move("H", GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_STA_REGISTRO);

            /*" -2070- MOVE -1 TO VIND-PRODUTO */
            _.Move(-1, VIND_PRODUTO);

            /*" -2071- MOVE 0 TO GEOBJECT-NUM-INI-POS-VERSO */
            _.Move(0, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_NUM_INI_POS_VERSO);

            /*" -2072- MOVE 0 TO GEOBJECT-QTD-PESO-GRAMAS */
            _.Move(0, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_QTD_PESO_GRAMAS);

            /*" -2073- MOVE 0 TO GEOBJECT-VLR-DECLARADO */
            _.Move(0, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_VLR_DECLARADO);

            /*" -2074- MOVE SPACES TO GEOBJECT-COD-IDENT-OBJETO */
            _.Move("", GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_COD_IDENT_OBJETO);

            /*" -2075- MOVE 4500 TO GEOBJECT-DES-OBJETO-LEN */
            _.Move(4500, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_DES_OBJETO.GEOBJECT_DES_OBJETO_LEN);

            /*" -2075- MOVE SF05-HEADER TO GEOBJECT-DES-OBJETO-TEXT. */
            _.Move(IMPRESSAO_SAM.SF05_HEADER, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_DES_OBJETO.GEOBJECT_DES_OBJETO_TEXT);
        ...
        {
            /*" -2083- MOVE WORK-CEP TO GEOBJECT-NUM-CEP */
            _.Move(AREA_DE_WORK.WORK_CEP, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_NUM_CEP);

            /*" -2084- MOVE 'D' TO GEOBJECT-STA-REGISTRO */
            _.Move("D", GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_STA_REGISTRO);

            /*" -2085- MOVE REG-PRODUTO TO GEOBJECT-COD-PRODUTO */
            _.Move(BI6016B1_RECORD.REG_PRODUTO, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_COD_PRODUTO);

            /*" -2086- MOVE ZEROS TO VIND-PRODUTO */
            _.Move(0, VIND_PRODUTO);

            /*" -2087- MOVE 0 TO GEOBJECT-NUM-INI-POS-VERSO */
            _.Move(0, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_NUM_INI_POS_VERSO);

            /*" -2088- MOVE 4,6 TO GEOBJECT-QTD-PESO-GRAMAS */
            _.Move(4.6, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_QTD_PESO_GRAMAS);

            /*" -2089- MOVE 0 TO GEOBJECT-VLR-DECLARADO */
            _.Move(0, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_VLR_DECLARADO);

            /*" -2090- MOVE SPACES TO GEOBJECT-COD-IDENT-OBJETO */
            _.Move("", GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_COD_IDENT_OBJETO);

            /*" -2091- MOVE 4500 TO GEOBJECT-DES-OBJETO-LEN. */
            _.Move(4500, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_DES_OBJETO.GEOBJECT_DES_OBJETO_LEN);

            /*" -2091- MOVE SF05-REGISTRO TO GEOBJECT-DES-OBJETO-TEXT. */
            _.Move(IMPRESSAO_SAM.SF05_REGISTRO, GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_DES_OBJETO.GEOBJECT_DES_OBJETO_TEXT);
        ...
        {
            /*" -2111- PERFORM R9900_03_INSERT_OBJETO_DB_INSERT_1 */

            R9900_03_INSERT_OBJETO_DB_INSERT_1();

            /*" -2114- IF SQLCODE NOT EQUAL ZEROS */

            if (DB.SQLCODE != 00)
            {

                /*" -2115- DISPLAY 'ERRO NO INSERT DA GE-OBJETO-ECT ' */
                _.Display($"ERRO NO INSERT DA GE-OBJETO-ECT ");

                /*" -2117- DISPLAY 'H = HEADER D = DETALHE.' GEOBJECT-STA-REGISTRO */
                _.Display($"H = HEADER D = DETALHE.{GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_STA_REGISTRO}");

                /*" -2118- DISPLAY 'PROGRAMA BI6016B.......' */
                _.Display($"PROGRAMA BI6016B.......");

                /*" -2120- DISPLAY 'FORMULARIO............ ' GEOBJECT-COD-FORMULARIO */
                _.Display($"FORMULARIO............ {GEOBJECT.DCLGE_OBJETO_ECT.GEOBJECT_COD_FORMULARIO}");

                /*" -2121- DISPLAY 'SQLCODE............... ' SQLCODE */
                _.Display($"SQLCODE............... {DB.SQLCODE}");
        ...
        {
            /*" -2111- EXEC SQL INSERT INTO SEGUROS.GE_OBJETO_ECT VALUES (:GEOBJECT-NUM-CEP, 'BI6016B' , :GEOBJECT-COD-FORMULARIO, :GEOBJECT-STA-REGISTRO, CURRENT TIMESTAMP, :GEOBJECT-COD-PRODUTO:VIND-PRODUTO, :GEOBJECT-NUM-INI-POS-VERSO, :GEOBJECT-QTD-PESO-GRAMAS, :GEOBJECT-VLR-DECLARADO, :GEOBJECT-COD-IDENT-OBJETO, :GEOBJECT-DES-OBJETO) END-EXEC. */
        ...
        {
            /*" -2136- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, WABEND.WSQLCODE);

            /*" -2138- DISPLAY WABEND */
            _.Display(WABEND);

            /*" -2138- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -2140- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -2144- MOVE 99 TO RETURN-CODE. */
