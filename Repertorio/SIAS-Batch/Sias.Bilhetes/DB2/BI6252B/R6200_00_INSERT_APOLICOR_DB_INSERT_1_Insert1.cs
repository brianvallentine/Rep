...
{
    public class R6200_00_INSERT_APOLICOR_DB_INSERT_1_Insert1 : QueryBasis<R6200_00_INSERT_APOLICOR_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R6200_00_INSERT_APOLICOR_DB_INSERT_1_Insert1 r6200_00_INSERT_APOLICOR_DB_INSERT_1_Insert1)
        {
            var ths = r6200_00_INSERT_APOLICOR_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R6200_00_INSERT_APOLICOR_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
