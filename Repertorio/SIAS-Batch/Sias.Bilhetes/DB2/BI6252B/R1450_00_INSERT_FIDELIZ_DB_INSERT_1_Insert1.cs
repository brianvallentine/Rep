...
{
    public class R1450_00_INSERT_FIDELIZ_DB_INSERT_1_Insert1 : QueryBasis<R1450_00_INSERT_FIDELIZ_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :PROPOFID-DATA-NASC-CONJUGE
            :VIND-DTNASC-ESPOSA,
            :PROPOFID-PROFISSAO-CONJUGE
            :VIND-CBO-CONJ,
            :PROPOFID-FAIXA-RENDA-IND,
            :PROPOFID-FAIXA-RENDA-FAM,
            NULL,
        ...
        public static void Execute(R1450_00_INSERT_FIDELIZ_DB_INSERT_1_Insert1 r1450_00_INSERT_FIDELIZ_DB_INSERT_1_Insert1)
        {
            var ths = r1450_00_INSERT_FIDELIZ_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1450_00_INSERT_FIDELIZ_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
