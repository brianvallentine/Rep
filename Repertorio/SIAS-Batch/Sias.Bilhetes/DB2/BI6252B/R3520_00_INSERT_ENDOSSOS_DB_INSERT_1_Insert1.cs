...
{
    public class R3520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1 : QueryBasis<R3520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string VIND_CORRECAO { get; set; }
        public string ENDOSSOS_ISENTA_CUSTO { get; set; }
        public string VIND_ISENTA { get; set; }
        ...
        public string VIND_PREFIX { get; set; }
        public string ENDOSSOS_VAL_CUSTO_EMISSAO { get; set; }
        public string VIND_CUSEMIS { get; set; }

        public static void Execute(R3520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1 r3520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1)
        {
            var ths = r3520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
