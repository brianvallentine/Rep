...
{
    public class R5100_00_INSERT_MOVDEBCE_DB_INSERT_1_Insert1 : QueryBasis<R5100_00_INSERT_MOVDEBCE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            CURRENT TIMESTAMP ,
            :MOVDEBCE-DIA-DEBITO:VIND-DIADEB ,
            :MOVDEBCE-COD-AGENCIA-DEB:VIND-AGEDEB ,
            :MOVDEBCE-OPER-CONTA-DEB:VIND-OPEDEB ,
            :MOVDEBCE-NUM-CONTA-DEB:VIND-CTADEB ,
            :MOVDEBCE-DIG-CONTA-DEB:VIND-DIGDEB ,
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.MOVTO_DEBITOCC_CEF (COD_EMPRESA , NUM_APOLICE , NUM_ENDOSSO , NUM_PARCELA , SITUACAO_COBRANCA , DATA_VENCIMENTO , VALOR_DEBITO , DATA_MOVIMENTO , TIMESTAMP , DIA_DEBITO , COD_AGENCIA_DEB , OPER_CONTA_DEB , NUM_CONTA_DEB , DIG_CONTA_DEB , COD_CONVENIO , DATA_ENVIO , DATA_RETORNO , COD_RETORNO_CEF , NSAS , COD_USUARIO , NUM_REQUISICAO , NUM_CARTAO , SEQUENCIA , NUM_LOTE , DTCREDITO , STATUS_CARTAO , VLR_CREDITO , NUM_CERTIFICADO) VALUES ({FieldThreatment(this.MOVDEBCE_COD_EMPRESA)} , {FieldThreatment(this.MOVDEBCE_NUM_APOLICE)} , {FieldThreatment(this.MOVDEBCE_NUM_ENDOSSO)} , {FieldThreatment(this.MOVDEBCE_NUM_PARCELA)} , {FieldThreatment(this.MOVDEBCE_SITUACAO_COBRANCA)} , {FieldThreatment(this.MOVDEBCE_DATA_VENCIMENTO)} , {FieldThreatment(this.MOVDEBCE_VALOR_DEBITO)} , {FieldThreatment(this.MOVDEBCE_DATA_MOVIMENTO)} , CURRENT TIMESTAMP ,  {FieldThreatment((this.VIND_DIADEB?.ToInt() == -1 ? null : this.MOVDEBCE_DIA_DEBITO))} ,  {FieldThreatment((this.VIND_AGEDEB?.ToInt() == -1 ? null : this.MOVDEBCE_COD_AGENCIA_DEB))} ,  {FieldThreatment((this.VIND_OPEDEB?.ToInt() == -1 ? null : this.MOVDEBCE_OPER_CONTA_DEB))} ,  {FieldThreatment((this.VIND_CTADEB?.ToInt() == -1 ? null : this.MOVDEBCE_NUM_CONTA_DEB))} ,  {FieldThreatment((this.VIND_DIGDEB?.ToInt() == -1 ? null : this.MOVDEBCE_DIG_CONTA_DEB))} , {FieldThreatment(this.MOVDEBCE_COD_CONVENIO)} ,  {FieldThreatment((this.VIND_DTENVIO?.ToInt() == -1 ? null : this.MOVDEBCE_DATA_ENVIO))} ,  {FieldThreatment((this.VIND_DTRETORNO?.ToInt() == -1 ? null : this.MOVDEBCE_DATA_RETORNO))} ,  {FieldThreatment((this.VIND_CODRET?.ToInt() == -1 ? null : this.MOVDEBCE_COD_RETORNO_CEF))} , {FieldThreatment(this.MOVDEBCE_NSAS)} ,  {FieldThreatment((this.VIND_USUARIO?.ToInt() == -1 ? null : this.MOVDEBCE_COD_USUARIO))} ,  {FieldThreatment((this.VIND_REQUISICAO?.ToInt() == -1 ? null : this.MOVDEBCE_NUM_REQUISICAO))} ,  {FieldThreatment((this.VIND_CARTAO?.ToInt() == -1 ? null : this.MOVDEBCE_NUM_CARTAO))} ,  {FieldThreatment((this.VIND_SEQUENCIA?.ToInt() == -1 ? null : this.MOVDEBCE_SEQUENCIA))} ,  {FieldThreatment((this.VIND_LOTE?.ToInt() == -1 ? null : this.MOVDEBCE_NUM_LOTE))} ,  {FieldThreatment((this.VIND_DTCREDITO?.ToInt() == -1 ? null : this.MOVDEBCE_DTCREDITO))} ,  {FieldThreatment((this.VIND_STATUS?.ToInt() == -1 ? null : this.MOVDEBCE_STATUS_CARTAO))} ,  {FieldThreatment((this.VIND_VLCREDITO?.ToInt() == -1 ? null : this.MOVDEBCE_VLR_CREDITO))} , {FieldThreatment(this.MOVDEBCE_NUM_CERTIFICADO)} )";
        ...
        public string VIND_LOTE { get; set; }
        ...
        public static void Execute(R5100_00_INSERT_MOVDEBCE_DB_INSERT_1_Insert1 r5100_00_INSERT_MOVDEBCE_DB_INSERT_1_Insert1)
        {
            var ths = r5100_00_INSERT_MOVDEBCE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5100_00_INSERT_MOVDEBCE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
