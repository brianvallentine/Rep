...
{
    public class BI0005B_V1COSSEGPROD : QueryBasis<BI0005B_V1COSSEGPROD>
    {
        ...
        public BI0005B_V1COSSEGPROD() { IsCursor = true; }

        public BI0005B_V1COSSEGPROD(bool justACursor)
        {
        ...
        public override BI0005B_V1COSSEGPROD OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0005B_V1COSSEGPROD();
            var i = 0;
