...
{
    public class BI0005B_V0BILHETE : QueryBasis<BI0005B_V0BILHETE>
    {
        ...
        public BI0005B_V0BILHETE() { IsCursor = true; }

        public BI0005B_V0BILHETE(bool justACursor)
        {
        ...
        public override BI0005B_V0BILHETE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0005B_V0BILHETE();
            var i = 0;
