    ...
    public class R1500_00_INSERT_GELIMRISCO_DB_INSERT_1_Insert1 : QueryBasis<R1500_00_INSERT_GELIMRISCO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.GE_LIMITE_DE_RISCO VALUES ({FieldThreatment(this.V0CLIE_CGCCPF)} , 14 , {FieldThreatment(this.GELMR_QTD_SEGUROS)} , {FieldThreatment(this.GELMR_VLR_SOMA_IS)} , CURRENT DATE , 'BI0005B' , CURRENT TIMESTAMP)";
