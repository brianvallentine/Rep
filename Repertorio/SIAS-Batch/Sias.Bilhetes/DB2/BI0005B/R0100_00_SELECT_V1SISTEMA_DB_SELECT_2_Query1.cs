...
namespace Sias.Bilhetes.DB2.BI0005B
{
    public class R0100_00_SELECT_V1SISTEMA_DB_SELECT_2_Query1 : QueryBasis<R0100_00_SELECT_V1SISTEMA_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            SELECT DTMOVABE,CURRENT TIMESTAMP
            INTO :V1SIST-DTMOVACB, :V1SIST-TIMESTAMP
        ...
        public string V1SIST_TIMESTAMP { get; set; }
        ...
        public override R0100_00_SELECT_V1SISTEMA_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.V1SIST_TIMESTAMP = result[i++].Value?.ToString();
            return dta;
        }
