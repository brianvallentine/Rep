...
{
    public class BI0005B_V1RCAPCOMP : QueryBasis<BI0005B_V1RCAPCOMP>
    {
        ...
        public BI0005B_V1RCAPCOMP() { IsCursor = true; }

        public BI0005B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override BI0005B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0005B_V1RCAPCOMP();
            var i = 0;
