...
{
    public class BI2002B_V0MOVIMCOB : QueryBasis<BI2002B_V0MOVIMCOB>
    {
        ...
        public BI2002B_V0MOVIMCOB() { IsCursor = true; }

        public BI2002B_V0MOVIMCOB(bool justACursor)
        {
        ...
        public override BI2002B_V0MOVIMCOB OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI2002B_V0MOVIMCOB();
            var i = 0;
