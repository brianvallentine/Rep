...
{
    public class R0610_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1 : QueryBasis<R0610_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0610_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1 r0610_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1)
        {
            var ths = r0610_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0610_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
