...
{
    public class BI7401B_V1RELATORI : QueryBasis<BI7401B_V1RELATORI>
    {
        ...
        public BI7401B_V1RELATORI() { IsCursor = true; }

        public BI7401B_V1RELATORI(bool justACursor)
        {
        ...
        public override BI7401B_V1RELATORI OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI7401B_V1RELATORI();
            var i = 0;
