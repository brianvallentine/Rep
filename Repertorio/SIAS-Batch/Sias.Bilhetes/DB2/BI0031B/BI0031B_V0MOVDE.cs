...
{
    public class BI0031B_V0MOVDE : QueryBasis<BI0031B_V0MOVDE>
    {
        ...
        public BI0031B_V0MOVDE() { IsCursor = true; }

        public BI0031B_V0MOVDE(bool justACursor)
        {
        ...
        public override BI0031B_V0MOVDE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0031B_V0MOVDE();
            var i = 0;
