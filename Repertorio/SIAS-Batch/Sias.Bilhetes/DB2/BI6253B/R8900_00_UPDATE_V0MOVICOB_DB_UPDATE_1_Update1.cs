...
namespace Sias.Bilhetes.DB2.BI6253B
{
    public class R8900_00_UPDATE_V0MOVICOB_DB_UPDATE_1_Update1 : QueryBasis<R8900_00_UPDATE_V0MOVICOB_DB_UPDATE_1_Update1>
    {
        ...
        private BI6253B_V0MOVIMCOB CurrentOf { get; set; }

        public R8900_00_UPDATE_V0MOVICOB_DB_UPDATE_1_Update1(BI6253B_V0MOVIMCOB currentOf)
        {
            CurrentOf = currentOf;
        }
        ...
        string GetQuery()
        {
            var query = @$"
				...
				WHERE
				(
					SIT_REGISTRO IN ( '0', '*', '4' ) AND TIPO_MOVIMENTO = 'Y'
				)
