...
{
    public class BI1466B_CESCNEG : QueryBasis<BI1466B_CESCNEG>
    {
        ...
        public BI1466B_CESCNEG() { IsCursor = true; }

        public BI1466B_CESCNEG(bool justACursor)
        {
        ...
        public override BI1466B_CESCNEG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI1466B_CESCNEG();
            var i = 0;
