...
{
    public class BI8005B_V1COSSEGPROD : QueryBasis<BI8005B_V1COSSEGPROD>
    {
        ...
        public BI8005B_V1COSSEGPROD() { IsCursor = true; }

        public BI8005B_V1COSSEGPROD(bool justACursor)
        {
        ...
        public override BI8005B_V1COSSEGPROD OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI8005B_V1COSSEGPROD();
            var i = 0;
