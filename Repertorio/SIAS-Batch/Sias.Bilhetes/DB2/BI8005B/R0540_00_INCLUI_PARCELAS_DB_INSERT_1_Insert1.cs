...
{
    public class R0540_00_INCLUI_PARCELAS_DB_INSERT_1_Insert1 : QueryBasis<R0540_00_INCLUI_PARCELAS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0540_00_INCLUI_PARCELAS_DB_INSERT_1_Insert1 r0540_00_INCLUI_PARCELAS_DB_INSERT_1_Insert1)
        {
            var ths = r0540_00_INCLUI_PARCELAS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0540_00_INCLUI_PARCELAS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
