...
{
    public class R0530_00_INCLUI_ENDOSSO_DB_INSERT_1_Insert1 : QueryBasis<R0530_00_INCLUI_ENDOSSO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0530_00_INCLUI_ENDOSSO_DB_INSERT_1_Insert1 r0530_00_INCLUI_ENDOSSO_DB_INSERT_1_Insert1)
        {
            var ths = r0530_00_INCLUI_ENDOSSO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0530_00_INCLUI_ENDOSSO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
