...
{
    public class R0500_00_TRATA_APOLICE_DB_INSERT_1_Insert1 : QueryBasis<R0500_00_TRATA_APOLICE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0500_00_TRATA_APOLICE_DB_INSERT_1_Insert1 r0500_00_TRATA_APOLICE_DB_INSERT_1_Insert1)
        {
            var ths = r0500_00_TRATA_APOLICE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0500_00_TRATA_APOLICE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
