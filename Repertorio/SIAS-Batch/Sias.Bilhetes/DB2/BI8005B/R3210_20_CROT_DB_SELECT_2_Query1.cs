...
{
    public class R3210_20_CROT_DB_SELECT_2_Query1 : QueryBasis<R3210_20_CROT_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3210_20_CROT_DB_SELECT_2_Query1 Execute(R3210_20_CROT_DB_SELECT_2_Query1 r3210_20_CROT_DB_SELECT_2_Query1)
        {
            var ths = r3210_20_CROT_DB_SELECT_2_Query1;
        ...
        public override R3210_20_CROT_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3210_20_CROT_DB_SELECT_2_Query1();
            var i = 0;
