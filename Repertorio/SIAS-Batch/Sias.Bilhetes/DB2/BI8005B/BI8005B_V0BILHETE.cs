...
{
    public class BI8005B_V0BILHETE : QueryBasis<BI8005B_V0BILHETE>
    {
        ...
        public BI8005B_V0BILHETE() { IsCursor = true; }

        public BI8005B_V0BILHETE(bool justACursor)
        {
        ...
        public override BI8005B_V0BILHETE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI8005B_V0BILHETE();
            var i = 0;
