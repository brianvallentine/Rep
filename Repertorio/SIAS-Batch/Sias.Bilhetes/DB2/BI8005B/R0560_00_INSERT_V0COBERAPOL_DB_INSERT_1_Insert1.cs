...
{
    public class R0560_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1 : QueryBasis<R0560_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0560_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1 r0560_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1)
        {
            var ths = r0560_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0560_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
