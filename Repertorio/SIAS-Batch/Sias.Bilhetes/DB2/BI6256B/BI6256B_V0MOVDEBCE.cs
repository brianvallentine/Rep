...
{
    public class BI6256B_V0MOVDEBCE : QueryBasis<BI6256B_V0MOVDEBCE>
    {
        ...
        public BI6256B_V0MOVDEBCE() { IsCursor = true; }

        public BI6256B_V0MOVDEBCE(bool justACursor)
        {
        ...
        public override BI6256B_V0MOVDEBCE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI6256B_V0MOVDEBCE();
            var i = 0;
