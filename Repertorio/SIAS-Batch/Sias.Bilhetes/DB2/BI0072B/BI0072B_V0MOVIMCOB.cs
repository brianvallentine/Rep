...
{
    public class BI0072B_V0MOVIMCOB : QueryBasis<BI0072B_V0MOVIMCOB>
    {
        ...
        public BI0072B_V0MOVIMCOB() { IsCursor = true; }

        public BI0072B_V0MOVIMCOB(bool justACursor)
        {
        ...
        public override BI0072B_V0MOVIMCOB OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0072B_V0MOVIMCOB();
            var i = 0;
