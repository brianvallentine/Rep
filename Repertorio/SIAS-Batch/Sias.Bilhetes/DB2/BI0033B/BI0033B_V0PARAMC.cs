...
{
    public class BI0033B_V0PARAMC : QueryBasis<BI0033B_V0PARAMC>
    {
        ...
        public BI0033B_V0PARAMC() { IsCursor = true; }

        public BI0033B_V0PARAMC(bool justACursor)
        {
        ...
        public override BI0033B_V0PARAMC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0033B_V0PARAMC();
            var i = 0;
