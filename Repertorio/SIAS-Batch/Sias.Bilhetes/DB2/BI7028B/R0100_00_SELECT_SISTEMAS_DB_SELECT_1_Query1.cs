...
namespace Sias.Bilhetes.DB2.BI7028B
{
    public class R0100_00_SELECT_SISTEMAS_DB_SELECT_1_Query1 : QueryBasis<R0100_00_SELECT_SISTEMAS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            DATA_MOV_ABERTO - 1 YEAR,
            DATA_MOV_ABERTO - 5 DAY ,
            CURRENT DATE
            INTO :SISTEMAS-DATA-MOV-ABERTO,
            :SISTEMAS-DATA-MOV-ABERTO-1,
            :SISTEMAS-DATA-MOV-5DIA,
            :WS-DATA-ATUAL
        ...
        public string SISTEMAS_DATA_MOV_5DIA { get; set; }
        public string WS_DATA_ATUAL { get; set; }
        ...
        public override R0100_00_SELECT_SISTEMAS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.SISTEMAS_DATA_MOV_5DIA = result[i++].Value?.ToString();
            dta.WS_DATA_ATUAL = result[i++].Value?.ToString();
            return dta;
        }
