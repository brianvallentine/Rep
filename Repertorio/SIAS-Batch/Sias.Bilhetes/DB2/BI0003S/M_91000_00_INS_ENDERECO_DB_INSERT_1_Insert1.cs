...
{
    public class M_91000_00_INS_ENDERECO_DB_INSERT_1_Insert1 : QueryBasis<M_91000_00_INS_ENDERECO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(M_91000_00_INS_ENDERECO_DB_INSERT_1_Insert1 m_91000_00_INS_ENDERECO_DB_INSERT_1_Insert1)
        {
            var ths = m_91000_00_INS_ENDERECO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_91000_00_INS_ENDERECO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
