    ...
    public class R9900_03_INSERT_OBJETO_DB_INSERT_1_Insert1 : QueryBasis<R9900_03_INSERT_OBJETO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.GE_OBJETO_ECT VALUES ({FieldThreatment(this.GEOBJECT_NUM_CEP)}, 'BI6017B' , {FieldThreatment(this.GEOBJECT_COD_FORMULARIO)}, {FieldThreatment(this.GEOBJECT_STA_REGISTRO)}, CURRENT TIMESTAMP,  {FieldThreatment((this.VIND_PRODUTO?.ToInt() == -1 ? null : this.GEOBJECT_COD_PRODUTO))}, {FieldThreatment(this.GEOBJECT_NUM_INI_POS_VERSO)}, {FieldThreatment(this.GEOBJECT_QTD_PESO_GRAMAS)}, {FieldThreatment(this.GEOBJECT_VLR_DECLARADO)}, {FieldThreatment(this.GEOBJECT_COD_IDENT_OBJETO)}, {FieldThreatment(this.GEOBJECT_DES_OBJETO)})";
