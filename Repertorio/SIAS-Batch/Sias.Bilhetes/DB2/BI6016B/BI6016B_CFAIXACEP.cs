...
{
    public class BI6016B_CFAIXACEP : QueryBasis<BI6016B_CFAIXACEP>
    {
        ...
        public BI6016B_CFAIXACEP() { IsCursor = true; }

        public BI6016B_CFAIXACEP(bool justACursor)
        {
        ...
        public override BI6016B_CFAIXACEP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI6016B_CFAIXACEP();
            var i = 0;
