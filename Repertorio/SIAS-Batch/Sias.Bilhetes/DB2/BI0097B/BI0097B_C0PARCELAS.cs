...
{
    public class BI0097B_C0PARCELAS : QueryBasis<BI0097B_C0PARCELAS>
    {
        ...
        public BI0097B_C0PARCELAS() { IsCursor = true; }

        public BI0097B_C0PARCELAS(bool justACursor)
        {
        ...
        public override BI0097B_C0PARCELAS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0097B_C0PARCELAS();
            var i = 0;
