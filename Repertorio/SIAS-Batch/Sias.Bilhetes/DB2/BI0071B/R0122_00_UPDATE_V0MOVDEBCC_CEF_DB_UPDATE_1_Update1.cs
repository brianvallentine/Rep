...
{
    public class R0122_00_UPDATE_V0MOVDEBCC_CEF_DB_UPDATE_1_Update1 : QueryBasis<R0122_00_UPDATE_V0MOVDEBCC_CEF_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R0122_00_UPDATE_V0MOVDEBCC_CEF_DB_UPDATE_1_Update1 r0122_00_UPDATE_V0MOVDEBCC_CEF_DB_UPDATE_1_Update1)
        {
            var ths = r0122_00_UPDATE_V0MOVDEBCC_CEF_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0122_00_UPDATE_V0MOVDEBCC_CEF_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
