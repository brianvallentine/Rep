...
{
    public class BI0071B_V0PARAMC : QueryBasis<BI0071B_V0PARAMC>
    {
        ...
        public BI0071B_V0PARAMC() { IsCursor = true; }

        public BI0071B_V0PARAMC(bool justACursor)
        {
        ...
        public override BI0071B_V0PARAMC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0071B_V0PARAMC();
            var i = 0;
