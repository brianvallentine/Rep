...
{
    public class BI0071B_C01_RESULT : QueryBasis<BI0071B_C01_RESULT>
    {
        ...
        public BI0071B_C01_RESULT() { IsCursor = true; }

        public BI0071B_C01_RESULT(bool justACursor)
        {
        ...
        public override BI0071B_C01_RESULT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0071B_C01_RESULT();
            var i = 0;
