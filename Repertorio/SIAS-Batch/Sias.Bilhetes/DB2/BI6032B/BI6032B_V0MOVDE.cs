...
{
    public class BI6032B_V0MOVDE : QueryBasis<BI6032B_V0MOVDE>
    {
        ...
        public BI6032B_V0MOVDE() { IsCursor = true; }

        public BI6032B_V0MOVDE(bool justACursor)
        {
        ...
        public override BI6032B_V0MOVDE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI6032B_V0MOVDE();
            var i = 0;
