...
{
    public class BI6005B_V0BILHETE : QueryBasis<BI6005B_V0BILHETE>
    {
        ...
        public BI6005B_V0BILHETE() { IsCursor = true; }

        public BI6005B_V0BILHETE(bool justACursor)
        {
        ...
        public override BI6005B_V0BILHETE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI6005B_V0BILHETE();
            var i = 0;
