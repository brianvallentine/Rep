...
{
    public class BI6005B_V1COSSEGPROD : QueryBasis<BI6005B_V1COSSEGPROD>
    {
        ...
        public BI6005B_V1COSSEGPROD() { IsCursor = true; }

        public BI6005B_V1COSSEGPROD(bool justACursor)
        {
        ...
        public override BI6005B_V1COSSEGPROD OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI6005B_V1COSSEGPROD();
            var i = 0;
