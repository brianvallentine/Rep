...
{
    public class R1050_00_TRATA_FUNDAO_DB_INSERT_2_Insert1 : QueryBasis<R1050_00_TRATA_FUNDAO_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1050_00_TRATA_FUNDAO_DB_INSERT_2_Insert1 r1050_00_TRATA_FUNDAO_DB_INSERT_2_Insert1)
        {
            var ths = r1050_00_TRATA_FUNDAO_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1050_00_TRATA_FUNDAO_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
