...
{
    public class BI6005B_V1RCAPCOMP : QueryBasis<BI6005B_V1RCAPCOMP>
    {
        ...
        public BI6005B_V1RCAPCOMP() { IsCursor = true; }

        public BI6005B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override BI6005B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI6005B_V1RCAPCOMP();
            var i = 0;
