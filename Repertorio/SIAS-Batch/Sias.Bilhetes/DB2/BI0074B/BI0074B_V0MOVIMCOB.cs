...
{
    public class BI0074B_V0MOVIMCOB : QueryBasis<BI0074B_V0MOVIMCOB>
    {
        ...
        public BI0074B_V0MOVIMCOB() { IsCursor = true; }

        public BI0074B_V0MOVIMCOB(bool justACursor)
        {
        ...
        public override BI0074B_V0MOVIMCOB OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0074B_V0MOVIMCOB();
            var i = 0;
