...
{
    public class R1250_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1 : QueryBasis<R1250_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL INSERT
            INTO SEGUROS.CB_CONTR_DEVPREMIO
            (COD_EMPRESA
            ,TIPO_MOVIMENTO
            ,NUM_CHEQUE_INTERNO
            ,DIG_CHEQUE_INTERNO
        ...
        public static void Execute(R1250_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1 r1250_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1)
        {
            var ths = r1250_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1250_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
