...
namespace Sias.Bilhetes.DB2.BI8070B
{
    public class R0260_00_SELECT_APOLCOBR_DB_SELECT_1_Query1 : QueryBasis<R0260_00_SELECT_APOLCOBR_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            ,:APOLCOBR-MARGEM-COMERCIAL:VIND-MARGEM
        ...
        public override R0260_00_SELECT_APOLCOBR_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.APOLCOBR_MARGEM_COMERCIAL = result[i++].Value?.ToString();
            dta.VIND_MARGEM = string.IsNullOrWhiteSpace(dta.APOLCOBR_MARGEM_COMERCIAL) ? "-1" : "0";
            return dta;
        }
