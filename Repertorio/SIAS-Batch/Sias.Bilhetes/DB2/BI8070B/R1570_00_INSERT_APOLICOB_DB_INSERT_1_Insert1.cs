...
{
    public class R1570_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 : QueryBasis<R1570_00_INSERT_APOLICOB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1570_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 r1570_00_INSERT_APOLICOB_DB_INSERT_1_Insert1)
        {
            var ths = r1570_00_INSERT_APOLICOB_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1570_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
