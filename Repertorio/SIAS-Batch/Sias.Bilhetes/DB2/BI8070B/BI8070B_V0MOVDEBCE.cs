...
{
    public class BI8070B_V0MOVDEBCE : QueryBasis<BI8070B_V0MOVDEBCE>
    {
        ...
        public BI8070B_V0MOVDEBCE() { IsCursor = true; }

        public BI8070B_V0MOVDEBCE(bool justACursor)
        {
        ...
        public override BI8070B_V0MOVDEBCE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI8070B_V0MOVDEBCE();
            var i = 0;
