...
{
    public class R1530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1 : QueryBasis<R1530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1 r1530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1)
        {
            var ths = r1530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
