...
{
    public class M_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1 : QueryBasis<M_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1 Execute(M_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1 m_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1)
        {
            var ths = m_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1;
        ...
        public override M_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_15100_00_ACESSA_RCAPS_2_DB_SELECT_1_Query1();
            var i = 0;
