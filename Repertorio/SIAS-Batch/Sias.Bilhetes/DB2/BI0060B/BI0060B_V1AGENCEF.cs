...
{
    public class BI0060B_V1AGENCEF : QueryBasis<BI0060B_V1AGENCEF>
    {
        ...
        public BI0060B_V1AGENCEF() { IsCursor = true; }

        public BI0060B_V1AGENCEF(bool justACursor)
        {
        ...
        public override BI0060B_V1AGENCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new BI0060B_V1AGENCEF();
            var i = 0;
