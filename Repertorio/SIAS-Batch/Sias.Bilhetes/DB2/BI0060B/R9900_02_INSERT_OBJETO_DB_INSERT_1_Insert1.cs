    ...
    public class R9900_02_INSERT_OBJETO_DB_INSERT_1_Insert1 : QueryBasis<R9900_02_INSERT_OBJETO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.GE_OBJETO_ECT ( NUM_CEP , NOM_PROGRAMA , COD_FORMULARIO , STA_REGISTRO , DTH_TIMESTAMP , COD_PRODUTO , NUM_INI_POS_VERSO , QTD_PESO_GRAMAS , VLR_DECLARADO , COD_IDENT_OBJETO , DES_OBJETO ) VALUES ({FieldThreatment(this.GEOBJECT_NUM_CEP)}, 'BI0060B' , 'SF14' , {FieldThreatment(this.GEOBJECT_STA_REGISTRO)}, CURRENT TIMESTAMP,  {FieldThreatment((this.VIND_CODPRODUTO?.ToInt() == -1 ? null : this.GEOBJECT_COD_PRODUTO))}, {FieldThreatment(this.GEOBJECT_NUM_INI_POS_VERSO)}, {FieldThreatment(this.GEOBJECT_QTD_PESO_GRAMAS)}, {FieldThreatment(this.GEOBJECT_VLR_DECLARADO)}, {FieldThreatment(this.GEOBJECT_COD_IDENT_OBJETO)}, {FieldThreatment(this.GEOBJECT_DES_OBJETO)} )";
