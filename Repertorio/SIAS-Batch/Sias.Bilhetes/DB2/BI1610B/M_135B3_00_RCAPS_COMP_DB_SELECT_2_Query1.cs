...
{
    public class M_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1 : QueryBasis<M_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1 Execute(M_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1 m_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1)
        {
            var ths = m_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1;
        ...
        public override M_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_135B3_00_RCAPS_COMP_DB_SELECT_2_Query1();
            var i = 0;
