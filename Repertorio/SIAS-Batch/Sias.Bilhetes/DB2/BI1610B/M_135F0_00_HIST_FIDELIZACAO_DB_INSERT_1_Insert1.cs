...
{
    public class M_135F0_00_HIST_FIDELIZACAO_DB_INSERT_1_Insert1 : QueryBasis<M_135F0_00_HIST_FIDELIZACAO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            VALUES (:PROPFIDH-NUM-IDENTIFICACAO,
        ...
        public static void Execute(M_135F0_00_HIST_FIDELIZACAO_DB_INSERT_1_Insert1 m_135F0_00_HIST_FIDELIZACAO_DB_INSERT_1_Insert1)
        {
            var ths = m_135F0_00_HIST_FIDELIZACAO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_135F0_00_HIST_FIDELIZACAO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
