...
{
    public class VG0122B_RELATORIO : QueryBasis<VG0122B_RELATORIO>
    {
        ...
        public VG0122B_RELATORIO() { IsCursor = true; }

        public VG0122B_RELATORIO(bool justACursor)
        {
        ...
        public override VG0122B_RELATORIO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0122B_RELATORIO();
            var i = 0;
