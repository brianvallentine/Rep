...
{
    public class VG0122B_SEGURADO3 : QueryBasis<VG0122B_SEGURADO3>
    {
        ...
        public VG0122B_SEGURADO3() { IsCursor = true; }

        public VG0122B_SEGURADO3(bool justACursor)
        {
        ...
        public override VG0122B_SEGURADO3 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0122B_SEGURADO3();
            var i = 0;
