...
{
    public class R1140_00_REPASSA_SAF_DB_INSERT_1_Insert1 : QueryBasis<R1140_00_REPASSA_SAF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1140_00_REPASSA_SAF_DB_INSERT_1_Insert1 r1140_00_REPASSA_SAF_DB_INSERT_1_Insert1)
        {
            var ths = r1140_00_REPASSA_SAF_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1140_00_REPASSA_SAF_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
