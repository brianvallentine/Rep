...
{
    public class M_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1 : QueryBasis<M_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1 Execute(M_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1 m_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1)
        {
            var ths = m_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1;
        ...
        public override M_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_420_020_ATUALIZA_CARENCIAS_DB_SELECT_1_Query1();
            var i = 0;
