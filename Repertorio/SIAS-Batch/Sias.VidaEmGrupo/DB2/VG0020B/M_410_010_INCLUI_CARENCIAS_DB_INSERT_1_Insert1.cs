...
{
    public class M_410_010_INCLUI_CARENCIAS_DB_INSERT_1_Insert1 : QueryBasis<M_410_010_INCLUI_CARENCIAS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(M_410_010_INCLUI_CARENCIAS_DB_INSERT_1_Insert1 m_410_010_INCLUI_CARENCIAS_DB_INSERT_1_Insert1)
        {
            var ths = m_410_010_INCLUI_CARENCIAS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_410_010_INCLUI_CARENCIAS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
