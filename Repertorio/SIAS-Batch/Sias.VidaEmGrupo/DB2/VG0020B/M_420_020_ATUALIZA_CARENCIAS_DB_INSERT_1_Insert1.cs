...
{
    public class M_420_020_ATUALIZA_CARENCIAS_DB_INSERT_1_Insert1 : QueryBasis<M_420_020_ATUALIZA_CARENCIAS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(M_420_020_ATUALIZA_CARENCIAS_DB_INSERT_1_Insert1 m_420_020_ATUALIZA_CARENCIAS_DB_INSERT_1_Insert1)
        {
            var ths = m_420_020_ATUALIZA_CARENCIAS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_420_020_ATUALIZA_CARENCIAS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
