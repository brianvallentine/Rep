...
{
    public class VG0020B_TMOVIMENTO : QueryBasis<VG0020B_TMOVIMENTO>
    {
        ...
        public VG0020B_TMOVIMENTO() { IsCursor = true; }

        public VG0020B_TMOVIMENTO(bool justACursor)
        {
        ...
        public override VG0020B_TMOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0020B_TMOVIMENTO();
            var i = 0;
