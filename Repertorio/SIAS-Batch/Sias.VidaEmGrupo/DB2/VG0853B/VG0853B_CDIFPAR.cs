...
{
    public class VG0853B_CDIFPAR : QueryBasis<VG0853B_CDIFPAR>
    {
        ...
        public VG0853B_CDIFPAR() { IsCursor = true; }

        public VG0853B_CDIFPAR(bool justACursor)
        {
        ...
        public override VG0853B_CDIFPAR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0853B_CDIFPAR();
            var i = 0;
