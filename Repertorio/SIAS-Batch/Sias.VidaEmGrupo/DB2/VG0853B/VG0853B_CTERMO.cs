...
{
    public class VG0853B_CTERMO : QueryBasis<VG0853B_CTERMO>
    {
        ...
        public VG0853B_CTERMO() { IsCursor = true; }

        public VG0853B_CTERMO(bool justACursor)
        {
        ...
        public override VG0853B_CTERMO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0853B_CTERMO();
            var i = 0;
