...
{
    public class R1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1 : QueryBasis<R1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1 Execute(R1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1 r1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1)
        {
            var ths = r1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1;
        ...
        public override R1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1100_00_LE_OPCAOPAG_DB_SELECT_1_Query1();
            var i = 0;
