...
{
    public class VG0853B_CPROPVA : QueryBasis<VG0853B_CPROPVA>
    {
        ...
        public VG0853B_CPROPVA() { IsCursor = true; }

        public VG0853B_CPROPVA(bool justACursor)
        {
        ...
        public string V0PROP_STANTECIP { get; set; }
        public string VIND_STANTECIP { get; set; }
        ...
        public override VG0853B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0853B_CPROPVA();
            var i = 0;
            ...
            dta.V0PROP_STANTECIP = result[i++].Value?.ToString();
            dta.VIND_STANTECIP = string.IsNullOrWhiteSpace(dta.V0PROP_STANTECIP) ? "-1" : "0";
