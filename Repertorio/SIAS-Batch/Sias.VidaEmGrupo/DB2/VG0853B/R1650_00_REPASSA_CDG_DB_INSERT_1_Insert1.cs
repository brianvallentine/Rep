...
{
    public class R1650_00_REPASSA_CDG_DB_INSERT_1_Insert1 : QueryBasis<R1650_00_REPASSA_CDG_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1650_00_REPASSA_CDG_DB_INSERT_1_Insert1 r1650_00_REPASSA_CDG_DB_INSERT_1_Insert1)
        {
            var ths = r1650_00_REPASSA_CDG_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1650_00_REPASSA_CDG_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
