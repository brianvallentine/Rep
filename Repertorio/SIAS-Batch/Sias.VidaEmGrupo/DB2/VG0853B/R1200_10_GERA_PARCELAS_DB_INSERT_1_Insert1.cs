...
{
    public class R1200_10_GERA_PARCELAS_DB_INSERT_1_Insert1 : QueryBasis<R1200_10_GERA_PARCELAS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1200_10_GERA_PARCELAS_DB_INSERT_1_Insert1 r1200_10_GERA_PARCELAS_DB_INSERT_1_Insert1)
        {
            var ths = r1200_10_GERA_PARCELAS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1200_10_GERA_PARCELAS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
