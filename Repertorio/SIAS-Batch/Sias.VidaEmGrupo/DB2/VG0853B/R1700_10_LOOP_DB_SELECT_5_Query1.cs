...
{
    public class R1700_10_LOOP_DB_SELECT_5_Query1 : QueryBasis<R1700_10_LOOP_DB_SELECT_5_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1700_10_LOOP_DB_SELECT_5_Query1 Execute(R1700_10_LOOP_DB_SELECT_5_Query1 r1700_10_LOOP_DB_SELECT_5_Query1)
        {
            var ths = r1700_10_LOOP_DB_SELECT_5_Query1;
        ...
        public override R1700_10_LOOP_DB_SELECT_5_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1700_10_LOOP_DB_SELECT_5_Query1();
            var i = 0;
