...
{
    public class R310_00_INSE_ARG_SIVPF_DB_INSERT_1_Insert1 : QueryBasis<R310_00_INSE_ARG_SIVPF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R310_00_INSE_ARG_SIVPF_DB_INSERT_1_Insert1 r310_00_INSE_ARG_SIVPF_DB_INSERT_1_Insert1)
        {
            var ths = r310_00_INSE_ARG_SIVPF_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R310_00_INSE_ARG_SIVPF_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
