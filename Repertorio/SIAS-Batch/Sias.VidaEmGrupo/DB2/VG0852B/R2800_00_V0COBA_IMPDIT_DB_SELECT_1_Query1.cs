...
{
    public class R2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1 : QueryBasis<R2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1 Execute(R2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1 r2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1)
        {
            var ths = r2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1;
        ...
        public override R2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2800_00_V0COBA_IMPDIT_DB_SELECT_1_Query1();
            var i = 0;
