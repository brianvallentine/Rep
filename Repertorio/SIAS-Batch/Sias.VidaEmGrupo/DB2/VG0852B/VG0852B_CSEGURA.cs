...
{
    public class VG0852B_CSEGURA : QueryBasis<VG0852B_CSEGURA>
    {
        ...
        public VG0852B_CSEGURA() { IsCursor = true; }

        public VG0852B_CSEGURA(bool justACursor)
        {
        ...
        public override VG0852B_CSEGURA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0852B_CSEGURA();
            var i = 0;
