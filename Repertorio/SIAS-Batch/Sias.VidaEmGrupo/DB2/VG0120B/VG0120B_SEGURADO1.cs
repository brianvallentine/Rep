...
{
    public class VG0120B_SEGURADO1 : QueryBasis<VG0120B_SEGURADO1>
    {
        ...
        public VG0120B_SEGURADO1() { IsCursor = true; }

        public VG0120B_SEGURADO1(bool justACursor)
        {
        ...
        public override VG0120B_SEGURADO1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0120B_SEGURADO1();
            var i = 0;
