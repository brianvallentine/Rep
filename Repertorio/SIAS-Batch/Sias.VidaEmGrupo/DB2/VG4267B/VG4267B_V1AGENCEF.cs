...
{
    public class VG4267B_V1AGENCEF : QueryBasis<VG4267B_V1AGENCEF>
    {
        ...
        public VG4267B_V1AGENCEF() { IsCursor = true; }

        public VG4267B_V1AGENCEF(bool justACursor)
        {
        ...
        public override VG4267B_V1AGENCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG4267B_V1AGENCEF();
            var i = 0;
