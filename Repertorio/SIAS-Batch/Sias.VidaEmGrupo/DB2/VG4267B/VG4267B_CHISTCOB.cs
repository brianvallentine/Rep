...
{
    public class VG4267B_CHISTCOB : QueryBasis<VG4267B_CHISTCOB>
    {
        ...
        public VG4267B_CHISTCOB() { IsCursor = true; }

        public VG4267B_CHISTCOB(bool justACursor)
        {
        ...
        public override VG4267B_CHISTCOB OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG4267B_CHISTCOB();
            var i = 0;
