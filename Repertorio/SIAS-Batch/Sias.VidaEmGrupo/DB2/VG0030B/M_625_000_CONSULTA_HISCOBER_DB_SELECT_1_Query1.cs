...
{
    public class M_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1 : QueryBasis<M_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1 Execute(M_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1 m_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1)
        {
            var ths = m_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1;
        ...
        public override M_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_625_000_CONSULTA_HISCOBER_DB_SELECT_1_Query1();
            var i = 0;
