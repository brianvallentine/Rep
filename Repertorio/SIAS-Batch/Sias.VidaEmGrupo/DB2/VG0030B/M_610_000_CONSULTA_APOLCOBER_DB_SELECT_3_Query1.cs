...
{
    public class M_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1 : QueryBasis<M_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1 Execute(M_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1 m_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1)
        {
            var ths = m_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1;
        ...
        public override M_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_610_000_CONSULTA_APOLCOBER_DB_SELECT_3_Query1();
            var i = 0;
