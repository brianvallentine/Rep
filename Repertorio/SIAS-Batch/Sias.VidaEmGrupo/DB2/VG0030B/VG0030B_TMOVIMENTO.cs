...
{
    public class VG0030B_TMOVIMENTO : QueryBasis<VG0030B_TMOVIMENTO>
    {
        ...
        public VG0030B_TMOVIMENTO() { IsCursor = true; }

        public VG0030B_TMOVIMENTO(bool justACursor)
        {
        ...
        public override VG0030B_TMOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0030B_TMOVIMENTO();
            var i = 0;
