...
{
    public class VG0121B_RELATORIO : QueryBasis<VG0121B_RELATORIO>
    {
        ...
        public VG0121B_RELATORIO() { IsCursor = true; }

        public VG0121B_RELATORIO(bool justACursor)
        {
        ...
        public override VG0121B_RELATORIO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0121B_RELATORIO();
            var i = 0;
