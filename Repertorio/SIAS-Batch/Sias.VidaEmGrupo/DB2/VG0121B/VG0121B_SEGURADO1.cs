...
{
    public class VG0121B_SEGURADO1 : QueryBasis<VG0121B_SEGURADO1>
    {
        ...
        public VG0121B_SEGURADO1() { IsCursor = true; }

        public VG0121B_SEGURADO1(bool justACursor)
        {
        ...
        public override VG0121B_SEGURADO1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0121B_SEGURADO1();
            var i = 0;
