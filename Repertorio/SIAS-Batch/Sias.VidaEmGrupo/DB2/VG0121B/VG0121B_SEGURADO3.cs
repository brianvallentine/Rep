...
{
    public class VG0121B_SEGURADO3 : QueryBasis<VG0121B_SEGURADO3>
    {
        ...
        public VG0121B_SEGURADO3() { IsCursor = true; }

        public VG0121B_SEGURADO3(bool justACursor)
        {
        ...
        public override VG0121B_SEGURADO3 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0121B_SEGURADO3();
            var i = 0;
