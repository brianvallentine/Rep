...
{
    public class VP0105B_TFUNCIOSUR : QueryBasis<VP0105B_TFUNCIOSUR>
    {
        ...
        public VP0105B_TFUNCIOSUR() { IsCursor = true; }

        public VP0105B_TFUNCIOSUR(bool justACursor)
        {
        ...
        public override VP0105B_TFUNCIOSUR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0105B_TFUNCIOSUR();
            var i = 0;
