...
{
    public class VG0133B_TSEGURAVG : QueryBasis<VG0133B_TSEGURAVG>
    {
        ...
        public VG0133B_TSEGURAVG() { IsCursor = true; }

        public VG0133B_TSEGURAVG(bool justACursor)
        {
        ...
        public override VG0133B_TSEGURAVG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0133B_TSEGURAVG();
            var i = 0;
