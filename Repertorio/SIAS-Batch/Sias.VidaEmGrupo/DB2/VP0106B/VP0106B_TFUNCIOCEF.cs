...
{
    public class VP0106B_TFUNCIOCEF : QueryBasis<VP0106B_TFUNCIOCEF>
    {
        ...
        public VP0106B_TFUNCIOCEF() { IsCursor = true; }

        public VP0106B_TFUNCIOCEF(bool justACursor)
        {
        ...
        public override VP0106B_TFUNCIOCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0106B_TFUNCIOCEF();
            var i = 0;
