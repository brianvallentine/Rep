...
{
    public class VP0106B_TFUNCIOSUR : QueryBasis<VP0106B_TFUNCIOSUR>
    {
        ...
        public VP0106B_TFUNCIOSUR() { IsCursor = true; }

        public VP0106B_TFUNCIOSUR(bool justACursor)
        {
        ...
        public override VP0106B_TFUNCIOSUR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0106B_TFUNCIOSUR();
            var i = 0;
