...
{
    public class VG0100B_CMOVTO2 : QueryBasis<VG0100B_CMOVTO2>
    {
        ...
        public VG0100B_CMOVTO2() { IsCursor = true; }

        public VG0100B_CMOVTO2(bool justACursor)
        {
        ...
        public override VG0100B_CMOVTO2 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0100B_CMOVTO2();
            var i = 0;
