...
{
    public class VG0100B_MOVIMENTO : QueryBasis<VG0100B_MOVIMENTO>
    {
        ...
        public VG0100B_MOVIMENTO() { IsCursor = true; }

        public VG0100B_MOVIMENTO(bool justACursor)
        {
        ...
        public override VG0100B_MOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0100B_MOVIMENTO();
            var i = 0;
