...
{
    public class M_6510_ATUALIZA_MOV_DB_UPDATE_1_Update1 : QueryBasis<M_6510_ATUALIZA_MOV_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(M_6510_ATUALIZA_MOV_DB_UPDATE_1_Update1 m_6510_ATUALIZA_MOV_DB_UPDATE_1_Update1)
        {
            var ths = m_6510_ATUALIZA_MOV_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_6510_ATUALIZA_MOV_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
