...
{
    public class VG0100B_V1FATURAST : QueryBasis<VG0100B_V1FATURAST>
    {
        ...
        public VG0100B_V1FATURAST() { IsCursor = true; }

        public VG0100B_V1FATURAST(bool justACursor)
        {
        ...
        public override VG0100B_V1FATURAST OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0100B_V1FATURAST();
            var i = 0;
