...
{
    public class M_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1 : QueryBasis<M_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            SELECT VALUE(MAX(C.NUM_FAIXA_FINAL), 18)
            INTO :WS-MAX-IDADE
            ...
            */
            #endregion
            var query = @$"
				SELECT VALUE(MAX(C.NUM_FAIXA_FINAL)
							, 18)
											FROM SEGUROS.VG_APOLICE_COB_GAR A
							,
											SEGUROS.VG_GRUPO_COB_CS_ETARIA B
        ...
        public string WS_MAX_IDADE { get; set; }
        public string WS_COD_SUBGRUPO_GAR { get; set; }
        public string WS_NUM_APOLICE_GAR { get; set; }
        public string WS_PRODUTO { get; set; }

        public static M_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1 Execute(M_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1 m_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1)
        {
            var ths = m_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1;
        ...
        public override M_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_0505_LER_MAX_IDADE_VLR_CS_491_DB_SELECT_1_Query1();
            var i = 0;
            dta.WS_MAX_IDADE = result[i++].Value?.ToString();
            return dta;
        }
