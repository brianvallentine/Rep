...
{
    public class VG0031B_V0RELATORIOS : QueryBasis<VG0031B_V0RELATORIOS>
    {
        ...
        public VG0031B_V0RELATORIOS() { IsCursor = true; }

        public VG0031B_V0RELATORIOS(bool justACursor)
        {
        ...
        public string V1REL_APOL_RAMO { get; set; }
        ...
        public override VG0031B_V0RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0031B_V0RELATORIOS();
            var i = 0;

            dta.V1REL_COD_USUR = result[i++].Value?.ToString();
            dta.V1REL_CODRELAT = result[i++].Value?.ToString();
            ...
            dta.V1REL_APOL_RAMO = result[i++].Value?.ToString();
