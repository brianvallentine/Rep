...
{
    public class R0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1 : QueryBasis<R0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND :V0PARC-DTVENCTO BETWEEN DTINIVIG
            AND DTTERVIG
            ORDER BY NRCERTIF,
            DTINIVIG
            ...
            var query = @$"
				SELECT
							...
							,
											...
											AND '{this.V0PARC_DTVENCTO}' BETWEEN DTINIVIG
											AND DTTERVIG
											ORDER BY NRCERTIF
							,
											DTINIVIG
        ...
        public static R0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1 Execute(R0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1 r0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1)
        {
            var ths = r0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1;
        ...
        public override R0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0730_00_SELECT_HISCOBPR_DB_SELECT_1_Query1();
            var i = 0;
