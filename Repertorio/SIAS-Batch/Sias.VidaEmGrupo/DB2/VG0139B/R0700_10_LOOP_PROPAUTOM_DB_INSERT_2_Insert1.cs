...
{
    public class R0700_10_LOOP_PROPAUTOM_DB_INSERT_2_Insert1 : QueryBasis<R0700_10_LOOP_PROPAUTOM_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0700_10_LOOP_PROPAUTOM_DB_INSERT_2_Insert1 r0700_10_LOOP_PROPAUTOM_DB_INSERT_2_Insert1)
        {
            var ths = r0700_10_LOOP_PROPAUTOM_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0700_10_LOOP_PROPAUTOM_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
