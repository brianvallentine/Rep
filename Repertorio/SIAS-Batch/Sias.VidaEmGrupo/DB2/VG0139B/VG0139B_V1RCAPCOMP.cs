...
{
    public class VG0139B_V1RCAPCOMP : QueryBasis<VG0139B_V1RCAPCOMP>
    {
        ...
        public VG0139B_V1RCAPCOMP() { IsCursor = true; }

        public VG0139B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VG0139B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0139B_V1RCAPCOMP();
            var i = 0;
