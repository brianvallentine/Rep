...
{
    public class VG0139B_CHISTCTBL : QueryBasis<VG0139B_CHISTCTBL>
    {
        ...
        public VG0139B_CHISTCTBL() { IsCursor = true; }

        public VG0139B_CHISTCTBL(bool justACursor)
        {
        ...
        public override VG0139B_CHISTCTBL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0139B_CHISTCTBL();
            var i = 0;
