...
{
    public class R9990_00_INSERT_RELATORI_DB_INSERT_1_Insert1 : QueryBasis<R9990_00_INSERT_RELATORI_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R9990_00_INSERT_RELATORI_DB_INSERT_1_Insert1 r9990_00_INSERT_RELATORI_DB_INSERT_1_Insert1)
        {
            var ths = r9990_00_INSERT_RELATORI_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R9990_00_INSERT_RELATORI_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
