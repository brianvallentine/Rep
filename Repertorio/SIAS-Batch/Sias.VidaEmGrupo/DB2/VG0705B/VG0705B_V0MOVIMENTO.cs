...
{
    public class VG0705B_V0MOVIMENTO : QueryBasis<VG0705B_V0MOVIMENTO>
    {
        ...
        public VG0705B_V0MOVIMENTO() { IsCursor = true; }

        public VG0705B_V0MOVIMENTO(bool justACursor)
        {
        ...
        public override VG0705B_V0MOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0705B_V0MOVIMENTO();
            var i = 0;
