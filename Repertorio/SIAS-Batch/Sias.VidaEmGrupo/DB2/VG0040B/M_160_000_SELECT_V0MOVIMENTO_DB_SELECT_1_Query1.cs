...
namespace Sias.VidaEmGrupo.DB2.VG0040B
{
    public class M_160_000_SELECT_V0MOVIMENTO_DB_SELECT_1_Query1 : QueryBasis<M_160_000_SELECT_V0MOVIMENTO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            AND COD_OPERACAO NOT BETWEEN 0500 AND 599
            AND DATA_MOVIMENTO < :MDATA-MOVIMENTO
            ...
            var query = @$"
				SELECT
							...
							,0)
											...
											AND COD_OPERACAO NOT BETWEEN 0500 AND 599
											AND DATA_MOVIMENTO < '{this.MDATA_MOVIMENTO}'
											AND DATA_INCLUSAO IS NULL";

            return query;
        }
        public string V0NUM_COUNT { get; set; }
        ...
        public override M_160_000_SELECT_V0MOVIMENTO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            var i = 0;
            dta.V0NUM_COUNT = result[i++].Value?.ToString();
            return dta;
        }
