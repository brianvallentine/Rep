...
{
    public class VG0040B_TMOVIMENTO : QueryBasis<VG0040B_TMOVIMENTO>
    {
        ...
        public VG0040B_TMOVIMENTO() { IsCursor = true; }

        public VG0040B_TMOVIMENTO(bool justACursor)
        {
        ...
        public override VG0040B_TMOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0040B_TMOVIMENTO();
            var i = 0;
