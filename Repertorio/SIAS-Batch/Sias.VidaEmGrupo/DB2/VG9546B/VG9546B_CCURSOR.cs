...
{
    public class VG9546B_CCURSOR : QueryBasis<VG9546B_CCURSOR>
    {
        ...
        public VG9546B_CCURSOR() { IsCursor = true; }

        public VG9546B_CCURSOR(bool justACursor)
        {
        ...
        public override VG9546B_CCURSOR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG9546B_CCURSOR();
            var i = 0;
