...
namespace Sias.VidaEmGrupo.DB2.VG9546B
{
    public class R6000_10_PROX_PROP_DB_INSERT_1_Insert1 : QueryBasis<R6000_10_PROX_PROP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R6000_10_PROX_PROP_DB_INSERT_1_Insert1 r6000_10_PROX_PROP_DB_INSERT_1_Insert1)
        {
            var ths = r6000_10_PROX_PROP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R6000_10_PROX_PROP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
