...
{
    public class R1700_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1 : QueryBasis<R1700_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :SISTEMAS-DATA-MOV-ABERTO :VIND-DATA-AVERBACAO,
            :MOVIMVGA-DATA-ADMISSAO :VIND-DATA-ADMISSAO,
            NULL ,
            :MOVIMVGA-DATA-NASCIMENTO :VIND-DATA-NASCIMENTO,
            :SISTEMAS-DATA-MOV-ABERTO :VIND-DATA-FATURA,
            :SISTEMAS-DATA-MOV-ABERTO :VIND-DATA-REFERENCIA,
            :SISTEMAS-DATA-MOV-ABERTO :VIND-DATA-MOVIMENTO,
        ...
        public static void Execute(R1700_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1 r1700_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1)
        {
            var ths = r1700_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1700_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
