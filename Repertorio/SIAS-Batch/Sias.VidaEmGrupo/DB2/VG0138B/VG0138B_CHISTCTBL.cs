...
{
    public class VG0138B_CHISTCTBL : QueryBasis<VG0138B_CHISTCTBL>
    {
        ...
        public VG0138B_CHISTCTBL() { IsCursor = true; }

        public VG0138B_CHISTCTBL(bool justACursor)
        {
        ...
        public override VG0138B_CHISTCTBL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0138B_CHISTCTBL();
            var i = 0;
