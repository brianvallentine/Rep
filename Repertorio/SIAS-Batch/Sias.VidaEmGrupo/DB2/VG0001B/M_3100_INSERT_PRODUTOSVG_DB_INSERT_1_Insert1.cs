...
{
    public class M_3100_INSERT_PRODUTOSVG_DB_INSERT_1_Insert1 : QueryBasis<M_3100_INSERT_PRODUTOSVG_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            NULL ,
            NULL ,
            :PRODUVG-TEM-CDG:VIND-TEM-CDG ,
            NULL ,
            :PRODUVG-TEM-SAF:VIND-TEM-SAF ,
            NULL ,
            NULL ,
            NULL ,
            NULL ,
            ...
            NULL ,
            NULL ,
            :PRODUVG-ROT-SAF:VIND-ROT-SAF ,
            :PRODUVG-COD-PRODUTO-EA :VIND-COD-PROD-EA,
        ...
        public string VIND_ROT_SAF { get; set; }
        public string PRODUVG_COD_PRODUTO_EA { get; set; }
        public string VIND_COD_PROD_EA { get; set; }
        ...
        public static void Execute(M_3100_INSERT_PRODUTOSVG_DB_INSERT_1_Insert1 m_3100_INSERT_PRODUTOSVG_DB_INSERT_1_Insert1)
        {
            var ths = m_3100_INSERT_PRODUTOSVG_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_3100_INSERT_PRODUTOSVG_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
