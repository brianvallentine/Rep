...
{
    public class VG0001B_V1RCAPCOMP : QueryBasis<VG0001B_V1RCAPCOMP>
    {
        ...
        public VG0001B_V1RCAPCOMP() { IsCursor = true; }

        public VG0001B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VG0001B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0001B_V1RCAPCOMP();
            var i = 0;
