...
{
    public class M_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1 : QueryBasis<M_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1 Execute(M_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1 m_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1)
        {
            var ths = m_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1;
        ...
        public override M_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_1000_PROCESSA_VGSOLFAT_DB_SELECT_2_Query1();
            var i = 0;
