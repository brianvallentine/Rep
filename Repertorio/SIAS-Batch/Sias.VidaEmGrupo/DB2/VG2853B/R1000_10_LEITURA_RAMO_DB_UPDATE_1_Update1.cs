...
namespace Sias.VidaEmGrupo.DB2.VG2853B
{
    public class R1000_10_LEITURA_RAMO_DB_UPDATE_1_Update1 : QueryBasis<R1000_10_LEITURA_RAMO_DB_UPDATE_1_Update1>
    {
        ...
        private VG2853B_CPROPVA CurrentOf { get; set; }

        public R1000_10_LEITURA_RAMO_DB_UPDATE_1_Update1(VG2853B_CPROPVA currentOf)
        {
            CurrentOf = currentOf;
        }
        ...
        string GetQuery()
        {
            var query = @$"
				...
				WHERE
				(
					DTPROXVEN BETWEEN '{this.WHOST_MIN_DTPROXVEN}' AND '{this.V1SIST_DTVENFIM_CN}' AND SITUACAO IN ( '3', '6' ) AND NUM_APOLICE = 108208503665
				)
