...
{
    public class VG2853B_CPROPVA : QueryBasis<VG2853B_CPROPVA>
    {
        ...
        public VG2853B_CPROPVA() { IsCursor = true; }

        public VG2853B_CPROPVA(bool justACursor)
        {
        ...
        public override VG2853B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG2853B_CPROPVA();
            var i = 0;
