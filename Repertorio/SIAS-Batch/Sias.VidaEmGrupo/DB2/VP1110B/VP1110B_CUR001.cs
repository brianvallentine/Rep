...
{
    public class VP1110B_CUR001 : QueryBasis<VP1110B_CUR001>
    {
        ...
        public VP1110B_CUR001() { IsCursor = true; }

        public VP1110B_CUR001(bool justACursor)
        {
        ...
        public override VP1110B_CUR001 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP1110B_CUR001();
            var i = 0;
