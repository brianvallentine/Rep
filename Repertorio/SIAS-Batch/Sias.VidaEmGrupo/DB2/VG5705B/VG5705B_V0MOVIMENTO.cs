...
{
    public class VG5705B_V0MOVIMENTO : QueryBasis<VG5705B_V0MOVIMENTO>
    {
        ...
        public VG5705B_V0MOVIMENTO() { IsCursor = true; }

        public VG5705B_V0MOVIMENTO(bool justACursor)
        {
        ...
        public string SQL_PRM_VG_ATU { get; set; }
        public string SQL_PRM_AP_ATU { get; set; }
        ...
        public override VG5705B_V0MOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG5705B_V0MOVIMENTO();
            var i = 0;
            ...
            dta.SQL_PRM_VG_ATU = result[i++].Value?.ToString();
            dta.SQL_PRM_AP_ATU = result[i++].Value?.ToString();
