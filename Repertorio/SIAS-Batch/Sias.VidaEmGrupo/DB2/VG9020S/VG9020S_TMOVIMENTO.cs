...
{
    public class VG9020S_TMOVIMENTO : QueryBasis<VG9020S_TMOVIMENTO>
    {
        ...
        public VG9020S_TMOVIMENTO() { IsCursor = true; }

        public VG9020S_TMOVIMENTO(bool justACursor)
        {
        ...
        public string WDATA_MOVIMENTO1 { get; set; }
        ...
        public string WS_DT_MAIS30D { get; set; }
        public string WDATA_MOVIMENTO2 { get; set; }
        ...
        public override VG9020S_TMOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG9020S_TMOVIMENTO();
            var i = 0;
            ...
            dta.SDATA_MOVIMENTO = result[i++].Value?.ToString();
            dta.WDATA_MOVIMENTO1 = string.IsNullOrWhiteSpace(dta.SDATA_MOVIMENTO) ? "-1" : "0";
            ...
            dta.WS_DT_MAIS30D = result[i++].Value?.ToString();
            dta.WDATA_MOVIMENTO2 = string.IsNullOrWhiteSpace(dta.WS_DT_MAIS30D) ? "-1" : "0";
