...
{
    public class R0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1 : QueryBasis<R0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1 Execute(R0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1 r0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1)
        {
            var ths = r0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1;
        ...
        public override R0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0925_00_VAL_ARQUIVO_SIVPF_DB_SELECT_1_Query1();
            var i = 0;
