...
{
    public class R3800_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1 : QueryBasis<R3800_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.COBER_HIST_VIDAZUL (NUM_CERTIFICADO , NUM_PARCELA , NUM_TITULO , DATA_VENCIMENTO , PRM_TOTAL , OPCAO_PAGAMENTO , SIT_REGISTRO , COD_OPERACAO , OCORR_HISTORICO , COD_DEVOLUCAO , BCO_AVISO , AGE_AVISO , NUM_AVISO_CREDITO , NUM_TITULO_COMP) VALUES ({FieldThreatment(this.PROPOVA_NUM_CERTIFICADO)}, {FieldThreatment(this.COBHISVI_NUM_PARCELA)}, {FieldThreatment(this.COBHISVI_NUM_TITULO)}, {FieldThreatment(this.COBHISVI_DATA_VENCIMENTO)}, {FieldThreatment(this.COBHISVI_PRM_TOTAL)}, {FieldThreatment(this.PARCEVID_OPCAO_PAGAMENTO)}, {FieldThreatment(this.COBHISVI_SIT_REGISTRO)}, 0, {FieldThreatment(this.COBHISVI_OCORR_HISTORICO)}, 0, {FieldThreatment(this.COBHISVI_BCO_AVISO)} , {FieldThreatment(this.COBHISVI_AGE_AVISO)} , {FieldThreatment(this.COBHISVI_NUM_AVISO_CREDITO)}, 0)";
        ...
        public static void Execute(R3800_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1 r3800_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1)
        {
            var ths = r3800_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3800_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
