...
{
    public class VG1652B_CPROPOVA : QueryBasis<VG1652B_CPROPOVA>
    {
        ...
        public VG1652B_CPROPOVA() { IsCursor = true; }

        public VG1652B_CPROPOVA(bool justACursor)
        {
        ...
        public override VG1652B_CPROPOVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG1652B_CPROPOVA();
            var i = 0;
