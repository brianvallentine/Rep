...
{
    public class VP6706B_V0MOVIMENTO : QueryBasis<VP6706B_V0MOVIMENTO>
    {
        ...
        public VP6706B_V0MOVIMENTO() { IsCursor = true; }

        public VP6706B_V0MOVIMENTO(bool justACursor)
        {
        ...
        public override VP6706B_V0MOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP6706B_V0MOVIMENTO();
            var i = 0;
