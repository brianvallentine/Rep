...
{
    public class R2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1 : QueryBasis<R2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            SELECT VALUE(MAX(IMP_SEGURADA_IX), 0)
            ...
            */
            #endregion
            var query = @$"
				SELECT VALUE(MAX(IMP_SEGURADA_IX)
							, 0)
											FROM SEGUROS.APOLICE_COBERTURAS
        ...
        public static R2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1 Execute(R2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1 r2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1)
        {
            var ths = r2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1;
        ...
        public override R2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2140_00_SELECT_APOLICOB_DB_SELECT_1_Query1();
            var i = 0;
