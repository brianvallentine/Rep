...
{
    public class VG1626B_CPROPOVA : QueryBasis<VG1626B_CPROPOVA>
    {
        ...
        public VG1626B_CPROPOVA() { IsCursor = true; }

        public VG1626B_CPROPOVA(bool justACursor)
        {
        ...
        public override VG1626B_CPROPOVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG1626B_CPROPOVA();
            var i = 0;
