...
{
    public class R2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 : QueryBasis<R2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 Execute(R2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 r2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1)
        {
            var ths = r2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1;
        ...
        public override R2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2930_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1();
            var i = 0;
