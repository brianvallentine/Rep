...
{
    public class VG0716S_C01_RESULT : QueryBasis<VG0716S_C01_RESULT>
    {
        ...
        public VG0716S_C01_RESULT() { IsCursor = true; }

        public VG0716S_C01_RESULT(bool justACursor)
        {
        ...
        public override VG0716S_C01_RESULT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0716S_C01_RESULT();
            var i = 0;
