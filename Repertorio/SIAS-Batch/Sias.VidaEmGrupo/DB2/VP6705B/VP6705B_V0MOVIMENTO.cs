...
{
    public class VP6705B_V0MOVIMENTO : QueryBasis<VP6705B_V0MOVIMENTO>
    {
        ...
        public VP6705B_V0MOVIMENTO() { IsCursor = true; }

        public VP6705B_V0MOVIMENTO(bool justACursor)
        {
        ...
        public override VP6705B_V0MOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP6705B_V0MOVIMENTO();
            var i = 0;
