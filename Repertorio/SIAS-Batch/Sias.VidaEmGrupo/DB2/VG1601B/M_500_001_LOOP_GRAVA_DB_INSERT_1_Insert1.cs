...
{
    public class M_500_001_LOOP_GRAVA_DB_INSERT_1_Insert1 : QueryBasis<M_500_001_LOOP_GRAVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string WLOT_EMP_SEG { get; set; }

        public static void Execute(M_500_001_LOOP_GRAVA_DB_INSERT_1_Insert1 m_500_001_LOOP_GRAVA_DB_INSERT_1_Insert1)
        {
            var ths = m_500_001_LOOP_GRAVA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_500_001_LOOP_GRAVA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
