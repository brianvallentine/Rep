...
{
    public class VG1706B_AGENCTOAPOL : QueryBasis<VG1706B_AGENCTOAPOL>
    {
        ...
        public VG1706B_AGENCTOAPOL() { IsCursor = true; }

        public VG1706B_AGENCTOAPOL(bool justACursor)
        {
        ...
        public override VG1706B_AGENCTOAPOL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG1706B_AGENCTOAPOL();
            var i = 0;
