...
{
    public class R1450_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 : QueryBasis<R1450_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1450_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 r1450_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1)
        {
            var ths = r1450_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1450_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
