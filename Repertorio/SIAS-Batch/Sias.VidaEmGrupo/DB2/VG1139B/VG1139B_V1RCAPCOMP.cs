...
{
    public class VG1139B_V1RCAPCOMP : QueryBasis<VG1139B_V1RCAPCOMP>
    {
        ...
        public VG1139B_V1RCAPCOMP() { IsCursor = true; }

        public VG1139B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VG1139B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG1139B_V1RCAPCOMP();
            var i = 0;
