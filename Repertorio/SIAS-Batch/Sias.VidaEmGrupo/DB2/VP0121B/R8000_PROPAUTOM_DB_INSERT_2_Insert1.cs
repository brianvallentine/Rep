...
{
    public class R8000_PROPAUTOM_DB_INSERT_2_Insert1 : QueryBasis<R8000_PROPAUTOM_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R8000_PROPAUTOM_DB_INSERT_2_Insert1 r8000_PROPAUTOM_DB_INSERT_2_Insert1)
        {
            var ths = r8000_PROPAUTOM_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R8000_PROPAUTOM_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
