...
{
    public class R7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1 : QueryBasis<R7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1 Execute(R7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1 r7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1)
        {
            var ths = r7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1;
        ...
        public override R7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R7774_00_LER_RCAP_COMP_DB_SELECT_1_Query1();
            var i = 0;
