    ...
    public class M_2100_INCLUI_CORRETOR_DB_INSERT_1_Insert1 : QueryBasis<M_2100_INCLUI_CORRETOR_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0APOLCORRET VALUES (0109700000024, {FieldThreatment(this.APCORR_RAMO)}, 0, 17256, {FieldThreatment(this.PROPVA_CODSUBES)}, {FieldThreatment(this.APCORR_DTINIVIG)}, '9999-12-31' , 100.00, 5.00, '1' , '1' , 0, CURRENT TIMESTAMP, 'VP0121B' )";
