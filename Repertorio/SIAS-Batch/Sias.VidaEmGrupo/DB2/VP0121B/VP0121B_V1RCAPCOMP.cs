...
{
    public class VP0121B_V1RCAPCOMP : QueryBasis<VP0121B_V1RCAPCOMP>
    {
        ...
        public VP0121B_V1RCAPCOMP() { IsCursor = true; }

        public VP0121B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VP0121B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0121B_V1RCAPCOMP();
            var i = 0;
