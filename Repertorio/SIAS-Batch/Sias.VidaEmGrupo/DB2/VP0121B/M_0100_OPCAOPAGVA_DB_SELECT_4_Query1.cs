...
{
    public class M_0100_OPCAOPAGVA_DB_SELECT_4_Query1 : QueryBasis<M_0100_OPCAOPAGVA_DB_SELECT_4_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            var query = @$"
				SELECT DTINIVIG
							...
							,
											...
											AND OCORHIST = '{this.V0COBER_MINOCOR}'
											WITH UR";
        ...
        public static M_0100_OPCAOPAGVA_DB_SELECT_4_Query1 Execute(M_0100_OPCAOPAGVA_DB_SELECT_4_Query1 m_0100_OPCAOPAGVA_DB_SELECT_4_Query1)
        {
            var ths = m_0100_OPCAOPAGVA_DB_SELECT_4_Query1;
        ...
        public override M_0100_OPCAOPAGVA_DB_SELECT_4_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_0100_OPCAOPAGVA_DB_SELECT_4_Query1();
            var i = 0;
