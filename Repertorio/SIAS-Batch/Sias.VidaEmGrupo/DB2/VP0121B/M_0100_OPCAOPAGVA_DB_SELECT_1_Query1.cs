...
{
    public class M_0100_OPCAOPAGVA_DB_SELECT_1_Query1 : QueryBasis<M_0100_OPCAOPAGVA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string INDCARTAO { get; set; }
        public string PROPVA_NRCERTIF { get; set; }

        public static M_0100_OPCAOPAGVA_DB_SELECT_1_Query1 Execute(M_0100_OPCAOPAGVA_DB_SELECT_1_Query1 m_0100_OPCAOPAGVA_DB_SELECT_1_Query1)
        {
            var ths = m_0100_OPCAOPAGVA_DB_SELECT_1_Query1;
        ...
        public override M_0100_OPCAOPAGVA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_0100_OPCAOPAGVA_DB_SELECT_1_Query1();
            var i = 0;
            ...
            dta.OPCAOP_CARTAOCRED = result[i++].Value?.ToString();
            dta.INDCARTAO = string.IsNullOrWhiteSpace(dta.OPCAOP_CARTAOCRED) ? "-1" : "0";
            return dta;
        }
