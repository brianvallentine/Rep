...
{
    public class M_8600_10_CONTINUA_DB_INSERT_2_Insert1 : QueryBasis<M_8600_10_CONTINUA_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(M_8600_10_CONTINUA_DB_INSERT_2_Insert1 m_8600_10_CONTINUA_DB_INSERT_2_Insert1)
        {
            var ths = m_8600_10_CONTINUA_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_8600_10_CONTINUA_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
