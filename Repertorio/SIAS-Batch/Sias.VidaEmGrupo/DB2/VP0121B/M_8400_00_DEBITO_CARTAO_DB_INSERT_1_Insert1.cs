...
{
    public class M_8400_00_DEBITO_CARTAO_DB_INSERT_1_Insert1 : QueryBasis<M_8400_00_DEBITO_CARTAO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(M_8400_00_DEBITO_CARTAO_DB_INSERT_1_Insert1 m_8400_00_DEBITO_CARTAO_DB_INSERT_1_Insert1)
        {
            var ths = m_8400_00_DEBITO_CARTAO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_8400_00_DEBITO_CARTAO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
