...
{
    public class VP0121B_CPROPVA : QueryBasis<VP0121B_CPROPVA>
    {
        ...
        public VP0121B_CPROPVA() { IsCursor = true; }

        public VP0121B_CPROPVA(bool justACursor)
        {
        ...
        public string PROPVA_COD_OPER_CREDITO { get; set; }
        ...
        public override VP0121B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0121B_CPROPVA();
            var i = 0;
            ...
            dta.PROPVA_COD_OPER_CREDITO = result[i++].Value?.ToString();
