...
{
    public class VP0121B_C01_RCAPCOMP : QueryBasis<VP0121B_C01_RCAPCOMP>
    {
        ...
        public VP0121B_C01_RCAPCOMP() { IsCursor = true; }

        public VP0121B_C01_RCAPCOMP(bool justACursor)
        {
        ...
        public override VP0121B_C01_RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0121B_C01_RCAPCOMP();
            var i = 0;
