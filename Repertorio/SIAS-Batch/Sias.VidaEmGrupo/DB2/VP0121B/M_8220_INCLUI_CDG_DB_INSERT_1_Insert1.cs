    ...
    public class M_8220_INCLUI_CDG_DB_INSERT_1_Insert1 : QueryBasis<M_8220_INCLUI_CDG_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0CDGCOBER VALUES ({FieldThreatment(this.PROPVA_CODCLIEN)}, {FieldThreatment(this.PROPVA_DTINICDG)}, '9999-12-31' , {FieldThreatment(this.COBERP_IMPSEGCDG)}, {FieldThreatment(this.COBERP_VLCUSTCDG)}, {FieldThreatment(this.PROPVA_NRCERTIF)}, {FieldThreatment(this.PROPVA_OCORHIST)}, '0' , 'VP0121B' , CURRENT TIMESTAMP)";
