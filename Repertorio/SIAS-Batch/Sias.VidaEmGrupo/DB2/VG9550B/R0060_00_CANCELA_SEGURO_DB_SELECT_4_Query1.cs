...
{
    public class R0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1 : QueryBasis<R0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1 Execute(R0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1 r0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1)
        {
            var ths = r0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1;
        ...
        public override R0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0060_00_CANCELA_SEGURO_DB_SELECT_4_Query1();
            var i = 0;
