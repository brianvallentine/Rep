...
{
    public class VG9550B_CCURSOR : QueryBasis<VG9550B_CCURSOR>
    {
        ...
        public VG9550B_CCURSOR() { IsCursor = true; }

        public VG9550B_CCURSOR(bool justACursor)
        {
        ...
        public override VG9550B_CCURSOR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG9550B_CCURSOR();
            var i = 0;
