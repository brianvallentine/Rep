    ...
    public class M_0200_INSERT_REPSAF_DB_INSERT_1_Insert1 : QueryBasis<M_0200_INSERT_REPSAF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.MOVIMENTO_EA VALUES ({FieldThreatment(this.PROPOVA_NUM_CERTIFICADO)}, {FieldThreatment(this.GEARDETA_SEQ_GERACAO)}, {FieldThreatment(this.MOVIMEA_TIPO_MOVIMENTO)}, 'VG1473B' , CURRENT TIMESTAMP)";
