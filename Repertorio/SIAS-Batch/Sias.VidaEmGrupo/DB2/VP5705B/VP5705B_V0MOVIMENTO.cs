...
{
    public class VP5705B_V0MOVIMENTO : QueryBasis<VP5705B_V0MOVIMENTO>
    {
        ...
        public VP5705B_V0MOVIMENTO() { IsCursor = true; }

        public VP5705B_V0MOVIMENTO(bool justACursor)
        {
        ...
        public override VP5705B_V0MOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP5705B_V0MOVIMENTO();
            var i = 0;
