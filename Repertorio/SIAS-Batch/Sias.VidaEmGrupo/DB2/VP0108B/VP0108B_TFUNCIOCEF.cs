...
{
    public class VP0108B_TFUNCIOCEF : QueryBasis<VP0108B_TFUNCIOCEF>
    {
        ...
        public VP0108B_TFUNCIOCEF() { IsCursor = true; }

        public VP0108B_TFUNCIOCEF(bool justACursor)
        {
        ...
        public override VP0108B_TFUNCIOCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0108B_TFUNCIOCEF();
            var i = 0;
