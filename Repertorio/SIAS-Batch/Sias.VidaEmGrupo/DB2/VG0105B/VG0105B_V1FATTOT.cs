...
{
    public class VG0105B_V1FATTOT : QueryBasis<VG0105B_V1FATTOT>
    {
        ...
        public VG0105B_V1FATTOT() { IsCursor = true; }

        public VG0105B_V1FATTOT(bool justACursor)
        {
        ...
        public override VG0105B_V1FATTOT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0105B_V1FATTOT();
            var i = 0;
