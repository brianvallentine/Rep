...
{
    public class VG0105B_V1SOLICFAT : QueryBasis<VG0105B_V1SOLICFAT>
    {
        ...
        public VG0105B_V1SOLICFAT() { IsCursor = true; }

        public VG0105B_V1SOLICFAT(bool justACursor)
        {
        ...
        public override VG0105B_V1SOLICFAT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0105B_V1SOLICFAT();
            var i = 0;
