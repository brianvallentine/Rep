...
{
    public class VG0105B_V1SUBGRUPO : QueryBasis<VG0105B_V1SUBGRUPO>
    {
        ...
        public VG0105B_V1SUBGRUPO() { IsCursor = true; }

        public VG0105B_V1SUBGRUPO(bool justACursor)
        {
        ...
        public override VG0105B_V1SUBGRUPO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0105B_V1SUBGRUPO();
            var i = 0;
