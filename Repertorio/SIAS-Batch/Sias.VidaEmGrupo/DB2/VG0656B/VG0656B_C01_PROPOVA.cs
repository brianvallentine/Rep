...
{
    public class VG0656B_C01_PROPOVA : QueryBasis<VG0656B_C01_PROPOVA>
    {
        ...
        public VG0656B_C01_PROPOVA() { IsCursor = true; }

        public VG0656B_C01_PROPOVA(bool justACursor)
        {
        ...
        public override VG0656B_C01_PROPOVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0656B_C01_PROPOVA();
            var i = 0;
