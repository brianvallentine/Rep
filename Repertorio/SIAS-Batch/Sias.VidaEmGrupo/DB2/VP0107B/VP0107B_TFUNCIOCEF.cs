...
{
    public class VP0107B_TFUNCIOCEF : QueryBasis<VP0107B_TFUNCIOCEF>
    {
        ...
        public VP0107B_TFUNCIOCEF() { IsCursor = true; }

        public VP0107B_TFUNCIOCEF(bool justACursor)
        {
        ...
        public override VP0107B_TFUNCIOCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0107B_TFUNCIOCEF();
            var i = 0;
