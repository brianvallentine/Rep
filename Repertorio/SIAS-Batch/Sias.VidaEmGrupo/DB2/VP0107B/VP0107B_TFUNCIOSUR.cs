...
{
    public class VP0107B_TFUNCIOSUR : QueryBasis<VP0107B_TFUNCIOSUR>
    {
        ...
        public VP0107B_TFUNCIOSUR() { IsCursor = true; }

        public VP0107B_TFUNCIOSUR(bool justACursor)
        {
        ...
        public override VP0107B_TFUNCIOSUR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0107B_TFUNCIOSUR();
            var i = 0;
