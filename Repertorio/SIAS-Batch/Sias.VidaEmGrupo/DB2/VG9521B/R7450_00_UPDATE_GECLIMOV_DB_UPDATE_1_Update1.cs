...
{
    public class R7450_00_UPDATE_GECLIMOV_DB_UPDATE_1_Update1 : QueryBasis<R7450_00_UPDATE_GECLIMOV_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R7450_00_UPDATE_GECLIMOV_DB_UPDATE_1_Update1 r7450_00_UPDATE_GECLIMOV_DB_UPDATE_1_Update1)
        {
            var ths = r7450_00_UPDATE_GECLIMOV_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R7450_00_UPDATE_GECLIMOV_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
