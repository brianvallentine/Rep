...
{
    public class R6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1 : QueryBasis<R6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1 Execute(R6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1 r6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1)
        {
            var ths = r6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1;
        ...
        public override R6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R6666_00_AUMENTA_REDUZ_VG_DB_SELECT_5_Query1();
            var i = 0;
