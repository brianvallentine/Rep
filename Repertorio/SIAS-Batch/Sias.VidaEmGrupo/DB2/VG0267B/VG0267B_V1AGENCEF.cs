...
{
    public class VG0267B_V1AGENCEF : QueryBasis<VG0267B_V1AGENCEF>
    {
        ...
        public VG0267B_V1AGENCEF() { IsCursor = true; }

        public VG0267B_V1AGENCEF(bool justACursor)
        {
        ...
        public override VG0267B_V1AGENCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0267B_V1AGENCEF();
            var i = 0;
