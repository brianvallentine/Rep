...
{
    public class VG0267B_CFAIXACEP : QueryBasis<VG0267B_CFAIXACEP>
    {
        ...
        public VG0267B_CFAIXACEP() { IsCursor = true; }

        public VG0267B_CFAIXACEP(bool justACursor)
        {
        ...
        public override VG0267B_CFAIXACEP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0267B_CFAIXACEP();
            var i = 0;
