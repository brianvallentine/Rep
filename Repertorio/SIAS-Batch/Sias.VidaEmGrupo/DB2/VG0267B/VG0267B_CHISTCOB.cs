...
{
    public class VG0267B_CHISTCOB : QueryBasis<VG0267B_CHISTCOB>
    {
        ...
        public VG0267B_CHISTCOB() { IsCursor = true; }

        public VG0267B_CHISTCOB(bool justACursor)
        {
        ...
        public string V0HIST_QTDPARCEL { get; set; }
        ...
        public override VG0267B_CHISTCOB OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0267B_CHISTCOB();
            var i = 0;
            ...
            dta.V0HIST_QTDPARCEL = result[i++].Value?.ToString();
