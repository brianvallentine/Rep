    ...
    public class M_1400_LOOP_GRAVA_DB_INSERT_1_Insert1 : QueryBasis<M_1400_LOOP_GRAVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0COMISSAO VALUES ({FieldThreatment(this.SQL_NUM_APOL)} , 0, {FieldThreatment(this.SQL_NUM_CERT)} , {FieldThreatment(this.SQL_DAC_CERT)} , {FieldThreatment(this.SQL_TIPO_SEG)} , 0 , 1101, {FieldThreatment(this.SQL_COD_AGEN)} , {FieldThreatment(this.SQL_RAMOFR)} , 0, 0, {FieldThreatment(this.SQL_COD_FONTE)}, {FieldThreatment(this.SQL_COD_CLIE)} , {FieldThreatment(this.SQL_VLCOMIS)} , {FieldThreatment(this.SQL_DTMOVABE)} , 0, {FieldThreatment(this.SQL_VALBAS)} , '8' , 0, {FieldThreatment(this.SQL_PCT_AGENC)}, 0, {FieldThreatment(this.SQL_COD_SUB)}, {FieldThreatment(this.SQL_HORAOPER)}, NULL,  {FieldThreatment((this.SQL_NOT_NULL?.ToInt() == -1 ? null : this.SQL_DATSEL))}, NULL,  {FieldThreatment((this.SQL_NOT_NULL?.ToInt() == -1 ? null : this.SQL_PROPOSTA))}, CURRENT TIMESTAMP,  {FieldThreatment((this.SQL_NUMBILI?.ToInt() == -1 ? null : this.SQL_NUMBIL))}, 0, NULL)";
