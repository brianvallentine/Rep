...
{
    public class R8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1 : QueryBasis<R8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1 Execute(R8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1 r8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1)
        {
            var ths = r8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1;
        ...
        public override R8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R8020_00_VERIFICA_PESSOA_FIS_DB_SELECT_1_Query1();
            var i = 0;
