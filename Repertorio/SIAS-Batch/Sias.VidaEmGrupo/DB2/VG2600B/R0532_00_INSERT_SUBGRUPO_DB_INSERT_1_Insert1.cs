...
{
    public class R0532_00_INSERT_SUBGRUPO_DB_INSERT_1_Insert1 : QueryBasis<R0532_00_INSERT_SUBGRUPO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            INSERT
            INTO SEGUROS.SUBGRUPOS_VGAP
            VALUES (:SUBGVGAP-NUM-APOLICE ,
        ...
        public static void Execute(R0532_00_INSERT_SUBGRUPO_DB_INSERT_1_Insert1 r0532_00_INSERT_SUBGRUPO_DB_INSERT_1_Insert1)
        {
            var ths = r0532_00_INSERT_SUBGRUPO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0532_00_INSERT_SUBGRUPO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
