...
{
    public class DB030_INSERT_VG_COMPL_CLI_EMP_DB_INSERT_1_Insert1 : QueryBasis<DB030_INSERT_VG_COMPL_CLI_EMP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(DB030_INSERT_VG_COMPL_CLI_EMP_DB_INSERT_1_Insert1 dB030_INSERT_VG_COMPL_CLI_EMP_DB_INSERT_1_Insert1)
        {
            var ths = dB030_INSERT_VG_COMPL_CLI_EMP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override DB030_INSERT_VG_COMPL_CLI_EMP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
