...
{
    public class R2060_00_ATUALIZA_ARQSIVPF_DB_INSERT_1_Insert1 : QueryBasis<R2060_00_ATUALIZA_ARQSIVPF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            INSERT
            INTO SEGUROS.ARQUIVOS_SIVPF
            VALUES (:ARQSIVPF-SIGLA-ARQUIVO ,
            :ARQSIVPF-SISTEMA-ORIGEM ,
            :ARQSIVPF-NSAS-SIVPF ,
            :ARQSIVPF-DATA-GERACAO ,
            :ARQSIVPF-QTDE-REG-GER ,
            :ARQSIVPF-DATA-PROCESSAMENTO)
            END-EXEC.
            */
            #endregion
            var query = @$"
        ...
        public static void Execute(R2060_00_ATUALIZA_ARQSIVPF_DB_INSERT_1_Insert1 r2060_00_ATUALIZA_ARQSIVPF_DB_INSERT_1_Insert1)
        {
            var ths = r2060_00_ATUALIZA_ARQSIVPF_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2060_00_ATUALIZA_ARQSIVPF_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
