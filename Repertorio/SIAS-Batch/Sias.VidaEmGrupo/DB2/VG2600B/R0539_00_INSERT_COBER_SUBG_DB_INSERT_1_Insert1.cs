...
{
    public class R0539_00_INSERT_COBER_SUBG_DB_INSERT_1_Insert1 : QueryBasis<R0539_00_INSERT_COBER_SUBG_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            INSERT
            INTO SEGUROS.VG_COBERTURAS_SUBG
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.VG_COBERTURAS_SUBG VALUES ({FieldThreatment(this.VGCOBSUB_NUM_APOLICE)} , {FieldThreatment(this.VGCOBSUB_COD_SUBGRUPO)} , {FieldThreatment(this.VGCOBSUB_RAMO_COBERTURA)} , {FieldThreatment(this.VGCOBSUB_COD_COBERTURA)} , {FieldThreatment(this.VGCOBSUB_MODALI_COBERTURA)} , {FieldThreatment(this.VGCOBSUB_IMP_SEGURADA_IX)} , {FieldThreatment(this.VGCOBSUB_PRM_TARIFARIO_IX)} , {FieldThreatment(this.VGCOBSUB_IMP_SEGURADA_VAR)} , {FieldThreatment(this.VGCOBSUB_PRM_TARIFARIO_VAR)} , {FieldThreatment(this.VGCOBSUB_PCT_COBERTURA)} , {FieldThreatment(this.VGCOBSUB_FATOR_MULTIPLICA)} , {FieldThreatment(this.VGCOBSUB_DATA_INIVIGENCIA)} , {FieldThreatment(this.VGCOBSUB_TRATAMENTO_FATURA)} , {FieldThreatment(this.VGCOBSUB_TRATAMENTO_PRMTOT)} , {FieldThreatment(this.VGCOBSUB_SIT_COBERTURA)} , {FieldThreatment(this.VGCOBSUB_COD_USUARIO)} , CURRENT_TIMESTAMP , {FieldThreatment(this.VGCOBSUB_VLR_LIM_MIN_COBER)} , {FieldThreatment(this.VGCOBSUB_VLR_LIM_MAX_COBER)} )";
        ...
        public string VGCOBSUB_SIT_COBERTURA { get; set; }
        ...
        public static void Execute(R0539_00_INSERT_COBER_SUBG_DB_INSERT_1_Insert1 r0539_00_INSERT_COBER_SUBG_DB_INSERT_1_Insert1)
        {
            var ths = r0539_00_INSERT_COBER_SUBG_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0539_00_INSERT_COBER_SUBG_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
