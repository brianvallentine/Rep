...
{
    public class M_1500_PROC_FATURAS_DB_SELECT_6_Query1 : QueryBasis<M_1500_PROC_FATURAS_DB_SELECT_6_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND NUM_ITEM = 0
            AND OCORR_HISTORICO = 0
            AND RAMO_COBERTURA = 82
            AND COD_COBERTURA = 0
            END-EXEC.
            */
            #endregion
        ...
        public static M_1500_PROC_FATURAS_DB_SELECT_6_Query1 Execute(M_1500_PROC_FATURAS_DB_SELECT_6_Query1 m_1500_PROC_FATURAS_DB_SELECT_6_Query1)
        {
            var ths = m_1500_PROC_FATURAS_DB_SELECT_6_Query1;
        ...
        public override M_1500_PROC_FATURAS_DB_SELECT_6_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_1500_PROC_FATURAS_DB_SELECT_6_Query1();
            var i = 0;
