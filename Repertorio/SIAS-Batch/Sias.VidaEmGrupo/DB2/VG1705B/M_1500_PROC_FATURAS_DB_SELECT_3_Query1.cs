...
{
    public class M_1500_PROC_FATURAS_DB_SELECT_3_Query1 : QueryBasis<M_1500_PROC_FATURAS_DB_SELECT_3_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_1500_PROC_FATURAS_DB_SELECT_3_Query1 Execute(M_1500_PROC_FATURAS_DB_SELECT_3_Query1 m_1500_PROC_FATURAS_DB_SELECT_3_Query1)
        {
            var ths = m_1500_PROC_FATURAS_DB_SELECT_3_Query1;
        ...
        public override M_1500_PROC_FATURAS_DB_SELECT_3_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_1500_PROC_FATURAS_DB_SELECT_3_Query1();
            var i = 0;
