...
{
    public class R2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1 : QueryBasis<R2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1 Execute(R2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1 r2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1)
        {
            var ths = r2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1;
        ...
        public override R2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2245_VALIDAR_IMPORTANCIA_DB_SELECT_2_Query1();
            var i = 0;
