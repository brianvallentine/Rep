...
{
    public class VP0601B_C01_RCAPCOMP : QueryBasis<VP0601B_C01_RCAPCOMP>
    {
        ...
        public VP0601B_C01_RCAPCOMP() { IsCursor = true; }

        public VP0601B_C01_RCAPCOMP(bool justACursor)
        {
        ...
        public override VP0601B_C01_RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_C01_RCAPCOMP();
            var i = 0;
