...
{
    public class R2310_00_INSERT_CLIENTES_DB_INSERT_2_Insert1 : QueryBasis<R2310_00_INSERT_CLIENTES_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2310_00_INSERT_CLIENTES_DB_INSERT_2_Insert1 r2310_00_INSERT_CLIENTES_DB_INSERT_2_Insert1)
        {
            var ths = r2310_00_INSERT_CLIENTES_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2310_00_INSERT_CLIENTES_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
