...
{
    public class VP0601B_C01_GECLIMOV : QueryBasis<VP0601B_C01_GECLIMOV>
    {
        ...
        public VP0601B_C01_GECLIMOV() { IsCursor = true; }

        public VP0601B_C01_GECLIMOV(bool justACursor)
        {
        ...
        public override VP0601B_C01_GECLIMOV OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_C01_GECLIMOV();
            var i = 0;
