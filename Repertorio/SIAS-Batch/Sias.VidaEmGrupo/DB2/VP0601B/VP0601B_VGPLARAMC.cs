...
{
    public class VP0601B_VGPLARAMC : QueryBasis<VP0601B_VGPLARAMC>
    {
        ...
        public VP0601B_VGPLARAMC() { IsCursor = true; }

        public VP0601B_VGPLARAMC(bool justACursor)
        {
        ...
        public override VP0601B_VGPLARAMC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_VGPLARAMC();
            var i = 0;
