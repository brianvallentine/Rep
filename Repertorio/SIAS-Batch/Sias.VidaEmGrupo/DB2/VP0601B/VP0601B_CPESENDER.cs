...
{
    public class VP0601B_CPESENDER : QueryBasis<VP0601B_CPESENDER>
    {
        ...
        public VP0601B_CPESENDER() { IsCursor = true; }

        public VP0601B_CPESENDER(bool justACursor)
        {
        ...
        public override VP0601B_CPESENDER OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_CPESENDER();
            var i = 0;
