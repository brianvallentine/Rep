...
{
    public class VP0601B_CPROPOSTA : QueryBasis<VP0601B_CPROPOSTA>
    {
        ...
        public VP0601B_CPROPOSTA() { IsCursor = true; }

        public VP0601B_CPROPOSTA(bool justACursor)
        {
        ...
        public string DCLPRODUTOS_VG_PRODUVG_RAMO { get; set; }
        ...
        public override VP0601B_CPROPOSTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_CPROPOSTA();
            var i = 0;
            ...
            dta.DCLPRODUTOS_VG_PRODUVG_RAMO = result[i++].Value?.ToString();
            dta.DCLPROPOSTA_FIDELIZ_PROPOFID_NRMATRCON = result[i++].Value?.ToString();
