...
{
    public class VP0601B_VGPLAACES : QueryBasis<VP0601B_VGPLAACES>
    {
        ...
        public VP0601B_VGPLAACES() { IsCursor = true; }

        public VP0601B_VGPLAACES(bool justACursor)
        {
        ...
        public override VP0601B_VGPLAACES OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_VGPLAACES();
            var i = 0;
