...
{
    public class VP0601B_CFONTES : QueryBasis<VP0601B_CFONTES>
    {
        ...
        public VP0601B_CFONTES() { IsCursor = true; }

        public VP0601B_CFONTES(bool justACursor)
        {
        ...
        public override VP0601B_CFONTES OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_CFONTES();
            var i = 0;
