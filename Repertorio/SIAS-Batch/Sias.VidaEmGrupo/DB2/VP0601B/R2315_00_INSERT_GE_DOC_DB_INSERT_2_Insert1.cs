...
{
    public class R2315_00_INSERT_GE_DOC_DB_INSERT_2_Insert1 : QueryBasis<R2315_00_INSERT_GE_DOC_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2315_00_INSERT_GE_DOC_DB_INSERT_2_Insert1 r2315_00_INSERT_GE_DOC_DB_INSERT_2_Insert1)
        {
            var ths = r2315_00_INSERT_GE_DOC_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2315_00_INSERT_GE_DOC_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
