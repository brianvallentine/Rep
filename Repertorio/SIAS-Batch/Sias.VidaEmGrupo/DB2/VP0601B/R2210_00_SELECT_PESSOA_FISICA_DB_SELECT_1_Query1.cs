...
namespace Sias.VidaEmGrupo.DB2.VP0601B
{
    public class R2210_00_SELECT_PESSOA_FISICA_DB_SELECT_1_Query1 : QueryBasis<R2210_00_SELECT_PESSOA_FISICA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            DATA_NASCIMENTO,
            DATA_NASCIMENTO -
            :DCLPROPOSTA-FIDELIZ.PROPOFID-COD-PLANO MONTHS,
            DATA_NASCIMENTO - 2 DAYS,
            SEXO,
            COD_CBO,
            ESTADO_CIVIL,
            ORGAO_EXPEDIDOR,
            ...
            :WHOST-DATA-NASCIMENTO-7708,
            :WHOST-DATA-NASCIMENTO-2,
            ...
            */
            ...
            var query = @$"
				SELECT CPF
							...
							,
											DATA_NASCIMENTO -
											{this.PROPOFID_COD_PLANO} MONTHS
							,
											DATA_NASCIMENTO - 2 DAYS
							,
											SEXO
        ...
        public string WHOST_DATA_NASCIMENTO_7708 { get; set; }
        public string WHOST_DATA_NASCIMENTO_2 { get; set; }
        ...
        public override R2210_00_SELECT_PESSOA_FISICA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.WHOST_DATA_NASCIMENTO_7708 = result[i++].Value?.ToString();
            dta.WHOST_DATA_NASCIMENTO_2 = result[i++].Value?.ToString();
