...
{
    public class R3100_00_INSERT_COBERPROPVA_DB_INSERT_2_Insert1 : QueryBasis<R3100_00_INSERT_COBERPROPVA_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.HIS_COBER_PROPOST (NUM_CERTIFICADO , OCORR_HISTORICO , DATA_INIVIGENCIA , DATA_TERVIGENCIA , IMPSEGUR , QUANT_VIDAS , IMPSEGIND , COD_OPERACAO , OPCAO_COBERTURA , IMP_MORNATU , IMPMORACID , IMPINVPERM , IMPAMDS , IMPDH , IMPDIT , VLPREMIO , PRMVG , PRMAP , QTDE_TIT_CAPITALIZ, VAL_TIT_CAPITALIZ , VAL_CUSTO_CAPITALI, IMPSEGCDG , VLCUSTCDG , COD_USUARIO , TIMESTAMP , IMPSEGAUXF , VLCUSTAUXF , PRMDIT , QTMDIT) VALUES ({FieldThreatment(this.PROPOFID_NUM_PROPOSTA_SIVPF)}, 1, {FieldThreatment(this.PROPOFID_DTQITBCO)}, '9999-12-31' , {FieldThreatment(this.IMPMORNATU)}, 0, {FieldThreatment(this.IMPMORNATU)}, 106, {FieldThreatment(this.PROPOFID_OPCAO_COBER)}, {FieldThreatment(this.IMPMORNATU)}, {FieldThreatment(this.IMPMORACID)}, {FieldThreatment(this.IMPINVPERM)}, {FieldThreatment(this.IMPAMDS)}, {FieldThreatment(this.IMPDH)}, {FieldThreatment(this.IMPDIT)}, {FieldThreatment(this.VLPREMIOTOT)}, {FieldThreatment(this.PRMVG)}, {FieldThreatment(this.PRMAP)}, {FieldThreatment(this.QTTITCAP)}, {FieldThreatment(this.VLTITCAP)}, {FieldThreatment(this.VLCUSTCAP)}, {FieldThreatment(this.IMPSEGCDG)}, {FieldThreatment(this.VLCUSTCDG)}, 'VP0601B' , CURRENT TIMESTAMP,  {FieldThreatment((this.VIND_IMPSEGAUXF?.ToInt() == -1 ? null : this.IMPSEGAUXF))},  {FieldThreatment((this.VIND_VLCUSTAUXF?.ToInt() == -1 ? null : this.VLCUSTAUXF))},  {FieldThreatment((this.VIND_PRMDIT?.ToInt() == -1 ? null : this.PRMDIT))},  {FieldThreatment((this.VIND_QTDIT?.ToInt() == -1 ? null : this.QTDIT))})";
        ...
        public static void Execute(R3100_00_INSERT_COBERPROPVA_DB_INSERT_2_Insert1 r3100_00_INSERT_COBERPROPVA_DB_INSERT_2_Insert1)
        {
            var ths = r3100_00_INSERT_COBERPROPVA_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3100_00_INSERT_COBERPROPVA_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
