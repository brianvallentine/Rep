...
{
    public class VP0601B_CPESENDERR : QueryBasis<VP0601B_CPESENDERR>
    {
        ...
        public VP0601B_CPESENDERR() { IsCursor = true; }

        public VP0601B_CPESENDERR(bool justACursor)
        {
        ...
        public override VP0601B_CPESENDERR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VP0601B_CPESENDERR();
            var i = 0;
