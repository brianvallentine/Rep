...
{
    public class VG0123B_RELATORIO : QueryBasis<VG0123B_RELATORIO>
    {
        ...
        public VG0123B_RELATORIO() { IsCursor = true; }

        public VG0123B_RELATORIO(bool justACursor)
        {
        ...
        public string RELAT_MES_REFERENCIA { get; set; }
        public string RELAT_ANO_REFERENCIA { get; set; }
        ...
        public override VG0123B_RELATORIO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0123B_RELATORIO();
            var i = 0;
            ...
            dta.RELAT_MES_REFERENCIA = result[i++].Value?.ToString();
            dta.RELAT_ANO_REFERENCIA = result[i++].Value?.ToString();
