...
{
    public class VG0123B_SEGURADO2 : QueryBasis<VG0123B_SEGURADO2>
    {
        ...
        public VG0123B_SEGURADO2() { IsCursor = true; }

        public VG0123B_SEGURADO2(bool justACursor)
        {
        ...
        public override VG0123B_SEGURADO2 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0123B_SEGURADO2();
            var i = 0;
