...
{
    public class VG0145B_CPROPOVA : QueryBasis<VG0145B_CPROPOVA>
    {
        ...
        public VG0145B_CPROPOVA() { IsCursor = true; }

        public VG0145B_CPROPOVA(bool justACursor)
        {
        ...
        public override VG0145B_CPROPOVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG0145B_CPROPOVA();
            var i = 0;
