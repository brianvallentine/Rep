...
{
    public class VG5706B_V0MOVIMENTO : QueryBasis<VG5706B_V0MOVIMENTO>
    {
        ...
        public VG5706B_V0MOVIMENTO() { IsCursor = true; }

        public VG5706B_V0MOVIMENTO(bool justACursor)
        {
        ...
        public override VG5706B_V0MOVIMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VG5706B_V0MOVIMENTO();
            var i = 0;
