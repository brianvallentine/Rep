...
{
    public class R4400_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1 : QueryBasis<R4400_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4400_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1 r4400_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1)
        {
            var ths = r4400_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4400_00_INSERT_MOVIMVGA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
