...
using Dclgens;
using Copies;
using Sias.VidaEmGrupo.DB2.VG9546B;

namespace Code
{
    public class VG9546B
    {
        ...
        /*"      *                             PARA APOLICES CONSIGNACAO FUNCEF   *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *--------------------------------------                                 */
        #endregion
        ...
        /*"01           WNATURALIDADE.*/
        public VG9546B_WNATURALIDADE WNATURALIDADE { get; set; } = new VG9546B_WNATURALIDADE();
        public class VG9546B_WNATURALIDADE : VarBasis
        {
        ...
        private _REDEF_VG9546B_WDTNAS_FUNCICEF_R _wdtnas_funcicef_r { get; set; }
        public _REDEF_VG9546B_WDTNAS_FUNCICEF_R WDTNAS_FUNCICEF_R
        {
            get { _wdtnas_funcicef_r = new _REDEF_VG9546B_WDTNAS_FUNCICEF_R(); _.Move(WDTNAS_FUNCICEF, _wdtnas_funcicef_r); VarBasis.RedefinePassValue(WDTNAS_FUNCICEF, _wdtnas_funcicef_r, WDTNAS_FUNCICEF); _wdtnas_funcicef_r.ValueChanged += () => { _.Move(_wdtnas_funcicef_r, WDTNAS_FUNCICEF); }; return _wdtnas_funcicef_r; }
            set { VarBasis.RedefinePassValue(value, _wdtnas_funcicef_r, WDTNAS_FUNCICEF); }
        }  //Redefines
        public class _REDEF_VG9546B_WDTNAS_FUNCICEF_R : VarBasis
        {
            ...
            public _REDEF_VG9546B_WDTNAS_FUNCICEF_R()
            {
        ...
        public VG9546B_WDATASQL WDATASQL { get; set; } = new VG9546B_WDATASQL();
        public class VG9546B_WDATASQL : VarBasis
        {
        ...
        public VG9546B_WDATA_FILE WDATA_FILE { get; set; } = new VG9546B_WDATA_FILE();
        public class VG9546B_WDATA_FILE : VarBasis
        {
        ...
        private _REDEF_VG9546B_WDTOP _wdtop { get; set; }
        public _REDEF_VG9546B_WDTOP WDTOP
        {
            get { _wdtop = new _REDEF_VG9546B_WDTOP(); _.Move(WDTOPER, _wdtop); VarBasis.RedefinePassValue(WDTOPER, _wdtop, WDTOPER); _wdtop.ValueChanged += () => { _.Move(_wdtop, WDTOPER); }; return _wdtop; }
            set { VarBasis.RedefinePassValue(value, _wdtop, WDTOPER); }
        }  //Redefines
        public class _REDEF_VG9546B_WDTOP : VarBasis
        {
        ...
        public VG9546B_WDTINIVIG WDTINIVIG { get; set; } = new VG9546B_WDTINIVIG();
        public class VG9546B_WDTINIVIG : VarBasis
        {
        ...
        public VG9546B_WDTTERVIG WDTTERVIG { get; set; } = new VG9546B_WDTTERVIG();
        public class VG9546B_WDTTERVIG : VarBasis
        {
        ...
        public VG9546B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new VG9546B_AREA_DE_WORK();
        public class VG9546B_AREA_DE_WORK : VarBasis
        {
            /*"  05   WS-DATA-BASE.*/
            public VG9546B_WS_DATA_BASE WS_DATA_BASE { get; set; } = new VG9546B_WS_DATA_BASE();
            public class VG9546B_WS_DATA_BASE : VarBasis
            {
            ...
            public VG9546B_WDTNAS_REG WDTNAS_REG { get; set; } = new VG9546B_WDTNAS_REG();
            public class VG9546B_WDTNAS_REG : VarBasis
            {
            ...
            public VG9546B_W02DTSQL W02DTSQL { get; set; } = new VG9546B_W02DTSQL();
            public class VG9546B_W02DTSQL : VarBasis
            {
                /*"       10  W02AAMMSQL.*/
                public VG9546B_W02AAMMSQL W02AAMMSQL { get; set; } = new VG9546B_W02AAMMSQL();
                public class VG9546B_W02AAMMSQL : VarBasis
                {
            ...
            public VG9546B_W03DTSQL W03DTSQL { get; set; } = new VG9546B_W03DTSQL();
            public class VG9546B_W03DTSQL : VarBasis
            {
                /*"       10  W03AAMMSQL.*/
                public VG9546B_W03AAMMSQL W03AAMMSQL { get; set; } = new VG9546B_W03AAMMSQL();
                public class VG9546B_W03AAMMSQL : VarBasis
                {
            ...
            /*"  05        WABEND.*/
            public VG9546B_WABEND WABEND { get; set; } = new VG9546B_WABEND();
            public class VG9546B_WABEND : VarBasis
            {
                /*"    10      FILLER              PIC  X(008) VALUE           'VG9546B '.*/
                public StringBasis FILLER_4 { get; set; } = new StringBasis(new PIC("X", "8", "X(008)"), @"VG9546B ");
        ...
        public VG9546B_CCURSOR CCURSOR { get; set; } = new VG9546B_CCURSOR();
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -302- PERFORM R0040-00-VERIFICA-APOLICE. */
            ...
            /*" -325- PERFORM R0000_00_PRINCIPAL_DB_DECLARE_1 */

            R0000_00_PRINCIPAL_DB_DECLARE_1();

            /*" -327- PERFORM R0000_00_PRINCIPAL_DB_OPEN_1 */
            ...
            /*" -334- PERFORM R0030-00-FETCH-SEGURVGA */

            R0030_00_FETCH_SEGURVGA_SECTION();

            /*" -337- PERFORM R0050-00-PROCESSA-REGISTRO UNTIL WFIM-ENTRADA NOT EQUAL SPACES. */
            ...
            /*" -339- DISPLAY '*--------  VG9546B - FIM NORMAL  --------*' */
            _.Display($"*--------  VG9546B - FIM NORMAL  --------*");

            /*" -340- DISPLAY ' ' */
            _.Display($" ");

            /*" -343- DISPLAY 'TOTAL DE SEGUROS CANCELADOS   ... ' WACC-CANCELADOS */
            _.Display($"TOTAL DE SEGUROS CANCELADOS   ... {AREA_DE_WORK.WACC_CANCELADOS}");

            /*" -344- MOVE '0000' TO WNR-EXEC-SQL. */
            _.Move("0000", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -344- EXEC SQL COMMIT WORK END-EXEC. */
        ...
        {
            /*" -325- EXEC SQL DECLARE CCURSOR CURSOR FOR SELECT TIPO_INCLUSAO, COD_AGENCIADOR, NUM_ITEM, OCORR_HISTORICO, NUM_APOLICE, COD_SUBGRUPO, NUM_CERTIFICADO, COD_FONTE, SIT_REGISTRO, COD_CLIENTE, NUM_MATRICULA, DATA_INIVIGENCIA, NATURALIDADE, OCORR_ENDERECO FROM SEGUROS.SEGURADOS_VGAP A WHERE NUM_APOLICE IN (0107700000005 , 0093605000853 ) AND SIT_REGISTRO IN ( '0' , '1' ) AND COD_PROFISSAO = 0 END-EXEC. */
            CCURSOR = new VG9546B_CCURSOR(false);
            string GetQuery_CCURSOR()
            {
                var query = @$"SELECT 
							...
							WHERE NUM_APOLICE IN (0107700000005
							, 
							0093605000853 ) 
        ...
        {
            /*" -327- EXEC SQL OPEN CCURSOR END-EXEC. */
        ...
        {
            /*" -362- MOVE '0030' TO WNR-EXEC-SQL. */
            _.Move("0030", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -377- PERFORM R0030_00_FETCH_SEGURVGA_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -380- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -381- MOVE 'S' TO WFIM-ENTRADA */
                    _.Move("S", AREA_DE_WORK.WFIM_ENTRADA);

                    /*" -381- PERFORM R0030_00_FETCH_SEGURVGA_DB_CLOSE_1 */
        ...
        {
            /*" -381- EXEC SQL CLOSE CCURSOR END-EXEC */
        ...
        {
            /*" -395- MOVE '0040' TO WNR-EXEC-SQL. */
            _.Move("0040", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -410- PERFORM R0040_00_VERIFICA_APOLICE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -414- DISPLAY 'ERRO SELECT PARAMETROS_RAMOS' */
        ...
        {
            /*" -410- EXEC SQL SELECT RAMO_VGAPC, RAMO_VG, RAMO_AP, NUM_RAMO_PRSTMISTA INTO :PARAMRAM-RAMO-VGAPC, :PARAMRAM-RAMO-VG, :PARAMRAM-RAMO-AP, :PARAMRAM-NUM-RAMO-PRSTMISTA FROM SEGUROS.PARAMETROS_RAMOS WHERE 1 = 1 END-EXEC. */
        ...
        {
            /*" -427- ADD 1 TO WACC-LIDOS. */
            AREA_DE_WORK.WACC_LIDOS.Value = AREA_DE_WORK.WACC_LIDOS + 1;

            /*" -427- PERFORM R6000-00-CANCELA-SEGURO. */
        ...
        {
            /*" -431- PERFORM R0030-00-FETCH-SEGURVGA. */
        ...
        {
            /*" -444- MOVE 1 TO MOVIMVGA-PERI-PAGAMENTO. */
            _.Move(1, MOVIMVGA.DCLMOVIMENTO_VGAP.MOVIMVGA_PERI_PAGAMENTO);

            /*" -446- MOVE '6025' TO WNR-EXEC-SQL. */
            _.Move("6025", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -460- PERFORM R6000_00_CANCELA_SEGURO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -466- MOVE ZEROS TO V0COBA-IMPMORNATU V0COBA-PRMVG */
                ...
                else
                {
                    ...
                    /*" -468- DISPLAY 'R6000-00 (ERRO - SELECT APOLICE_COBERTURAS)' */
                    _.Display($"R6000-00 (ERRO - SELECT APOLICE_COBERTURAS)");

                    /*" -469- DISPLAY 'R6000-00 (COD_COBERTURA 11 - VG OU PST    )' */
            ...
            /*" -473- MOVE '6030' TO WNR-EXEC-SQL. */
            _.Move("6030", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -486- PERFORM R6000_00_CANCELA_SEGURO_DB_SELECT_2 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -490- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -492- MOVE 0 TO V0COBA-IMPMORACID V0COBA-PRMAP */
                ...
                else
                {
                    ...
                    /*" -494- DISPLAY 'R6030-00 (ERRO - SELECT APOLICE_COBERTURAS)' */
                    _.Display($"R6030-00 (ERRO - SELECT APOLICE_COBERTURAS)");
            ...
            /*" -498- MOVE '6035' TO WNR-EXEC-SQL. */
            _.Move("6035", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -509- PERFORM R6000_00_CANCELA_SEGURO_DB_SELECT_3 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -514- MOVE 0 TO V0COBA-IMPINVPERM */
                ...
                else
                {
                    ...
                    /*" -516- DISPLAY 'R6030-00 (ERRO - SELECT APOLICE_COBERTURAS)' */
                    _.Display($"R6030-00 (ERRO - SELECT APOLICE_COBERTURAS)");
            ...
            /*" -520- MOVE '6040' TO WNR-EXEC-SQL. */
            _.Move("6040", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -531- PERFORM R6000_00_CANCELA_SEGURO_DB_SELECT_4 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                else
                {
                    ...
                    /*" -538- DISPLAY 'R6040-00 (ERRO - SELECT APOLICE_COBERTURAS)' */
                    _.Display($"R6040-00 (ERRO - SELECT APOLICE_COBERTURAS)");
            ...
            /*" -542- MOVE '6045' TO WNR-EXEC-SQL. */
            _.Move("6045", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -551- PERFORM R6000_00_CANCELA_SEGURO_DB_SELECT_5 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -556- MOVE ZEROS TO CONTACOR-COD-AGENCIA */
                    _.Move(0, CONTACOR.DCLCONTA_CORRENTE.CONTACOR_COD_AGENCIA);

                    /*" -557- MOVE ZEROS TO CONTACOR-NUM-CTA-CORRENTE */
                    _.Move(0, CONTACOR.DCLCONTA_CORRENTE.CONTACOR_NUM_CTA_CORRENTE);

                    /*" -558- MOVE SPACES TO CONTACOR-DAC-CTA-CORRENTE */
                ...
                else
                {
                    ...
                    /*" -560- DISPLAY 'R6045-00 (ERRO - SELECT APOLICE_COBERTURAS)' */
                    _.Display($"R6045-00 (ERRO - SELECT APOLICE_COBERTURAS)");
            ...
            /*" -572- MOVE SISTEMAS-DATA-MOV-ABERTO TO MOVIMVGA-DATA-MOVIMENTO MOVIMVGA-DATA-OPERACAO. */
            ...
            /*" -574- MOVE '6005' TO WNR-EXEC-SQL. */
            _.Move("6005", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -579- PERFORM R6000_00_CANCELA_SEGURO_DB_SELECT_6 */
            ...
            /*" -0- FLUXCONTROL_PERFORM R6000_10_PROX_PROP */
        ...
        [StopWatch]
        /*" R6000-10-PROX-PROP */
        private void R6000_10_PROX_PROP(bool isPerform = false)
        {
            /*" -589- COMPUTE FONTES-ULT-PROP-AUTOMAT = FONTES-ULT-PROP-AUTOMAT + 1. */
            FONTES.DCLFONTES.FONTES_ULT_PROP_AUTOMAT.Value = FONTES.DCLFONTES.FONTES_ULT_PROP_AUTOMAT + 1;

            /*" -591- MOVE '6010' TO WNR-EXEC-SQL. */
            _.Move("6010", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -596- PERFORM R6000_10_PROX_PROP_DB_UPDATE_1 */

            R6000_10_PROX_PROP_DB_UPDATE_1();
            ...
            /*" -605- MOVE '6090' TO WNR-EXEC-SQL. */
            _.Move("6090", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -757- PERFORM R6000_10_PROX_PROP_DB_INSERT_1 */

            R6000_10_PROX_PROP_DB_INSERT_1();
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == -803)
                {
                    ...
                    /*" -764- DISPLAY 'PROPOSTA DUPLICADA ' ' ' SEGURVGA-COD-FONTE ' ' FONTES-ULT-PROP-AUTOMAT */

                    $"PROPOSTA DUPLICADA  {SEGURVGA.DCLSEGURADOS_VGAP.SEGURVGA_COD_FONTE} {FONTES.DCLFONTES.FONTES_ULT_PROP_AUTOMAT}"
                    .Display();

                    /*" -765- GO TO R6000-10-PROX-PROP */
                    new Task(() => R6000_10_PROX_PROP()).RunSynchronously(); //GOTO
                ...
                else
                {
                    ...
                    /*" -767- DISPLAY 'R6000-00 (ERRO - INSERT V0MOVIMENTO  )' */
                    _.Display($"R6000-00 (ERRO - INSERT V0MOVIMENTO  )");

                    /*" -770- DISPLAY 'CERTIF: ' SEGURVGA-NUM-CERTIFICADO ' ' 'FONTE:  ' SEGURVGA-COD-FONTE ' ' 'PROPOS: ' FONTES-ULT-PROP-AUTOMAT */
            ...
            /*" -772- ADD 1 TO WACC-CANCELADOS. */
            AREA_DE_WORK.WACC_CANCELADOS.Value = AREA_DE_WORK.WACC_CANCELADOS + 1;

        }

        [StopWatch]
        /*" R6000-10-PROX-PROP-DB-UPDATE-1 */
        public void R6000_10_PROX_PROP_DB_UPDATE_1()
        {
            /*" -596- EXEC SQL UPDATE SEGUROS.FONTES SET ULT_PROP_AUTOMAT = :FONTES-ULT-PROP-AUTOMAT, TIMESTAMP = CURRENT TIMESTAMP WHERE COD_FONTE = :SEGURVGA-COD-FONTE END-EXEC. */

            var r6000_10_PROX_PROP_DB_UPDATE_1_Update1 = new R6000_10_PROX_PROP_DB_UPDATE_1_Update1()
            {
        ...
        public void R6000_10_PROX_PROP_DB_INSERT_1()
        {
            ...
            R6000_10_PROX_PROP_DB_INSERT_1_Insert1.Execute(r6000_10_PROX_PROP_DB_INSERT_1_Insert1);
        ...
        {
            /*" -551- EXEC SQL SELECT COD_AGENCIA, NUM_CTA_CORRENTE, DAC_CTA_CORRENTE INTO :CONTACOR-COD-AGENCIA, :CONTACOR-NUM-CTA-CORRENTE, :CONTACOR-DAC-CTA-CORRENTE FROM SEGUROS.CONTA_CORRENTE WHERE NUM_CERTIFICADO = :SEGURVGA-NUM-CERTIFICADO END-EXEC. */
        ...
        {
            /*" -579- EXEC SQL SELECT ULT_PROP_AUTOMAT INTO :FONTES-ULT-PROP-AUTOMAT FROM SEGUROS.FONTES WHERE COD_FONTE = :SEGURVGA-COD-FONTE END-EXEC. */
