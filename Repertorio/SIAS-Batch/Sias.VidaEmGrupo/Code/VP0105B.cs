...
using Dclgens;
using Copies;
using Sias.VidaEmGrupo.DB2.VP0105B;

namespace Code
{
    public class VP0105B
    {
        ...
        /*"      *                             VOS DA CEF QUE  POSSUEM  O SEGURO  *      */
        /*"      *                             PREFERENCIAL VIDA.                 *      */
        /*"      *                                                                *      */
        ...
        /*"      *                                                                *      */
        /*"      ******************************************************************      */
        /*"      * CONVERSAO PARA O ANO 2000.              MARCEL   28/04/1998.   *      */
        /*"      *----------------------------------------------------------------*      */
        #endregion
        ...
        /*"  03        TRACO.*/
        public VP0105B_TRACO TRACO { get; set; } = new VP0105B_TRACO();
        public class VP0105B_TRACO : VarBasis
        {
            /*"      05    FILLER              PIC  X(132) VALUE ALL '-'.*/
            public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "132", "X(132)"), @"ALL");
            /*"  03        CABEC01.*/
        }
        public VP0105B_CABEC01 CABEC01 { get; set; } = new VP0105B_CABEC01();
        public class VP0105B_CABEC01 : VarBasis
        {
            ...
            public StringBasis FILLER_3 { get; set; } = new StringBasis(new PIC("X", "38", "X(038)"), @"");
        ...
        public VP0105B_CABEC02 CABEC02 { get; set; } = new VP0105B_CABEC02();
        public class VP0105B_CABEC02 : VarBasis
        {
            /*"      05    FILLER              PIC  X(007) VALUE 'VP0105B'.*/
            public StringBasis FILLER_5 { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"VP0105B");
        ...
        public VP0105B_CABEC02A CABEC02A { get; set; } = new VP0105B_CABEC02A();
        public class VP0105B_CABEC02A : VarBasis
        {
        ...
        public VP0105B_CABEC03 CABEC03 { get; set; } = new VP0105B_CABEC03();
        public class VP0105B_CABEC03 : VarBasis
        {
        ...
        public VP0105B_CABEC03A CABEC03A { get; set; } = new VP0105B_CABEC03A();
        public class VP0105B_CABEC03A : VarBasis
        {
            /*"    05      FILLER          PIC  X(002) VALUE SPACES.*/
        ...
        public VP0105B_CABEC04 CABEC04 { get; set; } = new VP0105B_CABEC04();
        public class VP0105B_CABEC04 : VarBasis
        {
        ...
        public VP0105B_DETALHE DETALHE { get; set; } = new VP0105B_DETALHE();
        public class VP0105B_DETALHE : VarBasis
        {
        ...
        public VP0105B_TOTAL_FILIAL TOTAL_FILIAL { get; set; } = new VP0105B_TOTAL_FILIAL();
        public class VP0105B_TOTAL_FILIAL : VarBasis
        {
            /*"      05    FILLER              PIC  X(059) VALUE SPACES.*/
            public StringBasis FILLER_32 { get; set; } = new StringBasis(new PIC("X", "59", "X(059)"), @"");
        ...
        public VP0105B_TOTAL_GERAL TOTAL_GERAL { get; set; } = new VP0105B_TOTAL_GERAL();
        public class VP0105B_TOTAL_GERAL : VarBasis
        {
            /*"      05    FILLER              PIC  X(059) VALUE SPACES.*/
            public StringBasis FILLER_35 { get; set; } = new StringBasis(new PIC("X", "59", "X(059)"), @"");
        ...
        public VP0105B_WS_VARIAVEIS_ANTERIORES WS_VARIAVEIS_ANTERIORES { get; set; } = new VP0105B_WS_VARIAVEIS_ANTERIORES();
        public class VP0105B_WS_VARIAVEIS_ANTERIORES : VarBasis
        {
        ...
        private _REDEF_VP0105B_FILLER_38 _filler_38 { get; set; }
        public _REDEF_VP0105B_FILLER_38 FILLER_38
        {
            get { _filler_38 = new _REDEF_VP0105B_FILLER_38(); _.Move(WDATA_CURRENT, _filler_38); VarBasis.RedefinePassValue(WDATA_CURRENT, _filler_38, WDATA_CURRENT); _filler_38.ValueChanged += () => { _.Move(_filler_38, WDATA_CURRENT); }; return _filler_38; }
            set { VarBasis.RedefinePassValue(value, _filler_38, WDATA_CURRENT); }
        }  //Redefines
        public class _REDEF_VP0105B_FILLER_38 : VarBasis
        {
            ...
            public _REDEF_VP0105B_FILLER_38()
            {
        ...
        private _REDEF_VP0105B_WS_DATA_HOJE_RD _ws_data_hoje_rd { get; set; }
        public _REDEF_VP0105B_WS_DATA_HOJE_RD WS_DATA_HOJE_RD
        {
            get { _ws_data_hoje_rd = new _REDEF_VP0105B_WS_DATA_HOJE_RD(); _.Move(WS_DATA_HOJE, _ws_data_hoje_rd); VarBasis.RedefinePassValue(WS_DATA_HOJE, _ws_data_hoje_rd, WS_DATA_HOJE); _ws_data_hoje_rd.ValueChanged += () => { _.Move(_ws_data_hoje_rd, WS_DATA_HOJE); }; return _ws_data_hoje_rd; }
            set { VarBasis.RedefinePassValue(value, _ws_data_hoje_rd, WS_DATA_HOJE); }
        }  //Redefines
        public class _REDEF_VP0105B_WS_DATA_HOJE_RD : VarBasis
        {
            ...
            public _REDEF_VP0105B_WS_DATA_HOJE_RD()
            {
        ...
        public VP0105B_WS_HORA_ATUAL WS_HORA_ATUAL { get; set; } = new VP0105B_WS_HORA_ATUAL();
        public class VP0105B_WS_HORA_ATUAL : VarBasis
        {
        ...
        public VP0105B_WS_HORA_CABEC WS_HORA_CABEC { get; set; } = new VP0105B_WS_HORA_CABEC();
        public class VP0105B_WS_HORA_CABEC : VarBasis
        {
        ...
        /*"  03        WABEND.*/
        public VP0105B_WABEND WABEND { get; set; } = new VP0105B_WABEND();
        public class VP0105B_WABEND : VarBasis
        {
            /*"    05      FILLER              PIC  X(010) VALUE           ' VP0105B'.*/
            public StringBasis FILLER_43 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" VP0105B");
        ...
        public VP0105B_TRELAT TRELAT { get; set; } = new VP0105B_TRELAT();
        public VP0105B_TFUNCIOCEF TFUNCIOCEF { get; set; } = new VP0105B_TFUNCIOCEF();
        public VP0105B_TFUNCIOSUR TFUNCIOSUR { get; set; } = new VP0105B_TFUNCIOSUR();
        ...
        {
            /*" -291- MOVE '000-000-PRINCIPAL         ' TO PARAGRAFO. */
            _.Move("000-000-PRINCIPAL         ", WABEND.PARAGRAFO);

            /*" -293- MOVE '000' TO WNR-EXEC-SQL. */
            _.Move("000", WABEND.WNR_EXEC_SQL);

            /*" -294- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

            /*" -297- EXEC SQL WHENEVER SQLERROR GO TO 999-999-ROT-ERRO END-EXEC. */

            /*" -299- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

            /*" -301- PERFORM 010-000-INICIO-PROCESSO. */
        ...
        private void M_010_000_INICIO_PROCESSO(bool isPerform = false)
        {
            ...
            /*" -350- PERFORM 015-000-PROCESSA UNTIL WFIM-RELATORIOS EQUAL 'S' . */
        ...
        {
            /*" -337- EXEC SQL DECLARE TRELAT CURSOR FOR SELECT DATA_SOLICITACAO, NRCOPIAS FROM SEGUROS.V1RELATORIOS WHERE CODRELAT = 'VP0105B' AND SITUACAO = '0' END-EXEC. */
            TRELAT = new VP0105B_TRELAT(false);
        ...
        {
            /*" -339- EXEC SQL OPEN TRELAT END-EXEC. */
        ...
        {
            /*" -531- EXEC SQL DECLARE TFUNCIOCEF CURSOR FOR SELECT A.COD_SUREG, A.COD_UNIDADE, A.NOME_UNIDADE, A.NUM_MATRICULA, A.NOME_FUNCIONARIO, B.NUM_CERTIFICADO, B.NUM_ITEM, B.OCORR_HISTORICO FROM SEGUROS.V0FUNCIOCEF A, SEGUROS.V0SEGURAVG B WHERE A.TIPO_VINCULO <> 'EMPREGADO CEF' AND A.NUM_MATRICULA = B.NUM_MATRICULA AND B.NUM_APOLICE = 93010000890 AND B.COD_SUBGRUPO = 1 AND B.TIPO_SEGURADO = '1' AND B.SIT_REGISTRO = '0' ORDER BY A.COD_SUREG, A.COD_UNIDADE, A.NOME_FUNCIONARIO END-EXEC. */
            TFUNCIOCEF = new VP0105B_TFUNCIOCEF(false);
        ...
        {
            /*" -362- MOVE '012-000-SELECT-V1SISTEMA' TO PARAGRAFO. */
            _.Move("012-000-SELECT-V1SISTEMA", WABEND.PARAGRAFO);

            /*" -364- MOVE '012' TO WNR-EXEC-SQL. */
            _.Move("012", WABEND.WNR_EXEC_SQL);

            /*" -369- PERFORM M_012_000_SELECT_V1SISTEMA_DB_SELECT_1 */
        ...
        {
            /*" -369- EXEC SQL SELECT DTMOVABE, CURRENT DATE INTO :V1SIST-DTMOVABE, :V1SIST-DTCURRENT FROM SEGUROS.V1SISTEMA WHERE IDSISTEM = 'VP' END-EXEC. */
        ...
        {
            /*" -380- MOVE '015-000-PROCESSA          ' TO PARAGRAFO. */
            _.Move("015-000-PROCESSA          ", WABEND.PARAGRAFO);

            /*" -382- MOVE '015' TO WNR-EXEC-SQL. */
            _.Move("015", WABEND.WNR_EXEC_SQL);

            /*" -385- DISPLAY 'INICIO DO DECLARE NA V0FUNCIOCEF' WHORA UPON CONSOLE. */
            _.Display($"INICIO DO DECLARE NA V0FUNCIOCEF{WHORA}");

            /*" -386- IF NRCOPIAS EQUAL 0 */

            if (NRCOPIAS == 0)
            {

                /*" -387- PERFORM 090-000-CURSOR-V0FUNCIOCEF */
            ...
            else
            {
                ...
                /*" -390- PERFORM 091-000-CURSOR-V0FUNCIOSUR. */

                M_091_000_CURSOR_V0FUNCIOSUR_SECTION();
            }


            /*" -391- ACCEPT WHORA FROM TIME. */
            _.Move(_.AcceptDate("TIME"), WHORA);

            /*" -394- DISPLAY 'FIM DO DECLARE NA V0FUNCIOCEF' WHORA UPON CONSOLE. */
            _.Display($"FIM DO DECLARE NA V0FUNCIOCEF{WHORA}");

            /*" -395- IF NRCOPIAS EQUAL 0 */

            if (NRCOPIAS == 0)
            {

                /*" -396- PERFORM 100-000-FETCH-V0FUNCIOCEF */
            ...
            else
            {
                ...
                /*" -399- PERFORM 101-000-FETCH-V0FUNCIOSUR. */

                M_101_000_FETCH_V0FUNCIOSUR_SECTION();
            }


            /*" -401- IF WFIM-FUNCIOCEF EQUAL 'N' NEXT SENTENCE */
            ...
            else
            {
                ...
                /*" -406- DISPLAY ' VP0105B - NAO HOUVE SELECAO DE SEGURADO DO SEGU' 'RO PREFERENCIAL VIDA' */
                _.Display($" VP0105B - NAO HOUVE SELECAO DE SEGURADO DO SEGURO PREFERENCIAL VIDA");
            ...
            /*" -413- PERFORM 020-000-PROCESSA UNTIL WFIM-FUNCIOCEF EQUAL 'S' . */
            ...
            /*" -419- PERFORM M_015_000_PROCESSA_DB_UPDATE_1 */

            M_015_000_PROCESSA_DB_UPDATE_1();

            /*" -423- PERFORM 800-000-TOTAL-GERAL. */

            M_800_000_TOTAL_GERAL_SECTION();

            /*" -424- MOVE 'N' TO WFIM-FUNCIOCEF. */
            _.Move("N", WFIM_FUNCIOCEF);

            /*" -430- MOVE ZEROS TO WTOT-PREMIO-L WTOT-PREMIO-S WTOT-PREMIO-G W-PAGINA W-CONT-LINHA. */
            _.Move(0, WTOT_PREMIO_L, WTOT_PREMIO_S, WTOT_PREMIO_G, W_PAGINA, W_CONT_LINHA);

            /*" -430- PERFORM 102-000-FETCH-V0RELATORIOS. */
        ...
        {
            /*" -419- EXEC SQL UPDATE SEGUROS.V1RELATORIOS SET SITUACAO = '1' WHERE CODRELAT = 'VP0105B' AND SITUACAO = '0' AND NRCOPIAS = :NRCOPIAS END-EXEC. */
        ...
        {
            /*" -439- MOVE FSUREG TO WSUREG-ANT */
            _.Move(FSUREG, WS_VARIAVEIS_ANTERIORES.WSUREG_ANT);

            /*" -440- PERFORM 150-000-SELECT-V0SUREG. */

            M_150_000_SELECT_V0SUREG_SECTION();

            /*" -442- MOVE ZEROS TO WTOT-PREMIO-S. */
            _.Move(0, WTOT_PREMIO_S);

            /*" -446- PERFORM 030-000-TRATA-SUREG UNTIL FSUREG NOT = WSUREG-ANT OR WFIM-FUNCIOCEF EQUAL 'S' . */
            ...
            /*" -446- PERFORM 270-000-TOTAL-SUREG. */
        ...
        {
            /*" -457- MOVE FCOD-UNIDADE TO WS-LOTACAO-ANT */
            _.Move(FCOD_UNIDADE, WS_VARIAVEIS_ANTERIORES.WS_LOTACAO_ANT);

            /*" -458- MOVE FCOD-UNIDADE TO CODLOTACAO-C03. */
            _.Move(FCOD_UNIDADE, CABEC03A.CODLOTACAO_C03);

            /*" -460- MOVE FNOME-UNIDADE TO NOMLOTACAO-C03. */
            _.Move(FNOME_UNIDADE, CABEC03A.NOMLOTACAO_C03);

            /*" -462- PERFORM 265-000-CABECALHO. */

            M_265_000_CABECALHO_SECTION();

            /*" -464- MOVE ZEROS TO WTOT-PREMIO-L. */
            _.Move(0, WTOT_PREMIO_L);

            /*" -468- PERFORM 040-000-TRATA-LOTACAO UNTIL FCOD-UNIDADE NOT = WS-LOTACAO-ANT OR WFIM-FUNCIOCEF EQUAL 'S' . */
            ...
            /*" -468- PERFORM 280-000-TOTAL-LOTACAO. */
        ...
        {
            /*" -481- ADD 1 TO W-LIDOS. */
            W_LIDOS.Value = W_LIDOS + 1;

            /*" -483- PERFORM 8888-DISPLAY-TOTAIS THRU 8888-EXIT */

            M_8888_DISPLAY_TOTAIS_SECTION();
            /*Método Suprimido por falta de linha ou apenas EXIT nome: M_8888_EXIT*/


            /*" -485- PERFORM 230-000-SELECT-V0COBERAPOL. */

            M_230_000_SELECT_V0COBERAPOL_SECTION();

            /*" -487- PERFORM 255-000-MONTA-DETALHE. */

            M_255_000_MONTA_DETALHE_SECTION();

            /*" -489- PERFORM 260-000-IMPRIME-RELACAO. */

            M_260_000_IMPRIME_RELACAO_SECTION();

            /*" -490- IF NRCOPIAS EQUAL 0 */

            if (NRCOPIAS == 0)
            {

                /*" -491- PERFORM 100-000-FETCH-V0FUNCIOCEF */
            ...
            else
            {
                ...
                /*" -492- PERFORM 101-000-FETCH-V0FUNCIOSUR. */
        ...
        {
            /*" -504- MOVE '090-000-CURSOR-V0FUNCIOCEF' TO PARAGRAFO. */
            _.Move("090-000-CURSOR-V0FUNCIOCEF", WABEND.PARAGRAFO);

            /*" -505- MOVE '090' TO WNR-EXEC-SQL. */
            _.Move("090", WABEND.WNR_EXEC_SQL);

            /*" -507- MOVE 'N' TO WFIM-FUNCIOCEF. */
            _.Move("N", WFIM_FUNCIOCEF);

            /*" -531- PERFORM M_090_000_CURSOR_V0FUNCIOCEF_DB_DECLARE_1 */

            M_090_000_CURSOR_V0FUNCIOCEF_DB_DECLARE_1();

            /*" -533- PERFORM M_090_000_CURSOR_V0FUNCIOCEF_DB_OPEN_1 */
        ...
        {
            /*" -533- EXEC SQL OPEN TFUNCIOCEF END-EXEC. */
        ...
        {
            /*" -570- EXEC SQL DECLARE TFUNCIOSUR CURSOR FOR SELECT A.COD_SUREG, A.COD_UNIDADE, A.NOME_UNIDADE, A.NUM_MATRICULA, A.NOME_FUNCIONARIO, B.NUM_CERTIFICADO, B.NUM_ITEM, B.OCORR_HISTORICO FROM SEGUROS.V0FUNCIOCEF A, SEGUROS.V0SEGURAVG B WHERE A.TIPO_VINCULO <> 'EMPREGADO CEF' AND A.NUM_MATRICULA = B.NUM_MATRICULA AND B.NUM_APOLICE = 93010000890 AND B.COD_SUBGRUPO = 1 AND B.TIPO_SEGURADO = '1' AND B.SIT_REGISTRO = '0' AND A.COD_SUREG = :NRCOPIAS ORDER BY A.COD_UNIDADE, A.NOME_FUNCIONARIO END-EXEC. */
            TFUNCIOSUR = new VP0105B_TFUNCIOSUR(true);
        ...
        {
            /*" -543- MOVE '091-000-CURSOR-V0FUNCIOSUR' TO PARAGRAFO. */
            _.Move("091-000-CURSOR-V0FUNCIOSUR", WABEND.PARAGRAFO);

            /*" -544- MOVE '091' TO WNR-EXEC-SQL. */
            _.Move("091", WABEND.WNR_EXEC_SQL);

            /*" -546- MOVE 'N' TO WFIM-FUNCIOCEF. */
            _.Move("N", WFIM_FUNCIOCEF);

            /*" -570- PERFORM M_091_000_CURSOR_V0FUNCIOSUR_DB_DECLARE_1 */

            M_091_000_CURSOR_V0FUNCIOSUR_DB_DECLARE_1();

            /*" -572- PERFORM M_091_000_CURSOR_V0FUNCIOSUR_DB_OPEN_1 */
        ...
        {
            /*" -572- EXEC SQL OPEN TFUNCIOSUR END-EXEC. */
        ...
        private void M_100_000_FETCH_V0FUNCIOCEF_SECTION()
        {
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -603- PERFORM M_100_000_FETCH_V0FUNCIOCEF_DB_CLOSE_1 */

                M_100_000_FETCH_V0FUNCIOCEF_DB_CLOSE_1();

                /*" -604- GO TO 100-999-EXIT. */
        ...
        {
            /*" -599- EXEC SQL FETCH TFUNCIOCEF INTO :FSUREG, :FCOD-UNIDADE, :FNOME-UNIDADE, :FMATRICULA, :FNOME-FUNC, :SNUM-CERTIFICADO, :SNUM-ITEM, :SOCORR-HISTORICO END-EXEC. */
        ...
        {
            /*" -603- EXEC SQL CLOSE TFUNCIOCEF END-EXEC. */
        ...
        {
            /*" -619- MOVE '101-000-FETCH-V0FUNCIOSUR' TO PARAGRAFO. */
            _.Move("101-000-FETCH-V0FUNCIOSUR", WABEND.PARAGRAFO);

            /*" -621- MOVE '101' TO WNR-EXEC-SQL. */
            _.Move("101", WABEND.WNR_EXEC_SQL);

            /*" -631- PERFORM M_101_000_FETCH_V0FUNCIOSUR_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -635- MOVE 'S' TO WFIM-FUNCIOCEF */
                _.Move("S", WFIM_FUNCIOCEF);

                /*" -635- PERFORM M_101_000_FETCH_V0FUNCIOSUR_DB_CLOSE_1 */

                M_101_000_FETCH_V0FUNCIOSUR_DB_CLOSE_1();

                /*" -636- GO TO 101-999-EXIT. */
        ...
        {
            /*" -631- EXEC SQL FETCH TFUNCIOSUR INTO :FSUREG, :FCOD-UNIDADE, :FNOME-UNIDADE, :FMATRICULA, :FNOME-FUNC, :SNUM-CERTIFICADO, :SNUM-ITEM, :SOCORR-HISTORICO END-EXEC. */
        ...
        {
            /*" -635- EXEC SQL CLOSE TFUNCIOSUR END-EXEC. */
        ...
        {
            /*" -646- MOVE '102-000-FETCH-V0RELATORIOS' TO PARAGRAFO. */
            _.Move("102-000-FETCH-V0RELATORIOS", WABEND.PARAGRAFO);

            /*" -648- MOVE '102' TO WNR-EXEC-SQL. */
            _.Move("102", WABEND.WNR_EXEC_SQL);

            /*" -651- PERFORM M_102_000_FETCH_V0RELATORIOS_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -655- MOVE 'S' TO WFIM-RELATORIOS */
                _.Move("S", WFIM_RELATORIOS);

                /*" -655- PERFORM M_102_000_FETCH_V0RELATORIOS_DB_CLOSE_1 */

                M_102_000_FETCH_V0RELATORIOS_DB_CLOSE_1();

                /*" -656- GO TO 102-999-EXIT. */
        ...
        {
            /*" -651- EXEC SQL FETCH TRELAT INTO :DATA-SOLICITACAO, :NRCOPIAS END-EXEC. */
        ...
        {
            /*" -655- EXEC SQL CLOSE TRELAT END-EXEC. */
        ...
        {
            /*" -672- MOVE '150-000-SELECT-V0SUREG' TO PARAGRAFO */
            _.Move("150-000-SELECT-V0SUREG", WABEND.PARAGRAFO);

            /*" -674- MOVE '150' TO WNR-EXEC-SQL. */
            _.Move("150", WABEND.WNR_EXEC_SQL);

            /*" -682- PERFORM M_150_000_SELECT_V0SUREG_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -688- MOVE FSUREG TO SUREG. */
                _.Move(FSUREG, SUREG);
            }


            /*" -689- MOVE FSUREG TO CODFILIAL-C03. */
            _.Move(FSUREG, CABEC03.CODFILIAL_C03);

            /*" -689- MOVE SUREG TO FILIAL-C03. */
        ...
        {
            /*" -682- EXEC SQL SELECT NOME_SUREG INTO :SUREG FROM SEGUROS.V0SUREG WHERE COD_SUREG = :FSUREG END-EXEC. */
        ...
        {
            /*" -705- MOVE '230-000-SELECT-V0COBERAPOL' TO PARAGRAFO. */
            _.Move("230-000-SELECT-V0COBERAPOL", WABEND.PARAGRAFO);

            /*" -707- MOVE '230' TO WNR-EXEC-SQL. */
            _.Move("230", WABEND.WNR_EXEC_SQL);

            /*" -723- PERFORM M_230_000_SELECT_V0COBERAPOL_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -728- MOVE +0 TO CIMP-SEGURADA-IX CPRM-TARIFARIO-IX */
            ...
            else
            {
                ...
                /*" -730- PERFORM 1000-000-COTACAO */

                M_1000_000_COTACAO_SECTION();

                /*" -732- COMPUTE CIMP-SEGURADA-IX = CIMP-SEGURADA-IX * DVLCRUZAD-IMP */
                CIMP_SEGURADA_IX.Value = CIMP_SEGURADA_IX * DVLCRUZAD_IMP;

                /*" -733- COMPUTE CPRM-TARIFARIO-IX = CPRM-TARIFARIO-IX * DVLCRUZAD-PRM. */
        ...
        {
            /*" -723- EXEC SQL SELECT IMP_SEGURADA_IX, PRM_TARIFARIO_IX INTO :CIMP-SEGURADA-IX, :CPRM-TARIFARIO-IX FROM SEGUROS.V0COBERAPOL WHERE NUM_APOLICE = 93010000890 AND NRENDOS = 0 AND NUM_ITEM = :SNUM-ITEM AND OCORHIST = :SOCORR-HISTORICO AND MODALIFR = 0 AND RAMOFR = 93 END-EXEC. */
        ...
        {
            /*" -748- MOVE FMATRICULA TO MATRICULA-DET. */
            _.Move(FMATRICULA, DETALHE.MATRICULA_DET);

            /*" -749- MOVE SNUM-CERTIFICADO TO CERTIF-DET. */
            _.Move(SNUM_CERTIFICADO, DETALHE.CERTIF_DET);

            /*" -750- MOVE FNOME-FUNC TO NOME-DET. */
            _.Move(FNOME_FUNC, DETALHE.NOME_DET);

            /*" -751- MOVE CIMP-SEGURADA-IX TO MORTE-NAT-DET. */
            _.Move(CIMP_SEGURADA_IX, DETALHE.MORTE_NAT_DET);

            /*" -752- COMPUTE WS-MORTE-ACI = CIMP-SEGURADA-IX * 2. */
            WS_MORTE_ACI.Value = CIMP_SEGURADA_IX * 2;

            /*" -754- MOVE WS-MORTE-ACI TO MORTE-ACI-DET INV-PERM-DET. */
            _.Move(WS_MORTE_ACI, DETALHE.MORTE_ACI_DET, DETALHE.INV_PERM_DET);

            /*" -754- MOVE CPRM-TARIFARIO-IX TO PREMIO-DET. */
        ...
        {
            /*" -771- ADD CPRM-TARIFARIO-IX TO WTOT-PREMIO-L WTOT-PREMIO-S WTOT-PREMIO-G. */
            ...
            /*" -772- IF W-CONT-LINHA = 48 */

            if (W_CONT_LINHA == 48)
            {

                /*" -774- PERFORM 265-000-CABECALHO. */

                M_265_000_CABECALHO_SECTION();
            }


            /*" -776- WRITE REG-IMPRESSAO FROM DETALHE AFTER 1. */
            _.Move(DETALHE.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -776- ADD 1 TO W-CONT-LINHA. */
        ...
        {
            /*" -791- ADD 1 TO W-PAGINA */
            W_PAGINA.Value = W_PAGINA + 1;

            /*" -793- MOVE W-PAGINA TO PAGINA-C01 */
            _.Move(W_PAGINA, CABEC01.PAGINA_C01);

            /*" -794- MOVE WS-AA-HOJE TO ANO-C02 */
            _.Move(WS_DATA_HOJE_RD.WS_AA_HOJE, CABEC02.ANO_C02);

            /*" -795- MOVE WS-MM-HOJE TO MES-C02 */
            _.Move(WS_DATA_HOJE_RD.WS_MM_HOJE, CABEC02.MES_C02);

            /*" -797- MOVE WS-DD-HOJE TO DIA-C02 */
            _.Move(WS_DATA_HOJE_RD.WS_DD_HOJE, CABEC02.DIA_C02);

            /*" -798- WRITE REG-IMPRESSAO FROM TRACO AFTER PAGE. */
            _.Move(TRACO.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -799- WRITE REG-IMPRESSAO FROM CABEC01 AFTER 1. */
            _.Move(CABEC01.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -800- WRITE REG-IMPRESSAO FROM CABEC02 AFTER 1. */
            _.Move(CABEC02.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -801- WRITE REG-IMPRESSAO FROM CABEC02A AFTER 1. */
            _.Move(CABEC02A.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -802- WRITE REG-IMPRESSAO FROM TRACO AFTER 1. */
            _.Move(TRACO.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -803- WRITE REG-IMPRESSAO FROM CABEC03 AFTER 1. */
            _.Move(CABEC03.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -804- WRITE REG-IMPRESSAO FROM CABEC03A AFTER 1. */
            _.Move(CABEC03A.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -806- WRITE REG-IMPRESSAO FROM CABEC04 AFTER 2. */
            _.Move(CABEC04.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -807- MOVE SPACES TO REG-IMPRESSAO. */
            _.Move("", REG_IMPRESSAO);

            /*" -809- WRITE REG-IMPRESSAO AFTER 1. */
            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -809- MOVE ZEROS TO W-CONT-LINHA. */
        ...
        {
            /*" -826- MOVE WTOT-PREMIO-S TO DESCONTO-TOT-FL. */
            _.Move(WTOT_PREMIO_S, TOTAL_FILIAL.DESCONTO_TOT_FL);

            /*" -826- WRITE REG-IMPRESSAO FROM TOTAL-FILIAL AFTER 3. */
        ...
        {
            /*" -838- MOVE WTOT-PREMIO-L TO DESCONTO-TOT-FL. */
            _.Move(WTOT_PREMIO_L, TOTAL_FILIAL.DESCONTO_TOT_FL);

            /*" -838- WRITE REG-IMPRESSAO FROM TOTAL-FILIAL AFTER 3. */
            _.Move(TOTAL_FILIAL.GetMoveValues(), REG_IMPRESSAO);
        ...
        {
            /*" -852- IF W-LIDOS EQUAL ZEROS */

            if (W_LIDOS == 00)
            {

                /*" -854- GO TO 800-999-EXIT. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: M_800_999_EXIT*/ //GOTO
                return;
            }


            /*" -856- MOVE WTOT-PREMIO-G TO DESCONTO-GERAL. */
            _.Move(WTOT_PREMIO_G, TOTAL_GERAL.DESCONTO_GERAL);

            /*" -856- WRITE REG-IMPRESSAO FROM TOTAL-GERAL AFTER 2. */
        ...
        private void M_900_000_FINALIZA_SECTION()
        {
            ...
            /*" -872- EXEC SQL COMMIT WORK END-EXEC */

            DatabaseConnection.Instance.CommitTransaction();

            /*" -875- IF W-LIDOS NOT EQUAL ZEROS */
            ...
            if (W_LIDOS != 00)
            {
                ...
                /*" -877- DISPLAY '  TOTAL DE REGISTROS PROCESSADOS.             ' */
                _.Display($"  TOTAL DE REGISTROS PROCESSADOS.             ");

                /*" -878- DISPLAY '      TOTAL DE LIDOS............ ' W-LIDOS */
                _.Display($"      TOTAL DE LIDOS............ {W_LIDOS}");

                /*" -879- DISPLAY '----------------------------------------------' */
                _.Display($"----------------------------------------------");

                /*" -881- DISPLAY 'FIM NORMAL      **** VP0105B ****' . */
                _.Display($"FIM NORMAL      **** VP0105B ****");
            }


            /*" -883- MOVE ZEROS TO RETURN-CODE */
        ...
        private void M_1000_000_COTACAO_SECTION()
        {
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -912- DISPLAY 'VP0105B - NAO EXISTE HISTSEGVG P/ A APOLICE ' */
                _.Display($"VP0105B - NAO EXISTE HISTSEGVG P/ A APOLICE ");

                /*" -914- GO TO 999-999-ROT-ERRO. */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -916- DISPLAY 'VP0105B - ERRO NO SELECT NA V1HISTSEGVG' */
                _.Display($"VP0105B - ERRO NO SELECT NA V1HISTSEGVG");

                /*" -917- GO TO 999-999-ROT-ERRO. */
            ...
            /*" -919- IF ECOD-MOEDA-IMP = 0 OR ECOD-MOEDA-PRM = 0 */

            if (ECOD_MOEDA_IMP == 0 || ECOD_MOEDA_PRM == 0)
            {

                /*" -920- DISPLAY 'VP0105B - V1HISTSEGVG SEM MEODA' */
                _.Display($"VP0105B - V1HISTSEGVG SEM MEODA");

                /*" -921- GO TO 999-999-ROT-ERRO. */
            ...
            /*" -921- PERFORM 1200-ACESSA-V1MOEDA. */
        ...
        {
            /*" -908- EXEC SQL SELECT DATA_MOVIMENTO, VALUE(COD_MOEDA_IMP, 0), VALUE(COD_MOEDA_PRM, 0) INTO :XDATA-MOVIMENTO, :ECOD-MOEDA-IMP, :ECOD-MOEDA-PRM FROM SEGUROS.V1HISTSEGVG WHERE NUM_APOLICE = 93010000890 AND NUM_ITEM = :SNUM-ITEM AND OCORR_HISTORICO = :SOCORR-HISTORICO END-EXEC. */
        ...
        {
            /*" -936- MOVE '1200-ACESSA-V1MOEDA' TO PARAGRAFO. */
            _.Move("1200-ACESSA-V1MOEDA", WABEND.PARAGRAFO);

            /*" -938- MOVE '1200' TO WNR-EXEC-SQL. */
            _.Move("1200", WABEND.WNR_EXEC_SQL);

            /*" -947- PERFORM M_1200_ACESSA_V1MOEDA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -952- DISPLAY 'VP0105B - NAO CONSTA REGISTRO NA V1MOEDA ' ECOD-MOEDA-IMP ' ' XDATA-MOVIMENTO */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -956- DISPLAY 'VP0105B - ERRO NO SELECT  NA V1MOEDA  1 ' */
                _.Display($"VP0105B - ERRO NO SELECT  NA V1MOEDA  1 ");

                /*" -959- GO TO 999-999-ROT-ERRO. */
            ...
            /*" -960- IF ECOD-MOEDA-IMP EQUAL ECOD-MOEDA-PRM */

            if (ECOD_MOEDA_IMP == ECOD_MOEDA_PRM)
            {

                /*" -961- MOVE DVLCRUZAD-IMP TO DVLCRUZAD-PRM */
            ...
            /*" -972- PERFORM M_1200_ACESSA_V1MOEDA_DB_SELECT_2 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -977- DISPLAY 'VP0105B - NAO CONSTA REGISTRO NA V1MOEDA ' ECOD-MOEDA-PRM ' ' XDATA-MOVIMENTO */

                $"VP0105B - NAO CONSTA REGISTRO NA V1MOEDA {ECOD_MOEDA_PRM} {XDATA_MOVIMENTO}"
                .Display();

                /*" -979- GO TO 999-999-ROT-ERRO. */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -981- DISPLAY 'VP0105B - ERRO NO SELECT  NA V1MOEDA  2 ' */
        ...
        {
            /*" -947- EXEC SQL SELECT VLCRUZAD INTO :DVLCRUZAD-IMP FROM SEGUROS.V1MOEDA WHERE CODUNIMO = :ECOD-MOEDA-IMP AND DTINIVIG <= :XDATA-MOVIMENTO AND DTTERVIG >= :XDATA-MOVIMENTO AND SITUACAO = '0' END-EXEC. */
        ...
        {
            /*" -972- EXEC SQL SELECT VLCRUZAD INTO :DVLCRUZAD-PRM FROM SEGUROS.V1MOEDA WHERE CODUNIMO = :ECOD-MOEDA-PRM AND DTINIVIG <= :XDATA-MOVIMENTO AND DTTERVIG >= :XDATA-MOVIMENTO AND SITUACAO = '0' END-EXEC. */
        ...
        {
            /*" -991- ADD 1 TO WS-COUNT ON-COUNTER. */
            TOTAL_GERAL.WS_COUNT.Value = TOTAL_GERAL.WS_COUNT + 1;
            TOTAL_GERAL.ON_COUNTER.Value = TOTAL_GERAL.ON_COUNTER + 1;

            /*" -993- IF WS-COUNT EQUAL 10000 OR ON-COUNTER EQUAL ON-INTERVAL */

            if (TOTAL_GERAL.WS_COUNT == 10000 || TOTAL_GERAL.ON_COUNTER == TOTAL_GERAL.ON_INTERVAL)
            {

                /*" -994- ACCEPT WS-TIME FROM TIME */
                _.Move(_.AcceptDate("TIME"), TOTAL_GERAL.WS_TIME);

                /*" -996- DISPLAY 'FUNC LIDOS -' WS-COUNT ' ' WS-TIME UPON CONSOLE */

                $"FUNC LIDOS -{TOTAL_GERAL.WS_COUNT} {TOTAL_GERAL.WS_TIME}"
                .Display();

                /*" -997- MOVE 0 TO ON-COUNTER. */
                _.Move(0, TOTAL_GERAL.ON_COUNTER);
            }


            /*" -997- GO TO 8888-EXIT. */
            /*Método Suprimido por falta de linha ou apenas EXIT nome: M_8888_EXIT*/ //GOTO
            return;
        ...
        private void M_999_999_ROT_ERRO_SECTION()
        {
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1009- MOVE SQLCODE TO WSQLCODE */
                _.Move(DB.SQLCODE, WABEND.WSQLCODE);

                /*" -1010- MOVE SQLERRD(1) TO WSQLCODE1 */
                _.Move(DB.SQLERRD[1], WABEND.WSQLCODE1);

                /*" -1011- MOVE SQLERRD(2) TO WSQLCODE2 */
                _.Move(DB.SQLERRD[2], WABEND.WSQLCODE2);

                /*" -1012- MOVE SQLCODE TO WSQLCODE3 */
            ...
            /*" -1016- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -1020- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1024- MOVE 9 TO RETURN-CODE */
