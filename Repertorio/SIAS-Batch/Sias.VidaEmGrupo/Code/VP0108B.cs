...
using Dclgens;
using Copies;
using Sias.VidaEmGrupo.DB2.VP0108B;

namespace Code
{
    public class VP0108B
    {
        ...
        /*"      *                                                                *      */
        /*"      *                                                                *      */
        /*"      *   FUNCAO .................  LISTA RELACAO DE SEGURADOS ATIVOS  *      */
        /*"      *                             DA CEF QUE NAO  POSSUEM  O SEGURO*        */
        /*"      *                             PREFERENCIAL VIDA.                 *      */
        /*"      *                                                                *      */
        /*"      *                             LEITURA  TABELAS..: V0FUNCIOCEF    *      */
        /*"      *                                                 V0SUREG        *      */
        /*"      *                                                                *      */
        ...
        /*"  03        TRACO.*/
        public VP0108B_TRACO TRACO { get; set; } = new VP0108B_TRACO();
        public class VP0108B_TRACO : VarBasis
        {
            /*"      05    FILLER              PIC  X(080) VALUE ALL '-'.*/
            public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "80", "X(080)"), @"ALL");
            /*"  03        CABEC01.*/
        }
        public VP0108B_CABEC01 CABEC01 { get; set; } = new VP0108B_CABEC01();
        public class VP0108B_CABEC01 : VarBasis
        {
        ...
        public VP0108B_CABEC02 CABEC02 { get; set; } = new VP0108B_CABEC02();
        public class VP0108B_CABEC02 : VarBasis
        {
            /*"      05    FILLER              PIC  X(007) VALUE 'VP0108B'.*/
            public StringBasis FILLER_5 { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"VP0108B");
            ...
            public StringBasis FILLER_8 { get; set; } = new StringBasis(new PIC("X", "8", "X(008)"), @"");
        ...
        public VP0108B_CABEC02A CABEC02A { get; set; } = new VP0108B_CABEC02A();
        public class VP0108B_CABEC02A : VarBasis
        {
        ...
        public VP0108B_CABEC03 CABEC03 { get; set; } = new VP0108B_CABEC03();
        public class VP0108B_CABEC03 : VarBasis
        {
        ...
        public VP0108B_CABEC03A CABEC03A { get; set; } = new VP0108B_CABEC03A();
        public class VP0108B_CABEC03A : VarBasis
        {
            /*"    05      FILLER          PIC  X(002) VALUE SPACES.*/
        ...
        public VP0108B_CABEC04 CABEC04 { get; set; } = new VP0108B_CABEC04();
        public class VP0108B_CABEC04 : VarBasis
        {
        ...
        public VP0108B_DETALHE DETALHE { get; set; } = new VP0108B_DETALHE();
        public class VP0108B_DETALHE : VarBasis
        {
        ...
        public VP0108B_TOTAL_FILIAL TOTAL_FILIAL { get; set; } = new VP0108B_TOTAL_FILIAL();
        public class VP0108B_TOTAL_FILIAL : VarBasis
        {
        ...
        public VP0108B_TOTAL_GERAL TOTAL_GERAL { get; set; } = new VP0108B_TOTAL_GERAL();
        public class VP0108B_TOTAL_GERAL : VarBasis
        {
            /*"      05    FILLER              PIC  X(019) VALUE SPACES.*/
        ...
        public VP0108B_WS_VARIAVEIS_ANTERIORES WS_VARIAVEIS_ANTERIORES { get; set; } = new VP0108B_WS_VARIAVEIS_ANTERIORES();
        public class VP0108B_WS_VARIAVEIS_ANTERIORES : VarBasis
        {
        ...
        private _REDEF_VP0108B_WS_DATA_HOJE_RD _ws_data_hoje_rd { get; set; }
        public _REDEF_VP0108B_WS_DATA_HOJE_RD WS_DATA_HOJE_RD
        {
            get { _ws_data_hoje_rd = new _REDEF_VP0108B_WS_DATA_HOJE_RD(); _.Move(WS_DATA_HOJE, _ws_data_hoje_rd); VarBasis.RedefinePassValue(WS_DATA_HOJE, _ws_data_hoje_rd, WS_DATA_HOJE); _ws_data_hoje_rd.ValueChanged += () => { _.Move(_ws_data_hoje_rd, WS_DATA_HOJE); }; return _ws_data_hoje_rd; }
            set { VarBasis.RedefinePassValue(value, _ws_data_hoje_rd, WS_DATA_HOJE); }
        }  //Redefines
        public class _REDEF_VP0108B_WS_DATA_HOJE_RD : VarBasis
        {
            ...
            public _REDEF_VP0108B_WS_DATA_HOJE_RD()
            {
        ...
        private _REDEF_VP0108B_FILLER_34 _filler_34 { get; set; }
        public _REDEF_VP0108B_FILLER_34 FILLER_34
        {
            get { _filler_34 = new _REDEF_VP0108B_FILLER_34(); _.Move(WDATA_CURRENT, _filler_34); VarBasis.RedefinePassValue(WDATA_CURRENT, _filler_34, WDATA_CURRENT); _filler_34.ValueChanged += () => { _.Move(_filler_34, WDATA_CURRENT); }; return _filler_34; }
            set { VarBasis.RedefinePassValue(value, _filler_34, WDATA_CURRENT); }
        }  //Redefines
        public class _REDEF_VP0108B_FILLER_34 : VarBasis
        {
            ...
            public _REDEF_VP0108B_FILLER_34()
            {
        ...
        public VP0108B_WS_HORA_ATUAL WS_HORA_ATUAL { get; set; } = new VP0108B_WS_HORA_ATUAL();
        public class VP0108B_WS_HORA_ATUAL : VarBasis
        {
        ...
        public VP0108B_WS_HORA_CABEC WS_HORA_CABEC { get; set; } = new VP0108B_WS_HORA_CABEC();
        public class VP0108B_WS_HORA_CABEC : VarBasis
        {
        ...
        /*"  03        WABEND.*/
        public VP0108B_WABEND WABEND { get; set; } = new VP0108B_WABEND();
        public class VP0108B_WABEND : VarBasis
        {
            /*"    05      FILLER              PIC  X(010) VALUE           ' VP0108B'.*/
            public StringBasis FILLER_39 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" VP0108B");
        ...
        public VP0108B_TRELAT TRELAT { get; set; } = new VP0108B_TRELAT();
        public VP0108B_TFUNCIOCEF TFUNCIOCEF { get; set; } = new VP0108B_TFUNCIOCEF();
        public VP0108B_TFUNCIOSUR TFUNCIOSUR { get; set; } = new VP0108B_TFUNCIOSUR();
        ...
        private void M_010_000_INICIO_PROCESSO(bool isPerform = false)
        {
            ...
            /*" -306- PERFORM 015-000-PROCESSA UNTIL WFIM-RELATORIOS EQUAL 'S' . */
        ...
        {
            /*" -293- EXEC SQL DECLARE TRELAT CURSOR FOR SELECT DATA_SOLICITACAO, NRCOPIAS FROM SEGUROS.V1RELATORIOS WHERE CODRELAT = 'VP0108B' AND SITUACAO = '0' END-EXEC. */
            TRELAT = new VP0108B_TRELAT(false);
        ...
        {
            /*" -295- EXEC SQL OPEN TRELAT END-EXEC. */
        ...
        {
            /*" -472- EXEC SQL DECLARE TFUNCIOCEF CURSOR FOR SELECT COD_SUREG, COD_UNIDADE, NOME_UNIDADE, NUM_MATRICULA, NOME_FUNCIONARIO FROM SEGUROS.V0FUNCIOCEF WHERE TIPO_VINCULO = 'EMPREGADO CEF' AND VALOR3 = 0 ORDER BY COD_SUREG, COD_UNIDADE, NOME_FUNCIONARIO END-EXEC. */
            TFUNCIOCEF = new VP0108B_TFUNCIOCEF(false);
        ...
        {
            /*" -312- MOVE '012-000-PROCESSA       ' TO PARAGRAFO. */
            _.Move("012-000-PROCESSA       ", WABEND.PARAGRAFO);

            /*" -314- MOVE '012' TO WNR-EXEC-SQL. */
            _.Move("012", WABEND.WNR_EXEC_SQL);

            /*" -319- PERFORM M_012_000_SELECT_V1SISTEMA_DB_SELECT_1 */
        ...
        {
            /*" -319- EXEC SQL SELECT DTMOVABE, CURRENT DATE INTO :V1SIST-DTMOVABE, :V1SIST-DTCURRENT FROM SEGUROS.V1SISTEMA WHERE IDSISTEM = 'VP' END-EXEC. */
        ...
        {
            /*" -330- MOVE '015-000-PROCESSA         ' TO PARAGRAFO. */
            _.Move("015-000-PROCESSA         ", WABEND.PARAGRAFO);

            /*" -332- MOVE '015' TO WNR-EXEC-SQL. */
            _.Move("015", WABEND.WNR_EXEC_SQL);

            /*" -335- DISPLAY 'INICIO DO DECLARE NA V0FUNCIOCEF' WHORA UPON CONSOLE. */
            _.Display($"INICIO DO DECLARE NA V0FUNCIOCEF{WHORA}");

            /*" -336- IF NRCOPIAS EQUAL 0 */

            if (NRCOPIAS == 0)
            {

                /*" -337- PERFORM 090-000-CURSOR-V0FUNCIOCEF */
            ...
            else
            {
                ...
                /*" -340- PERFORM 091-000-CURSOR-V0FUNCIOSUR. */

                M_091_000_CURSOR_V0FUNCIOSUR_SECTION();
            }


            /*" -341- ACCEPT WHORA FROM TIME. */
            _.Move(_.AcceptDate("TIME"), WHORA);

            /*" -344- DISPLAY 'FIM DO DECLARE NA V0FUNCIOCEF' WHORA UPON CONSOLE. */
            _.Display($"FIM DO DECLARE NA V0FUNCIOCEF{WHORA}");

            /*" -345- IF NRCOPIAS EQUAL 0 */

            if (NRCOPIAS == 0)
            {

                /*" -346- PERFORM 100-000-FETCH-V0FUNCIOCEF */
            ...
            else
            {
                ...
                /*" -349- PERFORM 101-000-FETCH-V0FUNCIOSUR. */

                M_101_000_FETCH_V0FUNCIOSUR_SECTION();
            }


            /*" -351- IF WFIM-FUNCIOCEF EQUAL 'N' NEXT SENTENCE */
            ...
            else
            {
                ...
                /*" -356- DISPLAY ' VP0108B - NAO HOUVE SELECAO DE SEGURADO DO SEGU' 'RO PREFERENCIAL VIDA' */
                _.Display($" VP0108B - NAO HOUVE SELECAO DE SEGURADO DO SEGURO PREFERENCIAL VIDA");
            ...
            /*" -363- PERFORM 020-000-PROCESSA UNTIL WFIM-FUNCIOCEF EQUAL 'S' . */
            ...
            /*" -369- PERFORM M_015_000_PROCESSA_DB_UPDATE_1 */

            M_015_000_PROCESSA_DB_UPDATE_1();

            /*" -373- PERFORM 800-000-TOTAL-GERAL. */

            M_800_000_TOTAL_GERAL_SECTION();

            /*" -374- MOVE 'N' TO WFIM-FUNCIOCEF. */
            _.Move("N", WFIM_FUNCIOCEF);

            /*" -380- MOVE ZEROS TO WTOT-PREMIO-L WTOT-PREMIO-S WTOT-PREMIO-G W-PAGINA W-CONT-LINHA. */
            _.Move(0, WTOT_PREMIO_L, WTOT_PREMIO_S, WTOT_PREMIO_G, W_PAGINA, W_CONT_LINHA);

            /*" -380- PERFORM 102-000-FETCH-V0RELATORIOS. */
        ...
        {
            /*" -369- EXEC SQL UPDATE SEGUROS.V1RELATORIOS SET SITUACAO = '1' WHERE CODRELAT = 'VP0108B' AND SITUACAO = '0' AND NRCOPIAS = :NRCOPIAS END-EXEC. */
        ...
        {
            /*" -388- MOVE '020-000-PROCESSA         ' TO PARAGRAFO. */
            _.Move("020-000-PROCESSA         ", WABEND.PARAGRAFO);

            /*" -390- MOVE '020' TO WNR-EXEC-SQL. */
            _.Move("020", WABEND.WNR_EXEC_SQL);

            /*" -392- MOVE FSUREG TO WSUREG-ANT */
            _.Move(FSUREG, WS_VARIAVEIS_ANTERIORES.WSUREG_ANT);

            /*" -394- PERFORM 150-000-SELECT-V0SUREG. */

            M_150_000_SELECT_V0SUREG_SECTION();

            /*" -396- MOVE ZEROS TO WTOT-PREMIO-S. */
            _.Move(0, WTOT_PREMIO_S);

            /*" -400- PERFORM 030-000-TRATA-SUREG UNTIL FSUREG NOT = WSUREG-ANT OR WFIM-FUNCIOCEF EQUAL 'S' . */
            ...
            /*" -400- PERFORM 270-000-TOTAL-SUREG. */
        ...
        {
            /*" -409- MOVE '030-000-TRATA-SUREG      ' TO PARAGRAFO. */
            _.Move("030-000-TRATA-SUREG      ", WABEND.PARAGRAFO);

            /*" -411- MOVE '030' TO WNR-EXEC-SQL. */
            _.Move("030", WABEND.WNR_EXEC_SQL);

            /*" -412- MOVE FCOD-UNIDADE TO WS-LOTACAO-ANT */
            _.Move(FCOD_UNIDADE, WS_VARIAVEIS_ANTERIORES.WS_LOTACAO_ANT);

            /*" -413- MOVE FCOD-UNIDADE TO CODLOTACAO-C03. */
            _.Move(FCOD_UNIDADE, CABEC03A.CODLOTACAO_C03);

            /*" -415- MOVE FNOME-UNIDADE TO NOMLOTACAO-C03. */
            _.Move(FNOME_UNIDADE, CABEC03A.NOMLOTACAO_C03);

            /*" -417- PERFORM 265-000-CABECALHO. */

            M_265_000_CABECALHO_SECTION();

            /*" -419- MOVE ZEROS TO WTOT-PREMIO-L. */
            _.Move(0, WTOT_PREMIO_L);

            /*" -423- PERFORM 040-000-TRATA-LOTACAO UNTIL FCOD-UNIDADE NOT = WS-LOTACAO-ANT OR WFIM-FUNCIOCEF EQUAL 'S' . */
            ...
            /*" -423- PERFORM 280-000-TOTAL-LOTACAO. */
        ...
        {
            /*" -432- MOVE '040-000-TRATA-LOTACAO    ' TO PARAGRAFO. */
            _.Move("040-000-TRATA-LOTACAO    ", WABEND.PARAGRAFO);

            /*" -434- MOVE '040' TO WNR-EXEC-SQL. */
            _.Move("040", WABEND.WNR_EXEC_SQL);

            /*" -435- ADD 1 TO W-LIDOS. */
            W_LIDOS.Value = W_LIDOS + 1;

            /*" -437- PERFORM 8888-DISPLAY-TOTAIS THRU 8888-EXIT */

            M_8888_DISPLAY_TOTAIS_SECTION();
            /*Método Suprimido por falta de linha ou apenas EXIT nome: M_8888_EXIT*/


            /*" -439- PERFORM 255-000-MONTA-DETALHE. */

            M_255_000_MONTA_DETALHE_SECTION();

            /*" -441- PERFORM 260-000-IMPRIME-RELACAO. */

            M_260_000_IMPRIME_RELACAO_SECTION();

            /*" -442- IF NRCOPIAS EQUAL 0 */

            if (NRCOPIAS == 0)
            {

                /*" -443- PERFORM 100-000-FETCH-V0FUNCIOCEF */
            ...
            else
            {
                ...
                /*" -444- PERFORM 101-000-FETCH-V0FUNCIOSUR. */
        ...
        {
            /*" -453- MOVE '090-000-CURSOR-V0FUNCIOCEF' TO PARAGRAFO. */
            _.Move("090-000-CURSOR-V0FUNCIOCEF", WABEND.PARAGRAFO);

            /*" -454- MOVE '090' TO WNR-EXEC-SQL. */
            _.Move("090", WABEND.WNR_EXEC_SQL);

            /*" -456- MOVE 'N' TO WFIM-FUNCIOCEF. */
            _.Move("N", WFIM_FUNCIOCEF);

            /*" -472- PERFORM M_090_000_CURSOR_V0FUNCIOCEF_DB_DECLARE_1 */

            M_090_000_CURSOR_V0FUNCIOCEF_DB_DECLARE_1();

            /*" -474- PERFORM M_090_000_CURSOR_V0FUNCIOCEF_DB_OPEN_1 */
        ...
        {
            /*" -474- EXEC SQL OPEN TFUNCIOCEF END-EXEC. */
        ...
        {
            /*" -503- EXEC SQL DECLARE TFUNCIOSUR CURSOR FOR SELECT COD_SUREG, COD_UNIDADE, NOME_UNIDADE, NUM_MATRICULA, NOME_FUNCIONARIO FROM SEGUROS.V0FUNCIOCEF WHERE TIPO_VINCULO = 'EMPREGADO CEF' AND VALOR3 = 0 AND COD_SUREG = :NRCOPIAS ORDER BY COD_SUREG, COD_UNIDADE, NOME_FUNCIONARIO END-EXEC. */
            TFUNCIOSUR = new VP0108B_TFUNCIOSUR(true);
        ...
        {
            /*" -483- MOVE '091-000-CURSOR-V0FUNCIOSUR' TO PARAGRAFO. */
            _.Move("091-000-CURSOR-V0FUNCIOSUR", WABEND.PARAGRAFO);

            /*" -484- MOVE '091' TO WNR-EXEC-SQL. */
            _.Move("091", WABEND.WNR_EXEC_SQL);

            /*" -486- MOVE 'N' TO WFIM-FUNCIOCEF. */
            _.Move("N", WFIM_FUNCIOCEF);

            /*" -503- PERFORM M_091_000_CURSOR_V0FUNCIOSUR_DB_DECLARE_1 */

            M_091_000_CURSOR_V0FUNCIOSUR_DB_DECLARE_1();

            /*" -505- PERFORM M_091_000_CURSOR_V0FUNCIOSUR_DB_OPEN_1 */
        ...
        {
            /*" -505- EXEC SQL OPEN TFUNCIOSUR END-EXEC. */
        ...
        {
            /*" -514- MOVE '100-000-FETCH-V0FUNCIOCEF' TO PARAGRAFO. */
            _.Move("100-000-FETCH-V0FUNCIOCEF", WABEND.PARAGRAFO);

            /*" -516- MOVE '100' TO WNR-EXEC-SQL. */
            _.Move("100", WABEND.WNR_EXEC_SQL);

            /*" -523- PERFORM M_100_000_FETCH_V0FUNCIOCEF_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -527- MOVE 'S' TO WFIM-FUNCIOCEF */
                _.Move("S", WFIM_FUNCIOCEF);

                /*" -527- PERFORM M_100_000_FETCH_V0FUNCIOCEF_DB_CLOSE_1 */

                M_100_000_FETCH_V0FUNCIOCEF_DB_CLOSE_1();

                /*" -528- GO TO 100-999-EXIT. */
        ...
        {
            /*" -523- EXEC SQL FETCH TFUNCIOCEF INTO :FSUREG, :FCOD-UNIDADE, :FNOME-UNIDADE, :FMATRICULA, :FNOME-FUNC END-EXEC. */
        ...
        {
            /*" -527- EXEC SQL CLOSE TFUNCIOCEF END-EXEC */
        ...
        {
            /*" -537- MOVE '101-000-FETCH-V0FUNCIOSUR' TO PARAGRAFO. */
            _.Move("101-000-FETCH-V0FUNCIOSUR", WABEND.PARAGRAFO);

            /*" -539- MOVE '101' TO WNR-EXEC-SQL. */
            _.Move("101", WABEND.WNR_EXEC_SQL);

            /*" -546- PERFORM M_101_000_FETCH_V0FUNCIOSUR_DB_FETCH_1 */

            M_101_000_FETCH_V0FUNCIOSUR_DB_FETCH_1();

            /*" -549- IF SQLCODE EQUAL 100 */

            if (DB.SQLCODE == 100)
            {

                /*" -550- MOVE 'S' TO WFIM-FUNCIOCEF */
                _.Move("S", WFIM_FUNCIOCEF);

                /*" -550- PERFORM M_101_000_FETCH_V0FUNCIOSUR_DB_CLOSE_1 */

                M_101_000_FETCH_V0FUNCIOSUR_DB_CLOSE_1();

                /*" -551- GO TO 101-999-EXIT. */
        ...
        {
            /*" -546- EXEC SQL FETCH TFUNCIOSUR INTO :FSUREG, :FCOD-UNIDADE, :FNOME-UNIDADE, :FMATRICULA, :FNOME-FUNC END-EXEC. */
        ...
        {
            /*" -550- EXEC SQL CLOSE TFUNCIOSUR END-EXEC */
        ...
        {
            /*" -560- MOVE '102-000-FETCH-V0RELATORIO' TO PARAGRAFO. */
            _.Move("102-000-FETCH-V0RELATORIO", WABEND.PARAGRAFO);

            /*" -562- MOVE '102' TO WNR-EXEC-SQL. */
            _.Move("102", WABEND.WNR_EXEC_SQL);

            /*" -566- PERFORM M_102_000_FETCH_V0RELATORIOS_DB_FETCH_1 */

            M_102_000_FETCH_V0RELATORIOS_DB_FETCH_1();

            /*" -569- IF SQLCODE EQUAL 100 */

            if (DB.SQLCODE == 100)
            {

                /*" -570- MOVE 'S' TO WFIM-RELATORIOS */
                _.Move("S", WFIM_RELATORIOS);

                /*" -570- PERFORM M_102_000_FETCH_V0RELATORIOS_DB_CLOSE_1 */

                M_102_000_FETCH_V0RELATORIOS_DB_CLOSE_1();

                /*" -571- GO TO 102-999-EXIT. */
        ...
        {
            /*" -566- EXEC SQL FETCH TRELAT INTO :DATA-SOLICITACAO, :NRCOPIAS END-EXEC. */
        ...
        {
            /*" -570- EXEC SQL CLOSE TRELAT END-EXEC */
        ...
        {
            /*" -587- MOVE '150-000-SELECT-V0SUREG' TO PARAGRAFO */
            _.Move("150-000-SELECT-V0SUREG", WABEND.PARAGRAFO);

            /*" -589- MOVE '150' TO WNR-EXEC-SQL. */
            _.Move("150", WABEND.WNR_EXEC_SQL);

            /*" -597- PERFORM M_150_000_SELECT_V0SUREG_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -603- MOVE FSUREG TO SUREG. */
                _.Move(FSUREG, SUREG);
            }


            /*" -604- MOVE FSUREG TO CODFILIAL-C03. */
            _.Move(FSUREG, CABEC03.CODFILIAL_C03);

            /*" -604- MOVE SUREG TO FILIAL-C03. */
        ...
        {
            /*" -597- EXEC SQL SELECT NOME_SUREG INTO :SUREG FROM SEGUROS.V0SUREG WHERE COD_SUREG = :FSUREG END-EXEC. */
        ...
        {
            /*" -619- MOVE FMATRICULA TO MATRICULA-DET. */
            _.Move(FMATRICULA, DETALHE.MATRICULA_DET);

            /*" -619- MOVE FNOME-FUNC TO NOME-DET. */
        ...
        {
            /*" -656- ADD 1 TO W-PAGINA */
            W_PAGINA.Value = W_PAGINA + 1;

            /*" -658- MOVE W-PAGINA TO PAGINA-C01 */
            _.Move(W_PAGINA, CABEC01.PAGINA_C01);

            /*" -659- MOVE WS-AA-HOJE TO ANO-C02 */
            _.Move(WS_DATA_HOJE_RD.WS_AA_HOJE, CABEC02.ANO_C02);

            /*" -660- MOVE WS-MM-HOJE TO MES-C02 */
            _.Move(WS_DATA_HOJE_RD.WS_MM_HOJE, CABEC02.MES_C02);

            /*" -662- MOVE WS-DD-HOJE TO DIA-C02 */
            _.Move(WS_DATA_HOJE_RD.WS_DD_HOJE, CABEC02.DIA_C02);

            /*" -663- WRITE REG-IMPRESSAO FROM TRACO AFTER PAGE. */
            _.Move(TRACO.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -664- WRITE REG-IMPRESSAO FROM CABEC01 AFTER 1. */
            _.Move(CABEC01.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -665- WRITE REG-IMPRESSAO FROM CABEC02 AFTER 1. */
            _.Move(CABEC02.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -666- WRITE REG-IMPRESSAO FROM CABEC02A AFTER 1. */
            _.Move(CABEC02A.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -667- WRITE REG-IMPRESSAO FROM TRACO AFTER 1. */
            _.Move(TRACO.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -668- WRITE REG-IMPRESSAO FROM CABEC03 AFTER 1. */
            _.Move(CABEC03.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -669- WRITE REG-IMPRESSAO FROM CABEC03A AFTER 1. */
            _.Move(CABEC03A.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -671- WRITE REG-IMPRESSAO FROM CABEC04 AFTER 2. */
            _.Move(CABEC04.GetMoveValues(), REG_IMPRESSAO);

            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -672- MOVE SPACES TO REG-IMPRESSAO. */
            _.Move("", REG_IMPRESSAO);

            /*" -674- WRITE REG-IMPRESSAO AFTER 1. */
            RELPREFV.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -674- MOVE ZEROS TO W-CONT-LINHA. */
        ...
        {
            /*" -704- MOVE WTOT-PREMIO-L TO DESCONTO-TOT-FL. */
            _.Move(WTOT_PREMIO_L, TOTAL_FILIAL.DESCONTO_TOT_FL);

            /*" -704- WRITE REG-IMPRESSAO FROM TOTAL-FILIAL AFTER 3. */
            _.Move(TOTAL_FILIAL.GetMoveValues(), REG_IMPRESSAO);
        ...
        {
            /*" -718- IF W-LIDOS EQUAL ZEROS */

            if (W_LIDOS == 00)
            {

                /*" -720- GO TO 800-999-EXIT. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: M_800_999_EXIT*/ //GOTO
                return;
            }


            /*" -722- MOVE WTOT-PREMIO-G TO DESCONTO-GERAL. */
            _.Move(WTOT_PREMIO_G, TOTAL_GERAL.DESCONTO_GERAL);

            /*" -722- WRITE REG-IMPRESSAO FROM TOTAL-GERAL AFTER 2. */
        ...
        {
            /*" -734- ADD 1 TO WS-COUNT ON-COUNTER. */
            WS_COUNT.Value = WS_COUNT + 1;
            ON_COUNTER.Value = ON_COUNTER + 1;

            /*" -736- IF WS-COUNT EQUAL 10000 OR ON-COUNTER EQUAL ON-INTERVAL */
            ...
            if (WS_COUNT == 10000 || ON_COUNTER == ON_INTERVAL)
            {
                ...
                /*" -738- DISPLAY 'FUNC LIDOS ' WS-COUNT ' ' WS-TIME UPON CONSOLE */

                $"FUNC LIDOS {WS_COUNT} {WS_TIME}"
                .Display();

                /*" -738- MOVE 0 TO ON-COUNTER. */
                _.Move(0, ON_COUNTER);
            }
        ...
        private void M_900_000_FINALIZA_SECTION()
        {
            ...
            /*" -754- IF W-LIDOS NOT EQUAL ZEROS */
            ...
            if (W_LIDOS != 00)
            {
                ...
                /*" -756- DISPLAY '  TOTAL DE REGISTROS PROCESSADOS.             ' */
                _.Display($"  TOTAL DE REGISTROS PROCESSADOS.             ");

                /*" -757- DISPLAY '      TOTAL DE LIDOS............ ' W-LIDOS */
                _.Display($"      TOTAL DE LIDOS............ {W_LIDOS}");

                /*" -758- DISPLAY '----------------------------------------------' */
                _.Display($"----------------------------------------------");

                /*" -760- DISPLAY 'FIM NORMAL      **** VP0108B ****' . */
                _.Display($"FIM NORMAL      **** VP0108B ****");
            }
        ...
        private void M_999_999_ROT_ERRO(bool isPerform = false)
        {
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -776- MOVE SQLCODE TO WSQLCODE */
                _.Move(DB.SQLCODE, WABEND.WSQLCODE);

                /*" -777- MOVE SQLERRD(1) TO WSQLCODE1 */
                _.Move(DB.SQLERRD[1], WABEND.WSQLCODE1);

                /*" -778- MOVE SQLERRD(2) TO WSQLCODE2 */
                _.Move(DB.SQLERRD[2], WABEND.WSQLCODE2);

                /*" -779- MOVE SQLCODE TO WSQLCODE3 */
            ...
            /*" -783- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -787- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -791- MOVE 9 TO RETURN-CODE */
