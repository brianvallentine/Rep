...
{
    public class AC0241B_V0COSCEDCHQ : QueryBasis<AC0241B_V0COSCEDCHQ>
    {
        ...
        public AC0241B_V0COSCEDCHQ() { IsCursor = true; }

        public AC0241B_V0COSCEDCHQ(bool justACursor)
        {
        ...
        public override AC0241B_V0COSCEDCHQ OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0241B_V0COSCEDCHQ();
            var i = 0;
