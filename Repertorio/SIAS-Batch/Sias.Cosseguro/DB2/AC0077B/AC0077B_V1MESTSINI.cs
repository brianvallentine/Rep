...
{
    public class AC0077B_V1MESTSINI : QueryBasis<AC0077B_V1MESTSINI>
    {
        ...
        public AC0077B_V1MESTSINI() { IsCursor = true; }

        public AC0077B_V1MESTSINI(bool justACursor)
        {
        ...
        public override AC0077B_V1MESTSINI OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0077B_V1MESTSINI();
            var i = 0;
