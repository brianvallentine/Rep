...
{
    public class R1800_00_INSERT_V0COSSEG_SINI_DB_INSERT_1_Insert1 : QueryBasis<R1800_00_INSERT_V0COSSEG_SINI_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1800_00_INSERT_V0COSSEG_SINI_DB_INSERT_1_Insert1 r1800_00_INSERT_V0COSSEG_SINI_DB_INSERT_1_Insert1)
        {
            var ths = r1800_00_INSERT_V0COSSEG_SINI_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1800_00_INSERT_V0COSSEG_SINI_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
