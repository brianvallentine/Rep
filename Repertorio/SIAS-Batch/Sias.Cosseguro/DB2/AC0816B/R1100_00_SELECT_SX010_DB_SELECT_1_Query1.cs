...
{
    public class R1100_00_SELECT_SX010_DB_SELECT_1_Query1 : QueryBasis<R1100_00_SELECT_SX010_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            WHERE A.NUM_APOLICE = :V0MSIN-NUM-APOL
            AND A.STA_APOLICE = 'A'
            ...
            */
            ...
            var query = @$"
				SELECT DISTINCT
							...
							,
											SEGUROS.SX_PRODUTO C
											WHERE A.NUM_APOLICE = '{this.V0MSIN_NUM_APOL}'
											AND A.STA_APOLICE = 'A'
											AND B.SEQ_APOLICE = A.SEQ_PROP_APOL
											AND B.STA_ORIGEM_CONTRATO = 'A'
											AND C.COD_PRODUTO = B.COD_PRODUTO
        ...
        public static R1100_00_SELECT_SX010_DB_SELECT_1_Query1 Execute(R1100_00_SELECT_SX010_DB_SELECT_1_Query1 r1100_00_SELECT_SX010_DB_SELECT_1_Query1)
        {
            var ths = r1100_00_SELECT_SX010_DB_SELECT_1_Query1;
        ...
        public override R1100_00_SELECT_SX010_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1100_00_SELECT_SX010_DB_SELECT_1_Query1();
            var i = 0;
