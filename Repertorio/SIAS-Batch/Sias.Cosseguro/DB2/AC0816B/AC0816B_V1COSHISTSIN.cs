...
{
    public class AC0816B_V1COSHISTSIN : QueryBasis<AC0816B_V1COSHISTSIN>
    {
        ...
        public AC0816B_V1COSHISTSIN() { IsCursor = true; }

        public AC0816B_V1COSHISTSIN(bool justACursor)
        {
        ...
        public override AC0816B_V1COSHISTSIN OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0816B_V1COSHISTSIN();
            var i = 0;
