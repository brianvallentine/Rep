...
{
    public class AC0010B_V2HISTOPARC : QueryBasis<AC0010B_V2HISTOPARC>
    {
        ...
        public AC0010B_V2HISTOPARC() { IsCursor = true; }

        public AC0010B_V2HISTOPARC(bool justACursor)
        {
        ...
        public override AC0010B_V2HISTOPARC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0010B_V2HISTOPARC();
            var i = 0;
