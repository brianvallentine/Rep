...
{
    public class AC0010B_V1APOLCOSCED : QueryBasis<AC0010B_V1APOLCOSCED>
    {
        ...
        public AC0010B_V1APOLCOSCED() { IsCursor = true; }

        public AC0010B_V1APOLCOSCED(bool justACursor)
        {
        ...
        public override AC0010B_V1APOLCOSCED OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0010B_V1APOLCOSCED();
            var i = 0;
