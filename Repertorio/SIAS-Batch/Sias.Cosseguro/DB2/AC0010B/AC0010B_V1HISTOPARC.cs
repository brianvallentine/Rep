...
{
    public class AC0010B_V1HISTOPARC : QueryBasis<AC0010B_V1HISTOPARC>
    {
        ...
        public AC0010B_V1HISTOPARC() { IsCursor = true; }

        public AC0010B_V1HISTOPARC(bool justACursor)
        {
        ...
        public override AC0010B_V1HISTOPARC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0010B_V1HISTOPARC();
            var i = 0;
