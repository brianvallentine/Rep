...
{
    public class R2600_00_INSERT_COSSEG_PREM_DB_INSERT_1_Insert1 : QueryBasis<R2600_00_INSERT_COSSEG_PREM_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2600_00_INSERT_COSSEG_PREM_DB_INSERT_1_Insert1 r2600_00_INSERT_COSSEG_PREM_DB_INSERT_1_Insert1)
        {
            var ths = r2600_00_INSERT_COSSEG_PREM_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2600_00_INSERT_COSSEG_PREM_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
