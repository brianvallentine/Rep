...
{
    public class R2900_00_INSERT_V0COSSEG_HIST_DB_INSERT_1_Insert1 : QueryBasis<R2900_00_INSERT_V0COSSEG_HIST_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2900_00_INSERT_V0COSSEG_HIST_DB_INSERT_1_Insert1 r2900_00_INSERT_V0COSSEG_HIST_DB_INSERT_1_Insert1)
        {
            var ths = r2900_00_INSERT_V0COSSEG_HIST_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2900_00_INSERT_V0COSSEG_HIST_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
