...
{
    public class R2700_00_INSERT_V0COSSEG_PREM_DB_INSERT_1_Insert1 : QueryBasis<R2700_00_INSERT_V0COSSEG_PREM_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2700_00_INSERT_V0COSSEG_PREM_DB_INSERT_1_Insert1 r2700_00_INSERT_V0COSSEG_PREM_DB_INSERT_1_Insert1)
        {
            var ths = r2700_00_INSERT_V0COSSEG_PREM_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2700_00_INSERT_V0COSSEG_PREM_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
