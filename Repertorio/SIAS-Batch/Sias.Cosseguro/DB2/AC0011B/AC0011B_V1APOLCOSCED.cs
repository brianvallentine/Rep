...
{
    public class AC0011B_V1APOLCOSCED : QueryBasis<AC0011B_V1APOLCOSCED>
    {
        ...
        public AC0011B_V1APOLCOSCED() { IsCursor = true; }

        public AC0011B_V1APOLCOSCED(bool justACursor)
        {
        ...
        public override AC0011B_V1APOLCOSCED OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0011B_V1APOLCOSCED();
            var i = 0;
