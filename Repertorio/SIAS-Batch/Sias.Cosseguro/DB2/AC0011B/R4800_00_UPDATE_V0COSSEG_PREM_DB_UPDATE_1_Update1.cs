...
{
    public class R4800_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1 : QueryBasis<R4800_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
				...
				AND NUM_ORDEM =  '{this.V2CPRE_NUM_ORDEM}'
        ...
        public static void Execute(R4800_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1 r4800_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1)
        {
            var ths = r4800_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4800_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
