...
{
    public class R4700_00_INSERT_V0COSSEG_HPRE_DB_INSERT_1_Insert1 : QueryBasis<R4700_00_INSERT_V0COSSEG_HPRE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string V2CHIS_SIT_LIBRECUP { get; set; }
        public string VIND_SIT_LIBR { get; set; }
        public string V2CHIS_NUMOCOR { get; set; }
        public string VIND_NUM_OCOR { get; set; }

        public static void Execute(R4700_00_INSERT_V0COSSEG_HPRE_DB_INSERT_1_Insert1 r4700_00_INSERT_V0COSSEG_HPRE_DB_INSERT_1_Insert1)
        {
            var ths = r4700_00_INSERT_V0COSSEG_HPRE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4700_00_INSERT_V0COSSEG_HPRE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
