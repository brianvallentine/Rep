...
{
    public class R2400_00_UPDATE_V0COSHISTSIN_DB_UPDATE_1_Update1 : QueryBasis<R2400_00_UPDATE_V0COSHISTSIN_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R2400_00_UPDATE_V0COSHISTSIN_DB_UPDATE_1_Update1 r2400_00_UPDATE_V0COSHISTSIN_DB_UPDATE_1_Update1)
        {
            var ths = r2400_00_UPDATE_V0COSHISTSIN_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2400_00_UPDATE_V0COSHISTSIN_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
