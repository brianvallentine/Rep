...
{
    public class R2400_10_INSERE_V0COSSEG_HSIN_DB_INSERT_1_Insert1 : QueryBasis<R2400_10_INSERE_V0COSSEG_HSIN_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string V0CHSI_SIT_LIBRECUP { get; set; }
        public string VIND_SIT_LIBR { get; set; }

        public static void Execute(R2400_10_INSERE_V0COSSEG_HSIN_DB_INSERT_1_Insert1 r2400_10_INSERE_V0COSSEG_HSIN_DB_INSERT_1_Insert1)
        {
            var ths = r2400_10_INSERE_V0COSSEG_HSIN_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2400_10_INSERE_V0COSSEG_HSIN_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
