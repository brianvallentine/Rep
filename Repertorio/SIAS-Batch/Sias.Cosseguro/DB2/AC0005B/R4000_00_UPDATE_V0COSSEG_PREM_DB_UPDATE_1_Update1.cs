...
{
    public class R4000_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1 : QueryBasis<R4000_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R4000_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1 r4000_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1)
        {
            var ths = r4000_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4000_00_UPDATE_V0COSSEG_PREM_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
