...
{
    public class AC0003B_C01_PARCEHIS : QueryBasis<AC0003B_C01_PARCEHIS>
    {
        ...
        public AC0003B_C01_PARCEHIS() { IsCursor = true; }

        public AC0003B_C01_PARCEHIS(bool justACursor)
        {
        ...
        public override AC0003B_C01_PARCEHIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0003B_C01_PARCEHIS();
            var i = 0;
