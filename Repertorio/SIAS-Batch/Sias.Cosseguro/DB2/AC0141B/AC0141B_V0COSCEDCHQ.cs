...
{
    public class AC0141B_V0COSCEDCHQ : QueryBasis<AC0141B_V0COSCEDCHQ>
    {
        ...
        public AC0141B_V0COSCEDCHQ() { IsCursor = true; }

        public AC0141B_V0COSCEDCHQ(bool justACursor)
        {
        ...
        public override AC0141B_V0COSCEDCHQ OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0141B_V0COSCEDCHQ();
            var i = 0;
