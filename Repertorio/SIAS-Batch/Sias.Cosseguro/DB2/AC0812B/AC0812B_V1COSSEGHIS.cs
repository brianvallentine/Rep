...
{
    public class AC0812B_V1COSSEGHIS : QueryBasis<AC0812B_V1COSSEGHIS>
    {
        ...
        public AC0812B_V1COSSEGHIS() { IsCursor = true; }

        public AC0812B_V1COSSEGHIS(bool justACursor)
        {
        ...
        public override AC0812B_V1COSSEGHIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0812B_V1COSSEGHIS();
            var i = 0;
