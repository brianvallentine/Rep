...
{
    public class R1200_00_DELETE_V0RELATORIOS_DB_DELETE_1_Delete1 : QueryBasis<R1200_00_DELETE_V0RELATORIOS_DB_DELETE_1_Delete1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1200_00_DELETE_V0RELATORIOS_DB_DELETE_1_Delete1 r1200_00_DELETE_V0RELATORIOS_DB_DELETE_1_Delete1)
        {
            var ths = r1200_00_DELETE_V0RELATORIOS_DB_DELETE_1_Delete1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1200_00_DELETE_V0RELATORIOS_DB_DELETE_1_Delete1 OpenData(List<KeyValuePair<string, object>> result)
        {
