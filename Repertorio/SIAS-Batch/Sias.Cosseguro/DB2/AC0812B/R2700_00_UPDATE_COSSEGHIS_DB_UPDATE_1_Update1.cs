...
{
    public class R2700_00_UPDATE_COSSEGHIS_DB_UPDATE_1_Update1 : QueryBasis<R2700_00_UPDATE_COSSEGHIS_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R2700_00_UPDATE_COSSEGHIS_DB_UPDATE_1_Update1 r2700_00_UPDATE_COSSEGHIS_DB_UPDATE_1_Update1)
        {
            var ths = r2700_00_UPDATE_COSSEGHIS_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2700_00_UPDATE_COSSEGHIS_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
