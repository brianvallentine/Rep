...
{
    public class AC0815B_V1COSSEGHIS : QueryBasis<AC0815B_V1COSSEGHIS>
    {
        ...
        public AC0815B_V1COSSEGHIS() { IsCursor = true; }

        public AC0815B_V1COSSEGHIS(bool justACursor)
        {
        ...
        public override AC0815B_V1COSSEGHIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0815B_V1COSSEGHIS();
            var i = 0;
