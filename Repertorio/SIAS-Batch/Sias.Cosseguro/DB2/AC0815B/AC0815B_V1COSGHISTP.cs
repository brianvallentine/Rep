...
{
    public class AC0815B_V1COSGHISTP : QueryBasis<AC0815B_V1COSGHISTP>
    {
        ...
        public AC0815B_V1COSGHISTP() { IsCursor = true; }

        public AC0815B_V1COSGHISTP(bool justACursor)
        {
        ...
        public override AC0815B_V1COSGHISTP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new AC0815B_V1COSGHISTP();
            var i = 0;
