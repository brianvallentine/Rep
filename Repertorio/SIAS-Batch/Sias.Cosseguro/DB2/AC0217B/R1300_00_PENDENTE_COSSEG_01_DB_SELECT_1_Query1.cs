...
{
    public class R1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1 : QueryBasis<R1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND A.DATA_MOVIMENTO <= :SISTEMAS-DATA-MOV-ABERTO
            ...
            var query = @$"
				SELECT VALUE(SUM(A.VAL_OPERACAO * B.NUM_FATOR)
							...
							,
											...
											AND A.DATA_MOVIMENTO <= '{this.SISTEMAS_DATA_MOV_ABERTO}'
											AND B.COD_OPERACAO = A.COD_OPERACAO
        ...
        public static R1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1 Execute(R1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1 r1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1)
        {
            var ths = r1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1;
        ...
        public override R1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1300_00_PENDENTE_COSSEG_01_DB_SELECT_1_Query1();
            var i = 0;
