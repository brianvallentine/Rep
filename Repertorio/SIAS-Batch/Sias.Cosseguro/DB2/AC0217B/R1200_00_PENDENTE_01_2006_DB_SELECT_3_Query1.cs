...
{
    public class R1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1 : QueryBasis<R1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND NUM_ANO_REFER = 2005
            AND NUM_MES_REFER = 11
            AND NUM_DIA_REFER = 30
        ...
        public static R1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1 Execute(R1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1 r1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1)
        {
            var ths = r1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1;
        ...
        public override R1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1200_00_PENDENTE_01_2006_DB_SELECT_3_Query1();
            var i = 0;
