...
using Dclgens;
using Copies;
using Sias.Cosseguro.DB2.AC0241B;

namespace Code
{
    public class AC0241B
    {
        ...
        /*"      *                             PERADO.                            *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *   COPIA DO PROGRAMA AC0041B PARA A EMPRESA 011 - JASS 188194   *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      * TABELA                              VIEW              ACESSO   *      */
        /*"      *------------------------------------ ----------------- -------- *      */
        /*"      * SISTEMAS                            V1SISTEMA         INPUT    *      */
        /*"      * EMPRESAS                            V1EMPRESA         INPUT    *      */
        /*"      * CHEQUE DE COSSEGURO                 V0COSCED-CHEQUE   INPUT    *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *                                                                       */
        #endregion
        ...
        public FileBasis _RAC0241B { get; set; } = new FileBasis(new PIC("X", "0", "X(0)"));

        public FileBasis RAC0241B
        {
            get
            {
                _.Move(REG_AC0241B, _RAC0241B); VarBasis.RedefinePassValue(REG_AC0241B, _RAC0241B, REG_AC0241B); return _RAC0241B;
            }
        }
        /*"01              REG-AC0241B.*/
        public AC0241B_REG_AC0241B REG_AC0241B { get; set; } = new AC0241B_REG_AC0241B();
        public class AC0241B_REG_AC0241B : VarBasis
        {
            /*"  05            REG-AC0241BC       PIC  X(001).*/
            public StringBasis REG_AC0241BC { get; set; } = new StringBasis(new PIC("X", "1", "X(001)."), @"");
            /*"  05            REG-AC0241BL       PIC  X(132).*/
            public StringBasis REG_AC0241BL { get; set; } = new StringBasis(new PIC("X", "132", "X(132)."), @"");
        }
        ...
        /*"01           AREA-DE-WORK.*/
        public AC0241B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new AC0241B_AREA_DE_WORK();
        public class AC0241B_AREA_DE_WORK : VarBasis
        {
            ...
            /*"  05         WDATA-AUX.*/
            public AC0241B_WDATA_AUX WDATA_AUX { get; set; } = new AC0241B_WDATA_AUX();
            public class AC0241B_WDATA_AUX : VarBasis
            {
            ...
            public AC0241B_WDATA_EDIT WDATA_EDIT { get; set; } = new AC0241B_WDATA_EDIT();
            public class AC0241B_WDATA_EDIT : VarBasis
            {
            ...
            public AC0241B_WHORA_CURR WHORA_CURR { get; set; } = new AC0241B_WHORA_CURR();
            public class AC0241B_WHORA_CURR : VarBasis
            {
            ...
            public AC0241B_WHORA_EDIT WHORA_EDIT { get; set; } = new AC0241B_WHORA_EDIT();
            public class AC0241B_WHORA_EDIT : VarBasis
            {
        ...
        public AC0241B_RELATORIO RELATORIO { get; set; } = new AC0241B_RELATORIO();
        public class AC0241B_RELATORIO : VarBasis
        {
            /*"  05         LC01.*/
            public AC0241B_LC01 LC01 { get; set; } = new AC0241B_LC01();
            public class AC0241B_LC01 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0241B_LC02 LC02 { get; set; } = new AC0241B_LC02();
            public class AC0241B_LC02 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0241B_LC03 LC03 { get; set; } = new AC0241B_LC03();
            public class AC0241B_LC03 : VarBasis
            {
                /*"    10       FILLER            PIC  X(002)    VALUE '* '.*/
                public StringBasis FILLER_12 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"* ");
                /*"    10       FILLER            PIC  X(007)    VALUE 'AC0241B'.*/
                public StringBasis FILLER_13 { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"AC0241B");
            ...
            public AC0241B_LC04 LC04 { get; set; } = new AC0241B_LC04();
            public class AC0241B_LC04 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0241B_LC05 LC05 { get; set; } = new AC0241B_LC05();
            public class AC0241B_LC05 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0241B_LC06 LC06 { get; set; } = new AC0241B_LC06();
            public class AC0241B_LC06 : VarBasis
            {
                /*"    10       FILLER            PIC  X(002)    VALUE '* '.*/
            ...
            public AC0241B_LC07 LC07 { get; set; } = new AC0241B_LC07();
            public class AC0241B_LC07 : VarBasis
            {
            ...
            public AC0241B_LC08 LC08 { get; set; } = new AC0241B_LC08();
            public class AC0241B_LC08 : VarBasis
            {
            ...
            public AC0241B_LC09 LC09 { get; set; } = new AC0241B_LC09();
            public class AC0241B_LC09 : VarBasis
            {
            ...
            public AC0241B_LC10 LC10 { get; set; } = new AC0241B_LC10();
            public class AC0241B_LC10 : VarBasis
            {
            ...
            public AC0241B_LC11 LC11 { get; set; } = new AC0241B_LC11();
            public class AC0241B_LC11 : VarBasis
            {
            ...
            public AC0241B_LC12 LC12 { get; set; } = new AC0241B_LC12();
            public class AC0241B_LC12 : VarBasis
            {
                /*"    10       FILLER            PIC  X(006)    VALUE  SPACES.*/
            ...
            public AC0241B_LC13 LC13 { get; set; } = new AC0241B_LC13();
            public class AC0241B_LC13 : VarBasis
            {
            ...
            public AC0241B_LC14 LC14 { get; set; } = new AC0241B_LC14();
            public class AC0241B_LC14 : VarBasis
            {
            ...
            public AC0241B_LC15 LC15 { get; set; } = new AC0241B_LC15();
            public class AC0241B_LC15 : VarBasis
            {
                /*"    10       FILLER            PIC  X(006)    VALUE  SPACES.*/
            ...
            public AC0241B_LD01 LD01 { get; set; } = new AC0241B_LD01();
            public class AC0241B_LD01 : VarBasis
            {
                /*"    10       FILLER            PIC  X(005)    VALUE  SPACES.*/
            ...
            public AC0241B_LD02 LD02 { get; set; } = new AC0241B_LD02();
            public class AC0241B_LD02 : VarBasis
            {
                /*"    10       FILLER            PIC  X(005)    VALUE  SPACES.*/
            ...
            public AC0241B_LD03 LD03 { get; set; } = new AC0241B_LD03();
            public class AC0241B_LD03 : VarBasis
            {
                /*"    10       FILLER            PIC  X(005)    VALUE  SPACES.*/
            ...
            public AC0241B_LD04 LD04 { get; set; } = new AC0241B_LD04();
            public class AC0241B_LD04 : VarBasis
            {
            ...
            public AC0241B_LD05 LD05 { get; set; } = new AC0241B_LD05();
            public class AC0241B_LD05 : VarBasis
            {
                /*"    10       FILLER            PIC  X(004)    VALUE  SPACES.*/
            ...
            public AC0241B_LD06 LD06 { get; set; } = new AC0241B_LD06();
            public class AC0241B_LD06 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0241B_LD07 LD07 { get; set; } = new AC0241B_LD07();
            public class AC0241B_LD07 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0241B_LD08 LD08 { get; set; } = new AC0241B_LD08();
            public class AC0241B_LD08 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0241B_LD09 LD09 { get; set; } = new AC0241B_LD09();
            public class AC0241B_LD09 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0241B_LD10 LD10 { get; set; } = new AC0241B_LD10();
            public class AC0241B_LD10 : VarBasis
            {
                /*"    10       FILLER            PIC  X(004)    VALUE  SPACES.*/
                ...
                /*"    10       LD10-NRCHEQUE.*/
                public AC0241B_LD10_NRCHEQUE LD10_NRCHEQUE { get; set; } = new AC0241B_LD10_NRCHEQUE();
                public class AC0241B_LD10_NRCHEQUE : VarBasis
                {
            ...
            public AC0241B_LD11 LD11 { get; set; } = new AC0241B_LD11();
            public class AC0241B_LD11 : VarBasis
            {
                ...
                /*"    10       LD11-NRCHEQUE.*/
                public AC0241B_LD11_NRCHEQUE LD11_NRCHEQUE { get; set; } = new AC0241B_LD11_NRCHEQUE();
                public class AC0241B_LD11_NRCHEQUE : VarBasis
                {
                ...
                private _REDEF_AC0241B_FILLER_149 _filler_149 { get; set; }
                public _REDEF_AC0241B_FILLER_149 FILLER_149
                {
                    get { _filler_149 = new _REDEF_AC0241B_FILLER_149(); _.Move(LD11_NRCHEQUE, _filler_149); VarBasis.RedefinePassValue(LD11_NRCHEQUE, _filler_149, LD11_NRCHEQUE); _filler_149.ValueChanged += () => { _.Move(_filler_149, LD11_NRCHEQUE); }; return _filler_149; }
                    set { VarBasis.RedefinePassValue(value, _filler_149, LD11_NRCHEQUE); }
                }  //Redefines
                public class _REDEF_AC0241B_FILLER_149 : VarBasis
                {
                    ...
                    public _REDEF_AC0241B_FILLER_149()
                    {
            ...
            public AC0241B_LR01 LR01 { get; set; } = new AC0241B_LR01();
            public class AC0241B_LR01 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '+'.*/
            ...
            public AC0241B_LR02 LR02 { get; set; } = new AC0241B_LR02();
            public class AC0241B_LR02 : VarBasis
            {
            ...
            public AC0241B_LR03 LR03 { get; set; } = new AC0241B_LR03();
            public class AC0241B_LR03 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE 'I'.*/
            ...
            public AC0241B_LR04 LR04 { get; set; } = new AC0241B_LR04();
            public class AC0241B_LR04 : VarBasis
            {
            ...
            public AC0241B_LR05 LR05 { get; set; } = new AC0241B_LR05();
            public class AC0241B_LR05 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE 'I'.*/
            ...
            public AC0241B_LR06 LR06 { get; set; } = new AC0241B_LR06();
            public class AC0241B_LR06 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE 'I'.*/
        ...
        public AC0241B_IDENTIFICA_FORM_DBM IDENTIFICA_FORM_DBM { get; set; } = new AC0241B_IDENTIFICA_FORM_DBM();
        public class AC0241B_IDENTIFICA_FORM_DBM : VarBasis
        {
        ...
        public AC0241B_LK_LINK LK_LINK { get; set; } = new AC0241B_LK_LINK();
        public class AC0241B_LK_LINK : VarBasis
        {
        ...
        public AC0241B_WEXTENSO WEXTENSO { get; set; } = new AC0241B_WEXTENSO();
        public class AC0241B_WEXTENSO : VarBasis
        {
            ...
            /*"  05        WAREA-1.*/
            public AC0241B_WAREA_1 WAREA_1 { get; set; } = new AC0241B_WAREA_1();
            public class AC0241B_WAREA_1 : VarBasis
            {
            ...
            public AC0241B_WAREA_2 WAREA_2 { get; set; } = new AC0241B_WAREA_2();
            public class AC0241B_WAREA_2 : VarBasis
            {
        ...
        public AC0241B_WABEND WABEND { get; set; } = new AC0241B_WABEND();
        public class AC0241B_WABEND : VarBasis
        {
            /*"  05        FILLER              PIC  X(010)     VALUE           ' AC0241B'.*/
            public StringBasis FILLER_182 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" AC0241B");
        ...
        public AC0241B_V0COSCEDCHQ V0COSCEDCHQ { get; set; } = new AC0241B_V0COSCEDCHQ();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string RAC0241B_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                RAC0241B.SetFile(RAC0241B_FILE_NAME_P);
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -637- OPEN OUTPUT RAC0241B. */
            RAC0241B.Open(REG_AC0241B);

            /*" -639- PERFORM R0100-00-SELECT-V1SISTEMA-AC. */

            R0100_00_SELECT_V1SISTEMA_AC_SECTION();

            /*" -641- PERFORM R0150-00-SELECT-V1SISTEMA-FI. */

            R0150_00_SELECT_V1SISTEMA_FI_SECTION();

            /*" -642- IF V1SIST-DTMOVABE-FI NOT EQUAL V1SIST-DTMOVABE-AC */

            if (V1SIST_DTMOVABE_FI != V1SIST_DTMOVABE_AC)
            {

                /*" -643- DISPLAY 'R0000 - DATA DO SISTEMA FI DIFERE DO AC' */
                _.Display($"R0000 - DATA DO SISTEMA FI DIFERE DO AC");

                /*" -644- DISPLAY 'DATA MOVTO FI - ' V1SIST-DTMOVABE-FI */
                _.Display($"DATA MOVTO FI - {V1SIST_DTMOVABE_FI}");

                /*" -645- DISPLAY 'DATA MOVTO AC - ' V1SIST-DTMOVABE-AC */
            ...
            /*" -649- PERFORM R0200-00-SELECT-V1EMPRESA. */

            R0200_00_SELECT_V1EMPRESA_SECTION();

            /*" -655- MOVE ZEROS TO WTOT-GER-SD WTOT-GER-PG WTOT-GER-RC WTOT-GER-DC WTOT-GERAL. */
            ...
            /*" -657- PERFORM R0400-00-DECLARE-V0COSCEDCHQ. */

            R0400_00_DECLARE_V0COSCEDCHQ_SECTION();

            /*" -659- PERFORM R0450-00-FETCH-V0COSCEDCHQ. */

            R0450_00_FETCH_V0COSCEDCHQ_SECTION();

            /*" -660- IF WFIM-V0COSCEDCHQ NOT EQUAL SPACES */

            if (!AREA_DE_WORK.WFIM_V0COSCEDCHQ.IsEmpty())
            {

                /*" -665- GO TO R0000-90-FINALIZA. */
            ...
            /*" -668- PERFORM R0500-00-PROCESSA-CONGENERE UNTIL WFIM-V0COSCEDCHQ NOT EQUAL SPACES. */
            ...
            /*" -673- IF WTOT-GER-SD = ZEROS AND WTOT-GER-PG = ZEROS AND WTOT-GER-RC = ZEROS AND WTOT-GER-DC = ZEROS NEXT SENTENCE */
            ...
            else
            {
                ...
                /*" -674- PERFORM R4000-00-IMPRIME-TOTAL-GERAL. */
        ...
        private void R0000_90_FINALIZA(bool isPerform = false)
        {
            ...
            /*" -683- DISPLAY 'CHEQUE COSSEGURO *** ' . */
            _.Display($"CHEQUE COSSEGURO *** ");

            /*" -684- DISPLAY 'REGISTROS  LIDOS   - ' AC-L-V0COSCEDCHQ. */
            _.Display($"REGISTROS  LIDOS   - {AREA_DE_WORK.AC_L_V0COSCEDCHQ}");

            /*" -686- DISPLAY 'AC0241B - FIM NORMAL ' . */
            _.Display($"AC0241B - FIM NORMAL ");

            /*" -686- EXEC SQL COMMIT WORK END-EXEC. */

            DatabaseConnection.Instance.CommitTransaction();

            /*" -690- MOVE ZEROS TO RETURN-CODE. */
        ...
        {
            /*" -703- MOVE '0100' TO WNR-EXEC-SQL. */
            _.Move("0100", WABEND.WNR_EXEC_SQL);

            /*" -708- PERFORM R0100_00_SELECT_V1SISTEMA_AC_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -712- DISPLAY 'R0100 - ERRO NO SELECT DA V1SISTEMA - AC' */
            ...
            else
            {
                ...
                /*" -714- DISPLAY 'DATA DO MOVIMENTO (AC) - ' V1SIST-DTMOVABE-AC. */
        ...
        {
            /*" -708- EXEC SQL SELECT DTMOVABE INTO :V1SIST-DTMOVABE-AC FROM SEGUROS.V1SISTEMA WHERE IDSISTEM = 'AC' END-EXEC. */
        ...
        {
            /*" -727- MOVE '0150' TO WNR-EXEC-SQL. */
            _.Move("0150", WABEND.WNR_EXEC_SQL);

            /*" -734- PERFORM R0150_00_SELECT_V1SISTEMA_FI_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -738- DISPLAY 'R0150 - ERRO NO SELECT DA V1SISTEMA - FI' */
            ...
            else
            {
                ...
                /*" -740- DISPLAY 'DATA DO MOVIMENTO (FI) - ' V1SIST-DTMOVABE-FI. */
        ...
        {
            /*" -734- EXEC SQL SELECT DTMOVABE, CURRENT DATE INTO :V1SIST-DTMOVABE-FI, :V1SIST-DTCURRENT FROM SEGUROS.V1SISTEMA WHERE IDSISTEM = 'FI' END-EXEC. */
        ...
        {
            /*" -753- MOVE '0200' TO WNR-EXEC-SQL. */
            _.Move("0200", WABEND.WNR_EXEC_SQL);

            /*" -760- PERFORM R0200_00_SELECT_V1EMPRESA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -764- DISPLAY 'R0200 - ERRO NO SELECT DA V1EMPRESA' */
            ...
            else
            {
                ...
                /*" -774- DISPLAY 'R0200 - ERRO NO CALL DA SUB-ROTINA PROALN01' */
        ...
        {
            /*" -760- EXEC SQL SELECT NOME_EMPRESA, CGCCPF INTO :V1EMPR-NOM-EMP, :V1EMPR-CGCCPF FROM SEGUROS.V1EMPRESA WHERE COD_EMPRESA = 99 END-EXEC. */
        ...
        {
            /*" -813- MOVE '0300' TO WNR-EXEC-SQL. */
            _.Move("0300", WABEND.WNR_EXEC_SQL);

            /*" -820- PERFORM R0300_00_SELECT_V1EMPRESA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -825- IF V1EMPR-COD-EMP = 11 */

                    if (V1EMPR_COD_EMP == 11)
                    {

                        /*" -826- MOVE SPACES TO V1EMPR-NOM-EMP */
                        _.Move("", V1EMPR_NOM_EMP);

                        /*" -827- MOVE 'JV1     ' TO V1EMPR-NOM-EMP */
                        _.Move("JV1     ", V1EMPR_NOM_EMP);
                    ...
                    else
                    {
                        ...
                        /*" -829- DISPLAY 'R0300 - ERRO NO SELECT DA V1EMPRESA' */
                        _.Display($"R0300 - ERRO NO SELECT DA V1EMPRESA");

                        /*" -830- DISPLAY 'COD EMPR - ' V1EMPR-COD-EMP */
                ...
                else
                {
                    ...
                    /*" -834- DISPLAY 'R0300 - ERRO NO SELECT DA V1EMPRESA' */
                    _.Display($"R0300 - ERRO NO SELECT DA V1EMPRESA");

                    /*" -835- DISPLAY 'COD EMPR - ' V1EMPR-COD-EMP */
                    _.Display($"COD EMPR - {V1EMPR_COD_EMP}");
        ...
        {
            /*" -820- EXEC SQL SELECT COD_EMPRESA, NOME_EMPRESA INTO :V1EMPR-COD-EMP, :V1EMPR-NOM-EMP FROM SEGUROS.V1EMPRESA WHERE COD_EMPRESA = :V1EMPR-COD-EMP END-EXEC. */
        ...
        {
            /*" -850- MOVE '0400' TO WNR-EXEC-SQL. */
            _.Move("0400", WABEND.WNR_EXEC_SQL);

            /*" -882- PERFORM R0400_00_DECLARE_V0COSCEDCHQ_DB_DECLARE_1 */

            R0400_00_DECLARE_V0COSCEDCHQ_DB_DECLARE_1();

            /*" -884- PERFORM R0400_00_DECLARE_V0COSCEDCHQ_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -888- DISPLAY 'R0400 - ERRO NO DECLARE DA V0COSCED-CHEQUE' */
            ...
            else
            {
                ...
                /*" -890- MOVE SPACES TO WFIM-V0COSCEDCHQ. */
        ...
        {
            /*" -884- EXEC SQL OPEN V0COSCEDCHQ END-EXEC. */
        ...
        {
            /*" -931- PERFORM R0450_10_LER_V0COSCEDCHQ_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -936- MOVE 'S' TO WFIM-V0COSCEDCHQ */
                    _.Move("S", AREA_DE_WORK.WFIM_V0COSCEDCHQ);

                    /*" -936- PERFORM R0450_10_LER_V0COSCEDCHQ_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -939- DISPLAY 'R0450 - ERRO NO FETCH DA V0COSCED-CHEQUE' */
            ...
            else
            {
                ...
                if (V0CCCH_VLPREMIO == 00 && V0CCCH_VLDESCON == 00 && V0CCCH_VLADIFRA == 00 && V0CCCH_VLRCOMIS == 00 && V0CCCH_VLRSINI == 00 && V0CCCH_VLDESPESA == 00 && V0CCCH_VLRHONOR == 00 && V0CCCH_VLRSALVD == 00 && V0CCCH_VLRESSARC == 00 && V0CCCH_VALOR_EDI == 00 && V0CCCH_VALOR_USS == 00 && V0CCCH_VLEQPVNDA == 00 && V0CCCH_VLDESPADM == 00 && V0CCCH_OUTRDEBIT == 00 && V0CCCH_OUTRCREDT == 00 && V0CCCH_VLRSLDANT == 00)
                {
                    ...
                    /*" -958- GO TO R0450-10-LER-V0COSCEDCHQ */
        ...
        {
            /*" -936- EXEC SQL CLOSE V0COSCEDCHQ END-EXEC */
        ...
        {
            /*" -972- MOVE '0500' TO WNR-EXEC-SQL. */
            _.Move("0500", WABEND.WNR_EXEC_SQL);

            /*" -974- PERFORM R0600-00-SELECT-V1CONGENERE. */

            R0600_00_SELECT_V1CONGENERE_SECTION();

            /*" -975- MOVE V1CONG-CONGENER TO LC06-CONGENER. */
            _.Move(V1CONG_CONGENER, RELATORIO.LC06.LC06_CONGENER);

            /*" -977- MOVE V1CONG-NOMECONG TO LC06-NOME-CONG. */
            _.Move(V1CONG_NOMECONG, RELATORIO.LC06.LC06_NOME_CONG);

            /*" -979- PERFORM R3000-00-IMPRIME-CABECALHO. */

            R3000_00_IMPRIME_CABECALHO_SECTION();

            /*" -981- MOVE V0CCCH-VLRSLDANT TO LC07-VLRSLDANT. */
            _.Move(V0CCCH_VLRSLDANT, RELATORIO.LC07.LC07_VLRSLDANT);

            /*" -982- MOVE V0CCCH-DTLIBERA TO WDATA-AUX. */
            _.Move(V0CCCH_DTLIBERA, AREA_DE_WORK.WDATA_AUX);

            /*" -983- MOVE WDATA-DD-AUX TO WDATA-DD-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_DD_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_DD_EDT);

            /*" -984- MOVE WDATA-MM-AUX TO WDATA-MM-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_MM_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_MM_EDT);

            /*" -985- MOVE WDATA-AA-AUX TO WDATA-AA-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_AA_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_AA_EDT);

            /*" -987- MOVE WDATA-EDIT TO LC08-DTLIBERA. */
            _.Move(AREA_DE_WORK.WDATA_EDIT, RELATORIO.LC08.LC08_DTLIBERA);

            /*" -988- MOVE V0CCCH-DTMOVTAC TO WDATA-AUX. */
            _.Move(V0CCCH_DTMOVTAC, AREA_DE_WORK.WDATA_AUX);

            /*" -989- MOVE WDATA-DD-AUX TO WDATA-DD-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_DD_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_DD_EDT);

            /*" -990- MOVE WDATA-MM-AUX TO WDATA-MM-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_MM_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_MM_EDT);

            /*" -991- MOVE WDATA-AA-AUX TO WDATA-AA-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_AA_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_AA_EDT);

            /*" -993- MOVE WDATA-EDIT TO LC08-DTMOVTAC. */
            _.Move(AREA_DE_WORK.WDATA_EDIT, RELATORIO.LC08.LC08_DTMOVTAC);

            /*" -994- MOVE V0CCCH-DTMOVTFI TO WDATA-AUX. */
            _.Move(V0CCCH_DTMOVTFI, AREA_DE_WORK.WDATA_AUX);

            /*" -995- MOVE WDATA-DD-AUX TO WDATA-DD-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_DD_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_DD_EDT);

            /*" -996- MOVE WDATA-MM-AUX TO WDATA-MM-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_MM_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_MM_EDT);

            /*" -997- MOVE WDATA-AA-AUX TO WDATA-AA-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_AA_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_AA_EDT);

            /*" -999- MOVE WDATA-EDIT TO LC13-DTMOVTFI. */
            _.Move(AREA_DE_WORK.WDATA_EDIT, RELATORIO.LC13.LC13_DTMOVTFI);

            /*" -1000- MOVE V0CCCH-VLPREMIO TO LD01-VLPREMIO. */
            _.Move(V0CCCH_VLPREMIO, RELATORIO.LD01.LD01_VLPREMIO);

            /*" -1001- MOVE V0CCCH-VLDESCON TO LD01-VLDESCON. */
            _.Move(V0CCCH_VLDESCON, RELATORIO.LD01.LD01_VLDESCON);

            /*" -1003- MOVE V0CCCH-VLADIFRA TO LD01-VLADIFRA. */
            _.Move(V0CCCH_VLADIFRA, RELATORIO.LD01.LD01_VLADIFRA);

            /*" -1007- COMPUTE WPRM-TOTAL = V0CCCH-VLPREMIO - V0CCCH-VLDESCON + V0CCCH-VLADIFRA. */
            AREA_DE_WORK.WPRM_TOTAL.Value = V0CCCH_VLPREMIO - V0CCCH_VLDESCON + V0CCCH_VLADIFRA;

            /*" -1008- MOVE WPRM-TOTAL TO LD01-PRM-TOTAL. */
            _.Move(AREA_DE_WORK.WPRM_TOTAL, RELATORIO.LD01.LD01_PRM_TOTAL);

            /*" -1010- MOVE V0CCCH-VLRCOMIS TO LD01-VLRCOMIS. */
            _.Move(V0CCCH_VLRCOMIS, RELATORIO.LD01.LD01_VLRCOMIS);

            /*" -1013- COMPUTE WTOT-PAGAR = WPRM-TOTAL - V0CCCH-VLRCOMIS. */
            AREA_DE_WORK.WTOT_PAGAR.Value = AREA_DE_WORK.WPRM_TOTAL - V0CCCH_VLRCOMIS;

            /*" -1015- MOVE WTOT-PAGAR TO LD01-TOT-PAGAR. */
            _.Move(AREA_DE_WORK.WTOT_PAGAR, RELATORIO.LD01.LD01_TOT_PAGAR);

            /*" -1016- MOVE V0CCCH-VLRSINI TO LD02-VLRSINI. */
            _.Move(V0CCCH_VLRSINI, RELATORIO.LD02.LD02_VLRSINI);

            /*" -1017- MOVE V0CCCH-VLDESPESA TO LD02-VLDESPESA. */
            _.Move(V0CCCH_VLDESPESA, RELATORIO.LD02.LD02_VLDESPESA);

            /*" -1018- MOVE V0CCCH-VLRHONOR TO LD02-VLRHONOR. */
            _.Move(V0CCCH_VLRHONOR, RELATORIO.LD02.LD02_VLRHONOR);

            /*" -1019- MOVE V0CCCH-VLRSALVD TO LD02-VLRSALVD. */
            _.Move(V0CCCH_VLRSALVD, RELATORIO.LD02.LD02_VLRSALVD);

            /*" -1021- MOVE V0CCCH-VLRESSARC TO LD02-VLRESSARC. */
            _.Move(V0CCCH_VLRESSARC, RELATORIO.LD02.LD02_VLRESSARC);

            /*" -1027- COMPUTE WTOT-RECUP = V0CCCH-VLRSINI + V0CCCH-VLDESPESA + V0CCCH-VLRHONOR - V0CCCH-VLRSALVD - V0CCCH-VLRESSARC. */
            AREA_DE_WORK.WTOT_RECUP.Value = V0CCCH_VLRSINI + V0CCCH_VLDESPESA + V0CCCH_VLRHONOR - V0CCCH_VLRSALVD - V0CCCH_VLRESSARC;

            /*" -1029- MOVE WTOT-RECUP TO LD02-TOT-RECUP. */
            _.Move(AREA_DE_WORK.WTOT_RECUP, RELATORIO.LD02.LD02_TOT_RECUP);

            /*" -1030- MOVE V0CCCH-VALOR-EDI TO LD03-VALOR-EDI. */
            _.Move(V0CCCH_VALOR_EDI, RELATORIO.LD03.LD03_VALOR_EDI);

            /*" -1031- MOVE V0CCCH-VALOR-USS TO LD03-VALOR-USS. */
            _.Move(V0CCCH_VALOR_USS, RELATORIO.LD03.LD03_VALOR_USS);

            /*" -1032- MOVE V0CCCH-VLEQPVNDA TO LD03-VLEQPVNDA. */
            _.Move(V0CCCH_VLEQPVNDA, RELATORIO.LD03.LD03_VLEQPVNDA);

            /*" -1033- MOVE V0CCCH-VLDESPADM TO LD03-VLDESPADM. */
            _.Move(V0CCCH_VLDESPADM, RELATORIO.LD03.LD03_VLDESPADM);

            /*" -1034- MOVE V0CCCH-OUTRDEBIT TO LD03-OUTRDEBIT. */
            _.Move(V0CCCH_OUTRDEBIT, RELATORIO.LD03.LD03_OUTRDEBIT);

            /*" -1036- MOVE V0CCCH-OUTRCREDT TO LD03-OUTRCREDT. */
            _.Move(V0CCCH_OUTRCREDT, RELATORIO.LD03.LD03_OUTRCREDT);

            /*" -1043- COMPUTE WTOT-DBECR = V0CCCH-VALOR-EDI + V0CCCH-VALOR-USS + V0CCCH-VLEQPVNDA + V0CCCH-VLDESPADM + V0CCCH-OUTRDEBIT - V0CCCH-OUTRCREDT. */
            ...
            else
            {
                ...
                /*" -1085- MOVE 'NAO HOUVE EMISSAO DE CHEQUE - ' TO LD11-TITL-01 */
                _.Move("NAO HOUVE EMISSAO DE CHEQUE - ", RELATORIO.LD11.FILLER_149.LD11_TITL_01);

                /*" -1086- IF WTOT-CONG = ZEROS */

                if (AREA_DE_WORK.WTOT_CONG == 00)
                {

                    /*" -1087- MOVE 'SALDO IGUAL A ZERO' TO LD11-TITL-02 */
                ...
                else
                {
                    ...
                    /*" -1090- MOVE 'SALDO A RECUPERAR' TO LD11-TITL-02. */
        ...
        {
            /*" -1112- MOVE '0600' TO WNR-EXEC-SQL. */
            _.Move("0600", WABEND.WNR_EXEC_SQL);

            /*" -1119- PERFORM R0600_00_SELECT_V1CONGENERE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1123- DISPLAY 'R0600 - ERRO NO SELECT DA V1CONGENERE' */
                _.Display($"R0600 - ERRO NO SELECT DA V1CONGENERE");

                /*" -1124- DISPLAY 'CONGENRE - ' V0CCCH-CONGENER */
        ...
        {
            /*" -1119- EXEC SQL SELECT CONGENER, NOMECONG INTO :V1CONG-CONGENER, :V1CONG-NOMECONG FROM SEGUROS.V1CONGENERE WHERE CONGENER = :V0CCCH-CONGENER END-EXEC. */
        ...
        private void R0700_00_SELECT_V0LOTECHEQUE_SECTION()
        {
            ...
            /*" -1151- PERFORM R0700_00_SELECT_V0LOTECHEQUE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1155- DISPLAY 'R0700 - ERRO NO SELECT DA V0LOTECHEQUE' */
                _.Display($"R0700 - ERRO NO SELECT DA V0LOTECHEQUE");

                /*" -1156- DISPLAY 'CHEQUE INT - ' V0CCCH-NRCHQINT */
                _.Display($"CHEQUE INT - {V0CCCH_NRCHQINT}");

                /*" -1157- DISPLAY 'DV CHQ INT - ' V0CCCH-DVCHQINT */
                _.Display($"DV CHQ INT - {V0CCCH_DVCHQINT}");

                /*" -1157- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -1151- EXEC SQL SELECT BANCO, AGENCIA, NUMCHQ, DIGCHQ, SERCHQ INTO :V0LTCH-BANCO, :V0LTCH-AGENCIA, :V0LTCH-NRCHQEXT, :V0LTCH-DVCHQEXT, :V0LTCH-SERCHQ FROM SEGUROS.V0LOTECHEQUE WHERE CHQINT = :V0CCCH-NRCHQINT AND DIGINT = :V0CCCH-DVCHQINT END-EXEC. */
        ...
        {
            /*" -1170- MOVE '3000' TO WNR-EXEC-SQL. */
            _.Move("3000", WABEND.WNR_EXEC_SQL);

            /*" -1171- ADD 1 TO AC-PAGINA. */
            AREA_DE_WORK.AC_PAGINA.Value = AREA_DE_WORK.AC_PAGINA + 1;

            /*" -1173- MOVE AC-PAGINA TO LC03-PAGINA. */
            _.Move(AREA_DE_WORK.AC_PAGINA, RELATORIO.LC03.LC03_PAGINA);

            /*" -1174- MOVE '1' TO REG-AC0241BC. */
            _.Move("1", REG_AC0241B.REG_AC0241BC);

            /*" -1175- MOVE LC01 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC01, REG_AC0241B.REG_AC0241BL);

            /*" -1177- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1178- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1179- MOVE LC02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC02, REG_AC0241B.REG_AC0241BL);

            /*" -1181- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1182- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1183- MOVE LC03 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC03, REG_AC0241B.REG_AC0241BL);

            /*" -1185- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1186- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1187- MOVE LC04 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC04, REG_AC0241B.REG_AC0241BL);

            /*" -1189- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1190- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1191- MOVE LC05 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC05, REG_AC0241B.REG_AC0241BL);

            /*" -1193- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1194- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1195- MOVE LC02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC02, REG_AC0241B.REG_AC0241BL);

            /*" -1197- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1198- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1199- MOVE LC06 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC06, REG_AC0241B.REG_AC0241BL);

            /*" -1201- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1202- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1203- MOVE LC02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC02, REG_AC0241B.REG_AC0241BL);

            /*" -1205- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1206- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1207- MOVE LC01 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC01, REG_AC0241B.REG_AC0241BL);

            /*" -1209- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1209- MOVE 09 TO AC-LINHAS. */
        ...
        {
            /*" -1222- MOVE '3100' TO WNR-EXEC-SQL. */
            _.Move("3100", WABEND.WNR_EXEC_SQL);

            /*" -1223- MOVE '-' TO REG-AC0241BC. */
            _.Move("-", REG_AC0241B.REG_AC0241BC);

            /*" -1224- MOVE LC07 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC07, REG_AC0241B.REG_AC0241BL);

            /*" -1226- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1227- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1228- MOVE LC08 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC08, REG_AC0241B.REG_AC0241BL);

            /*" -1230- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1232- ADD 04 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 04;

            /*" -1233- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1234- MOVE LC09 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC09, REG_AC0241B.REG_AC0241BL);

            /*" -1236- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1237- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1238- MOVE LC10 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC10, REG_AC0241B.REG_AC0241BL);

            /*" -1240- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1241- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1242- MOVE LD01 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD01, REG_AC0241B.REG_AC0241BL);

            /*" -1244- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1246- ADD 04 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 04;

            /*" -1247- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1248- MOVE LC11 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC11, REG_AC0241B.REG_AC0241BL);

            /*" -1250- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1251- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1252- MOVE LC12 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC12, REG_AC0241B.REG_AC0241BL);

            /*" -1254- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1255- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1256- MOVE LD02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD02, REG_AC0241B.REG_AC0241BL);

            /*" -1258- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1260- ADD 04 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 04;

            /*" -1261- MOVE '-' TO REG-AC0241BC. */
            _.Move("-", REG_AC0241B.REG_AC0241BC);

            /*" -1262- MOVE LC13 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC13, REG_AC0241B.REG_AC0241BL);

            /*" -1264- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1265- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1266- MOVE LC14 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC14, REG_AC0241B.REG_AC0241BL);

            /*" -1268- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1269- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1270- MOVE LC15 TO REG-AC0241BL. */
            _.Move(RELATORIO.LC15, REG_AC0241B.REG_AC0241BL);

            /*" -1272- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1273- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1274- MOVE LD03 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD03, REG_AC0241B.REG_AC0241BL);

            /*" -1276- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1278- ADD 07 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 07;

            /*" -1279- MOVE '-' TO REG-AC0241BC. */
            _.Move("-", REG_AC0241B.REG_AC0241BC);

            /*" -1280- MOVE LD04 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD04, REG_AC0241B.REG_AC0241BL);

            /*" -1282- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1283- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1284- MOVE LD05 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD05, REG_AC0241B.REG_AC0241BL);

            /*" -1286- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1287- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1288- MOVE LD06 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD06, REG_AC0241B.REG_AC0241BL);

            /*" -1290- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1291- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1292- MOVE LD07 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD07, REG_AC0241B.REG_AC0241BL);

            /*" -1294- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1295- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1296- MOVE LD08 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD08, REG_AC0241B.REG_AC0241BL);

            /*" -1298- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1299- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1300- MOVE LD09 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD09, REG_AC0241B.REG_AC0241BL);

            /*" -1302- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1303- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1304- MOVE LD10 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD10, REG_AC0241B.REG_AC0241BL);

            /*" -1306- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1307- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1308- MOVE LD11 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD11, REG_AC0241B.REG_AC0241BL);

            /*" -1310- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1310- ADD 12 TO AC-LINHAS. */
        ...
        {
            /*" -1323- MOVE '3200' TO WNR-EXEC-SQL. */
            _.Move("3200", WABEND.WNR_EXEC_SQL);

            /*" -1324- IF WTOT-CONG < ZEROS */

            if (AREA_DE_WORK.WTOT_CONG < 00)
            {

                /*" -1325- MOVE ZEROS TO WVLR-EXTENSO */
            ...
            else
            {
                ...
                /*" -1341- MOVE SPACES TO LR03-EXTENSO1 */
                _.Move("", RELATORIO.LR03.LR03_EXTENSO1);

                /*" -1342- MOVE SPACES TO LR04-EXTENSO2 */
                _.Move("", RELATORIO.LR04.LR04_EXTENSO2);

                /*" -1345- DISPLAY 'TAMANHO INSUFICIENTE NA WORKING - VALOR - ' WVLR-EXTENSO. */
                _.Display($"TAMANHO INSUFICIENTE NA WORKING - VALOR - {AREA_DE_WORK.WVLR_EXTENSO}");
            }


            /*" -1346- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1347- MOVE LR01 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR01, REG_AC0241B.REG_AC0241BL);

            /*" -1349- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1350- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1351- MOVE LR02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR02, REG_AC0241B.REG_AC0241BL);

            /*" -1353- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1354- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1355- MOVE LR03 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR03, REG_AC0241B.REG_AC0241BL);

            /*" -1357- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1358- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1359- MOVE LR04 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR04, REG_AC0241B.REG_AC0241BL);

            /*" -1361- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1362- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1363- MOVE LR02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR02, REG_AC0241B.REG_AC0241BL);

            /*" -1365- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1366- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1367- MOVE LR02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR02, REG_AC0241B.REG_AC0241BL);

            /*" -1369- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1370- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1371- MOVE LR02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR02, REG_AC0241B.REG_AC0241BL);

            /*" -1373- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1374- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1375- MOVE LR05 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR05, REG_AC0241B.REG_AC0241BL);

            /*" -1377- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1378- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1379- MOVE LR06 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR06, REG_AC0241B.REG_AC0241BL);

            /*" -1381- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1382- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1383- MOVE LR02 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR02, REG_AC0241B.REG_AC0241BL);

            /*" -1385- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1386- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1387- MOVE LR01 TO REG-AC0241BL. */
            _.Move(RELATORIO.LR01, REG_AC0241B.REG_AC0241BL);

            /*" -1389- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1389- ADD 12 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 12;
        ...
        {
            /*" -1402- MOVE '4000' TO WNR-EXEC-SQL. */
            _.Move("4000", WABEND.WNR_EXEC_SQL);

            /*" -1403- MOVE ZEROS TO LC06-CONGENER. */
            _.Move(0, RELATORIO.LC06.LC06_CONGENER);

            /*" -1405- MOVE SPACES TO LC06-NOME-CONG. */
            _.Move("", RELATORIO.LC06.LC06_NOME_CONG);

            /*" -1407- PERFORM R3000-00-IMPRIME-CABECALHO. */

            R3000_00_IMPRIME_CABECALHO_SECTION();

            /*" -1412- COMPUTE WTOT-GERAL = WTOT-GER-PG - WTOT-GER-RC - WTOT-GER-DC - WTOT-GER-SD. */
            ...
            /*" -1413- MOVE WTOT-GER-SD TO LD06-TOT-SDANT. */
            _.Move(AREA_DE_WORK.WTOT_GER_SD, RELATORIO.LD06.LD06_TOT_SDANT);

            /*" -1414- MOVE WTOT-GER-PG TO LD07-TOT-PAGAR. */
            _.Move(AREA_DE_WORK.WTOT_GER_PG, RELATORIO.LD07.LD07_TOT_PAGAR);

            /*" -1415- MOVE WTOT-GER-RC TO LD08-TOT-RECUP. */
            _.Move(AREA_DE_WORK.WTOT_GER_RC, RELATORIO.LD08.LD08_TOT_RECUP);

            /*" -1416- MOVE WTOT-GER-DC TO LD09-TOT-DBECR. */
            _.Move(AREA_DE_WORK.WTOT_GER_DC, RELATORIO.LD09.LD09_TOT_DBECR);

            /*" -1418- MOVE WTOT-GERAL TO LD11-TOT-CONG. */
            _.Move(AREA_DE_WORK.WTOT_GERAL, RELATORIO.LD11.LD11_TOT_CONG);

            /*" -1421- MOVE SPACES TO LD10-NRCHEQUE LD11-NRCHEQUE. */
            _.Move("", RELATORIO.LD10.LD10_NRCHEQUE, RELATORIO.LD11.LD11_NRCHEQUE);

            /*" -1422- MOVE '-' TO REG-AC0241BC. */
            _.Move("-", REG_AC0241B.REG_AC0241BC);

            /*" -1423- MOVE SPACES TO REG-AC0241BL. */
            _.Move("", REG_AC0241B.REG_AC0241BL);

            /*" -1425- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1426- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1427- MOVE LD04 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD04, REG_AC0241B.REG_AC0241BL);

            /*" -1429- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1430- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1431- MOVE LD05 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD05, REG_AC0241B.REG_AC0241BL);

            /*" -1433- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1434- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1435- MOVE LD06 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD06, REG_AC0241B.REG_AC0241BL);

            /*" -1437- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1438- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1439- MOVE LD07 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD07, REG_AC0241B.REG_AC0241BL);

            /*" -1441- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1442- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1443- MOVE LD08 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD08, REG_AC0241B.REG_AC0241BL);

            /*" -1445- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1446- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1447- MOVE LD09 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD09, REG_AC0241B.REG_AC0241BL);

            /*" -1449- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1450- MOVE SPACES TO REG-AC0241BC. */
            _.Move("", REG_AC0241B.REG_AC0241BC);

            /*" -1451- MOVE LD10 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD10, REG_AC0241B.REG_AC0241BL);

            /*" -1453- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1454- MOVE '0' TO REG-AC0241BC. */
            _.Move("0", REG_AC0241B.REG_AC0241BC);

            /*" -1455- MOVE LD11 TO REG-AC0241BL. */
            _.Move(RELATORIO.LD11, REG_AC0241B.REG_AC0241BL);

            /*" -1457- WRITE REG-AC0241B. */
            RAC0241B.Write(REG_AC0241B.GetMoveValues().ToString());

            /*" -1457- ADD 14 TO AC-LINHAS. */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1472- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, WABEND.WSQLCODE);

            /*" -1474- DISPLAY WABEND. */
            _.Display(WABEND);

            /*" -1474- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1478- MOVE 99 TO RETURN-CODE. */
