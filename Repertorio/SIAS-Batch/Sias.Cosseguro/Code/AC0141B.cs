...
using Dclgens;
using Copies;
using Sias.Cosseguro.DB2.AC0141B;

namespace Code
{
    public class AC0141B
    {
        ...
        /*"      *                             PERADO.                            *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *   COPIA DO PROGRAMA AC0041B PARA A EMPRESA 010 - JASS 188194   *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      * TABELA                              VIEW              ACESSO   *      */
        /*"      *------------------------------------ ----------------- -------- *      */
        ...
        public FileBasis _RAC0141B { get; set; } = new FileBasis(new PIC("X", "0", "X(0)"));

        public FileBasis RAC0141B
        {
            get
            {
                _.Move(REG_AC0141B, _RAC0141B); VarBasis.RedefinePassValue(REG_AC0141B, _RAC0141B, REG_AC0141B); return _RAC0141B;
            }
        }
        /*"01         REG-AC0141B.*/
        public AC0141B_REG_AC0141B REG_AC0141B { get; set; } = new AC0141B_REG_AC0141B();
        public class AC0141B_REG_AC0141B : VarBasis
        {
            /*"  05       REG-AC0141BC        PIC  X(001).*/
            public StringBasis REG_AC0141BC { get; set; } = new StringBasis(new PIC("X", "1", "X(001)."), @"");
            /*"  05       REG-AC0141BL        PIC  X(132).*/
            public StringBasis REG_AC0141BL { get; set; } = new StringBasis(new PIC("X", "132", "X(132)."), @"");
        }
        ...
        /*"01           AREA-DE-WORK.*/
        public AC0141B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new AC0141B_AREA_DE_WORK();
        public class AC0141B_AREA_DE_WORK : VarBasis
        {
            ...
            /*"  05         WDATA-AUX.*/
            public AC0141B_WDATA_AUX WDATA_AUX { get; set; } = new AC0141B_WDATA_AUX();
            public class AC0141B_WDATA_AUX : VarBasis
            {
            ...
            public AC0141B_WDATA_EDIT WDATA_EDIT { get; set; } = new AC0141B_WDATA_EDIT();
            public class AC0141B_WDATA_EDIT : VarBasis
            {
            ...
            public AC0141B_WHORA_CURR WHORA_CURR { get; set; } = new AC0141B_WHORA_CURR();
            public class AC0141B_WHORA_CURR : VarBasis
            {
            ...
            public AC0141B_WHORA_EDIT WHORA_EDIT { get; set; } = new AC0141B_WHORA_EDIT();
            public class AC0141B_WHORA_EDIT : VarBasis
            {
        ...
        public AC0141B_RELATORIO RELATORIO { get; set; } = new AC0141B_RELATORIO();
        public class AC0141B_RELATORIO : VarBasis
        {
            /*"  05         LC01.*/
            public AC0141B_LC01 LC01 { get; set; } = new AC0141B_LC01();
            public class AC0141B_LC01 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0141B_LC02 LC02 { get; set; } = new AC0141B_LC02();
            public class AC0141B_LC02 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0141B_LC03 LC03 { get; set; } = new AC0141B_LC03();
            public class AC0141B_LC03 : VarBasis
            {
                /*"    10       FILLER            PIC  X(002)    VALUE '* '.*/
                public StringBasis FILLER_12 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"* ");
                /*"    10       FILLER            PIC  X(007)    VALUE 'AC0141B'.*/
                public StringBasis FILLER_13 { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"AC0141B");
            ...
            public AC0141B_LC04 LC04 { get; set; } = new AC0141B_LC04();
            public class AC0141B_LC04 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0141B_LC05 LC05 { get; set; } = new AC0141B_LC05();
            public class AC0141B_LC05 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '*'.*/
            ...
            public AC0141B_LC06 LC06 { get; set; } = new AC0141B_LC06();
            public class AC0141B_LC06 : VarBasis
            {
                /*"    10       FILLER            PIC  X(002)    VALUE '* '.*/
            ...
            public AC0141B_LC07 LC07 { get; set; } = new AC0141B_LC07();
            public class AC0141B_LC07 : VarBasis
            {
            ...
            public AC0141B_LC08 LC08 { get; set; } = new AC0141B_LC08();
            public class AC0141B_LC08 : VarBasis
            {
            ...
            public AC0141B_LC09 LC09 { get; set; } = new AC0141B_LC09();
            public class AC0141B_LC09 : VarBasis
            {
            ...
            public AC0141B_LC10 LC10 { get; set; } = new AC0141B_LC10();
            public class AC0141B_LC10 : VarBasis
            {
            ...
            public AC0141B_LC11 LC11 { get; set; } = new AC0141B_LC11();
            public class AC0141B_LC11 : VarBasis
            {
            ...
            public AC0141B_LC12 LC12 { get; set; } = new AC0141B_LC12();
            public class AC0141B_LC12 : VarBasis
            {
                /*"    10       FILLER            PIC  X(006)    VALUE  SPACES.*/
            ...
            public AC0141B_LC13 LC13 { get; set; } = new AC0141B_LC13();
            public class AC0141B_LC13 : VarBasis
            {
            ...
            public AC0141B_LC14 LC14 { get; set; } = new AC0141B_LC14();
            public class AC0141B_LC14 : VarBasis
            {
            ...
            public AC0141B_LC15 LC15 { get; set; } = new AC0141B_LC15();
            public class AC0141B_LC15 : VarBasis
            {
                /*"    10       FILLER            PIC  X(006)    VALUE  SPACES.*/
            ...
            public AC0141B_LD01 LD01 { get; set; } = new AC0141B_LD01();
            public class AC0141B_LD01 : VarBasis
            {
                /*"    10       FILLER            PIC  X(005)    VALUE  SPACES.*/
            ...
            public AC0141B_LD02 LD02 { get; set; } = new AC0141B_LD02();
            public class AC0141B_LD02 : VarBasis
            {
                /*"    10       FILLER            PIC  X(005)    VALUE  SPACES.*/
            ...
            public AC0141B_LD03 LD03 { get; set; } = new AC0141B_LD03();
            public class AC0141B_LD03 : VarBasis
            {
                /*"    10       FILLER            PIC  X(005)    VALUE  SPACES.*/
            ...
            public AC0141B_LD04 LD04 { get; set; } = new AC0141B_LD04();
            public class AC0141B_LD04 : VarBasis
            {
            ...
            public AC0141B_LD05 LD05 { get; set; } = new AC0141B_LD05();
            public class AC0141B_LD05 : VarBasis
            {
                /*"    10       FILLER            PIC  X(004)    VALUE  SPACES.*/
            ...
            public AC0141B_LD06 LD06 { get; set; } = new AC0141B_LD06();
            public class AC0141B_LD06 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0141B_LD07 LD07 { get; set; } = new AC0141B_LD07();
            public class AC0141B_LD07 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0141B_LD08 LD08 { get; set; } = new AC0141B_LD08();
            public class AC0141B_LD08 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0141B_LD09 LD09 { get; set; } = new AC0141B_LD09();
            public class AC0141B_LD09 : VarBasis
            {
                /*"    10       FILLER            PIC  X(003)    VALUE '***'.*/
            ...
            public AC0141B_LD10 LD10 { get; set; } = new AC0141B_LD10();
            public class AC0141B_LD10 : VarBasis
            {
                /*"    10       FILLER            PIC  X(004)    VALUE  SPACES.*/
                ...
                /*"    10       LD10-NRCHEQUE.*/
                public AC0141B_LD10_NRCHEQUE LD10_NRCHEQUE { get; set; } = new AC0141B_LD10_NRCHEQUE();
                public class AC0141B_LD10_NRCHEQUE : VarBasis
                {
            ...
            public AC0141B_LD11 LD11 { get; set; } = new AC0141B_LD11();
            public class AC0141B_LD11 : VarBasis
            {
                ...
                /*"    10       LD11-NRCHEQUE.*/
                public AC0141B_LD11_NRCHEQUE LD11_NRCHEQUE { get; set; } = new AC0141B_LD11_NRCHEQUE();
                public class AC0141B_LD11_NRCHEQUE : VarBasis
                {
                ...
                private _REDEF_AC0141B_FILLER_149 _filler_149 { get; set; }
                public _REDEF_AC0141B_FILLER_149 FILLER_149
                {
                    get { _filler_149 = new _REDEF_AC0141B_FILLER_149(); _.Move(LD11_NRCHEQUE, _filler_149); VarBasis.RedefinePassValue(LD11_NRCHEQUE, _filler_149, LD11_NRCHEQUE); _filler_149.ValueChanged += () => { _.Move(_filler_149, LD11_NRCHEQUE); }; return _filler_149; }
                    set { VarBasis.RedefinePassValue(value, _filler_149, LD11_NRCHEQUE); }
                }  //Redefines
                public class _REDEF_AC0141B_FILLER_149 : VarBasis
                {
                    ...
                    public _REDEF_AC0141B_FILLER_149()
                    {
            ...
            public AC0141B_LR01 LR01 { get; set; } = new AC0141B_LR01();
            public class AC0141B_LR01 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE '+'.*/
            ...
            public AC0141B_LR02 LR02 { get; set; } = new AC0141B_LR02();
            public class AC0141B_LR02 : VarBasis
            {
            ...
            public AC0141B_LR03 LR03 { get; set; } = new AC0141B_LR03();
            public class AC0141B_LR03 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE 'I'.*/
            ...
            public AC0141B_LR04 LR04 { get; set; } = new AC0141B_LR04();
            public class AC0141B_LR04 : VarBasis
            {
            ...
            public AC0141B_LR05 LR05 { get; set; } = new AC0141B_LR05();
            public class AC0141B_LR05 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE 'I'.*/
            ...
            public AC0141B_LR06 LR06 { get; set; } = new AC0141B_LR06();
            public class AC0141B_LR06 : VarBasis
            {
                /*"    10       FILLER            PIC  X(001)    VALUE 'I'.*/
        ...
        public AC0141B_IDENTIFICA_FORM_DBM IDENTIFICA_FORM_DBM { get; set; } = new AC0141B_IDENTIFICA_FORM_DBM();
        public class AC0141B_IDENTIFICA_FORM_DBM : VarBasis
        {
        ...
        public AC0141B_LK_LINK LK_LINK { get; set; } = new AC0141B_LK_LINK();
        public class AC0141B_LK_LINK : VarBasis
        {
        ...
        public AC0141B_WEXTENSO WEXTENSO { get; set; } = new AC0141B_WEXTENSO();
        public class AC0141B_WEXTENSO : VarBasis
        {
            ...
            /*"  05        WAREA-1.*/
            public AC0141B_WAREA_1 WAREA_1 { get; set; } = new AC0141B_WAREA_1();
            public class AC0141B_WAREA_1 : VarBasis
            {
            ...
            public AC0141B_WAREA_2 WAREA_2 { get; set; } = new AC0141B_WAREA_2();
            public class AC0141B_WAREA_2 : VarBasis
            {
        ...
        public AC0141B_WABEND WABEND { get; set; } = new AC0141B_WABEND();
        public class AC0141B_WABEND : VarBasis
        {
            /*"  05        FILLER              PIC  X(010)     VALUE           ' AC0141B'.*/
            public StringBasis FILLER_182 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" AC0141B");
        ...
        public AC0141B_V0COSCEDCHQ V0COSCEDCHQ { get; set; } = new AC0141B_V0COSCEDCHQ();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string RAC0141B_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                RAC0141B.SetFile(RAC0141B_FILE_NAME_P);
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -637- OPEN OUTPUT RAC0141B. */
            RAC0141B.Open(REG_AC0141B);
        ...
        private void R0000_90_FINALIZA(bool isPerform = false)
        {
            ...
            /*" -686- DISPLAY 'AC0141B - FIM NORMAL ' . */
            _.Display($"AC0141B - FIM NORMAL ");
        ...
        private void R0200_00_SELECT_V1EMPRESA_SECTION()
        {
            ...
            /*" -777- MOVE 010 TO V1EMPR-COD-EMP. */
            _.Move(010, V1EMPR_COD_EMP);
        ...
        private void R0300_00_SELECT_V1EMPRESA_SECTION()
        {
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -824- DISPLAY 'R0300 - ERRO NO SELECT DA V1EMPRESA' */
                _.Display($"R0300 - ERRO NO SELECT DA V1EMPRESA");

                /*" -825- DISPLAY 'COD EMPR - ' V1EMPR-COD-EMP */
        ...
        {
            /*" -839- MOVE '0400' TO WNR-EXEC-SQL. */
            _.Move("0400", WABEND.WNR_EXEC_SQL);

            /*" -871- PERFORM R0400_00_DECLARE_V0COSCEDCHQ_DB_DECLARE_1 */

            R0400_00_DECLARE_V0COSCEDCHQ_DB_DECLARE_1();

            /*" -873- PERFORM R0400_00_DECLARE_V0COSCEDCHQ_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -877- DISPLAY 'R0400 - ERRO NO DECLARE DA V0COSCED-CHEQUE' */
            ...
            else
            {
                ...
                /*" -879- MOVE SPACES TO WFIM-V0COSCEDCHQ. */
        ...
        {
            /*" -873- EXEC SQL OPEN V0COSCEDCHQ END-EXEC. */
        ...
        {
            /*" -920- PERFORM R0450_10_LER_V0COSCEDCHQ_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -925- MOVE 'S' TO WFIM-V0COSCEDCHQ */
                    _.Move("S", AREA_DE_WORK.WFIM_V0COSCEDCHQ);

                    /*" -925- PERFORM R0450_10_LER_V0COSCEDCHQ_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -928- DISPLAY 'R0450 - ERRO NO FETCH DA V0COSCED-CHEQUE' */
            ...
            else
            {
                ...
                if (V0CCCH_VLPREMIO == 00 && V0CCCH_VLDESCON == 00 && V0CCCH_VLADIFRA == 00 && V0CCCH_VLRCOMIS == 00 && V0CCCH_VLRSINI == 00 && V0CCCH_VLDESPESA == 00 && V0CCCH_VLRHONOR == 00 && V0CCCH_VLRSALVD == 00 && V0CCCH_VLRESSARC == 00 && V0CCCH_VALOR_EDI == 00 && V0CCCH_VALOR_USS == 00 && V0CCCH_VLEQPVNDA == 00 && V0CCCH_VLDESPADM == 00 && V0CCCH_OUTRDEBIT == 00 && V0CCCH_OUTRCREDT == 00 && V0CCCH_VLRSLDANT == 00)
                {
                    ...
                    /*" -947- GO TO R0450-10-LER-V0COSCEDCHQ */
        ...
        {
            /*" -925- EXEC SQL CLOSE V0COSCEDCHQ END-EXEC */
        ...
        {
            /*" -961- MOVE '0500' TO WNR-EXEC-SQL. */
            _.Move("0500", WABEND.WNR_EXEC_SQL);

            /*" -963- PERFORM R0600-00-SELECT-V1CONGENERE. */

            R0600_00_SELECT_V1CONGENERE_SECTION();

            /*" -964- MOVE V1CONG-CONGENER TO LC06-CONGENER. */
            _.Move(V1CONG_CONGENER, RELATORIO.LC06.LC06_CONGENER);

            /*" -966- MOVE V1CONG-NOMECONG TO LC06-NOME-CONG. */
            _.Move(V1CONG_NOMECONG, RELATORIO.LC06.LC06_NOME_CONG);

            /*" -968- PERFORM R3000-00-IMPRIME-CABECALHO. */

            R3000_00_IMPRIME_CABECALHO_SECTION();

            /*" -970- MOVE V0CCCH-VLRSLDANT TO LC07-VLRSLDANT. */
            _.Move(V0CCCH_VLRSLDANT, RELATORIO.LC07.LC07_VLRSLDANT);

            /*" -971- MOVE V0CCCH-DTLIBERA TO WDATA-AUX. */
            _.Move(V0CCCH_DTLIBERA, AREA_DE_WORK.WDATA_AUX);

            /*" -972- MOVE WDATA-DD-AUX TO WDATA-DD-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_DD_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_DD_EDT);

            /*" -973- MOVE WDATA-MM-AUX TO WDATA-MM-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_MM_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_MM_EDT);

            /*" -974- MOVE WDATA-AA-AUX TO WDATA-AA-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_AA_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_AA_EDT);

            /*" -976- MOVE WDATA-EDIT TO LC08-DTLIBERA. */
            _.Move(AREA_DE_WORK.WDATA_EDIT, RELATORIO.LC08.LC08_DTLIBERA);

            /*" -977- MOVE V0CCCH-DTMOVTAC TO WDATA-AUX. */
            _.Move(V0CCCH_DTMOVTAC, AREA_DE_WORK.WDATA_AUX);

            /*" -978- MOVE WDATA-DD-AUX TO WDATA-DD-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_DD_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_DD_EDT);

            /*" -979- MOVE WDATA-MM-AUX TO WDATA-MM-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_MM_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_MM_EDT);

            /*" -980- MOVE WDATA-AA-AUX TO WDATA-AA-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_AA_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_AA_EDT);

            /*" -982- MOVE WDATA-EDIT TO LC08-DTMOVTAC. */
            _.Move(AREA_DE_WORK.WDATA_EDIT, RELATORIO.LC08.LC08_DTMOVTAC);

            /*" -983- MOVE V0CCCH-DTMOVTFI TO WDATA-AUX. */
            _.Move(V0CCCH_DTMOVTFI, AREA_DE_WORK.WDATA_AUX);

            /*" -984- MOVE WDATA-DD-AUX TO WDATA-DD-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_DD_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_DD_EDT);

            /*" -985- MOVE WDATA-MM-AUX TO WDATA-MM-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_MM_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_MM_EDT);

            /*" -986- MOVE WDATA-AA-AUX TO WDATA-AA-EDT. */
            _.Move(AREA_DE_WORK.WDATA_AUX.WDATA_AA_AUX, AREA_DE_WORK.WDATA_EDIT.WDATA_AA_EDT);

            /*" -988- MOVE WDATA-EDIT TO LC13-DTMOVTFI. */
            _.Move(AREA_DE_WORK.WDATA_EDIT, RELATORIO.LC13.LC13_DTMOVTFI);

            /*" -989- MOVE V0CCCH-VLPREMIO TO LD01-VLPREMIO. */
            _.Move(V0CCCH_VLPREMIO, RELATORIO.LD01.LD01_VLPREMIO);

            /*" -990- MOVE V0CCCH-VLDESCON TO LD01-VLDESCON. */
            _.Move(V0CCCH_VLDESCON, RELATORIO.LD01.LD01_VLDESCON);

            /*" -992- MOVE V0CCCH-VLADIFRA TO LD01-VLADIFRA. */
            _.Move(V0CCCH_VLADIFRA, RELATORIO.LD01.LD01_VLADIFRA);

            /*" -996- COMPUTE WPRM-TOTAL = V0CCCH-VLPREMIO - V0CCCH-VLDESCON + V0CCCH-VLADIFRA. */
            AREA_DE_WORK.WPRM_TOTAL.Value = V0CCCH_VLPREMIO - V0CCCH_VLDESCON + V0CCCH_VLADIFRA;

            /*" -997- MOVE WPRM-TOTAL TO LD01-PRM-TOTAL. */
            _.Move(AREA_DE_WORK.WPRM_TOTAL, RELATORIO.LD01.LD01_PRM_TOTAL);

            /*" -999- MOVE V0CCCH-VLRCOMIS TO LD01-VLRCOMIS. */
            _.Move(V0CCCH_VLRCOMIS, RELATORIO.LD01.LD01_VLRCOMIS);

            /*" -1002- COMPUTE WTOT-PAGAR = WPRM-TOTAL - V0CCCH-VLRCOMIS. */
            AREA_DE_WORK.WTOT_PAGAR.Value = AREA_DE_WORK.WPRM_TOTAL - V0CCCH_VLRCOMIS;

            /*" -1004- MOVE WTOT-PAGAR TO LD01-TOT-PAGAR. */
            _.Move(AREA_DE_WORK.WTOT_PAGAR, RELATORIO.LD01.LD01_TOT_PAGAR);

            /*" -1005- MOVE V0CCCH-VLRSINI TO LD02-VLRSINI. */
            _.Move(V0CCCH_VLRSINI, RELATORIO.LD02.LD02_VLRSINI);

            /*" -1006- MOVE V0CCCH-VLDESPESA TO LD02-VLDESPESA. */
            _.Move(V0CCCH_VLDESPESA, RELATORIO.LD02.LD02_VLDESPESA);

            /*" -1007- MOVE V0CCCH-VLRHONOR TO LD02-VLRHONOR. */
            _.Move(V0CCCH_VLRHONOR, RELATORIO.LD02.LD02_VLRHONOR);

            /*" -1008- MOVE V0CCCH-VLRSALVD TO LD02-VLRSALVD. */
            _.Move(V0CCCH_VLRSALVD, RELATORIO.LD02.LD02_VLRSALVD);

            /*" -1010- MOVE V0CCCH-VLRESSARC TO LD02-VLRESSARC. */
            _.Move(V0CCCH_VLRESSARC, RELATORIO.LD02.LD02_VLRESSARC);

            /*" -1016- COMPUTE WTOT-RECUP = V0CCCH-VLRSINI + V0CCCH-VLDESPESA + V0CCCH-VLRHONOR - V0CCCH-VLRSALVD - V0CCCH-VLRESSARC. */
            AREA_DE_WORK.WTOT_RECUP.Value = V0CCCH_VLRSINI + V0CCCH_VLDESPESA + V0CCCH_VLRHONOR - V0CCCH_VLRSALVD - V0CCCH_VLRESSARC;

            /*" -1018- MOVE WTOT-RECUP TO LD02-TOT-RECUP. */
            _.Move(AREA_DE_WORK.WTOT_RECUP, RELATORIO.LD02.LD02_TOT_RECUP);

            /*" -1019- MOVE V0CCCH-VALOR-EDI TO LD03-VALOR-EDI. */
            _.Move(V0CCCH_VALOR_EDI, RELATORIO.LD03.LD03_VALOR_EDI);

            /*" -1020- MOVE V0CCCH-VALOR-USS TO LD03-VALOR-USS. */
            _.Move(V0CCCH_VALOR_USS, RELATORIO.LD03.LD03_VALOR_USS);

            /*" -1021- MOVE V0CCCH-VLEQPVNDA TO LD03-VLEQPVNDA. */
            _.Move(V0CCCH_VLEQPVNDA, RELATORIO.LD03.LD03_VLEQPVNDA);

            /*" -1022- MOVE V0CCCH-VLDESPADM TO LD03-VLDESPADM. */
            _.Move(V0CCCH_VLDESPADM, RELATORIO.LD03.LD03_VLDESPADM);

            /*" -1023- MOVE V0CCCH-OUTRDEBIT TO LD03-OUTRDEBIT. */
            _.Move(V0CCCH_OUTRDEBIT, RELATORIO.LD03.LD03_OUTRDEBIT);

            /*" -1025- MOVE V0CCCH-OUTRCREDT TO LD03-OUTRCREDT. */
            _.Move(V0CCCH_OUTRCREDT, RELATORIO.LD03.LD03_OUTRCREDT);

            /*" -1032- COMPUTE WTOT-DBECR = V0CCCH-VALOR-EDI + V0CCCH-VALOR-USS + V0CCCH-VLEQPVNDA + V0CCCH-VLDESPADM + V0CCCH-OUTRDEBIT - V0CCCH-OUTRCREDT. */
            ...
            else
            {
                ...
                /*" -1074- MOVE 'NAO HOUVE EMISSAO DE CHEQUE - ' TO LD11-TITL-01 */
                _.Move("NAO HOUVE EMISSAO DE CHEQUE - ", RELATORIO.LD11.FILLER_149.LD11_TITL_01);

                /*" -1075- IF WTOT-CONG = ZEROS */

                if (AREA_DE_WORK.WTOT_CONG == 00)
                {

                    /*" -1076- MOVE 'SALDO IGUAL A ZERO' TO LD11-TITL-02 */
                ...
                else
                {
                    ...
                    /*" -1079- MOVE 'SALDO A RECUPERAR' TO LD11-TITL-02. */
        ...
        {
            /*" -1101- MOVE '0600' TO WNR-EXEC-SQL. */
            _.Move("0600", WABEND.WNR_EXEC_SQL);

            /*" -1108- PERFORM R0600_00_SELECT_V1CONGENERE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1112- DISPLAY 'R0600 - ERRO NO SELECT DA V1CONGENERE' */
                _.Display($"R0600 - ERRO NO SELECT DA V1CONGENERE");

                /*" -1113- DISPLAY 'CONGENRE - ' V0CCCH-CONGENER */
        ...
        {
            /*" -1108- EXEC SQL SELECT CONGENER, NOMECONG INTO :V1CONG-CONGENER, :V1CONG-NOMECONG FROM SEGUROS.V1CONGENERE WHERE CONGENER = :V0CCCH-CONGENER END-EXEC. */
        ...
        {
            /*" -1126- MOVE '0700' TO WNR-EXEC-SQL. */
            _.Move("0700", WABEND.WNR_EXEC_SQL);

            /*" -1140- PERFORM R0700_00_SELECT_V0LOTECHEQUE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1144- DISPLAY 'R0700 - ERRO NO SELECT DA V0LOTECHEQUE' */
                _.Display($"R0700 - ERRO NO SELECT DA V0LOTECHEQUE");

                /*" -1145- DISPLAY 'CHEQUE INT - ' V0CCCH-NRCHQINT */
                _.Display($"CHEQUE INT - {V0CCCH_NRCHQINT}");

                /*" -1146- DISPLAY 'DV CHQ INT - ' V0CCCH-DVCHQINT */
        ...
        {
            /*" -1140- EXEC SQL SELECT BANCO, AGENCIA, NUMCHQ, DIGCHQ, SERCHQ INTO :V0LTCH-BANCO, :V0LTCH-AGENCIA, :V0LTCH-NRCHQEXT, :V0LTCH-DVCHQEXT, :V0LTCH-SERCHQ FROM SEGUROS.V0LOTECHEQUE WHERE CHQINT = :V0CCCH-NRCHQINT AND DIGINT = :V0CCCH-DVCHQINT END-EXEC. */
        ...
        {
            /*" -1159- MOVE '3000' TO WNR-EXEC-SQL. */
            _.Move("3000", WABEND.WNR_EXEC_SQL);

            /*" -1160- ADD 1 TO AC-PAGINA. */
            AREA_DE_WORK.AC_PAGINA.Value = AREA_DE_WORK.AC_PAGINA + 1;

            /*" -1162- MOVE AC-PAGINA TO LC03-PAGINA. */
            _.Move(AREA_DE_WORK.AC_PAGINA, RELATORIO.LC03.LC03_PAGINA);

            /*" -1163- MOVE '1' TO REG-AC0141BC. */
            _.Move("1", REG_AC0141B.REG_AC0141BC);

            /*" -1164- MOVE LC01 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC01, REG_AC0141B.REG_AC0141BL);

            /*" -1166- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1167- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1168- MOVE LC02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC02, REG_AC0141B.REG_AC0141BL);

            /*" -1170- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1171- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1172- MOVE LC03 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC03, REG_AC0141B.REG_AC0141BL);

            /*" -1174- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1175- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1176- MOVE LC04 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC04, REG_AC0141B.REG_AC0141BL);

            /*" -1178- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1179- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1180- MOVE LC05 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC05, REG_AC0141B.REG_AC0141BL);

            /*" -1182- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1183- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1184- MOVE LC02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC02, REG_AC0141B.REG_AC0141BL);

            /*" -1186- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1187- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1188- MOVE LC06 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC06, REG_AC0141B.REG_AC0141BL);

            /*" -1190- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1191- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1192- MOVE LC02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC02, REG_AC0141B.REG_AC0141BL);

            /*" -1194- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1195- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1196- MOVE LC01 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC01, REG_AC0141B.REG_AC0141BL);

            /*" -1198- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1198- MOVE 09 TO AC-LINHAS. */
        ...
        {
            /*" -1211- MOVE '3100' TO WNR-EXEC-SQL. */
            _.Move("3100", WABEND.WNR_EXEC_SQL);

            /*" -1212- MOVE '-' TO REG-AC0141BC. */
            _.Move("-", REG_AC0141B.REG_AC0141BC);

            /*" -1213- MOVE LC07 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC07, REG_AC0141B.REG_AC0141BL);

            /*" -1215- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1216- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1217- MOVE LC08 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC08, REG_AC0141B.REG_AC0141BL);

            /*" -1219- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1221- ADD 04 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 04;

            /*" -1222- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1223- MOVE LC09 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC09, REG_AC0141B.REG_AC0141BL);

            /*" -1225- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1226- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1227- MOVE LC10 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC10, REG_AC0141B.REG_AC0141BL);

            /*" -1229- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1230- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1231- MOVE LD01 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD01, REG_AC0141B.REG_AC0141BL);

            /*" -1233- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1235- ADD 04 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 04;

            /*" -1236- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1237- MOVE LC11 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC11, REG_AC0141B.REG_AC0141BL);

            /*" -1239- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1240- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1241- MOVE LC12 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC12, REG_AC0141B.REG_AC0141BL);

            /*" -1243- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1244- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1245- MOVE LD02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD02, REG_AC0141B.REG_AC0141BL);

            /*" -1247- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1249- ADD 04 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 04;

            /*" -1250- MOVE '-' TO REG-AC0141BC. */
            _.Move("-", REG_AC0141B.REG_AC0141BC);

            /*" -1251- MOVE LC13 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC13, REG_AC0141B.REG_AC0141BL);

            /*" -1253- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1254- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1255- MOVE LC14 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC14, REG_AC0141B.REG_AC0141BL);

            /*" -1257- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1258- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1259- MOVE LC15 TO REG-AC0141BL. */
            _.Move(RELATORIO.LC15, REG_AC0141B.REG_AC0141BL);

            /*" -1261- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1262- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1263- MOVE LD03 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD03, REG_AC0141B.REG_AC0141BL);

            /*" -1265- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1267- ADD 07 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 07;

            /*" -1268- MOVE '-' TO REG-AC0141BC. */
            _.Move("-", REG_AC0141B.REG_AC0141BC);

            /*" -1269- MOVE LD04 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD04, REG_AC0141B.REG_AC0141BL);

            /*" -1271- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1272- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1273- MOVE LD05 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD05, REG_AC0141B.REG_AC0141BL);

            /*" -1275- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1276- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1277- MOVE LD06 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD06, REG_AC0141B.REG_AC0141BL);

            /*" -1279- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1280- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1281- MOVE LD07 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD07, REG_AC0141B.REG_AC0141BL);

            /*" -1283- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1284- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1285- MOVE LD08 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD08, REG_AC0141B.REG_AC0141BL);

            /*" -1287- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1288- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1289- MOVE LD09 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD09, REG_AC0141B.REG_AC0141BL);

            /*" -1291- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1292- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1293- MOVE LD10 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD10, REG_AC0141B.REG_AC0141BL);

            /*" -1295- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1296- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1297- MOVE LD11 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD11, REG_AC0141B.REG_AC0141BL);

            /*" -1299- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1299- ADD 12 TO AC-LINHAS. */
        ...
        {
            /*" -1312- MOVE '3200' TO WNR-EXEC-SQL. */
            _.Move("3200", WABEND.WNR_EXEC_SQL);

            /*" -1313- IF WTOT-CONG < ZEROS */

            if (AREA_DE_WORK.WTOT_CONG < 00)
            {

                /*" -1314- MOVE ZEROS TO WVLR-EXTENSO */
            ...
            else
            {
                ...
                /*" -1330- MOVE SPACES TO LR03-EXTENSO1 */
                _.Move("", RELATORIO.LR03.LR03_EXTENSO1);

                /*" -1331- MOVE SPACES TO LR04-EXTENSO2 */
                _.Move("", RELATORIO.LR04.LR04_EXTENSO2);

                /*" -1334- DISPLAY 'TAMANHO INSUFICIENTE NA WORKING - VALOR - ' WVLR-EXTENSO. */
                _.Display($"TAMANHO INSUFICIENTE NA WORKING - VALOR - {AREA_DE_WORK.WVLR_EXTENSO}");
            }


            /*" -1335- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1336- MOVE LR01 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR01, REG_AC0141B.REG_AC0141BL);

            /*" -1338- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1339- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1340- MOVE LR02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR02, REG_AC0141B.REG_AC0141BL);

            /*" -1342- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1343- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1344- MOVE LR03 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR03, REG_AC0141B.REG_AC0141BL);

            /*" -1346- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1347- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1348- MOVE LR04 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR04, REG_AC0141B.REG_AC0141BL);

            /*" -1350- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1351- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1352- MOVE LR02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR02, REG_AC0141B.REG_AC0141BL);

            /*" -1354- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1355- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1356- MOVE LR02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR02, REG_AC0141B.REG_AC0141BL);

            /*" -1358- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1359- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1360- MOVE LR02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR02, REG_AC0141B.REG_AC0141BL);

            /*" -1362- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1363- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1364- MOVE LR05 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR05, REG_AC0141B.REG_AC0141BL);

            /*" -1366- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1367- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1368- MOVE LR06 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR06, REG_AC0141B.REG_AC0141BL);

            /*" -1370- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1371- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1372- MOVE LR02 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR02, REG_AC0141B.REG_AC0141BL);

            /*" -1374- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1375- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1376- MOVE LR01 TO REG-AC0141BL. */
            _.Move(RELATORIO.LR01, REG_AC0141B.REG_AC0141BL);

            /*" -1378- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1378- ADD 12 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 12;
        ...
        {
            /*" -1391- MOVE '4000' TO WNR-EXEC-SQL. */
            _.Move("4000", WABEND.WNR_EXEC_SQL);

            /*" -1392- MOVE ZEROS TO LC06-CONGENER. */
            _.Move(0, RELATORIO.LC06.LC06_CONGENER);

            /*" -1394- MOVE SPACES TO LC06-NOME-CONG. */
            _.Move("", RELATORIO.LC06.LC06_NOME_CONG);

            /*" -1396- PERFORM R3000-00-IMPRIME-CABECALHO. */

            R3000_00_IMPRIME_CABECALHO_SECTION();

            /*" -1401- COMPUTE WTOT-GERAL = WTOT-GER-PG - WTOT-GER-RC - WTOT-GER-DC - WTOT-GER-SD. */
            ...
            /*" -1402- MOVE WTOT-GER-SD TO LD06-TOT-SDANT. */
            _.Move(AREA_DE_WORK.WTOT_GER_SD, RELATORIO.LD06.LD06_TOT_SDANT);

            /*" -1403- MOVE WTOT-GER-PG TO LD07-TOT-PAGAR. */
            _.Move(AREA_DE_WORK.WTOT_GER_PG, RELATORIO.LD07.LD07_TOT_PAGAR);

            /*" -1404- MOVE WTOT-GER-RC TO LD08-TOT-RECUP. */
            _.Move(AREA_DE_WORK.WTOT_GER_RC, RELATORIO.LD08.LD08_TOT_RECUP);

            /*" -1405- MOVE WTOT-GER-DC TO LD09-TOT-DBECR. */
            _.Move(AREA_DE_WORK.WTOT_GER_DC, RELATORIO.LD09.LD09_TOT_DBECR);

            /*" -1407- MOVE WTOT-GERAL TO LD11-TOT-CONG. */
            _.Move(AREA_DE_WORK.WTOT_GERAL, RELATORIO.LD11.LD11_TOT_CONG);

            /*" -1410- MOVE SPACES TO LD10-NRCHEQUE LD11-NRCHEQUE. */
            _.Move("", RELATORIO.LD10.LD10_NRCHEQUE, RELATORIO.LD11.LD11_NRCHEQUE);

            /*" -1411- MOVE '-' TO REG-AC0141BC. */
            _.Move("-", REG_AC0141B.REG_AC0141BC);

            /*" -1412- MOVE SPACES TO REG-AC0141BL. */
            _.Move("", REG_AC0141B.REG_AC0141BL);

            /*" -1414- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1415- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1416- MOVE LD04 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD04, REG_AC0141B.REG_AC0141BL);

            /*" -1418- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1419- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1420- MOVE LD05 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD05, REG_AC0141B.REG_AC0141BL);

            /*" -1422- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1423- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1424- MOVE LD06 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD06, REG_AC0141B.REG_AC0141BL);

            /*" -1426- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1427- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1428- MOVE LD07 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD07, REG_AC0141B.REG_AC0141BL);

            /*" -1430- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1431- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1432- MOVE LD08 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD08, REG_AC0141B.REG_AC0141BL);

            /*" -1434- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1435- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1436- MOVE LD09 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD09, REG_AC0141B.REG_AC0141BL);

            /*" -1438- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1439- MOVE SPACES TO REG-AC0141BC. */
            _.Move("", REG_AC0141B.REG_AC0141BC);

            /*" -1440- MOVE LD10 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD10, REG_AC0141B.REG_AC0141BL);

            /*" -1442- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1443- MOVE '0' TO REG-AC0141BC. */
            _.Move("0", REG_AC0141B.REG_AC0141BC);

            /*" -1444- MOVE LD11 TO REG-AC0141BL. */
            _.Move(RELATORIO.LD11, REG_AC0141B.REG_AC0141BL);

            /*" -1446- WRITE REG-AC0141B. */
            RAC0141B.Write(REG_AC0141B.GetMoveValues().ToString());

            /*" -1446- ADD 14 TO AC-LINHAS. */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1461- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, WABEND.WSQLCODE);

            /*" -1463- DISPLAY WABEND. */
            _.Display(WABEND);

            /*" -1463- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1467- MOVE 99 TO RETURN-CODE. */
