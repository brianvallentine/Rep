...
{
    public class R9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 : QueryBasis<R9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 Execute(R9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 r9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1)
        {
            var ths = r9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1;
        ...
        public override R9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R9200_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1();
            var i = 0;
