...
{
    public class R1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1 : QueryBasis<R1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1 Execute(R1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1 r1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1)
        {
            var ths = r1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1;
        ...
        public override R1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1940_00_SELECT_HISCOBPR_DB_SELECT_2_Query1();
            var i = 0;
