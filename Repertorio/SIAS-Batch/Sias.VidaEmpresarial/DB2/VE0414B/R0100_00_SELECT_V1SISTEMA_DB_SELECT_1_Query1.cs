...
namespace Sias.VidaEmpresarial.DB2.VE0414B
{
    public class R0100_00_SELECT_V1SISTEMA_DB_SELECT_1_Query1 : QueryBasis<R0100_00_SELECT_V1SISTEMA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            :V1SIST-MESREFER,
            :V1SIST-ANOREFER,
            :WHOST-DATA-MOV-ABERTO
            FROM SEGUROS.SISTEMAS
            WHERE IDE_SISTEMA =
            :SISTEMAS-IDE-SISTEMA
            END-EXEC.
            */
            #endregion
            var query = @$"
        ...
        public string WHOST_DATA_MOV_ABERTO { get; set; }
        ...
        public override R0100_00_SELECT_V1SISTEMA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.WHOST_DATA_MOV_ABERTO = result[i++].Value?.ToString();
            return dta;
        }
