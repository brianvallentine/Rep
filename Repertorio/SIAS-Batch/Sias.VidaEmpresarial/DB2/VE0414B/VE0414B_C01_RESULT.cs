...
{
    public class VE0414B_C01_RESULT : QueryBasis<VE0414B_C01_RESULT>
    {
        ...
        public VE0414B_C01_RESULT() { IsCursor = true; }

        public VE0414B_C01_RESULT(bool justACursor)
        {
        ...
        public override VE0414B_C01_RESULT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VE0414B_C01_RESULT();
            var i = 0;
