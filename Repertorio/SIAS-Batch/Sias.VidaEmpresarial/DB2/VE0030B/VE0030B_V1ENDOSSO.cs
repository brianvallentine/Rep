...
{
    public class VE0030B_V1ENDOSSO : QueryBasis<VE0030B_V1ENDOSSO>
    {
        ...
        public VE0030B_V1ENDOSSO() { IsCursor = true; }

        public VE0030B_V1ENDOSSO(bool justACursor)
        {
        ...
        public override VE0030B_V1ENDOSSO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VE0030B_V1ENDOSSO();
            var i = 0;
