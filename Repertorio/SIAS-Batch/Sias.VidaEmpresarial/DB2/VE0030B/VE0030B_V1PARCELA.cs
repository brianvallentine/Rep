...
{
    public class VE0030B_V1PARCELA : QueryBasis<VE0030B_V1PARCELA>
    {
        ...
        public VE0030B_V1PARCELA() { IsCursor = true; }

        public VE0030B_V1PARCELA(bool justACursor)
        {
        ...
        public override VE0030B_V1PARCELA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VE0030B_V1PARCELA();
            var i = 0;
