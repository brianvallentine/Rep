...
{
    public class R0200_00_LER_RCAPS_DB_SELECT_2_Query1 : QueryBasis<R0200_00_LER_RCAPS_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0200_00_LER_RCAPS_DB_SELECT_2_Query1 Execute(R0200_00_LER_RCAPS_DB_SELECT_2_Query1 r0200_00_LER_RCAPS_DB_SELECT_2_Query1)
        {
            var ths = r0200_00_LER_RCAPS_DB_SELECT_2_Query1;
        ...
        public override R0200_00_LER_RCAPS_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0200_00_LER_RCAPS_DB_SELECT_2_Query1();
            var i = 0;
