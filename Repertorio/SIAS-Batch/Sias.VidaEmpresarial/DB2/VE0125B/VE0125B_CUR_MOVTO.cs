...
{
    public class VE0125B_CUR_MOVTO : QueryBasis<VE0125B_CUR_MOVTO>
    {
        ...
        public VE0125B_CUR_MOVTO() { IsCursor = true; }

        public VE0125B_CUR_MOVTO(bool justACursor)
        {
        ...
        public override VE0125B_CUR_MOVTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VE0125B_CUR_MOVTO();
            var i = 0;
