...
{
    public class VE2640B_C6_VGRAMOCOMP : QueryBasis<VE2640B_C6_VGRAMOCOMP>
    {
        ...
        public VE2640B_C6_VGRAMOCOMP() { IsCursor = true; }

        public VE2640B_C6_VGRAMOCOMP(bool justACursor)
        {
        ...
        public override VE2640B_C6_VGRAMOCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VE2640B_C6_VGRAMOCOMP();
            var i = 0;
