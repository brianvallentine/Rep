...
{
    public class R2800_2610_INSERT_HISTCONTAVA_DB_INSERT_1_Insert1 : QueryBasis<R2800_2610_INSERT_HISTCONTAVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2800_2610_INSERT_HISTCONTAVA_DB_INSERT_1_Insert1 r2800_2610_INSERT_HISTCONTAVA_DB_INSERT_1_Insert1)
        {
            var ths = r2800_2610_INSERT_HISTCONTAVA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2800_2610_INSERT_HISTCONTAVA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
