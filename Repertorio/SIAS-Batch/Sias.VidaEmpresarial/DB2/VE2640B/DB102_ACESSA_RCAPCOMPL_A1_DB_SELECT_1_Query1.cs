...
{
    public class DB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1 : QueryBasis<DB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static DB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1 Execute(DB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1 dB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1)
        {
            var ths = dB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1;
        ...
        public override DB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new DB102_ACESSA_RCAPCOMPL_A1_DB_SELECT_1_Query1();
            var i = 0;
