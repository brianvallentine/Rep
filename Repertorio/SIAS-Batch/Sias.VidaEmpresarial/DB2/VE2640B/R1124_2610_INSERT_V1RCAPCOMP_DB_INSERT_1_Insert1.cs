...
{
    public class R1124_2610_INSERT_V1RCAPCOMP_DB_INSERT_1_Insert1 : QueryBasis<R1124_2610_INSERT_V1RCAPCOMP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL INSERT INTO SEGUROS.RCAP_COMPLEMENTAR
            (COD_FONTE ,
            NUM_RCAP ,
            NUM_RCAP_COMPLEMEN ,
            COD_OPERACAO ,
        ...
        public static void Execute(R1124_2610_INSERT_V1RCAPCOMP_DB_INSERT_1_Insert1 r1124_2610_INSERT_V1RCAPCOMP_DB_INSERT_1_Insert1)
        {
            var ths = r1124_2610_INSERT_V1RCAPCOMP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1124_2610_INSERT_V1RCAPCOMP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
