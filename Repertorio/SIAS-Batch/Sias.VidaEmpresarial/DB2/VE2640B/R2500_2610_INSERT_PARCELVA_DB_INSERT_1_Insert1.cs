...
{
    public class R2500_2610_INSERT_PARCELVA_DB_INSERT_1_Insert1 : QueryBasis<R2500_2610_INSERT_PARCELVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2500_2610_INSERT_PARCELVA_DB_INSERT_1_Insert1 r2500_2610_INSERT_PARCELVA_DB_INSERT_1_Insert1)
        {
            var ths = r2500_2610_INSERT_PARCELVA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2500_2610_INSERT_PARCELVA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
