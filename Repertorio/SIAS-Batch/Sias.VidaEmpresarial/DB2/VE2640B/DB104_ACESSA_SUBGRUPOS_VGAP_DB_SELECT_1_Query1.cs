...
{
    public class DB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1 : QueryBasis<DB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static DB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1 Execute(DB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1 dB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1)
        {
            var ths = dB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1;
        ...
        public override DB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new DB104_ACESSA_SUBGRUPOS_VGAP_DB_SELECT_1_Query1();
            var i = 0;
