...
{
    public class DB028_INCLUI_ENDERECOS_DB_INSERT_1_Insert1 : QueryBasis<DB028_INCLUI_ENDERECOS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(DB028_INCLUI_ENDERECOS_DB_INSERT_1_Insert1 dB028_INCLUI_ENDERECOS_DB_INSERT_1_Insert1)
        {
            var ths = dB028_INCLUI_ENDERECOS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override DB028_INCLUI_ENDERECOS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
