...
{
    public class R1123_2610_UPDATE_V1RCAPCOMP_DB_UPDATE_1_Update1 : QueryBasis<R1123_2610_UPDATE_V1RCAPCOMP_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R1123_2610_UPDATE_V1RCAPCOMP_DB_UPDATE_1_Update1 r1123_2610_UPDATE_V1RCAPCOMP_DB_UPDATE_1_Update1)
        {
            var ths = r1123_2610_UPDATE_V1RCAPCOMP_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1123_2610_UPDATE_V1RCAPCOMP_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
