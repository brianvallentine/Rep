...
{
    public class R6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1 : QueryBasis<R6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1 Execute(R6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1 r6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1)
        {
            var ths = r6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1;
        ...
        public override R6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R6000_00_CANCELA_SEGURO_DB_SELECT_7_Query1();
            var i = 0;
