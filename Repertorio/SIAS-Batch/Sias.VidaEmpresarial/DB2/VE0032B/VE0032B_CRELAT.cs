...
{
    public class VE0032B_CRELAT : QueryBasis<VE0032B_CRELAT>
    {
        ...
        public VE0032B_CRELAT() { IsCursor = true; }

        public VE0032B_CRELAT(bool justACursor)
        {
        ...
        public override VE0032B_CRELAT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VE0032B_CRELAT();
            var i = 0;
