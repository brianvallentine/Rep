...
{
    public class VE0123B_CURS01 : QueryBasis<VE0123B_CURS01>
    {
        ...
        public VE0123B_CURS01() { IsCursor = true; }

        public VE0123B_CURS01(bool justACursor)
        {
        ...
        public string VIND_STAMDPLAN { get; set; }
        ...
        public override VE0123B_CURS01 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VE0123B_CURS01();
            var i = 0;
            ...
            dta.VIND_STAMDPLAN = string.IsNullOrWhiteSpace(dta.PROPOVA_STA_MUDANCA_PLANO) ? "-1" : "0";
