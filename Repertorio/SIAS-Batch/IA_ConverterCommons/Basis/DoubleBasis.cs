...
public class _REDEF_DoubleBasis : DoubleBasis
{
    //NUNCA USAR
    public _REDEF_DoubleBasis() : base(new PIC("", "", ""), 0) { }

    public _REDEF_DoubleBasis(PIC picAttr, int precision, double value = 0)
        : base(picAttr, precision, value)
    {
        //Precision = precision;
    }
}
