...
namespace Dclgens
{
    public class LTSOLPAR_DCLLT_SOLICITA_PARAM : VarBasis
    {
        ...
        public DoubleBasis LTSOLPAR_PARAM_FLOAT01 { get; set; } = new DoubleBasis(new PIC("S9", "17", "S9(17)V"), 0);
        /*"    10 LTSOLPAR-PARAM-FLOAT02       USAGE COMP-2.*/
        public DoubleBasis LTSOLPAR_PARAM_FLOAT02 { get; set; } = new DoubleBasis(new PIC("S9", "17", "S9(17)V"), 0);
