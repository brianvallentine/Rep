...
{
    public class R1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1 : QueryBasis<R1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1 Execute(R1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1 r1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1)
        {
            var ths = r1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1;
        ...
        public override R1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1200_00_GRAVA_FENEMIS_DB_SELECT_1_Query1();
            var i = 0;
