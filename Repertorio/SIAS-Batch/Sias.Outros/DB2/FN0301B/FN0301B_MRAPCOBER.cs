...
{
    public class FN0301B_MRAPCOBER : QueryBasis<FN0301B_MRAPCOBER>
    {
        ...
        public FN0301B_MRAPCOBER() { IsCursor = true; }

        public FN0301B_MRAPCOBER(bool justACursor)
        {
        ...
        public override FN0301B_MRAPCOBER OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new FN0301B_MRAPCOBER();
            var i = 0;
