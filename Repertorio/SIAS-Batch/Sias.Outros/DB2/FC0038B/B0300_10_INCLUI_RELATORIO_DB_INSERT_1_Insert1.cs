...
{
    public class B0300_10_INCLUI_RELATORIO_DB_INSERT_1_Insert1 : QueryBasis<B0300_10_INCLUI_RELATORIO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(B0300_10_INCLUI_RELATORIO_DB_INSERT_1_Insert1 b0300_10_INCLUI_RELATORIO_DB_INSERT_1_Insert1)
        {
            var ths = b0300_10_INCLUI_RELATORIO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override B0300_10_INCLUI_RELATORIO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
