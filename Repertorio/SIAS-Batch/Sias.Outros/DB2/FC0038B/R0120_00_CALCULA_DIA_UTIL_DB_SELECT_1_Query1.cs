...
{
    public class R0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 : QueryBasis<R0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 Execute(R0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 r0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1)
        {
            var ths = r0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1;
        ...
        public override R0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0120_00_CALCULA_DIA_UTIL_DB_SELECT_1_Query1();
            var i = 0;
