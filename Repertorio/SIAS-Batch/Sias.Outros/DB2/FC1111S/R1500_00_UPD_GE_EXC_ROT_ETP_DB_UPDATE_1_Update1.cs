...
{
    public class R1500_00_UPD_GE_EXC_ROT_ETP_DB_UPDATE_1_Update1 : QueryBasis<R1500_00_UPD_GE_EXC_ROT_ETP_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R1500_00_UPD_GE_EXC_ROT_ETP_DB_UPDATE_1_Update1 r1500_00_UPD_GE_EXC_ROT_ETP_DB_UPDATE_1_Update1)
        {
            var ths = r1500_00_UPD_GE_EXC_ROT_ETP_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1500_00_UPD_GE_EXC_ROT_ETP_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
