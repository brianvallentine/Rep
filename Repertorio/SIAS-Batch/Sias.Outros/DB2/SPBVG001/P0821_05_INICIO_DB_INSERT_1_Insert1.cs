...
namespace Sias.Outros.DB2.SPBVG001
{
    public class P0821_05_INICIO_DB_INSERT_1_Insert1 : QueryBasis<P0821_05_INICIO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            INSERT INTO SEGUROS.VG_CRITICA_PROPOSTA_HIST
            ( NUM_CERTIFICADO
            ,SEQ_CRITICA
            ,DTH_CADASTRAMENTO
            ,IND_TP_PROPOSTA
