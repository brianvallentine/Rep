...
{
    public class P1010_05_INICIO_DB_SELECT_1_Query1 : QueryBasis<P1010_05_INICIO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static P1010_05_INICIO_DB_SELECT_1_Query1 Execute(P1010_05_INICIO_DB_SELECT_1_Query1 p1010_05_INICIO_DB_SELECT_1_Query1)
        {
            var ths = p1010_05_INICIO_DB_SELECT_1_Query1;
        ...
        public override P1010_05_INICIO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new P1010_05_INICIO_DB_SELECT_1_Query1();
            var i = 0;
