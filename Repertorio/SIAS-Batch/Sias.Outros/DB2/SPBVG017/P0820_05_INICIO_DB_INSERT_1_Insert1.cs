...
namespace Sias.Outros.DB2.SPBVG017
{
    public class P0820_05_INICIO_DB_INSERT_1_Insert1 : QueryBasis<P0820_05_INICIO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            INSERT INTO SEGUROS.VG_DPS_PROPOSTA
            ( NUM_PROPOSTA
            ,NUM_CPF_CNPJ
            ,SEQ_PRODUTO_DPS
            ,STA_DPS_PROPOSTA
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.VG_DPS_PROPOSTA ( NUM_PROPOSTA ,NUM_CPF_CNPJ ,SEQ_PRODUTO_DPS ,STA_DPS_PROPOSTA ,IND_TP_PESSOA ,IND_TP_SEGURADO ,NUM_CERTIFICADO ,VLR_IS ,VLR_ACUMULO_IS ,COD_USUARIO ,NOM_PROGRAMA ,DTH_CADASTRAMENTO ) VALUES ( {FieldThreatment(this.VG143_NUM_PROPOSTA)} ,{FieldThreatment(this.VG143_NUM_CPF_CNPJ)} ,{FieldThreatment(this.VG143_SEQ_PRODUTO_DPS)} ,{FieldThreatment(this.VG143_STA_DPS_PROPOSTA)} ,{FieldThreatment(this.VG143_IND_TP_PESSOA)} ,{FieldThreatment(this.VG143_IND_TP_SEGURADO)} ,{FieldThreatment(this.VG143_NUM_CERTIFICADO)} ,{FieldThreatment(this.VG143_VLR_IS)} ,{FieldThreatment(this.VG143_VLR_ACUMULO_IS)} ,{FieldThreatment(this.VG143_COD_USUARIO)} ,{FieldThreatment(this.VG143_NOM_PROGRAMA)} ,{FieldThreatment(this.VG143_DTH_CADASTRAMENTO)} )";
