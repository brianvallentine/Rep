...
namespace Sias.Outros.DB2.EF0102S
{
    public class D0000_PROCESSAMENTO_DB2_DB_SELECT_1_Query1 : QueryBasis<D0000_PROCESSAMENTO_DB2_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            SELECT VALUE(NOME_SEGURADO, ' ' )
            INTO :LS-V0SEGU-NOME-SEGURADO
            FROM SEGUROS.V0SEGURADO_HABIT
        ...
        public string LS_V0SEGU_NOME_SEGURADO { get; set; }
        ...
        public override D0000_PROCESSAMENTO_DB2_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            var i = 0;
            dta.LS_V0SEGU_NOME_SEGURADO = result[i++].Value?.ToString();
            return dta;
        }
