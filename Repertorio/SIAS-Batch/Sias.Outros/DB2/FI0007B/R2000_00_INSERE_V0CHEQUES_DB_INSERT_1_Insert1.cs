...
{
    public class R2000_00_INSERE_V0CHEQUES_DB_INSERT_1_Insert1 : QueryBasis<R2000_00_INSERE_V0CHEQUES_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL INSERT
            INTO SEGUROS.V0CHEQUES
        ...
        public static void Execute(R2000_00_INSERE_V0CHEQUES_DB_INSERT_1_Insert1 r2000_00_INSERE_V0CHEQUES_DB_INSERT_1_Insert1)
        {
            var ths = r2000_00_INSERE_V0CHEQUES_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2000_00_INSERE_V0CHEQUES_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
