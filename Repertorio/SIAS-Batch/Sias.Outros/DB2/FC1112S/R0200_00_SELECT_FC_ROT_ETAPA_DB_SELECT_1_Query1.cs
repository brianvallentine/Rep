...
{
    public class R0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1 : QueryBasis<R0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :GE386-DTH-FIM-VIGENCIA:VIND-DTH-FIM-VIGC,
            ...
            AND NOM_PROGRAMA = :GE386-NOM-PROGRAMA
            AND STA_ETAPA = :GE386-STA-ETAPA
            ...
            var query = @$"
				SELECT NOM_ROTINA
							...
							,
											...
											AND STA_ETAPA = '{this.GE386_STA_ETAPA}'
											AND DTH_FIM_VIGENCIA IS NULL
											WITH UR";
        ...
        public string GE386_DTH_FIM_VIGENCIA { get; set; }
        public string VIND_DTH_FIM_VIGC { get; set; }
        ...
        public static R0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1 Execute(R0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1 r0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1)
        {
            var ths = r0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1;
        ...
        public override R0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0200_00_SELECT_FC_ROT_ETAPA_DB_SELECT_1_Query1();
            var i = 0;
            ...
            dta.GE386_DTH_FIM_VIGENCIA = result[i++].Value?.ToString();
            dta.VIND_DTH_FIM_VIGC = string.IsNullOrWhiteSpace(dta.GE386_DTH_FIM_VIGENCIA) ? "-1" : "0";
