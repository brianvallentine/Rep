...
namespace Sias.Loterico.DB2.LT3150S
{
    public class R0400_00_LER_COEF_DB_SELECT_1_Query1 : QueryBasis<R0400_00_LER_COEF_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0400_00_LER_COEF_DB_SELECT_1_Query1 Execute(R0400_00_LER_COEF_DB_SELECT_1_Query1 r0400_00_LER_COEF_DB_SELECT_1_Query1)
        {
            var ths = r0400_00_LER_COEF_DB_SELECT_1_Query1;
        ...
        public override R0400_00_LER_COEF_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0400_00_LER_COEF_DB_SELECT_1_Query1();
            var i = 0;
