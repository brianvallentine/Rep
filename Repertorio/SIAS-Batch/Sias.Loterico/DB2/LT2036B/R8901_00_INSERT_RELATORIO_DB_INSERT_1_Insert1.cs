...
{
    public class R8901_00_INSERT_RELATORIO_DB_INSERT_1_Insert1 : QueryBasis<R8901_00_INSERT_RELATORIO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R8901_00_INSERT_RELATORIO_DB_INSERT_1_Insert1 r8901_00_INSERT_RELATORIO_DB_INSERT_1_Insert1)
        {
            var ths = r8901_00_INSERT_RELATORIO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R8901_00_INSERT_RELATORIO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
