...
{
    public class R1110_00_LER_COEF_DB_SELECT_1_Query1 : QueryBasis<R1110_00_LER_COEF_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1110_00_LER_COEF_DB_SELECT_1_Query1 Execute(R1110_00_LER_COEF_DB_SELECT_1_Query1 r1110_00_LER_COEF_DB_SELECT_1_Query1)
        {
            var ths = r1110_00_LER_COEF_DB_SELECT_1_Query1;
        ...
        public override R1110_00_LER_COEF_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1110_00_LER_COEF_DB_SELECT_1_Query1();
            var i = 0;
