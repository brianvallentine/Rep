...
{
    public class R1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1 : QueryBasis<R1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1 Execute(R1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1 r1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1)
        {
            var ths = r1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1;
        ...
        public override R1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1250_00_LER_PCT_PLURI_DB_SELECT_1_Query1();
            var i = 0;
