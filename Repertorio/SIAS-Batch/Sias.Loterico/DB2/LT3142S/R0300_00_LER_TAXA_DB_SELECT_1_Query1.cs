...
namespace Sias.Loterico.DB2.LT3142S
{
    public class R0300_00_LER_TAXA_DB_SELECT_1_Query1 : QueryBasis<R0300_00_LER_TAXA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0300_00_LER_TAXA_DB_SELECT_1_Query1 Execute(R0300_00_LER_TAXA_DB_SELECT_1_Query1 r0300_00_LER_TAXA_DB_SELECT_1_Query1)
        {
            var ths = r0300_00_LER_TAXA_DB_SELECT_1_Query1;
        ...
        public override R0300_00_LER_TAXA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0300_00_LER_TAXA_DB_SELECT_1_Query1();
            var i = 0;
