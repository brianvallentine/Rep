...
{
    public class R1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1 : QueryBasis<R1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND PARAM_DATE01 = :WS-DT-INIVIGENCIA
            WITH UR
            END-EXEC
            */
            #endregion
            var query = @$"
				SELECT VALUE(COUNT(*)
							,0)
											...
											AND PARAM_DATE01 = '{this.WS_DT_INIVIGENCIA}'
											WITH UR";
        ...
        public static R1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1 Execute(R1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1 r1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1)
        {
            var ths = r1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1;
        ...
        public override R1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1500_00_PESQ_DATA_SIST_DB_SELECT_1_Query1();
            var i = 0;
