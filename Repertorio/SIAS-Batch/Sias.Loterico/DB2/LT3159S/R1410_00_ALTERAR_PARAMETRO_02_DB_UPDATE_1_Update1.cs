...
{
    public class R1410_00_ALTERAR_PARAMETRO_02_DB_UPDATE_1_Update1 : QueryBasis<R1410_00_ALTERAR_PARAMETRO_02_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
				UPDATE SEGUROS.LT_SOLICITA_PARAM
				SET PARAM_DATE03 =  '{this.LTSOLPAR_PARAM_DATE03}'
        ...
        public static void Execute(R1410_00_ALTERAR_PARAMETRO_02_DB_UPDATE_1_Update1 r1410_00_ALTERAR_PARAMETRO_02_DB_UPDATE_1_Update1)
        {
            var ths = r1410_00_ALTERAR_PARAMETRO_02_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1410_00_ALTERAR_PARAMETRO_02_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
