...
{
    public class R1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1 : QueryBasis<R1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1 Execute(R1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1 r1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1)
        {
            var ths = r1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1;
        ...
        public override R1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1210_00_CONSULTA_COUNT_DB_SELECT_1_Query1();
            var i = 0;
