...
{
    public class R1420_00_ALTERAR_PARAMETRO_03_DB_UPDATE_1_Update1 : QueryBasis<R1420_00_ALTERAR_PARAMETRO_03_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R1420_00_ALTERAR_PARAMETRO_03_DB_UPDATE_1_Update1 r1420_00_ALTERAR_PARAMETRO_03_DB_UPDATE_1_Update1)
        {
            var ths = r1420_00_ALTERAR_PARAMETRO_03_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1420_00_ALTERAR_PARAMETRO_03_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
