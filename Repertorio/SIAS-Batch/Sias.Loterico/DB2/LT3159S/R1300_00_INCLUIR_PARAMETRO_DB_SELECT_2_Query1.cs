...
{
    public class R1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1 : QueryBasis<R1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND :WS-DATA-AUX BETWEEN PARAM_DATE01
            AND PARAM_DATE02
            ...
            var query = @$"
				SELECT VALUE(COUNT(*)
							,0)
											...
											AND '{this.WS_DATA_AUX}' BETWEEN PARAM_DATE01
											AND PARAM_DATE02
        ...
        public static R1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1 Execute(R1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1 r1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1)
        {
            var ths = r1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1;
        ...
        public override R1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1300_00_INCLUIR_PARAMETRO_DB_SELECT_2_Query1();
            var i = 0;
