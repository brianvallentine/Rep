...
{
    public class VF0340B_DEBITO : QueryBasis<VF0340B_DEBITO>
    {
        ...
        public VF0340B_DEBITO() { IsCursor = true; }

        public VF0340B_DEBITO(bool justACursor)
        {
        ...
        public override VF0340B_DEBITO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VF0340B_DEBITO();
            var i = 0;
