...
{
    public class R1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1 : QueryBasis<R1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1 Execute(R1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1 r1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1)
        {
            var ths = r1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1;
        ...
        public override R1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1300_00_CANCELA_FALTA_PG_DB_SELECT_7_Query1();
            var i = 0;
