...
{
    public class VF0851B_CDIFPAR : QueryBasis<VF0851B_CDIFPAR>
    {
        ...
        public VF0851B_CDIFPAR() { IsCursor = true; }

        public VF0851B_CDIFPAR(bool justACursor)
        {
        ...
        public override VF0851B_CDIFPAR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VF0851B_CDIFPAR();
            var i = 0;
