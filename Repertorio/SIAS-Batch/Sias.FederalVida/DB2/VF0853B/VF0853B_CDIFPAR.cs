...
{
    public class VF0853B_CDIFPAR : QueryBasis<VF0853B_CDIFPAR>
    {
        ...
        public VF0853B_CDIFPAR() { IsCursor = true; }

        public VF0853B_CDIFPAR(bool justACursor)
        {
        ...
        public string V0DIFP_NUM_PARCELA { get; set; }
        ...
        public override VF0853B_CDIFPAR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VF0853B_CDIFPAR();
            var i = 0;

            dta.V0DIFP_NRPARCEL = result[i++].Value?.ToString();
            dta.V0DIFP_DTVENCTO = result[i++].Value?.ToString();
            ...
            dta.V0DIFP_NUM_PARCELA = result[i++].Value?.ToString();
