...
{
    public class M_2000_INTEGRA_VG_DB_SELECT_1_Query1 : QueryBasis<M_2000_INTEGRA_VG_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_2000_INTEGRA_VG_DB_SELECT_1_Query1 Execute(M_2000_INTEGRA_VG_DB_SELECT_1_Query1 m_2000_INTEGRA_VG_DB_SELECT_1_Query1)
        {
            var ths = m_2000_INTEGRA_VG_DB_SELECT_1_Query1;
        ...
        public override M_2000_INTEGRA_VG_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_2000_INTEGRA_VG_DB_SELECT_1_Query1();
            var i = 0;
