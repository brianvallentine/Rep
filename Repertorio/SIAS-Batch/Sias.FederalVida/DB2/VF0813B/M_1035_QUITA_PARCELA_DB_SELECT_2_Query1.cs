...
{
    public class M_1035_QUITA_PARCELA_DB_SELECT_2_Query1 : QueryBasis<M_1035_QUITA_PARCELA_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_1035_QUITA_PARCELA_DB_SELECT_2_Query1 Execute(M_1035_QUITA_PARCELA_DB_SELECT_2_Query1 m_1035_QUITA_PARCELA_DB_SELECT_2_Query1)
        {
            var ths = m_1035_QUITA_PARCELA_DB_SELECT_2_Query1;
        ...
        public override M_1035_QUITA_PARCELA_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_1035_QUITA_PARCELA_DB_SELECT_2_Query1();
            var i = 0;
