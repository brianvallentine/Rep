...
{
    public class M_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1 : QueryBasis<M_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1 Execute(M_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1 m_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1)
        {
            var ths = m_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1;
        ...
        public override M_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_0021_LOCALIZA_TIT_DEB_DB_SELECT_2_Query1();
            var i = 0;
