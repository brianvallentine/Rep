...
namespace Copies
{
    public class LBFPF164_REGISTRO_EMPRESA : VarBasis
    {
        ...
        /*" 03    FILLER                        PIC  X(007)*/
        public StringBasis FILLER { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"");
        /*"*/
    }
}