...
namespace Copies
{
    public class LBTB3201_TABELA_COBERTURAS : VarBasis
    {
        ...
        /*"  10   CB0006 PIC X(050) VALUE        'RC-OPERACOES   -RESPONSABILID. CIVIL OPERACOES '*/
        public StringBasis CB0006 { get; set; } = new StringBasis(new PIC("X", "50", "X(050)"), @"RC-OPERACOES   -RESPONSABILID. CIVIL OPERACOES ");
