...
namespace Copies
{
    public class LBTB3101_TABELA_LIM_MINMAX_CCAT : VarBasis
    {
        /*"  10 FCCAT01 PIC X(34) VALUE '30.000,00        300.000,00      '*/
        public StringBasis FCCAT01 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"30.000,00        300.000,00      ");
        ...
        /*"  10 FCCAT07 PIC X(34) VALUE '5.000,00         150.000,00      '*/
        public StringBasis FCCAT07 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         150.000,00      ");
        /*"  10 FCCAT08 PIC X(34) VALUE '5.000,00         150.000,00      '*/
        public StringBasis FCCAT08 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         150.000,00      ");
        ...
        /*"  10 FCCAT11 PIC X(34) VALUE '5.000,00         50.000,00       '*/
        public StringBasis FCCAT11 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         50.000,00       ");
