...
namespace Copies
{
    public class LBTB3101_TABELA_LIM_MINMAX_CCA : VarBasis
    {
        /*"  10 FCCA01 PIC X(34) VALUE '30.000,00        300.000,00       '*/
        public StringBasis FCCA01 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"30.000,00        300.000,00       ");
        ...
        /*"  10 FCCA07 PIC X(34) VALUE '5.000,00         120.000,00       '*/
        public StringBasis FCCA07 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         120.000,00       ");
        /*"  10 FCCA08 PIC X(34) VALUE '5.000,00         120.000,00       '*/
        public StringBasis FCCA08 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         120.000,00       ");
        ...
        /*"  10 FCCA11 PIC X(34) VALUE '5.000,00         50.000,00        '*/
        public StringBasis FCCA11 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         50.000,00        ");
