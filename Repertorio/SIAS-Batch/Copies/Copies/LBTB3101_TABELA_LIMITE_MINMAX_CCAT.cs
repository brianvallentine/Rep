...
namespace Copies
{
    public class LBTB3101_TABELA_LIMITE_MINMAX_CCAT : VarBasis
    {
        /*"  10 FCCATE1 PIC X(30) VALUE '00030000 000    00300000 000 '*/
        public StringBasis FCCATE1 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00030000 000    00300000 000 ");
        ...
        /*"  10 FCCATE7 PIC X(30) VALUE '00005000 000    00150000 100 '*/
        public StringBasis FCCATE7 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00005000 000    00150000 100 ");
        /*"  10 FCCATE8 PIC X(30) VALUE '00005000 000    00150000 100 '*/
        public StringBasis FCCATE8 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00005000 000    00150000 100 ");
        /*"  10 FCCATE9 PIC X(30) VALUE '00002000 000    00050000 050 '*/
        public StringBasis FCCATE9 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00002000 000    00050000 050 ");
