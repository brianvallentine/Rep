...
namespace Copies
{
    public class LBTB3101_TAB_LIMITE_MINMAX_CCAT : VarBasis
    {
        ...
        /*"    15   FILLER                PIC  X(04)*/
        public StringBasis FILLER_37 { get; set; } = new StringBasis(new PIC("X", "4", "X(04)"), @"");
        ...
        /*"    15   FILLER                PIC  X(02)*/
        public StringBasis FILLER_39 { get; set; } = new StringBasis(new PIC("X", "2", "X(02)"), @"");
        /*"*/

        public LBTB3101_TAB_LIMITE_MINMAX_CCAT()
        {
