...
namespace Copies
{
    public class LBTB3101_TABELA_LIMITE_MINMAX : VarBasis
    {
        ...
        /*"  10 FILLE7 PIC X(30) VALUE '00005000 000    00200000 100 '*/
        public StringBasis FILLE7_0 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00005000 000    00200000 100 ");
        /*"  10 FILLE8 PIC X(30) VALUE '00005000 000    00200000 100 '*/
        public StringBasis FILLE8_0 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00005000 000    00200000 100 ");
