...
namespace Copies
{
    public class LBTB3201_TABELA_LIMITE_MINMAX_CCA : VarBasis
    {
        /*"  10 FCCAE1 PIC X(30) VALUE '00030000 000    00500000 000 '*/
        public StringBasis FCCAE1 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00030000 000    00500000 000 ");
        ...
        /*"  10 FCCAE7 PIC X(30) VALUE '00005000 000    00500000 100 '*/
        public StringBasis FCCAE7 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00005000 000    00500000 100 ");
        /*"  10 FCCAE8 PIC X(30) VALUE '00005000 000    00500000 100 '*/
        public StringBasis FCCAE8 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00005000 000    00500000 100 ");
        /*"  10 FCCAE9 PIC X(30) VALUE '00002000 000    00050000 020 '*/
        public StringBasis FCCAE9 { get; set; } = new StringBasis(new PIC("X", "30", "X(30)"), @"00002000 000    00050000 020 ");
