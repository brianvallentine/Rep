...
namespace Copies
{
    public class LBTB3201_TABELA_LIM_MINMAX : VarBasis
    {
        ...
        /*"  10 FILLE7 PIC X(34) VALUE '5.000,00         500.000,00       '*/
        public StringBasis FILLE7 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         500.000,00       ");
        /*"  10 FILLE8 PIC X(34) VALUE '5.000,00         500.000,00       '*/
        public StringBasis FILLE8 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         500.000,00       ");
        ...
        /*"  10 FILL11 PIC X(34) VALUE '5.000,00         20% COB BASICA   '*/
        public StringBasis FILL11_1 { get; set; } = new StringBasis(new PIC("X", "34", "X(34)"), @"5.000,00         20% COB BASICA   ");
