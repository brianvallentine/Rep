...
{
    public class M_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1 : QueryBasis<M_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1 Execute(M_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1 m_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1)
        {
            var ths = m_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1;
        ...
        public override M_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_210_000_PESQ_V1PRAZOSEG_DB_SELECT_1_Query1();
            var i = 0;
