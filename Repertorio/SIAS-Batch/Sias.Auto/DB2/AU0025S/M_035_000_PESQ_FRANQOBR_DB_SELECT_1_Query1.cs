...
{
    public class M_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1 : QueryBasis<M_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1 Execute(M_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1 m_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1)
        {
            var ths = m_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1;
        ...
        public override M_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_035_000_PESQ_FRANQOBR_DB_SELECT_1_Query1();
            var i = 0;
