...
{
    public class M_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1 : QueryBasis<M_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string TAXAC_VERSAO { get; set; }

        public static M_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1 Execute(M_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1 m_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1)
        {
            var ths = m_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1;
        ...
        public override M_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_010_000_SELECIONA_TAXAS_DB_SELECT_1_Query1();
            var i = 0;
