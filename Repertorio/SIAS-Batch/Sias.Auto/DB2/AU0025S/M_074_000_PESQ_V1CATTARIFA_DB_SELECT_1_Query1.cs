...
{
    public class M_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1 : QueryBasis<M_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL SELECT VALUE(VLPRTXCF,50)
            INTO
            :CATTF-VLPRTXCF
        ...
        public static M_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1 Execute(M_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1 m_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1)
        {
            var ths = m_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1;
        ...
        public override M_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_074_000_PESQ_V1CATTARIFA_DB_SELECT_1_Query1();
            var i = 0;
