...
{
    public class SI9148B_C01_SIARDEVC : QueryBasis<SI9148B_C01_SIARDEVC>
    {
        ...
        public SI9148B_C01_SIARDEVC() { IsCursor = true; }

        public SI9148B_C01_SIARDEVC(bool justACursor)
        {
        ...
        public override SI9148B_C01_SIARDEVC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI9148B_C01_SIARDEVC();
            var i = 0;
