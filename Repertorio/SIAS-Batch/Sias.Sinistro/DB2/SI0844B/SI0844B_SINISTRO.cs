...
{
    public class SI0844B_SINISTRO : QueryBasis<SI0844B_SINISTRO>
    {
        ...
        public SI0844B_SINISTRO() { IsCursor = true; }

        public SI0844B_SINISTRO(bool justACursor)
        {
        ...
        public override SI0844B_SINISTRO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0844B_SINISTRO();
            var i = 0;
