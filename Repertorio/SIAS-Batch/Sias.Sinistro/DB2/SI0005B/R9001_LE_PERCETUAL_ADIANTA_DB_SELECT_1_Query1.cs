...
{
    public class R9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1 : QueryBasis<R9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1 Execute(R9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1 r9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1)
        {
            var ths = r9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1;
        ...
        public override R9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R9001_LE_PERCETUAL_ADIANTA_DB_SELECT_1_Query1();
            var i = 0;
