...
{
    public class R700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1 : QueryBasis<R700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1 Execute(R700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1 r700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1)
        {
            var ths = r700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1;
        ...
        public override R700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R700_CRITICA_APOL_POR_LOT_DB_SELECT_1_Query1();
            var i = 0;
