...
{
    public class R8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1 : QueryBasis<R8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND H1.COD_OPERACAO IN (1003 , 1004)
            )
            END-EXEC.
            */
            #endregion
        ...
        public static R8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1 Execute(R8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1 r8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1)
        {
            var ths = r8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1;
        ...
        public override R8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R8150_EST_INDENIZ_EFETIVADAS_DB_SELECT_1_Query1();
            var i = 0;
