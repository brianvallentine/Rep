...
{
    public class R111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1 : QueryBasis<R111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1 Execute(R111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1 r111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1)
        {
            var ths = r111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1;
        ...
        public override R111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R111_VERIFICA_PGTO_PREMIO_DB_SELECT_2_Query1();
            var i = 0;
