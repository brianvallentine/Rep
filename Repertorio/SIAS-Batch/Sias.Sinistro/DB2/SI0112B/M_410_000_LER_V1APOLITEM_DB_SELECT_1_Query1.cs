...
namespace Sias.Sinistro.DB2.SI0112B
{
    public class M_410_000_LER_V1APOLITEM_DB_SELECT_1_Query1 : QueryBasis<M_410_000_LER_V1APOLITEM_DB_SELECT_1_Query1>
    {
            ...
            */
            ...
            var query = @$"
				SELECT DESCR_ITEM
											...
											AND NRITEM = '{this.MEST_NRITEM}'";

            return query;
        }
        public string APITE_DESCRITEM { get; set; }
        public string MEST_NUM_APOL { get; set; }
        public string MEST_NRENDOS { get; set; }
        public string MEST_NRITEM { get; set; }
        ...
        public override M_410_000_LER_V1APOLITEM_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            var i = 0;
            dta.APITE_DESCRITEM = result[i++].Value?.ToString();
            return dta;
        }
