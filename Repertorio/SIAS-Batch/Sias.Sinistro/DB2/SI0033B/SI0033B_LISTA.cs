...
{
    public class SI0033B_LISTA : QueryBasis<SI0033B_LISTA>
    {
        ...
        public SI0033B_LISTA() { IsCursor = true; }

        public SI0033B_LISTA(bool justACursor)
        {
        ...
        public override SI0033B_LISTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0033B_LISTA();
            var i = 0;
