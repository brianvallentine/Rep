...
{
    public class R1240_00_INCLUI_SINISHIS_DB_INSERT_1_Insert1 : QueryBasis<R1240_00_INCLUI_SINISHIS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1240_00_INCLUI_SINISHIS_DB_INSERT_1_Insert1 r1240_00_INCLUI_SINISHIS_DB_INSERT_1_Insert1)
        {
            var ths = r1240_00_INCLUI_SINISHIS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1240_00_INCLUI_SINISHIS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
