...
{
    public class SI0853B_CPTPP : QueryBasis<SI0853B_CPTPP>
    {
        ...
        public SI0853B_CPTPP() { IsCursor = true; }

        public SI0853B_CPTPP(bool justACursor)
        {
        ...
        public override SI0853B_CPTPP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0853B_CPTPP();
            var i = 0;
