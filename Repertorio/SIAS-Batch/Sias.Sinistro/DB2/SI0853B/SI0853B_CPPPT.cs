...
{
    public class SI0853B_CPPPT : QueryBasis<SI0853B_CPPPT>
    {
        ...
        public SI0853B_CPPPT() { IsCursor = true; }

        public SI0853B_CPPPT(bool justACursor)
        {
        ...
        public override SI0853B_CPPPT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0853B_CPPPT();
            var i = 0;
