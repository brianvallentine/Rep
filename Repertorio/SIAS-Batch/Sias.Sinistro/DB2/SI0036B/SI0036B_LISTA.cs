...
{
    public class SI0036B_LISTA : QueryBasis<SI0036B_LISTA>
    {
        ...
        public SI0036B_LISTA() { IsCursor = true; }

        public SI0036B_LISTA(bool justACursor)
        {
        ...
        public override SI0036B_LISTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0036B_LISTA();
            var i = 0;
