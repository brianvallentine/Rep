...
{
    public class R0330_INSERT_CHEQUE_EMIT_DB_INSERT_1_Insert1 : QueryBasis<R0330_INSERT_CHEQUE_EMIT_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL INSERT INTO SEGUROS.CHEQUES_EMITIDOS
            (TIPO_MOVIMENTO,
            COD_FONTE,
            NUM_DOCUMENTO,
            NOME_FAVORECIDO,
        ...
        public static void Execute(R0330_INSERT_CHEQUE_EMIT_DB_INSERT_1_Insert1 r0330_INSERT_CHEQUE_EMIT_DB_INSERT_1_Insert1)
        {
            var ths = r0330_INSERT_CHEQUE_EMIT_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0330_INSERT_CHEQUE_EMIT_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
