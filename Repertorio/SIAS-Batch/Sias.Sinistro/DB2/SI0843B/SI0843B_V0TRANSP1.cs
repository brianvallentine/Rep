...
{
    public class SI0843B_V0TRANSP1 : QueryBasis<SI0843B_V0TRANSP1>
    {
        ...
        public SI0843B_V0TRANSP1() { IsCursor = true; }

        public SI0843B_V0TRANSP1(bool justACursor)
        {
        ...
        public string V0IND_VAL_DECLARADO { get; set; }
        ...
        public string V0SITUACAO { get; set; }
        ...
        public override SI0843B_V0TRANSP1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0843B_V0TRANSP1();
            var i = 0;

            dta.V0NUM_APOL_SINISTRO = result[i++].Value?.ToString();
            dta.V0COD_FRANQUE = result[i++].Value?.ToString();
            dta.V0IND_VAL_DECLARADO = result[i++].Value?.ToString();
            ...
            dta.V0SITUACAO = result[i++].Value?.ToString();
