...
{
    public class SI0843B_V0RELATORIOS : QueryBasis<SI0843B_V0RELATORIOS>
    {
        ...
        public SI0843B_V0RELATORIOS() { IsCursor = true; }

        public SI0843B_V0RELATORIOS(bool justACursor)
        {
        ...
        public override SI0843B_V0RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0843B_V0RELATORIOS();
            var i = 0;
