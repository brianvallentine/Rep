...
{
    public class SI9108B_C01_SIARDEVC : QueryBasis<SI9108B_C01_SIARDEVC>
    {
        ...
        public SI9108B_C01_SIARDEVC() { IsCursor = true; }

        public SI9108B_C01_SIARDEVC(bool justACursor)
        {
        ...
        public override SI9108B_C01_SIARDEVC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI9108B_C01_SIARDEVC();
            var i = 0;
