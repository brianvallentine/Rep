...
{
    public class SISAP15B_LE_MOVDEBCE : QueryBasis<SISAP15B_LE_MOVDEBCE>
    {
        ...
        public SISAP15B_LE_MOVDEBCE() { IsCursor = true; }

        public SISAP15B_LE_MOVDEBCE(bool justACursor)
        {
        ...
        public override SISAP15B_LE_MOVDEBCE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SISAP15B_LE_MOVDEBCE();
            var i = 0;
