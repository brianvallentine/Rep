...
{
    public class SISAP01B_IMPOSTOS : QueryBasis<SISAP01B_IMPOSTOS>
    {
        ...
        public SISAP01B_IMPOSTOS() { IsCursor = true; }

        public SISAP01B_IMPOSTOS(bool justACursor)
        {
        ...
        public override SISAP01B_IMPOSTOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SISAP01B_IMPOSTOS();
            var i = 0;
