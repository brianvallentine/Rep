...
{
    public class SISAP01B_LE_MOVDEBCE : QueryBasis<SISAP01B_LE_MOVDEBCE>
    {
        ...
        public SISAP01B_LE_MOVDEBCE() { IsCursor = true; }

        public SISAP01B_LE_MOVDEBCE(bool justACursor)
        {
        ...
        public override SISAP01B_LE_MOVDEBCE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SISAP01B_LE_MOVDEBCE();
            var i = 0;
