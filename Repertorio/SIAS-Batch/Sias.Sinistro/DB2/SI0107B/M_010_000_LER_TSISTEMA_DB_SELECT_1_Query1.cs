...
namespace Sias.Sinistro.DB2.SI0107B
{
    public class M_010_000_LER_TSISTEMA_DB_SELECT_1_Query1 : QueryBasis<M_010_000_LER_TSISTEMA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            /*EXEC SQL
            SELECT
            DTMOVABE, CURRENT DATE
            INTO
            :TSISTEMA-DTMOVABE, :TSISTEMA-DTCURRENT
        ...
        public string TSISTEMA_DTCURRENT { get; set; }
        ...
        public override M_010_000_LER_TSISTEMA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            var i = 0;
            dta.TSISTEMA_DTMOVABE = result[i++].Value?.ToString();
            dta.TSISTEMA_DTCURRENT = result[i++].Value?.ToString();
            return dta;
        }
