...
{
    public class R3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1 : QueryBasis<R3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            ,A.NOM_CIDADE
            ,VALUE(A.COD_UF, ' ' )
            INTO :EF083-DES-ENDERECO
            ,:EF083-DES-COMPL-ENDERECO
            ,:EF083-NOM-BAIRRO
            ,:EF083-NUM-CEP
            ,:EF083-NOM-CIDADE
            ,:EF083-COD-UF
        ...
        public string EF083_DES_ENDERECO { get; set; }
        public string EF083_DES_COMPL_ENDERECO { get; set; }
        ...
        public static R3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1 Execute(R3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1 r3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1)
        {
            var ths = r3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1;
        ...
        public override R3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3000_SEL_IMOVEL_OBJ_CTRTO_SEG_DB_SELECT_1_Query1();
            var i = 0;
            dta.EF083_DES_ENDERECO = result[i++].Value?.ToString();
            dta.EF083_DES_COMPL_ENDERECO = result[i++].Value?.ToString();
