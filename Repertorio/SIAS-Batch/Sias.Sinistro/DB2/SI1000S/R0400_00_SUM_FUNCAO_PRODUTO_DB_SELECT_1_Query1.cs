...
{
    public class R0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1 : QueryBasis<R0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            WHERE A.COD_PRODUTO = :SINISHIS-COD-PRODUTO
            ...
            */
            ...
            var query = @$"
				SELECT VALUE(SUM(A.VAL_OPERACAO * B.NUM_FATOR)
							...
							,
											SEGUROS.GE_SIS_FUNCAO_OPER B
											WHERE A.COD_PRODUTO = '{this.SINISHIS_COD_PRODUTO}'
        ...
        public static R0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1 Execute(R0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1 r0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1)
        {
            var ths = r0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1;
        ...
        public override R0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0400_00_SUM_FUNCAO_PRODUTO_DB_SELECT_1_Query1();
            var i = 0;
