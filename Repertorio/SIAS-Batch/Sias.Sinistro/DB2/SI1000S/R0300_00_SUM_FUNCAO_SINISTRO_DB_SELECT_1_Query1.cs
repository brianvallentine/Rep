...
{
    public class R0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1 : QueryBasis<R0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            var query = @$"
				SELECT VALUE(SUM(A.VAL_OPERACAO * B.NUM_FATOR)
							...
							,
											SEGUROS.GE_SIS_FUNCAO_OPER B
											WHERE A.NUM_APOL_SINISTRO
											= '{this.SINISMES_NUM_APOL_SINISTRO}'
        ...
        public static R0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1 Execute(R0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1 r0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1)
        {
            var ths = r0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1;
        ...
        public override R0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0300_00_SUM_FUNCAO_SINISTRO_DB_SELECT_1_Query1();
            var i = 0;
