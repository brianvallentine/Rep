...
{
    public class SI9268B_C01_SIARDEVC : QueryBasis<SI9268B_C01_SIARDEVC>
    {
        ...
        public SI9268B_C01_SIARDEVC() { IsCursor = true; }

        public SI9268B_C01_SIARDEVC(bool justACursor)
        {
        ...
        public override SI9268B_C01_SIARDEVC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI9268B_C01_SIARDEVC();
            var i = 0;
