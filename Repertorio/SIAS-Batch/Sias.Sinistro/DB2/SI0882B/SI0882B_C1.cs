...
{
    public class SI0882B_C1 : QueryBasis<SI0882B_C1>
    {
        ...
        public SI0882B_C1() { IsCursor = true; }

        public SI0882B_C1(bool justACursor)
        {
        ...
        public override SI0882B_C1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0882B_C1();
            var i = 0;
