...
{
    public class SI0809B_JOIN_HIST_MEST : QueryBasis<SI0809B_JOIN_HIST_MEST>
    {
        ...
        public SI0809B_JOIN_HIST_MEST() { IsCursor = true; }

        public SI0809B_JOIN_HIST_MEST(bool justACursor)
        {
        ...
        public string V0HIST_OPERACAO { get; set; }
        ...
        public override SI0809B_JOIN_HIST_MEST OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0809B_JOIN_HIST_MEST();
            var i = 0;
            ...
            dta.V0HIST_OPERACAO = result[i++].Value?.ToString();
