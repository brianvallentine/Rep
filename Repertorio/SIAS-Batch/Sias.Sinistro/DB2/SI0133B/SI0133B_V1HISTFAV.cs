...
{
    public class SI0133B_V1HISTFAV : QueryBasis<SI0133B_V1HISTFAV>
    {
        ...
        public SI0133B_V1HISTFAV() { IsCursor = true; }

        public SI0133B_V1HISTFAV(bool justACursor)
        {
        ...
        public override SI0133B_V1HISTFAV OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0133B_V1HISTFAV();
            var i = 0;
