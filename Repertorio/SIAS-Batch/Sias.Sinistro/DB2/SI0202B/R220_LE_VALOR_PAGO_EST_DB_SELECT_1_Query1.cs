...
{
    public class R220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1 : QueryBasis<R220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1 Execute(R220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1 r220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1)
        {
            var ths = r220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1;
        ...
        public override R220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R220_LE_VALOR_PAGO_EST_DB_SELECT_1_Query1();
            var i = 0;
