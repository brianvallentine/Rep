...
{
    public class SI0202B_XXXXX : QueryBasis<SI0202B_XXXXX>
    {
        ...
        public SI0202B_XXXXX() { IsCursor = true; }

        public SI0202B_XXXXX(bool justACursor)
        {
        ...
        public override SI0202B_XXXXX OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0202B_XXXXX();
            var i = 0;
