...
{
    public class SI0867B_APOLICE : QueryBasis<SI0867B_APOLICE>
    {
        ...
        public SI0867B_APOLICE() { IsCursor = true; }

        public SI0867B_APOLICE(bool justACursor)
        {
        ...
        public override SI0867B_APOLICE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0867B_APOLICE();
            var i = 0;
