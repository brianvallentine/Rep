...
{
    public class SI0867B_RELATORIOS : QueryBasis<SI0867B_RELATORIOS>
    {
        ...
        public SI0867B_RELATORIOS() { IsCursor = true; }

        public SI0867B_RELATORIOS(bool justACursor)
        {
        ...
        public override SI0867B_RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0867B_RELATORIOS();
            var i = 0;
