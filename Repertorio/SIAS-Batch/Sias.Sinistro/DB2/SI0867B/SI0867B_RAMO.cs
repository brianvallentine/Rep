...
{
    public class SI0867B_RAMO : QueryBasis<SI0867B_RAMO>
    {
        ...
        public SI0867B_RAMO() { IsCursor = true; }

        public SI0867B_RAMO(bool justACursor)
        {
        ...
        public override SI0867B_RAMO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0867B_RAMO();
            var i = 0;
