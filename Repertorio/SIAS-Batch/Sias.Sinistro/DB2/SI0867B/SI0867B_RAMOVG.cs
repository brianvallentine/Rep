...
{
    public class SI0867B_RAMOVG : QueryBasis<SI0867B_RAMOVG>
    {
        ...
        public SI0867B_RAMOVG() { IsCursor = true; }

        public SI0867B_RAMOVG(bool justACursor)
        {
        ...
        public override SI0867B_RAMOVG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0867B_RAMOVG();
            var i = 0;
