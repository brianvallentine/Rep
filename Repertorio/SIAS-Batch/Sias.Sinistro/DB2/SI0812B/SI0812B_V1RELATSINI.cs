...
{
    public class SI0812B_V1RELATSINI : QueryBasis<SI0812B_V1RELATSINI>
    {
        ...
        public SI0812B_V1RELATSINI() { IsCursor = true; }

        public SI0812B_V1RELATSINI(bool justACursor)
        {
        ...
        public override SI0812B_V1RELATSINI OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0812B_V1RELATSINI();
            var i = 0;
