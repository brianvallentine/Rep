...
{
    public class SI0896B_C1 : QueryBasis<SI0896B_C1>
    {
        ...
        public SI0896B_C1() { IsCursor = true; }

        public SI0896B_C1(bool justACursor)
        {
        ...
        public override SI0896B_C1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0896B_C1();
            var i = 0;
