...
{
    public class SI0896B_CTRAB : QueryBasis<SI0896B_CTRAB>
    {
        ...
        public SI0896B_CTRAB() { IsCursor = true; }

        public SI0896B_CTRAB(bool justACursor)
        {
        ...
        public override SI0896B_CTRAB OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0896B_CTRAB();
            var i = 0;
            ...
            dta.SINIPLAN_OCORHIST = result[i++].Value?.ToString();
