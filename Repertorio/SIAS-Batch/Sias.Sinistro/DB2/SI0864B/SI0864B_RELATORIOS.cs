...
{
    public class SI0864B_RELATORIOS : QueryBasis<SI0864B_RELATORIOS>
    {
        ...
        public SI0864B_RELATORIOS() { IsCursor = true; }

        public SI0864B_RELATORIOS(bool justACursor)
        {
        ...
        public override SI0864B_RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0864B_RELATORIOS();
            var i = 0;
