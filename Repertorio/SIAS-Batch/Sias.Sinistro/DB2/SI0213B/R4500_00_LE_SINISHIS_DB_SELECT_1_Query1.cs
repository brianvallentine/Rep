...
{
    public class R4500_00_LE_SINISHIS_DB_SELECT_1_Query1 : QueryBasis<R4500_00_LE_SINISHIS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND A.COD_OPERACAO IN (4101, 4102)
        ...
        public string HOST_VAL_RECEBIDO { get; set; }
        ...
        public static R4500_00_LE_SINISHIS_DB_SELECT_1_Query1 Execute(R4500_00_LE_SINISHIS_DB_SELECT_1_Query1 r4500_00_LE_SINISHIS_DB_SELECT_1_Query1)
        {
            var ths = r4500_00_LE_SINISHIS_DB_SELECT_1_Query1;
        ...
        public override R4500_00_LE_SINISHIS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R4500_00_LE_SINISHIS_DB_SELECT_1_Query1();
            var i = 0;
            dta.HOST_VAL_RECEBIDO = result[i++].Value?.ToString();
            return dta;
        }
