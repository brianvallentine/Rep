...
{
    public class R2600_00_LE_SINCREIN_DB_SELECT_1_Query1 : QueryBasis<R2600_00_LE_SINCREIN_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2600_00_LE_SINCREIN_DB_SELECT_1_Query1 Execute(R2600_00_LE_SINCREIN_DB_SELECT_1_Query1 r2600_00_LE_SINCREIN_DB_SELECT_1_Query1)
        {
            var ths = r2600_00_LE_SINCREIN_DB_SELECT_1_Query1;
        ...
        public override R2600_00_LE_SINCREIN_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2600_00_LE_SINCREIN_DB_SELECT_1_Query1();
            var i = 0;
