...
{
    public class SI0213B_C01_SINISHIS : QueryBasis<SI0213B_C01_SINISHIS>
    {
        ...
        public SI0213B_C01_SINISHIS() { IsCursor = true; }

        public SI0213B_C01_SINISHIS(bool justACursor)
        {
        ...
        public override SI0213B_C01_SINISHIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0213B_C01_SINISHIS();
            var i = 0;
