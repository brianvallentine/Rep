...
{
    public class R100_ROTINA_CRITICA_DB_SELECT_5_Query1 : QueryBasis<R100_ROTINA_CRITICA_DB_SELECT_5_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R100_ROTINA_CRITICA_DB_SELECT_5_Query1 Execute(R100_ROTINA_CRITICA_DB_SELECT_5_Query1 r100_ROTINA_CRITICA_DB_SELECT_5_Query1)
        {
            var ths = r100_ROTINA_CRITICA_DB_SELECT_5_Query1;
        ...
        public override R100_ROTINA_CRITICA_DB_SELECT_5_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R100_ROTINA_CRITICA_DB_SELECT_5_Query1();
            var i = 0;
