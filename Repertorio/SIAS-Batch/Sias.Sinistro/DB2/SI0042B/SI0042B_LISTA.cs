...
{
    public class SI0042B_LISTA : QueryBasis<SI0042B_LISTA>
    {
        ...
        public SI0042B_LISTA() { IsCursor = true; }

        public SI0042B_LISTA(bool justACursor)
        {
        ...
        public override SI0042B_LISTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0042B_LISTA();
            var i = 0;
