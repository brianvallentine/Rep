...
{
    public class M_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1 : QueryBasis<M_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1 Execute(M_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1 m_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1)
        {
            var ths = m_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1;
        ...
        public override M_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_030_PROCESSA_LOTERICO_DB_SELECT_7_Query1();
            var i = 0;
