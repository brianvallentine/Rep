...
{
    public class SI0035B_LISTA : QueryBasis<SI0035B_LISTA>
    {
        ...
        public SI0035B_LISTA() { IsCursor = true; }

        public SI0035B_LISTA(bool justACursor)
        {
        ...
        public override SI0035B_LISTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0035B_LISTA();
            var i = 0;
