...
{
    public class R2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1 : QueryBasis<R2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1 Execute(R2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1 r2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1)
        {
            var ths = r2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1;
        ...
        public override R2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2210_00_ACESSA_APOLICRE_DB_SELECT_1_Query1();
            var i = 0;
