...
{
    public class R2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1 : QueryBasis<R2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1 Execute(R2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1 r2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1)
        {
            var ths = r2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1;
        ...
        public override R2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2400_00_TRAZ_NOM_HAB_MATCON_DB_SELECT_1_Query1();
            var i = 0;
