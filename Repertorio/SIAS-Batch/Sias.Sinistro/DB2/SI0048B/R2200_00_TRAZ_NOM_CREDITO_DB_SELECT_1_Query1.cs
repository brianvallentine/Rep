...
{
    public class R2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1 : QueryBasis<R2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1 Execute(R2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1 r2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1)
        {
            var ths = r2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1;
        ...
        public override R2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2200_00_TRAZ_NOM_CREDITO_DB_SELECT_1_Query1();
            var i = 0;
