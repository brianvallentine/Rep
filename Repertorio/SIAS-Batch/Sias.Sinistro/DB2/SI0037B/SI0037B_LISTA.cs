...
{
    public class SI0037B_LISTA : QueryBasis<SI0037B_LISTA>
    {
        ...
        public SI0037B_LISTA() { IsCursor = true; }

        public SI0037B_LISTA(bool justACursor)
        {
        ...
        public override SI0037B_LISTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0037B_LISTA();
            var i = 0;
