...
{
    public class SI0868B_RAMO : QueryBasis<SI0868B_RAMO>
    {
        ...
        public SI0868B_RAMO() { IsCursor = true; }

        public SI0868B_RAMO(bool justACursor)
        {
        ...
        public override SI0868B_RAMO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0868B_RAMO();
            var i = 0;
