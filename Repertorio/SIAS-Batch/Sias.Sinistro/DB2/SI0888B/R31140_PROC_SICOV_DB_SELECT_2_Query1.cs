...
{
    public class R31140_PROC_SICOV_DB_SELECT_2_Query1 : QueryBasis<R31140_PROC_SICOV_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R31140_PROC_SICOV_DB_SELECT_2_Query1 Execute(R31140_PROC_SICOV_DB_SELECT_2_Query1 r31140_PROC_SICOV_DB_SELECT_2_Query1)
        {
            var ths = r31140_PROC_SICOV_DB_SELECT_2_Query1;
        ...
        public override R31140_PROC_SICOV_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R31140_PROC_SICOV_DB_SELECT_2_Query1();
            var i = 0;
