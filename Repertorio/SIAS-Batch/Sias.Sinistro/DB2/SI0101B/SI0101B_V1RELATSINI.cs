...
{
    public class SI0101B_V1RELATSINI : QueryBasis<SI0101B_V1RELATSINI>
    {
        ...
        public SI0101B_V1RELATSINI() { IsCursor = true; }

        public SI0101B_V1RELATSINI(bool justACursor)
        {
        ...
        public override SI0101B_V1RELATSINI OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0101B_V1RELATSINI();
            var i = 0;
