...
{
    public class SI0095B_INDENIZACOES : QueryBasis<SI0095B_INDENIZACOES>
    {
        ...
        public SI0095B_INDENIZACOES() { IsCursor = true; }

        public SI0095B_INDENIZACOES(bool justACursor)
        {
        ...
        public override SI0095B_INDENIZACOES OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0095B_INDENIZACOES();
            var i = 0;
