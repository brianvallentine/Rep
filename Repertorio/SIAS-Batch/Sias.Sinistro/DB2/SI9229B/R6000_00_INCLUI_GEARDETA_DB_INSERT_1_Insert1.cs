...
{
    public class R6000_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1 : QueryBasis<R6000_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :GEARDETA-DTH-MOVIMENTO,
            :GEARDETA-DTH-GERACAO,
            :GEARDETA-DTH-RECEPCAO,
        ...
        public string GEARDETA_DTH_MOVIMENTO { get; set; }
        public string GEARDETA_DTH_GERACAO { get; set; }
        public string GEARDETA_DTH_RECEPCAO { get; set; }
        ...
        public static void Execute(R6000_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1 r6000_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1)
        {
            var ths = r6000_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R6000_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
