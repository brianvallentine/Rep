...
{
    public class SI0105B_RELATORIOS : QueryBasis<SI0105B_RELATORIOS>
    {
        ...
        public SI0105B_RELATORIOS() { IsCursor = true; }

        public SI0105B_RELATORIOS(bool justACursor)
        {
        ...
        public override SI0105B_RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0105B_RELATORIOS();
            var i = 0;
