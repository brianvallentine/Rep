...
{
    public class R1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1 : QueryBasis<R1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1 Execute(R1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1 r1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1)
        {
            var ths = r1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1;
        ...
        public override R1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1610_00_ATUAL_SI_PESS_DB_SELECT_1_Query1();
            var i = 0;
