...
{
    public class R1520_00_INCLUI_SINIS_DB_INSERT_1_Insert1 : QueryBasis<R1520_00_INCLUI_SINIS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1520_00_INCLUI_SINIS_DB_INSERT_1_Insert1 r1520_00_INCLUI_SINIS_DB_INSERT_1_Insert1)
        {
            var ths = r1520_00_INCLUI_SINIS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1520_00_INCLUI_SINIS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
