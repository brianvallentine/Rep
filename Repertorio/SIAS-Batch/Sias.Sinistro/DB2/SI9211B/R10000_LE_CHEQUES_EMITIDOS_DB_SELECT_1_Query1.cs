...
namespace Sias.Sinistro.DB2.SI9211B
{
    public class R10000_LE_CHEQUES_EMITIDOS_DB_SELECT_1_Query1 : QueryBasis<R10000_LE_CHEQUES_EMITIDOS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            :CHEQUEMI-DATA-MOVIMENTO:IND-DATA-MOV,
        ...
        public string IND_DATA_MOV { get; set; }
        ...
        public override R10000_LE_CHEQUES_EMITIDOS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.CHEQUEMI_DATA_MOVIMENTO = result[i++].Value?.ToString();
            dta.IND_DATA_MOV = string.IsNullOrWhiteSpace(dta.CHEQUEMI_DATA_MOVIMENTO) ? "-1" : "0";
            dta.CHEQUEMI_SIT_REGISTRO = result[i++].Value?.ToString();
            return dta;
        }
