...
{
    public class R1643_00_INSERT_GE_MOVTO_CONT_DB_INSERT_1_Insert1 : QueryBasis<R1643_00_INSERT_GE_MOVTO_CONT_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1643_00_INSERT_GE_MOVTO_CONT_DB_INSERT_1_Insert1 r1643_00_INSERT_GE_MOVTO_CONT_DB_INSERT_1_Insert1)
        {
            var ths = r1643_00_INSERT_GE_MOVTO_CONT_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1643_00_INSERT_GE_MOVTO_CONT_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
