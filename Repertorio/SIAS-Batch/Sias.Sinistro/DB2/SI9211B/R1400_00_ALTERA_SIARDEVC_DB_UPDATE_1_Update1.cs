    ...
    public class R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1_Update1 : QueryBasis<R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
				...
				SET STA_RETORNO = '2' ,
				NUM_IDENTIFICADOR =  '{this.SIARDEVC_NUM_IDENTIFICADOR}',
				VAL_LIQUIDO_PAGTO =  '{this.SIARDEVC_VAL_LIQUIDO_PAGTO}',
				NUM_CHEQUE_INTERNO =  '{this.SIARDEVC_NUM_CHEQUE_INTERNO}',
				STA_PROCESSAMENTO =  '{this.SIARDEVC_STA_PROCESSAMENTO}'
