...
{
    public class SI0845B_SINISTRO : QueryBasis<SI0845B_SINISTRO>
    {
        ...
        public SI0845B_SINISTRO() { IsCursor = true; }

        public SI0845B_SINISTRO(bool justACursor)
        {
        ...
        public string V1HSIN_CODUSU { get; set; }
        ...
        public override SI0845B_SINISTRO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0845B_SINISTRO();
            var i = 0;
            ...
            dta.V1HSIN_CODUSU = result[i++].Value?.ToString();
