...
{
    public class SI9109B_C01_SIARDEVC : QueryBasis<SI9109B_C01_SIARDEVC>
    {
        ...
        public SI9109B_C01_SIARDEVC() { IsCursor = true; }

        public SI9109B_C01_SIARDEVC(bool justACursor)
        {
        ...
        public override SI9109B_C01_SIARDEVC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI9109B_C01_SIARDEVC();
            var i = 0;
