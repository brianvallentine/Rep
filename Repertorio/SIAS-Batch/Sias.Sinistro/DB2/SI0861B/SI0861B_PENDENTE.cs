...
{
    public class SI0861B_PENDENTE : QueryBasis<SI0861B_PENDENTE>
    {
        ...
        public SI0861B_PENDENTE() { IsCursor = true; }

        public SI0861B_PENDENTE(bool justACursor)
        {
        ...
        public override SI0861B_PENDENTE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0861B_PENDENTE();
            var i = 0;
