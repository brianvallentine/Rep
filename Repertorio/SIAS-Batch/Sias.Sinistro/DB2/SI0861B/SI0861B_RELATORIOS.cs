...
{
    public class SI0861B_RELATORIOS : QueryBasis<SI0861B_RELATORIOS>
    {
        ...
        public SI0861B_RELATORIOS() { IsCursor = true; }

        public SI0861B_RELATORIOS(bool justACursor)
        {
        ...
        public string HOST_APOLICE_INICIAL { get; set; }
        ...
        public override SI0861B_RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0861B_RELATORIOS();
            var i = 0;
            ...
            dta.HOST_APOLICE_INICIAL = result[i++].Value?.ToString();
