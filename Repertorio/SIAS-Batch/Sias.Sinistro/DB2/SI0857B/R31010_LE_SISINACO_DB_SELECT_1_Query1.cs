...
{
    public class R31010_LE_SISINACO_DB_SELECT_1_Query1 : QueryBasis<R31010_LE_SISINACO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND COD_EVENTO = 1001
            ORDER BY DATA_MOVTO_SINIACO DESC
        ...
        public static R31010_LE_SISINACO_DB_SELECT_1_Query1 Execute(R31010_LE_SISINACO_DB_SELECT_1_Query1 r31010_LE_SISINACO_DB_SELECT_1_Query1)
        {
            var ths = r31010_LE_SISINACO_DB_SELECT_1_Query1;
        ...
        public override R31010_LE_SISINACO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R31010_LE_SISINACO_DB_SELECT_1_Query1();
            var i = 0;
