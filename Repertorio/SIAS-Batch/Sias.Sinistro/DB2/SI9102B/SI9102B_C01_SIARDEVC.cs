...
{
    public class SI9102B_C01_SIARDEVC : QueryBasis<SI9102B_C01_SIARDEVC>
    {
        ...
        public SI9102B_C01_SIARDEVC() { IsCursor = true; }

        public SI9102B_C01_SIARDEVC(bool justACursor)
        {
        ...
        public string SIARDEVC_STA_RETORNO { get; set; }
        ...
        public override SI9102B_C01_SIARDEVC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI9102B_C01_SIARDEVC();
            var i = 0;
            ...
            dta.SIARDEVC_STA_RETORNO = result[i++].Value?.ToString();
