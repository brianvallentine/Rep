...
{
    public class SI0805B_TMESTSIN : QueryBasis<SI0805B_TMESTSIN>
    {
        ...
        public SI0805B_TMESTSIN() { IsCursor = true; }

        public SI0805B_TMESTSIN(bool justACursor)
        {
        ...
        public override SI0805B_TMESTSIN OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0805B_TMESTSIN();
            var i = 0;
