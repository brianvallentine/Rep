...
namespace Sias.Sinistro.DB2.SI9168B
{
    public class SI9168B_C01_SIARDEVC : QueryBasis<SI9168B_C01_SIARDEVC>
    {
        ...
        public SI9168B_C01_SIARDEVC() { IsCursor = true; }

        public SI9168B_C01_SIARDEVC(bool justACursor)
        {
        ...
        public override SI9168B_C01_SIARDEVC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI9168B_C01_SIARDEVC();
            var i = 0;
