...
{
    public class R230_GRAVA_RESSARC_PCLA_DB_INSERT_1_Insert1 : QueryBasis<R230_GRAVA_RESSARC_PCLA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R230_GRAVA_RESSARC_PCLA_DB_INSERT_1_Insert1 r230_GRAVA_RESSARC_PCLA_DB_INSERT_1_Insert1)
        {
            var ths = r230_GRAVA_RESSARC_PCLA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R230_GRAVA_RESSARC_PCLA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
