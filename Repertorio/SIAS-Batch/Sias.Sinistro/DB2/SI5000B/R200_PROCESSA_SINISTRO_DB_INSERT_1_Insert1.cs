...
{
    public class R200_PROCESSA_SINISTRO_DB_INSERT_1_Insert1 : QueryBasis<R200_PROCESSA_SINISTRO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R200_PROCESSA_SINISTRO_DB_INSERT_1_Insert1 r200_PROCESSA_SINISTRO_DB_INSERT_1_Insert1)
        {
            var ths = r200_PROCESSA_SINISTRO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R200_PROCESSA_SINISTRO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
