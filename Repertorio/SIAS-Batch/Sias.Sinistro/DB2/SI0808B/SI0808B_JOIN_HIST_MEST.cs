...
{
    public class SI0808B_JOIN_HIST_MEST : QueryBasis<SI0808B_JOIN_HIST_MEST>
    {
        ...
        public SI0808B_JOIN_HIST_MEST() { IsCursor = true; }

        public SI0808B_JOIN_HIST_MEST(bool justACursor)
        {
        ...
        public override SI0808B_JOIN_HIST_MEST OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0808B_JOIN_HIST_MEST();
            var i = 0;
