...
{
    public class R180_GRAVA_COLUNA_O_DB_SELECT_1_Query1 : QueryBasis<R180_GRAVA_COLUNA_O_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R180_GRAVA_COLUNA_O_DB_SELECT_1_Query1 Execute(R180_GRAVA_COLUNA_O_DB_SELECT_1_Query1 r180_GRAVA_COLUNA_O_DB_SELECT_1_Query1)
        {
            var ths = r180_GRAVA_COLUNA_O_DB_SELECT_1_Query1;
        ...
        public override R180_GRAVA_COLUNA_O_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R180_GRAVA_COLUNA_O_DB_SELECT_1_Query1();
            var i = 0;
