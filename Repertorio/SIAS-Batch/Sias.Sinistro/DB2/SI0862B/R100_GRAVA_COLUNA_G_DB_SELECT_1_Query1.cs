...
{
    public class R100_GRAVA_COLUNA_G_DB_SELECT_1_Query1 : QueryBasis<R100_GRAVA_COLUNA_G_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R100_GRAVA_COLUNA_G_DB_SELECT_1_Query1 Execute(R100_GRAVA_COLUNA_G_DB_SELECT_1_Query1 r100_GRAVA_COLUNA_G_DB_SELECT_1_Query1)
        {
            var ths = r100_GRAVA_COLUNA_G_DB_SELECT_1_Query1;
        ...
        public override R100_GRAVA_COLUNA_G_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R100_GRAVA_COLUNA_G_DB_SELECT_1_Query1();
            var i = 0;
