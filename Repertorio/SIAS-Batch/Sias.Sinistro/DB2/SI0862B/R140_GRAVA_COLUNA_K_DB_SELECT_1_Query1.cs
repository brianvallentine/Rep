...
{
    public class R140_GRAVA_COLUNA_K_DB_SELECT_1_Query1 : QueryBasis<R140_GRAVA_COLUNA_K_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R140_GRAVA_COLUNA_K_DB_SELECT_1_Query1 Execute(R140_GRAVA_COLUNA_K_DB_SELECT_1_Query1 r140_GRAVA_COLUNA_K_DB_SELECT_1_Query1)
        {
            var ths = r140_GRAVA_COLUNA_K_DB_SELECT_1_Query1;
        ...
        public override R140_GRAVA_COLUNA_K_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R140_GRAVA_COLUNA_K_DB_SELECT_1_Query1();
            var i = 0;
