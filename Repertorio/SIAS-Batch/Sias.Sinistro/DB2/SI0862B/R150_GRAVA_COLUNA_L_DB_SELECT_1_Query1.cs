...
{
    public class R150_GRAVA_COLUNA_L_DB_SELECT_1_Query1 : QueryBasis<R150_GRAVA_COLUNA_L_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R150_GRAVA_COLUNA_L_DB_SELECT_1_Query1 Execute(R150_GRAVA_COLUNA_L_DB_SELECT_1_Query1 r150_GRAVA_COLUNA_L_DB_SELECT_1_Query1)
        {
            var ths = r150_GRAVA_COLUNA_L_DB_SELECT_1_Query1;
        ...
        public override R150_GRAVA_COLUNA_L_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R150_GRAVA_COLUNA_L_DB_SELECT_1_Query1();
            var i = 0;
