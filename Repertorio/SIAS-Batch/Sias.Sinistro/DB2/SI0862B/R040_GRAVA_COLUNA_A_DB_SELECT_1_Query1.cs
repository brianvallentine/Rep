...
{
    public class R040_GRAVA_COLUNA_A_DB_SELECT_1_Query1 : QueryBasis<R040_GRAVA_COLUNA_A_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R040_GRAVA_COLUNA_A_DB_SELECT_1_Query1 Execute(R040_GRAVA_COLUNA_A_DB_SELECT_1_Query1 r040_GRAVA_COLUNA_A_DB_SELECT_1_Query1)
        {
            var ths = r040_GRAVA_COLUNA_A_DB_SELECT_1_Query1;
        ...
        public override R040_GRAVA_COLUNA_A_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R040_GRAVA_COLUNA_A_DB_SELECT_1_Query1();
            var i = 0;
