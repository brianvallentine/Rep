...
{
    public class R090_GRAVA_COLUNA_F_DB_SELECT_1_Query1 : QueryBasis<R090_GRAVA_COLUNA_F_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R090_GRAVA_COLUNA_F_DB_SELECT_1_Query1 Execute(R090_GRAVA_COLUNA_F_DB_SELECT_1_Query1 r090_GRAVA_COLUNA_F_DB_SELECT_1_Query1)
        {
            var ths = r090_GRAVA_COLUNA_F_DB_SELECT_1_Query1;
        ...
        public override R090_GRAVA_COLUNA_F_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R090_GRAVA_COLUNA_F_DB_SELECT_1_Query1();
            var i = 0;
