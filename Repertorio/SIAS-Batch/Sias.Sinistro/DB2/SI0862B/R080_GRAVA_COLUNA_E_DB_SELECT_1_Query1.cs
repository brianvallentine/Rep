...
{
    public class R080_GRAVA_COLUNA_E_DB_SELECT_1_Query1 : QueryBasis<R080_GRAVA_COLUNA_E_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R080_GRAVA_COLUNA_E_DB_SELECT_1_Query1 Execute(R080_GRAVA_COLUNA_E_DB_SELECT_1_Query1 r080_GRAVA_COLUNA_E_DB_SELECT_1_Query1)
        {
            var ths = r080_GRAVA_COLUNA_E_DB_SELECT_1_Query1;
        ...
        public override R080_GRAVA_COLUNA_E_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R080_GRAVA_COLUNA_E_DB_SELECT_1_Query1();
            var i = 0;
