...
{
    public class R190_GRAVA_COLUNA_P_DB_SELECT_1_Query1 : QueryBasis<R190_GRAVA_COLUNA_P_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R190_GRAVA_COLUNA_P_DB_SELECT_1_Query1 Execute(R190_GRAVA_COLUNA_P_DB_SELECT_1_Query1 r190_GRAVA_COLUNA_P_DB_SELECT_1_Query1)
        {
            var ths = r190_GRAVA_COLUNA_P_DB_SELECT_1_Query1;
        ...
        public override R190_GRAVA_COLUNA_P_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R190_GRAVA_COLUNA_P_DB_SELECT_1_Query1();
            var i = 0;
