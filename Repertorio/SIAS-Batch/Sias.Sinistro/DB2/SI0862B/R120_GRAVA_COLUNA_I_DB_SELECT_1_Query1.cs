...
{
    public class R120_GRAVA_COLUNA_I_DB_SELECT_1_Query1 : QueryBasis<R120_GRAVA_COLUNA_I_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R120_GRAVA_COLUNA_I_DB_SELECT_1_Query1 Execute(R120_GRAVA_COLUNA_I_DB_SELECT_1_Query1 r120_GRAVA_COLUNA_I_DB_SELECT_1_Query1)
        {
            var ths = r120_GRAVA_COLUNA_I_DB_SELECT_1_Query1;
        ...
        public override R120_GRAVA_COLUNA_I_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R120_GRAVA_COLUNA_I_DB_SELECT_1_Query1();
            var i = 0;
