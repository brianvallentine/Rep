...
{
    public class R070_GRAVA_COLUNA_D_DB_SELECT_1_Query1 : QueryBasis<R070_GRAVA_COLUNA_D_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R070_GRAVA_COLUNA_D_DB_SELECT_1_Query1 Execute(R070_GRAVA_COLUNA_D_DB_SELECT_1_Query1 r070_GRAVA_COLUNA_D_DB_SELECT_1_Query1)
        {
            var ths = r070_GRAVA_COLUNA_D_DB_SELECT_1_Query1;
        ...
        public override R070_GRAVA_COLUNA_D_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R070_GRAVA_COLUNA_D_DB_SELECT_1_Query1();
            var i = 0;
