...
{
    public class R110_GRAVA_COLUNA_H_DB_SELECT_1_Query1 : QueryBasis<R110_GRAVA_COLUNA_H_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND M.COD_CAUSA NOT IN (31,14,44)
        ...
        public static R110_GRAVA_COLUNA_H_DB_SELECT_1_Query1 Execute(R110_GRAVA_COLUNA_H_DB_SELECT_1_Query1 r110_GRAVA_COLUNA_H_DB_SELECT_1_Query1)
        {
            var ths = r110_GRAVA_COLUNA_H_DB_SELECT_1_Query1;
        ...
        public override R110_GRAVA_COLUNA_H_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R110_GRAVA_COLUNA_H_DB_SELECT_1_Query1();
            var i = 0;
