...
{
    public class R0020_CRITICA_LINKAGE_DB_SELECT_1_Query1 : QueryBasis<R0020_CRITICA_LINKAGE_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0020_CRITICA_LINKAGE_DB_SELECT_1_Query1 Execute(R0020_CRITICA_LINKAGE_DB_SELECT_1_Query1 r0020_CRITICA_LINKAGE_DB_SELECT_1_Query1)
        {
            var ths = r0020_CRITICA_LINKAGE_DB_SELECT_1_Query1;
        ...
        public override R0020_CRITICA_LINKAGE_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0020_CRITICA_LINKAGE_DB_SELECT_1_Query1();
            var i = 0;
