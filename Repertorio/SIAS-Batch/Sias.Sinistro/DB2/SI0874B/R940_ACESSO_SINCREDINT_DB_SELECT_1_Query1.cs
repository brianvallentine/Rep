...
{
    public class R940_ACESSO_SINCREDINT_DB_SELECT_1_Query1 : QueryBasis<R940_ACESSO_SINCREDINT_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string SINCREIN_SIT_REGISTRO { get; set; }
        public string SINISHIS_NUM_APOL_SINISTRO { get; set; }

        public static R940_ACESSO_SINCREDINT_DB_SELECT_1_Query1 Execute(R940_ACESSO_SINCREDINT_DB_SELECT_1_Query1 r940_ACESSO_SINCREDINT_DB_SELECT_1_Query1)
        {
            var ths = r940_ACESSO_SINCREDINT_DB_SELECT_1_Query1;
        ...
        public override R940_ACESSO_SINCREDINT_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R940_ACESSO_SINCREDINT_DB_SELECT_1_Query1();
            var i = 0;
            ...
            dta.SINCREIN_SIT_REGISTRO = result[i++].Value?.ToString();
            return dta;
        }
