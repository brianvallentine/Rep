...
{
    public class P7011_SI1_INSERT_DB_INSERT_1_Insert1 : QueryBasis<P7011_SI1_INSERT_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL INSERT
            INTO SEGUROS.SINISTRO_HISTORICO (
            COD_EMPRESA
            ,TIPO_REGISTRO
            ,NUM_APOL_SINISTRO
            ,OCORR_HISTORICO
        ...
        public static void Execute(P7011_SI1_INSERT_DB_INSERT_1_Insert1 p7011_SI1_INSERT_DB_INSERT_1_Insert1)
        {
            var ths = p7011_SI1_INSERT_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override P7011_SI1_INSERT_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
