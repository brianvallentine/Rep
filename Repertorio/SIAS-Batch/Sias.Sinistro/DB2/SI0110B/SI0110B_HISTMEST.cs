...
{
    public class SI0110B_HISTMEST : QueryBasis<SI0110B_HISTMEST>
    {
        ...
        public SI0110B_HISTMEST() { IsCursor = true; }

        public SI0110B_HISTMEST(bool justACursor)
        {
        ...
        public string V1HISTMEST_PRODUTO { get; set; }
        ...
        public override SI0110B_HISTMEST OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0110B_HISTMEST();
            var i = 0;
            ...
            dta.V1HISTMEST_PRODUTO = result[i++].Value?.ToString();
