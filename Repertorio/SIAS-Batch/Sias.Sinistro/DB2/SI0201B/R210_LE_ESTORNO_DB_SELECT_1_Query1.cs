...
{
    public class R210_LE_ESTORNO_DB_SELECT_1_Query1 : QueryBasis<R210_LE_ESTORNO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R210_LE_ESTORNO_DB_SELECT_1_Query1 Execute(R210_LE_ESTORNO_DB_SELECT_1_Query1 r210_LE_ESTORNO_DB_SELECT_1_Query1)
        {
            var ths = r210_LE_ESTORNO_DB_SELECT_1_Query1;
        ...
        public override R210_LE_ESTORNO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R210_LE_ESTORNO_DB_SELECT_1_Query1();
            var i = 0;
