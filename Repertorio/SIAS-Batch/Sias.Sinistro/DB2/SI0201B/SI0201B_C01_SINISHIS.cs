...
{
    public class SI0201B_C01_SINISHIS : QueryBasis<SI0201B_C01_SINISHIS>
    {
        ...
        public SI0201B_C01_SINISHIS() { IsCursor = true; }

        public SI0201B_C01_SINISHIS(bool justACursor)
        {
        ...
        public override SI0201B_C01_SINISHIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0201B_C01_SINISHIS();
            var i = 0;
