...
{
    public class SI0038B_LISTA : QueryBasis<SI0038B_LISTA>
    {
        ...
        public SI0038B_LISTA() { IsCursor = true; }

        public SI0038B_LISTA(bool justACursor)
        {
        ...
        public override SI0038B_LISTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0038B_LISTA();
            var i = 0;
