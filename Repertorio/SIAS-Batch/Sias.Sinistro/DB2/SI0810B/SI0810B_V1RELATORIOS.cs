...
{
    public class SI0810B_V1RELATORIOS : QueryBasis<SI0810B_V1RELATORIOS>
    {
        ...
        public SI0810B_V1RELATORIOS() { IsCursor = true; }

        public SI0810B_V1RELATORIOS(bool justACursor)
        {
        ...
        public string V1RELA_NUM_APOLICE { get; set; }
        ...
        public override SI0810B_V1RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0810B_V1RELATORIOS();
            var i = 0;

            dta.V1RELA_RAMO = result[i++].Value?.ToString();
            dta.V1RELA_NUM_APOLICE = result[i++].Value?.ToString();
