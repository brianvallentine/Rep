...
{
    public class SI9110B_C01_SIARDEVC : QueryBasis<SI9110B_C01_SIARDEVC>
    {
        ...
        public SI9110B_C01_SIARDEVC() { IsCursor = true; }

        public SI9110B_C01_SIARDEVC(bool justACursor)
        {
        ...
        public string SIARDEVC_NOM_NAT_DOC { get; set; }
        public string SIARDEVC_COD_IDENTIDADE { get; set; }
        public string SIARDEVC_NOM_ORGAO_EXP { get; set; }
        public string SIARDEVC_DTH_EXP_DOC_IDENT { get; set; }
        public string SIARDEVC_COD_UF_EXPEDIDORA { get; set; }
        public string SIARDEVC_COD_ATIV_PRINCIPAL { get; set; }
        public string SIARDEVC_DTH_ULT_DOCTO { get; set; }
        public string SIARDEVC_DES_MARCA_MODELO { get; set; }
        public string SIARDEVC_NUM_PLACA { get; set; }
        public string SIARDEVC_NUM_CHASSIS { get; set; }
        public string SIARDEVC_DTH_ANO_VEICULO { get; set; }
        ...
        public override SI9110B_C01_SIARDEVC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI9110B_C01_SIARDEVC();
            var i = 0;
            ...
            dta.SIARDEVC_NOM_NAT_DOC = result[i++].Value?.ToString();
            dta.SIARDEVC_COD_IDENTIDADE = result[i++].Value?.ToString();
            dta.SIARDEVC_NOM_ORGAO_EXP = result[i++].Value?.ToString();
            dta.SIARDEVC_DTH_EXP_DOC_IDENT = result[i++].Value?.ToString();
            dta.SIARDEVC_COD_UF_EXPEDIDORA = result[i++].Value?.ToString();
            dta.SIARDEVC_COD_ATIV_PRINCIPAL = result[i++].Value?.ToString();
            dta.SIARDEVC_DTH_ULT_DOCTO = result[i++].Value?.ToString();
            dta.SIARDEVC_DES_MARCA_MODELO = result[i++].Value?.ToString();
            dta.SIARDEVC_NUM_PLACA = result[i++].Value?.ToString();
            dta.SIARDEVC_NUM_CHASSIS = result[i++].Value?.ToString();
            dta.SIARDEVC_DTH_ANO_VEICULO = result[i++].Value?.ToString();
