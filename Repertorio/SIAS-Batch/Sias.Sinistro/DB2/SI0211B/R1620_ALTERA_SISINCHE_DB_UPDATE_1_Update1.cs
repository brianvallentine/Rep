...
{
    public class R1620_ALTERA_SISINCHE_DB_UPDATE_1_Update1 : QueryBasis<R1620_ALTERA_SISINCHE_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R1620_ALTERA_SISINCHE_DB_UPDATE_1_Update1 r1620_ALTERA_SISINCHE_DB_UPDATE_1_Update1)
        {
            var ths = r1620_ALTERA_SISINCHE_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1620_ALTERA_SISINCHE_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
