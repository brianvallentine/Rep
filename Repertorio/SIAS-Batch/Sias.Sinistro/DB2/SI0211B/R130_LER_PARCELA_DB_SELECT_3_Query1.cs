...
{
    public class R130_LER_PARCELA_DB_SELECT_3_Query1 : QueryBasis<R130_LER_PARCELA_DB_SELECT_3_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R130_LER_PARCELA_DB_SELECT_3_Query1 Execute(R130_LER_PARCELA_DB_SELECT_3_Query1 r130_LER_PARCELA_DB_SELECT_3_Query1)
        {
            var ths = r130_LER_PARCELA_DB_SELECT_3_Query1;
        ...
        public override R130_LER_PARCELA_DB_SELECT_3_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R130_LER_PARCELA_DB_SELECT_3_Query1();
            var i = 0;
