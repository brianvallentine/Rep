...
{
    public class SI0211B_COBRANCA : QueryBasis<SI0211B_COBRANCA>
    {
        ...
        public SI0211B_COBRANCA() { IsCursor = true; }

        public SI0211B_COBRANCA(bool justACursor)
        {
        ...
        public string MOVIMCOB_TIMESTAMP { get; set; }
        ...
        public override SI0211B_COBRANCA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new SI0211B_COBRANCA();
            var i = 0;
            ...
            dta.MOVIMCOB_TIMESTAMP = result[i++].Value?.ToString();
