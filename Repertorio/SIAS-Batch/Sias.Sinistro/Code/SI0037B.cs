...
using Dclgens;
using Copies;
using Sias.Sinistro.DB2.SI0037B;

namespace Code
{
    public class SI0037B
    {
        ...
        /*"      *   FUNCAO ................. RELACAO DE PENDENCIA DE INVESTIGACAO*      */
        /*"      *----------------------------------------------------------------*      */
        ...
        public FileBasis _SI0037B1 { get; set; } = new FileBasis(new PIC("X", "200", "X(200)"));

        public FileBasis SI0037B1
        {
            get
            {
                _.Move(REG_SI0037B1, _SI0037B1); VarBasis.RedefinePassValue(REG_SI0037B1, _SI0037B1, REG_SI0037B1); return _SI0037B1;
            }
        }
        /*"01          REG-SI0037B1         PIC  X(200).*/
        public StringBasis REG_SI0037B1 { get; set; } = new StringBasis(new PIC("X", "200", "X(200)."), @"");
        ...
        /*"01          AREA-DE-WORK.*/
        public SI0037B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new SI0037B_AREA_DE_WORK();
        public class SI0037B_AREA_DE_WORK : VarBasis
        {
            /*"  05        AC-L-LISTA           PIC  9(006)   VALUE   ZEROS.*/
            public IntBasis AC_L_LISTA { get; set; } = new IntBasis(new PIC("9", "6", "9(006)"));
            /*"  05        AC-I-SI0037B1        PIC  9(006)   VALUE   ZEROS.*/
            public IntBasis AC_I_SI0037B1 { get; set; } = new IntBasis(new PIC("9", "6", "9(006)"));
            ...
            /*"  05        DB2-DATA.*/
            public SI0037B_DB2_DATA DB2_DATA { get; set; } = new SI0037B_DB2_DATA();
            public class SI0037B_DB2_DATA : VarBasis
            {
            ...
            public SI0037B_EDIT_DATA EDIT_DATA { get; set; } = new SI0037B_EDIT_DATA();
            public class SI0037B_EDIT_DATA : VarBasis
            {
            ...
            public SI0037B_ACC_HORA ACC_HORA { get; set; } = new SI0037B_ACC_HORA();
            public class SI0037B_ACC_HORA : VarBasis
            {
                /*"    10      ACC-HH               PIC  99.*/
            ...
            public SI0037B_EDIT_HORA EDIT_HORA { get; set; } = new SI0037B_EDIT_HORA();
            public class SI0037B_EDIT_HORA : VarBasis
            {
            ...
            public SI0037B_WABEND WABEND { get; set; } = new SI0037B_WABEND();
            public class SI0037B_WABEND : VarBasis
            {
                /*"    10      FILLER               PIC  X(010) VALUE           ' SI0037B'.*/
                public StringBasis FILLER_6 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" SI0037B");
        ...
        public SI0037B_LC00 LC00 { get; set; } = new SI0037B_LC00();
        public class SI0037B_LC00 : VarBasis
        {
        ...
        public SI0037B_LC01 LC01 { get; set; } = new SI0037B_LC01();
        public class SI0037B_LC01 : VarBasis
        {
            /*"  05        LC01-CANAL           PIC  X(001) VALUE '1'.*/
            public StringBasis LC01_CANAL { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"1");
            /*"  05        FILLER               PIC  X(075) VALUE 'SI0037B'.*/
            public StringBasis FILLER_10 { get; set; } = new StringBasis(new PIC("X", "75", "X(075)"), @"SI0037B");
        ...
        public SI0037B_LC02 LC02 { get; set; } = new SI0037B_LC02();
        public class SI0037B_LC02 : VarBasis
        {
            ...
            /*"  05        FILLER               PIC  X(029) VALUE                               'PENDENTE DE INVESTIGACAO ATE '.*/
            public StringBasis FILLER_15 { get; set; } = new StringBasis(new PIC("X", "29", "X(029)"), @"PENDENTE DE INVESTIGACAO ATE ");
            ...
            public StringBasis FILLER_16 { get; set; } = new StringBasis(new PIC("X", "59", "X(059)"), @"");
        ...
        public SI0037B_LC03 LC03 { get; set; } = new SI0037B_LC03();
        public class SI0037B_LC03 : VarBasis
        {
        ...
        public SI0037B_LC04 LC04 { get; set; } = new SI0037B_LC04();
        public class SI0037B_LC04 : VarBasis
        {
        ...
        public SI0037B_LC05 LC05 { get; set; } = new SI0037B_LC05();
        public class SI0037B_LC05 : VarBasis
        {
        ...
        public SI0037B_LC06 LC06 { get; set; } = new SI0037B_LC06();
        public class SI0037B_LC06 : VarBasis
        {
        ...
        public SI0037B_LC07 LC07 { get; set; } = new SI0037B_LC07();
        public class SI0037B_LC07 : VarBasis
        {
        ...
        public SI0037B_LD01 LD01 { get; set; } = new SI0037B_LD01();
        public class SI0037B_LD01 : VarBasis
        {
        ...
        public SI0037B_LD02 LD02 { get; set; } = new SI0037B_LD02();
        public class SI0037B_LD02 : VarBasis
        {
        ...
        public SI0037B_LISTA LISTA { get; set; } = new SI0037B_LISTA();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string SI0037B1_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                SI0037B1.SetFile(SI0037B1_FILE_NAME_P);

                /*" -227- MOVE '001' TO WNR-EXEC-SQL. */
                _.Move("001", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

                /*" -227- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

                /*" -228- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

                /*" -229- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

                /*" -229- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        {
            /*" -237- OPEN OUTPUT SI0037B1 */
            SI0037B1.Open(REG_SI0037B1);

            /*" -239- PERFORM R0500-00-LE-SISTEMAS */

            R0500_00_LE_SISTEMAS_SECTION();

            /*" -241- PERFORM R0600-00-LE-RELATORIOS */

            R0600_00_LE_RELATORIOS_SECTION();

            /*" -242- IF WFIM-RELATORI EQUAL 'S' */
            ...
            if (AREA_DE_WORK.WFIM_RELATORI == "S")
            {
                ...
                /*" -244- DISPLAY '* NAO HOUVE SOLICITACAO PARA O RELATORIO *' */
            ...
            /*" -249- PERFORM R0900-00-DECLARA-LISTA */

            R0900_00_DECLARA_LISTA_SECTION();

            /*" -251- PERFORM R0910-00-LE-LISTA */

            R0910_00_LE_LISTA_SECTION();

            /*" -252- IF WFIM-LISTA EQUAL 'S' */

            if (AREA_DE_WORK.WFIM_LISTA == "S")
            {

                /*" -259- GO TO R0000-90-ENCERRA. */
            ...
            /*" -262- PERFORM R1000-00-PROCESSA UNTIL WFIM-LISTA EQUAL 'S' . */
            ...
            /*" -267- PERFORM R0800-00-TOTAL-GERAL */

            R0800_00_TOTAL_GERAL_SECTION();

            /*" -267- PERFORM R0700-00-ALTERA-RELATORIOS. */
        ...
        private void R0000_90_ENCERRA(bool isPerform = false)
        {
            ...
            /*" -275- MOVE ZEROS TO RETURN-CODE */
            _.Move(0, RETURN_CODE);

            /*" -276- DISPLAY '******************************' */
            _.Display($"******************************");

            /*" -277- DISPLAY '***   SI0037B - FIM NORMAL ***' */
            _.Display($"***   SI0037B - FIM NORMAL ***");

            /*" -278- DISPLAY '******************************' */
            _.Display($"******************************");

            /*" -279- DISPLAY 'LIDOS      SIDOCACO  -  ' AC-L-LISTA */
            _.Display($"LIDOS      SIDOCACO  -  {AREA_DE_WORK.AC_L_LISTA}");

            /*" -281- DISPLAY 'IMPRESSOS  SI0037B1  -  ' AC-I-SI0037B1 */
            _.Display($"IMPRESSOS  SI0037B1  -  {AREA_DE_WORK.AC_I_SI0037B1}");
        ...
        {
            /*" -289- MOVE '050' TO WNR-EXEC-SQL. */
            _.Move("050", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -294- PERFORM R0500_00_LE_SISTEMAS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -298- DISPLAY 'SI0037B - PROBLEMAS NO SELECT SISTEMAS' */
                _.Display($"SI0037B - PROBLEMAS NO SELECT SISTEMAS");
        ...
        {
            /*" -294- EXEC SQL SELECT DATA_MOV_ABERTO INTO :SISTEMAS-DATA-MOV-ABERTO FROM SEGUROS.SISTEMAS WHERE IDE_SISTEMA = 'SI' END-EXEC. */
        ...
        {
            /*" -308- MOVE '060' TO WNR-EXEC-SQL. */
            _.Move("060", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -316- PERFORM R0600_00_LE_RELATORIOS_DB_SELECT_1 */

            R0600_00_LE_RELATORIOS_DB_SELECT_1();

            /*" -319- IF SQLCODE EQUAL 100 */

            if (DB.SQLCODE == 100)
            {

                /*" -320- MOVE 'S' TO WFIM-RELATORI */
            ...
            else
            {
                ...
                /*" -322- IF SQLCODE NOT EQUAL ZEROS */

                if (DB.SQLCODE != 00)
                {

                    /*" -323- DISPLAY 'SI0037B - PROBLEMAS NO SELECT RELATORIOS' */
                    _.Display($"SI0037B - PROBLEMAS NO SELECT RELATORIOS");

                    /*" -323- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -316- EXEC SQL SELECT COD_USUARIO INTO :RELATORI-COD-USUARIO FROM SEGUROS.RELATORIOS WHERE COD_RELATORIO = 'SI0037B' AND IDE_SISTEMA = 'SI' AND DATA_SOLICITACAO = :SISTEMAS-DATA-MOV-ABERTO AND SIT_REGISTRO = '0' END-EXEC. */
        ...
        {
            /*" -333- MOVE '070' TO WNR-EXEC-SQL. */
            _.Move("070", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -340- PERFORM R0700_00_ALTERA_RELATORIOS_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -344- DISPLAY 'SI0037B - PROBLEMAS NO UPDATE RELATORIOS' */
                _.Display($"SI0037B - PROBLEMAS NO UPDATE RELATORIOS");

                /*" -344- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -340- EXEC SQL UPDATE SEGUROS.RELATORIOS SET SIT_REGISTRO = '1' WHERE COD_RELATORIO = 'SI0037B' AND IDE_SISTEMA = 'SI' AND DATA_SOLICITACAO = :SISTEMAS-DATA-MOV-ABERTO AND SIT_REGISTRO = '0' END-EXEC. */
        ...
        {
            /*" -354- MOVE '080' TO WNR-EXEC-SQL. */
            _.Move("080", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -355- IF AC-LINHAS GREATER 55 */

            if (AREA_DE_WORK.AC_LINHAS > 55)
            {

                /*" -357- PERFORM R4000-00-CABECALHO. */

                R4000_00_CABECALHO_SECTION();
            }


            /*" -358- MOVE 'TOTAL GERAL.........' TO LD02-LITERAL */
            _.Move("TOTAL GERAL.........", LD02.LD02_LITERAL);

            /*" -360- MOVE AC-G-SINISTROS TO LD02-TOTAL */
            _.Move(AREA_DE_WORK.AC_G_SINISTROS, LD02.LD02_TOTAL);

            /*" -361- WRITE REG-SI0037B1 FROM LC00 */
            _.Move(LC00.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -362- WRITE REG-SI0037B1 FROM LD02 */
            _.Move(LD02.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -362- ADD 2 TO AC-LINHAS. */
        ...
        {
            /*" -372- MOVE '090' TO WNR-EXEC-SQL. */
            _.Move("090", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -446- PERFORM R0900_00_DECLARA_LISTA_DB_DECLARE_1 */

            R0900_00_DECLARA_LISTA_DB_DECLARE_1();

            /*" -448- PERFORM R0900_00_DECLARA_LISTA_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -453- DISPLAY 'SI0037B - PROBLEMAS NO OPEN LISTA ' ' ' SISTEMAS-DATA-MOV-ABERTO */

                $"SI0037B - PROBLEMAS NO OPEN LISTA  {SISTEMAS.DCLSISTEMAS.SISTEMAS_DATA_MOV_ABERTO}"
                .Display();
        ...
        {
            /*" -448- EXEC SQL OPEN LISTA END-EXEC. */
        ...
        {
            /*" -463- MOVE '091' TO WNR-EXEC-SQL. */
            _.Move("091", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -475- PERFORM R0910_00_LE_LISTA_DB_FETCH_1 */
            ...
            else
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -482- MOVE 'S' TO WFIM-LISTA */
                    _.Move("S", AREA_DE_WORK.WFIM_LISTA);

                    /*" -482- PERFORM R0910_00_LE_LISTA_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -486- DISPLAY 'SI0037B - PROBLEMAS NO FETCH LISTA ' ' ' SISTEMAS-DATA-MOV-ABERTO */

                    $"SI0037B - PROBLEMAS NO FETCH LISTA  {SISTEMAS.DCLSISTEMAS.SISTEMAS_DATA_MOV_ABERTO}"
                    .Display();
        ...
        {
            /*" -482- EXEC SQL CLOSE LISTA END-EXEC */
        ...
        private void R1000_00_PROCESSA_SECTION()
        {
            ...
            /*" -498- MOVE 80 TO AC-LINHAS */
            _.Move(80, AREA_DE_WORK.AC_LINHAS);

            /*" -500- PERFORM R1100-00-LE-USUARIOS */

            R1100_00_LE_USUARIOS_SECTION();

            /*" -502- MOVE SIANAROD-COD-USUARIO TO WS-COD-USUARIO-ANT */
            _.Move(SIANAROD.DCLSI_ANALISTA_RODIZI.SIANAROD_COD_USUARIO, WS_COD_USUARIO_ANT);

            /*" -507- PERFORM R2000-00-PROCESSA-ANALISTA UNTIL WFIM-LISTA EQUAL 'S' OR SIANAROD-COD-USUARIO NOT EQUAL WS-COD-USUARIO-ANT */
            ...
            /*" -507- PERFORM R1900-00-TOTAL-ANALISTA. */
        ...
        {
            /*" -517- MOVE '110' TO WNR-EXEC-SQL. */
            _.Move("110", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -522- PERFORM R1100_00_LE_USUARIOS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -526- DISPLAY 'SI0037B - PROBLEMAS NO SELECT USUARIOS' */
                _.Display($"SI0037B - PROBLEMAS NO SELECT USUARIOS");

                /*" -530- DISPLAY ' ' SIDOCACO-COD-FONTE ' ' SIDOCACO-NUM-PROTOCOLO-SINI ' ' SIDOCACO-DAC-PROTOCOLO-SINI ' ' SIANAROD-COD-USUARIO */
        ...
        {
            /*" -522- EXEC SQL SELECT NOME_USUARIO INTO :USUARIOS-NOME-USUARIO FROM SEGUROS.USUARIOS WHERE COD_USUARIO = :SIANAROD-COD-USUARIO END-EXEC. */
        ...
        {
            /*" -540- MOVE '190' TO WNR-EXEC-SQL. */
            _.Move("190", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -541- IF AC-LINHAS GREATER 55 */

            if (AREA_DE_WORK.AC_LINHAS > 55)
            {

                /*" -543- PERFORM R4000-00-CABECALHO. */

                R4000_00_CABECALHO_SECTION();
            }


            /*" -544- MOVE 'TOTAL DO ANALISTA...' TO LD02-LITERAL */
            _.Move("TOTAL DO ANALISTA...", LD02.LD02_LITERAL);

            /*" -546- MOVE AC-A-SINISTROS TO LD02-TOTAL */
            _.Move(AREA_DE_WORK.AC_A_SINISTROS, LD02.LD02_TOTAL);

            /*" -547- WRITE REG-SI0037B1 FROM LC00 */
            _.Move(LC00.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -548- WRITE REG-SI0037B1 FROM LD02 */
            _.Move(LD02.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -550- ADD 2 TO AC-LINHAS */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 2;

            /*" -551- ADD AC-A-SINISTROS TO AC-G-SINISTROS */
            AREA_DE_WORK.AC_G_SINISTROS.Value = AREA_DE_WORK.AC_G_SINISTROS + AREA_DE_WORK.AC_A_SINISTROS;

            /*" -551- MOVE ZEROS TO AC-A-SINISTROS. */
        ...
        {
            /*" -561- MOVE '200' TO WNR-EXEC-SQL. */
            _.Move("200", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -563- PERFORM R2100-00-LE-GEDESTIN */

            R2100_00_LE_GEDESTIN_SECTION();

            /*" -566- MOVE GERECADE-COD-DESTINATARIO TO WS-COD-DESTINATARIO-ANT */
            _.Move(GERECADE.DCLGE_REL_CARTA_DEST.GERECADE_COD_DESTINATARIO, WS_COD_DESTINATARIO_ANT);

            /*" -567- IF AC-LINHAS GREATER 55 */

            if (AREA_DE_WORK.AC_LINHAS > 55)
            {

                /*" -568- PERFORM R4000-00-CABECALHO */

                R4000_00_CABECALHO_SECTION();

                /*" -569- PERFORM R4100-00-CABECALHO-PRESTADOR */
            ...
            else
            {
                ...
                /*" -572- PERFORM R4100-00-CABECALHO-PRESTADOR. */

                R4100_00_CABECALHO_PRESTADOR_SECTION();
            }


            /*" -580- PERFORM R3000-00-PROCESSA-PRESTADOR UNTIL WFIM-LISTA EQUAL 'S' OR SIANAROD-COD-USUARIO NOT EQUAL WS-COD-USUARIO-ANT OR GERECADE-COD-DESTINATARIO NOT EQUAL WS-COD-DESTINATARIO-ANT */
            ...
            /*" -580- PERFORM R2900-00-TOTAL-PRESTADOR. */
        ...
        {
            /*" -590- MOVE '210' TO WNR-EXEC-SQL. */
            _.Move("210", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -596- PERFORM R2100_00_LE_GEDESTIN_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -600- DISPLAY 'SI0037B - PROBLEMAS NO SELECT GE_DESTINATARIO' */
                _.Display($"SI0037B - PROBLEMAS NO SELECT GE_DESTINATARIO");

                /*" -604- DISPLAY ' ' SIDOCACO-COD-FONTE ' ' SIDOCACO-NUM-PROTOCOLO-SINI ' ' SIDOCACO-DAC-PROTOCOLO-SINI ' ' GERECADE-COD-DESTINATARIO */
        ...
        {
            /*" -596- EXEC SQL SELECT NOME_DESTINATARIO INTO :GEDESTIN-NOME-DESTINATARIO FROM SEGUROS.GE_DESTINATARIO WHERE COD_DESTINATARIO = :GERECADE-COD-DESTINATARIO END-EXEC. */
        ...
        {
            /*" -614- MOVE '290' TO WNR-EXEC-SQL. */
            _.Move("290", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -615- IF AC-LINHAS GREATER 55 */

            if (AREA_DE_WORK.AC_LINHAS > 55)
            {

                /*" -617- PERFORM R4000-00-CABECALHO. */

                R4000_00_CABECALHO_SECTION();
            }


            /*" -618- MOVE 'TOTAL DO PRESTADOR..' TO LD02-LITERAL */
            _.Move("TOTAL DO PRESTADOR..", LD02.LD02_LITERAL);

            /*" -620- MOVE AC-P-SINISTROS TO LD02-TOTAL */
            _.Move(AREA_DE_WORK.AC_P_SINISTROS, LD02.LD02_TOTAL);

            /*" -621- WRITE REG-SI0037B1 FROM LC00 */
            _.Move(LC00.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -622- WRITE REG-SI0037B1 FROM LD02 */
            _.Move(LD02.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -624- ADD 2 TO AC-LINHAS */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 2;

            /*" -625- ADD AC-P-SINISTROS TO AC-A-SINISTROS */
            AREA_DE_WORK.AC_A_SINISTROS.Value = AREA_DE_WORK.AC_A_SINISTROS + AREA_DE_WORK.AC_P_SINISTROS;

            /*" -625- MOVE ZEROS TO AC-P-SINISTROS. */
        ...
        private void R3000_00_PROCESSA_PRESTADOR_SECTION()
        {
            ...
            else
            {
                ...
                /*" -653- MOVE 'DFI' TO LD01-TIPO-SINISTRO. */
                _.Move("DFI", LD01.LD01_TIPO_SINISTRO);
            }


            /*" -655- IF SISINACO-DATA-MOVTO-SINIACO EQUAL SPACES */

            if (SISINACO.DCLSI_SINISTRO_ACOMP.SISINACO_DATA_MOVTO_SINIACO.IsEmpty())
            {

                /*" -656- MOVE SPACES TO LD01-DATA-AVISO */
            ...
            else
            {
                ...
                /*" -659- MOVE SISINACO-DATA-MOVTO-SINIACO TO DB2-DATA */
                _.Move(SISINACO.DCLSI_SINISTRO_ACOMP.SISINACO_DATA_MOVTO_SINIACO, AREA_DE_WORK.DB2_DATA);

                /*" -660- MOVE DB2-DIA TO EDIT-DIA */
                _.Move(AREA_DE_WORK.DB2_DATA.DB2_DIA, AREA_DE_WORK.EDIT_DATA.EDIT_DIA);

                /*" -661- MOVE DB2-MES TO EDIT-MES */
                _.Move(AREA_DE_WORK.DB2_DATA.DB2_MES, AREA_DE_WORK.EDIT_DATA.EDIT_MES);

                /*" -662- MOVE DB2-ANO TO EDIT-ANO */
                _.Move(AREA_DE_WORK.DB2_DATA.DB2_ANO, AREA_DE_WORK.EDIT_DATA.EDIT_ANO);

                /*" -664- MOVE EDIT-DATA TO LD01-DATA-AVISO. */
                _.Move(AREA_DE_WORK.EDIT_DATA, LD01.LD01_DATA_AVISO);
            }


            /*" -667- MOVE SIEVETIP-DESCR-EVENTO TO LD01-DESCR-EVENTO */
            _.Move(SIEVETIP.DCLSI_EVENTO_TIPO.SIEVETIP_DESCR_EVENTO, LD01.LD01_DESCR_EVENTO);

            /*" -669- MOVE SIDOCACO-DATA-MOVTO-DOCACO TO DB2-DATA */
            _.Move(SIDOCACO.DCLSI_DOCUMENTO_ACOMP.SIDOCACO_DATA_MOVTO_DOCACO, AREA_DE_WORK.DB2_DATA);

            /*" -670- MOVE DB2-DIA TO EDIT-DIA */
            _.Move(AREA_DE_WORK.DB2_DATA.DB2_DIA, AREA_DE_WORK.EDIT_DATA.EDIT_DIA);

            /*" -671- MOVE DB2-MES TO EDIT-MES */
            _.Move(AREA_DE_WORK.DB2_DATA.DB2_MES, AREA_DE_WORK.EDIT_DATA.EDIT_MES);

            /*" -672- MOVE DB2-ANO TO EDIT-ANO */
            _.Move(AREA_DE_WORK.DB2_DATA.DB2_ANO, AREA_DE_WORK.EDIT_DATA.EDIT_ANO);

            /*" -674- MOVE EDIT-DATA TO LD01-DATA-EVENTO */
            _.Move(AREA_DE_WORK.EDIT_DATA, LD01.LD01_DATA_EVENTO);

            /*" -675- IF AC-LINHAS GREATER 55 */

            if (AREA_DE_WORK.AC_LINHAS > 55)
            {

                /*" -676- PERFORM R4000-00-CABECALHO */

                R4000_00_CABECALHO_SECTION();

                /*" -678- PERFORM R4100-00-CABECALHO-PRESTADOR. */

                R4100_00_CABECALHO_PRESTADOR_SECTION();
            }


            /*" -679- WRITE REG-SI0037B1 FROM LD01 */
            _.Move(LD01.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -685- ADD 1 TO AC-LINHAS AC-I-SI0037B1 AC-P-SINISTROS */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 1;
            AREA_DE_WORK.AC_I_SI0037B1.Value = AREA_DE_WORK.AC_I_SI0037B1 + 1;
            AREA_DE_WORK.AC_P_SINISTROS.Value = AREA_DE_WORK.AC_P_SINISTROS + 1;

            /*" -685- PERFORM R0910-00-LE-LISTA. */
        ...
        {
            /*" -695- MOVE '310' TO WNR-EXEC-SQL. */
            _.Move("310", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -705- PERFORM R3100_00_LE_SISINACO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -710- MOVE SPACES TO SISINACO-DATA-MOVTO-SINIACO */
            ...
            else
            {
                ...
                if (DB.SQLCODE != 00)
                {
                    ...
                    /*" -713- DISPLAY 'SI0037B - PROBLEMAS NO SELECT SI_SINISTRO_ACOMP' */
                    _.Display($"SI0037B - PROBLEMAS NO SELECT SI_SINISTRO_ACOMP");

                    /*" -716- DISPLAY ' ' SIDOCACO-COD-FONTE ' ' SIDOCACO-NUM-PROTOCOLO-SINI ' ' SIDOCACO-DAC-PROTOCOLO-SINI */
        ...
        {
            /*" -705- EXEC SQL SELECT DATA_MOVTO_SINIACO INTO :SISINACO-DATA-MOVTO-SINIACO FROM SEGUROS.SI_SINISTRO_ACOMP WHERE COD_FONTE = :SIDOCACO-COD-FONTE AND NUM_PROTOCOLO_SINI = :SIDOCACO-NUM-PROTOCOLO-SINI AND DAC_PROTOCOLO_SINI = :SIDOCACO-DAC-PROTOCOLO-SINI AND COD_EVENTO = 1001 END-EXEC. */
        ...
        {
            /*" -726- MOVE '320' TO WNR-EXEC-SQL. */
            _.Move("320", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -735- PERFORM R3200_00_LE_SINISMES_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -739- MOVE ZEROS TO SINISMES-NUM-IRB */
            ...
            else
            {
                ...
                if (DB.SQLCODE != 00)
                {
                    ...
                    /*" -742- DISPLAY 'SI0037B - PROBLEMAS NO SELECT SINISTRO_MESTRE' */
                    _.Display($"SI0037B - PROBLEMAS NO SELECT SINISTRO_MESTRE");

                    /*" -745- DISPLAY ' ' SIDOCACO-COD-FONTE ' ' SIDOCACO-NUM-PROTOCOLO-SINI ' ' SIDOCACO-DAC-PROTOCOLO-SINI */
        ...
        {
            /*" -735- EXEC SQL SELECT NUM_IRB INTO :SINISMES-NUM-IRB FROM SEGUROS.SINISTRO_MESTRE WHERE COD_FONTE = :SIDOCACO-COD-FONTE AND NUM_PROTOCOLO_SINI = :SIDOCACO-NUM-PROTOCOLO-SINI AND DAC_PROTOCOLO_SINI = :SIDOCACO-DAC-PROTOCOLO-SINI END-EXEC. */
        ...
        {
            /*" -755- MOVE '400' TO WNR-EXEC-SQL. */
            _.Move("400", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -756- ADD 1 TO AC-PAGINAS */
            AREA_DE_WORK.AC_PAGINAS.Value = AREA_DE_WORK.AC_PAGINAS + 1;

            /*" -758- MOVE AC-PAGINAS TO LC01-PAGINA */
            _.Move(AREA_DE_WORK.AC_PAGINAS, LC01.LC01_PAGINA);

            /*" -760- MOVE SISTEMAS-DATA-MOV-ABERTO TO DB2-DATA */
            _.Move(SISTEMAS.DCLSISTEMAS.SISTEMAS_DATA_MOV_ABERTO, AREA_DE_WORK.DB2_DATA);

            /*" -761- MOVE DB2-DIA TO EDIT-DIA */
            _.Move(AREA_DE_WORK.DB2_DATA.DB2_DIA, AREA_DE_WORK.EDIT_DATA.EDIT_DIA);

            /*" -762- MOVE DB2-MES TO EDIT-MES */
            _.Move(AREA_DE_WORK.DB2_DATA.DB2_MES, AREA_DE_WORK.EDIT_DATA.EDIT_MES);

            /*" -763- MOVE DB2-ANO TO EDIT-ANO */
            _.Move(AREA_DE_WORK.DB2_DATA.DB2_ANO, AREA_DE_WORK.EDIT_DATA.EDIT_ANO);

            /*" -766- MOVE EDIT-DATA TO LC02-DATA LC02-DATA-MOV-ABERTO */
            _.Move(AREA_DE_WORK.EDIT_DATA, LC02.LC02_DATA, LC02.LC02_DATA_MOV_ABERTO);

            /*" -767- ACCEPT ACC-HORA FROM TIME */
            _.Move(_.AcceptDate("TIME"), AREA_DE_WORK.ACC_HORA);

            /*" -768- MOVE ACC-HH TO EDIT-HH */
            _.Move(AREA_DE_WORK.ACC_HORA.ACC_HH, AREA_DE_WORK.EDIT_HORA.EDIT_HH);

            /*" -769- MOVE ACC-MM TO EDIT-MM */
            _.Move(AREA_DE_WORK.ACC_HORA.ACC_MM, AREA_DE_WORK.EDIT_HORA.EDIT_MM);

            /*" -770- MOVE ACC-SS TO EDIT-SS */
            _.Move(AREA_DE_WORK.ACC_HORA.ACC_SS, AREA_DE_WORK.EDIT_HORA.EDIT_SS);

            /*" -772- MOVE EDIT-HORA TO LC03-HORA */
            _.Move(AREA_DE_WORK.EDIT_HORA, LC03.LC03_HORA);

            /*" -775- MOVE USUARIOS-NOME-USUARIO TO LC05-ANALISTA */
            _.Move(USUARIOS.DCLUSUARIOS.USUARIOS_NOME_USUARIO, LC05.LC05_ANALISTA);

            /*" -776- WRITE REG-SI0037B1 FROM LC01 */
            _.Move(LC01.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -777- WRITE REG-SI0037B1 FROM LC02 */
            _.Move(LC02.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -778- WRITE REG-SI0037B1 FROM LC03 */
            _.Move(LC03.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -779- WRITE REG-SI0037B1 FROM LC00 */
            _.Move(LC00.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -780- WRITE REG-SI0037B1 FROM LC04 */
            _.Move(LC04.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -781- WRITE REG-SI0037B1 FROM LC05 */
            _.Move(LC05.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -782- WRITE REG-SI0037B1 FROM LC04 */
            _.Move(LC04.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -783- WRITE REG-SI0037B1 FROM LC07 */
            _.Move(LC07.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -784- WRITE REG-SI0037B1 FROM LC04 */
            _.Move(LC04.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -786- WRITE REG-SI0037B1 FROM LC00 */
            _.Move(LC00.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -786- MOVE 10 TO AC-LINHAS. */
        ...
        {
            /*" -796- MOVE '410' TO WNR-EXEC-SQL. */
            _.Move("410", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -799- MOVE GEDESTIN-NOME-DESTINATARIO TO LC06-PRESTADOR */
            _.Move(GEDESTIN.DCLGE_DESTINATARIO.GEDESTIN_NOME_DESTINATARIO, LC06.LC06_PRESTADOR);

            /*" -800- WRITE REG-SI0037B1 FROM LC06 */
            _.Move(LC06.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -802- WRITE REG-SI0037B1 FROM LC00 */
            _.Move(LC00.GetMoveValues(), REG_SI0037B1);

            SI0037B1.Write(REG_SI0037B1.GetMoveValues().ToString());

            /*" -802- ADD 2 TO AC-LINHAS. */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + 2;
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -813- MOVE 99 TO RETURN-CODE */
            _.Move(99, RETURN_CODE);

            /*" -815- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, AREA_DE_WORK.WABEND.WSQLCODE);

            /*" -817- DISPLAY WABEND */
            _.Display(AREA_DE_WORK.WABEND);

            /*" -817- EXEC SQL ROLLBACK WORK END-EXEC. */
            ...
            /*" -821- DISPLAY '***   SI0037B - CANCELADO  ***' */
            _.Display($"***   SI0037B - CANCELADO  ***");
