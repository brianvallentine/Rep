...
using Dclgens;
using Copies;
using Sias.Sinistro.DB2.SI9111B;

namespace Code
{
    public class SI9111B
    {
        ...
        /*"      *----------------------------------------------------------------*      */
        /*"      *   7.     7.0    23/10/2012 11:49   RILDO        CADMUS 75081   *      */
        /*"      *          FORCAR ENVIO DE REGISTRO DO SINISTRO 1103100104085 P/ *      */
        /*"      *          MAFRE.                                                *      */
        /*"      *                                                 PROCURE: V.07  *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *                                                                *      */
        ...
        /*"01       REG-VCMOVSIN.*/
        public SI9111B_REG_VCMOVSIN REG_VCMOVSIN { get; set; } = new SI9111B_REG_VCMOVSIN();
        public class SI9111B_REG_VCMOVSIN : VarBasis
        {
            /*"  05     VCMOVSIN-HEADER.*/
            public SI9111B_VCMOVSIN_HEADER VCMOVSIN_HEADER { get; set; } = new SI9111B_VCMOVSIN_HEADER();
            public class SI9111B_VCMOVSIN_HEADER : VarBasis
            {
            ...
            private _REDEF_SI9111B_VCMOVSIN_DADOS _vcmovsin_dados { get; set; }
            public _REDEF_SI9111B_VCMOVSIN_DADOS VCMOVSIN_DADOS
            {
                get { _vcmovsin_dados = new _REDEF_SI9111B_VCMOVSIN_DADOS(); _.Move(VCMOVSIN_HEADER, _vcmovsin_dados); VarBasis.RedefinePassValue(VCMOVSIN_HEADER, _vcmovsin_dados, VCMOVSIN_HEADER); _vcmovsin_dados.ValueChanged += () => { _.Move(_vcmovsin_dados, VCMOVSIN_HEADER); }; return _vcmovsin_dados; }
                set { VarBasis.RedefinePassValue(value, _vcmovsin_dados, VCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9111B_VCMOVSIN_DADOS : VarBasis
            {
                ...
                /*"    10   DET-CIRCULAR-200.*/
                public SI9111B_DET_CIRCULAR_200 DET_CIRCULAR_200 { get; set; } = new SI9111B_DET_CIRCULAR_200();
                public class SI9111B_DET_CIRCULAR_200 : VarBasis
                {
                    ...
                    public SI9111B_DET_CIRCULAR_200()
                    {
                ...
                public SI9111B_DET_CIRCULAR_255 DET_CIRCULAR_255 { get; set; } = new SI9111B_DET_CIRCULAR_255();
                public class SI9111B_DET_CIRCULAR_255 : VarBasis
                {
                    ...
                    public SI9111B_DET_CIRCULAR_255()
                    {
                ...
                public _REDEF_SI9111B_VCMOVSIN_DADOS()
                {
            ...
            private _REDEF_SI9111B_VCMOVSIN_TRAILLER _vcmovsin_trailler { get; set; }
            public _REDEF_SI9111B_VCMOVSIN_TRAILLER VCMOVSIN_TRAILLER
            {
                get { _vcmovsin_trailler = new _REDEF_SI9111B_VCMOVSIN_TRAILLER(); _.Move(VCMOVSIN_HEADER, _vcmovsin_trailler); VarBasis.RedefinePassValue(VCMOVSIN_HEADER, _vcmovsin_trailler, VCMOVSIN_HEADER); _vcmovsin_trailler.ValueChanged += () => { _.Move(_vcmovsin_trailler, VCMOVSIN_HEADER); }; return _vcmovsin_trailler; }
                set { VarBasis.RedefinePassValue(value, _vcmovsin_trailler, VCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9111B_VCMOVSIN_TRAILLER : VarBasis
            {
                ...
                public _REDEF_SI9111B_VCMOVSIN_TRAILLER()
                {
        ...
        public SI9111B_WS_IDENT_PAGTO_EDITADO WS_IDENT_PAGTO_EDITADO { get; set; } = new SI9111B_WS_IDENT_PAGTO_EDITADO();
        public class SI9111B_WS_IDENT_PAGTO_EDITADO : VarBasis
        {
            ...
            /*"01  WS-VERSAO             PIC   X(060) VALUE     'SI9111B - VERSAO: V7.0 - 23102012 11:30HS '.*/
        }
        public StringBasis WS_VERSAO { get; set; } = new StringBasis(new PIC("X", "60", "X(060)"), @"SI9111B - VERSAO: V7.0 - 23102012 11:30HS ");
        /*"01          WABEND.*/
        public SI9111B_WABEND WABEND { get; set; } = new SI9111B_WABEND();
        public class SI9111B_WABEND : VarBasis
        {
            /*"  05     FILLER                      PIC  X(010) VALUE           ' SI9111B'.*/
            public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" SI9111B");
        ...
        public SI9111B_C01_SIARDEVC C01_SIARDEVC { get; set; } = new SI9111B_C01_SIARDEVC();
        ...
        /**/
        {
            try
            {
                ...
                /*" -167- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

                /*" -168- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

                /*" -169- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

                /*" -169- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -178- DISPLAY 'PROGRAMA EM EXECUCAO SI9111B   ' . */
            _.Display($"PROGRAMA EM EXECUCAO SI9111B   ");

            /*" -179- DISPLAY '                               ' . */
            _.Display($"                               ");

            /*" -180- DISPLAY 'VERSAO V.08 NSGD    20/10/2014 ' . */
            _.Display($"VERSAO V.08 NSGD    20/10/2014 ");

            /*" -182- DISPLAY '-------------------------------' . */
            _.Display($"-------------------------------");

            /*" -184- MOVE '0000' TO WNR-EXEC-SQL */
            _.Move("0000", WABEND.WNR_EXEC_SQL);

            /*" -186- PERFORM R0100-00-LE-SISTEMAS */

            R0100_00_LE_SISTEMAS_SECTION();

            /*" -188- OPEN OUTPUT CVPAGSIN */
            CVPAGSIN.Open(REG_VCMOVSIN);

            /*" -189- MOVE SPACES TO WFIM-SIARDEVC */
            _.Move("", WFIM_SIARDEVC);

            /*" -190- PERFORM R0900-00-DECLARA-SIARDEVC */

            R0900_00_DECLARA_SIARDEVC_SECTION();

            /*" -192- PERFORM R0910-00-LE-SIARDEVC */

            R0910_00_LE_SIARDEVC_SECTION();

            /*" -193- IF WFIM-SIARDEVC EQUAL 'S' */

            if (WFIM_SIARDEVC == "S")
            {

                /*" -195- GO TO R0000-10-FINALIZA. */
            ...
            /*" -197- PERFORM R0500-00-GERA-HEADER */

            R0500_00_GERA_HEADER_SECTION();

            /*" -200- PERFORM R1000-00-PROCESSA-SIARDEVC UNTIL WFIM-SIARDEVC EQUAL 'S' */
            ...
            /*" -202- PERFORM R0600-00-GERA-TRAILLER */

            R0600_00_GERA_TRAILLER_SECTION();

            /*" -203- ADD AC-G-CVPAGSIN TO GEARDETA-QTD-REG-PROCESSADO */
            ...
            /*" -203- PERFORM R0700-00-ALTERA-GEARDETA. */
        ...
        private void R0000_10_FINALIZA(bool isPerform = false)
        {
            ...
            /*" -209- DISPLAY '*     SI9111B - FIM NORMAL     *' */
            _.Display($"*     SI9111B - FIM NORMAL     *");

            /*" -210- DISPLAY '********************************' */
            _.Display($"********************************");

            /*" -211- DISPLAY 'LIDOS       - SIARDEVC ' AC-L-SIARDEVC */
            _.Display($"LIDOS       - SIARDEVC {AC_L_SIARDEVC}");

            /*" -212- DISPLAY 'ALTERADOS   - SIARDEVC ' AC-U-SIARDEVC */
            _.Display($"ALTERADOS   - SIARDEVC {AC_U_SIARDEVC}");

            /*" -213- DISPLAY '            - GEARDETA ' AC-U-GEARDETA */
            _.Display($"            - GEARDETA {AC_U_GEARDETA}");

            /*" -214- DISPLAY 'INSERIDOS   - GEARDETA ' AC-I-GEARDETA */
            _.Display($"INSERIDOS   - GEARDETA {AC_I_GEARDETA}");

            /*" -215- DISPLAY '            - SIARVRCZ ' AC-I-SIARVRCZ */
            _.Display($"            - SIARVRCZ {AC_I_SIARVRCZ}");

            /*" -216- DISPLAY '            - SIARREVC ' AC-I-SIARREVC */
            _.Display($"            - SIARREVC {AC_I_SIARREVC}");

            /*" -218- DISPLAY 'GRAVADOS    - CVPAGSIN ' AC-G-CVPAGSIN */
        ...
        {
            /*" -232- MOVE '0100' TO WNR-EXEC-SQL */
            _.Move("0100", WABEND.WNR_EXEC_SQL);

            /*" -241- PERFORM R0100_00_LE_SISTEMAS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -245- DISPLAY 'ERRO NO SELECT SISTEMAS' */
            ...
            /*" -254- DISPLAY '*  DATA DO SISTEMA DE SINISTRO *' ' ' SISTEMAS-DATA-MOV-ABERTO. */
        ...
        {
            /*" -241- EXEC SQL SELECT DATA_MOV_ABERTO, YEAR(DATA_MOV_ABERTO), MONTH(DATA_MOV_ABERTO) INTO :SISTEMAS-DATA-MOV-ABERTO, :HOST-ANO-MOV-ABERTO, :HOST-MES-MOV-ABERTO FROM SEGUROS.SISTEMAS WHERE IDE_SISTEMA = 'SI' END-EXEC */
        ...
        {
            /*" -302- MOVE '0510' TO WNR-EXEC-SQL */
            _.Move("0510", WABEND.WNR_EXEC_SQL);

            /*" -307- PERFORM R0510_00_MAX_GEARDETA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -312- DISPLAY 'ERRO MAX GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO */
        ...
        {
            /*" -307- EXEC SQL SELECT VALUE(MAX(SEQ_GERACAO),0) INTO :GEARDETA-SEQ-GERACAO FROM SEGUROS.GE_AR_DETALHE WHERE NOM_ARQUIVO = :GEARDETA-NOM-ARQUIVO END-EXEC. */
        ...
        {
            /*" -322- MOVE '0520' TO WNR-EXEC-SQL. */
            _.Move("0520", WABEND.WNR_EXEC_SQL);

            /*" -352- PERFORM R0520_00_INCLUI_GEARDETA_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -358- DISPLAY 'PROBLEMAS NO INSERT GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO */
        ...
        {
            /*" -370- MOVE '0530' TO WNR-EXEC-SQL. */
            _.Move("0530", WABEND.WNR_EXEC_SQL);

            /*" -384- PERFORM R0530_00_INCLUI_SIARVRCZ_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -392- DISPLAY 'PROBLEMAS NO INSERT SI_AR_VERA_CRUZ' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' SIARVRCZ-TIPO-REGISTRO ' ' SIARVRCZ-SEQ-REGISTRO */
        ...
        {
            /*" -384- EXEC SQL INSERT INTO SEGUROS.SI_AR_VERA_CRUZ (NOM_ARQUIVO, SEQ_GERACAO, TIPO_REGISTRO, SEQ_REGISTRO, STA_PROCESSAMENTO, COD_ERRO) VALUES (:GEARDETA-NOM-ARQUIVO, :GEARDETA-SEQ-GERACAO, :SIARVRCZ-TIPO-REGISTRO, :SIARVRCZ-SEQ-REGISTRO, :SIARVRCZ-STA-PROCESSAMENTO, NULL) END-EXEC. */
        ...
        private void R0600_00_GERA_TRAILLER_SECTION()
        {
            ...
            /*" -420- WRITE REG-VCMOVSIN. */
            CVPAGSIN.Write(REG_VCMOVSIN.GetMoveValues().ToString());

            /*" -421- MOVE '3' TO SIARVRCZ-TIPO-REGISTRO */
            _.Move("3", SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_TIPO_REGISTRO);

            /*" -422- MOVE AC-G-CVPAGSIN TO SIARVRCZ-SEQ-REGISTRO */
            _.Move(AC_G_CVPAGSIN, SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_SEQ_REGISTRO);

            /*" -423- MOVE '1' TO SIARVRCZ-STA-PROCESSAMENTO */
            _.Move("1", SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_STA_PROCESSAMENTO);

            /*" -423- PERFORM R0530-00-INCLUI-SIARVRCZ. */
        ...
        {
            /*" -433- MOVE '0700' TO WNR-EXEC-SQL. */
            _.Move("0700", WABEND.WNR_EXEC_SQL);

            /*" -439- PERFORM R0700_00_ALTERA_GEARDETA_DB_UPDATE_1 */

            R0700_00_ALTERA_GEARDETA_DB_UPDATE_1();

            /*" -442- IF SQLCODE NOT EQUAL ZEROS */

            if (DB.SQLCODE != 00)
            {

                /*" -446- DISPLAY 'PROBLEMAS NO UPDATE GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' GEARDETA-QTD-REG-PROCESSADO */
        ...
        {
            /*" -439- EXEC SQL UPDATE SEGUROS.GE_AR_DETALHE SET QTD_REG_PROCESSADO = :GEARDETA-QTD-REG-PROCESSADO WHERE NOM_ARQUIVO = :GEARDETA-NOM-ARQUIVO AND SEQ_GERACAO = :GEARDETA-SEQ-GERACAO END-EXEC. */
        ...
        {
            /*" -463- MOVE '0900' TO WNR-EXEC-SQL */
            _.Move("0900", WABEND.WNR_EXEC_SQL);

            /*" -578- PERFORM R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1 */

            R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1();

            /*" -580- PERFORM R0900_00_DECLARA_SIARDEVC_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -584- DISPLAY 'PROBLEMAS NO OPEN SIARDEVC' */
        ...
        public void R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1()
        {
            ...
            string GetQuery_C01_SIARDEVC()
            {
                var query = @$"SELECT V.NOM_ARQUIVO
							...
							(H.NUM_APOL_SINISTRO = 1003100104085 AND 
							H.OCORR_HISTORICO = 11) 
							) 
							ORDER BY V.SEQ_REGISTRO";
        ...
        {
            /*" -580- EXEC SQL OPEN C01_SIARDEVC END-EXEC. */
        ...
        {
            /*" -595- MOVE '0910' TO WNR-EXEC-SQL. */
            _.Move("0910", WABEND.WNR_EXEC_SQL);

            /*" -684- PERFORM R0910_00_LE_SIARDEVC_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 00)
            {
                ...
                /*" -695- IF SIARDEVC-NUM-APOL-SINISTRO EQUAL 1003100063370 */

                if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_APOL_SINISTRO == 1003100063370)
                {

                    /*" -696- GO TO R0910-00-LE-SIARDEVC */
                    new Task(() => R0910_00_LE_SIARDEVC_SECTION()).RunSynchronously(); //GOTO
            ...
            else
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -701- MOVE 'S' TO WFIM-SIARDEVC */
                    _.Move("S", WFIM_SIARDEVC);

                    /*" -701- PERFORM R0910_00_LE_SIARDEVC_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -704- DISPLAY 'PROBLEMAS NO FETCH SIARDEVC' */
        ...
        {
            /*" -701- EXEC SQL CLOSE C01_SIARDEVC END-EXEC */
        ...
        {
            /*" -717- MOVE '1000' TO WNR-EXEC-SQL */
            _.Move("1000", WABEND.WNR_EXEC_SQL);

            /*" -718- IF SIARDEVC-VAL-LIQUIDO-PAGTO EQUAL 0 */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_VAL_LIQUIDO_PAGTO == 0)
            {

                /*" -728- COMPUTE SIARDEVC-VAL-LIQUIDO-PAGTO = SIARDEVC-VAL-TOT-MOVIMENTO - SIARDEVC-VAL-DESC-PARC-PEND - SIARDEVC-VAL-IRF - SIARDEVC-VAL-ISS - SIARDEVC-VAL-INSS - SIARDEVC-VAL-PISPASEP - SIARDEVC-VAL-COFINS - SIARDEVC-VAL-CSLL. */
            ...
            /*" -729- IF SIARDEVC-NUM-CHEQUE-INTERNO EQUAL 0 */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_CHEQUE_INTERNO == 0)
            {

                /*" -734- DISPLAY 'VERA CRUZ SEM NUM CHEQUE INTERNO ' ' SIN ' SIARDEVC-NUM-APOL-SINISTRO ' OCO ' SIARDEVC-OCORR-HISTORICO ' OPE ' SIARDEVC-COD-OPERACAO . */
            ...
            /*" -737- IF NOT (SIARDEVC-NUM-APOL-SINISTRO EQUAL 1003100104085 AND SIARDEVC-OCORR-HISTORICO EQUAL 11 ) */

            if (!(SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_APOL_SINISTRO.GetMoveValues().ToInt() == 1003100104085 && SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_OCORR_HISTORICO == 11))
            {

                /*" -739- PERFORM R10000-LE-CHEQUES-EMITIDOS */
        ...
        {
            /*" -780- PERFORM R0910-00-LE-SIARDEVC. */
        ...
        {
            /*" -790- MOVE '1100' TO WNR-EXEC-SQL */
            _.Move("1100", WABEND.WNR_EXEC_SQL);

            /*" -795- PERFORM R1100_00_LE_SIERRO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -804- DISPLAY 'ERRO SELECT SI_ERRO' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-COD-ERRO */
        ...
        {
            /*" -795- EXEC SQL SELECT DES_ERRO INTO :SIERRO-DES-ERRO FROM SEGUROS.SI_ERRO WHERE COD_ERRO = :SIARDEVC-COD-ERRO END-EXEC. */
        ...
        {
            /*" -814- MOVE '1200' TO WNR-EXEC-SQL */
            _.Move("1200", WABEND.WNR_EXEC_SQL);

            /*" -816- INITIALIZE REG-VCMOVSIN */
            _.Initialize(
                REG_VCMOVSIN
            );

            /*" -819- IF SIARDEVC-NUM-APOL-SINISTRO EQUAL ZEROS */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_APOL_SINISTRO == 00)
            {

                /*" -820- MOVE ZEROS TO DET-NUM-PROTOCOLO-SINI */
        ...
        {
            /*" -1050- MOVE '1250' TO WNR-EXEC-SQL */
            _.Move("1250", WABEND.WNR_EXEC_SQL);

            /*" -1057- PERFORM R1250_00_LE_SINISMES_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -1062- MOVE ZEROS TO SINISMES-COD-FONTE SINISMES-NUM-PROTOCOLO-SINI */
            ...
            else
            {
                ...
                if (DB.SQLCODE != 00)
                {
                    ...
                    /*" -1070- DISPLAY 'ERRO SELECT SINISTRO_MESTRE' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-NUM-APOL-SINISTRO */
        ...
        {
            /*" -1057- EXEC SQL SELECT COD_FONTE, NUM_PROTOCOLO_SINI INTO :SINISMES-COD-FONTE, :SINISMES-NUM-PROTOCOLO-SINI FROM SEGUROS.SINISTRO_MESTRE WHERE NUM_APOL_SINISTRO = :SIARDEVC-NUM-APOL-SINISTRO END-EXEC. */
        ...
        {
            /*" -1079- MOVE '1300' TO WNR-EXEC-SQL. */
            _.Move("1300", WABEND.WNR_EXEC_SQL);

            /*" -1097- PERFORM R1300_00_INCLUI_SIARREVC_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1109- DISPLAY 'PROBLEMAS NO INSERT SI_AR_RETORNO_VC' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' SIARREVC-TIPO-REGISTRO-VC ' ' SIARREVC-SEQ-REGISTRO-VC ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
        ...
        {
            /*" -1121- MOVE '1400' TO WNR-EXEC-SQL */
            _.Move("1400", WABEND.WNR_EXEC_SQL);

            /*" -1132- PERFORM R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1140- DISPLAY 'PROBLEMAS NO UPDATE SI_AR_DETALHE_VC' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
        ...
        {
            /*" -1151- MOVE '1500' TO WNR-EXEC-SQL */
            _.Move("1500", WABEND.WNR_EXEC_SQL);

            /*" -1153- INITIALIZE DCLCHEQUES-EMITIDOS DCLSI-SINI-CHEQUE. */
            _.Initialize(
                CHEQUEMI.DCLCHEQUES_EMITIDOS
                , SISINCHE.DCLSI_SINI_CHEQUE
            );

            /*" -1165- PERFORM R10000_LE_CHEQUES_EMITIDOS_DB_SELECT_1 */
            ...
            if ((DB.SQLCODE != 00))
            {
                ...
                /*" -1172- DISPLAY 'ERRO JOIN SI_SINI_CHEQUE E CHEQUES_EMITIDOS ' ' SIN ' SIARDEVC-NUM-APOL-SINISTRO ' OCO ' SIARDEVC-OCORR-HISTORICO ' NOM ' SIARDEVC-NOM-FAVORECIDO */
            ...
            /*" -1175- IF IND-DATA-EMISSAO LESS 0 */

            if (IND_DATA_EMISSAO < 0)
            {

                /*" -1176- MOVE '0001-01-01' TO CHEQUEMI-DATA-EMISSAO */
                _.Move("0001-01-01", CHEQUEMI.DCLCHEQUES_EMITIDOS.CHEQUEMI_DATA_EMISSAO);

                /*" -1176- MOVE +0 TO IND-DATA-EMISSAO. */
        ...
        {
            /*" -1191- MOVE '1500' TO WNR-EXEC-SQL */
            _.Move("1500", WABEND.WNR_EXEC_SQL);

            /*" -1193- INITIALIZE DCLLOTE-CHEQUES. */
            _.Initialize(
                LOTECHEQ.DCLLOTE_CHEQUES
            );

            /*" -1200- PERFORM R11000_ACESSA_CHEQUE_EXTERNO_DB_SELECT_1 */
            ...
            if ((DB.SQLCODE != 00))
            {
                ...
                if ((DB.SQLCODE == 100))
                {
                    ...
                    /*" -1205- MOVE ZEROS TO LOTECHEQ-NUM-CHEQUE */
                    _.Move(0, LOTECHEQ.DCLLOTE_CHEQUES.LOTECHEQ_NUM_CHEQUE);

                    /*" -1211- MOVE SPACES TO LOTECHEQ-SERIE-CHEQUE */
                ...
                else
                {
                    ...
                    /*" -1217- DISPLAY 'R11000-ERRO ACESSO LOTE_CHEQUE' ' SIN ' SIARDEVC-NUM-APOL-SINISTRO ' OCO ' SIARDEVC-OCORR-HISTORICO ' NOM ' SIARDEVC-NOM-FAVORECIDO ' CHQINT ' SISINCHE-NUM-CHEQUE-INTERNO */
        ...
        {
            /*" -1200- EXEC SQL SELECT NUM_CHEQUE , SERIE_CHEQUE INTO :LOTECHEQ-NUM-CHEQUE, :LOTECHEQ-SERIE-CHEQUE FROM SEGUROS.LOTE_CHEQUES WHERE NUM_CHEQUE_INTERNO = :SISINCHE-NUM-CHEQUE-INTERNO END-EXEC. */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1230- DISPLAY '*     SI9111B - CANCELADO      *' */
            _.Display($"*     SI9111B - CANCELADO      *");

            /*" -1232- DISPLAY '********************************' */
            _.Display($"********************************");

            /*" -1233- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, WABEND.WSQLCODE);

            /*" -1235- DISPLAY WABEND */
            _.Display(WABEND);

            /*" -1235- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1239- MOVE 99 TO RETURN-CODE */
