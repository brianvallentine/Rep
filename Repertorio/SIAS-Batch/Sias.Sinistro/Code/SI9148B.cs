...
using Dclgens;
using Copies;
using Sias.Sinistro.DB2.SI9148B;

namespace Code
{
    public class SI9148B
    {
        ...
        /*"01       REG-VCMOVSIN.*/
        public SI9148B_REG_VCMOVSIN REG_VCMOVSIN { get; set; } = new SI9148B_REG_VCMOVSIN();
        public class SI9148B_REG_VCMOVSIN : VarBasis
        {
            /*"  05     VCMOVSIN-HEADER.*/
            public SI9148B_VCMOVSIN_HEADER VCMOVSIN_HEADER { get; set; } = new SI9148B_VCMOVSIN_HEADER();
            public class SI9148B_VCMOVSIN_HEADER : VarBasis
            {
            ...
            private _REDEF_SI9148B_VCMOVSIN_DADOS _vcmovsin_dados { get; set; }
            public _REDEF_SI9148B_VCMOVSIN_DADOS VCMOVSIN_DADOS
            {
                get { _vcmovsin_dados = new _REDEF_SI9148B_VCMOVSIN_DADOS(); _.Move(VCMOVSIN_HEADER, _vcmovsin_dados); VarBasis.RedefinePassValue(VCMOVSIN_HEADER, _vcmovsin_dados, VCMOVSIN_HEADER); _vcmovsin_dados.ValueChanged += () => { _.Move(_vcmovsin_dados, VCMOVSIN_HEADER); }; return _vcmovsin_dados; }
                set { VarBasis.RedefinePassValue(value, _vcmovsin_dados, VCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9148B_VCMOVSIN_DADOS : VarBasis
            {
                ...
                /*"    10   DET-CIRCULAR-200.*/
                public SI9148B_DET_CIRCULAR_200 DET_CIRCULAR_200 { get; set; } = new SI9148B_DET_CIRCULAR_200();
                public class SI9148B_DET_CIRCULAR_200 : VarBasis
                {
                    ...
                    public SI9148B_DET_CIRCULAR_200()
                    {
                ...
                public SI9148B_DET_CIRCULAR_255 DET_CIRCULAR_255 { get; set; } = new SI9148B_DET_CIRCULAR_255();
                public class SI9148B_DET_CIRCULAR_255 : VarBasis
                {
                    ...
                    public SI9148B_DET_CIRCULAR_255()
                    {
                ...
                public _REDEF_SI9148B_VCMOVSIN_DADOS()
                {
            ...
            private _REDEF_SI9148B_VCMOVSIN_TRAILLER _vcmovsin_trailler { get; set; }
            public _REDEF_SI9148B_VCMOVSIN_TRAILLER VCMOVSIN_TRAILLER
            {
                get { _vcmovsin_trailler = new _REDEF_SI9148B_VCMOVSIN_TRAILLER(); _.Move(VCMOVSIN_HEADER, _vcmovsin_trailler); VarBasis.RedefinePassValue(VCMOVSIN_HEADER, _vcmovsin_trailler, VCMOVSIN_HEADER); _vcmovsin_trailler.ValueChanged += () => { _.Move(_vcmovsin_trailler, VCMOVSIN_HEADER); }; return _vcmovsin_trailler; }
                set { VarBasis.RedefinePassValue(value, _vcmovsin_trailler, VCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9148B_VCMOVSIN_TRAILLER : VarBasis
            {
                ...
                public _REDEF_SI9148B_VCMOVSIN_TRAILLER()
                {
        ...
        public SI9148B_WS_IDENT_PAGTO_EDITADO WS_IDENT_PAGTO_EDITADO { get; set; } = new SI9148B_WS_IDENT_PAGTO_EDITADO();
        public class SI9148B_WS_IDENT_PAGTO_EDITADO : VarBasis
        {
        ...
        public SI9148B_WABEND WABEND { get; set; } = new SI9148B_WABEND();
        public class SI9148B_WABEND : VarBasis
        {
            /*"  05     FILLER                      PIC  X(010) VALUE           ' SI9148B'.*/
            public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" SI9148B");
        ...
        public SI9148B_C01_SIARDEVC C01_SIARDEVC { get; set; } = new SI9148B_C01_SIARDEVC();
        ...
        /**/
        {
            try
            {
                ...
                /*" -136- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

                /*" -136- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -151- DISPLAY 'VERSAO V.03 - CADMUS 103659 - 20/10/2014' */
            _.Display($"VERSAO V.03 - CADMUS 103659 - 20/10/2014");
            ...
            /*" -157- PERFORM R0100-00-LE-SISTEMAS */

            R0100_00_LE_SISTEMAS_SECTION();

            /*" -159- OPEN OUTPUT CVPAGSIN */
            CVPAGSIN.Open(REG_VCMOVSIN);

            /*" -160- MOVE SPACES TO WFIM-SIARDEVC */
            _.Move("", WFIM_SIARDEVC);

            /*" -161- PERFORM R0900-00-DECLARA-SIARDEVC */

            R0900_00_DECLARA_SIARDEVC_SECTION();

            /*" -163- PERFORM R0910-00-LE-SIARDEVC */

            R0910_00_LE_SIARDEVC_SECTION();

            /*" -164- IF WFIM-SIARDEVC EQUAL 'S' */

            if (WFIM_SIARDEVC == "S")
            {

                /*" -166- GO TO R0000-10-FINALIZA. */
            ...
            /*" -169- MOVE 'N' TO WS-SEM-HEADER. */
            _.Move("N", WS_SEM_HEADER);

            /*" -177- PERFORM R1000-00-PROCESSA-SIARDEVC UNTIL WFIM-SIARDEVC EQUAL 'S' */
            ...
            /*" -178- IF WS-REG-GRAVADOS GREATER 0 */

            if (WS_REG_GRAVADOS > 0)
            {

                /*" -179- PERFORM R0600-00-GERA-TRAILLER */

                R0600_00_GERA_TRAILLER_SECTION();

                /*" -180- ADD AC-G-CVPAGSIN TO GEARDETA-QTD-REG-PROCESSADO */
                ...
                /*" -181- PERFORM R0700-00-ALTERA-GEARDETA */
        ...
        private void R0000_10_FINALIZA(bool isPerform = false)
        {
            ...
            /*" -187- DISPLAY '*     SI9148B - FIM NORMAL     *' */
            _.Display($"*     SI9148B - FIM NORMAL     *");

            /*" -188- DISPLAY '********************************' */
            _.Display($"********************************");

            /*" -189- DISPLAY 'LIDOS       - SIARDEVC ' AC-L-SIARDEVC */
            _.Display($"LIDOS       - SIARDEVC {AC_L_SIARDEVC}");

            /*" -190- DISPLAY 'ALTERADOS   - GEARDETA ' AC-U-GEARDETA */
            _.Display($"ALTERADOS   - GEARDETA {AC_U_GEARDETA}");

            /*" -191- DISPLAY '              SIARDEVC ' AC-U-SIARDEVC */
            _.Display($"              SIARDEVC {AC_U_SIARDEVC}");

            /*" -192- DISPLAY 'INSERIDOS   - GEARDETA ' AC-I-GEARDETA */
            _.Display($"INSERIDOS   - GEARDETA {AC_I_GEARDETA}");

            /*" -193- DISPLAY '            - SIARVRCZ ' AC-I-SIARVRCZ */
            _.Display($"            - SIARVRCZ {AC_I_SIARVRCZ}");

            /*" -194- DISPLAY '            - SIARREVC ' AC-I-SIARREVC */
            _.Display($"            - SIARREVC {AC_I_SIARREVC}");

            /*" -196- DISPLAY 'GRAVADOS    - CVPAGSIN ' AC-G-CVPAGSIN */
            _.Display($"GRAVADOS    - CVPAGSIN {AC_G_CVPAGSIN}");

            /*" -198- CLOSE CVPAGSIN */
            CVPAGSIN.Close();

            /*" -200- MOVE ZEROS TO RETURN-CODE */
        ...
        {
            /*" -208- MOVE '0100' TO WNR-EXEC-SQL */
            _.Move("0100", WABEND.WNR_EXEC_SQL);

            /*" -217- PERFORM R0100_00_LE_SISTEMAS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -221- DISPLAY 'ERRO NO SELECT SISTEMAS' */
                _.Display($"ERRO NO SELECT SISTEMAS");

                /*" -223- GO TO R9999-00-ROT-ERRO. */
            ...
            /*" -224- DISPLAY 'DATA DO SISTEMA DE SINISTRO -' ' ' SISTEMAS-DATA-MOV-ABERTO. */
        ...
        {
            /*" -217- EXEC SQL SELECT DATA_MOV_ABERTO, YEAR(DATA_MOV_ABERTO), MONTH(DATA_MOV_ABERTO) INTO :SISTEMAS-DATA-MOV-ABERTO, :HOST-ANO-MOV-ABERTO, :HOST-MES-MOV-ABERTO FROM SEGUROS.SISTEMAS WHERE IDE_SISTEMA = 'SI' END-EXEC */
        ...
        {
            /*" -271- MOVE '0510' TO WNR-EXEC-SQL */
            _.Move("0510", WABEND.WNR_EXEC_SQL);

            /*" -276- PERFORM R0510_00_MAX_GEARDETA_DB_SELECT_1 */

            R0510_00_MAX_GEARDETA_DB_SELECT_1();

            /*" -279- IF SQLCODE NOT EQUAL ZEROS */

            if (DB.SQLCODE != 00)
            {

                /*" -281- DISPLAY 'ERRO MAX GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO */

                $"ERRO MAX GE_AR_DETALHE {GEARDETA.DCLGE_AR_DETALHE.GEARDETA_NOM_ARQUIVO}"
                .Display();

                /*" -281- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -276- EXEC SQL SELECT VALUE(MAX(SEQ_GERACAO),0) INTO :GEARDETA-SEQ-GERACAO FROM SEGUROS.GE_AR_DETALHE WHERE NOM_ARQUIVO = :GEARDETA-NOM-ARQUIVO END-EXEC. */
        ...
        {
            /*" -291- MOVE '0520' TO WNR-EXEC-SQL. */
            _.Move("0520", WABEND.WNR_EXEC_SQL);

            /*" -321- PERFORM R0520_00_INCLUI_GEARDETA_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -327- DISPLAY 'PROBLEMAS NO INSERT GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO */
        ...
        {
            /*" -339- MOVE '0530' TO WNR-EXEC-SQL. */
            _.Move("0530", WABEND.WNR_EXEC_SQL);

            /*" -353- PERFORM R0530_00_INCLUI_SIARVRCZ_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -361- DISPLAY 'PROBLEMAS NO INSERT SI_AR_VERA_CRUZ' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' SIARVRCZ-TIPO-REGISTRO ' ' SIARVRCZ-SEQ-REGISTRO */
        ...
        {
            /*" -353- EXEC SQL INSERT INTO SEGUROS.SI_AR_VERA_CRUZ (NOM_ARQUIVO, SEQ_GERACAO, TIPO_REGISTRO, SEQ_REGISTRO, STA_PROCESSAMENTO, COD_ERRO) VALUES (:GEARDETA-NOM-ARQUIVO, :GEARDETA-SEQ-GERACAO, :SIARVRCZ-TIPO-REGISTRO, :SIARVRCZ-SEQ-REGISTRO, :SIARVRCZ-STA-PROCESSAMENTO, NULL) END-EXEC. */
        ...
        private void R0600_00_GERA_TRAILLER_SECTION()
        {
            ...
            /*" -396- WRITE REG-VCMOVSIN. */
            CVPAGSIN.Write(REG_VCMOVSIN.GetMoveValues().ToString());

            /*" -397- MOVE '3' TO SIARVRCZ-TIPO-REGISTRO */
            _.Move("3", SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_TIPO_REGISTRO);

            /*" -398- MOVE AC-G-CVPAGSIN TO SIARVRCZ-SEQ-REGISTRO */
            _.Move(AC_G_CVPAGSIN, SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_SEQ_REGISTRO);

            /*" -399- MOVE '1' TO SIARVRCZ-STA-PROCESSAMENTO */
            _.Move("1", SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_STA_PROCESSAMENTO);

            /*" -399- PERFORM R0530-00-INCLUI-SIARVRCZ. */
        ...
        {
            /*" -409- MOVE '0700' TO WNR-EXEC-SQL. */
            _.Move("0700", WABEND.WNR_EXEC_SQL);

            /*" -415- PERFORM R0700_00_ALTERA_GEARDETA_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -422- DISPLAY 'PROBLEMAS NO UPDATE GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' GEARDETA-QTD-REG-PROCESSADO */
        ...
        {
            /*" -415- EXEC SQL UPDATE SEGUROS.GE_AR_DETALHE SET QTD_REG_PROCESSADO = :GEARDETA-QTD-REG-PROCESSADO WHERE NOM_ARQUIVO = :GEARDETA-NOM-ARQUIVO AND SEQ_GERACAO = :GEARDETA-SEQ-GERACAO END-EXEC. */
        ...
        {
            /*" -434- MOVE '0900' TO WNR-EXEC-SQL */
            _.Move("0900", WABEND.WNR_EXEC_SQL);

            /*" -536- PERFORM R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1 */

            R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1();

            /*" -538- PERFORM R0900_00_DECLARA_SIARDEVC_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -542- DISPLAY 'PROBLEMAS NO OPEN SIARDEVC' */
        ...
        {
            /*" -538- EXEC SQL OPEN C01_SIARDEVC END-EXEC. */
        ...
        {
            /*" -552- MOVE '0910' TO WNR-EXEC-SQL. */
            _.Move("0910", WABEND.WNR_EXEC_SQL);

            /*" -642- PERFORM R0910_00_LE_SIARDEVC_DB_FETCH_1 */

            R0910_00_LE_SIARDEVC_DB_FETCH_1();

            /*" -645- IF SQLCODE EQUAL ZEROS */

            if (DB.SQLCODE == 00)
            {

                /*" -646- ADD 1 TO AC-L-SIARDEVC */
            ...
            else
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -649- MOVE 'S' TO WFIM-SIARDEVC */
                    _.Move("S", WFIM_SIARDEVC);

                    /*" -649- PERFORM R0910_00_LE_SIARDEVC_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -652- DISPLAY 'PROBLEMAS NO FETCH SIARDEVC' */
                    _.Display($"PROBLEMAS NO FETCH SIARDEVC");

                    /*" -652- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -649- EXEC SQL CLOSE C01_SIARDEVC END-EXEC */
        ...
        {
            /*" -662- MOVE '1000' TO WNR-EXEC-SQL */
            _.Move("1000", WABEND.WNR_EXEC_SQL);

            /*" -663- IF SIARDEVC-COD-ERRO NOT EQUAL ZEROS */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_COD_ERRO != 00)
            {

                /*" -664- PERFORM R1100-00-LE-SIERRO */
        ...
        {
            /*" -687- MOVE '1100' TO WNR-EXEC-SQL */
            _.Move("1100", WABEND.WNR_EXEC_SQL);

            /*" -692- PERFORM R1100_00_LE_SIERRO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -701- DISPLAY 'ERRO SELECT SI_ERRO' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-COD-ERRO */
        ...
        {
            /*" -692- EXEC SQL SELECT DES_ERRO INTO :SIERRO-DES-ERRO FROM SEGUROS.SI_ERRO WHERE COD_ERRO = :SIARDEVC-COD-ERRO END-EXEC. */
        ...
        {
            /*" -711- MOVE '1200' TO WNR-EXEC-SQL */
            _.Move("1200", WABEND.WNR_EXEC_SQL);

            /*" -712- IF WS-SEM-HEADER EQUAL 'N' */

            if (WS_SEM_HEADER == "N")
            {

                /*" -713- PERFORM R0500-00-GERA-HEADER */

                R0500_00_GERA_HEADER_SECTION();

                /*" -714- MOVE 'S' TO WS-SEM-HEADER */
            ...
            /*" -718- INITIALIZE REG-VCMOVSIN */
            _.Initialize(
                REG_VCMOVSIN
            );

            /*" -721- IF SIARDEVC-NUM-APOL-SINISTRO EQUAL ZEROS */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_APOL_SINISTRO == 00)
            {

                /*" -722- MOVE ZEROS TO DET-NUM-PROTOCOLO-SINI */
        ...
        {
            /*" -954- MOVE '1250' TO WNR-EXEC-SQL */
            _.Move("1250", WABEND.WNR_EXEC_SQL);

            /*" -961- PERFORM R1250_00_LE_SINISMES_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -966- MOVE ZEROS TO SINISMES-COD-FONTE SINISMES-NUM-PROTOCOLO-SINI */
            ...
            else
            {
                ...
                if (DB.SQLCODE != 00)
                {
                    ...
                    /*" -974- DISPLAY 'ERRO SELECT SINISTRO_MESTRE' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-NUM-APOL-SINISTRO */
        ...
        {
            /*" -961- EXEC SQL SELECT COD_FONTE, NUM_PROTOCOLO_SINI INTO :SINISMES-COD-FONTE, :SINISMES-NUM-PROTOCOLO-SINI FROM SEGUROS.SINISTRO_MESTRE WHERE NUM_APOL_SINISTRO = :SIARDEVC-NUM-APOL-SINISTRO END-EXEC. */
        ...
        {
            /*" -984- MOVE '1260' TO WNR-EXEC-SQL */
            _.Move("1260", WABEND.WNR_EXEC_SQL);

            /*" -990- PERFORM R1260_00_LE_LOTECHEQ_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -994- MOVE ALL '*' TO LOTECHEQ-SERIE-CHEQUE */
            ...
            else
            {
                ...
                if (DB.SQLCODE != 00)
                {
                    ...
                    /*" -1003- DISPLAY 'ERRO SELECT LOTE_CHEQUES' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-NUM-APOL-SINISTRO ' ' SIARDEVC-NUM-CHEQUE-INTERNO */
        ...
        {
            /*" -990- EXEC SQL SELECT SERIE_CHEQUE INTO :LOTECHEQ-SERIE-CHEQUE FROM SEGUROS.LOTE_CHEQUES WHERE NUM_CHEQUE_INTERNO = :SIARDEVC-NUM-CHEQUE-INTERNO END-EXEC. */
        ...
        {
            /*" -1013- MOVE '1300' TO WNR-EXEC-SQL. */
            _.Move("1300", WABEND.WNR_EXEC_SQL);

            /*" -1031- PERFORM R1300_00_INCLUI_SIARREVC_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1043- DISPLAY 'PROBLEMAS NO INSERT SI_AR_RETORNO_VC' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' SIARREVC-TIPO-REGISTRO-VC ' ' SIARREVC-SEQ-REGISTRO-VC ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
        ...
        {
            /*" -1055- MOVE '1400' TO WNR-EXEC-SQL */
            _.Move("1400", WABEND.WNR_EXEC_SQL);

            /*" -1064- PERFORM R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1072- DISPLAY 'PROBLEMAS NO UPDATE SI_AR_DETALHE_VC' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
            ...
            /*" -1074- ADD SQLERRD(3) TO AC-U-SIARDEVC. */
        ...
        {
            /*" -1064- EXEC SQL UPDATE SEGUROS.SI_AR_DETALHE_VC SET STA_PROCESSAMENTO = '4' WHERE NOM_ARQUIVO = :SIARDEVC-NOM-ARQUIVO AND SEQ_GERACAO = :SIARDEVC-SEQ-GERACAO AND TIPO_REGISTRO = :SIARDEVC-TIPO-REGISTRO AND SEQ_REGISTRO = :SIARDEVC-SEQ-REGISTRO AND STA_PROCESSAMENTO = '3' AND STA_RETORNO = '2' END-EXEC */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1086- DISPLAY '*     SI9148B - CANCELADO      *' */
            _.Display($"*     SI9148B - CANCELADO      *");

            /*" -1088- DISPLAY '********************************' */
            _.Display($"********************************");

            /*" -1089- MOVE SQLCODE TO WSQLCODE. */
