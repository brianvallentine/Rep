...
using Dclgens;
using Copies;
using Sias.Sinistro.DB2.SI9168B;

namespace Code
{
    public class SI9168B
    {
        ...
        /*"01       REG-VCMOVSIN.*/
        public SI9168B_REG_VCMOVSIN REG_VCMOVSIN { get; set; } = new SI9168B_REG_VCMOVSIN();
        public class SI9168B_REG_VCMOVSIN : VarBasis
        {
            /*"  05     VCMOVSIN-HEADER.*/
            public SI9168B_VCMOVSIN_HEADER VCMOVSIN_HEADER { get; set; } = new SI9168B_VCMOVSIN_HEADER();
            public class SI9168B_VCMOVSIN_HEADER : VarBasis
            {
            ...
            private _REDEF_SI9168B_VCMOVSIN_DADOS _vcmovsin_dados { get; set; }
            public _REDEF_SI9168B_VCMOVSIN_DADOS VCMOVSIN_DADOS
            {
                get { _vcmovsin_dados = new _REDEF_SI9168B_VCMOVSIN_DADOS(); _.Move(VCMOVSIN_HEADER, _vcmovsin_dados); VarBasis.RedefinePassValue(VCMOVSIN_HEADER, _vcmovsin_dados, VCMOVSIN_HEADER); _vcmovsin_dados.ValueChanged += () => { _.Move(_vcmovsin_dados, VCMOVSIN_HEADER); }; return _vcmovsin_dados; }
                set { VarBasis.RedefinePassValue(value, _vcmovsin_dados, VCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9168B_VCMOVSIN_DADOS : VarBasis
            {
                ...
                /*"    10   DET-CIRCULAR-200.*/
                public SI9168B_DET_CIRCULAR_200 DET_CIRCULAR_200 { get; set; } = new SI9168B_DET_CIRCULAR_200();
                public class SI9168B_DET_CIRCULAR_200 : VarBasis
                {
                    ...
                    public SI9168B_DET_CIRCULAR_200()
                    {
                ...
                public SI9168B_DET_CIRCULAR_255 DET_CIRCULAR_255 { get; set; } = new SI9168B_DET_CIRCULAR_255();
                public class SI9168B_DET_CIRCULAR_255 : VarBasis
                {
                    ...
                    public SI9168B_DET_CIRCULAR_255()
                    {
                ...
                public _REDEF_SI9168B_VCMOVSIN_DADOS()
                {
            ...
            private _REDEF_SI9168B_VCMOVSIN_TRAILLER _vcmovsin_trailler { get; set; }
            public _REDEF_SI9168B_VCMOVSIN_TRAILLER VCMOVSIN_TRAILLER
            {
                get { _vcmovsin_trailler = new _REDEF_SI9168B_VCMOVSIN_TRAILLER(); _.Move(VCMOVSIN_HEADER, _vcmovsin_trailler); VarBasis.RedefinePassValue(VCMOVSIN_HEADER, _vcmovsin_trailler, VCMOVSIN_HEADER); _vcmovsin_trailler.ValueChanged += () => { _.Move(_vcmovsin_trailler, VCMOVSIN_HEADER); }; return _vcmovsin_trailler; }
                set { VarBasis.RedefinePassValue(value, _vcmovsin_trailler, VCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9168B_VCMOVSIN_TRAILLER : VarBasis
            {
                ...
                public _REDEF_SI9168B_VCMOVSIN_TRAILLER()
                {
        ...
        public SI9168B_WS_IDENT_PAGTO_EDITADO WS_IDENT_PAGTO_EDITADO { get; set; } = new SI9168B_WS_IDENT_PAGTO_EDITADO();
        public class SI9168B_WS_IDENT_PAGTO_EDITADO : VarBasis
        {
        ...
        public SI9168B_WABEND WABEND { get; set; } = new SI9168B_WABEND();
        public class SI9168B_WABEND : VarBasis
        {
            /*"  05     FILLER                      PIC  X(010) VALUE           ' SI9168B'.*/
            public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" SI9168B");
        ...
        public SI9168B_C01_SIARDEVC C01_SIARDEVC { get; set; } = new SI9168B_C01_SIARDEVC();
        ...
        /**/
        {
            try
            {
                ...
                /*" -118- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -129- DISPLAY 'PROGRAMA EM EXECUCAO SI9168B   ' . */
            _.Display($"PROGRAMA EM EXECUCAO SI9168B   ");

            /*" -130- DISPLAY '                               ' . */
            _.Display($"                               ");

            /*" -131- DISPLAY 'VERSAO V.01 NSGD    20/10/2014 ' . */
        ...
        private void R0000_10_FINALIZA(bool isPerform = false)
        {
            ...
            /*" -158- DISPLAY '*     SI9168B - FIM NORMAL     *' */
            _.Display($"*     SI9168B - FIM NORMAL     *");
        ...
        private void R0900_00_DECLARA_SIARDEVC_SECTION()
        {
            ...
            /*" -504- PERFORM R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1 */

            R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1();

            /*" -506- PERFORM R0900_00_DECLARA_SIARDEVC_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -510- DISPLAY 'PROBLEMAS NO OPEN SIARDEVC' */
        ...
        {
            /*" -506- EXEC SQL OPEN C01_SIARDEVC END-EXEC. */
        ...
        {
            /*" -520- MOVE '0910' TO WNR-EXEC-SQL. */
            _.Move("0910", WABEND.WNR_EXEC_SQL);

            /*" -611- PERFORM R0910_00_LE_SIARDEVC_DB_FETCH_1 */

            R0910_00_LE_SIARDEVC_DB_FETCH_1();

            /*" -614- IF SQLCODE EQUAL ZEROS */

            if (DB.SQLCODE == 00)
            {

                /*" -615- ADD 1 TO AC-L-SIARDEVC */
            ...
            else
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -618- MOVE 'S' TO WFIM-SIARDEVC */
                    _.Move("S", WFIM_SIARDEVC);

                    /*" -618- PERFORM R0910_00_LE_SIARDEVC_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -621- DISPLAY 'PROBLEMAS NO FETCH SIARDEVC' */
        ...
        {
            /*" -618- EXEC SQL CLOSE C01_SIARDEVC END-EXEC */
        ...
        {
            /*" -631- MOVE '1000' TO WNR-EXEC-SQL */
            _.Move("1000", WABEND.WNR_EXEC_SQL);

            /*" -632- IF SIARDEVC-COD-ERRO NOT EQUAL ZEROS */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_COD_ERRO != 00)
            {

                /*" -633- PERFORM R1100-00-LE-SIERRO */
        ...
        {
            /*" -648- PERFORM R0910-00-LE-SIARDEVC. */
        ...
        {
            /*" -658- MOVE '1100' TO WNR-EXEC-SQL */
            _.Move("1100", WABEND.WNR_EXEC_SQL);

            /*" -663- PERFORM R1100_00_LE_SIERRO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -672- DISPLAY 'ERRO SELECT SI_ERRO' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-COD-ERRO */
        ...
        {
            /*" -663- EXEC SQL SELECT DES_ERRO INTO :SIERRO-DES-ERRO FROM SEGUROS.SI_ERRO WHERE COD_ERRO = :SIARDEVC-COD-ERRO END-EXEC. */
        ...
        {
            /*" -682- MOVE '1200' TO WNR-EXEC-SQL */
            _.Move("1200", WABEND.WNR_EXEC_SQL);

            /*" -684- INITIALIZE REG-VCMOVSIN */
            _.Initialize(
                REG_VCMOVSIN
            );

            /*" -687- IF SIARDEVC-NUM-APOL-SINISTRO EQUAL ZEROS */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_APOL_SINISTRO == 00)
            {

                /*" -688- MOVE ZEROS TO DET-NUM-PROTOCOLO-SINI */
        ...
        {
            /*" -910- MOVE '1210' TO WNR-EXEC-SQL */
            _.Move("1210", WABEND.WNR_EXEC_SQL);

            /*" -917- PERFORM R1210_00_LE_SINISMES_DB_SELECT_1 */

            R1210_00_LE_SINISMES_DB_SELECT_1();

            /*" -920- IF SQLCODE EQUAL 100 */

            if (DB.SQLCODE == 100)
            {

                /*" -922- MOVE ZEROS TO SINISMES-COD-FONTE SINISMES-NUM-PROTOCOLO-SINI */
            ...
            else
            {
                ...
                if (DB.SQLCODE != 00)
                {
                    ...
                    /*" -930- DISPLAY 'ERRO SELECT SINISTRO_MESTRE' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-NUM-APOL-SINISTRO */
        ...
        {
            /*" -917- EXEC SQL SELECT COD_FONTE, NUM_PROTOCOLO_SINI INTO :SINISMES-COD-FONTE, :SINISMES-NUM-PROTOCOLO-SINI FROM SEGUROS.SINISTRO_MESTRE WHERE NUM_APOL_SINISTRO = :SIARDEVC-NUM-APOL-SINISTRO END-EXEC. */
        ...
        {
            /*" -940- MOVE '1300' TO WNR-EXEC-SQL. */
            _.Move("1300", WABEND.WNR_EXEC_SQL);

            /*" -958- PERFORM R1300_00_INCLUI_SIARREVC_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -970- DISPLAY 'PROBLEMAS NO INSERT SI_AR_RETORNO_VC' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' SIARREVC-TIPO-REGISTRO-VC ' ' SIARREVC-SEQ-REGISTRO-VC ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
        ...
        {
            /*" -982- MOVE '1400' TO WNR-EXEC-SQL */
            _.Move("1400", WABEND.WNR_EXEC_SQL);

            /*" -992- PERFORM R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1000- DISPLAY 'PROBLEMAS NO UPDATE SI_AR_DETALHE_VC' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
        ...
        {
            /*" -992- EXEC SQL UPDATE SEGUROS.SI_AR_DETALHE_VC SET STA_RETORNO = '2' , STA_PROCESSAMENTO = '3' , OCORR_HISTORICO = :SINISHIS-OCORR-HISTORICO WHERE NOM_ARQUIVO = :SIARDEVC-NOM-ARQUIVO AND SEQ_GERACAO = :SIARDEVC-SEQ-GERACAO AND TIPO_REGISTRO = :SIARDEVC-TIPO-REGISTRO AND SEQ_REGISTRO = :SIARDEVC-SEQ-REGISTRO AND STA_RETORNO = '1' END-EXEC. */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1014- DISPLAY '*     SI9168B - CANCELADO      *' */
            _.Display($"*     SI9168B - CANCELADO      *");
            ...
            /*" -1019- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1023- MOVE 99 TO RETURN-CODE */
