...
using Dclgens;
using Copies;
using Sias.Sinistro.DB2.SI9269B;

namespace Code
{
    public class SI9269B
    {
        ...
        /*"01       REG-SCMOVSIN.*/
        public SI9269B_REG_SCMOVSIN REG_SCMOVSIN { get; set; } = new SI9269B_REG_SCMOVSIN();
        public class SI9269B_REG_SCMOVSIN : VarBasis
        {
            /*"  05     SCMOVSIN-HEADER.*/
            public SI9269B_SCMOVSIN_HEADER SCMOVSIN_HEADER { get; set; } = new SI9269B_SCMOVSIN_HEADER();
            public class SI9269B_SCMOVSIN_HEADER : VarBasis
            {
            ...
            private _REDEF_SI9269B_SCMOVSIN_DADOS _scmovsin_dados { get; set; }
            public _REDEF_SI9269B_SCMOVSIN_DADOS SCMOVSIN_DADOS
            {
                get { _scmovsin_dados = new _REDEF_SI9269B_SCMOVSIN_DADOS(); _.Move(SCMOVSIN_HEADER, _scmovsin_dados); VarBasis.RedefinePassValue(SCMOVSIN_HEADER, _scmovsin_dados, SCMOVSIN_HEADER); _scmovsin_dados.ValueChanged += () => { _.Move(_scmovsin_dados, SCMOVSIN_HEADER); }; return _scmovsin_dados; }
                set { VarBasis.RedefinePassValue(value, _scmovsin_dados, SCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9269B_SCMOVSIN_DADOS : VarBasis
            {
                ...
                /*"    10   DET-CEP.*/
                public SI9269B_DET_CEP DET_CEP { get; set; } = new SI9269B_DET_CEP();
                public class SI9269B_DET_CEP : VarBasis
                {
                    /*"         15  DET-NUM-CEP             PIC  9(008).*/
                    public IntBasis DET_NUM_CEP { get; set; } = new IntBasis(new PIC("9", "8", "9(008)."));
                    /*"    10   DET-NUM-DDD                 PIC  9(002).*/

                    public SI9269B_DET_CEP()
                    {
                ...
                /*"    10   DET-CIRCULAR-200.*/
                public SI9269B_DET_CIRCULAR_200 DET_CIRCULAR_200 { get; set; } = new SI9269B_DET_CIRCULAR_200();
                public class SI9269B_DET_CIRCULAR_200 : VarBasis
                {
                    ...
                    public SI9269B_DET_CIRCULAR_200()
                    {
                ...
                public SI9269B_DET_CIRCULAR_255 DET_CIRCULAR_255 { get; set; } = new SI9269B_DET_CIRCULAR_255();
                public class SI9269B_DET_CIRCULAR_255 : VarBasis
                {
                    ...
                    public SI9269B_DET_CIRCULAR_255()
                    {
                ...
                public _REDEF_SI9269B_SCMOVSIN_DADOS()
                {
            ...
            private _REDEF_SI9269B_SCMOVSIN_TRAILLER _scmovsin_trailler { get; set; }
            public _REDEF_SI9269B_SCMOVSIN_TRAILLER SCMOVSIN_TRAILLER
            {
                get { _scmovsin_trailler = new _REDEF_SI9269B_SCMOVSIN_TRAILLER(); _.Move(SCMOVSIN_HEADER, _scmovsin_trailler); VarBasis.RedefinePassValue(SCMOVSIN_HEADER, _scmovsin_trailler, SCMOVSIN_HEADER); _scmovsin_trailler.ValueChanged += () => { _.Move(_scmovsin_trailler, SCMOVSIN_HEADER); }; return _scmovsin_trailler; }
                set { VarBasis.RedefinePassValue(value, _scmovsin_trailler, SCMOVSIN_HEADER); }
            }  //Redefines
            public class _REDEF_SI9269B_SCMOVSIN_TRAILLER : VarBasis
            {
                ...
                public _REDEF_SI9269B_SCMOVSIN_TRAILLER()
                {
        ...
        public SI9269B_WS_IDENT_PAGTO_EDITADO WS_IDENT_PAGTO_EDITADO { get; set; } = new SI9269B_WS_IDENT_PAGTO_EDITADO();
        public class SI9269B_WS_IDENT_PAGTO_EDITADO : VarBasis
        {
        ...
        public SI9269B_WABEND WABEND { get; set; } = new SI9269B_WABEND();
        public class SI9269B_WABEND : VarBasis
        {
            /*"  05     FILLER                      PIC  X(010) VALUE           ' SI9269B'.*/
            public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" SI9269B");
        ...
        public SI9269B_C01_SIARDEVC C01_SIARDEVC { get; set; } = new SI9269B_C01_SIARDEVC();
        ...
        /**/
        {
            try
            {
                ...
                /*" -132- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        {
            /*" -140- MOVE '0000' TO WNR-EXEC-SQL */
            _.Move("0000", WABEND.WNR_EXEC_SQL);

            /*" -141- DISPLAY '-------------------------------' . */
            _.Display($"-------------------------------");

            /*" -142- DISPLAY 'PROGRAMA EM EXECUCAO SI9269B   ' . */
            _.Display($"PROGRAMA EM EXECUCAO SI9269B   ");

            /*" -143- DISPLAY '                               ' . */
            _.Display($"                               ");

            /*" -144- DISPLAY 'VERSAO V.01 NSGD    21/10/2014 ' . */
            _.Display($"VERSAO V.01 NSGD    21/10/2014 ");

            /*" -146- DISPLAY '-------------------------------' . */
            _.Display($"-------------------------------");

            /*" -148- PERFORM R0100-00-LE-SISTEMAS */

            R0100_00_LE_SISTEMAS_SECTION();

            /*" -150- OPEN OUTPUT CSPAGSIN */
            CSPAGSIN.Open(REG_SCMOVSIN);

            /*" -151- MOVE SPACES TO WFIM-SIARDEVC */
            _.Move("", WFIM_SIARDEVC);

            /*" -152- PERFORM R0900-00-DECLARA-SIARDEVC */

            R0900_00_DECLARA_SIARDEVC_SECTION();

            /*" -154- PERFORM R0910-00-LE-SIARDEVC */

            R0910_00_LE_SIARDEVC_SECTION();

            /*" -155- IF WFIM-SIARDEVC EQUAL 'S' */

            if (WFIM_SIARDEVC == "S")
            {

                /*" -157- GO TO R0000-10-FINALIZA. */
            ...
            /*" -159- PERFORM R0500-00-GERA-HEADER */

            R0500_00_GERA_HEADER_SECTION();

            /*" -162- PERFORM R1000-00-PROCESSA-SIARDEVC UNTIL WFIM-SIARDEVC EQUAL 'S' */
            ...
            /*" -164- PERFORM R0600-00-GERA-TRAILLER */

            R0600_00_GERA_TRAILLER_SECTION();

            /*" -165- ADD AC-G-CSPAGSIN TO GEARDETA-QTD-REG-PROCESSADO */
            ...
            /*" -165- PERFORM R0700-00-ALTERA-GEARDETA. */
        ...
        private void R0000_10_FINALIZA(bool isPerform = false)
        {
            ...
            /*" -171- DISPLAY '*     SI9269B - FIM NORMAL     *' */
            _.Display($"*     SI9269B - FIM NORMAL     *");

            /*" -172- DISPLAY '********************************' */
            _.Display($"********************************");

            /*" -173- DISPLAY 'LIDOS       - SIARDEVC ' AC-L-SIARDEVC */
            _.Display($"LIDOS       - SIARDEVC {AC_L_SIARDEVC}");

            /*" -174- DISPLAY 'ALTERADOS   - SIARDEVC ' AC-U-SIARDEVC */
            _.Display($"ALTERADOS   - SIARDEVC {AC_U_SIARDEVC}");

            /*" -175- DISPLAY '            - GEARDETA ' AC-U-GEARDETA */
            _.Display($"            - GEARDETA {AC_U_GEARDETA}");

            /*" -176- DISPLAY 'INSERIDOS   - GEARDETA ' AC-I-GEARDETA */
            _.Display($"INSERIDOS   - GEARDETA {AC_I_GEARDETA}");

            /*" -177- DISPLAY '            - SIARVRCZ ' AC-I-SIARVRCZ */
            _.Display($"            - SIARVRCZ {AC_I_SIARVRCZ}");

            /*" -178- DISPLAY '            - SIARREVC ' AC-I-SIARREVC */
            _.Display($"            - SIARREVC {AC_I_SIARREVC}");

            /*" -180- DISPLAY 'GRAVADOS    - CSPAGSIN ' AC-G-CSPAGSIN */
            _.Display($"GRAVADOS    - CSPAGSIN {AC_G_CSPAGSIN}");

            /*" -182- CLOSE CSPAGSIN */
            CSPAGSIN.Close();

            /*" -184- MOVE ZEROS TO RETURN-CODE */
        ...
        {
            /*" -192- MOVE '0100' TO WNR-EXEC-SQL */
            _.Move("0100", WABEND.WNR_EXEC_SQL);

            /*" -201- PERFORM R0100_00_LE_SISTEMAS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -205- DISPLAY 'ERRO NO SELECT SISTEMAS' */
                _.Display($"ERRO NO SELECT SISTEMAS");

                /*" -207- GO TO R9999-00-ROT-ERRO. */
            ...
            /*" -208- DISPLAY 'DATA DO SISTEMA DE SINISTRO -' ' ' SISTEMAS-DATA-MOV-ABERTO. */
        ...
        {
            /*" -201- EXEC SQL SELECT DATA_MOV_ABERTO, YEAR(DATA_MOV_ABERTO), MONTH(DATA_MOV_ABERTO) INTO :SISTEMAS-DATA-MOV-ABERTO, :HOST-ANO-MOV-ABERTO, :HOST-MES-MOV-ABERTO FROM SEGUROS.SISTEMAS WHERE IDE_SISTEMA = 'SI' END-EXEC */
        ...
        {
            /*" -260- MOVE '0510' TO WNR-EXEC-SQL */
            _.Move("0510", WABEND.WNR_EXEC_SQL);

            /*" -265- PERFORM R0510_00_MAX_GEARDETA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -270- DISPLAY 'ERRO MAX GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO */

                $"ERRO MAX GE_AR_DETALHE {GEARDETA.DCLGE_AR_DETALHE.GEARDETA_NOM_ARQUIVO}"
                .Display();

                /*" -270- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -265- EXEC SQL SELECT VALUE(MAX(SEQ_GERACAO),0) INTO :GEARDETA-SEQ-GERACAO FROM SEGUROS.GE_AR_DETALHE WHERE NOM_ARQUIVO = :GEARDETA-NOM-ARQUIVO END-EXEC. */
        ...
        {
            /*" -280- MOVE '0520' TO WNR-EXEC-SQL. */
            _.Move("0520", WABEND.WNR_EXEC_SQL);

            /*" -310- PERFORM R0520_00_INCLUI_GEARDETA_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -316- DISPLAY 'PROBLEMAS NO INSERT GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO */
        ...
        {
            /*" -328- MOVE '0530' TO WNR-EXEC-SQL. */
            _.Move("0530", WABEND.WNR_EXEC_SQL);

            /*" -342- PERFORM R0530_00_INCLUI_SIARVRCZ_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -350- DISPLAY 'PROBLEMAS NO INSERT SI_AR_VERA_CRUZ' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' SIARVRCZ-TIPO-REGISTRO ' ' SIARVRCZ-SEQ-REGISTRO */
        ...
        {
            /*" -342- EXEC SQL INSERT INTO SEGUROS.SI_AR_VERA_CRUZ (NOM_ARQUIVO, SEQ_GERACAO, TIPO_REGISTRO, SEQ_REGISTRO, STA_PROCESSAMENTO, COD_ERRO) VALUES (:GEARDETA-NOM-ARQUIVO, :GEARDETA-SEQ-GERACAO, :SIARVRCZ-TIPO-REGISTRO, :SIARVRCZ-SEQ-REGISTRO, :SIARVRCZ-STA-PROCESSAMENTO, NULL) END-EXEC. */
        ...
        private void R0600_00_GERA_TRAILLER_SECTION()
        {
            ...
            /*" -379- WRITE REG-SCMOVSIN. */
            CSPAGSIN.Write(REG_SCMOVSIN.GetMoveValues().ToString());

            /*" -380- MOVE '3' TO SIARVRCZ-TIPO-REGISTRO */
            _.Move("3", SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_TIPO_REGISTRO);

            /*" -381- MOVE AC-G-CSPAGSIN TO SIARVRCZ-SEQ-REGISTRO */
            _.Move(AC_G_CSPAGSIN, SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_SEQ_REGISTRO);

            /*" -382- MOVE '1' TO SIARVRCZ-STA-PROCESSAMENTO */
            _.Move("1", SIARVRCZ.DCLSI_AR_VERA_CRUZ.SIARVRCZ_STA_PROCESSAMENTO);

            /*" -382- PERFORM R0530-00-INCLUI-SIARVRCZ. */
        ...
        {
            /*" -392- MOVE '0700' TO WNR-EXEC-SQL. */
            _.Move("0700", WABEND.WNR_EXEC_SQL);

            /*" -398- PERFORM R0700_00_ALTERA_GEARDETA_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -405- DISPLAY 'PROBLEMAS NO UPDATE GE_AR_DETALHE' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' GEARDETA-QTD-REG-PROCESSADO */
        ...
        {
            /*" -398- EXEC SQL UPDATE SEGUROS.GE_AR_DETALHE SET QTD_REG_PROCESSADO = :GEARDETA-QTD-REG-PROCESSADO WHERE NOM_ARQUIVO = :GEARDETA-NOM-ARQUIVO AND SEQ_GERACAO = :GEARDETA-SEQ-GERACAO END-EXEC. */
        ...
        {
            /*" -417- MOVE '0900' TO WNR-EXEC-SQL */
            _.Move("0900", WABEND.WNR_EXEC_SQL);

            /*" -534- PERFORM R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1 */

            R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1();

            /*" -536- PERFORM R0900_00_DECLARA_SIARDEVC_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -540- DISPLAY 'PROBLEMAS NO OPEN SIARDEVC' */
        ...
        public void R0900_00_DECLARA_SIARDEVC_DB_DECLARE_1()
        {
            ...
            string GetQuery_C01_SIARDEVC()
            {
                var query = @$"SELECT A.NOM_ARQUIVO
							...
							, 0)
							, 
							VALUE(A.NUM_SINISTRO_CONV
							, ' ' )
							, 
							VALUE(A.NUM_IDENT_CONV
							, 0)
							, 
							VALUE(A.NUM_IDE_COBR_CONV
							, 0)
							, 
							VALUE(A.COD_CFOP
							, 0)
        ...
        {
            /*" -536- EXEC SQL OPEN C01_SIARDEVC END-EXEC. */
        ...
        {
            /*" -550- MOVE '0910' TO WNR-EXEC-SQL. */
            _.Move("0910", WABEND.WNR_EXEC_SQL);

            /*" -652- PERFORM R0910_00_LE_SIARDEVC_DB_FETCH_1 */

            R0910_00_LE_SIARDEVC_DB_FETCH_1();

            /*" -655- IF SQLCODE EQUAL ZEROS */

            if (DB.SQLCODE == 00)
            {

                /*" -656- ADD 1 TO AC-L-SIARDEVC */
            ...
            else
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -659- MOVE 'S' TO WFIM-SIARDEVC */
                    _.Move("S", WFIM_SIARDEVC);

                    /*" -659- PERFORM R0910_00_LE_SIARDEVC_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -662- DISPLAY 'PROBLEMAS NO FETCH SIARDEVC' */
        ...
        {
            /*" -659- EXEC SQL CLOSE C01_SIARDEVC END-EXEC */
        ...
        {
            /*" -672- MOVE '1000' TO WNR-EXEC-SQL */
            _.Move("1000", WABEND.WNR_EXEC_SQL);

            /*" -673- IF SIARDEVC-COD-ERRO NOT EQUAL ZEROS */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_COD_ERRO != 00)
            {

                /*" -674- PERFORM R1100-00-LE-SIERRO */
        ...
        {
            /*" -689- PERFORM R0910-00-LE-SIARDEVC. */
        ...
        {
            /*" -699- MOVE '1100' TO WNR-EXEC-SQL */
            _.Move("1100", WABEND.WNR_EXEC_SQL);

            /*" -704- PERFORM R1100_00_LE_SIERRO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -713- DISPLAY 'ERRO SELECT SI_ERRO' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-COD-ERRO */
        ...
        {
            /*" -704- EXEC SQL SELECT DES_ERRO INTO :SIERRO-DES-ERRO FROM SEGUROS.SI_ERRO WHERE COD_ERRO = :SIARDEVC-COD-ERRO END-EXEC. */
        ...
        {
            /*" -723- MOVE '1200' TO WNR-EXEC-SQL */
            _.Move("1200", WABEND.WNR_EXEC_SQL);

            /*" -725- INITIALIZE REG-SCMOVSIN */
            _.Initialize(
                REG_SCMOVSIN
            );

            /*" -728- IF SIARDEVC-NUM-APOL-SINISTRO EQUAL ZEROS */

            if (SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_APOL_SINISTRO == 00)
            {

                /*" -729- MOVE ZEROS TO DET-NUM-PROTOCOLO-SINI */
        ...
        {
            /*" -972- MOVE '1210' TO WNR-EXEC-SQL */
            _.Move("1210", WABEND.WNR_EXEC_SQL);

            /*" -979- PERFORM R1210_00_LE_SINISMES_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -984- MOVE ZEROS TO SINISMES-COD-FONTE SINISMES-NUM-PROTOCOLO-SINI */
            ...
            else
            {
                ...
                if (DB.SQLCODE != 00)
                {
                    ...
                    /*" -992- DISPLAY 'ERRO SELECT SINISTRO_MESTRE' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO ' ' SIARDEVC-NUM-APOL-SINISTRO */
        ...
        {
            /*" -979- EXEC SQL SELECT COD_FONTE, NUM_PROTOCOLO_SINI INTO :SINISMES-COD-FONTE, :SINISMES-NUM-PROTOCOLO-SINI FROM SEGUROS.SINISTRO_MESTRE WHERE NUM_APOL_SINISTRO = :SIARDEVC-NUM-APOL-SINISTRO END-EXEC. */
        ...
        {
            /*" -1002- MOVE '1300' TO WNR-EXEC-SQL. */
            _.Move("1300", WABEND.WNR_EXEC_SQL);

            /*" -1020- PERFORM R1300_00_INCLUI_SIARREVC_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1032- DISPLAY 'PROBLEMAS NO INSERT SI_AR_RETORNO_VC' ' ' GEARDETA-NOM-ARQUIVO ' ' GEARDETA-SEQ-GERACAO ' ' SIARREVC-TIPO-REGISTRO-VC ' ' SIARREVC-SEQ-REGISTRO-VC ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
        ...
        {
            /*" -1044- MOVE '1400' TO WNR-EXEC-SQL */
            _.Move("1400", WABEND.WNR_EXEC_SQL);

            /*" -1054- PERFORM R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1062- DISPLAY 'PROBLEMAS NO UPDATE SI_AR_DETALHE_VC' ' ' SIARDEVC-NOM-ARQUIVO ' ' SIARDEVC-SEQ-GERACAO ' ' SIARDEVC-TIPO-REGISTRO ' ' SIARDEVC-SEQ-REGISTRO */
        ...
        {
            /*" -1054- EXEC SQL UPDATE SEGUROS.SI_AR_DETALHE_VC SET STA_PROCESSAMENTO = '4' WHERE NOM_ARQUIVO = :SIARDEVC-NOM-ARQUIVO AND SEQ_GERACAO = :SIARDEVC-SEQ-GERACAO AND TIPO_REGISTRO = :SIARDEVC-TIPO-REGISTRO AND SEQ_REGISTRO = :SIARDEVC-SEQ-REGISTRO AND STA_RETORNO = '2' AND STA_PROCESSAMENTO = '3' END-EXEC. */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1077- DISPLAY '*     SI9269B - CANCELADO      *' */
            _.Display($"*     SI9269B - CANCELADO      *");

            /*" -1079- DISPLAY '********************************' */
            _.Display($"********************************");

            /*" -1080- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, WABEND.WSQLCODE);

            /*" -1082- DISPLAY WABEND */
            _.Display(WABEND);

            /*" -1082- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1086- MOVE 99 TO RETURN-CODE */
