...
using Dclgens;
using Copies;
using Sias.Sinistro.DB2.SI0844B;

namespace Code
{
    public class SI0844B
    {
        ...
        /*"      *----------------------------------------------------------------*      */
        /*"      *   FUNCAO .................  RELACAO DE SALVADOS PENDENTES ATE' *      */
        /*"      *                             O MES-REF/ANO-REF.                 *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      * TABELA                              VIEW              ACESSO   *      */
        /*"      * ----------------------------------- ----------------- -------- *      */
        ...
        public FileBasis _RSI0844B { get; set; } = new FileBasis(new PIC("X", "0", "X(0)"));

        public FileBasis RSI0844B
        {
            get
            {
                _.Move(REG_SI0844B, _RSI0844B); VarBasis.RedefinePassValue(REG_SI0844B, _RSI0844B, REG_SI0844B); return _RSI0844B;
            }
        }
        /*"01              REG-SI0844B.*/
        public SI0844B_REG_SI0844B REG_SI0844B { get; set; } = new SI0844B_REG_SI0844B();
        public class SI0844B_REG_SI0844B : VarBasis
        {
        ...
        /*"01              AREA-DE-WORK.*/
        public SI0844B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new SI0844B_AREA_DE_WORK();
        public class SI0844B_AREA_DE_WORK : VarBasis
        {
            ...
            private _REDEF_SI0844B_FILLER_1 _filler_1 { get; set; }
            public _REDEF_SI0844B_FILLER_1 FILLER_1
            {
                get { _filler_1 = new _REDEF_SI0844B_FILLER_1(); _.Move(WCODRELAT, _filler_1); VarBasis.RedefinePassValue(WCODRELAT, _filler_1, WCODRELAT); _filler_1.ValueChanged += () => { _.Move(_filler_1, WCODRELAT); }; return _filler_1; }
                set { VarBasis.RedefinePassValue(value, _filler_1, WCODRELAT); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_1 : VarBasis
            {
                /*"    10          WNOME-PROGRAMA.*/
                public SI0844B_WNOME_PROGRAMA WNOME_PROGRAMA { get; set; } = new SI0844B_WNOME_PROGRAMA();
                public class SI0844B_WNOME_PROGRAMA : VarBasis
                {
                ...
                public _REDEF_SI0844B_FILLER_1()
                {
            ...
            private _REDEF_SI0844B_FILLER_2 _filler_2 { get; set; }
            public _REDEF_SI0844B_FILLER_2 FILLER_2
            {
                get { _filler_2 = new _REDEF_SI0844B_FILLER_2(); _.Move(WTIME_DAY, _filler_2); VarBasis.RedefinePassValue(WTIME_DAY, _filler_2, WTIME_DAY); _filler_2.ValueChanged += () => { _.Move(_filler_2, WTIME_DAY); }; return _filler_2; }
                set { VarBasis.RedefinePassValue(value, _filler_2, WTIME_DAY); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_2 : VarBasis
            {
                /*"    10       WTIME-DAYR.*/
                public SI0844B_WTIME_DAYR WTIME_DAYR { get; set; } = new SI0844B_WTIME_DAYR();
                public class SI0844B_WTIME_DAYR : VarBasis
                {
                ...
                public _REDEF_SI0844B_FILLER_2()
                {
            ...
            public SI0844B_WDATA_CURR WDATA_CURR { get; set; } = new SI0844B_WDATA_CURR();
            public class SI0844B_WDATA_CURR : VarBasis
            {
            ...
            public SI0844B_WHORA_CURR WHORA_CURR { get; set; } = new SI0844B_WHORA_CURR();
            public class SI0844B_WHORA_CURR : VarBasis
            {
            ...
            public SI0844B_WDATA_CABEC WDATA_CABEC { get; set; } = new SI0844B_WDATA_CABEC();
            public class SI0844B_WDATA_CABEC : VarBasis
            {
            ...
            public SI0844B_WHORA_CABEC WHORA_CABEC { get; set; } = new SI0844B_WHORA_CABEC();
            public class SI0844B_WHORA_CABEC : VarBasis
            {
            ...
            private _REDEF_SI0844B_FILLER_9 _filler_9 { get; set; }
            public _REDEF_SI0844B_FILLER_9 FILLER_9
            {
                get { _filler_9 = new _REDEF_SI0844B_FILLER_9(); _.Move(WDATA_DTMOVTO, _filler_9); VarBasis.RedefinePassValue(WDATA_DTMOVTO, _filler_9, WDATA_DTMOVTO); _filler_9.ValueChanged += () => { _.Move(_filler_9, WDATA_DTMOVTO); }; return _filler_9; }
                set { VarBasis.RedefinePassValue(value, _filler_9, WDATA_DTMOVTO); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_9 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_9()
                {
            ...
            private _REDEF_SI0844B_FILLER_12 _filler_12 { get; set; }
            public _REDEF_SI0844B_FILLER_12 FILLER_12
            {
                get { _filler_12 = new _REDEF_SI0844B_FILLER_12(); _.Move(WDATA_INIVIG, _filler_12); VarBasis.RedefinePassValue(WDATA_INIVIG, _filler_12, WDATA_INIVIG); _filler_12.ValueChanged += () => { _.Move(_filler_12, WDATA_INIVIG); }; return _filler_12; }
                set { VarBasis.RedefinePassValue(value, _filler_12, WDATA_INIVIG); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_12 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_12()
                {
            ...
            private _REDEF_SI0844B_FILLER_15 _filler_15 { get; set; }
            public _REDEF_SI0844B_FILLER_15 FILLER_15
            {
                get { _filler_15 = new _REDEF_SI0844B_FILLER_15(); _.Move(WDATA_TERVIG, _filler_15); VarBasis.RedefinePassValue(WDATA_TERVIG, _filler_15, WDATA_TERVIG); _filler_15.ValueChanged += () => { _.Move(_filler_15, WDATA_TERVIG); }; return _filler_15; }
                set { VarBasis.RedefinePassValue(value, _filler_15, WDATA_TERVIG); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_15 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_15()
                {
            ...
            private _REDEF_SI0844B_FILLER_18 _filler_18 { get; set; }
            public _REDEF_SI0844B_FILLER_18 FILLER_18
            {
                get { _filler_18 = new _REDEF_SI0844B_FILLER_18(); _.Move(WDATA_REL, _filler_18); VarBasis.RedefinePassValue(WDATA_REL, _filler_18, WDATA_REL); _filler_18.ValueChanged += () => { _.Move(_filler_18, WDATA_REL); }; return _filler_18; }
                set { VarBasis.RedefinePassValue(value, _filler_18, WDATA_REL); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_18 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_18()
                {
            ...
            public SI0844B_WDAT_REL_LIT WDAT_REL_LIT { get; set; } = new SI0844B_WDAT_REL_LIT();
            public class SI0844B_WDAT_REL_LIT : VarBasis
            {
            ...
            private _REDEF_SI0844B_FILLER_23 _filler_23 { get; set; }
            public _REDEF_SI0844B_FILLER_23 FILLER_23
            {
                get { _filler_23 = new _REDEF_SI0844B_FILLER_23(); _.Move(WREFE_REFERENCIA, _filler_23); VarBasis.RedefinePassValue(WREFE_REFERENCIA, _filler_23, WREFE_REFERENCIA); _filler_23.ValueChanged += () => { _.Move(_filler_23, WREFE_REFERENCIA); }; return _filler_23; }
                set { VarBasis.RedefinePassValue(value, _filler_23, WREFE_REFERENCIA); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_23 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_23()
                {
            ...
            private _REDEF_SI0844B_FILLER_26 _filler_26 { get; set; }
            public _REDEF_SI0844B_FILLER_26 FILLER_26
            {
                get { _filler_26 = new _REDEF_SI0844B_FILLER_26(); _.Move(WDATA_SISTEMA, _filler_26); VarBasis.RedefinePassValue(WDATA_SISTEMA, _filler_26, WDATA_SISTEMA); _filler_26.ValueChanged += () => { _.Move(_filler_26, WDATA_SISTEMA); }; return _filler_26; }
                set { VarBasis.RedefinePassValue(value, _filler_26, WDATA_SISTEMA); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_26 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_26()
                {
            ...
            private _REDEF_SI0844B_FILLER_29 _filler_29 { get; set; }
            public _REDEF_SI0844B_FILLER_29 FILLER_29
            {
                get { _filler_29 = new _REDEF_SI0844B_FILLER_29(); _.Move(WSIST_DATA, _filler_29); VarBasis.RedefinePassValue(WSIST_DATA, _filler_29, WSIST_DATA); _filler_29.ValueChanged += () => { _.Move(_filler_29, WSIST_DATA); }; return _filler_29; }
                set { VarBasis.RedefinePassValue(value, _filler_29, WSIST_DATA); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_29 : VarBasis
            {
                /*"    10       WSIST-ANOMES.*/
                public SI0844B_WSIST_ANOMES WSIST_ANOMES { get; set; } = new SI0844B_WSIST_ANOMES();
                public class SI0844B_WSIST_ANOMES : VarBasis
                {
                ...
                public _REDEF_SI0844B_FILLER_29()
                {
            ...
            private _REDEF_SI0844B_FILLER_32 _filler_32 { get; set; }
            public _REDEF_SI0844B_FILLER_32 FILLER_32
            {
                get { _filler_32 = new _REDEF_SI0844B_FILLER_32(); _.Move(WDTMOVTO, _filler_32); VarBasis.RedefinePassValue(WDTMOVTO, _filler_32, WDTMOVTO); _filler_32.ValueChanged += () => { _.Move(_filler_32, WDTMOVTO); }; return _filler_32; }
                set { VarBasis.RedefinePassValue(value, _filler_32, WDTMOVTO); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_32 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_32()
                {
            ...
            public SI0844B_LC01 LC01 { get; set; } = new SI0844B_LC01();
            public class SI0844B_LC01 : VarBasis
            {
                /*"    10          LC01-RELATORIO  PIC  X(010) VALUE 'SI0844B.1'.*/
                public StringBasis LC01_RELATORIO { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"SI0844B.1");
            ...
            public SI0844B_LC02 LC02 { get; set; } = new SI0844B_LC02();
            public class SI0844B_LC02 : VarBasis
            {
            ...
            public SI0844B_LC03 LC03 { get; set; } = new SI0844B_LC03();
            public class SI0844B_LC03 : VarBasis
            {
                /*"    10          FILLER          PIC  X(029) VALUE   SPACES.*/
                public StringBasis FILLER_40 { get; set; } = new StringBasis(new PIC("X", "29", "X(029)"), @"");
                /*"    10          FILLER          PIC  X(051) VALUE    '               RELACAO DE SALVADOS PENDENTES ATE: '.*/
                public StringBasis FILLER_41 { get; set; } = new StringBasis(new PIC("X", "51", "X(051)"), @"               RELACAO DE SALVADOS PENDENTES ATE: ");
            ...
            public SI0844B_LC04 LC04 { get; set; } = new SI0844B_LC04();
            public class SI0844B_LC04 : VarBasis
            {
            ...
            public SI0844B_LC05 LC05 { get; set; } = new SI0844B_LC05();
            public class SI0844B_LC05 : VarBasis
            {
            ...
            public SI0844B_LC06 LC06 { get; set; } = new SI0844B_LC06();
            public class SI0844B_LC06 : VarBasis
            {
                /*"    10          FILLER          PIC  X(132) VALUE ALL '-'.*/
                public StringBasis FILLER_49 { get; set; } = new StringBasis(new PIC("X", "132", "X(132)"), @"ALL");
                /*"  05            LC07.*/
            }
            public SI0844B_LC07 LC07 { get; set; } = new SI0844B_LC07();
            public class SI0844B_LC07 : VarBasis
            {
                ...
                /*"    10          FILLER    PIC  X(011) VALUE 'VL.PROVISAO'.*/
                public StringBasis FILLER_58 { get; set; } = new StringBasis(new PIC("X", "11", "X(011)"), @"VL.PROVISAO");
                /*"    10          FILLER    PIC  X(002) VALUE SPACE.*/
            ...
            public SI0844B_LD01 LD01 { get; set; } = new SI0844B_LD01();
            public class SI0844B_LD01 : VarBasis
            {
            ...
            public SI0844B_LT01 LT01 { get; set; } = new SI0844B_LT01();
            public class SI0844B_LT01 : VarBasis
            {
            ...
            public SI0844B_TABELA_MESES TABELA_MESES { get; set; } = new SI0844B_TABELA_MESES();
            public class SI0844B_TABELA_MESES : VarBasis
            {
            ...
            private ListBasis<_REDEF_SI0844B_FILLER_85> _filler_85 { get; set; }
            public ListBasis<_REDEF_SI0844B_FILLER_85> FILLER_85
            {
                get { _filler_85 = new ListBasis<_REDEF_SI0844B_FILLER_85>(12); _.Move(TABELA_MESES, _filler_85); VarBasis.RedefinePassValue(TABELA_MESES, _filler_85, TABELA_MESES); _filler_85.ValueChanged += () => { _.Move(_filler_85, TABELA_MESES); }; return _filler_85; }
                set { VarBasis.RedefinePassValue(value, _filler_85, TABELA_MESES); }
            }  //Redefines
            public class _REDEF_SI0844B_FILLER_85 : VarBasis
            {
                ...
                public _REDEF_SI0844B_FILLER_85()
                {
            ...
            /*"  05        WABEND.*/
            public SI0844B_WABEND WABEND { get; set; } = new SI0844B_WABEND();
            public class SI0844B_WABEND : VarBasis
            {
                /*"    10      FILLER              PIC  X(010) VALUE           ' SI0844B'.*/
                public StringBasis FILLER_86 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" SI0844B");
        ...
        public SI0844B_LK_LINK LK_LINK { get; set; } = new SI0844B_LK_LINK();
        public class SI0844B_LK_LINK : VarBasis
        {
        ...
        public SI0844B_SINISTRO SINISTRO { get; set; } = new SI0844B_SINISTRO();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string RSI0844B_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                RSI0844B.SetFile(RSI0844B_FILE_NAME_P);
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -688- DISPLAY 'SI0844B - INICIO DE EXECUCAO ' WDATA-CABEC ' ' WHORA-CABEC */

            $"SI0844B - INICIO DE EXECUCAO {AREA_DE_WORK.WDATA_CABEC} {AREA_DE_WORK.WHORA_CABEC}"
            .Display();
            ...
            /*" -728- WRITE REG-SI0844B FROM LT01 AFTER 2. */
            _.Move(AREA_DE_WORK.LT01.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());
        ...
        private void R0000_90_ENCERRA(bool isPerform = false)
        {
            ...
            if (AREA_DE_WORK.WCH_FINAL.IsEmpty())
            {
                ...
                /*" -756- DISPLAY 'SI0844B - FIM NORMAL ' WDATA-CABEC ' ' WHORA-CABEC */

                $"SI0844B - FIM NORMAL {AREA_DE_WORK.WDATA_CABEC} {AREA_DE_WORK.WHORA_CABEC}"
                .Display();
            ...
            else
            {
                ...
                /*" -761- DISPLAY 'SI0844B - ENCERRADO COM PROBLEMAS ' WDATA-CABEC ' ' WHORA-CABEC. */

                $"SI0844B - ENCERRADO COM PROBLEMAS {AREA_DE_WORK.WDATA_CABEC} {AREA_DE_WORK.WHORA_CABEC}"
                .Display();
            }
        ...
        private void R0150_00_SELECT_V1RELATORIOS_SECTION()
        {
            ...
            /*" -860- MOVE WSIST-DATA TO WDATA-SISTEMA V1SIST-DTMOVABE. */
            _.Move(AREA_DE_WORK.WSIST_DATA, AREA_DE_WORK.WDATA_SISTEMA, V1SIST_DTMOVABE);

            /*" -860- DISPLAY ' DATA FINAL DE SELECAO: ' V1SIST-DTMOVABE. */
            _.Display($" DATA FINAL DE SELECAO: {V1SIST_DTMOVABE}");
        ...
        {
            /*" -813- EXEC SQL SELECT CODRELAT, MES_REFERENCIA, ANO_REFERENCIA INTO :V1RELA-CODRELAT, :V1RELA-MES-REFER, :V1RELA-ANO-REFER FROM SEGUROS.V1RELATORIOS WHERE CODRELAT = 'SI0844B1' AND SITUACAO = '0' END-EXEC. */
        ...
        {
            /*" -874- MOVE '040' TO WNR-EXEC-SQL. */
            _.Move("040", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -875- MOVE V1SIST-DTCURRENT TO WDATA-CURR */
            _.Move(V1SIST_DTCURRENT, AREA_DE_WORK.WDATA_CURR);

            /*" -876- MOVE WDATA-DD-CURR TO WDATA-DD-CABEC */
            _.Move(AREA_DE_WORK.WDATA_CURR.WDATA_DD_CURR, AREA_DE_WORK.WDATA_CABEC.WDATA_DD_CABEC);

            /*" -877- MOVE WDATA-MM-CURR TO WDATA-MM-CABEC */
            _.Move(AREA_DE_WORK.WDATA_CURR.WDATA_MM_CURR, AREA_DE_WORK.WDATA_CABEC.WDATA_MM_CABEC);

            /*" -878- MOVE WDATA-AA-CURR TO WDATA-AA-CABEC */
            _.Move(AREA_DE_WORK.WDATA_CURR.WDATA_AA_CURR, AREA_DE_WORK.WDATA_CABEC.WDATA_AA_CABEC);

            /*" -880- MOVE WDATA-CABEC TO LC02-DATA */
            _.Move(AREA_DE_WORK.WDATA_CABEC, AREA_DE_WORK.LC02.LC02_DATA);

            /*" -881- ACCEPT WHORA-CURR FROM TIME */
            _.Move(_.AcceptDate("TIME"), AREA_DE_WORK.WHORA_CURR);

            /*" -882- MOVE WHORA-HH-CURR TO WHORA-HH-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_HH_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_HH_CABEC);

            /*" -883- MOVE WHORA-MM-CURR TO WHORA-MM-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_MM_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_MM_CABEC);

            /*" -884- MOVE WHORA-SS-CURR TO WHORA-SS-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_SS_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_SS_CABEC);

            /*" -886- MOVE WHORA-CABEC TO LC03-HORA */
            _.Move(AREA_DE_WORK.WHORA_CABEC, AREA_DE_WORK.LC03.LC03_HORA);

            /*" -887- MOVE TAB-MES(V1RELA-MES-REFER) TO LC03-MES */
            _.Move(AREA_DE_WORK.FILLER_85[V1RELA_MES_REFER].TAB_MES, AREA_DE_WORK.LC03.LC03_MES);

            /*" -889- MOVE V1RELA-ANO-REFER TO LC03-ANO */
            _.Move(V1RELA_ANO_REFER, AREA_DE_WORK.LC03.LC03_ANO);

            /*" -893- PERFORM R0400_00_MONTA_CABECALHO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -898- DISPLAY 'EMPRESA NAO CADASTRADA' */
                    _.Display($"EMPRESA NAO CADASTRADA");

                    /*" -899- MOVE 'S' TO WFIM-FECHAMENTO */
                    _.Move("S", AREA_DE_WORK.WFIM_FECHAMENTO);

                    /*" -900- GO TO R0400-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -902- DISPLAY 'PROBLEMAS ACESSO V1EMPRESA' */
            ...
            /*" -906- ADD 1 TO AC-S-V1EMPRESA */
            AREA_DE_WORK.AC_S_V1EMPRESA.Value = AREA_DE_WORK.AC_S_V1EMPRESA + 1;

            /*" -907- MOVE V1EMPR-NOM-EMP TO LK-TITULO */
            _.Move(V1EMPR_NOM_EMP, LK_LINK.LK_TITULO);

            /*" -909- CALL 'PROALN01' USING LK-LINK */
            _.Call("PROALN01", LK_LINK);

            /*" -910- IF LK-RTCODE EQUAL ZEROS */

            if (LK_LINK.LK_RTCODE == 00)
            {

                /*" -911- MOVE LK-TITULO TO LC01-EMPRESA */
            ...
            else
            {
                ...
                /*" -913- DISPLAY 'PROBLEMA CALL V1EMPRESA' */
        ...
        {
            /*" -893- EXEC SQL SELECT NOME_EMPRESA INTO :V1EMPR-NOM-EMP FROM SEGUROS.V1EMPRESA WHERE COD_EMPRESA = 0 END-EXEC. */
        ...
        {
            /*" -928- MOVE '080' TO WNR-EXEC-SQL. */
            _.Move("080", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -932- PERFORM R0800_00_DELETE_V0RELATORIOS_DB_DELETE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -936- DISPLAY 'PROBLEMAS DELETE V0RELATORIOS ... ' */
        ...
        {
            /*" -932- EXEC SQL DELETE FROM SEGUROS.V0RELATORIOS WHERE CODRELAT = :V1RELA-CODRELAT AND SITUACAO = '0' END-EXEC. */
        ...
        {
            /*" -951- MOVE '090' TO WNR-EXEC-SQL. */
            _.Move("090", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -971- PERFORM R0900_00_DECLARE_SINISTRO_DB_DECLARE_1 */

            R0900_00_DECLARE_SINISTRO_DB_DECLARE_1();

            /*" -973- PERFORM R0900_00_DECLARE_SINISTRO_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -977- DISPLAY 'PROBLEMAS DECLARE SINISTRO ... ' */
        ...
        {
            /*" -971- EXEC SQL DECLARE SINISTRO CURSOR FOR SELECT A.NUM_APOLICE, B.DTMOVTO, B.NUM_APOL_SINISTRO, A.RAMO, A.FONTE, A.CODCAU, B.VAL_OPERACAO, B.CODUSU FROM SEGUROS.V0MESTSINI A, SEGUROS.V0HISTSINI B WHERE A.NUM_APOL_SINISTRO = B.NUM_APOL_SINISTRO AND A.INDSVD = 'S' AND A.TIPREG = '1' AND A.SITUACAO <> '2' AND B.SITUACAO = '0' AND B.TIPREG = '1' AND B.OPERACAO = 5000 AND B.DTMOVTO <= :V1SIST-DTMOVABE ORDER BY A.RAMO,B.DTMOVTO END-EXEC. */
            SINISTRO = new SI0844B_SINISTRO(true);
        ...
        {
            /*" -973- EXEC SQL OPEN SINISTRO END-EXEC. */
        ...
        {
            /*" -990- MOVE '091' TO WNR-EXEC-SQL. */
            _.Move("091", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1000- PERFORM R0910_00_FETCH_SINISTRO_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1005- MOVE 'S' TO WFIM-SINISTRO */
                    _.Move("S", AREA_DE_WORK.WFIM_SINISTRO);

                    /*" -1006- MOVE HIGH-VALUES TO WFIM-PROCESSO */

                    AREA_DE_WORK.WFIM_PROCESSO.IsHighValues = true;

                    /*" -1007- MOVE 9999 TO CH-RAMOS-ATU */
                    _.Move(9999, AREA_DE_WORK.CH_RAMOS_ATU);

                    /*" -1007- PERFORM R0910_00_FETCH_SINISTRO_DB_CLOSE_1 */

                    R0910_00_FETCH_SINISTRO_DB_CLOSE_1();

                    /*" -1009- GO TO R0910-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -1011- DISPLAY 'PROBLEMAS FETCH SINISTRO ... ' */
            ...
            /*" -1015- MOVE V1MSIN-RAMO TO CH-RAMOS-ATU */
            _.Move(V1MSIN_RAMO, AREA_DE_WORK.CH_RAMOS_ATU);

            /*" -1015- ADD 1 TO AC-S-SINISTRO. */
        ...
        {
            /*" -1000- EXEC SQL FETCH SINISTRO INTO :V1MSIN-NUM-APOL, :V1HSIN-DTMOVTO, :V1HSIN-NUM-SINI, :V1MSIN-RAMO, :V1MSIN-FONTE, :V1MSIN-CODCAU, :V1HSIN-VAL-OPERACAO, :V1HSIN-CODUSU END-EXEC. */
        ...
        {
            /*" -1007- EXEC SQL CLOSE SINISTRO END-EXEC */
        ...
        {
            /*" -1027- MOVE CH-RAMOS-ATU TO CH-RAMOS-ANT */
            _.Move(AREA_DE_WORK.CH_RAMOS_ATU, AREA_DE_WORK.CH_RAMOS_ANT);

            /*" -1029- PERFORM R4000-00-CABECALHOS. */

            R4000_00_CABECALHOS_SECTION();

            /*" -1035- PERFORM R1200-00-PROCESSA-RAMO UNTIL CH-RAMOS-ATU NOT EQUAL CH-RAMOS-ANT OR WFIM-SINISTRO NOT EQUAL SPACES. */
            ...
            /*" -1036- MOVE AC-VALTOT-RAM TO LT01-VALOR */
            _.Move(AREA_DE_WORK.AC_VALTOT_RAM, AREA_DE_WORK.LT01.LT01_VALOR);

            /*" -1038- MOVE 'TOTAL RAMO:  ' TO LT01-TOT */
            _.Move("TOTAL RAMO:  ", AREA_DE_WORK.LT01.LT01_TOT);

            /*" -1039- ADD +2 TO AC-LINHAS */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + +2;

            /*" -1040- IF AC-LINHAS GREATER +52 */

            if (AREA_DE_WORK.AC_LINHAS > +52)
            {

                /*" -1042- PERFORM R4000-00-CABECALHOS. */

                R4000_00_CABECALHOS_SECTION();
            }


            /*" -1046- WRITE REG-SI0844B FROM LT01 AFTER 2. */
            _.Move(AREA_DE_WORK.LT01.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());

            /*" -1047- ADD AC-VALTOT-RAM TO AC-VALTOT-GER. */
            AREA_DE_WORK.AC_VALTOT_GER.Value = AREA_DE_WORK.AC_VALTOT_GER + AREA_DE_WORK.AC_VALTOT_RAM;

            /*" -1047- MOVE ZEROS TO AC-VALTOT-RAM. */
        ...
        {
            /*" -1095- MOVE '220' TO WNR-EXEC-SQL. */
            _.Move("220", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1101- PERFORM R2200_00_SELECT_V1RAMO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1104- MOVE ALL 'X' TO V1RAMO-NOMERAMO. */
        ...
        {
            /*" -1101- EXEC SQL SELECT NOMERAMO INTO :V1RAMO-NOMERAMO FROM SEGUROS.V1RAMO WHERE RAMO = :HOST-RAMO AND MODALIDA = 0 END-EXEC. */
        ...
        private void R2300_00_SELECT_V1SINICAUSA_SECTION()
        {
            ...
            /*" -1120- PERFORM R2300_00_SELECT_V1SINICAUSA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1123- MOVE ALL 'X' TO V1SCAU-DESCAU. */
        ...
        {
            /*" -1120- EXEC SQL SELECT DESCAU INTO :V1SCAU-DESCAU FROM SEGUROS.V1SINICAUSA WHERE CODCAU = :V1MSIN-CODCAU AND RAMO = :V1MSIN-RAMO END-EXEC. */
        ...
        {
            /*" -1133- MOVE '240' TO WNR-EXEC-SQL. */
            _.Move("240", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1138- PERFORM R2400_00_SELECT_V1APOLICE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1141- MOVE ALL 'X' TO V1APOL-NOME. */
        ...
        {
            /*" -1138- EXEC SQL SELECT NOME INTO :V1APOL-NOME FROM SEGUROS.V1APOLICE WHERE NUM_APOLICE = :V1MSIN-NUM-APOL END-EXEC. */
        ...
        {
            /*" -1154- MOVE '300' TO WNR-EXEC-SQL. */
            _.Move("300", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1155- ADD 1 TO AC-PAGINA */
            AREA_DE_WORK.AC_PAGINA.Value = AREA_DE_WORK.AC_PAGINA + 1;

            /*" -1156- MOVE AC-PAGINA TO LC01-PAGINA */
            _.Move(AREA_DE_WORK.AC_PAGINA, AREA_DE_WORK.LC01.LC01_PAGINA);

            /*" -1160- MOVE +9 TO AC-LINHAS */
            _.Move(+9, AREA_DE_WORK.AC_LINHAS);

            /*" -1161- MOVE CH-RAMOS-ANT TO HOST-RAMO */
            _.Move(AREA_DE_WORK.CH_RAMOS_ANT, HOST_RAMO);

            /*" -1162- PERFORM R2200-00-SELECT-V1RAMO */

            R2200_00_SELECT_V1RAMO_SECTION();

            /*" -1163- MOVE CH-RAMOS-ANT TO LC05-CODRAMO */
            _.Move(AREA_DE_WORK.CH_RAMOS_ANT, AREA_DE_WORK.LC05.LC05_CODRAMO);

            /*" -1165- MOVE V1RAMO-NOMERAMO TO LC05-NOMRAMO */
            _.Move(V1RAMO_NOMERAMO, AREA_DE_WORK.LC05.LC05_NOMRAMO);

            /*" -1166- WRITE REG-SI0844B FROM LC01 AFTER PAGE */
            _.Move(AREA_DE_WORK.LC01.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());

            /*" -1167- WRITE REG-SI0844B FROM LC02 */
            _.Move(AREA_DE_WORK.LC02.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());

            /*" -1169- WRITE REG-SI0844B FROM LC03 */
            _.Move(AREA_DE_WORK.LC03.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());

            /*" -1170- WRITE REG-SI0844B FROM LC05 AFTER 2. */
            _.Move(AREA_DE_WORK.LC05.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());

            /*" -1171- WRITE REG-SI0844B FROM LC06 */
            _.Move(AREA_DE_WORK.LC06.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());

            /*" -1172- WRITE REG-SI0844B FROM LC07 */
            _.Move(AREA_DE_WORK.LC07.GetMoveValues(), REG_SI0844B);

            RSI0844B.Write(REG_SI0844B.GetMoveValues().ToString());

            /*" -1172- WRITE REG-SI0844B FROM LC06. */
            _.Move(AREA_DE_WORK.LC06.GetMoveValues(), REG_SI0844B);
        ...
        {
            /*" -1183- OPEN OUTPUT RSI0844B. */
            RSI0844B.Open(REG_SI0844B);
