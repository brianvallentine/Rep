...
using Dclgens;
using Copies;
using Sias.Sinistro.DB2.SI0845B;

namespace Code
{
    public class SI0845B
    {
        ...
        /*"      *----------------------------------------------------------------*      */
        /*"      *   FUNCAO .................  RELACAO DE SALVADOS VENDIDOS EM    *      */
        /*"      *                             MES-REF/ANO-REF.                   *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      * TABELA                              VIEW              ACESSO   *      */
        /*"      * ----------------------------------- ----------------- -------- *      */
        ...
        /*"      * RAMOS E MODALIDADES                 V1RAMO            INPUT    *      */
        /*"      * HISTORICO DE SINISTRO               V1HISTSINI        INPUT    *      */
        /*"      * MESTRE DE SINISTRO                  V1MESTSINI        INPUT    *      */
        /*"      * CAUSAS DE SINISTROS                 V1SINICAUSA       INPUT    *      */
        /*"      * APOLICE                             V1APOLICE         INPUT    *      */
        /*"      *                                                                *      */
        /*"      * RECONVERSAO ANO 2000            CONSEDA4           11/09/1998  *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      * "DE PARA" DAS OPERACOES DE SINISTRO REFERENTES A SALVADOS      *      */
        /*"      *                                        PRODEXTER - 02/08/2005  *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *                                                                       */
        #endregion
        ...
        public FileBasis _RSI0845B { get; set; } = new FileBasis(new PIC("X", "0", "X(0)"));

        public FileBasis RSI0845B
        {
            get
            {
                _.Move(REG_SI0845B, _RSI0845B); VarBasis.RedefinePassValue(REG_SI0845B, _RSI0845B, REG_SI0845B); return _RSI0845B;
            }
        }
        /*"01              REG-SI0845B.*/
        public SI0845B_REG_SI0845B REG_SI0845B { get; set; } = new SI0845B_REG_SI0845B();
        public class SI0845B_REG_SI0845B : VarBasis
        {
        ...
        /*"77         HOST-RAMO           PIC S9(004)                COMP.*/
        public IntBasis HOST_RAMO { get; set; } = new IntBasis(new PIC("S9", "4", "S9(004)"));
        ...
        /*"01              AREA-DE-WORK.*/
        public SI0845B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new SI0845B_AREA_DE_WORK();
        public class SI0845B_AREA_DE_WORK : VarBasis
        {
            ...
            private _REDEF_SI0845B_FILLER_1 _filler_1 { get; set; }
            public _REDEF_SI0845B_FILLER_1 FILLER_1
            {
                get { _filler_1 = new _REDEF_SI0845B_FILLER_1(); _.Move(WCODRELAT, _filler_1); VarBasis.RedefinePassValue(WCODRELAT, _filler_1, WCODRELAT); _filler_1.ValueChanged += () => { _.Move(_filler_1, WCODRELAT); }; return _filler_1; }
                set { VarBasis.RedefinePassValue(value, _filler_1, WCODRELAT); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_1 : VarBasis
            {
                /*"    10          WNOME-PROGRAMA.*/
                public SI0845B_WNOME_PROGRAMA WNOME_PROGRAMA { get; set; } = new SI0845B_WNOME_PROGRAMA();
                public class SI0845B_WNOME_PROGRAMA : VarBasis
                {
                ...
                public _REDEF_SI0845B_FILLER_1()
                {
            ...
            /*"  05            CH-RAMOS-ATU     PIC  9(004).*/
            public IntBasis CH_RAMOS_ATU { get; set; } = new IntBasis(new PIC("9", "4", "9(004)."));
            /*"  05            CH-RAMOS-ANT     PIC  9(004).*/
            public IntBasis CH_RAMOS_ANT { get; set; } = new IntBasis(new PIC("9", "4", "9(004)."));
            /*"  05         WTIME-DAY         PIC  99.99.99.99.*/
            public IntBasis WTIME_DAY { get; set; } = new IntBasis(new PIC("9", "8", "99.99.99.99."));
            /*"  05         FILLER            REDEFINES      WTIME-DAY.*/
            private _REDEF_SI0845B_FILLER_2 _filler_2 { get; set; }
            public _REDEF_SI0845B_FILLER_2 FILLER_2
            {
                get { _filler_2 = new _REDEF_SI0845B_FILLER_2(); _.Move(WTIME_DAY, _filler_2); VarBasis.RedefinePassValue(WTIME_DAY, _filler_2, WTIME_DAY); _filler_2.ValueChanged += () => { _.Move(_filler_2, WTIME_DAY); }; return _filler_2; }
                set { VarBasis.RedefinePassValue(value, _filler_2, WTIME_DAY); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_2 : VarBasis
            {
                /*"    10       WTIME-DAYR.*/
                public SI0845B_WTIME_DAYR WTIME_DAYR { get; set; } = new SI0845B_WTIME_DAYR();
                public class SI0845B_WTIME_DAYR : VarBasis
                {
                ...
                public _REDEF_SI0845B_FILLER_2()
                {
            ...
            public SI0845B_WDATA_CURR WDATA_CURR { get; set; } = new SI0845B_WDATA_CURR();
            public class SI0845B_WDATA_CURR : VarBasis
            {
            ...
            public SI0845B_WHORA_CURR WHORA_CURR { get; set; } = new SI0845B_WHORA_CURR();
            public class SI0845B_WHORA_CURR : VarBasis
            {
            ...
            public SI0845B_WDATA_CABEC WDATA_CABEC { get; set; } = new SI0845B_WDATA_CABEC();
            public class SI0845B_WDATA_CABEC : VarBasis
            {
            ...
            public SI0845B_WHORA_CABEC WHORA_CABEC { get; set; } = new SI0845B_WHORA_CABEC();
            public class SI0845B_WHORA_CABEC : VarBasis
            {
            ...
            private _REDEF_SI0845B_FILLER_9 _filler_9 { get; set; }
            public _REDEF_SI0845B_FILLER_9 FILLER_9
            {
                get { _filler_9 = new _REDEF_SI0845B_FILLER_9(); _.Move(WDATA_DTMOVTO, _filler_9); VarBasis.RedefinePassValue(WDATA_DTMOVTO, _filler_9, WDATA_DTMOVTO); _filler_9.ValueChanged += () => { _.Move(_filler_9, WDATA_DTMOVTO); }; return _filler_9; }
                set { VarBasis.RedefinePassValue(value, _filler_9, WDATA_DTMOVTO); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_9 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_9()
                {
            ...
            private _REDEF_SI0845B_FILLER_12 _filler_12 { get; set; }
            public _REDEF_SI0845B_FILLER_12 FILLER_12
            {
                get { _filler_12 = new _REDEF_SI0845B_FILLER_12(); _.Move(WDATA_INIVIG, _filler_12); VarBasis.RedefinePassValue(WDATA_INIVIG, _filler_12, WDATA_INIVIG); _filler_12.ValueChanged += () => { _.Move(_filler_12, WDATA_INIVIG); }; return _filler_12; }
                set { VarBasis.RedefinePassValue(value, _filler_12, WDATA_INIVIG); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_12 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_12()
                {
            ...
            private _REDEF_SI0845B_FILLER_15 _filler_15 { get; set; }
            public _REDEF_SI0845B_FILLER_15 FILLER_15
            {
                get { _filler_15 = new _REDEF_SI0845B_FILLER_15(); _.Move(WDATA_TERVIG, _filler_15); VarBasis.RedefinePassValue(WDATA_TERVIG, _filler_15, WDATA_TERVIG); _filler_15.ValueChanged += () => { _.Move(_filler_15, WDATA_TERVIG); }; return _filler_15; }
                set { VarBasis.RedefinePassValue(value, _filler_15, WDATA_TERVIG); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_15 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_15()
                {
            ...
            private _REDEF_SI0845B_FILLER_18 _filler_18 { get; set; }
            public _REDEF_SI0845B_FILLER_18 FILLER_18
            {
                get { _filler_18 = new _REDEF_SI0845B_FILLER_18(); _.Move(WDATA_REL, _filler_18); VarBasis.RedefinePassValue(WDATA_REL, _filler_18, WDATA_REL); _filler_18.ValueChanged += () => { _.Move(_filler_18, WDATA_REL); }; return _filler_18; }
                set { VarBasis.RedefinePassValue(value, _filler_18, WDATA_REL); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_18 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_18()
                {
            ...
            public SI0845B_WDAT_REL_LIT WDAT_REL_LIT { get; set; } = new SI0845B_WDAT_REL_LIT();
            public class SI0845B_WDAT_REL_LIT : VarBasis
            {
            ...
            private _REDEF_SI0845B_FILLER_23 _filler_23 { get; set; }
            public _REDEF_SI0845B_FILLER_23 FILLER_23
            {
                get { _filler_23 = new _REDEF_SI0845B_FILLER_23(); _.Move(WREFE_REFERENCIA, _filler_23); VarBasis.RedefinePassValue(WREFE_REFERENCIA, _filler_23, WREFE_REFERENCIA); _filler_23.ValueChanged += () => { _.Move(_filler_23, WREFE_REFERENCIA); }; return _filler_23; }
                set { VarBasis.RedefinePassValue(value, _filler_23, WREFE_REFERENCIA); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_23 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_23()
                {
            ...
            private _REDEF_SI0845B_FILLER_26 _filler_26 { get; set; }
            public _REDEF_SI0845B_FILLER_26 FILLER_26
            {
                get { _filler_26 = new _REDEF_SI0845B_FILLER_26(); _.Move(WDATA_SISTEMA, _filler_26); VarBasis.RedefinePassValue(WDATA_SISTEMA, _filler_26, WDATA_SISTEMA); _filler_26.ValueChanged += () => { _.Move(_filler_26, WDATA_SISTEMA); }; return _filler_26; }
                set { VarBasis.RedefinePassValue(value, _filler_26, WDATA_SISTEMA); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_26 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_26()
                {
            ...
            private _REDEF_SI0845B_FILLER_29 _filler_29 { get; set; }
            public _REDEF_SI0845B_FILLER_29 FILLER_29
            {
                get { _filler_29 = new _REDEF_SI0845B_FILLER_29(); _.Move(WSIST_DATA, _filler_29); VarBasis.RedefinePassValue(WSIST_DATA, _filler_29, WSIST_DATA); _filler_29.ValueChanged += () => { _.Move(_filler_29, WSIST_DATA); }; return _filler_29; }
                set { VarBasis.RedefinePassValue(value, _filler_29, WSIST_DATA); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_29 : VarBasis
            {
                /*"    10       WSIST-ANOMES.*/
                public SI0845B_WSIST_ANOMES WSIST_ANOMES { get; set; } = new SI0845B_WSIST_ANOMES();
                public class SI0845B_WSIST_ANOMES : VarBasis
                {
                ...
                public _REDEF_SI0845B_FILLER_29()
                {
            ...
            private _REDEF_SI0845B_FILLER_32 _filler_32 { get; set; }
            public _REDEF_SI0845B_FILLER_32 FILLER_32
            {
                get { _filler_32 = new _REDEF_SI0845B_FILLER_32(); _.Move(WDTMOVTO, _filler_32); VarBasis.RedefinePassValue(WDTMOVTO, _filler_32, WDTMOVTO); _filler_32.ValueChanged += () => { _.Move(_filler_32, WDTMOVTO); }; return _filler_32; }
                set { VarBasis.RedefinePassValue(value, _filler_32, WDTMOVTO); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_32 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_32()
                {
            ...
            public SI0845B_LC01 LC01 { get; set; } = new SI0845B_LC01();
            public class SI0845B_LC01 : VarBasis
            {
                /*"    10          LC01-RELATORIO  PIC  X(010) VALUE 'SI0845B.1'.*/
                public StringBasis LC01_RELATORIO { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"SI0845B.1");
            ...
            public SI0845B_LC02 LC02 { get; set; } = new SI0845B_LC02();
            public class SI0845B_LC02 : VarBasis
            {
            ...
            public SI0845B_LC03 LC03 { get; set; } = new SI0845B_LC03();
            public class SI0845B_LC03 : VarBasis
            {
                /*"    10          FILLER          PIC  X(029) VALUE   SPACES.*/
                public StringBasis FILLER_40 { get; set; } = new StringBasis(new PIC("X", "29", "X(029)"), @"");
                /*"    10          FILLER          PIC  X(051) VALUE    '               RELACAO DE SALVADOS VENDIDOS  EM : '.*/
                public StringBasis FILLER_41 { get; set; } = new StringBasis(new PIC("X", "51", "X(051)"), @"               RELACAO DE SALVADOS VENDIDOS  EM : ");
            ...
            public SI0845B_LC04 LC04 { get; set; } = new SI0845B_LC04();
            public class SI0845B_LC04 : VarBasis
            {
            ...
            public SI0845B_LC05 LC05 { get; set; } = new SI0845B_LC05();
            public class SI0845B_LC05 : VarBasis
            {
                /*"    10          FILLER          PIC  X(008) VALUE 'RAMO  - '.*/
                public StringBasis FILLER_47 { get; set; } = new StringBasis(new PIC("X", "8", "X(008)"), @"RAMO  - ");
                /*"    10          LC05-CODRAMO    PIC  9(003) VALUE  ZEROS.*/
                public IntBasis LC05_CODRAMO { get; set; } = new IntBasis(new PIC("9", "3", "9(003)"));
                /*"    10          FILLER          PIC  X(003) VALUE ' - '.*/
                public StringBasis FILLER_48 { get; set; } = new StringBasis(new PIC("X", "3", "X(003)"), @" - ");
                /*"    10          LC05-NOMRAMO    PIC  X(040).*/
                public StringBasis LC05_NOMRAMO { get; set; } = new StringBasis(new PIC("X", "40", "X(040)."), @"");
                /*"  05            LC06.*/
            }
            public SI0845B_LC06 LC06 { get; set; } = new SI0845B_LC06();
            public class SI0845B_LC06 : VarBasis
            {
                /*"    10          FILLER          PIC  X(132) VALUE ALL '-'.*/
                public StringBasis FILLER_49 { get; set; } = new StringBasis(new PIC("X", "132", "X(132)"), @"ALL");
                /*"  05            LC07.*/
            }
            public SI0845B_LC07 LC07 { get; set; } = new SI0845B_LC07();
            public class SI0845B_LC07 : VarBasis
            {
                /*"    10          FILLER    PIC  X(011) VALUE 'DT.CADASTRO'.*/
                public StringBasis FILLER_50 { get; set; } = new StringBasis(new PIC("X", "11", "X(011)"), @"DT.CADASTRO");
                /*"    10          FILLER    PIC  X(004) VALUE SPACE.*/
                public StringBasis FILLER_51 { get; set; } = new StringBasis(new PIC("X", "4", "X(004)"), @"");
                /*"    10          FILLER    PIC  X(011) VALUE 'N. SINISTRO'.*/
                public StringBasis FILLER_52 { get; set; } = new StringBasis(new PIC("X", "11", "X(011)"), @"N. SINISTRO");
                /*"    10          FILLER    PIC  X(002) VALUE SPACE.*/
                public StringBasis FILLER_53 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"    10          FILLER    PIC  X(008) VALUE 'SEGURADO'.*/
                public StringBasis FILLER_54 { get; set; } = new StringBasis(new PIC("X", "8", "X(008)"), @"SEGURADO");
                /*"    10          FILLER    PIC  X(024) VALUE SPACES.*/
                public StringBasis FILLER_55 { get; set; } = new StringBasis(new PIC("X", "24", "X(024)"), @"");
                /*"    10          FILLER    PIC  X(005) VALUE 'CAUSA'.*/
                public StringBasis FILLER_56 { get; set; } = new StringBasis(new PIC("X", "5", "X(005)"), @"CAUSA");
                /*"    10          FILLER    PIC  X(031) VALUE SPACES.*/
                public StringBasis FILLER_57 { get; set; } = new StringBasis(new PIC("X", "31", "X(031)"), @"");
                /*"    10          FILLER    PIC  X(011) VALUE 'VALOR VENDA'.*/
                public StringBasis FILLER_58 { get; set; } = new StringBasis(new PIC("X", "11", "X(011)"), @"VALOR VENDA");
                /*"    10          FILLER    PIC  X(002) VALUE SPACE.*/
                public StringBasis FILLER_59 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"    10          FILLER    PIC  X(007) VALUE 'USUARIO'.*/
                public StringBasis FILLER_60 { get; set; } = new StringBasis(new PIC("X", "7", "X(007)"), @"USUARIO");
                /*"    10          FILLER    PIC  X(002) VALUE SPACES.*/
                public StringBasis FILLER_61 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"    10          FILLER    PIC  X(005) VALUE 'FONTE'.*/
                public StringBasis FILLER_62 { get; set; } = new StringBasis(new PIC("X", "5", "X(005)"), @"FONTE");
                /*"  05            LD01.*/
            }
            public SI0845B_LD01 LD01 { get; set; } = new SI0845B_LD01();
            public class SI0845B_LD01 : VarBasis
            {
                ...
                /*"    10          LD01-SEGURADO   PIC  X(030).*/
                public StringBasis LD01_SEGURADO { get; set; } = new StringBasis(new PIC("X", "30", "X(030)."), @"");
                /*"    10          FILLER          PIC  X(002) VALUE  SPACES.*/
                public StringBasis FILLER_68 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"    10          LD01-CAUSA      PIC  X(030).*/
                public StringBasis LD01_CAUSA { get; set; } = new StringBasis(new PIC("X", "30", "X(030)."), @"");
                /*"    10          FILLER          PIC  X(002) VALUE  SPACES.*/
                public StringBasis FILLER_69 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"    10          LD01-VALOR      PIC  ZZZZ.ZZZ.ZZ9,99.*/
                public DoubleBasis LD01_VALOR { get; set; } = new DoubleBasis(new PIC("9", "10", "ZZZZ.ZZZ.ZZ9V99."), 2);
                /*"    10          FILLER          PIC  X(002) VALUE  SPACES.*/
                public StringBasis FILLER_70 { get; set; } = new StringBasis(new PIC("X", "2", "X(002)"), @"");
                /*"    10          LD01-CODUSU     PIC  X(008).*/
                public StringBasis LD01_CODUSU { get; set; } = new StringBasis(new PIC("X", "8", "X(008)."), @"");
                /*"    10          FILLER          PIC  X(003) VALUE  SPACES.*/
                public StringBasis FILLER_71 { get; set; } = new StringBasis(new PIC("X", "3", "X(003)"), @"");
                /*"    10          LD01-FONTE      PIC  ZZ9.*/
                public IntBasis LD01_FONTE { get; set; } = new IntBasis(new PIC("9", "3", "ZZ9."));
                /*"  05            LT01.*/
            }
            public SI0845B_LT01 LT01 { get; set; } = new SI0845B_LT01();
            public class SI0845B_LT01 : VarBasis
            {
                /*"    10          FILLER     PIC  X(079) VALUE  SPACES.*/
                public StringBasis FILLER_72 { get; set; } = new StringBasis(new PIC("X", "79", "X(079)"), @"");
                /*"    10          LT01-TOT   PIC  X(013).*/
                public StringBasis LT01_TOT { get; set; } = new StringBasis(new PIC("X", "13", "X(013)."), @"");
                /*"    10          LT01-VALOR PIC  ZZZZ.ZZZ.ZZ9,99.*/
                public DoubleBasis LT01_VALOR { get; set; } = new DoubleBasis(new PIC("9", "10", "ZZZZ.ZZZ.ZZ9V99."), 2);
                /*"  05            TABELA-MESES.*/
            }
            public SI0845B_TABELA_MESES TABELA_MESES { get; set; } = new SI0845B_TABELA_MESES();
            public class SI0845B_TABELA_MESES : VarBasis
            {
                /*"    10          FILLER          PIC X(010)  VALUE '0  JANEIRO'.*/
                public StringBasis FILLER_73 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0  JANEIRO");
                /*"    10          FILLER          PIC X(010)  VALUE '0FEVEREIRO'.*/
                public StringBasis FILLER_74 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0FEVEREIRO");
                /*"    10          FILLER          PIC X(010)  VALUE '0    MARCO'.*/
                public StringBasis FILLER_75 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0    MARCO");
                /*"    10          FILLER          PIC X(010)  VALUE '0    ABRIL'.*/
                public StringBasis FILLER_76 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0    ABRIL");
                /*"    10          FILLER          PIC X(010)  VALUE '0     MAIO'.*/
                public StringBasis FILLER_77 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0     MAIO");
                /*"    10          FILLER          PIC X(010)  VALUE '0    JUNHO'.*/
                public StringBasis FILLER_78 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0    JUNHO");
                /*"    10          FILLER          PIC X(010)  VALUE '0    JULHO'.*/
                public StringBasis FILLER_79 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0    JULHO");
                /*"    10          FILLER          PIC X(010)  VALUE '0   AGOSTO'.*/
                public StringBasis FILLER_80 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0   AGOSTO");
                /*"    10          FILLER          PIC X(010)  VALUE '0 SETEMBRO'.*/
                public StringBasis FILLER_81 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0 SETEMBRO");
                /*"    10          FILLER          PIC X(010)  VALUE '0  OUTUBRO'.*/
                public StringBasis FILLER_82 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0  OUTUBRO");
                /*"    10          FILLER          PIC X(010)  VALUE '0 NOVEMBRO'.*/
                public StringBasis FILLER_83 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0 NOVEMBRO");
                /*"    10          FILLER          PIC X(010)  VALUE '0 DEZEMBRO'.*/
                public StringBasis FILLER_84 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"0 DEZEMBRO");
                /*"  05            FILLER          REDEFINES   TABELA-MESES                                OCCURS      12.*/
            }
            private ListBasis<_REDEF_SI0845B_FILLER_85> _filler_85 { get; set; }
            public ListBasis<_REDEF_SI0845B_FILLER_85> FILLER_85
            {
                get { _filler_85 = new ListBasis<_REDEF_SI0845B_FILLER_85>(12); _.Move(TABELA_MESES, _filler_85); VarBasis.RedefinePassValue(TABELA_MESES, _filler_85, TABELA_MESES); _filler_85.ValueChanged += () => { _.Move(_filler_85, TABELA_MESES); }; return _filler_85; }
                set { VarBasis.RedefinePassValue(value, _filler_85, TABELA_MESES); }
            }  //Redefines
            public class _REDEF_SI0845B_FILLER_85 : VarBasis
            {
                ...
                public _REDEF_SI0845B_FILLER_85()
                {
            ...
            /*"  05            AC-VALTOT-RAM   PIC S9(013)V99 VALUE +0 COMP-3.*/
            public DoubleBasis AC_VALTOT_RAM { get; set; } = new DoubleBasis(new PIC("S9", "13", "S9(013)V99"), 2);
            ...
            /*"  05        WABEND.*/
            public SI0845B_WABEND WABEND { get; set; } = new SI0845B_WABEND();
            public class SI0845B_WABEND : VarBasis
            {
                /*"    10      FILLER              PIC  X(010) VALUE           ' SI0845B'.*/
                public StringBasis FILLER_86 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" SI0845B");
                /*"    10      FILLER              PIC  X(026) VALUE           ' *** ERRO EXEC SQL NUMERO '.*/
                public StringBasis FILLER_87 { get; set; } = new StringBasis(new PIC("X", "26", "X(026)"), @" *** ERRO EXEC SQL NUMERO ");
                /*"    10      WNR-EXEC-SQL        PIC  X(003) VALUE '000'.*/
                public StringBasis WNR_EXEC_SQL { get; set; } = new StringBasis(new PIC("X", "3", "X(003)"), @"000");
                /*"    10      FILLER              PIC  X(015) VALUE           ' *** PARAGRAFO '.*/
                public StringBasis FILLER_88 { get; set; } = new StringBasis(new PIC("X", "15", "X(015)"), @" *** PARAGRAFO ");
                /*"    10      PARAGRAFO           PIC  X(040) VALUE SPACES.*/
                public StringBasis PARAGRAFO { get; set; } = new StringBasis(new PIC("X", "40", "X(040)"), @"");
                /*"    10      FILLER              PIC  X(013) VALUE           ' *** SQLCODE '.*/
                public StringBasis FILLER_89 { get; set; } = new StringBasis(new PIC("X", "13", "X(013)"), @" *** SQLCODE ");
                /*"    10      WSQLCODE            PIC  ZZZZZ999- VALUE ZEROS.*/
                public IntBasis WSQLCODE { get; set; } = new IntBasis(new PIC("9", "9", "ZZZZZ999-"));
                /*"01          LK-LINK.*/
            }
        }
        public SI0845B_LK_LINK LK_LINK { get; set; } = new SI0845B_LK_LINK();
        public class SI0845B_LK_LINK : VarBasis
        {
        ...
        public SI0845B_SINISTRO SINISTRO { get; set; } = new SI0845B_SINISTRO();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string RSI0845B_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                RSI0845B.SetFile(RSI0845B_FILE_NAME_P);

                /*" -663- MOVE '001' TO WNR-EXEC-SQL. */
                _.Move("001", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

                /*" -664- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

                /*" -667- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

                /*" -670- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

                /*" -670- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        {
            /*" -679- ACCEPT WHORA-CURR FROM TIME */
            _.Move(_.AcceptDate("TIME"), AREA_DE_WORK.WHORA_CURR);

            /*" -680- MOVE WHORA-HH-CURR TO WHORA-HH-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_HH_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_HH_CABEC);

            /*" -681- MOVE WHORA-MM-CURR TO WHORA-MM-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_MM_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_MM_CABEC);

            /*" -683- MOVE WHORA-SS-CURR TO WHORA-SS-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_SS_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_SS_CABEC);

            /*" -688- DISPLAY 'SI0845B - INICIO DE EXECUCAO ' WDATA-CABEC ' ' WHORA-CABEC */

            $"SI0845B - INICIO DE EXECUCAO {AREA_DE_WORK.WDATA_CABEC} {AREA_DE_WORK.WHORA_CABEC}"
            .Display();

            /*" -689- PERFORM R0100-00-SELECT-V1SISTEMA */

            R0100_00_SELECT_V1SISTEMA_SECTION();

            /*" -690- IF WFIM-V1SISTEMA NOT EQUAL SPACES */

            if (!AREA_DE_WORK.WFIM_V1SISTEMA.IsEmpty())
            {

                /*" -691- MOVE '*' TO WCH-FINAL */
                _.Move("*", AREA_DE_WORK.WCH_FINAL);

                /*" -693- GO TO R0000-90-ENCERRA. */
            ...
            /*" -707- PERFORM R0400-00-MONTA-CABECALHO */

            R0400_00_MONTA_CABECALHO_SECTION();

            /*" -711- PERFORM R8000-00-OPEN-ARQUIVOS */

            R8000_00_OPEN_ARQUIVOS_SECTION();

            /*" -712- PERFORM R0900-00-DECLARE-SINISTRO */

            R0900_00_DECLARE_SINISTRO_SECTION();

            /*" -713- PERFORM R0910-00-FETCH-SINISTRO */

            R0910_00_FETCH_SINISTRO_SECTION();

            /*" -714- IF WFIM-PROCESSO EQUAL HIGH-VALUES */

            if (AREA_DE_WORK.WFIM_PROCESSO.IsHighValues)
            {

                /*" -716- GO TO R0000-50-SEM-MOVIMENTO. */
            ...
            /*" -721- PERFORM R1000-00-PROCESSA-REGISTRO UNTIL WFIM-SINISTRO NOT EQUAL SPACES. */
            ...
            /*" -722- MOVE AC-VALTOT-GER TO LT01-VALOR */
            _.Move(AREA_DE_WORK.AC_VALTOT_GER, AREA_DE_WORK.LT01.LT01_VALOR);

            /*" -724- MOVE 'TOTAL GERAL: ' TO LT01-TOT */
            _.Move("TOTAL GERAL: ", AREA_DE_WORK.LT01.LT01_TOT);

            /*" -725- ADD +1 TO AC-LINHAS */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + +1;

            /*" -726- IF AC-LINHAS GREATER +52 */

            if (AREA_DE_WORK.AC_LINHAS > +52)
            {

                /*" -728- PERFORM R4000-00-CABECALHOS. */

                R4000_00_CABECALHOS_SECTION();
            }


            /*" -728- WRITE REG-SI0845B FROM LT01 AFTER 2. */
            _.Move(AREA_DE_WORK.LT01.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());
        ...
        {
            /*" -735- PERFORM R0800-00-DELETE-V0RELATORIOS */

            R0800_00_DELETE_V0RELATORIOS_SECTION();

            /*" -735- PERFORM R9000-00-CLOSE-ARQUIVOS. */
        ...
        {
            /*" -739- EXEC SQL COMMIT WORK END-EXEC. */

            DatabaseConnection.Instance.CommitTransaction();

            /*" -743- MOVE ZEROS TO RETURN-CODE */
            _.Move(0, RETURN_CODE);

            /*" -744- ACCEPT WHORA-CURR FROM TIME */
            _.Move(_.AcceptDate("TIME"), AREA_DE_WORK.WHORA_CURR);
            ...
            /*" -748- MOVE WHORA-SS-CURR TO WHORA-SS-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_SS_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_SS_CABEC);

            /*" -749- DISPLAY ' ' */
            _.Display($" ");

            /*" -750- DISPLAY ' LINHAS IMPRESSAS: ' AC-LINIMP. */
            _.Display($" LINHAS IMPRESSAS: {AREA_DE_WORK.AC_LINIMP}");

            /*" -752- DISPLAY ' ' */
            _.Display($" ");

            /*" -753- IF WCH-FINAL EQUAL SPACES */
            ...
            if (AREA_DE_WORK.WCH_FINAL.IsEmpty())
            {
                ...
                /*" -756- DISPLAY 'SI0845B - FIM NORMAL ' WDATA-CABEC ' ' WHORA-CABEC */

                $"SI0845B - FIM NORMAL {AREA_DE_WORK.WDATA_CABEC} {AREA_DE_WORK.WHORA_CABEC}"
                .Display();
            ...
            else
            {
                ...
                /*" -758- MOVE 99 TO RETURN-CODE */
                _.Move(99, RETURN_CODE);

                /*" -761- DISPLAY 'SI0845B - ENCERRADO COM PROBLEMAS ' WDATA-CABEC ' ' WHORA-CABEC. */

                $"SI0845B - ENCERRADO COM PROBLEMAS {AREA_DE_WORK.WDATA_CABEC} {AREA_DE_WORK.WHORA_CABEC}"
                .Display();
            }
        ...
        {
            /*" -774- MOVE '010' TO WNR-EXEC-SQL. */
            _.Move("010", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -779- PERFORM R0100_00_SELECT_V1SISTEMA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -784- DISPLAY 'SISTEMA DE SINISTROS NAO CADASTRADO' */
                    _.Display($"SISTEMA DE SINISTROS NAO CADASTRADO");

                    /*" -785- MOVE 'S' TO WFIM-V1SISTEMA */
                    _.Move("S", AREA_DE_WORK.WFIM_V1SISTEMA);

                    /*" -786- GO TO R0100-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -788- DISPLAY 'PROBLEMAS ACESSO V1SISTEMA' */
        ...
        {
            /*" -779- EXEC SQL SELECT DTMOVABE, CURRENT DATE INTO :V1SIST-DTMOVABE, :V1SIST-DTCURRENT FROM SEGUROS.V1SISTEMA WHERE IDSISTEM = 'SI' END-EXEC. */
        ...
        {
            /*" -803- MOVE '015' TO WNR-EXEC-SQL. */
            _.Move("015", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -813- PERFORM R0150_00_SELECT_V1RELATORIOS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -818- DISPLAY 'NAO HOUVE SOLICITACAO PARA EXECUCAO' */
                    _.Display($"NAO HOUVE SOLICITACAO PARA EXECUCAO");

                    /*" -819- MOVE 'S' TO WFIM-V1RELATORIOS */
                    _.Move("S", AREA_DE_WORK.WFIM_V1RELATORIOS);

                    /*" -820- GO TO R0150-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -822- DISPLAY 'PROBLEMAS ACESSO V1RELATORIOS' */
            ...
            /*" -863- MOVE WSIST-DATA TO WDATA-SISTEMA WHOST-DTTERVIG V1SIST-DTMOVABE. */
            _.Move(AREA_DE_WORK.WSIST_DATA, AREA_DE_WORK.WDATA_SISTEMA, WHOST_DTTERVIG, V1SIST_DTMOVABE);

            /*" -864- DISPLAY ' ' */
            _.Display($" ");

            /*" -865- DISPLAY ' DATA INICIAL DE SELECAO: ' WHOST-DTINIVIG. */
            _.Display($" DATA INICIAL DE SELECAO: {WHOST_DTINIVIG}");

            /*" -865- DISPLAY ' DATA FINAL   DE SELECAO: ' WHOST-DTTERVIG. */
        ...
        {
            /*" -813- EXEC SQL SELECT CODRELAT, MES_REFERENCIA, ANO_REFERENCIA INTO :V1RELA-CODRELAT, :V1RELA-MES-REFER, :V1RELA-ANO-REFER FROM SEGUROS.V1RELATORIOS WHERE CODRELAT = 'SI0845B1' AND SITUACAO = '0' END-EXEC. */
        ...
        {
            /*" -879- MOVE '040' TO WNR-EXEC-SQL. */
            _.Move("040", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -880- MOVE V1SIST-DTCURRENT TO WDATA-CURR */
            _.Move(V1SIST_DTCURRENT, AREA_DE_WORK.WDATA_CURR);

            /*" -881- MOVE WDATA-DD-CURR TO WDATA-DD-CABEC */
            _.Move(AREA_DE_WORK.WDATA_CURR.WDATA_DD_CURR, AREA_DE_WORK.WDATA_CABEC.WDATA_DD_CABEC);

            /*" -882- MOVE WDATA-MM-CURR TO WDATA-MM-CABEC */
            _.Move(AREA_DE_WORK.WDATA_CURR.WDATA_MM_CURR, AREA_DE_WORK.WDATA_CABEC.WDATA_MM_CABEC);

            /*" -883- MOVE WDATA-AA-CURR TO WDATA-AA-CABEC */
            _.Move(AREA_DE_WORK.WDATA_CURR.WDATA_AA_CURR, AREA_DE_WORK.WDATA_CABEC.WDATA_AA_CABEC);

            /*" -885- MOVE WDATA-CABEC TO LC02-DATA */
            _.Move(AREA_DE_WORK.WDATA_CABEC, AREA_DE_WORK.LC02.LC02_DATA);

            /*" -886- ACCEPT WHORA-CURR FROM TIME */
            _.Move(_.AcceptDate("TIME"), AREA_DE_WORK.WHORA_CURR);

            /*" -887- MOVE WHORA-HH-CURR TO WHORA-HH-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_HH_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_HH_CABEC);

            /*" -888- MOVE WHORA-MM-CURR TO WHORA-MM-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_MM_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_MM_CABEC);

            /*" -889- MOVE WHORA-SS-CURR TO WHORA-SS-CABEC */
            _.Move(AREA_DE_WORK.WHORA_CURR.WHORA_SS_CURR, AREA_DE_WORK.WHORA_CABEC.WHORA_SS_CABEC);

            /*" -891- MOVE WHORA-CABEC TO LC03-HORA */
            _.Move(AREA_DE_WORK.WHORA_CABEC, AREA_DE_WORK.LC03.LC03_HORA);

            /*" -892- MOVE TAB-MES(V1RELA-MES-REFER) TO LC03-MES */
            _.Move(AREA_DE_WORK.FILLER_85[V1RELA_MES_REFER].TAB_MES, AREA_DE_WORK.LC03.LC03_MES);

            /*" -894- MOVE V1RELA-ANO-REFER TO LC03-ANO */
            _.Move(V1RELA_ANO_REFER, AREA_DE_WORK.LC03.LC03_ANO);

            /*" -898- PERFORM R0400_00_MONTA_CABECALHO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -903- DISPLAY 'EMPRESA NAO CADASTRADA' */
                    _.Display($"EMPRESA NAO CADASTRADA");

                    /*" -904- MOVE 'S' TO WFIM-FECHAMENTO */
                    _.Move("S", AREA_DE_WORK.WFIM_FECHAMENTO);

                    /*" -905- GO TO R0400-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -907- DISPLAY 'PROBLEMAS ACESSO V1EMPRESA' */
            ...
            /*" -911- ADD 1 TO AC-S-V1EMPRESA */
            AREA_DE_WORK.AC_S_V1EMPRESA.Value = AREA_DE_WORK.AC_S_V1EMPRESA + 1;

            /*" -912- MOVE V1EMPR-NOM-EMP TO LK-TITULO */
            _.Move(V1EMPR_NOM_EMP, LK_LINK.LK_TITULO);

            /*" -914- CALL 'PROALN01' USING LK-LINK */
            _.Call("PROALN01", LK_LINK);

            /*" -915- IF LK-RTCODE EQUAL ZEROS */

            if (LK_LINK.LK_RTCODE == 00)
            {

                /*" -916- MOVE LK-TITULO TO LC01-EMPRESA */
            ...
            else
            {
                ...
                /*" -918- DISPLAY 'PROBLEMA CALL V1EMPRESA' */
        ...
        {
            /*" -898- EXEC SQL SELECT NOME_EMPRESA INTO :V1EMPR-NOM-EMP FROM SEGUROS.V1EMPRESA WHERE COD_EMPRESA = 0 END-EXEC. */
        ...
        {
            /*" -933- MOVE '080' TO WNR-EXEC-SQL. */
            _.Move("080", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -937- PERFORM R0800_00_DELETE_V0RELATORIOS_DB_DELETE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -941- DISPLAY 'PROBLEMAS DELETE V0RELATORIOS ... ' */
        ...
        {
            /*" -937- EXEC SQL DELETE FROM SEGUROS.V0RELATORIOS WHERE CODRELAT = :V1RELA-CODRELAT AND SITUACAO = '0' END-EXEC. */
        ...
        {
            /*" -956- MOVE '090' TO WNR-EXEC-SQL. */
            _.Move("090", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -977- PERFORM R0900_00_DECLARE_SINISTRO_DB_DECLARE_1 */

            R0900_00_DECLARE_SINISTRO_DB_DECLARE_1();

            /*" -979- PERFORM R0900_00_DECLARE_SINISTRO_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -983- DISPLAY 'PROBLEMAS DECLARE SINISTRO ... ' */
                _.Display($"PROBLEMAS DECLARE SINISTRO ... ");

                /*" -983- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -977- EXEC SQL DECLARE SINISTRO CURSOR FOR SELECT A.NUM_APOLICE, B.DTMOVTO, B.NUM_APOL_SINISTRO, A.RAMO, A.FONTE, A.CODCAU, B.VAL_OPERACAO, B.CODUSU FROM SEGUROS.V0MESTSINI A, SEGUROS.V0HISTSINI B WHERE A.NUM_APOL_SINISTRO = B.NUM_APOL_SINISTRO AND A.INDSVD = 'S' AND A.TIPREG = '1' AND A.SITUACAO <> '2' AND B.SITUACAO <> '2' AND B.TIPREG = '1' AND B.OPERACAO = 5002 AND B.DTMOVTO BETWEEN :WHOST-DTINIVIG AND :WHOST-DTTERVIG ORDER BY A.RAMO,B.DTMOVTO END-EXEC. */
            SINISTRO = new SI0845B_SINISTRO(true);
        ...
        {
            /*" -979- EXEC SQL OPEN SINISTRO END-EXEC. */
        ...
        {
            /*" -996- MOVE '091' TO WNR-EXEC-SQL. */
            _.Move("091", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1006- PERFORM R0910_00_FETCH_SINISTRO_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1011- MOVE 'S' TO WFIM-SINISTRO */
                    _.Move("S", AREA_DE_WORK.WFIM_SINISTRO);

                    /*" -1012- MOVE HIGH-VALUES TO WFIM-PROCESSO */

                    AREA_DE_WORK.WFIM_PROCESSO.IsHighValues = true;

                    /*" -1013- MOVE 9999 TO CH-RAMOS-ATU */
                    _.Move(9999, AREA_DE_WORK.CH_RAMOS_ATU);

                    /*" -1013- PERFORM R0910_00_FETCH_SINISTRO_DB_CLOSE_1 */

                    R0910_00_FETCH_SINISTRO_DB_CLOSE_1();

                    /*" -1015- GO TO R0910-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -1017- DISPLAY 'PROBLEMAS FETCH SINISTRO ... ' */
            ...
            /*" -1021- MOVE V1MSIN-RAMO TO CH-RAMOS-ATU */
            _.Move(V1MSIN_RAMO, AREA_DE_WORK.CH_RAMOS_ATU);

            /*" -1021- ADD 1 TO AC-S-SINISTRO. */
        ...
        {
            /*" -1006- EXEC SQL FETCH SINISTRO INTO :V1MSIN-NUM-APOL, :V1HSIN-DTMOVTO, :V1HSIN-NUM-SINI, :V1MSIN-RAMO, :V1MSIN-FONTE, :V1MSIN-CODCAU, :V1HSIN-VAL-OPERACAO, :V1HSIN-CODUSU END-EXEC. */
            ...
            if (SINISTRO.Fetch())
            {
                ...
                _.Move(SINISTRO.V1HSIN_CODUSU, V1HSIN_CODUSU);
            }
        ...
        {
            /*" -1013- EXEC SQL CLOSE SINISTRO END-EXEC */
        ...
        {
            /*" -1033- MOVE CH-RAMOS-ATU TO CH-RAMOS-ANT */
            _.Move(AREA_DE_WORK.CH_RAMOS_ATU, AREA_DE_WORK.CH_RAMOS_ANT);

            /*" -1035- PERFORM R4000-00-CABECALHOS. */

            R4000_00_CABECALHOS_SECTION();

            /*" -1041- PERFORM R1200-00-PROCESSA-RAMO UNTIL CH-RAMOS-ATU NOT EQUAL CH-RAMOS-ANT OR WFIM-SINISTRO NOT EQUAL SPACES. */

            while (!(AREA_DE_WORK.CH_RAMOS_ATU != AREA_DE_WORK.CH_RAMOS_ANT || !AREA_DE_WORK.WFIM_SINISTRO.IsEmpty()))
            {

                R1200_00_PROCESSA_RAMO_SECTION();
            }

            /*" -1042- MOVE AC-VALTOT-RAM TO LT01-VALOR */
            _.Move(AREA_DE_WORK.AC_VALTOT_RAM, AREA_DE_WORK.LT01.LT01_VALOR);

            /*" -1044- MOVE 'TOTAL RAMO:  ' TO LT01-TOT */
            _.Move("TOTAL RAMO:  ", AREA_DE_WORK.LT01.LT01_TOT);

            /*" -1045- ADD +2 TO AC-LINHAS */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + +2;

            /*" -1046- IF AC-LINHAS GREATER +52 */

            if (AREA_DE_WORK.AC_LINHAS > +52)
            {

                /*" -1048- PERFORM R4000-00-CABECALHOS. */

                R4000_00_CABECALHOS_SECTION();
            }


            /*" -1052- WRITE REG-SI0845B FROM LT01 AFTER 2. */
            _.Move(AREA_DE_WORK.LT01.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1053- ADD AC-VALTOT-RAM TO AC-VALTOT-GER. */
            AREA_DE_WORK.AC_VALTOT_GER.Value = AREA_DE_WORK.AC_VALTOT_GER + AREA_DE_WORK.AC_VALTOT_RAM;

            /*" -1053- MOVE ZEROS TO AC-VALTOT-RAM. */
            _.Move(0, AREA_DE_WORK.AC_VALTOT_RAM);

        }
        /*Método Suprimido por falta de linha ou apenas EXIT nome: R1000_99_SAIDA*/

        [StopWatch]
        /*" R1200-00-PROCESSA-RAMO-SECTION */
        private void R1200_00_PROCESSA_RAMO_SECTION()
        {
            /*" -1065- MOVE '120' TO WNR-EXEC-SQL. */
            _.Move("120", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1067- PERFORM R2300-00-SELECT-V1SINICAUSA */

            R2300_00_SELECT_V1SINICAUSA_SECTION();

            /*" -1069- PERFORM R2400-00-SELECT-V1APOLICE */

            R2400_00_SELECT_V1APOLICE_SECTION();

            /*" -1070- MOVE V1HSIN-DTMOVTO TO WDTMOVTO. */
            _.Move(V1HSIN_DTMOVTO, AREA_DE_WORK.WDTMOVTO);

            /*" -1071- MOVE WDTMOVTO-DIA TO LD01-DIA. */
            _.Move(AREA_DE_WORK.FILLER_32.WDTMOVTO_DIA, AREA_DE_WORK.LD01.LD01_DIA);

            /*" -1072- MOVE WDTMOVTO-MES TO LD01-MES. */
            _.Move(AREA_DE_WORK.FILLER_32.WDTMOVTO_MES, AREA_DE_WORK.LD01.LD01_MES);

            /*" -1073- MOVE WDTMOVTO-ANO TO LD01-ANO. */
            _.Move(AREA_DE_WORK.FILLER_32.WDTMOVTO_ANO, AREA_DE_WORK.LD01.LD01_ANO);

            /*" -1074- MOVE V1HSIN-NUM-SINI TO LD01-SINISTRO */
            _.Move(V1HSIN_NUM_SINI, AREA_DE_WORK.LD01.LD01_SINISTRO);

            /*" -1075- MOVE V1APOL-NOME TO LD01-SEGURADO */
            _.Move(V1APOL_NOME, AREA_DE_WORK.LD01.LD01_SEGURADO);

            /*" -1076- MOVE V1SCAU-DESCAU TO LD01-CAUSA */
            _.Move(V1SCAU_DESCAU, AREA_DE_WORK.LD01.LD01_CAUSA);

            /*" -1077- MOVE V1HSIN-VAL-OPERACAO TO LD01-VALOR. */
            _.Move(V1HSIN_VAL_OPERACAO, AREA_DE_WORK.LD01.LD01_VALOR);

            /*" -1078- MOVE V1HSIN-CODUSU TO LD01-CODUSU. */
            _.Move(V1HSIN_CODUSU, AREA_DE_WORK.LD01.LD01_CODUSU);

            /*" -1080- MOVE V1MSIN-FONTE TO LD01-FONTE. */
            _.Move(V1MSIN_FONTE, AREA_DE_WORK.LD01.LD01_FONTE);

            /*" -1081- ADD +1 TO AC-LINHAS */
            AREA_DE_WORK.AC_LINHAS.Value = AREA_DE_WORK.AC_LINHAS + +1;

            /*" -1082- IF AC-LINHAS GREATER +52 */

            if (AREA_DE_WORK.AC_LINHAS > +52)
            {

                /*" -1084- PERFORM R4000-00-CABECALHOS. */

                R4000_00_CABECALHOS_SECTION();
            }


            /*" -1086- WRITE REG-SI0845B FROM LD01 AFTER 1. */
            _.Move(AREA_DE_WORK.LD01.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1087- ADD V1HSIN-VAL-OPERACAO TO AC-VALTOT-RAM. */
            AREA_DE_WORK.AC_VALTOT_RAM.Value = AREA_DE_WORK.AC_VALTOT_RAM + V1HSIN_VAL_OPERACAO;

            /*" -1089- ADD 1 TO AC-LINIMP */
            AREA_DE_WORK.AC_LINIMP.Value = AREA_DE_WORK.AC_LINIMP + 1;

            /*" -1089- PERFORM R0910-00-FETCH-SINISTRO. */
        ...
        [StopWatch]
        /*" R2200-00-SELECT-V1RAMO-SECTION */
        private void R2200_00_SELECT_V1RAMO_SECTION()
        {
            /*" -1101- MOVE '220' TO WNR-EXEC-SQL. */
            _.Move("220", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1107- PERFORM R2200_00_SELECT_V1RAMO_DB_SELECT_1 */

            R2200_00_SELECT_V1RAMO_DB_SELECT_1();
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1110- MOVE ALL 'X' TO V1RAMO-NOMERAMO. */
                _.MoveAll("X", V1RAMO_NOMERAMO);
            }
        ...
        [StopWatch]
        /*" R2200-00-SELECT-V1RAMO-DB-SELECT-1 */
        public void R2200_00_SELECT_V1RAMO_DB_SELECT_1()
        {
            /*" -1107- EXEC SQL SELECT NOMERAMO INTO :V1RAMO-NOMERAMO FROM SEGUROS.V1RAMO WHERE RAMO = :HOST-RAMO AND MODALIDA = 0 END-EXEC. */

            var r2200_00_SELECT_V1RAMO_DB_SELECT_1_Query1 = new R2200_00_SELECT_V1RAMO_DB_SELECT_1_Query1()
            {
                HOST_RAMO = HOST_RAMO.ToString(),
            };

            var executed_1 = R2200_00_SELECT_V1RAMO_DB_SELECT_1_Query1.Execute(r2200_00_SELECT_V1RAMO_DB_SELECT_1_Query1);
            if (executed_1 != null)
            {
        ...
        {
            /*" -1120- MOVE '230' TO WNR-EXEC-SQL. */
            _.Move("230", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1126- PERFORM R2300_00_SELECT_V1SINICAUSA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1129- MOVE ALL 'X' TO V1SCAU-DESCAU. */
        ...
        {
            /*" -1126- EXEC SQL SELECT DESCAU INTO :V1SCAU-DESCAU FROM SEGUROS.V1SINICAUSA WHERE CODCAU = :V1MSIN-CODCAU AND RAMO = :V1MSIN-RAMO END-EXEC. */
        ...
        [StopWatch]
        /*" R2400-00-SELECT-V1APOLICE-SECTION */
        private void R2400_00_SELECT_V1APOLICE_SECTION()
        {
            /*" -1139- MOVE '240' TO WNR-EXEC-SQL. */
            _.Move("240", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1144- PERFORM R2400_00_SELECT_V1APOLICE_DB_SELECT_1 */

            R2400_00_SELECT_V1APOLICE_DB_SELECT_1();
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1147- MOVE ALL 'X' TO V1APOL-NOME. */
                _.MoveAll("X", V1APOL_NOME);
            }
        ...
        [StopWatch]
        /*" R2400-00-SELECT-V1APOLICE-DB-SELECT-1 */
        public void R2400_00_SELECT_V1APOLICE_DB_SELECT_1()
        {
            /*" -1144- EXEC SQL SELECT NOME INTO :V1APOL-NOME FROM SEGUROS.V1APOLICE WHERE NUM_APOLICE = :V1MSIN-NUM-APOL END-EXEC. */

            var r2400_00_SELECT_V1APOLICE_DB_SELECT_1_Query1 = new R2400_00_SELECT_V1APOLICE_DB_SELECT_1_Query1()
            {
                V1MSIN_NUM_APOL = V1MSIN_NUM_APOL.ToString(),
            };

            var executed_1 = R2400_00_SELECT_V1APOLICE_DB_SELECT_1_Query1.Execute(r2400_00_SELECT_V1APOLICE_DB_SELECT_1_Query1);
            if (executed_1 != null)
            {
        ...
        {
            /*" -1160- MOVE '300' TO WNR-EXEC-SQL. */
            _.Move("300", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1161- ADD 1 TO AC-PAGINA */
            AREA_DE_WORK.AC_PAGINA.Value = AREA_DE_WORK.AC_PAGINA + 1;

            /*" -1162- MOVE AC-PAGINA TO LC01-PAGINA */
            _.Move(AREA_DE_WORK.AC_PAGINA, AREA_DE_WORK.LC01.LC01_PAGINA);

            /*" -1166- MOVE +9 TO AC-LINHAS */
            _.Move(+9, AREA_DE_WORK.AC_LINHAS);

            /*" -1167- MOVE CH-RAMOS-ANT TO HOST-RAMO */
            _.Move(AREA_DE_WORK.CH_RAMOS_ANT, HOST_RAMO);

            /*" -1168- PERFORM R2200-00-SELECT-V1RAMO */

            R2200_00_SELECT_V1RAMO_SECTION();

            /*" -1169- MOVE CH-RAMOS-ANT TO LC05-CODRAMO */
            _.Move(AREA_DE_WORK.CH_RAMOS_ANT, AREA_DE_WORK.LC05.LC05_CODRAMO);

            /*" -1171- MOVE V1RAMO-NOMERAMO TO LC05-NOMRAMO */
            _.Move(V1RAMO_NOMERAMO, AREA_DE_WORK.LC05.LC05_NOMRAMO);

            /*" -1172- WRITE REG-SI0845B FROM LC01 AFTER PAGE */
            _.Move(AREA_DE_WORK.LC01.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1173- WRITE REG-SI0845B FROM LC02 */
            _.Move(AREA_DE_WORK.LC02.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1175- WRITE REG-SI0845B FROM LC03 */
            _.Move(AREA_DE_WORK.LC03.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1176- WRITE REG-SI0845B FROM LC05 AFTER 2. */
            _.Move(AREA_DE_WORK.LC05.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1177- WRITE REG-SI0845B FROM LC06 */
            _.Move(AREA_DE_WORK.LC06.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1178- WRITE REG-SI0845B FROM LC07 */
            _.Move(AREA_DE_WORK.LC07.GetMoveValues(), REG_SI0845B);

            RSI0845B.Write(REG_SI0845B.GetMoveValues().ToString());

            /*" -1178- WRITE REG-SI0845B FROM LC06. */
            _.Move(AREA_DE_WORK.LC06.GetMoveValues(), REG_SI0845B);
        ...
        {
            /*" -1189- OPEN OUTPUT RSI0845B. */
            RSI0845B.Open(REG_SI0845B);
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1222- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

            /*" -1224- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1228- MOVE 99 TO RETURN-CODE */
            _.Move(99, RETURN_CODE);
