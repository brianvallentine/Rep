...
namespace Code
{
    public class SI1018S
    {
        ...
        /*"      *----------------------------------------------------------------*      */
        /*"      *   FUNCAO .................  CALCULO DO VALOR PAGO DO SINISTRO -*      */
        /*"      *                             SEGURO, JUDICIAL E SUCUMBENCIA     *      */
        /*"      *                                                                *      */
        /*"      *   OBS.:                                                        *      */
        ...
        private void R0100_00_CONSISTE_ENTRADA_SECTION()
        {
            ...
            if (!LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO.IsNumeric())
            {
                ...
                /*" -93- MOVE 'SI1018S - NUMERO DO SINISTRO INVALIDO' TO SI1001S-ERRO-MENSAGEM */
                _.Move("SI1018S - NUMERO DO SINISTRO INVALIDO", LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM);
            ...
            if (LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO == 00 && LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_COD_PRODUTO == 00 && LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_RAMO == 00)
            {
                ...
                /*" -104- MOVE 'SI1018S - INFORME O SINISTRO, PRODUTO OU RAMO' TO SI1001S-ERRO-MENSAGEM */
                _.Move("SI1018S - INFORME O SINISTRO, PRODUTO OU RAMO", LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM);
        ...
        private void R0200_00_OBTEM_VALOR_SECTION()
        {
            ...
            /*" -137- MOVE 2 TO SI1000S-COD-FUNCAO */
            ...
            /*" -144- MOVE SI1000S-VALOR-CALCULADO TO SI1001S-VALOR-CALCULADO */
            ...
            /*" -145- MOVE 8 TO SI1000S-COD-FUNCAO */
            _.Move(8, LBSI1000.SI1000S_PARAMETROS.SI1000S_ENTRADA.SI1000S_COD_FUNCAO);

            /*" -147- PERFORM R0300-00-CHAMA-SI1000S */

            R0300_00_CHAMA_SI1000S_SECTION();

            /*" -152- ADD SI1000S-VALOR-CALCULADO TO SI1001S-VALOR-CALCULADO */
            ...
            /*" -153- MOVE 12 TO SI1000S-COD-FUNCAO */
            _.Move(12, LBSI1000.SI1000S_PARAMETROS.SI1000S_ENTRADA.SI1000S_COD_FUNCAO);

            /*" -155- PERFORM R0300-00-CHAMA-SI1000S */

            R0300_00_CHAMA_SI1000S_SECTION();

            /*" -156- ADD SI1000S-VALOR-CALCULADO TO SI1001S-VALOR-CALCULADO. */
            LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_VALOR_CALCULADO.Value = LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_VALOR_CALCULADO + LBSI1000.SI1000S_PARAMETROS.SI1000S_SAIDA.SI1000S_VALOR_CALCULADO;
        ...
        private void R0300_00_CHAMA_SI1000S_SECTION()
        {
            ...
            if (!LBSI1000.SI1000S_PARAMETROS.SI1000S_SAIDA.SI1000S_ERRO_MENSAGEM.IsEmpty())
            {
                ...
                /*" -178- MOVE SI1000S-ERRO-PARAGRAFO TO SI1001S-ERRO-PARAGRAFO */
                ...
                /*" -180- MOVE SI1000S-ERRO-SQLCODE TO SI1001S-ERRO-SQLCODE */
