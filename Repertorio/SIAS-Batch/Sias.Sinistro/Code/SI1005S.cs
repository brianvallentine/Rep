...
namespace Code
{
    public class SI1005S
    {
        ...
        /*"      *----------------------------------------------------------------*      */
        /*"      *   FUNCAO .................  CALCULO DO VALOR DE DESPESA        *      */
        /*"      *                             PAGA DO SEGURO                     *      */
        /*"      *                                                                *      */
        /*"      *   OBS.:                                                        *      */
        ...
        private void R0100_00_CONSISTE_ENTRADA_SECTION()
        {
            ...
            if (!LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO.IsNumeric())
            {
                ...
                /*" -93- MOVE 'SI1005S - NUMERO DO SINISTRO INVALIDO' TO SI1001S-ERRO-MENSAGEM */
                _.Move("SI1005S - NUMERO DO SINISTRO INVALIDO", LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM);
            ...
            if (LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO == 00 && LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_COD_PRODUTO == 00 && LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_RAMO == 00)
            {
                ...
                /*" -104- MOVE 'SI1005S - INFORME O SINISTRO, PRODUTO OU RAMO' TO SI1001S-ERRO-MENSAGEM */
                _.Move("SI1005S - INFORME O SINISTRO, PRODUTO OU RAMO", LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM);
        ...
        private void R0200_00_OBTEM_VALOR_SECTION()
        {
            ...
            /*" -137- MOVE 5 TO SI1000S-COD-FUNCAO */
            _.Move(5, LBSI1000.SI1000S_PARAMETROS.SI1000S_ENTRADA.SI1000S_COD_FUNCAO);
