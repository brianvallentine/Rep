...
namespace Code
{
    public class SI1025S
    {
        ...
        /*"      *----------------------------------------------------------------*      */
        /*"      *   FUNCAO .................  CALCULO DE VALOR DE ADIANTAMENTOS  *      */
        /*"      *                             PAGOS A CEF/SGTO                   *      */
        /*"      *                                                                *      */
        /*"      *   OBS.:                                                        *      */
        ...
        private void R0100_00_CONSISTE_ENTRADA_SECTION()
        {
            ...
            if (!LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO.IsNumeric())
            {
                ...
                /*" -90- MOVE 'SI1025S - NUMERO DO SINISTRO INVALIDO' TO SI1001S-ERRO-MENSAGEM */
                _.Move("SI1025S - NUMERO DO SINISTRO INVALIDO", LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM);
            ...
            if (LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO == 00 && LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_COD_PRODUTO == 00 && LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_RAMO == 00)
            {
                ...
                /*" -101- MOVE 'SI1025S - INFORME O SINISTRO, PRODUTO OU RAMO' TO SI1001S-ERRO-MENSAGEM */
                _.Move("SI1025S - INFORME O SINISTRO, PRODUTO OU RAMO", LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM);
        ...
        private void R0200_00_OBTEM_VALOR_SECTION()
        {
            ...
            /*" -134- MOVE 19 TO SI1000S-COD-FUNCAO */
            _.Move(19, LBSI1000.SI1000S_PARAMETROS.SI1000S_ENTRADA.SI1000S_COD_FUNCAO);
