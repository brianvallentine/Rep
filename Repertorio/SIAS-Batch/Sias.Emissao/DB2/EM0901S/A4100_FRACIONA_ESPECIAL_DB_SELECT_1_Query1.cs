...
namespace Sias.Emissao.DB2.EM0901S
{
    public class A4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1 : QueryBasis<A4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static A4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1 Execute(A4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1 a4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1)
        {
            var ths = a4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1;
        ...
        public override A4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new A4100_FRACIONA_ESPECIAL_DB_SELECT_1_Query1();
            var i = 0;
