...
{
    public class R4400_00_UPDATE_V0COBERAPOL_DB_UPDATE_1_Update1 : QueryBasis<R4400_00_UPDATE_V0COBERAPOL_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R4400_00_UPDATE_V0COBERAPOL_DB_UPDATE_1_Update1 r4400_00_UPDATE_V0COBERAPOL_DB_UPDATE_1_Update1)
        {
            var ths = r4400_00_UPDATE_V0COBERAPOL_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4400_00_UPDATE_V0COBERAPOL_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
