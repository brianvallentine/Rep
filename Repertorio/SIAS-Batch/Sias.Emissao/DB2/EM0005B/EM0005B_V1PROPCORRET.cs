...
{
    public class EM0005B_V1PROPCORRET : QueryBasis<EM0005B_V1PROPCORRET>
    {
        ...
        public EM0005B_V1PROPCORRET() { IsCursor = true; }

        public EM0005B_V1PROPCORRET(bool justACursor)
        {
        ...
        public override EM0005B_V1PROPCORRET OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0005B_V1PROPCORRET();
            var i = 0;
