...
{
    public class R3100_00_INSERT_V0APOLICE_DB_INSERT_1_Insert1 : QueryBasis<R3100_00_INSERT_V0APOLICE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :V0APOL-QTCOSSEG ,
            :V0APOL-PCTCED ,
            :V0APOL-DATA-SORT:VIND-DAT-SORT,
            :V0APOL-COD-EMPRESA:VIND-COD-EMP,
            CURRENT TIMESTAMP,
            :V0APOL-CODPRODU ,
            :V0APOL-TPCORRET)
            END-EXEC.
        ...
        public string V0APOL_DATA_SORT { get; set; }
        ...
        public static void Execute(R3100_00_INSERT_V0APOLICE_DB_INSERT_1_Insert1 r3100_00_INSERT_V0APOLICE_DB_INSERT_1_Insert1)
        {
            var ths = r3100_00_INSERT_V0APOLICE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3100_00_INSERT_V0APOLICE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
