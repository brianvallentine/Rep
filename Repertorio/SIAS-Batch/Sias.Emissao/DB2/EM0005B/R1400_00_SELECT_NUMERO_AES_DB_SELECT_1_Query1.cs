...
{
    public class R1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1 : QueryBasis<R1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1 Execute(R1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1 r1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1)
        {
            var ths = r1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1;
        ...
        public override R1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1400_00_SELECT_NUMERO_AES_DB_SELECT_1_Query1();
            var i = 0;
            dta.V0NAES_SEQ_APOLICE = result[i++].Value?.ToString();
