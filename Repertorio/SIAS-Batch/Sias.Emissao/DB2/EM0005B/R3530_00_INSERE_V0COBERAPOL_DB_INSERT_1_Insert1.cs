...
{
    public class R3530_00_INSERE_V0COBERAPOL_DB_INSERT_1_Insert1 : QueryBasis<R3530_00_INSERE_V0COBERAPOL_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3530_00_INSERE_V0COBERAPOL_DB_INSERT_1_Insert1 r3530_00_INSERE_V0COBERAPOL_DB_INSERT_1_Insert1)
        {
            var ths = r3530_00_INSERE_V0COBERAPOL_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3530_00_INSERE_V0COBERAPOL_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
