...
{
    public class R3600_00_INSERT_V0ACOMPROP_DB_INSERT_1_Insert1 : QueryBasis<R3600_00_INSERT_V0ACOMPROP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3600_00_INSERT_V0ACOMPROP_DB_INSERT_1_Insert1 r3600_00_INSERT_V0ACOMPROP_DB_INSERT_1_Insert1)
        {
            var ths = r3600_00_INSERT_V0ACOMPROP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3600_00_INSERT_V0ACOMPROP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
