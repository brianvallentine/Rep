...
{
    public class EM0005B_V1COBERPROP : QueryBasis<EM0005B_V1COBERPROP>
    {
        ...
        public EM0005B_V1COBERPROP() { IsCursor = true; }

        public EM0005B_V1COBERPROP(bool justACursor)
        {
        ...
        public override EM0005B_V1COBERPROP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0005B_V1COBERPROP();
            var i = 0;
