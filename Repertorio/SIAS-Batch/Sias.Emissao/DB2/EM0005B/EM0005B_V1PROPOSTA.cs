...
{
    public class EM0005B_V1PROPOSTA : QueryBasis<EM0005B_V1PROPOSTA>
    {
        ...
        public EM0005B_V1PROPOSTA() { IsCursor = true; }

        public EM0005B_V1PROPOSTA(bool justACursor)
        {
        ...
        public override EM0005B_V1PROPOSTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0005B_V1PROPOSTA();
            var i = 0;
            ...
            dta.V1PROP_TIPO_ENDOS = result[i++].Value?.ToString();
            ...
            dta.V1PROP_CODEMPR = result[i++].Value?.ToString();
