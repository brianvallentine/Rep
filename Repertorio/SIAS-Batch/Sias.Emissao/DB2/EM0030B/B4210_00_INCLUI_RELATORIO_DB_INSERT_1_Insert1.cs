...
{
    public class B4210_00_INCLUI_RELATORIO_DB_INSERT_1_Insert1 : QueryBasis<B4210_00_INCLUI_RELATORIO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(B4210_00_INCLUI_RELATORIO_DB_INSERT_1_Insert1 b4210_00_INCLUI_RELATORIO_DB_INSERT_1_Insert1)
        {
            var ths = b4210_00_INCLUI_RELATORIO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override B4210_00_INCLUI_RELATORIO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
