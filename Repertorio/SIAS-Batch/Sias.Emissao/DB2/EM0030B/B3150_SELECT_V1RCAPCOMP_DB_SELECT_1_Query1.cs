...
{
    public class B3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1 : QueryBasis<B3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static B3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1 Execute(B3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1 b3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1)
        {
            var ths = b3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1;
        ...
        public override B3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new B3150_SELECT_V1RCAPCOMP_DB_SELECT_1_Query1();
            var i = 0;
