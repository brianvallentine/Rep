...
{
    public class B2000_CONTINUA_DB_SELECT_1_Query1 : QueryBasis<B2000_CONTINUA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static B2000_CONTINUA_DB_SELECT_1_Query1 Execute(B2000_CONTINUA_DB_SELECT_1_Query1 b2000_CONTINUA_DB_SELECT_1_Query1)
        {
            var ths = b2000_CONTINUA_DB_SELECT_1_Query1;
        ...
        public override B2000_CONTINUA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new B2000_CONTINUA_DB_SELECT_1_Query1();
            var i = 0;
