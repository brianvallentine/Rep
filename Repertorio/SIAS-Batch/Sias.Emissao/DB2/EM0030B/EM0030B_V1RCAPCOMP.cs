...
{
    public class EM0030B_V1RCAPCOMP : QueryBasis<EM0030B_V1RCAPCOMP>
    {
        ...
        public EM0030B_V1RCAPCOMP() { IsCursor = true; }

        public EM0030B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override EM0030B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0030B_V1RCAPCOMP();
            var i = 0;
