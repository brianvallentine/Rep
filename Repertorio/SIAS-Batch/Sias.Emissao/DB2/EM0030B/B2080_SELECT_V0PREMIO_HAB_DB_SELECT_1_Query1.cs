...
{
    public class B2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1 : QueryBasis<B2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static B2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1 Execute(B2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1 b2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1)
        {
            var ths = b2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1;
        ...
        public override B2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new B2080_SELECT_V0PREMIO_HAB_DB_SELECT_1_Query1();
            var i = 0;
