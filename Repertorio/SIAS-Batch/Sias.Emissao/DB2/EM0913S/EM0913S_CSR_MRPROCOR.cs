...
{
    public class EM0913S_CSR_MRPROCOR : QueryBasis<EM0913S_CSR_MRPROCOR>
    {
        ...
        public EM0913S_CSR_MRPROCOR() { IsCursor = true; }

        public EM0913S_CSR_MRPROCOR(bool justACursor)
        {
        ...
        public override EM0913S_CSR_MRPROCOR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0913S_CSR_MRPROCOR();
            var i = 0;
