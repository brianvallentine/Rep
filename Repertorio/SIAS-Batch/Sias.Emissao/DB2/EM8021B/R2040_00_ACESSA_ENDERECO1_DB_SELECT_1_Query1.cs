...
{
    public class R2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1 : QueryBasis<R2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1 Execute(R2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1 r2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1)
        {
            var ths = r2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1;
        ...
        public override R2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2040_00_ACESSA_ENDERECO1_DB_SELECT_1_Query1();
            var i = 0;
