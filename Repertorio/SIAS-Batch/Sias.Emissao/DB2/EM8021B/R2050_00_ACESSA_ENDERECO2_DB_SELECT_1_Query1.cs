...
{
    public class R2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1 : QueryBasis<R2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1 Execute(R2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1 r2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1)
        {
            var ths = r2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1;
        ...
        public override R2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2050_00_ACESSA_ENDERECO2_DB_SELECT_1_Query1();
            var i = 0;
