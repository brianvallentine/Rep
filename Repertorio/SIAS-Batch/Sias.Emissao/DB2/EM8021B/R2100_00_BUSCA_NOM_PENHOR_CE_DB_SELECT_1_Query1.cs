...
{
    public class R2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1 : QueryBasis<R2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1 Execute(R2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1 r2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1)
        {
            var ths = r2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1;
        ...
        public override R2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2100_00_BUSCA_NOM_PENHOR_CE_DB_SELECT_1_Query1();
            var i = 0;
