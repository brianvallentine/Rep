...
{
    public class R3200_00_INSERT_V0ENDOSSO_DB_INSERT_1_Insert1 : QueryBasis<R3200_00_INSERT_V0ENDOSSO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :V0ENDO-OCORR-END ,
            :V0ENDO-SITUACAO ,
            :V0ENDO-DATARCAP:VIND-DAT-RCAP,
            :V0ENDO-COD-EMPRESA:VIND-COD-EMP,
            :V0ENDO-CORRECAO:VIND-CORRECAO,
            :V0ENDO-ISENTA-CST,
            CURRENT TIMESTAMP,
        ...
        public static void Execute(R3200_00_INSERT_V0ENDOSSO_DB_INSERT_1_Insert1 r3200_00_INSERT_V0ENDOSSO_DB_INSERT_1_Insert1)
        {
            var ths = r3200_00_INSERT_V0ENDOSSO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3200_00_INSERT_V0ENDOSSO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
