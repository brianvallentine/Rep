...
{
    public class EM0006B_V1COSSEGSORT : QueryBasis<EM0006B_V1COSSEGSORT>
    {
        ...
        public EM0006B_V1COSSEGSORT() { IsCursor = true; }

        public EM0006B_V1COSSEGSORT(bool justACursor)
        {
        ...
        public override EM0006B_V1COSSEGSORT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0006B_V1COSSEGSORT();
            var i = 0;
