...
{
    public class R4700_00_UPDATE_NUMERO_AES_DB_UPDATE_1_Update1 : QueryBasis<R4700_00_UPDATE_NUMERO_AES_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R4700_00_UPDATE_NUMERO_AES_DB_UPDATE_1_Update1 r4700_00_UPDATE_NUMERO_AES_DB_UPDATE_1_Update1)
        {
            var ths = r4700_00_UPDATE_NUMERO_AES_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4700_00_UPDATE_NUMERO_AES_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
