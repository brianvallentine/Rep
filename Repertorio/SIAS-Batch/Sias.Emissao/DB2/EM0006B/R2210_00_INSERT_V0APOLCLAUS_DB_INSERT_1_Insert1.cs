...
{
    public class R2210_00_INSERT_V0APOLCLAUS_DB_INSERT_1_Insert1 : QueryBasis<R2210_00_INSERT_V0APOLCLAUS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL INSERT
            INTO SEGUROS.V0APOLCLAUSULA
            VALUES (:V0APCL-COD-EMPRESA,
            :V0APCL-NUM-APOL ,
            :V0APCL-NRENDOS ,
            :V0APCL-RAMOFR ,
            :V0APCL-MODALIFR ,
        ...
        public static void Execute(R2210_00_INSERT_V0APOLCLAUS_DB_INSERT_1_Insert1 r2210_00_INSERT_V0APOLCLAUS_DB_INSERT_1_Insert1)
        {
            var ths = r2210_00_INSERT_V0APOLCLAUS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2210_00_INSERT_V0APOLCLAUS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
