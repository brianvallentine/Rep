...
{
    public class R0720_00_ATUALIZA_MOVDEBCE_DB_UPDATE_1_Update1 : QueryBasis<R0720_00_ATUALIZA_MOVDEBCE_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R0720_00_ATUALIZA_MOVDEBCE_DB_UPDATE_1_Update1 r0720_00_ATUALIZA_MOVDEBCE_DB_UPDATE_1_Update1)
        {
            var ths = r0720_00_ATUALIZA_MOVDEBCE_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0720_00_ATUALIZA_MOVDEBCE_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
