...
{
    public class R0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1 : QueryBasis<R0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1 Execute(R0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1 r0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1)
        {
            var ths = r0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1;
        ...
        public override R0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0542_00_LE_V0FUNCIOCEF_DB_SELECT_1_Query1();
            var i = 0;
            dta.V0FUNCI_NUM_MATRICULA = result[i++].Value?.ToString();
