...
{
    public class R2610_00_INSERT_V0APOLCLAU_DB_INSERT_1_Insert1 : QueryBasis<R2610_00_INSERT_V0APOLCLAU_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2610_00_INSERT_V0APOLCLAU_DB_INSERT_1_Insert1 r2610_00_INSERT_V0APOLCLAU_DB_INSERT_1_Insert1)
        {
            var ths = r2610_00_INSERT_V0APOLCLAU_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2610_00_INSERT_V0APOLCLAU_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
