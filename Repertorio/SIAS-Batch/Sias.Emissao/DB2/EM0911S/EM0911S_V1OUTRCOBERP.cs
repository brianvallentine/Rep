...
{
    public class EM0911S_V1OUTRCOBERP : QueryBasis<EM0911S_V1OUTRCOBERP>
    {
        ...
        public EM0911S_V1OUTRCOBERP() { IsCursor = true; }

        public EM0911S_V1OUTRCOBERP(bool justACursor)
        {
        ...
        public override EM0911S_V1OUTRCOBERP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0911S_V1OUTRCOBERP();
            var i = 0;
