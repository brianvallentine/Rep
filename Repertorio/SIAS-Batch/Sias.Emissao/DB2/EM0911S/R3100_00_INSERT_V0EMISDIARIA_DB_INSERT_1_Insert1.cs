...
{
    public class R3100_00_INSERT_V0EMISDIARIA_DB_INSERT_1_Insert1 : QueryBasis<R3100_00_INSERT_V0EMISDIARIA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3100_00_INSERT_V0EMISDIARIA_DB_INSERT_1_Insert1 r3100_00_INSERT_V0EMISDIARIA_DB_INSERT_1_Insert1)
        {
            var ths = r3100_00_INSERT_V0EMISDIARIA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3100_00_INSERT_V0EMISDIARIA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
