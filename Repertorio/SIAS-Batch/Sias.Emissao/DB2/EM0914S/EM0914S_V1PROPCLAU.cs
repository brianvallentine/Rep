...
{
    public class EM0914S_V1PROPCLAU : QueryBasis<EM0914S_V1PROPCLAU>
    {
        ...
        public EM0914S_V1PROPCLAU() { IsCursor = true; }

        public EM0914S_V1PROPCLAU(bool justACursor)
        {
        ...
        public override EM0914S_V1PROPCLAU OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0914S_V1PROPCLAU();
            var i = 0;
