...
namespace Sias.Emissao.DB2.EM0914S
{
    public class R2110_00_INSERT_MR_APOL_ITEM_DB_INSERT_1_Insert1 : QueryBasis<R2110_00_INSERT_MR_APOL_ITEM_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            :MRAPOITE-COD-BENEFICIARIO:WSNULL-COD-BENEF,
        ...
        public string WSNULL_COD_BENEF { get; set; }
