...
{
    public class EM0914S_CSR_MRPROITE : QueryBasis<EM0914S_CSR_MRPROITE>
    {
        ...
        public EM0914S_CSR_MRPROITE() { IsCursor = true; }

        public EM0914S_CSR_MRPROITE(bool justACursor)
        {
        ...
        public override EM0914S_CSR_MRPROITE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0914S_CSR_MRPROITE();
            var i = 0;
            ...
            dta.WSNULL_COD_BENEF = string.IsNullOrWhiteSpace(dta.MRPROITE_COD_BENEFICIARIO) ? "-1" : "0";
