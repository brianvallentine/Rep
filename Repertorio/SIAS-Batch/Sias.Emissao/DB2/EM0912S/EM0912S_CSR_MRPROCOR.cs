...
{
    public class EM0912S_CSR_MRPROCOR : QueryBasis<EM0912S_CSR_MRPROCOR>
    {
        ...
        public EM0912S_CSR_MRPROCOR() { IsCursor = true; }

        public EM0912S_CSR_MRPROCOR(bool justACursor)
        {
        ...
        public override EM0912S_CSR_MRPROCOR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0912S_CSR_MRPROCOR();
            var i = 0;
