...
{
    public class EM0912S_CSR_MRPROITE : QueryBasis<EM0912S_CSR_MRPROITE>
    {
        ...
        public EM0912S_CSR_MRPROITE() { IsCursor = true; }

        public EM0912S_CSR_MRPROITE(bool justACursor)
        {
        ...
        public string MRPROITE_PCT_DESC_FUNC_PUBL { get; set; }
        public string MRPROITE_PCT_DESC_COMERCIAL { get; set; }
        ...
        public override EM0912S_CSR_MRPROITE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0912S_CSR_MRPROITE();
            var i = 0;
            ...
            dta.MRPROITE_PCT_DESC_FUNC_PUBL = result[i++].Value?.ToString();
            dta.MRPROITE_PCT_DESC_COMERCIAL = result[i++].Value?.ToString();
