...
{
    public class R2340_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 : QueryBasis<R2340_00_INSERT_APOLICOB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2340_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 r2340_00_INSERT_APOLICOB_DB_INSERT_1_Insert1)
        {
            var ths = r2340_00_INSERT_APOLICOB_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2340_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
