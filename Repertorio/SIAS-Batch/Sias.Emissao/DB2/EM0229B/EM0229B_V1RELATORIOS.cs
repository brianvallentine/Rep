...
{
    public class EM0229B_V1RELATORIOS : QueryBasis<EM0229B_V1RELATORIOS>
    {
        ...
        public EM0229B_V1RELATORIOS() { IsCursor = true; }

        public EM0229B_V1RELATORIOS(bool justACursor)
        {
        ...
        public string V1RELA_NRPARCEL { get; set; }
        public string V1RELA_DTSOLIC { get; set; }
        ...
        public override EM0229B_V1RELATORIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0229B_V1RELATORIOS();
            var i = 0;
            ...
            dta.V1RELA_NRPARCEL = result[i++].Value?.ToString();
            dta.V1RELA_DTSOLIC = result[i++].Value?.ToString();
