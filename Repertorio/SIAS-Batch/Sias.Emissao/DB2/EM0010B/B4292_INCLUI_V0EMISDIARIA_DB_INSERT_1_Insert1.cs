...
{
    public class B4292_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1 : QueryBasis<B4292_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(B4292_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1 b4292_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1)
        {
            var ths = b4292_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override B4292_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
