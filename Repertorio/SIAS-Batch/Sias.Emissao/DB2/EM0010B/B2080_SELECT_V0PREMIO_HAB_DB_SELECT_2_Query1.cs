...
{
    public class B2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 : QueryBasis<B2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            SELECT VALUE(SUM(R.VAL_IOF_TOT),0) +
            ...
            SEGUROS.V0AGENTE_FINANC A
            WHERE
            R.COD_PRODUTO = :ENDO-CODPRODU
            AND R.COD_CLIENTE = :V0PRHA-CODCLIEN
            AND R.COD_ITEM < '3'
            AND R.COD_SUBESTIPULANTE = A.COD_AGENTE
            ...
            AND A.COD_SUBGRUPO = :ENDO-CODSUBES
            WITH UR
            END-EXEC
            */
            #endregion
            var query = @$"
				SELECT VALUE(SUM(R.VAL_IOF_TOT)
							,0) +
							...
							,
											...
											AND A.COD_SUBGRUPO = '{this.ENDO_CODSUBES}'
											WITH UR";
        ...
        public static B2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 Execute(B2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 b2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1)
        {
            var ths = b2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1;
        ...
        public override B2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new B2080_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1();
            var i = 0;
