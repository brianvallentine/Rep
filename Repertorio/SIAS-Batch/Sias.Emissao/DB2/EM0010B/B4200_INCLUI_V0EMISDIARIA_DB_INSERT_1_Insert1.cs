...
{
    public class B4200_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1 : QueryBasis<B4200_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(B4200_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1 b4200_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1)
        {
            var ths = b4200_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override B4200_INCLUI_V0EMISDIARIA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
