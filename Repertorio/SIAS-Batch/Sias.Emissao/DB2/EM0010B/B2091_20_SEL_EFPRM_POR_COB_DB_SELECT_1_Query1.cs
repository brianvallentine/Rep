...
{
    public class B2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1 : QueryBasis<B2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND A.NUM_APOLICE = :WHOST-NUM-APOLICE-EF
            AND F.COD_COBERTURA = :WHOST-COD-COBERTURA
            WITH UR
            END-EXEC.
            */
            #endregion
            var query = @$"
				SELECT VALUE(SUM(F.VLR_EMISSAO)
							...
							,
											...
											AND FE.SEQ_OPERACAO_FATUR = F.SEQ_OPERACAO
											AND A.NUM_CONTRATO = FE.NUM_CONTRATO_FATUR
											AND A.NUM_APOLICE = '{this.WHOST_NUM_APOLICE_EF}'
											AND F.COD_COBERTURA = '{this.WHOST_COD_COBERTURA}'
											WITH UR";
        ...
        public string WHOST_NUM_APOLICE_EF { get; set; }
        public string WHOST_COD_COBERTURA { get; set; }
        public string ENDO_NRENDOS { get; set; }

        public static B2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1 Execute(B2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1 b2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1)
        {
            var ths = b2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1;
        ...
        public override B2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new B2091_20_SEL_EFPRM_POR_COB_DB_SELECT_1_Query1();
            var i = 0;
