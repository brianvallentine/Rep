...
{
    public class EM0010B_V0ENDOS : QueryBasis<EM0010B_V0ENDOS>
    {
        ...
        public EM0010B_V0ENDOS() { IsCursor = true; }

        public EM0010B_V0ENDOS(bool justACursor)
        {
        ...
        public override EM0010B_V0ENDOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new EM0010B_V0ENDOS();
            var i = 0;
