...
{
    public class B2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 : QueryBasis<B2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static B2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 Execute(B2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 b2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1)
        {
            var ths = b2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1;
        ...
        public override B2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new B2081_SELECT_V0PREMIO_HAB_DB_SELECT_2_Query1();
            var i = 0;
