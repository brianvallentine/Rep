...
{
    public class R3110_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1 : QueryBasis<R3110_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3110_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1 r3110_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1)
        {
            var ths = r3110_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3110_00_INSERT_CBCONDEV_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
