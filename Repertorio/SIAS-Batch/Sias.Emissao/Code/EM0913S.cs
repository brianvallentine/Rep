...
using Dclgens;
using Copies;
using Sias.Emissao.DB2.EM0913S;

namespace Code
{
    public class EM0913S
    {
        ...
        /*"      * MR_APOL_ITEM_COND                   MR021             OUTPUT   *      */
        ...
        /*"77    WNULL-COD-COND             PIC S9(004)    VALUE +0  COMP.*/
        public IntBasis WNULL_COD_COND { get; set; } = new IntBasis(new PIC("S9", "4", "S9(004)"));
        /*"77    WNULL-DES-COND             PIC S9(004)    VALUE +0  COMP.*/
        public IntBasis WNULL_DES_COND { get; set; } = new IntBasis(new PIC("S9", "4", "S9(004)"));
        /*"77    WNULL-PROPOSTA-SIMU        PIC S9(004)    VALUE +0  COMP.*/
        public IntBasis WNULL_PROPOSTA_SIMU { get; set; } = new IntBasis(new PIC("S9", "4", "S9(004)"));
        ...
        /*"01           AREA-DE-WORK.*/
        public EM0913S_AREA_DE_WORK AREA_DE_WORK { get; set; } = new EM0913S_AREA_DE_WORK();
        public class EM0913S_AREA_DE_WORK : VarBasis
        {
            ...
            /*"  05         WFIM-MR023             PIC  X(001)    VALUE SPACES.*/
            public StringBasis WFIM_MR023 { get; set; } = new StringBasis(new PIC("X", "1", "X(001)"), @"");
            ...
            /*"  05         AC-S-MR023             PIC  9(004)    VALUE ZEROS.*/
            public IntBasis AC_S_MR023 { get; set; } = new IntBasis(new PIC("9", "4", "9(004)"));
            /*"  05         AC-I-MR021             PIC  9(004)    VALUE ZEROS.*/
            public IntBasis AC_I_MR021 { get; set; } = new IntBasis(new PIC("9", "4", "9(004)"));
            /*"  05        WABEND.*/
            public EM0913S_WABEND WABEND { get; set; } = new EM0913S_WABEND();
            public class EM0913S_WABEND : VarBasis
            {
                /*"    10      FILLER              PIC  X(010) VALUE           ' EM0913S'.*/
                public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" EM0913S");
        ...
        public EM0913S_LK_PROPOSTA LK_PROPOSTA { get; set; } = new EM0913S_LK_PROPOSTA();
        public class EM0913S_LK_PROPOSTA : VarBasis
        {
            ...
            /*"  05             LK-S-MR023           PIC  9(004).*/
            public IntBasis LK_S_MR023 { get; set; } = new IntBasis(new PIC("9", "4", "9(004)."));
            /*"  05             LK-I-MR021           PIC  9(004).*/
            public IntBasis LK_I_MR021 { get; set; } = new IntBasis(new PIC("9", "4", "9(004)."));
        ...
        public Dclgens.MR023 MR023 { get; set; } = new Dclgens.MR023();
        public EM0913S_CSR_MRPROITE CSR_MRPROITE { get; set; } = new EM0913S_CSR_MRPROITE();
        public EM0913S_CSR_MR023 CSR_MR023 { get; set; } = new EM0913S_CSR_MR023();
        public EM0913S_CSR_MRPROCOR CSR_MRPROCOR { get; set; } = new EM0913S_CSR_MRPROCOR();
        public EM0913S_V1PROPCLAU V1PROPCLAU { get; set; } = new EM0913S_V1PROPCLAU();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(EM0913S_LK_PROPOSTA EM0913S_LK_PROPOSTA_P) //PROCEDURE DIVISION USING 
        /*LK_PROPOSTA*/
        {
            try
            {
                this.LK_PROPOSTA = EM0913S_LK_PROPOSTA_P;

                /*" -178- MOVE '001' TO WNR-EXEC-SQL. */
                _.Move("001", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

                /*" -179- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

                /*" -182- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

                /*" -185- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

                /*" -185- FLUXCONTROL_PERFORM R0000-00-PRINCIPAL-SECTION */
        ...
        {
            /*" -208- MOVE ZEROS TO AC-S-MRPROITE AC-I-MRAPOITE AC-S-MRPROCOR AC-I-MRAPOCOB AC-S-MRPROBEN AC-I-MRPROBEN AC-S-BENSCOBER AC-I-BENSCOBER AC-S-PROPCLAU AC-I-APOLCLAU AC-S-PROPCOBER AC-I-APOLCOBER WS-TOT-IMP-SEGURADA-IX WS-TOT-IMP-SEGURADA-VAR WS-TOT-PRM-TARIFARIO-IX WS-TOT-PRM-TARIFARIO-VAR. */
            ...
            /*" -209- IF LK-CODPRODU EQUAL 99 */

            if (LK_PROPOSTA.LK_CODPRODU == 99)
            {

                /*" -211- GO TO R0000-90-FINAL. */
        ...
        {
            /*" -251- MOVE '100' TO WNR-EXEC-SQL. */
            _.Move("100", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -253- PERFORM R1100-00-SELECT-APOL-ENDOSSO */

            R1100_00_SELECT_APOL_ENDOSSO_SECTION();

            /*" -254- PERFORM R2100-00-DECLARE-MR-PROP-ITEM */

            R2100_00_DECLARE_MR_PROP_ITEM_SECTION();

            /*" -255- MOVE SPACES TO WFIM-MRPROITE */
            _.Move("", AREA_DE_WORK.WFIM_MRPROITE);

            /*" -258- PERFORM R2110-00-INSERT-MR-APOL-ITEM UNTIL WFIM-MRPROITE NOT EQUAL SPACES */
            ...
            /*" -259- PERFORM R2200-00-DECLARE-MR023 */

            R2200_00_DECLARE_MR023_SECTION();

            /*" -260- MOVE SPACES TO WFIM-MR023 */
            _.Move("", AREA_DE_WORK.WFIM_MR023);

            /*" -263- PERFORM R2210-00-INSERT-MR021 UNTIL WFIM-MR023 NOT EQUAL SPACES */

            while (!(!AREA_DE_WORK.WFIM_MR023.IsEmpty()))
            {

                R2210_00_INSERT_MR021_SECTION();
            }

            /*" -264- PERFORM R2300-00-DECLARE-MR-PROP-COBER */

            R2300_00_DECLARE_MR_PROP_COBER_SECTION();

            /*" -265- MOVE SPACES TO WFIM-MRPROCOR */
            _.Move("", AREA_DE_WORK.WFIM_MRPROCOR);

            /*" -268- PERFORM R2310-00-INSERT-MR-APOL-COBER UNTIL WFIM-MRPROCOR NOT EQUAL SPACES */
            ...
            /*" -270- PERFORM R2340-00-INSERT-APOLICOB. */

            R2340_00_INSERT_APOLICOB_SECTION();

            /*" -271- PERFORM R2600-00-DECLARE-PROP-CLAUS */

            R2600_00_DECLARE_PROP_CLAUS_SECTION();

            /*" -272- MOVE SPACES TO WFIM-PROPOCLA */
            _.Move("", AREA_DE_WORK.WFIM_PROPOCLA);

            /*" -273- PERFORM R2610-00-INSERT-APOL-CLAUS UNTIL WFIM-PROPOCLA NOT EQUAL SPACES. */
        ...
        {
            /*" -284- MOVE '110' TO WNR-EXEC-SQL. */
            _.Move("110", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -300- PERFORM R1100_00_SELECT_APOL_ENDOSSO_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -304- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -306- MOVE 'V1ENDOSSO (DOCUMENTO NAO CADASTRADO)' TO LK-RETORNO */
                ...
                else
                {
                    ...
                    /*" -310- MOVE 'PROBLEMAS NO SELECT (V1ENDOSSO) ... ' TO LK-RETORNO */
            ...
            /*" -313- IF VIND-CODPRODU LESS ZEROS */

            if (VIND_CODPRODU < 00)
            {

                /*" -313- MOVE ZEROS TO APOLICES-COD-PRODUTO. */
        ...
        {
            /*" -324- MOVE '210' TO WNR-EXEC-SQL. */
            _.Move("210", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -347- PERFORM R2100_00_DECLARE_MR_PROP_ITEM_DB_DECLARE_1 */

            R2100_00_DECLARE_MR_PROP_ITEM_DB_DECLARE_1();

            /*" -349- PERFORM R2100_00_DECLARE_MR_PROP_ITEM_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -354- MOVE 'PROBLEMAS NO OPEN (CSR-MRPROITE) ' TO LK-RETORNO */
        ...
        {
            /*" -349- EXEC SQL OPEN CSR-MRPROITE END-EXEC. */
        ...
        [StopWatch]
        /*" R2200-00-DECLARE-MR023-DB-DECLARE-1 */
        public void R2200_00_DECLARE_MR023_DB_DECLARE_1()
        {
            /*" -536- EXEC SQL DECLARE CSR-MR023 CURSOR FOR SELECT COD_FONTE, NUM_PROPOSTA, NUM_ITEM, NUM_TP_CONDOMINIO, NUM_PAVIMENTOS, NUM_ELEVADORES, NUM_PORTAO_ELETRON, NUM_VAGAS, NUM_UNID_AUTONOMA, PCT_DESC_COBERTURA, PCT_BONUS_RENOVCAO, PCT_DESC_PROMOCAO, PCT_DESC_CORRETOR , COD_BENEFICIARIO , DES_CLAUSULA_BENEF FROM SEGUROS.MR_PROP_ITEM_COND WHERE COD_FONTE = :WHOST-FONTE AND NUM_PROPOSTA = :WHOST-NRPROPOS ORDER BY NUM_ITEM END-EXEC. */
            CSR_MR023 = new EM0913S_CSR_MR023(true);
            string GetQuery_CSR_MR023()
            {
                var query = @$"SELECT COD_FONTE
							...
							, 
							DES_CLAUSULA_BENEF 
							FROM SEGUROS.MR_PROP_ITEM_COND 
							WHERE COD_FONTE = '{WHOST_FONTE}' 
							AND NUM_PROPOSTA = '{WHOST_NRPROPOS}' 
							ORDER BY NUM_ITEM";
            ...
            CSR_MR023.GetQueryEvent += GetQuery_CSR_MR023;
        ...
        {
            /*" -364- PERFORM R2120-00-FETCH-MR-PROP-ITEM */

            R2120_00_FETCH_MR_PROP_ITEM_SECTION();

            /*" -365- IF WFIM-MRPROITE NOT EQUAL SPACES */

            if (!AREA_DE_WORK.WFIM_MRPROITE.IsEmpty())
            {

                /*" -367- GO TO R2110-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R2110_99_SAIDA*/ //GOTO
                return;
            }


            /*" -369- PERFORM R2130-00-MONTA-MR-APOL-ITEM */

            R2130_00_MONTA_MR_APOL_ITEM_SECTION();

            /*" -371- MOVE '211' TO WNR-EXEC-SQL. */
            _.Move("211", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -413- PERFORM R2110_00_INSERT_MR_APOL_ITEM_DB_INSERT_1 */

            R2110_00_INSERT_MR_APOL_ITEM_DB_INSERT_1();

            /*" -416- IF SQLCODE EQUAL -803 */

            if (DB.SQLCODE == -803)
            {

                /*" -418- MOVE 'MR_APOLICE_ITEM (REGISTRO DUPLICADO)' TO LK-RETORNO */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -423- MOVE 'MR_APOLICE_ITEM (PROBLEMAS INSERCAO)' TO LK-RETORNO */
        ...
        public void R2110_00_INSERT_MR_APOL_ITEM_DB_INSERT_1()
        {
            ...
            var r2110_00_INSERT_MR_APOL_ITEM_DB_INSERT_1_Insert1 = new R2110_00_INSERT_MR_APOL_ITEM_DB_INSERT_1_Insert1()
            {
                ...
                WNULL_PROPOSTA_SIMU = WNULL_PROPOSTA_SIMU.ToString(),
            };
        ...
        {
            /*" -436- MOVE '212' TO WNR-EXEC-SQL. */
            _.Move("212", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -455- PERFORM R2120_00_FETCH_MR_PROP_ITEM_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -459- MOVE 'S' TO WFIM-MRPROITE */
                _.Move("S", AREA_DE_WORK.WFIM_MRPROITE);

                /*" -459- PERFORM R2120_00_FETCH_MR_PROP_ITEM_DB_CLOSE_1 */

                R2120_00_FETCH_MR_PROP_ITEM_DB_CLOSE_1();

                /*" -462- GO TO R2120-99-SAIDA. */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -466- DISPLAY 'PROBLEMAS NO FETCH (MR-PROPOSTA-ITEM) ... ' ' ' WHOST-FONTE ' ' WHOST-NRPROPOS */
        ...
        {
            /*" -455- EXEC SQL FETCH CSR-MRPROITE INTO :MRPROITE-NUM-ITEM, :MRPROITE-COD-PRODUTO, :MRPROITE-NUM-VERSAO, :MRPROITE-NUM-TP-MORA-IMOVEL, :MRPROITE-NUM-TP-OCUP-IMOVEL, :MRPROITE-DTH-INI-VIGENCIA, :MRPROITE-DTH-FIM-VIGENCIA, :MRPROITE-IND-TIPO-SEGURO, :MRPROITE-QTD-RENOVACAO, :MRPROITE-STA-PROPOSTA-ITEM, :MRPROITE-NUM-PROPOSTA-SIMU, :MRPROITE-OCORR-ENDERECO, :MRPROITE-PCT-DESC-FIDEL, :MRPROITE-PCT-DESC-AGRUP, :MRPROITE-PCT-DESC-EXPER, :MRPROITE-COD-CLIENTE , :MRPROITE-COD-BENEFICIARIO :WNULL-COD-BENEF, :MRPROITE-IND-RENOVACAO-AUT END-EXEC. */
        ...
        {
            /*" -459- EXEC SQL CLOSE CSR-MRPROITE END-EXEC */
        ...
        private void R2130_00_MONTA_MR_APOL_ITEM_SECTION()
        {
            ...
            else
            {
                ...
                /*" -505- MOVE MRPROITE-STA-PROPOSTA-ITEM TO MRAPOITE-STA-PROP-ITEM. */
        ...
        [StopWatch]
        /*" R2200-00-DECLARE-MR023-SECTION */
        private void R2200_00_DECLARE_MR023_SECTION()
        {
            /*" -516- MOVE '220' TO WNR-EXEC-SQL. */
            _.Move("220", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -536- PERFORM R2200_00_DECLARE_MR023_DB_DECLARE_1 */

            R2200_00_DECLARE_MR023_DB_DECLARE_1();

            /*" -538- PERFORM R2200_00_DECLARE_MR023_DB_OPEN_1 */

            R2200_00_DECLARE_MR023_DB_OPEN_1();
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -543- MOVE 'PROBLEMAS NO OPEN (CSR-MR023) ' TO LK-RETORNO */
                _.Move("PROBLEMAS NO OPEN (CSR-MR023) ", LK_PROPOSTA.LK_RETORNO);
        ...
        [StopWatch]
        /*" R2200-00-DECLARE-MR023-DB-OPEN-1 */
        public void R2200_00_DECLARE_MR023_DB_OPEN_1()
        {
            /*" -538- EXEC SQL OPEN CSR-MR023 END-EXEC. */
        ...
        [StopWatch]
        /*" R2210-00-INSERT-MR021-SECTION */
        private void R2210_00_INSERT_MR021_SECTION()
        {
            /*" -553- PERFORM R2220-00-FETCH-MR023 */

            R2220_00_FETCH_MR023_SECTION();

            /*" -554- IF WFIM-MR023 NOT EQUAL SPACES */

            if (!AREA_DE_WORK.WFIM_MR023.IsEmpty())
            {

                /*" -556- GO TO R2210-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R2210_99_SAIDA*/ //GOTO
                return;
            }


            /*" -558- PERFORM R2230-00-MONTA-MR023 . */

            R2230_00_MONTA_MR023_SECTION();

            /*" -560- MOVE '221' TO WNR-EXEC-SQL. */
            _.Move("221", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -594- PERFORM R2210_00_INSERT_MR021_DB_INSERT_1 */

            R2210_00_INSERT_MR021_DB_INSERT_1();

            /*" -597- IF SQLCODE EQUAL -803 */

            if (DB.SQLCODE == -803)
            {

                /*" -599- MOVE 'MR_APOLICE_ITEM_COND (REGISTRO DUPLICADO)' TO LK-RETORNO */
                _.Move("MR_APOLICE_ITEM_COND (REGISTRO DUPLICADO)", LK_PROPOSTA.LK_RETORNO);
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -604- MOVE 'MR_APOLICE_ITEM_COND (PROBLEMAS INSERCAO)' TO LK-RETORNO */
                _.Move("MR_APOLICE_ITEM_COND (PROBLEMAS INSERCAO)", LK_PROPOSTA.LK_RETORNO);
            ...
            /*" -606- ADD 1 TO AC-I-MR021. */
            AREA_DE_WORK.AC_I_MR021.Value = AREA_DE_WORK.AC_I_MR021 + 1;

        }

        [StopWatch]
        /*" R2210-00-INSERT-MR021-DB-INSERT-1 */
        public void R2210_00_INSERT_MR021_DB_INSERT_1()
        {
            /*" -594- EXEC SQL INSERT INTO SEGUROS.MR_APOL_ITEM_COND (NUM_APOLICE, NUM_ENDOSSO, NUM_ITEM, NUM_TP_CONDOMINIO, NUM_PAVIMENTOS, NUM_ELEVADORES, NUM_PORTAO_ELETRON, NUM_VAGAS, NUM_UNID_AUTONOMA, PCT_DESC_COBERTURA, PCT_BONUS_RENOVCAO, PCT_DESC_PROMOCAO, PCT_DESC_CORRETOR, DTH_CADASTRAMENTO , COD_BENEFICIARIO, DES_CLAUSULA_BENEF) VALUES (:MR021-NUM-APOLICE, :MR021-NUM-ENDOSSO, :MR021-NUM-ITEM, :MR021-NUM-TP-CONDOMINIO, :MR021-NUM-PAVIMENTOS, :MR021-NUM-ELEVADORES, :MR021-NUM-PORTAO-ELETRON, :MR021-NUM-VAGAS, :MR021-NUM-UNID-AUTONOMA, :MR021-PCT-DESC-COBERTURA, :MR021-PCT-BONUS-RENOVCAO, :MR021-PCT-DESC-PROMOCAO, :MR021-PCT-DESC-CORRETOR, CURRENT TIMESTAMP , :MR021-COD-BENEFICIARIO :WNULL-COD-COND , :MR021-DES-CLAUSULA-BENEF :WNULL-DES-COND ) END-EXEC. */

            var r2210_00_INSERT_MR021_DB_INSERT_1_Insert1 = new R2210_00_INSERT_MR021_DB_INSERT_1_Insert1()
            {
                MR021_NUM_APOLICE = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_APOLICE.ToString(),
                MR021_NUM_ENDOSSO = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_ENDOSSO.ToString(),
                MR021_NUM_ITEM = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_ITEM.ToString(),
                MR021_NUM_TP_CONDOMINIO = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_TP_CONDOMINIO.ToString(),
                MR021_NUM_PAVIMENTOS = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_PAVIMENTOS.ToString(),
                MR021_NUM_ELEVADORES = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_ELEVADORES.ToString(),
                MR021_NUM_PORTAO_ELETRON = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_PORTAO_ELETRON.ToString(),
                MR021_NUM_VAGAS = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_VAGAS.ToString(),
                MR021_NUM_UNID_AUTONOMA = MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_UNID_AUTONOMA.ToString(),
                MR021_PCT_DESC_COBERTURA = MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_DESC_COBERTURA.ToString(),
                MR021_PCT_BONUS_RENOVCAO = MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_BONUS_RENOVCAO.ToString(),
                MR021_PCT_DESC_PROMOCAO = MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_DESC_PROMOCAO.ToString(),
                MR021_PCT_DESC_CORRETOR = MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_DESC_CORRETOR.ToString(),
                MR021_COD_BENEFICIARIO = MR021.DCLMR_APOL_ITEM_COND.MR021_COD_BENEFICIARIO.ToString(),
                WNULL_COD_COND = WNULL_COD_COND.ToString(),
                MR021_DES_CLAUSULA_BENEF = MR021.DCLMR_APOL_ITEM_COND.MR021_DES_CLAUSULA_BENEF.ToString(),
                WNULL_DES_COND = WNULL_DES_COND.ToString(),
            };

            R2210_00_INSERT_MR021_DB_INSERT_1_Insert1.Execute(r2210_00_INSERT_MR021_DB_INSERT_1_Insert1);

        }
        /*Método Suprimido por falta de linha ou apenas EXIT nome: R2210_99_SAIDA*/

        [StopWatch]
        /*" R2220-00-FETCH-MR023-SECTION */
        private void R2220_00_FETCH_MR023_SECTION()
        {
            /*" -617- MOVE '222' TO WNR-EXEC-SQL. */
            _.Move("222", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -633- PERFORM R2220_00_FETCH_MR023_DB_FETCH_1 */

            R2220_00_FETCH_MR023_DB_FETCH_1();

            /*" -636- IF SQLCODE EQUAL 100 */

            if (DB.SQLCODE == 100)
            {

                /*" -637- MOVE 'S' TO WFIM-MR023 */
                _.Move("S", AREA_DE_WORK.WFIM_MR023);

                /*" -637- PERFORM R2220_00_FETCH_MR023_DB_CLOSE_1 */

                R2220_00_FETCH_MR023_DB_CLOSE_1();

                /*" -640- GO TO R2220-99-SAIDA. */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -644- DISPLAY 'PROBLEMAS NO FETCH (MR-PROPOSTA-ITEM-COND)..' ' ' WHOST-FONTE ' ' WHOST-NRPROPOS */

                $"PROBLEMAS NO FETCH (MR-PROPOSTA-ITEM-COND).. {WHOST_FONTE} {WHOST_NRPROPOS}"
                .Display();
            ...
            /*" -646- ADD 1 TO AC-S-MR023. */
            AREA_DE_WORK.AC_S_MR023.Value = AREA_DE_WORK.AC_S_MR023 + 1;

        }

        [StopWatch]
        /*" R2220-00-FETCH-MR023-DB-FETCH-1 */
        public void R2220_00_FETCH_MR023_DB_FETCH_1()
        {
            /*" -633- EXEC SQL FETCH CSR-MR023 INTO :MR023-COD-FONTE, :MR023-NUM-PROPOSTA, :MR023-NUM-ITEM, :MR023-NUM-TP-CONDOMINIO, :MR023-NUM-PAVIMENTOS, :MR023-NUM-ELEVADORES, :MR023-NUM-PORTAO-ELETRON, :MR023-NUM-VAGAS, :MR023-NUM-UNID-AUTONOMA, :MR023-PCT-DESC-COBERTURA, :MR023-PCT-BONUS-RENOVCAO, :MR023-PCT-DESC-PROMOCAO, :MR023-PCT-DESC-CORRETOR, :MR023-COD-BENEFICIARIO :WNULL-COD-COND , :MR023-DES-CLAUSULA-BENEF :WNULL-DES-COND END-EXEC. */

            if (CSR_MR023.Fetch())
            {
                _.Move(CSR_MR023.MR023_COD_FONTE, MR023.DCLMR_PROP_ITEM_COND.MR023_COD_FONTE);
                _.Move(CSR_MR023.MR023_NUM_PROPOSTA, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_PROPOSTA);
                _.Move(CSR_MR023.MR023_NUM_ITEM, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_ITEM);
                _.Move(CSR_MR023.MR023_NUM_TP_CONDOMINIO, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_TP_CONDOMINIO);
                _.Move(CSR_MR023.MR023_NUM_PAVIMENTOS, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_PAVIMENTOS);
                _.Move(CSR_MR023.MR023_NUM_ELEVADORES, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_ELEVADORES);
                _.Move(CSR_MR023.MR023_NUM_PORTAO_ELETRON, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_PORTAO_ELETRON);
                _.Move(CSR_MR023.MR023_NUM_VAGAS, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_VAGAS);
                _.Move(CSR_MR023.MR023_NUM_UNID_AUTONOMA, MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_UNID_AUTONOMA);
                _.Move(CSR_MR023.MR023_PCT_DESC_COBERTURA, MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_DESC_COBERTURA);
                _.Move(CSR_MR023.MR023_PCT_BONUS_RENOVCAO, MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_BONUS_RENOVCAO);
                _.Move(CSR_MR023.MR023_PCT_DESC_PROMOCAO, MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_DESC_PROMOCAO);
                _.Move(CSR_MR023.MR023_PCT_DESC_CORRETOR, MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_DESC_CORRETOR);
                _.Move(CSR_MR023.MR023_COD_BENEFICIARIO, MR023.DCLMR_PROP_ITEM_COND.MR023_COD_BENEFICIARIO);
                _.Move(CSR_MR023.WNULL_COD_COND, WNULL_COD_COND);
                _.Move(CSR_MR023.MR023_DES_CLAUSULA_BENEF, MR023.DCLMR_PROP_ITEM_COND.MR023_DES_CLAUSULA_BENEF);
                _.Move(CSR_MR023.WNULL_DES_COND, WNULL_DES_COND);
            }

        }

        [StopWatch]
        /*" R2220-00-FETCH-MR023-DB-CLOSE-1 */
        public void R2220_00_FETCH_MR023_DB_CLOSE_1()
        {
            /*" -637- EXEC SQL CLOSE CSR-MR023 END-EXEC */
        ...
        [StopWatch]
        /*" R2230-00-MONTA-MR023-SECTION */
        private void R2230_00_MONTA_MR023_SECTION()
        {
            /*" -657- MOVE '223' TO WNR-EXEC-SQL. */
            _.Move("223", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -658- MOVE WHOST-NUM-APOL TO MR021-NUM-APOLICE. */
            _.Move(WHOST_NUM_APOL, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_APOLICE);

            /*" -659- MOVE WHOST-NRENDOS TO MR021-NUM-ENDOSSO. */
            _.Move(WHOST_NRENDOS, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_ENDOSSO);

            /*" -660- MOVE MR023-NUM-ITEM TO MR021-NUM-ITEM. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_ITEM, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_ITEM);

            /*" -661- MOVE MR023-NUM-TP-CONDOMINIO TO MR021-NUM-TP-CONDOMINIO. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_TP_CONDOMINIO, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_TP_CONDOMINIO);

            /*" -662- MOVE MR023-NUM-PAVIMENTOS TO MR021-NUM-PAVIMENTOS. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_PAVIMENTOS, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_PAVIMENTOS);

            /*" -663- MOVE MR023-NUM-ELEVADORES TO MR021-NUM-ELEVADORES. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_ELEVADORES, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_ELEVADORES);

            /*" -664- MOVE MR023-NUM-PORTAO-ELETRON TO MR021-NUM-PORTAO-ELETRON. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_PORTAO_ELETRON, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_PORTAO_ELETRON);

            /*" -665- MOVE MR023-NUM-VAGAS TO MR021-NUM-VAGAS. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_VAGAS, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_VAGAS);

            /*" -666- MOVE MR023-NUM-UNID-AUTONOMA TO MR021-NUM-UNID-AUTONOMA. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_NUM_UNID_AUTONOMA, MR021.DCLMR_APOL_ITEM_COND.MR021_NUM_UNID_AUTONOMA);

            /*" -667- MOVE MR023-PCT-DESC-COBERTURA TO MR021-PCT-DESC-COBERTURA. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_DESC_COBERTURA, MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_DESC_COBERTURA);

            /*" -668- MOVE MR023-PCT-BONUS-RENOVCAO TO MR021-PCT-BONUS-RENOVCAO. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_BONUS_RENOVCAO, MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_BONUS_RENOVCAO);

            /*" -669- MOVE MR023-PCT-DESC-PROMOCAO TO MR021-PCT-DESC-PROMOCAO. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_DESC_PROMOCAO, MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_DESC_PROMOCAO);

            /*" -670- MOVE MR023-PCT-DESC-CORRETOR TO MR021-PCT-DESC-CORRETOR. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_PCT_DESC_CORRETOR, MR021.DCLMR_APOL_ITEM_COND.MR021_PCT_DESC_CORRETOR);

            /*" -671- MOVE MR023-COD-BENEFICIARIO TO MR021-COD-BENEFICIARIO. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_COD_BENEFICIARIO, MR021.DCLMR_APOL_ITEM_COND.MR021_COD_BENEFICIARIO);

            /*" -671- MOVE MR023-DES-CLAUSULA-BENEF TO MR021-DES-CLAUSULA-BENEF. */
            _.Move(MR023.DCLMR_PROP_ITEM_COND.MR023_DES_CLAUSULA_BENEF, MR021.DCLMR_APOL_ITEM_COND.MR021_DES_CLAUSULA_BENEF);
        ...
        {
            /*" -682- MOVE '230' TO WNR-EXEC-SQL. */
            _.Move("230", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -703- PERFORM R2300_00_DECLARE_MR_PROP_COBER_DB_DECLARE_1 */

            R2300_00_DECLARE_MR_PROP_COBER_DB_DECLARE_1();

            /*" -705- PERFORM R2300_00_DECLARE_MR_PROP_COBER_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -710- MOVE 'PROBLEMAS NO OPEN (CSR-MRPROCOR) ' TO LK-RETORNO */
        ...
        {
            /*" -705- EXEC SQL OPEN CSR-MRPROCOR END-EXEC. */
        ...
        {
            /*" -964- EXEC SQL DECLARE V1PROPCLAU CURSOR FOR SELECT COD_EMPRESA, RAMO_COBERTURA, MODALI_COBERTURA, COD_COBERTURA, DATA_INIVIGENCIA, DATA_TERVIGENCIA, NUM_ITEM, COD_CLAUSULA, LIMITE_INDENIZA_IX, TIPO_CLAUSULA FROM SEGUROS.PROPOSTA_CLAUSULAS WHERE COD_FONTE = :WHOST-FONTE AND NUM_PROPOSTA = :WHOST-NRPROPOS ORDER BY NUM_ITEM END-EXEC. */
            V1PROPCLAU = new EM0913S_V1PROPCLAU(true);
        ...
        {
            /*" -720- PERFORM R2320-00-FETCH-MR-PROP-COBER */

            R2320_00_FETCH_MR_PROP_COBER_SECTION();

            /*" -721- IF WFIM-MRPROCOR NOT EQUAL SPACES */

            if (!AREA_DE_WORK.WFIM_MRPROCOR.IsEmpty())
            {

                /*" -723- GO TO R2310-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R2310_99_SAIDA*/ //GOTO
                return;
            }


            /*" -725- PERFORM R2330-00-MONTA-MR-APOL-COBER */

            R2330_00_MONTA_MR_APOL_COBER_SECTION();

            /*" -727- MOVE '231' TO WNR-EXEC-SQL. */
            _.Move("231", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -765- PERFORM R2310_00_INSERT_MR_APOL_COBER_DB_INSERT_1 */

            R2310_00_INSERT_MR_APOL_COBER_DB_INSERT_1();

            /*" -768- IF SQLCODE EQUAL -803 */

            if (DB.SQLCODE == -803)
            {

                /*" -770- MOVE 'MR_APOLICE_COBER (REGISTRO DUPLICADO)' TO LK-RETORNO */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -775- MOVE 'MR_APOLICE_COBER (PROBLEMAS INSERCAO)' TO LK-RETORNO */
        ...
        {
            /*" -788- MOVE '232' TO WNR-EXEC-SQL. */
            _.Move("232", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -804- PERFORM R2320_00_FETCH_MR_PROP_COBER_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -808- MOVE 'S' TO WFIM-MRPROCOR */
                _.Move("S", AREA_DE_WORK.WFIM_MRPROCOR);

                /*" -808- PERFORM R2320_00_FETCH_MR_PROP_COBER_DB_CLOSE_1 */

                R2320_00_FETCH_MR_PROP_COBER_DB_CLOSE_1();

                /*" -811- GO TO R2320-99-SAIDA. */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -815- DISPLAY 'PROBLEMAS NO FETCH (CSR-MRPROCOR) ... ' ' ' WHOST-FONTE ' ' WHOST-NRPROPOS */
        ...
        {
            /*" -808- EXEC SQL CLOSE CSR-MRPROCOR END-EXEC */
        ...
        private void R2330_00_MONTA_MR_APOL_COBER_SECTION()
        {
            ...
            else
            {
                ...
                /*" -854- MOVE MRPROCOR-SIT-REGISTRO TO MRAPOCOB-SIT-REGISTRO. */
        ...
        private void R2340_00_INSERT_APOLICOB_SECTION()
        {
            ...
            if (DB.SQLCODE == -803)
            {
                ...
                /*" -931- MOVE 'APOLICE_COBERTURAS (REGISTRO DUPLICADO)' TO LK-RETORNO */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -936- MOVE 'APOLICE_COBERTURAS (PROBLEMAS INSERCAO)' TO LK-RETORNO */
        ...
        {
            /*" -949- MOVE '260' TO WNR-EXEC-SQL. */
            _.Move("260", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -964- PERFORM R2600_00_DECLARE_PROP_CLAUS_DB_DECLARE_1 */

            R2600_00_DECLARE_PROP_CLAUS_DB_DECLARE_1();

            /*" -966- PERFORM R2600_00_DECLARE_PROP_CLAUS_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -970- DISPLAY 'R2600-00 (ERRO DECLARE CLAUSULAS)' */
        ...
        {
            /*" -966- EXEC SQL OPEN V1PROPCLAU END-EXEC. */
        ...
        {
            /*" -980- PERFORM R2620-00-FETCH-PROP-CLAUS */

            R2620_00_FETCH_PROP_CLAUS_SECTION();

            /*" -981- IF WFIM-PROPOCLA NOT EQUAL SPACES */

            if (!AREA_DE_WORK.WFIM_PROPOCLA.IsEmpty())
            {

                /*" -983- GO TO R2610-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R2610_99_SAIDA*/ //GOTO
                return;
            }


            /*" -985- PERFORM R2630-00-MONTA-APOL-CLAUS */

            R2630_00_MONTA_APOL_CLAUS_SECTION();

            /*" -987- MOVE '263' TO WNR-EXEC-SQL. */
            _.Move("263", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1015- PERFORM R2610_00_INSERT_APOL_CLAUS_DB_INSERT_1 */

            R2610_00_INSERT_APOL_CLAUS_DB_INSERT_1();

            /*" -1018- IF SQLCODE EQUAL -803 */

            if (DB.SQLCODE == -803)
            {

                /*" -1021- DISPLAY 'R2610-00 (REGISTRO DUPLICADO) ... ' ' ' WHOST-FONTE ' ' WHOST-NRPROPOS */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1027- DISPLAY 'R2610-00 (PROBLEMAS NA INSERCAO) ... ' ' ' WHOST-FONTE ' ' WHOST-NRPROPOS */
        ...
        {
            /*" -1015- EXEC SQL INSERT INTO SEGUROS.APOLICE_CLAUSULAS (COD_EMPRESA, NUM_APOLICE, NUM_ENDOSSO, RAMO_COBERTURA, MODALI_COBERTURA, COD_COBERTURA , DATA_INIVIGENCIA, DATA_TERVIGENCIA, NUM_ITEM , COD_CLAUSULA , TIPO_CLAUSULA , LIMITE_INDENIZA_IX , TIMESTAMP) VALUES (:APOLICLA-COD-EMPRESA, :APOLICLA-NUM-APOLICE, :APOLICLA-NUM-ENDOSSO, :APOLICLA-RAMO-COBERTURA, :APOLICLA-MODALI-COBERTURA, :APOLICLA-COD-COBERTURA , :APOLICLA-DATA-INIVIGENCIA, :APOLICLA-DATA-TERVIGENCIA, :APOLICLA-NUM-ITEM , :APOLICLA-COD-CLAUSULA , :APOLICLA-TIPO-CLAUSULA , :APOLICLA-LIMITE-INDENIZA-IX , CURRENT TIMESTAMP) END-EXEC. */
        ...
        {
            /*" -1040- MOVE '262' TO WNR-EXEC-SQL. */
            _.Move("262", AREA_DE_WORK.WABEND.WNR_EXEC_SQL);

            /*" -1051- PERFORM R2620_00_FETCH_PROP_CLAUS_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1056- MOVE 'S' TO WFIM-PROPOCLA */
                    _.Move("S", AREA_DE_WORK.WFIM_PROPOCLA);

                    /*" -1056- PERFORM R2620_00_FETCH_PROP_CLAUS_DB_CLOSE_1 */

                    R2620_00_FETCH_PROP_CLAUS_DB_CLOSE_1();

                    /*" -1058- GO TO R2620-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -1060- DISPLAY 'R2620-00 (ERRO FETCH CLAUSULAS) ... ' */
        ...
        {
            /*" -1051- EXEC SQL FETCH V1PROPCLAU INTO :PROPOCLA-COD-EMPRESA, :PROPOCLA-RAMO-COBERTURA, :PROPOCLA-MODALI-COBERTURA, :PROPOCLA-COD-COBERTURA, :PROPOCLA-DATA-INIVIGENCIA, :PROPOCLA-DATA-TERVIGENCIA, :PROPOCLA-NUM-ITEM, :PROPOCLA-COD-CLAUSULA, :PROPOCLA-LIMITE-INDENIZA-IX, :PROPOCLA-TIPO-CLAUSULA END-EXEC. */
        ...
        {
            /*" -1056- EXEC SQL CLOSE V1PROPCLAU END-EXEC */
        ...
        {
            /*" -1095- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, AREA_DE_WORK.WABEND.WSQLCODE);

            /*" -1097- DISPLAY WABEND */
            _.Display(AREA_DE_WORK.WABEND);

            /*" -1097- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

            /*" -1099- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1103- MOVE 99 TO RETURN-CODE */
            _.Move(99, RETURN_CODE);

            /*" -1105- IF LK-RETORNO EQUAL SPACES OR LOW-VALUES */

            if (LK_PROPOSTA.LK_RETORNO.IsLowValues())
            {

                /*" -1107- MOVE ALL '*' TO LK-RETORNO. */
