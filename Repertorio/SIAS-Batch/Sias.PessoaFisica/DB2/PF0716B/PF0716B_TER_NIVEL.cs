...
{
    public class PF0716B_TER_NIVEL : QueryBasis<PF0716B_TER_NIVEL>
    {
        ...
        public PF0716B_TER_NIVEL() { IsCursor = true; }

        public PF0716B_TER_NIVEL(bool justACursor)
        {
        ...
        public override PF0716B_TER_NIVEL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0716B_TER_NIVEL();
            var i = 0;
