...
{
    public class PF0716B_COBERTURAS : QueryBasis<PF0716B_COBERTURAS>
    {
        ...
        public PF0716B_COBERTURAS() { IsCursor = true; }

        public PF0716B_COBERTURAS(bool justACursor)
        {
        ...
        public override PF0716B_COBERTURAS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0716B_COBERTURAS();
            var i = 0;
