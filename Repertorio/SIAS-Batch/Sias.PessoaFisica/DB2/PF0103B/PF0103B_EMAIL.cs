...
{
    public class PF0103B_EMAIL : QueryBasis<PF0103B_EMAIL>
    {
        ...
        public PF0103B_EMAIL() { IsCursor = true; }

        public PF0103B_EMAIL(bool justACursor)
        {
        ...
        public override PF0103B_EMAIL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0103B_EMAIL();
            var i = 0;
