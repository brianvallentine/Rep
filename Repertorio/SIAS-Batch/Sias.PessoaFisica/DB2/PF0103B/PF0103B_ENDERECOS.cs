...
{
    public class PF0103B_ENDERECOS : QueryBasis<PF0103B_ENDERECOS>
    {
        ...
        public PF0103B_ENDERECOS() { IsCursor = true; }

        public PF0103B_ENDERECOS(bool justACursor)
        {
        ...
        public override PF0103B_ENDERECOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0103B_ENDERECOS();
            var i = 0;
