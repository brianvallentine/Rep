...
{
    public class PF0103B_CFONTES : QueryBasis<PF0103B_CFONTES>
    {
        ...
        public PF0103B_CFONTES() { IsCursor = true; }

        public PF0103B_CFONTES(bool justACursor)
        {
        ...
        public override PF0103B_CFONTES OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0103B_CFONTES();
            var i = 0;
