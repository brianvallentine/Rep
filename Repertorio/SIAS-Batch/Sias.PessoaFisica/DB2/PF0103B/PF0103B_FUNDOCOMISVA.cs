...
{
    public class PF0103B_FUNDOCOMISVA : QueryBasis<PF0103B_FUNDOCOMISVA>
    {
        ...
        public PF0103B_FUNDOCOMISVA() { IsCursor = true; }

        public PF0103B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override PF0103B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0103B_FUNDOCOMISVA();
            var i = 0;
