...
{
    public class R0525_INCLUIR_PESSOA_FISICA_DB_INSERT_2_Insert1 : QueryBasis<R0525_INCLUIR_PESSOA_FISICA_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0525_INCLUIR_PESSOA_FISICA_DB_INSERT_2_Insert1 r0525_INCLUIR_PESSOA_FISICA_DB_INSERT_2_Insert1)
        {
            var ths = r0525_INCLUIR_PESSOA_FISICA_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0525_INCLUIR_PESSOA_FISICA_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
