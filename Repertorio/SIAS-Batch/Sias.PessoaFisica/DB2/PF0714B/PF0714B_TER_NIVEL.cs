...
{
    public class PF0714B_TER_NIVEL : QueryBasis<PF0714B_TER_NIVEL>
    {
        ...
        public PF0714B_TER_NIVEL() { IsCursor = true; }

        public PF0714B_TER_NIVEL(bool justACursor)
        {
        ...
        public override PF0714B_TER_NIVEL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0714B_TER_NIVEL();
            var i = 0;
