...
{
    public class PF0721B_CPAGAMENTOS : QueryBasis<PF0721B_CPAGAMENTOS>
    {
        ...
        public PF0721B_CPAGAMENTOS() { IsCursor = true; }

        public PF0721B_CPAGAMENTOS(bool justACursor)
        {
        ...
        public override PF0721B_CPAGAMENTOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0721B_CPAGAMENTOS();
            var i = 0;
