...
{
    public class PF0726B_CPAGAMENTOS : QueryBasis<PF0726B_CPAGAMENTOS>
    {
        ...
        public PF0726B_CPAGAMENTOS() { IsCursor = true; }

        public PF0726B_CPAGAMENTOS(bool justACursor)
        {
        ...
        public override PF0726B_CPAGAMENTOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0726B_CPAGAMENTOS();
            var i = 0;
