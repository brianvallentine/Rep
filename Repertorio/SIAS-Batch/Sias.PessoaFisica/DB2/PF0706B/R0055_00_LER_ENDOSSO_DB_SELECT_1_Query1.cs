...
{
    public class R0055_00_LER_ENDOSSO_DB_SELECT_1_Query1 : QueryBasis<R0055_00_LER_ENDOSSO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0055_00_LER_ENDOSSO_DB_SELECT_1_Query1 Execute(R0055_00_LER_ENDOSSO_DB_SELECT_1_Query1 r0055_00_LER_ENDOSSO_DB_SELECT_1_Query1)
        {
            var ths = r0055_00_LER_ENDOSSO_DB_SELECT_1_Query1;
        ...
        public override R0055_00_LER_ENDOSSO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0055_00_LER_ENDOSSO_DB_SELECT_1_Query1();
            var i = 0;
