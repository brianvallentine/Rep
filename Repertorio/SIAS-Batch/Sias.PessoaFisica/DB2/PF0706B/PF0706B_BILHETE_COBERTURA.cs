...
{
    public class PF0706B_BILHETE_COBERTURA : QueryBasis<PF0706B_BILHETE_COBERTURA>
    {
        ...
        public PF0706B_BILHETE_COBERTURA() { IsCursor = true; }

        public PF0706B_BILHETE_COBERTURA(bool justACursor)
        {
        ...
        public override PF0706B_BILHETE_COBERTURA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0706B_BILHETE_COBERTURA();
            var i = 0;
