...
{
    public class R0056_00_LER_ENDOSSO_DB_SELECT_1_Query1 : QueryBasis<R0056_00_LER_ENDOSSO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0056_00_LER_ENDOSSO_DB_SELECT_1_Query1 Execute(R0056_00_LER_ENDOSSO_DB_SELECT_1_Query1 r0056_00_LER_ENDOSSO_DB_SELECT_1_Query1)
        {
            var ths = r0056_00_LER_ENDOSSO_DB_SELECT_1_Query1;
        ...
        public override R0056_00_LER_ENDOSSO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0056_00_LER_ENDOSSO_DB_SELECT_1_Query1();
            var i = 0;
