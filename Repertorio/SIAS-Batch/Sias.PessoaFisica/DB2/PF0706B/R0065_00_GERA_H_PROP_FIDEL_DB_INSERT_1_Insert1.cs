...
{
    public class R0065_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1 : QueryBasis<R0065_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0065_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1 r0065_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1)
        {
            var ths = r0065_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0065_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
