...
{
    public class R0250_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 : QueryBasis<R0250_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0250_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 r0250_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1)
        {
            var ths = r0250_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0250_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
