...
{
    public class R3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1 : QueryBasis<R3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1 Execute(R3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1 r3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1)
        {
            var ths = r3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1;
        ...
        public override R3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3250_SELECT_V1ENDOSSO_DB_SELECT_1_Query1();
            var i = 0;
