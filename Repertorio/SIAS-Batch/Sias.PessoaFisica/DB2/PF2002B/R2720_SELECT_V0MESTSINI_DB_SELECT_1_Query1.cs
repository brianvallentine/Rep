...
{
    public class R2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1 : QueryBasis<R2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1 Execute(R2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1 r2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1)
        {
            var ths = r2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1;
        ...
        public override R2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2720_SELECT_V0MESTSINI_DB_SELECT_1_Query1();
            var i = 0;
