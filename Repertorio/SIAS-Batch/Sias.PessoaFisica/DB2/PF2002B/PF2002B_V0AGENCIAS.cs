...
{
    public class PF2002B_V0AGENCIAS : QueryBasis<PF2002B_V0AGENCIAS>
    {
        ...
        public PF2002B_V0AGENCIAS() { IsCursor = true; }

        public PF2002B_V0AGENCIAS(bool justACursor)
        {
        ...
        public override PF2002B_V0AGENCIAS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF2002B_V0AGENCIAS();
            var i = 0;
