...
{
    public class R2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1 : QueryBasis<R2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND P.NUM_TITULO_SIGCB = :SI111-NUM-TITULO-SIGCB
            WITH UR
            END-EXEC.
            */
            #endregion
            var query = @$"
				SELECT M.COD_PRODUTO 
							...
							,
											...
											AND P.NUM_APOL_SINISTRO = M.NUM_APOL_SINISTRO
											AND P.COD_OPERACAO = 4000
											AND P.NUM_TITULO_SIGCB = '{this.SI111_NUM_TITULO_SIGCB}'
											WITH UR";
        ...
        public string V0MSIN_NUM_NOSSO_TITULO { get; set; }
        public string SI111_NUM_APOL_SINISTRO { get; set; }
        public string SI111_NUM_TITULO_SIGCB { get; set; }

        public static R2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1 Execute(R2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1 r2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1)
        {
            var ths = r2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1;
        ...
        public override R2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2710_SELECT_V0MESTSINI_DB_SELECT_1_Query1();
            var i = 0;
            ...
            dta.V0MSIN_NUM_NOSSO_TITULO = result[i++].Value?.ToString();
            return dta;
        }
