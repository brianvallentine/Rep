...
{
    public class R6700_INCLUI_TARIFA_BALCAO_DB_INSERT_1_Insert1 : QueryBasis<R6700_INCLUI_TARIFA_BALCAO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R6700_INCLUI_TARIFA_BALCAO_DB_INSERT_1_Insert1 r6700_INCLUI_TARIFA_BALCAO_DB_INSERT_1_Insert1)
        {
            var ths = r6700_INCLUI_TARIFA_BALCAO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R6700_INCLUI_TARIFA_BALCAO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
