...
{
    public class R3750_INCLUI_V0RCAPCOMP_DB_INSERT_1_Insert1 : QueryBasis<R3750_INCLUI_V0RCAPCOMP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3750_INCLUI_V0RCAPCOMP_DB_INSERT_1_Insert1 r3750_INCLUI_V0RCAPCOMP_DB_INSERT_1_Insert1)
        {
            var ths = r3750_INCLUI_V0RCAPCOMP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3750_INCLUI_V0RCAPCOMP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
