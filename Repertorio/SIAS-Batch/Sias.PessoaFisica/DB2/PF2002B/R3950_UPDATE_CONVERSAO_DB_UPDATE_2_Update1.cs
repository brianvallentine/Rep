...
{
    public class R3950_UPDATE_CONVERSAO_DB_UPDATE_2_Update1 : QueryBasis<R3950_UPDATE_CONVERSAO_DB_UPDATE_2_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R3950_UPDATE_CONVERSAO_DB_UPDATE_2_Update1 r3950_UPDATE_CONVERSAO_DB_UPDATE_2_Update1)
        {
            var ths = r3950_UPDATE_CONVERSAO_DB_UPDATE_2_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3950_UPDATE_CONVERSAO_DB_UPDATE_2_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
