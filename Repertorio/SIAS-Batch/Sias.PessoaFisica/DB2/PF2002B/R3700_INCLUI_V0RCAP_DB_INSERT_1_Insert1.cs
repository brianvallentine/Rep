...
{
    public class R3700_INCLUI_V0RCAP_DB_INSERT_1_Insert1 : QueryBasis<R3700_INCLUI_V0RCAP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3700_INCLUI_V0RCAP_DB_INSERT_1_Insert1 r3700_INCLUI_V0RCAP_DB_INSERT_1_Insert1)
        {
            var ths = r3700_INCLUI_V0RCAP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3700_INCLUI_V0RCAP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
