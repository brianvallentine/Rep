...
{
    public class R4650_INCLUI_V0CONTROCNAB_DB_INSERT_1_Insert1 : QueryBasis<R4650_INCLUI_V0CONTROCNAB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4650_INCLUI_V0CONTROCNAB_DB_INSERT_1_Insert1 r4650_INCLUI_V0CONTROCNAB_DB_INSERT_1_Insert1)
        {
            var ths = r4650_INCLUI_V0CONTROCNAB_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4650_INCLUI_V0CONTROCNAB_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
