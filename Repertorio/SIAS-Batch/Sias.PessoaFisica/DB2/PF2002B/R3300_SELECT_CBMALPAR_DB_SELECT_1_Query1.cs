...
{
    public class R3300_SELECT_CBMALPAR_DB_SELECT_1_Query1 : QueryBasis<R3300_SELECT_CBMALPAR_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3300_SELECT_CBMALPAR_DB_SELECT_1_Query1 Execute(R3300_SELECT_CBMALPAR_DB_SELECT_1_Query1 r3300_SELECT_CBMALPAR_DB_SELECT_1_Query1)
        {
            var ths = r3300_SELECT_CBMALPAR_DB_SELECT_1_Query1;
        ...
        public override R3300_SELECT_CBMALPAR_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3300_SELECT_CBMALPAR_DB_SELECT_1_Query1();
            var i = 0;
