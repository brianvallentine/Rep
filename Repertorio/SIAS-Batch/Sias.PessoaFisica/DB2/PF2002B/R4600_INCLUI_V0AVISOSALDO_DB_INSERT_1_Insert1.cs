...
{
    public class R4600_INCLUI_V0AVISOSALDO_DB_INSERT_1_Insert1 : QueryBasis<R4600_INCLUI_V0AVISOSALDO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4600_INCLUI_V0AVISOSALDO_DB_INSERT_1_Insert1 r4600_INCLUI_V0AVISOSALDO_DB_INSERT_1_Insert1)
        {
            var ths = r4600_INCLUI_V0AVISOSALDO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4600_INCLUI_V0AVISOSALDO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
