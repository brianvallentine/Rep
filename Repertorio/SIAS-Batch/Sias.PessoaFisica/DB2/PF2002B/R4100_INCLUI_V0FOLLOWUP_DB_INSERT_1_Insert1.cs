...
{
    public class R4100_INCLUI_V0FOLLOWUP_DB_INSERT_1_Insert1 : QueryBasis<R4100_INCLUI_V0FOLLOWUP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4100_INCLUI_V0FOLLOWUP_DB_INSERT_1_Insert1 r4100_INCLUI_V0FOLLOWUP_DB_INSERT_1_Insert1)
        {
            var ths = r4100_INCLUI_V0FOLLOWUP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4100_INCLUI_V0FOLLOWUP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
