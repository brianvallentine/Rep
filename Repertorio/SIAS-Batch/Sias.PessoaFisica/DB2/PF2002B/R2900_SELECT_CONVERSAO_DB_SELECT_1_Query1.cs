...
{
    public class R2900_SELECT_CONVERSAO_DB_SELECT_1_Query1 : QueryBasis<R2900_SELECT_CONVERSAO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2900_SELECT_CONVERSAO_DB_SELECT_1_Query1 Execute(R2900_SELECT_CONVERSAO_DB_SELECT_1_Query1 r2900_SELECT_CONVERSAO_DB_SELECT_1_Query1)
        {
            var ths = r2900_SELECT_CONVERSAO_DB_SELECT_1_Query1;
        ...
        public override R2900_SELECT_CONVERSAO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2900_SELECT_CONVERSAO_DB_SELECT_1_Query1();
            var i = 0;
