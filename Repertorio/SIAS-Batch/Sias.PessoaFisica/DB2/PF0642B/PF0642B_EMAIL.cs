...
{
    public class PF0642B_EMAIL : QueryBasis<PF0642B_EMAIL>
    {
        ...
        public PF0642B_EMAIL() { IsCursor = true; }

        public PF0642B_EMAIL(bool justACursor)
        {
        ...
        public override PF0642B_EMAIL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0642B_EMAIL();
            var i = 0;
