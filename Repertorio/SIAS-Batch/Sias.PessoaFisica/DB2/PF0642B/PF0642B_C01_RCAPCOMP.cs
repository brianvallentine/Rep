...
{
    public class PF0642B_C01_RCAPCOMP : QueryBasis<PF0642B_C01_RCAPCOMP>
    {
        ...
        public PF0642B_C01_RCAPCOMP() { IsCursor = true; }

        public PF0642B_C01_RCAPCOMP(bool justACursor)
        {
        ...
        public override PF0642B_C01_RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0642B_C01_RCAPCOMP();
            var i = 0;
