...
{
    public class R3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1 : QueryBasis<R3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1 r3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1)
        {
            var ths = r3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
