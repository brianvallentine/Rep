...
{
    public class PF0642B_C01_ENDERECO : QueryBasis<PF0642B_C01_ENDERECO>
    {
        ...
        public PF0642B_C01_ENDERECO() { IsCursor = true; }

        public PF0642B_C01_ENDERECO(bool justACursor)
        {
        ...
        public override PF0642B_C01_ENDERECO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0642B_C01_ENDERECO();
            var i = 0;
