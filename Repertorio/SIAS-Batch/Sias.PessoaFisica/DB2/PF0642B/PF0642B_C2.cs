...
{
    public class PF0642B_C2 : QueryBasis<PF0642B_C2>
    {
        ...
        public PF0642B_C2() { IsCursor = true; }

        public PF0642B_C2(bool justACursor)
        {
        ...
        public override PF0642B_C2 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0642B_C2();
            var i = 0;
