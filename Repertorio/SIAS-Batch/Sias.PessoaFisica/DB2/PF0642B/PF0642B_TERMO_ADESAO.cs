...
{
    public class PF0642B_TERMO_ADESAO : QueryBasis<PF0642B_TERMO_ADESAO>
    {
        ...
        public PF0642B_TERMO_ADESAO() { IsCursor = true; }

        public PF0642B_TERMO_ADESAO(bool justACursor)
        {
        ...
        public override PF0642B_TERMO_ADESAO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0642B_TERMO_ADESAO();
            var i = 0;
            ...
            dta.VGCOMTRO_DTH_LIBERACAO = result[i++].Value?.ToString();
