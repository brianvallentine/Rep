...
{
    public class PF0642B_COBERTURAS : QueryBasis<PF0642B_COBERTURAS>
    {
        ...
        public PF0642B_COBERTURAS() { IsCursor = true; }

        public PF0642B_COBERTURAS(bool justACursor)
        {
        ...
        public override PF0642B_COBERTURAS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0642B_COBERTURAS();
            var i = 0;
