...
{
    public class R23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1 : QueryBasis<R23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1 Execute(R23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1 r23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1)
        {
            var ths = r23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1;
        ...
        public override R23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R23543_00_OBTER_COBER_COM_PRO_DB_SELECT_1_Query1();
            var i = 0;
