...
{
    public class R2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1 : QueryBasis<R2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1 Execute(R2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1 r2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1)
        {
            var ths = r2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1;
        ...
        public override R2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2352_00_OBTER_COBERTURA_DB_SELECT_1_Query1();
            var i = 0;
