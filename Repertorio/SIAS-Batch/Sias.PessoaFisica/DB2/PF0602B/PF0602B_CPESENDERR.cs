...
{
    public class PF0602B_CPESENDERR : QueryBasis<PF0602B_CPESENDERR>
    {
        ...
        public PF0602B_CPESENDERR() { IsCursor = true; }

        public PF0602B_CPESENDERR(bool justACursor)
        {
        ...
        public override PF0602B_CPESENDERR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0602B_CPESENDERR();
            var i = 0;
