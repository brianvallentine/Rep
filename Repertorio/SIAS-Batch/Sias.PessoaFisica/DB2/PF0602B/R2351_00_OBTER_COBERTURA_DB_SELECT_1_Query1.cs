...
{
    public class R2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1 : QueryBasis<R2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            var query = @$"
				SELECT COD_OPCAO_PLANO 
							,
											...
											AND PRM_TOTAL >=
											'{this.WHOST_PREMIO_MIN}'
											AND PRM_TOTAL <=
											'{this.WHOST_PREMIO_MAX}'
											AND DATA_INIVIGENCIA <=
											'{this.DATA_PROPOSTA}'
											AND DATA_TERVIGENCIA >=
											'{this.DATA_PROPOSTA}'
        ...
        public static R2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1 Execute(R2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1 r2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1)
        {
            var ths = r2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1;
        ...
        public override R2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2351_00_OBTER_COBERTURA_DB_SELECT_1_Query1();
            var i = 0;
