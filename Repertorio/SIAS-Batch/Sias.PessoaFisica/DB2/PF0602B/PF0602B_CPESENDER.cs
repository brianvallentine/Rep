...
{
    public class PF0602B_CPESENDER : QueryBasis<PF0602B_CPESENDER>
    {
        ...
        public PF0602B_CPESENDER() { IsCursor = true; }

        public PF0602B_CPESENDER(bool justACursor)
        {
        ...
        public override PF0602B_CPESENDER OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0602B_CPESENDER();
            var i = 0;
