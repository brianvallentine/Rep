...
{
    public class PF0602B_C01_GECLIMOV : QueryBasis<PF0602B_C01_GECLIMOV>
    {
        ...
        public PF0602B_C01_GECLIMOV() { IsCursor = true; }

        public PF0602B_C01_GECLIMOV(bool justACursor)
        {
        ...
        public override PF0602B_C01_GECLIMOV OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0602B_C01_GECLIMOV();
            var i = 0;
