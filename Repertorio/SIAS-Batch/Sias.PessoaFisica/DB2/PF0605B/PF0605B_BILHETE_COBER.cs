...
{
    public class PF0605B_BILHETE_COBER : QueryBasis<PF0605B_BILHETE_COBER>
    {
        ...
        public PF0605B_BILHETE_COBER() { IsCursor = true; }

        public PF0605B_BILHETE_COBER(bool justACursor)
        {
        ...
        public override PF0605B_BILHETE_COBER OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0605B_BILHETE_COBER();
            var i = 0;
