...
{
    public class R0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1 : QueryBasis<R0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1 Execute(R0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1 r0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1)
        {
            var ths = r0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1;
        ...
        public override R0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0586_00_ACESSA_MOVIMENTO_DB_SELECT_1_Query1();
            var i = 0;
