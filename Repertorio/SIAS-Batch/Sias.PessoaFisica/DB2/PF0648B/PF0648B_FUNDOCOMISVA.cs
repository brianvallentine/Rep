...
{
    public class PF0648B_FUNDOCOMISVA : QueryBasis<PF0648B_FUNDOCOMISVA>
    {
        ...
        public PF0648B_FUNDOCOMISVA() { IsCursor = true; }

        public PF0648B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override PF0648B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0648B_FUNDOCOMISVA();
            var i = 0;
