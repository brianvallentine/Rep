...
{
    public class PF0623B_EMAIL : QueryBasis<PF0623B_EMAIL>
    {
        ...
        public PF0623B_EMAIL() { IsCursor = true; }

        public PF0623B_EMAIL(bool justACursor)
        {
        ...
        public override PF0623B_EMAIL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0623B_EMAIL();
            var i = 0;
