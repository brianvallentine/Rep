...
{
    public class PF0623B_ENDERECOS : QueryBasis<PF0623B_ENDERECOS>
    {
        ...
        public PF0623B_ENDERECOS() { IsCursor = true; }

        public PF0623B_ENDERECOS(bool justACursor)
        {
        ...
        public override PF0623B_ENDERECOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0623B_ENDERECOS();
            var i = 0;
