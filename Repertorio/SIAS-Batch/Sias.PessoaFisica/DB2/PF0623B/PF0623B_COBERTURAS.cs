...
{
    public class PF0623B_COBERTURAS : QueryBasis<PF0623B_COBERTURAS>
    {
        ...
        public PF0623B_COBERTURAS() { IsCursor = true; }

        public PF0623B_COBERTURAS(bool justACursor)
        {
        ...
        public override PF0623B_COBERTURAS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0623B_COBERTURAS();
            var i = 0;
