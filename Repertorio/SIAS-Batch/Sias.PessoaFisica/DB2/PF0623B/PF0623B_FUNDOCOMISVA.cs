...
{
    public class PF0623B_FUNDOCOMISVA : QueryBasis<PF0623B_FUNDOCOMISVA>
    {
        ...
        public PF0623B_FUNDOCOMISVA() { IsCursor = true; }

        public PF0623B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override PF0623B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0623B_FUNDOCOMISVA();
            var i = 0;
