...
{
    public class PF0705B_PAGAMENTO : QueryBasis<PF0705B_PAGAMENTO>
    {
        ...
        public PF0705B_PAGAMENTO() { IsCursor = true; }

        public PF0705B_PAGAMENTO(bool justACursor)
        {
        ...
        public override PF0705B_PAGAMENTO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0705B_PAGAMENTO();
            var i = 0;
