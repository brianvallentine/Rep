...
{
    public class R0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1 : QueryBasis<R0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1 Execute(R0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1 r0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1)
        {
            var ths = r0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1;
        ...
        public override R0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0075_00_OBTER_PCT_IOF_DB_SELECT_1_Query1();
            var i = 0;
