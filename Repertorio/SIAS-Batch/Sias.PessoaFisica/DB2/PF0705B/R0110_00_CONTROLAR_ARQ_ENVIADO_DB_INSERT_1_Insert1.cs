...
{
    public class R0110_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 : QueryBasis<R0110_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0110_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 r0110_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1)
        {
            var ths = r0110_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0110_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
