...
{
    public class PF0100B_PROPOSTA_FIDELIZ : QueryBasis<PF0100B_PROPOSTA_FIDELIZ>
    {
        ...
        public PF0100B_PROPOSTA_FIDELIZ() { IsCursor = true; }

        public PF0100B_PROPOSTA_FIDELIZ(bool justACursor)
        {
        ...
        public override PF0100B_PROPOSTA_FIDELIZ OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0100B_PROPOSTA_FIDELIZ();
            var i = 0;
