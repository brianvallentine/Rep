...
{
    public class R0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1 : QueryBasis<R0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1 Execute(R0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1 r0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1)
        {
            var ths = r0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1;
        ...
        public override R0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0151_00_OBTER_MAX_NSAS_DB_SELECT_1_Query1();
            var i = 0;
