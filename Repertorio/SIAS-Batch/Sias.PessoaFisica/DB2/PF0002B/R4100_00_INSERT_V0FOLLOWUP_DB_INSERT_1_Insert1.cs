...
{
    public class R4100_00_INSERT_V0FOLLOWUP_DB_INSERT_1_Insert1 : QueryBasis<R4100_00_INSERT_V0FOLLOWUP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string V0FOLL_NUM_NOSSO_TITULO { get; set; }

        public static void Execute(R4100_00_INSERT_V0FOLLOWUP_DB_INSERT_1_Insert1 r4100_00_INSERT_V0FOLLOWUP_DB_INSERT_1_Insert1)
        {
            var ths = r4100_00_INSERT_V0FOLLOWUP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4100_00_INSERT_V0FOLLOWUP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
