...
namespace Sias.PessoaFisica.DB2.PF0002B
{
    public class R6100_00_INSERT_V0COMISFENAE_DB_INSERT_1_Insert1 : QueryBasis<R6100_00_INSERT_V0COMISFENAE_DB_INSERT_1_Insert1>
    {
        ...
        public string V0CFEN_NRMATRVEN { get; set; }
        public string V0CFEN_AGECTAVEN { get; set; }
        public string V0CFEN_OPRCTAVEN { get; set; }
        public string V0CFEN_NUMCTAVEN { get; set; }
        public string V0CFEN_DIGCTAVEN { get; set; }
