...
{
    public class R2680_00_GRAVA_MOVIMCOB_DB_INSERT_1_Insert1 : QueryBasis<R2680_00_GRAVA_MOVIMCOB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2680_00_GRAVA_MOVIMCOB_DB_INSERT_1_Insert1 r2680_00_GRAVA_MOVIMCOB_DB_INSERT_1_Insert1)
        {
            var ths = r2680_00_GRAVA_MOVIMCOB_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2680_00_GRAVA_MOVIMCOB_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
