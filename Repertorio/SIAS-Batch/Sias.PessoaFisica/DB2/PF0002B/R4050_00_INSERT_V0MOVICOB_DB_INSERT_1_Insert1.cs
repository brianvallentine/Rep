...
{
    public class R4050_00_INSERT_V0MOVICOB_DB_INSERT_1_Insert1 : QueryBasis<R4050_00_INSERT_V0MOVICOB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4050_00_INSERT_V0MOVICOB_DB_INSERT_1_Insert1 r4050_00_INSERT_V0MOVICOB_DB_INSERT_1_Insert1)
        {
            var ths = r4050_00_INSERT_V0MOVICOB_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4050_00_INSERT_V0MOVICOB_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
