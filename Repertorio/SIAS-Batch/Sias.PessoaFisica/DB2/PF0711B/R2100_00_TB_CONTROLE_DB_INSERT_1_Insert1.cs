...
{
    public class R2100_00_TB_CONTROLE_DB_INSERT_1_Insert1 : QueryBasis<R2100_00_TB_CONTROLE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2100_00_TB_CONTROLE_DB_INSERT_1_Insert1 r2100_00_TB_CONTROLE_DB_INSERT_1_Insert1)
        {
            var ths = r2100_00_TB_CONTROLE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2100_00_TB_CONTROLE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
