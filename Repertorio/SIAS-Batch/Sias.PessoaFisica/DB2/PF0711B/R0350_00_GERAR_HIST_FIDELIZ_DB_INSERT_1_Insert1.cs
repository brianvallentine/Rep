...
{
    public class R0350_00_GERAR_HIST_FIDELIZ_DB_INSERT_1_Insert1 : QueryBasis<R0350_00_GERAR_HIST_FIDELIZ_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0350_00_GERAR_HIST_FIDELIZ_DB_INSERT_1_Insert1 r0350_00_GERAR_HIST_FIDELIZ_DB_INSERT_1_Insert1)
        {
            var ths = r0350_00_GERAR_HIST_FIDELIZ_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0350_00_GERAR_HIST_FIDELIZ_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
