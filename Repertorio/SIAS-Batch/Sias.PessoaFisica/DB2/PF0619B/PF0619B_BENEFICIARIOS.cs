...
{
    public class PF0619B_BENEFICIARIOS : QueryBasis<PF0619B_BENEFICIARIOS>
    {
        ...
        public PF0619B_BENEFICIARIOS() { IsCursor = true; }

        public PF0619B_BENEFICIARIOS(bool justACursor)
        {
        ...
        public override PF0619B_BENEFICIARIOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0619B_BENEFICIARIOS();
            var i = 0;
