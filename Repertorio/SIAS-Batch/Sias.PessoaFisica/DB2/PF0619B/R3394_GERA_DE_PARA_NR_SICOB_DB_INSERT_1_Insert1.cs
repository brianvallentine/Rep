...
{
    public class R3394_GERA_DE_PARA_NR_SICOB_DB_INSERT_1_Insert1 : QueryBasis<R3394_GERA_DE_PARA_NR_SICOB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3394_GERA_DE_PARA_NR_SICOB_DB_INSERT_1_Insert1 r3394_GERA_DE_PARA_NR_SICOB_DB_INSERT_1_Insert1)
        {
            var ths = r3394_GERA_DE_PARA_NR_SICOB_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3394_GERA_DE_PARA_NR_SICOB_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
