...
{
    public class PF0619B_FUNDOCOMISVA : QueryBasis<PF0619B_FUNDOCOMISVA>
    {
        ...
        public PF0619B_FUNDOCOMISVA() { IsCursor = true; }

        public PF0619B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override PF0619B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0619B_FUNDOCOMISVA();
            var i = 0;
