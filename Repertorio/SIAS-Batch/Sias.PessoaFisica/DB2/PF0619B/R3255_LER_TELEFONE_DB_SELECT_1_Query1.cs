...
{
    public class R3255_LER_TELEFONE_DB_SELECT_1_Query1 : QueryBasis<R3255_LER_TELEFONE_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3255_LER_TELEFONE_DB_SELECT_1_Query1 Execute(R3255_LER_TELEFONE_DB_SELECT_1_Query1 r3255_LER_TELEFONE_DB_SELECT_1_Query1)
        {
            var ths = r3255_LER_TELEFONE_DB_SELECT_1_Query1;
        ...
        public override R3255_LER_TELEFONE_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3255_LER_TELEFONE_DB_SELECT_1_Query1();
            var i = 0;
