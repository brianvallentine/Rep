...
{
    public class PF0619B_PROPOSTAS_VA : QueryBasis<PF0619B_PROPOSTAS_VA>
    {
        ...
        public PF0619B_PROPOSTAS_VA() { IsCursor = true; }

        public PF0619B_PROPOSTAS_VA(bool justACursor)
        {
        ...
        public string DCLPROPOSTAS_VA_GRAU_PARENTESCO { get; set; }
        public string VIND_GRAU_PAREN { get; set; }
        public string DCLPROPOSTAS_VA_NUM_PROPOSTA { get; set; }
        public string VIND_NUM_PROPOSTA { get; set; }
        ...
        public string DCLPROPOSTAS_VA_COD_ORIGEM_PROPOSTA { get; set; }
        ...
        public override PF0619B_PROPOSTAS_VA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0619B_PROPOSTAS_VA();
            var i = 0;
            ...
            dta.DCLPROPOSTAS_VA_GRAU_PARENTESCO = result[i++].Value?.ToString();
            dta.VIND_GRAU_PAREN = string.IsNullOrWhiteSpace(dta.DCLPROPOSTAS_VA_GRAU_PARENTESCO) ? "-1" : "0";
            dta.DCLPROPOSTAS_VA_NUM_PROPOSTA = result[i++].Value?.ToString();
            dta.VIND_NUM_PROPOSTA = string.IsNullOrWhiteSpace(dta.DCLPROPOSTAS_VA_NUM_PROPOSTA) ? "-1" : "0";
            ...
            dta.DCLPROPOSTAS_VA_COD_ORIGEM_PROPOSTA = result[i++].Value?.ToString();
            dta.VIND_COD_ORIGEM_PROP = string.IsNullOrWhiteSpace(dta.DCLPROPOSTAS_VA_COD_ORIGEM_PROPOSTA) ? "-1" : "0";
