...
{
    public class PF0619B_ENDERECOS : QueryBasis<PF0619B_ENDERECOS>
    {
        ...
        public PF0619B_ENDERECOS() { IsCursor = true; }

        public PF0619B_ENDERECOS(bool justACursor)
        {
        ...
        public override PF0619B_ENDERECOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0619B_ENDERECOS();
            var i = 0;
