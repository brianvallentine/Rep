...
{
    public class R3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1 : QueryBasis<R3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1 Execute(R3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1 r3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1)
        {
            var ths = r3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1;
        ...
        public override R3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3105_LER_PESSOA_FISICA_DB_SELECT_1_Query1();
            var i = 0;
