...
{
    public class PF0619B_EMAIL : QueryBasis<PF0619B_EMAIL>
    {
        ...
        public PF0619B_EMAIL() { IsCursor = true; }

        public PF0619B_EMAIL(bool justACursor)
        {
        ...
        public override PF0619B_EMAIL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0619B_EMAIL();
            var i = 0;
