...
{
    public class R0900_TRATA_INF_COMPLEMENTARES_DB_INSERT_1_Insert1 : QueryBasis<R0900_TRATA_INF_COMPLEMENTARES_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0900_TRATA_INF_COMPLEMENTARES_DB_INSERT_1_Insert1 r0900_TRATA_INF_COMPLEMENTARES_DB_INSERT_1_Insert1)
        {
            var ths = r0900_TRATA_INF_COMPLEMENTARES_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0900_TRATA_INF_COMPLEMENTARES_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
