...
{
    public class PF0600B_ENDERECOS : QueryBasis<PF0600B_ENDERECOS>
    {
        ...
        public PF0600B_ENDERECOS() { IsCursor = true; }

        public PF0600B_ENDERECOS(bool justACursor)
        {
        ...
        public override PF0600B_ENDERECOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0600B_ENDERECOS();
            var i = 0;
