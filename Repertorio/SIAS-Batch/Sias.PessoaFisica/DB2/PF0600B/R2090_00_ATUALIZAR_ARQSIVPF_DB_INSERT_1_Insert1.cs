...
{
    public class R2090_00_ATUALIZAR_ARQSIVPF_DB_INSERT_1_Insert1 : QueryBasis<R2090_00_ATUALIZAR_ARQSIVPF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2090_00_ATUALIZAR_ARQSIVPF_DB_INSERT_1_Insert1 r2090_00_ATUALIZAR_ARQSIVPF_DB_INSERT_1_Insert1)
        {
            var ths = r2090_00_ATUALIZAR_ARQSIVPF_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2090_00_ATUALIZAR_ARQSIVPF_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
