...
{
    public class R0971_00_INS_PROP_FIDELIZ_COMP_DB_INSERT_1_Insert1 : QueryBasis<R0971_00_INS_PROP_FIDELIZ_COMP_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0971_00_INS_PROP_FIDELIZ_COMP_DB_INSERT_1_Insert1 r0971_00_INS_PROP_FIDELIZ_COMP_DB_INSERT_1_Insert1)
        {
            var ths = r0971_00_INS_PROP_FIDELIZ_COMP_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0971_00_INS_PROP_FIDELIZ_COMP_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
