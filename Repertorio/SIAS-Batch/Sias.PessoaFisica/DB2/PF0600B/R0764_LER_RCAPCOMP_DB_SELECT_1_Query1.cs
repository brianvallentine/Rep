...
{
    public class R0764_LER_RCAPCOMP_DB_SELECT_1_Query1 : QueryBasis<R0764_LER_RCAPCOMP_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0764_LER_RCAPCOMP_DB_SELECT_1_Query1 Execute(R0764_LER_RCAPCOMP_DB_SELECT_1_Query1 r0764_LER_RCAPCOMP_DB_SELECT_1_Query1)
        {
            var ths = r0764_LER_RCAPCOMP_DB_SELECT_1_Query1;
        ...
        public override R0764_LER_RCAPCOMP_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0764_LER_RCAPCOMP_DB_SELECT_1_Query1();
            var i = 0;
