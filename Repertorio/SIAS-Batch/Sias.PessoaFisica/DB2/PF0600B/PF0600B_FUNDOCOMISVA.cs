...
{
    public class PF0600B_FUNDOCOMISVA : QueryBasis<PF0600B_FUNDOCOMISVA>
    {
        ...
        public PF0600B_FUNDOCOMISVA() { IsCursor = true; }

        public PF0600B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override PF0600B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0600B_FUNDOCOMISVA();
            var i = 0;
