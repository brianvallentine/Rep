...
{
    public class R0860_TRATA_INC_CARTAO_DB_INSERT_2_Insert1 : QueryBasis<R0860_TRATA_INC_CARTAO_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0860_TRATA_INC_CARTAO_DB_INSERT_2_Insert1 r0860_TRATA_INC_CARTAO_DB_INSERT_2_Insert1)
        {
            var ths = r0860_TRATA_INC_CARTAO_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0860_TRATA_INC_CARTAO_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
