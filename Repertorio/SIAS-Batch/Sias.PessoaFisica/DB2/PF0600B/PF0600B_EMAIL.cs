...
{
    public class PF0600B_EMAIL : QueryBasis<PF0600B_EMAIL>
    {
        ...
        public PF0600B_EMAIL() { IsCursor = true; }

        public PF0600B_EMAIL(bool justACursor)
        {
        ...
        public override PF0600B_EMAIL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0600B_EMAIL();
            var i = 0;
