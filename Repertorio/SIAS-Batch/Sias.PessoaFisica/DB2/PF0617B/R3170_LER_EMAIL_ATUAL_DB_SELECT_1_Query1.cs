...
{
    public class R3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1 : QueryBasis<R3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1 Execute(R3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1 r3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1)
        {
            var ths = r3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1;
        ...
        public override R3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3170_LER_EMAIL_ATUAL_DB_SELECT_1_Query1();
            var i = 0;
