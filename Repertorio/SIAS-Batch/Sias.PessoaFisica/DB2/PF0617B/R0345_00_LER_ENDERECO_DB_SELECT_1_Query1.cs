...
{
    public class R0345_00_LER_ENDERECO_DB_SELECT_1_Query1 : QueryBasis<R0345_00_LER_ENDERECO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0345_00_LER_ENDERECO_DB_SELECT_1_Query1 Execute(R0345_00_LER_ENDERECO_DB_SELECT_1_Query1 r0345_00_LER_ENDERECO_DB_SELECT_1_Query1)
        {
            var ths = r0345_00_LER_ENDERECO_DB_SELECT_1_Query1;
        ...
        public override R0345_00_LER_ENDERECO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0345_00_LER_ENDERECO_DB_SELECT_1_Query1();
            var i = 0;
