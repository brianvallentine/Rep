...
{
    public class PF0617B_ENDERECOS : QueryBasis<PF0617B_ENDERECOS>
    {
        ...
        public PF0617B_ENDERECOS() { IsCursor = true; }

        public PF0617B_ENDERECOS(bool justACursor)
        {
        ...
        public override PF0617B_ENDERECOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0617B_ENDERECOS();
            var i = 0;
