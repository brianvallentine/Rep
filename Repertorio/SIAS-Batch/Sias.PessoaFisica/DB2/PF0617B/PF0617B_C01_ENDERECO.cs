...
{
    public class PF0617B_C01_ENDERECO : QueryBasis<PF0617B_C01_ENDERECO>
    {
        ...
        public PF0617B_C01_ENDERECO() { IsCursor = true; }

        public PF0617B_C01_ENDERECO(bool justACursor)
        {
        ...
        public override PF0617B_C01_ENDERECO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0617B_C01_ENDERECO();
            var i = 0;
