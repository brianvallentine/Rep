...
{
    public class PF0617B_C01_BILHETE : QueryBasis<PF0617B_C01_BILHETE>
    {
        ...
        public PF0617B_C01_BILHETE() { IsCursor = true; }

        public PF0617B_C01_BILHETE(bool justACursor)
        {
        ...
        public string DCLENDOSSOS_ENDOSSOS_NUM_APOLICE { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_NUM_ENDOSSO { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_NUM_PROPOSTA { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_DATA_PROPOSTA { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_DATA_EMISSAO { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_NUM_RCAP { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_VAL_RCAP { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_DATA_INIVIGENCIA { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_DATA_TERVIGENCIA { get; set; }
        public string DCLENDOSSOS_ENDOSSOS_COD_PRODUTO { get; set; }
        ...
        public override PF0617B_C01_BILHETE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0617B_C01_BILHETE();
            var i = 0;
            ...
            dta.DCLENDOSSOS_ENDOSSOS_NUM_APOLICE = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_NUM_ENDOSSO = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_NUM_PROPOSTA = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_DATA_PROPOSTA = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_DATA_EMISSAO = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_NUM_RCAP = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_VAL_RCAP = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_DATA_INIVIGENCIA = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_DATA_TERVIGENCIA = result[i++].Value?.ToString();
            dta.DCLENDOSSOS_ENDOSSOS_COD_PRODUTO = result[i++].Value?.ToString();
