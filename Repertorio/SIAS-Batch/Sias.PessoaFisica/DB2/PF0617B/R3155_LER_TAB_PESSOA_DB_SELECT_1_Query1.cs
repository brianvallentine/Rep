...
{
    public class R3155_LER_TAB_PESSOA_DB_SELECT_1_Query1 : QueryBasis<R3155_LER_TAB_PESSOA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3155_LER_TAB_PESSOA_DB_SELECT_1_Query1 Execute(R3155_LER_TAB_PESSOA_DB_SELECT_1_Query1 r3155_LER_TAB_PESSOA_DB_SELECT_1_Query1)
        {
            var ths = r3155_LER_TAB_PESSOA_DB_SELECT_1_Query1;
        ...
        public override R3155_LER_TAB_PESSOA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3155_LER_TAB_PESSOA_DB_SELECT_1_Query1();
            var i = 0;
