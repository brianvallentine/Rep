...
{
    public class PF0715B_COBERTURAS : QueryBasis<PF0715B_COBERTURAS>
    {
        ...
        public PF0715B_COBERTURAS() { IsCursor = true; }

        public PF0715B_COBERTURAS(bool justACursor)
        {
        ...
        public override PF0715B_COBERTURAS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0715B_COBERTURAS();
            var i = 0;
