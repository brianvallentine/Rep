...
{
    public class PF0003B_V0BILCOBER : QueryBasis<PF0003B_V0BILCOBER>
    {
        ...
        public PF0003B_V0BILCOBER() { IsCursor = true; }

        public PF0003B_V0BILCOBER(bool justACursor)
        {
        ...
        public string V0BCOB_DTTERVIG { get; set; }
        ...
        public override PF0003B_V0BILCOBER OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0003B_V0BILCOBER();
            var i = 0;
            ...
            dta.V0BCOB_DTTERVIG = result[i++].Value?.ToString();
