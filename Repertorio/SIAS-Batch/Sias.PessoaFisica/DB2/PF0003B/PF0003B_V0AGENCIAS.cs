...
{
    public class PF0003B_V0AGENCIAS : QueryBasis<PF0003B_V0AGENCIAS>
    {
        ...
        public PF0003B_V0AGENCIAS() { IsCursor = true; }

        public PF0003B_V0AGENCIAS(bool justACursor)
        {
        ...
        public override PF0003B_V0AGENCIAS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0003B_V0AGENCIAS();
            var i = 0;
