...
{
    public class PF0612B_ENDERECOS : QueryBasis<PF0612B_ENDERECOS>
    {
        ...
        public PF0612B_ENDERECOS() { IsCursor = true; }

        public PF0612B_ENDERECOS(bool justACursor)
        {
        ...
        public override PF0612B_ENDERECOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0612B_ENDERECOS();
            var i = 0;
