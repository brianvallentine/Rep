...
{
    public class PF0612B_MOVIMENTO_VGAP : QueryBasis<PF0612B_MOVIMENTO_VGAP>
    {
        ...
        public PF0612B_MOVIMENTO_VGAP() { IsCursor = true; }

        public PF0612B_MOVIMENTO_VGAP(bool justACursor)
        {
        ...
        public override PF0612B_MOVIMENTO_VGAP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0612B_MOVIMENTO_VGAP();
            var i = 0;
