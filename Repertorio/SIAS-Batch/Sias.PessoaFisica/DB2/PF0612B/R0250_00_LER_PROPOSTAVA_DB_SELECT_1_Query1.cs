...
namespace Sias.PessoaFisica.DB2.PF0612B
{
    public class R0250_00_LER_PROPOSTAVA_DB_SELECT_1_Query1 : QueryBasis<R0250_00_LER_PROPOSTAVA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            :DCLPROPOSTAS-VA.COD-ORIGEM-PROPOSTA
        ...
        public string COD_ORIGEM_PROPOSTA { get; set; }
        ...
        public override R0250_00_LER_PROPOSTAVA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.COD_ORIGEM_PROPOSTA = result[i++].Value?.ToString();
            dta.VIND_COD_ORIGEM_PROP = string.IsNullOrWhiteSpace(dta.COD_ORIGEM_PROPOSTA) ? "-1" : "0";
            return dta;
        }
