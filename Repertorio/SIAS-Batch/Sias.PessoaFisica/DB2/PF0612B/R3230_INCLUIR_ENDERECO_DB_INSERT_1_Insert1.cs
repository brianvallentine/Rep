...
{
    public class R3230_INCLUIR_ENDERECO_DB_INSERT_1_Insert1 : QueryBasis<R3230_INCLUIR_ENDERECO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3230_INCLUIR_ENDERECO_DB_INSERT_1_Insert1 r3230_INCLUIR_ENDERECO_DB_INSERT_1_Insert1)
        {
            var ths = r3230_INCLUIR_ENDERECO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3230_INCLUIR_ENDERECO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
