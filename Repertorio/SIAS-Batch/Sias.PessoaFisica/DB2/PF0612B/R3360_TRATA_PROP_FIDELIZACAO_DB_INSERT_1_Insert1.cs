...
namespace Sias.PessoaFisica.DB2.PF0612B
{
    public class R3360_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1 : QueryBasis<R3360_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            :DCLPROPOSTA-FIDELIZ.IND-TP-PROPOSTA,
