...
{
    public class PF0612B_FUNDOCOMISVA : QueryBasis<PF0612B_FUNDOCOMISVA>
    {
        ...
        public PF0612B_FUNDOCOMISVA() { IsCursor = true; }

        public PF0612B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override PF0612B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0612B_FUNDOCOMISVA();
            var i = 0;
