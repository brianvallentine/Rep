...
{
    public class R0500_00_LER_RCAP_DB_SELECT_2_Query1 : QueryBasis<R0500_00_LER_RCAP_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            = :DCLRCAPS.RCAPS-NUM-CERTIFICADO
            WITH UR
            END-EXEC
            */
            #endregion
        ...
        public static R0500_00_LER_RCAP_DB_SELECT_2_Query1 Execute(R0500_00_LER_RCAP_DB_SELECT_2_Query1 r0500_00_LER_RCAP_DB_SELECT_2_Query1)
        {
            var ths = r0500_00_LER_RCAP_DB_SELECT_2_Query1;
        ...
        public override R0500_00_LER_RCAP_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0500_00_LER_RCAP_DB_SELECT_2_Query1();
            var i = 0;
