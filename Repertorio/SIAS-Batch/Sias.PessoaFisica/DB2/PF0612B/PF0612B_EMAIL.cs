...
{
    public class PF0612B_EMAIL : QueryBasis<PF0612B_EMAIL>
    {
        ...
        public PF0612B_EMAIL() { IsCursor = true; }

        public PF0612B_EMAIL(bool justACursor)
        {
        ...
        public override PF0612B_EMAIL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0612B_EMAIL();
            var i = 0;
