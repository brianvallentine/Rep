...
{
    public class R3120_INCLUIR_TAB_PESSOA_DB_INSERT_1_Insert1 : QueryBasis<R3120_INCLUIR_TAB_PESSOA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3120_INCLUIR_TAB_PESSOA_DB_INSERT_1_Insert1 r3120_INCLUIR_TAB_PESSOA_DB_INSERT_1_Insert1)
        {
            var ths = r3120_INCLUIR_TAB_PESSOA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3120_INCLUIR_TAB_PESSOA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
