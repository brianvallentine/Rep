...
{
    public class R3125_INCLUIR_PESSOA_FISICA_DB_INSERT_1_Insert1 : QueryBasis<R3125_INCLUIR_PESSOA_FISICA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3125_INCLUIR_PESSOA_FISICA_DB_INSERT_1_Insert1 r3125_INCLUIR_PESSOA_FISICA_DB_INSERT_1_Insert1)
        {
            var ths = r3125_INCLUIR_PESSOA_FISICA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3125_INCLUIR_PESSOA_FISICA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
