...
{
    public class R0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1 : QueryBasis<R0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1 Execute(R0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1 r0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1)
        {
            var ths = r0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1;
        ...
        public override R0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0516_00_OBTER_DT_VIA_HIST_DB_SELECT_1_Query1();
            var i = 0;
