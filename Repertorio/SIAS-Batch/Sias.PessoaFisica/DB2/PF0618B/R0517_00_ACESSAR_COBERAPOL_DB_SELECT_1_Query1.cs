...
{
    public class R0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1 : QueryBasis<R0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1 Execute(R0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1 r0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1)
        {
            var ths = r0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1;
        ...
        public override R0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0517_00_ACESSAR_COBERAPOL_DB_SELECT_1_Query1();
            var i = 0;
