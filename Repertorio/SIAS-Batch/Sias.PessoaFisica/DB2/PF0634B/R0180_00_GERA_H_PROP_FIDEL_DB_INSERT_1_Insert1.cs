...
{
    public class R0180_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1 : QueryBasis<R0180_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :DCLHIST-PROP-FIDELIZ.PROPFIDH-NSAS-SIVPF ,
            :DCLHIST-PROP-FIDELIZ.PROPFIDH-NSL ,
            :DCLHIST-PROP-FIDELIZ.PROPFIDH-SIT-PROPOSTA ,
            :DCLHIST-PROP-FIDELIZ.PROPFIDH-SIT-COBRANCA-SIVPF,
            :DCLHIST-PROP-FIDELIZ.PROPFIDH-SIT-MOTIVO-SIVPF ,
            :DCLHIST-PROP-FIDELIZ.PROPFIDH-COD-EMPRESA-SIVPF ,
            :DCLHIST-PROP-FIDELIZ.PROPFIDH-COD-PRODUTO-SIVPF)
            END-EXEC.
            */
            #endregion
            var query = @$"
        ...
        public static void Execute(R0180_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1 r0180_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1)
        {
            var ths = r0180_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0180_00_GERA_H_PROP_FIDEL_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
