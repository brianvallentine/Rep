...
{
    public class R0230_00_LER_ENDOSSO_DB_SELECT_1_Query1 : QueryBasis<R0230_00_LER_ENDOSSO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0230_00_LER_ENDOSSO_DB_SELECT_1_Query1 Execute(R0230_00_LER_ENDOSSO_DB_SELECT_1_Query1 r0230_00_LER_ENDOSSO_DB_SELECT_1_Query1)
        {
            var ths = r0230_00_LER_ENDOSSO_DB_SELECT_1_Query1;
        ...
        public override R0230_00_LER_ENDOSSO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0230_00_LER_ENDOSSO_DB_SELECT_1_Query1();
            var i = 0;
