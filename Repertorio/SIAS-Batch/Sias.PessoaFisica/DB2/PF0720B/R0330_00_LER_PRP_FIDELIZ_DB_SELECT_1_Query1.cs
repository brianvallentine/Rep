...
{
    public class R0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1 : QueryBasis<R0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            WHERE A.NUM_PROPOSTA_SIVPF = :PROPOFID-NUM-PROPOSTA-SIVPF
            ...
            */
            ...
            var query = @$"
				SELECT A.NUM_PROPOSTA_SIVPF
							...
							,
											SEGUROS.IDENTIFICA_RELAC B
											WHERE A.NUM_PROPOSTA_SIVPF = '{this.PROPOFID_NUM_PROPOSTA_SIVPF}'
											AND B.NUM_IDENTIFICACAO = A.NUM_IDENTIFICACAO
											AND A.COD_PRODUTO_SIVPF <> 48
        ...
        public static R0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1 Execute(R0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1 r0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1)
        {
            var ths = r0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1;
        ...
        public override R0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0330_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1();
            var i = 0;
