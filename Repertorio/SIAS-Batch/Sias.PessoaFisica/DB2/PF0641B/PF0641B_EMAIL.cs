...
{
    public class PF0641B_EMAIL : QueryBasis<PF0641B_EMAIL>
    {
        ...
        public PF0641B_EMAIL() { IsCursor = true; }

        public PF0641B_EMAIL(bool justACursor)
        {
        ...
        public override PF0641B_EMAIL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0641B_EMAIL();
            var i = 0;
