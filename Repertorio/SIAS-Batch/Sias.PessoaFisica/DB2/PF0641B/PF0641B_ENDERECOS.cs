...
{
    public class PF0641B_ENDERECOS : QueryBasis<PF0641B_ENDERECOS>
    {
        ...
        public PF0641B_ENDERECOS() { IsCursor = true; }

        public PF0641B_ENDERECOS(bool justACursor)
        {
        ...
        public override PF0641B_ENDERECOS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new PF0641B_ENDERECOS();
            var i = 0;
