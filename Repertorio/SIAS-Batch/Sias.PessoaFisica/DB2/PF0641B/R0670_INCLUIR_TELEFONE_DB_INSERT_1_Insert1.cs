...
{
    public class R0670_INCLUIR_TELEFONE_DB_INSERT_1_Insert1 : QueryBasis<R0670_INCLUIR_TELEFONE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0670_INCLUIR_TELEFONE_DB_INSERT_1_Insert1 r0670_INCLUIR_TELEFONE_DB_INSERT_1_Insert1)
        {
            var ths = r0670_INCLUIR_TELEFONE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0670_INCLUIR_TELEFONE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
