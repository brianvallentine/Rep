...
{
    [Collection("PF0642B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package01)]
    public class PF0642B_Tests
    {
        ...
        private static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("R0020_00_OBTER_MAX_NSAS_DB_SELECT_2_Query1", q2);

            #endregion

            #region PF0642B_TERMO_ADESAO
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_TERMO_ADESAO", q3);
            ...
            AppSettings.TestSet.DynamicData.Add("R0085_00_LER_PRODUTOS_SIVPF_DB_SELECT_1_Query1", q4);
            ...
            AppSettings.TestSet.DynamicData.Add("R0205_00_LER_RCAPCOMP_DB_SELECT_1_Query1", q6);

            #endregion

            #region PF0642B_C01_RCAPCOMP
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_C01_RCAPCOMP", q7);
            ...
            AppSettings.TestSet.DynamicData.Add("R0210_00_LER_PRP_FIDELIZ_DB_SELECT_1_Query1", q8);
            ...
            q9.AddDynamic(new Dictionary<string, string>{
                ...
                { "CLIENTES_COD_NATUREZA_ATIV" , ""},
                { "CLIENTES_COD_RAMO_ATIVIDADE" , ""},
                { "CLIENTES_COD_ATIVIDADE" , ""},
            });
            AppSettings.TestSet.DynamicData.Add("R0300_00_LER_CLIENTE_DB_SELECT_1_Query1", q9);

            #endregion

            #region PF0642B_C01_ENDERECO
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_C01_ENDERECO", q10);
            ...
            AppSettings.TestSet.DynamicData.Add("R0400_00_LER_SUBGRUPO_DB_SELECT_1_Query1", q11);
            ...
            AppSettings.TestSet.DynamicData.Add("R0500_00_OBTER_OPCAOPAG_DB_SELECT_1_Query1", q12);

            #endregion

            #region PF0642B_COBERTURAS
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_COBERTURAS", q13);

            #endregion

            #region R0470_00_LER_PROPOSTA_DB_SELECT_1_Query1
            ...
            AppSettings.TestSet.DynamicData.Add("R0470_00_LER_PROPOSTA_DB_SELECT_1_Query1", q14);

            #endregion

            #region PF0642B_FUNDOCOMISVA
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_FUNDOCOMISVA", q15);
            ...
            #region R0708_OBTER_VALOR_FATURA_DB_SELECT_1_Query1

            var q17 = new DynamicData();
            q17.AddDynamic(new Dictionary<string, string>{
                { "VGFUNCOB_VLR_PREMIO" , ""}
            });
            AppSettings.TestSet.DynamicData.Add("R0708_OBTER_VALOR_FATURA_DB_SELECT_1_Query1", q17);
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_C2", q18);

            #endregion

            #region PF0642B_FUNCIONARIOS
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_FUNCIONARIOS", q19);

            #endregion

            #region PF0642B_COBERFUNC

            var q20 = new DynamicData();
            q20.AddDynamic(new Dictionary<string, string>{
                { "VGFUNCOB_NUM_PROPOSTA_SIVPF" , ""},
                { "VGFUNCOB_DTH_INI_VIGENCIA" , ""},
                { "VGFUNCOB_NUM_CPF" , ""},
                { "VGFUNCOB_COD_GARANTIA" , ""},
                { "VGFUNCOB_IMP_SEGURADA" , ""},
                { "VGFUNCOB_VLR_PREMIO" , ""},
                { "VGFUNCOB_VLR_TAXA_CALC_PRM" , ""},
                { "VGMOVFUN_NUM_MATRICULA" , ""},
            });
            AppSettings.TestSet.DynamicData.Add("PF0642B_COBERFUNC", q20);
            ...
            AppSettings.TestSet.DynamicData.Add("R0860_LER_APOLICE_DB_SELECT_1_Query1", q21);
            ...
            AppSettings.TestSet.DynamicData.Add("R0870_LER_RAMOIND_DB_SELECT_1_Query1", q22);
            ...
            AppSettings.TestSet.DynamicData.Add("R1050_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1", q23);
            ...
            AppSettings.TestSet.DynamicData.Add("R1050_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_2_Insert1", q24);
            ...
            AppSettings.TestSet.DynamicData.Add("R3130_INCLUIR_PESSOA_JURIDICA_DB_INSERT_1_Insert1", q28);

            #endregion

            #region PF0642B_EMAIL
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_EMAIL", q29);
            ...
            AppSettings.TestSet.DynamicData.Add("R3140_OBTER_MAX_EMAIL_DB_SELECT_1_Query1", q30);
            ...
            AppSettings.TestSet.DynamicData.Add("R3141_INCLUIR_EMAIL_DB_INSERT_1_Insert1", q31);
            ...
            AppSettings.TestSet.DynamicData.Add("R3155_LER_TAB_PESSOA_DB_SELECT_1_Query1", q32);
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_ENDERECOS", q35);
            ...
            AppSettings.TestSet.DynamicData.Add("R3320_VERIFICA_EXISTE_RELACION_DB_SELECT_1_Query1", q41);
            ...
            AppSettings.TestSet.DynamicData.Add("R3330_GERA_RELACIONAMENTO_DB_INSERT_1_Insert1", q42);
            ...
            AppSettings.TestSet.DynamicData.Add("R3350_TRATA_TAB_IDE_RELACIONAM_DB_INSERT_1_Insert1", q43);
            ...
            AppSettings.TestSet.DynamicData.Add("R3355_OBTER_MAX_ID_RELACIONAM_DB_SELECT_1_Query1", q44);
            ...
            AppSettings.TestSet.DynamicData.Add("R3360_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1", q45);

            #endregion

            #region R3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1
            ...
            AppSettings.TestSet.DynamicData.Add("R3370_GERA_PROP_VIDA_DB_INSERT_1_Insert1", q46);
            ...
            AppSettings.TestSet.DynamicData.Add("R3390_GERA_HIST_FIDELIZACAO_DB_INSERT_1_Insert1", q47);

            #endregion

            #region PF0642B_C01_AGENCEF
            ...
            AppSettings.TestSet.DynamicData.Add("PF0642B_C01_AGENCEF", q48);
        ...
        [Theory]
        [InlineData("MOVTO_PRP_SASSE_FILE_01.txt", "MOVTO_STA_SASSE_FILE_01.txt")]
        public static void PF0642B_Tests_Theory(string MOVTO_PRP_SASSE_FILE_NAME_P, string MOVTO_STA_SASSE_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                //R1050_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_2_Insert1
                ...
                Assert.True(envList[1].TryGetValue("ARQSIVPF_NSAS_SIVPF", out valor) && valor == "000000001");
