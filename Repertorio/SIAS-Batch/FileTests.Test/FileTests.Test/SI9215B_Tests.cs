...
using Dclgens;
using Code;
using static Code.SI9215B;

namespace FileTests.Test
{
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    [Collection("SI9215B_Tests")]
    public class SI9215B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI9215B_C01_SIARDEVC", q5);
            ...
            AppSettings.TestSet.DynamicData.Add("R1210_00_LE_MOVDEBCE_DB_SELECT_1_Query1", q7);
            ...
            AppSettings.TestSet.DynamicData.Add("R1250_00_LE_SINISMES_DB_SELECT_1_Query1", q8);
            ...
            AppSettings.TestSet.DynamicData.Add("R1260_00_LE_LOTECHEQ_DB_SELECT_1_Query1", q9);
            ...
            AppSettings.TestSet.DynamicData.Add("R1300_00_INCLUI_SIARREVC_DB_INSERT_1_Insert1", q10);
            ...
            AppSettings.TestSet.DynamicData.Add("R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1_Update1", q11);
        ...
        [Theory]
        [InlineData("SI9215B_OUTPUT_202504150001")]
        public static void SI9215B_Tests_Theory_Erro99(string CSPAGSIN_FILE_NAME_P)
        {
        ...
        [Theory]
        [InlineData("SI9215B_OUTPUT_202504150000")]
        public static void SI9215B_Tests_Theory(string CSPAGSIN_FILE_NAME_P)
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                Assert.True(envList[1].TryGetValue("GEARDETA_SEQ_GERACAO", out var valor5) && valor.Contains("1"));
                Assert.True(envList.Count > 1);
