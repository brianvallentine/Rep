...
namespace FileTests.Test_DB
{
    ...
    [Collection("SI0105B_Tests_DB")]
    public class SI0105B_Tests_DB
    {
        private static string pData = "2020-02-02";
        [Fact]
        public static void SI0105B_Database()
        {
            ...
            try { /*5*/ program.M_000_600_UPDATE_V1RELATORIOS_DB_DELETE_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*6*/ program.M_200_100_SELECT_V1RAMO_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*7*/ program.M_300_100_SELECT_V1FONTE_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
