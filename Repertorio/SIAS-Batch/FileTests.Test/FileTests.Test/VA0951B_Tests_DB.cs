...
{
    [Collection("VA0951B_Tests_DB")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.DatabaseTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    public class VA0951B_Tests_DB
    {

        [Fact]
        public static void VA0951B_Database()
        {
            ...
            try
            { /*3*/
                program.V1SIST_DTMOVABE.Value = "2025-01-27";
                program.WHOST_DT_INICIO.Value = "2025-01-01";
                program.WHOST_DT_FIM.Value = "2025-01-01";
                program.R0900_00_DECLARE_PROPOVA_DB_DECLARE_1(); program.R0900_00_DECLARE_PROPOVA_DB_OPEN_1();
            }
            ...
            try { /*14*/ program.R3115_00_UPDATE_MOVIMENTO_DB_UPDATE_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*15*/ program.R3116_00_UPDATE_PREP_MVMTO_DB_UPDATE_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*16*/ program.R3190_00_SELECT_ESCNEG_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
