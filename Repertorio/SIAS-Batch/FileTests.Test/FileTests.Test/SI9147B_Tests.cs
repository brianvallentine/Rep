...
using Xunit;
using Code;
using static Code.SI9147B;

namespace FileTests.Test
{
    [Collection("SI9147B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    public class SI9147B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI9147B_C01_SIARDEVC", q5);
        ...
        [Theory]
        [InlineData("SI9147B_OUTPUT_202504150000")]
        public static void SI9147B_Tests_Theory(string CVPAGSIN_FILE_NAME_P)
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                var insert1 = AppSettings.TestSet.DynamicData["R0520_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1"].DynamicList;
                Assert.True(insert1?.Count > 1);
                Assert.True(insert1[1].TryGetValue("GEARDETA_SEQ_GERACAO", out var valOr1) && valOr1 == "000000001");

                var insert2 = AppSettings.TestSet.DynamicData["R0520_00_INCLUI_GEARDETA_DB_INSERT_1_Insert1"].DynamicList;
                Assert.True(insert2?.Count > 1);
                Assert.True(insert2[1].TryGetValue("GEARDETA_SEQ_GERACAO", out var valOr2) && valOr2 == "000000001");
        ...
        [Theory]
        [InlineData("SI9147B_OUTPUT_202504150001")]
        public static void SI9147B_Tests_Theory_Error_99(string CVPAGSIN_FILE_NAME_P)
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
