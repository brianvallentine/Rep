...
namespace FileTests.Test_DB
{
    ...
    [Collection("SI9215B_Tests_DB")]
    public class SI9215B_Tests_DB
    {
        private static string pData = "2020-02-02";

        [Fact]
        public static void SI9215B_Database()
        {
            ...
            try { /*8*/ program.R1210_00_LE_MOVDEBCE_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*9*/ program.R1250_00_LE_SINISMES_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*10*/ program.R1260_00_LE_LOTECHEQ_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*11*/ program.R1300_00_INCLUI_SIARREVC_DB_INSERT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*12*/ program.R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
