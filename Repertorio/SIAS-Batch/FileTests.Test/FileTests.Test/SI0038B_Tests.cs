...
using Xunit;
using Code;
using static Code.SI0038B;
using System.IO;

namespace FileTests.Test
{
    [Collection("SI0038B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    public class SI0038B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI0038B_LISTA", q3);
        ...
        [Theory]
        [InlineData("SI0038B_t1")]
        public static void SI0038B_Tests_Theory_ReturnCode00(string SI0038B1_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");

            SI0038B1_FILE_NAME_P = $"{SI0038B1_FILE_NAME_P}_{timestamp}.txt";
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                AppSettings.TestSet.DynamicData.Remove("SI0038B_LISTA");
                AppSettings.TestSet.DynamicData.Add("SI0038B_LISTA", q3);
                ...
                program.Execute(SI0038B1_FILE_NAME_P);

                Assert.True(File.Exists(program.SI0038B1.FilePath));
                Assert.True(new FileInfo(program.SI0038B1.FilePath).Length > 0);
        ...
        [Theory]
        [InlineData("SI0038B_t2")]
        public static void SI0038B_Tests_Theory_ReturnCode99(string SI0038B1_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
