...
namespace FileTests.Test
{
    ...
    public class SI9106B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI9106B_C01_SIARDEVC", q2);
        ...
        [Fact]
        public static void SI9106B_Tests_Fact()
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                { "SIARDEVC_NUM_EXPEDIENTE_VC" , "3"},
                { "SIARDEVC_COD_OPERACAO" , "4"},
                { "SIARDEVC_NUM_APOLICE" , "5"},
                { "SIARDEVC_NUM_ENDOSSO" , "6"},
                { "SIARDEVC_NUM_ITEM" , "7"},
                { "SIARDEVC_COD_COBERTURA" , "1"},
                { "SIARDEVC_DATA_OCORRENCIA" , "2020-01-01"},
                { "SIARDEVC_VAL_TOT_MOVIMENTO" , "120"},
            });
                AppSettings.TestSet.DynamicData.Remove("SI9106B_C01_SIARDEVC");
                AppSettings.TestSet.DynamicData.Add("SI9106B_C01_SIARDEVC", q2);
                ...
                Assert.True(envList[1].TryGetValue("SIARDEVC_NUM_APOL_SINISTRO", out var SIARDEVC_NUM_APOL_SINISTRO) && SIARDEVC_NUM_APOL_SINISTRO == "0000000000001");
                Assert.True(envList[1].TryGetValue("SINISMES_OCORR_HISTORICO", out var SINISMES_OCORR_HISTORICO) && SINISMES_OCORR_HISTORICO == "0002");
                Assert.True(envList[1].TryGetValue("SINISHIS_COD_OPERACAO", out var SINISHIS_COD_OPERACAO) && SINISHIS_COD_OPERACAO == "0004");
                ...
                Assert.True(envList[1].TryGetValue("SINISHIS_VAL_OPERACAO", out var SINISHIS_VAL_OPERACAO) && SINISHIS_VAL_OPERACAO == "0000000000120.00");
                Assert.True(envList[1].TryGetValue("SINISHIS_TIPO_FAVORECIDO", out var SINISHIS_TIPO_FAVORECIDO) && SINISHIS_TIPO_FAVORECIDO == " ");
                Assert.True(envList[1].TryGetValue("SINISMES_COD_FONTE", out var SINISMES_COD_FONTE) && SINISMES_COD_FONTE == "0001");
                ...
                Assert.True(envList[1].TryGetValue("SIARDEVC_NUM_APOLICE", out var SIARDEVC_NUM_APOLICE) && SIARDEVC_NUM_APOLICE == "0000000000005");
                Assert.True(envList[1].TryGetValue("SINISMES_COD_PRODUTO", out var SINISMES_COD_PRODUTO) && SINISMES_COD_PRODUTO == "0001");
                ...
                Assert.True(envList1[1].TryGetValue("SINISMES_OCORR_HISTORICO", out var SINISMES_OCORR_HISTORICO1) && SINISMES_OCORR_HISTORICO1 == "0002");
                Assert.True(envList1[1].TryGetValue("SINISMES_SALDO_PAGAR_IX", out var SINISMES_SALDO_PAGAR_IX1) && SINISMES_SALDO_PAGAR_IX1 == "0000000000.00000");
                Assert.True(envList1[1].TryGetValue("SIARDEVC_NUM_APOL_SINISTRO", out var SIARDEVC_NUM_APOL_SINISTRO1) && SIARDEVC_NUM_APOL_SINISTRO1 == "0000000000001");
                ...
                Assert.True(envList2[1].TryGetValue("SIARDEVC_OCORR_HISTORICO", out var SIARDEVC_OCORR_HISTORICO) && SIARDEVC_OCORR_HISTORICO == "0002");
                Assert.True(envList2[1].TryGetValue("SIARDEVC_TIPO_REGISTRO", out var SIARDEVC_TIPO_REGISTRO) && SIARDEVC_TIPO_REGISTRO == "1");
                Assert.True(envList2[1].TryGetValue("SIARDEVC_SEQ_REGISTRO", out var SIARDEVC_SEQ_REGISTRO) && SIARDEVC_SEQ_REGISTRO == "000000000");
        ...
        [Fact]
        public static void SI9106B_Tests99_Fact()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
