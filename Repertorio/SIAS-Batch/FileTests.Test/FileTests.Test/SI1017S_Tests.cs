...
using Copies;
using Code;
using static Code.SI1017S;

namespace FileTests.Test
{
    [Collection("SI1017S_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package02)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    public class SI1017S_Tests
    {
        ...
        [Fact]
        public static void SI1017S_Tests_Fact_SomaValorApolice_1000()
        {
        ...
        [Fact]
        public static void SI1017S_Tests_Fact_SomaValorRamo_3000()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                var program = new SI1017S();
                program.Execute(inputParam);
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_VALOR_CALCULADO == 60706977);
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_RAMO == 0003);

            }
        }
        [Fact]
        public static void SI1017S_Tests_Fact_Apolice_Produto_Ramo_Vazios()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
