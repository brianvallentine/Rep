...
namespace FileTests.Test_DB
{
    ...
    [Collection("SI0042B_Tests_DB")]
    public class SI0042B_Tests_DB
    {
        private static string pData = "2020-02-02";
        [Fact]
        public static void SI0042B_Database()
        {
            ...
            try { /*6*/ program.R2100_00_LE_SISINACO_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*7*/ program.R2200_00_LE_SIEVETIP_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
