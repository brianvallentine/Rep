...
using Dclgens;
using Code;
using static Code.SI9115B;

namespace FileTests.Test
{
    [Collection("SI9115B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    public class SI9115B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI9115B_C01_SIARDEVC", q5);
        ...
        [Theory]
        [InlineData("SI9115B_t1")]
        public static void SI9115B_Tests_Theory_ReturnCode00(string CVPAGSIN_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                q5.AddDynamic(new Dictionary<string, string>{
                    ...
                    { "SIARDEVC_COD_COBERTURA", "" },
                    { "SIARDEVC_COD_CAUSA", "" },
                    { "SIARDEVC_DATA_COMUNICADO", "2020-01-01" },
                    { "SIARDEVC_DATA_OCORRENCIA", "2020-01-01" },
                    { "SIARDEVC_HORA_OCORRENCIA", "01:01:01" },
                    { "SIARDEVC_DATA_MOVIMENTO", "2020-01-01" },
                    { "SIARDEVC_IND_FAVORECIDO", "" },
                    { "SIARDEVC_VAL_TOT_MOVIMENTO", "" },
                    { "SIARDEVC_VAL_PECAS", "" },
                    { "SIARDEVC_VAL_MAO_OBRA", "" },
                    ...
                    { "SIARDEVC_NOM_RESP_ACORDO", "" },
                    { "SIARDEVC_STA_ACORDO", "" },
                    { "SIARDEVC_DTH_INDENIZACAO", "2020-01-01" },
                    { "SIARDEVC_VLR_INDENIZACAO", "" },
                    { "SIARDEVC_VLR_PART_TERCEIROS", "" },
                    { "SIARDEVC_VLR_DIVIDA", "" },
                    { "SIARDEVC_PCT_DESCONTO", "" },
                ...
                AppSettings.TestSet.DynamicData.Remove("SI9115B_C01_SIARDEVC");
                AppSettings.TestSet.DynamicData.Add("SI9115B_C01_SIARDEVC", q5);
                ...
                var q9 = new DynamicData();
                q9.AddDynamic(new Dictionary<string, string>{
                    { "GEARDETA_NOM_ARQUIVO", "0" },
                    { "GEARDETA_SEQ_GERACAO", "0" },
                    { "SIARREVC_TIPO_REGISTRO_VC", "0" },
                    { "SIARREVC_SEQ_REGISTRO_VC", "0" },
                    { "SIARDEVC_NOM_ARQUIVO", "0" },
                    { "SIARDEVC_SEQ_GERACAO", "0" },
                    { "SIARDEVC_TIPO_REGISTRO", "0" },
        ...
        [Theory]
        [InlineData("SI9115B_t2")]
        public static void SI9115B_Tests_Theory_ReturnCode99(string CVPAGSIN_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
