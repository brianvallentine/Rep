...
using Xunit;
using Code;
using static Code.SI0809B;

namespace FileTests.Test
{
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    [Collection("SI0809B_Tests")]
    public class SI0809B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI0809B_V1RELATORIOS", q7);

            #endregion

            #region SI0809B_JOIN_HIST_MEST
            ...
            AppSettings.TestSet.DynamicData.Add("SI0809B_JOIN_HIST_MEST", q8);
            ...
            AppSettings.TestSet.DynamicData.Add("M_0000_00_DELETE_V1RELATORIOS_DB_DELETE_1_Delete1", q9);
        ...
        [Theory]
        [InlineData("SI0809B_t1")]
        public static void SI0809B_Tests_Theory_Erro99(string RSI0809B_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");

            RSI0809B_FILE_NAME_P = $"{RSI0809B_FILE_NAME_P}_{timestamp}.txt";
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                AppSettings.TestSet.DynamicData.Remove("SI0809B_V1RELATORIOS");
                AppSettings.TestSet.DynamicData.Add("SI0809B_V1RELATORIOS", q7);
                ...
                program.Execute(RSI0809B_FILE_NAME_P);
        ...
        [Theory]
        [InlineData("SI0809B_t2")]
        public static void SI0809B_Tests_Theory(string RSI0809B_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                //M_0000_00_SELECT_V1CLIENTE_DB_SELECT_1_Query1
                Assert.Empty(AppSettings.TestSet.DynamicData["M_0000_00_SELECT_V1CLIENTE_DB_SELECT_1_Query1"].DynamicList);
