...
namespace FileTests.Test
{
    ...
    public class VF0402B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VF0402B_CEVENT", q3);
            ...
            AppSettings.TestSet.DynamicData.Add("VF0402B_C1", q4);
            ...
            AppSettings.TestSet.DynamicData.Add("R1100_00_MONTA_SORT_DB_SELECT_1_Query1", q5);
            ...
            AppSettings.TestSet.DynamicData.Add("R1100_00_MONTA_SORT_DB_SELECT_2_Query1", q6);
            ...
            AppSettings.TestSet.DynamicData.Add("VF0402B_C2", q7);
            ...
            AppSettings.TestSet.DynamicData.Add("R1100_00_MONTA_SORT_DB_SELECT_3_Query1", q8);
            ...
            AppSettings.TestSet.DynamicData.Add("R1100_00_MONTA_SORT_DB_SELECT_4_Query1", q9);
            ...
            AppSettings.TestSet.DynamicData.Add("R1100_00_MONTA_SORT_DB_SELECT_5_Query1", q10);
        ...
        [Theory]
        [InlineData("RVF0402B_Saida", "SVF0402B_Saida")]
        public static void VF0402B_Tests_Theory(string RVF0402B_FILE_NAME_P, string SVF0402B_FILE_NAME_P)
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                AppSettings.TestSet.DynamicData.Remove("VF0402B_CEVENT");
                AppSettings.TestSet.DynamicData.Add("VF0402B_CEVENT", q3);
                ...
                AppSettings.TestSet.DynamicData.Remove("VF0402B_C1");
                AppSettings.TestSet.DynamicData.Add("VF0402B_C1", q4);
                ...
                AppSettings.TestSet.DynamicData.Remove("VF0402B_C2");
                AppSettings.TestSet.DynamicData.Add("VF0402B_C2", q7);
                ...
                program.Execute(RVF0402B_FILE_NAME_P, SVF0402B_FILE_NAME_P);

                #region R0020_00_UPDATE_V0RELATORIOS_DB_UPDATE_1_Update1             

                var envList = AppSettings.TestSet.DynamicData["R0020_00_UPDATE_V0RELATORIOS_DB_UPDATE_1_Update1"].DynamicList;
        ...
        [Theory]
        [InlineData("RVF0402B_Saida1", "SVF0402B_Saida1")]
        public static void VF0402B_Tests99_Theory(string RVF0402B_FILE_NAME_P, string SVF0402B_FILE_NAME_P)
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
