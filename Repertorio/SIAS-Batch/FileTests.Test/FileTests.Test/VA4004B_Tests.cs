...
{
    [Collection("VA4004B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package02)]
    public class VA4004B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VA4004B_TCOMIS", q2);

            #endregion

            #region VA4004B_CERROSPROP

            var q3 = new DynamicData();
            q3.AddDynamic(new Dictionary<string, string>{
                { "WS_DESCR_ERRO" , ""}
            });
            AppSettings.TestSet.DynamicData.Add("VA4004B_CERROSPROP", q3);
            ...
            #region R2230_00_SEL_ERRO_CPF_DB_SELECT_1_Query1

            var q9 = new DynamicData();
            q9.AddDynamic(new Dictionary<string, string>{
                { "WS_DESCR_ERRO" , ""}
            });
            AppSettings.TestSet.DynamicData.Add("R2230_00_SEL_ERRO_CPF_DB_SELECT_1_Query1", q9);

            #endregion

            #region VA4004B_CERROSP

            var q10 = new DynamicData();
            q10.AddDynamic(new Dictionary<string, string>{
                { "WS_DESCR_ERRO" , ""}
            });
            AppSettings.TestSet.DynamicData.Add("VA4004B_CERROSP", q10);

            #endregion

            #region VA4004B_CFONTES
            ...
            AppSettings.TestSet.DynamicData.Add("VA4004B_CFONTES", q11);
            ...
            AppSettings.TestSet.DynamicData.Add("R2500_00_SELECT_PRODUTO_DB_SELECT_1_Query1", q12);

            #endregion

            #region VA4004B_CESCNEG
            ...
            AppSettings.TestSet.DynamicData.Add("VA4004B_CESCNEG", q13);
            ...
            AppSettings.TestSet.DynamicData.Add("R3190_00_SELECT_ESCNEG_DB_SELECT_1_Query1", q14);
        ...
        [Theory]
        [InlineData("SVA4004B_FILE_NAME_P", "AVA4004B_FILE_NAME_P", "DVA4004B_FILE_NAME_P", "DSAIDA_FILE_NAME_P", "SSAIDA_FILE_NAME_P")]
        public static void VA4004B_Tests_Theory(string SVA4004B_FILE_NAME_P, string AVA4004B_FILE_NAME_P, string DVA4004B_FILE_NAME_P, string DSAIDA_FILE_NAME_P, string SSAIDA_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");

            SVA4004B_FILE_NAME_P = $"{SVA4004B_FILE_NAME_P}_{timestamp}.txt";
            AVA4004B_FILE_NAME_P = $"{AVA4004B_FILE_NAME_P}_{timestamp}.txt";
            DVA4004B_FILE_NAME_P = $"{DVA4004B_FILE_NAME_P}_{timestamp}.txt";
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                program.Execute(SVA4004B_FILE_NAME_P, AVA4004B_FILE_NAME_P, DVA4004B_FILE_NAME_P, DSAIDA_FILE_NAME_P, SSAIDA_FILE_NAME_P);
                ...
                var envList5 = AppSettings.TestSet.DynamicData["R1200_00_SELECT_V0ENDERECO_DB_SELECT_1_Query1"].DynamicList;
                Assert.Empty(envList5);

                var envList6 = AppSettings.TestSet.DynamicData["R1300_00_SELECT_V0AGENCIACEF_DB_SELECT_1_Query1"].DynamicList;
