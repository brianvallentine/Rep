...
using Xunit;
using Code;
using static Code.VA0956B;

namespace FileTests.Test
{
    [Collection("VA0956B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    public class VA0956B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VA0956B_V0SINISTROS", q2);

            #endregion

            #region VA0956B_C_SINISACO
            ...
            AppSettings.TestSet.DynamicData.Add("VA0956B_C_SINISACO", q3);
        ...
        public static void VA0956B_Tests_Theory(string ARQSORT_FILE_NAME_P, string AUDTSINI_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                var q3 = AppSettings.TestSet.DynamicData["VA0956B_V0SINISTROS"].DynamicList;
                Assert.Empty(q3);
        ...
        [Theory]
        [InlineData("ARQSORT_FILE_NAME_P", "AUDTSINI_FILE_NAME_P")]
        public static void VA0956B_Tests_SemDados(string ARQSORT_FILE_NAME_P, string AUDTSINI_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
