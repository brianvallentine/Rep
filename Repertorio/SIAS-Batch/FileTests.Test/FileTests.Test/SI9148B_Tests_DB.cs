...
namespace FileTests.Test_DB
{
    ...
    [Collection("SI9148B_Tests_DB")]
    public class SI9148B_Tests_DB
    {

        [Fact]
        public static void SI9148B_Database()
        {
            ...
            try { /*2*/ 
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_NOM_ARQUIVO.Value = "Arquivo";
            ...
            try { /*3*/
                ...
                program.HOST_ANO_MOV_ABERTO.Value = 2000;
            ...
            try { /*5*/
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_QTD_REG_PROCESSADO.Value = 1;
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_NOM_ARQUIVO.Value = "Y";
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_SEQ_GERACAO.Value = 1;
            ...
            try { /*9*/
                program.SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NUM_APOL_SINISTRO.Value = 123;
                program.R1260_00_LE_LOTECHEQ_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*10*/
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_NOM_ARQUIVO.Value ="X" ;
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_SEQ_GERACAO.Value = 1;
                program.SIARREVC.DCLSI_AR_RETORNO_VC.SIARREVC_TIPO_REGISTRO_VC.Value = "1";
                ...
                program.SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_TIPO_REGISTRO.Value = "1";
            ...
            try { /*11*/
                program.SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_TIPO_REGISTRO.Value =  "1";
                program.SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_SEQ_REGISTRO.Value  =  1;
                program.SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_NOM_ARQUIVO.Value   =  "Arquivo";
                program.SIARDEVC.DCLSI_AR_DETALHE_VC.SIARDEVC_SEQ_GERACAO.Value   =  1;
