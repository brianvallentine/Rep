...
namespace FileTests.Test
{
    ...
    public class GE0306B_Tests
    {
        ...
        [Fact]
        public static void GE0306B_Tests_FactNUM_ESTRUTURA1()
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                var param = new GE0306B_REGISTRO_LINKAGE_GE0306B();
                param.LK_GE0306B_REGISTRO.Value = "ABC\0123\0GHI";
                param.LK_GE0306B_FUNCAO.Value = 1;
                param.LK_GE0306B_IDE_SISTEMA.Value = "IDE SISTEMA";
                param.LK_GE0306B_CHR_USO_EMPRESA.Value = "CHR_USO_EMPRESA";
                param.LK_GE0306B_COD_OPERACAO.Value = 1;
                param.LK_GE0306B_NUM_ESTRUTURA.Value = 1;
                param.LK_GE0306B_NUM_NOSSO_TITULO.Value = 10;
                ...
                Assert.True(envList1[1].TryGetValue("GE113_CHR_USO_EMPRESA", out valor) && valor == "CHR_USO_EMPRESA                                                                                                                                                                                         ");
        ...
        [Fact]
        public static void GE0306B_Tests_FactNUM_ESTRUTURA2()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                param.LK_GE0306B_CHR_USO_EMPRESA.Value = "CHR_USO_EMPRESA";
                param.LK_GE0306B_COD_OPERACAO.Value = 1;
                param.LK_GE0306B_NUM_ESTRUTURA.Value = 2;
                param.LK_GE0306B_NUM_NOSSO_TITULO.Value = 10;
                param.LK_GE0306B_NUM_APOL_SINISTRO.Value = 10;
                param.LK_GE0306B_NUM_OCORR_HISTORICO.Value = 10;
                param.LK_GE0306B_NUM_RESSARC.Value = 10;
                param.LK_GE0306B_NUM_PARCELA.Value = 10;
                param.LK_GE0306B_NSAS.Value = 10;
                program.Execute(param);
        ...
        [Fact]
        public static void GE0306B_Tests_FactNUM_ESTRUTURA3()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                param.LK_GE0306B_CHR_USO_EMPRESA.Value = "CHR_USO_EMPRESA";
                param.LK_GE0306B_COD_OPERACAO.Value = 1;
                param.LK_GE0306B_NUM_ESTRUTURA.Value = 3;
                param.LK_GE0306B_NUM_NOSSO_TITULO.Value = 10;
                param.LK_GE0306B_NUM_CHEQUE_INTERNO.Value = 1;
                program.Execute(param);
        ...
        [Fact]
        public static void GE0306B_Tests_FactNUM_ESTRUTURA4()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                param.LK_GE0306B_CHR_USO_EMPRESA.Value = "CHR_USO_EMPRESA";
                param.LK_GE0306B_COD_OPERACAO.Value = 1;
                param.LK_GE0306B_NUM_ESTRUTURA.Value = 4;
                param.LK_GE0306B_NUM_NOSSO_TITULO.Value = 10;
                param.LK_GE0306B_NUM_APOL_SINISTRO.Value = 10;
                param.LK_GE0306B_NUM_OCORR_HISTORICO.Value = 10;
                param.LK_GE0306B_NUM_RESSARC.Value = 10;
                param.LK_GE0306B_NUM_PARCELA.Value = 10;
                param.LK_GE0306B_NSAS.Value = 10;
                param.LK_GE0306B_NUM_APOLICE.Value = 10;
                program.Execute(param);
        ...
        [Fact]
        public static void GE0306B_Tests_FactNUM_ESTRUTURA5()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                param.LK_GE0306B_CHR_USO_EMPRESA.Value = "CHR_USO_EMPRESA";
                param.LK_GE0306B_COD_OPERACAO.Value = 1;
                param.LK_GE0306B_NUM_ESTRUTURA.Value = 5;
                param.LK_GE0306B_NUM_NOSSO_TITULO.Value = 10;
                param.LK_GE0306B_NUM_APOL_SINISTRO.Value = 10;
                param.LK_GE0306B_NUM_OCORR_HISTORICO.Value = 10;
                param.LK_GE0306B_NUM_RESSARC.Value = 10;
                ...
                param.LK_GE0306B_NSAS.Value = 10;
                param.LK_GE0306B_NUM_APOLICE.Value = 10;
                param.LK_GE0306B_NUM_CERTIFICADO.Value = 10;
                program.Execute(param);
        ...
        [Fact]
        public static void GE0306B_Tests_FactErro99()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
