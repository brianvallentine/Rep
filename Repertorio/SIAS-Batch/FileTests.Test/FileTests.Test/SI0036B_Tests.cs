...
namespace FileTests.Test
{
    ...
    [Collection("SI0036B_Tests")]
    public class SI0036B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI0036B_LISTA", q3);
        ...
        [Theory]
        [InlineData("SI0036B_t1")]
        public static void SI0036B_Tests_Theory(string SI0036B1_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");

            SI0036B1_FILE_NAME_P = $"{SI0036B1_FILE_NAME_P}_{timestamp}.txt";
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                q3.AddDynamic(new Dictionary<string, string>{
                    ...
                    { "SIDOCACO_COD_DOCUMENTO" , "1"},
                    { "GEDOCTIP_DESCR_DOCUMENTO" , "1"},
                    { "SIMOVSIN_NATUREZA_SINISTRO" , "1"},
                    { "SIMOVSIN_NOME_SEGURADO" , "1"},
                    { "SIMOVSIN_COD_GIAFI" , "1"},
                    { "SIMOVSIN_NUM_CONTR_ESTIP" , "1"},
                    { "GERECADE_COD_DESTINATARIO" , "1"},
                });
                AppSettings.TestSet.DynamicData.Remove("SI0036B_LISTA");
                AppSettings.TestSet.DynamicData.Add("SI0036B_LISTA", q3);
                ...
                program.Execute(SI0036B1_FILE_NAME_P);
        ...
        [Theory]
        [InlineData("SI0036B_t2")]
        public static void SI0036B_Tests_Theory_Return99(string SI0036B1_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
