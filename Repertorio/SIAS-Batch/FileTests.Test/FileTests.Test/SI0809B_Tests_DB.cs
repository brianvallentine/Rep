...
namespace FileTests.Test_DB
{
    ...
    [Collection("SI0809B_Tests_DB")]
    public class SI0809B_Tests_DB
    {
        private static string pData = "2020-02-02";
        [Fact]
        public static void SI0809B_Database()
        {
            ...
            try { /*10*/ program.M_0000_00_DELETE_V1RELATORIOS_DB_DELETE_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
