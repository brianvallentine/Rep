...
{
    [Collection("GE0306B_Tests_DB")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.DatabaseTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    public class GE0306B_Tests_DB
    {

        [Fact]
        public static void GE0306B_Database()
        {
            var program = new GE0306B();
            AppSettings.TestSet.DB_Test.Is_DB_Test = true;
            program.GE099.DCLGE_MOVIMENTO_SAP.GE099_DTH_MOVIMENTO.Value = "2000-10-10";
            program.GE100.DCLGE_CONTROLE_INTERF_SAP.GE100_DTA_MOVIMENTO_LEGADO.Value = "2000-10-10";

            program.GE102.DCLGE_ARQUIVO_SAP.GE102_DTH_MOVIMENTO.Value = "2000-10-10";
            program.GE102.DCLGE_ARQUIVO_SAP.GE102_DTH_CADASTRAMENTO.Value = "2000-10-10";
