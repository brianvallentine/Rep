...
namespace FileTests.Test
{
    ...
    [Collection("SI9269B_Tests")]
    public class SI9269B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI9269B_C01_SIARDEVC", q5);
        ...
        [Theory]
        [InlineData("SI9269B_t1")]
        public static void SI9269B_Tests_Theory(string CSPAGSIN_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                AppSettings.TestSet.DynamicData.Remove("SI9269B_C01_SIARDEVC");
                AppSettings.TestSet.DynamicData.Add("SI9269B_C01_SIARDEVC", q5);
        ...
        [Theory]
        [InlineData("SI9269B_t2")]
        public static void SI9269B_Tests_TheoryReturn99(string CSPAGSIN_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
