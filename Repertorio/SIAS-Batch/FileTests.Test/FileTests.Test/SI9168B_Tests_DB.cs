...
{
    [Collection("SI9168B_Tests_DB")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.DatabaseTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]

    public class SI9168B_Tests_DB
    {

        [Fact]
        public static void SI9168B_Database()
        {
            ...
            try { /*3*/
                ...
                program.HOST_MES_MOV_ABERTO.Value = 2;
                program.SISTEMAS.DCLSISTEMAS.SISTEMAS_DATA_MOV_ABERTO.Value = "2020-01-01";
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_QTD_REG_PROCESSADO.Value = 2;
            ...
            try { /*8*/ 
                ...
                program.R1210_00_LE_SINISMES_DB_SELECT_1(); } catch (Exception ex) { _.ThreatableTestError(ex); }
            try { /*9*/
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_NOM_ARQUIVO.Value = "X";
                program.GEARDETA.DCLGE_AR_DETALHE.GEARDETA_SEQ_GERACAO.Value = 1;
