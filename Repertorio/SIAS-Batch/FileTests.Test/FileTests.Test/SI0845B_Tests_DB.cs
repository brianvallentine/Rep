...
namespace FileTests.Test_DB
{
    ...
    [Collection("SI0845B_Tests_DB")]
    public class SI0845B_Tests_DB
    {

        [Fact]
        public static void SI0845B_Database()
        {
            ...
            { /*4*/
                ...
                program.V1RELA_CODRELAT.Value = "1";
            ...
            try 
            { /*5*/
                program.WHOST_DTINIVIG.Value = "2024-01-01";
                program.WHOST_DTTERVIG.Value = "2024-01-01";
