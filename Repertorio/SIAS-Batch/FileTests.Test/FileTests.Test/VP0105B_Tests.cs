...
using Xunit;
using Code;
using static Code.VP0105B;
using System.IO;

namespace FileTests.Test
{
    [Collection("VP0105B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    public class VP0105B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VP0105B_TRELAT", q0);

            #endregion

            #region VP0105B_TFUNCIOCEF
            ...
            AppSettings.TestSet.DynamicData.Add("VP0105B_TFUNCIOCEF", q1);
            ...
            AppSettings.TestSet.DynamicData.Add("VP0105B_TFUNCIOSUR", q4);
        ...
        [Theory]
        [InlineData("VP0105B1.TXT")]
        public static void VP0105B_Tests_Theory(string RELPREFV_FILE_NAME_P)
        {
        ...
        [Theory]
        [InlineData("VP0105B2.TXT")]
        public static void VP0105B_Tests_TheoryErro(string RELPREFV_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
