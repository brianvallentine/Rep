...
using Xunit;
using Code;
using static Code.VA1474B;
using System.IO;

namespace FileTests.Test
{
    [Collection("VA1474B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package01)]
    public class VA1474B_Tests
    {
        ...
        private static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VA1474B_CPROPVA", q3);
            ...
            AppSettings.TestSet.DynamicData.Add("M_0200_INSERT_REPSAF_DB_INSERT_1_Insert1", q11);
        ...
        [Theory]
        [InlineData("REPSAF_FILE_01.txt")]
        public static void VA1474B_Tests_Theory(string REPSAF_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                var fileName = Path.GetFileNameWithoutExtension(REPSAF_FILE_NAME_P);
                ...
                //var envList = AppSettings.TestSet.DynamicData["M_0200_INSERT_REPSAF_DB_INSERT_1_Insert1"].DynamicList;
                //var envList1 = AppSettings.TestSet.DynamicData["M_0000_PRINCIPAL_DB_INSERT_1_Insert1"].DynamicList;
                //Assert.True(envList?.Count > 1);
                //Assert.True(envList1?.Count > 1);

                //Assert.True(envList[1].TryGetValue("MOVIMEA_TIPO_MOVIMENTO", out var valor) && valor == "E");
                //Assert.True(envList1[1].TryGetValue("CONARQEA_NSAS", out valor) && valor == "0002");
