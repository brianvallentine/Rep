...
using Copies;
using Code;
using static Code.SI1001S;

namespace FileTests.Test
{
    [Collection("SI1001S_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package02)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    public class SI1001S_Tests
    {
        ...
        [Fact]
        public static void SI1001S_Tests_Fact_SomaValorApolice_1000()
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                var inputParam = new LBSI1001_SI1001S_ENTRADA();
                inputParam.SI1001S_COD_FUNCAO.Value = 001;
                inputParam.SI1001S_NUM_APOL_SINISTRO.Value = 0000019790324;
                inputParam.SI1001S_COD_PRODUTO.Value = 0002;
                inputParam.SI1001S_RAMO.Value = 0003;
                inputParam.SI1001S_DATA_INICIO.Value = "2024-10-01";
                inputParam.SI1001S_DATA_FIM.Value = "2024-10-31";
                
                var param = new LBSI1001_SI1001S_PARAMETROS();
                param.SI1001S_ENTRADA = inputParam;
                #endregion
        ...
        [Fact]
        public static void SI1001S_Tests_Fact_SomaValorRamo_3000()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                var inputParam = new LBSI1001_SI1001S_ENTRADA();
                inputParam.SI1001S_COD_FUNCAO.Value = 001;
                inputParam.SI1001S_NUM_APOL_SINISTRO.Value = 0;
                inputParam.SI1001S_COD_PRODUTO.Value = 0;
                inputParam.SI1001S_RAMO.Value = 0003;
                inputParam.SI1001S_DATA_INICIO.Value = "2024-10-01";
                inputParam.SI1001S_DATA_FIM.Value = "2024-10-31";
        ...
        [Fact]
        public static void SI1001S_Tests_Fact_Apolice_Produto_Ramo_Vazios()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                inputParam.SI1001S_NUM_APOL_SINISTRO.Value = 0;
                inputParam.SI1001S_COD_PRODUTO.Value = 0;
                inputParam.SI1001S_RAMO.Value = 0;
                inputParam.SI1001S_DATA_INICIO.Value = "2024-10-01";
                inputParam.SI1001S_DATA_FIM.Value = "2024-10-31";
