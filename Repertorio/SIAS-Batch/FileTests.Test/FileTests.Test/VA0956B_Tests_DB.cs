...
{
    [Collection("VA0956B_Tests_DB")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.DatabaseTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    public class VA0956B_Tests_DB
    {

        [Fact]
        public static void VA0956B_Database()
        {
            ...
            try
            { /*3*/
                program.WHOST_DTH_INI.Value = "2024-01-01";
                program.WHOST_DTH_FIM.Value = "2024-01-01";
                program.R0500_00_DECLARE_V0SINISTROS_DB_DECLARE_1(); program.R0500_00_DECLARE_V0SINISTROS_DB_OPEN_1();
            }
            ...
            try
            { /*12*/
                program.V0MSIN_NUM_APOL.Value = 108200000065;
