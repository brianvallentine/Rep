...
using Xunit;
using Code;
using static Code.VG1706B;

namespace FileTests.Test
{
    [Collection("VG1706B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    public class VG1706B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VG1706B_AGENCTOAPOL", q1);

            #endregion

            #region VG1706B_FATURASC
            ...
            AppSettings.TestSet.DynamicData.Add("VG1706B_FATURASC", q2);
        ...
        [Fact]
        public static void VG1706B_Tests_Fact()
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                AppSettings.TestSet.DynamicData.Remove("VG1706B_AGENCTOAPOL");
                var q1 = new DynamicData();
                q1.AddDynamic(new Dictionary<string, string>{
                { "AGEAPOVG_NUM_APOLICE" , ""},
                { "AGEAPOVG_COD_SUBGRUPO" , ""},
                ...
                { "AGEAPOVG_MATRIC_INDICADOR" , ""},
                { "AGEAPOVG_PERC_PAG_PARCELA" , ""},
                { "AGEAPOVG_COD_PAG_ANGARIACAO" , "02"},
                { "AGEAPOVG_NUM_ENDOSSO" , ""},
                { "AGEAPOVG_DATA_MOVIMENTO" , ""},
                { "AGEAPOVG_SITUACAO_AGENCTO" , ""},
                { "AGEAPOVG_TIMESTAMP" , ""},
                ...
                var q7 = new DynamicData();
                q7.AddDynamic(new Dictionary<string, string>{
                { "MOEDACOT_VAL_VENDA" , "7"}
                });
                AppSettings.TestSet.DynamicData.Add("M_1500_PROC_FATURAS_DB_SELECT_2_Query1", q7);

                AppSettings.TestSet.DynamicData.Remove("M_1500_PROC_FATURAS_DB_SELECT_3_Query1");
                var q8 = new DynamicData();
                q8.AddDynamic(new Dictionary<string, string>{
                { "APOLICOB_PRM_TARIFARIO_IX" , "8"},
                { "APOLICOB_FATOR_MULTIPLICA" , "8"},
                });
                AppSettings.TestSet.DynamicData.Add("M_1500_PROC_FATURAS_DB_SELECT_3_Query1", q8);

                AppSettings.TestSet.DynamicData.Remove("M_1500_PROC_FATURAS_DB_SELECT_4_Query1");
                var q9 = new DynamicData();
                q9.AddDynamic(new Dictionary<string, string>{
                { "APOLICOB_PRM_TARIFARIO_IX" , "9"},
                { "APOLICOB_FATOR_MULTIPLICA" , "9"},
                });
                AppSettings.TestSet.DynamicData.Add("M_1500_PROC_FATURAS_DB_SELECT_4_Query1", q9);
                ...
                Assert.True(envList1[1].TryGetValue("COMISSOE_COD_OPERACAO", out valor) && valor == "1101");
                Assert.True(envList2[1].TryGetValue("FUNCOMVA_VAL_BASICO_VG", out valor) && valor == "0000000001015.00");
            }
        }
    }
}