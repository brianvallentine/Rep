...
using Xunit;
using Code;
using static Code.VG0122B;
using System.IO;

namespace FileTests.Test
{
    [Collection("VG0122B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package02)]
    public class VG0122B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VG0122B_RELATORIO", q3);

            #endregion

            #region VG0122B_SEGURADO1
            ...
            q4.AddDynamic(new Dictionary<string, string>{
                ...
                { "SEGURAVG_IDE_SEXO" , "M"},
                { "SEGURAVG_MATRICULA" , "555"},
                { "SEGURAVG_DT_INIVI" , "2024-01-01"},
                { "SEGURAVG_SIT_REG" , "1"},
                { "SEGURAVG_DT_NASCI" , "2000-10-01"},
                { "CLIENTE_COD_CLI" , "456789"},
                { "CLIENTE_NOME_RAZAO" , "NOME RAZAO CLIENTE"},
                { "CLIENTE_CGC_CPF" , "123456789-0000"},
            });
            AppSettings.TestSet.DynamicData.Add("VG0122B_SEGURADO1", q4);

            #endregion

            #region VG0122B_SEGURADO2
            ...
            AppSettings.TestSet.DynamicData.Add("VG0122B_SEGURADO2", q5);

            #endregion

            #region VG0122B_SEGURADO3
            ...
            AppSettings.TestSet.DynamicData.Add("VG0122B_SEGURADO3", q6);
        ...
        [Theory]
        [InlineData("RVG0122B_FILE_NAME_P")]
        public static void VG0122B_Tests_Theory_Update(string RVG0122B_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");

            RVG0122B_FILE_NAME_P = $"{RVG0122B_FILE_NAME_P}_{timestamp}.txt";
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                { "HISTSEGVG_COD_OPER" , "222"},
                { "HISTSEGVG_DATA_MOV" , "2024-01-01"},
                ...
                program.Execute(RVG0122B_FILE_NAME_P);
                AppSettings.TestSet.DynamicData.Where(x => (x.Key.Contains("Update") || x.Key.Contains("Insert")) && x.Value.DynamicList.Count > 1);

                Assert.True(File.Exists(program.RVG0122B.FilePath));
                Assert.True(new FileInfo(program.RVG0122B.FilePath)?.Length > 0);
                ...
                Assert.True(program.LK_LINK.LK_TITULO.Value.Contains("CAIXA SEGURADORA VIDA"));
        ...
        [Theory]
        [InlineData("RVG0122B_FILE_NAME_P")]
        public static void VG0122B_Tests_Theory_SemDados(string RVG0122B_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
