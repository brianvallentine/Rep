...
using Copies;
using Code;
using static Code.SI1007S;

namespace FileTests.Test
{
    [Collection("SI1007S_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package02)]
    public class SI1007S_Tests
    {
        ...
        [Fact]
        public static void SI1007S_Tests_Fact_SomaValorApolice_1000()
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                inputParam.SI1001S_ENTRADA.SI1001S_COD_FUNCAO.Value = 001;
                inputParam.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO.Value = 0000019790324;
                inputParam.SI1001S_ENTRADA.SI1001S_COD_PRODUTO.Value = 0002;
                inputParam.SI1001S_ENTRADA.SI1001S_RAMO.Value = 003;
                inputParam.SI1001S_ENTRADA.SI1001S_DATA_INICIO.Value = "2024-10-01";
                inputParam.SI1001S_ENTRADA.SI1001S_DATA_FIM.Value = "2024-10-31";
                #endregion
        ...
        [Fact]
        public static void SI1007S_Tests_Fact_SomaValorRamo_3000()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                var inputParam = new LBSI1001_SI1001S_PARAMETROS();
                inputParam.SI1001S_ENTRADA.SI1001S_COD_FUNCAO.Value = 001;
                inputParam.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO.Value = 0;
                inputParam.SI1001S_ENTRADA.SI1001S_COD_PRODUTO.Value = 0;
                inputParam.SI1001S_ENTRADA.SI1001S_RAMO.Value = 003;
                inputParam.SI1001S_ENTRADA.SI1001S_DATA_INICIO.Value = "2024-10-01";
                inputParam.SI1001S_ENTRADA.SI1001S_DATA_FIM.Value = "2024-10-31";
                #endregion
        ...
        [Fact]
        public static void SI1007S_Tests_Fact_Apolice_Produto_Ramo_Vazios()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                inputParam.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO.Value = 0;
                inputParam.SI1001S_ENTRADA.SI1001S_COD_PRODUTO.Value = 0;
                inputParam.SI1001S_ENTRADA.SI1001S_RAMO.Value = 0;
                inputParam.SI1001S_ENTRADA.SI1001S_DATA_INICIO.Value = "2024-10-01";
                inputParam.SI1001S_ENTRADA.SI1001S_DATA_FIM.Value = "2024-10-31";
                #endregion
                var program = new SI1007S();
