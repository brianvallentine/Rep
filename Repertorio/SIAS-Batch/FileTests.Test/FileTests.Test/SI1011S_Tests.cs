...
using Copies;
using Code;
using static Code.SI1011S;
using System.ComponentModel;

namespace FileTests.Test
{
    [Collection("SI1011S_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package02)]
    public class SI1011S_Tests
    {
        ...
        [Fact]
        public static void SI1011S_Tests_Fact_Valor_NumApolice_1000()
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                var inputParam = new LBSI1001_SI1001S_PARAMETROS()
                {
                    ...
                    {
                        SI1001S_IDE_SISTEMA = new StringBasis()
                        {
                            Pic = new PIC("X", "2", "X(002)"),
                            Value = "SI"
                        },
                        SI1001S_IDE_SISTEMA_OPER = new StringBasis()
                        {
                            Pic = new PIC("X", "2", "X(002)"),
                            Value = "SI"
                        },
                ...
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_PARAGRAFO == 030);
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM.IsEmpty());
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_VALOR_CALCULADO == 500000);
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_NUM_APOL_SINISTRO == 12589652);

            }
        }
        [Fact]
        public static void SI1011S_Tests_Fact_Valor_CodProduto_2000()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
                ...
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_PARAGRAFO == 030);
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_ERRO_MENSAGEM.IsEmpty());
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_SAIDA.SI1001S_VALOR_CALCULADO == 20336);
                Assert.True(program.LBSI1001.SI1001S_PARAMETROS.SI1001S_ENTRADA.SI1001S_COD_PRODUTO == 10);

            }
        }
        [Fact]
        public static void SI1011S_Tests_Fact_CodProduto0_Ramo0_Apolice_0Erro_10()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
