...
using Dclgens;
using Code;
using static Code.SI9169B;

namespace FileTests.Test
{
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]
    [Collection("SI9169B_Tests")]
    public class SI9169B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI9169B_C01_SIARDEVC", q5);
        ...
        [Theory]
        [InlineData("SI9169B_t1")]
        public static void SI9169B_Tests_Theory(string CVPAGSIN_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                AppSettings.TestSet.DynamicData.Remove("SI9169B_C01_SIARDEVC");
                AppSettings.TestSet.DynamicData.Add("SI9169B_C01_SIARDEVC", q5);
        ...
        [Theory]
        [InlineData("SI9169B_t2")]
        public static void SI9169B_Tests_TheoryReturn99(string CVPAGSIN_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
