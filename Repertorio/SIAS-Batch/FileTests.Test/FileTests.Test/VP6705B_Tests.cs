...
namespace FileTests.Test
{
    ...
    [Collection("VP6705B_Tests")]
    public class VP6705B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VP6705B_V0MOVIMENTO", q1);

            #endregion

            #region VP6705B_PLANOS
            ...
            AppSettings.TestSet.DynamicData.Add("VP6705B_PLANOS", q2);
        ...
        [Fact]
        public static void VP6705B_Tests_Fact()
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                { "SQL_PRM_VG" , "100000" },
                { "SQL_PRM_AP" , "5000" },
                { "SQL_PRM_VG_ATU" , "110000" },
                { "SQL_PRM_AP_ATU" , "5500" },
                { "SQL_COD_OPERAC" , "OP123456" },
                { "SQL_FAIXA" , "30-40" },
                { "SQL_DTMOVTO" , "2023-12-02" },
                });
                AppSettings.TestSet.DynamicData.Remove("VP6705B_V0MOVIMENTO");
                AppSettings.TestSet.DynamicData.Add("VP6705B_V0MOVIMENTO", q1);
                ...
                AppSettings.TestSet.DynamicData.Remove("VP6705B_PLANOS");
                AppSettings.TestSet.DynamicData.Add("VP6705B_PLANOS", q2);
                ...
                { "SQL_NUM_CERT" , "987654321" },
                { "SQL_NRPARCEL" , "12" },
                { "SQL_CODOPER_PLANOS" , "PL123456" },
                { "SQL_DTMOVABE" , "2023-12-01" },
                { "SQL_PRM_VG_CO" , "150000" },
                { "SQL_PRM_AP_CO" , "7500" },
                { "SQL_PERC_COMIS" , "10" },
                { "SQL_COD_FONTE" , "002" },
                { "SQL_PROPOSTA" , "P123456789" },
        ...
        [Fact]
        public static void VP6705B_Tests_Fact_Erro9()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
