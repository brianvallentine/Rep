...
using Xunit;
using Code;
using static Code.VA0955B;

namespace FileTests.Test
{
    [Collection("VA0955B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    public class VA0955B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            q0.AddDynamic(new Dictionary<string, string>{
                { "V0SIST_DTMOVABE_1" , "2024-01-01"},
                { "V0SIST_DTMOVABE" , "2024-01-01"},
                { "V0SIST_DTCURRENT" , "2024-01-01"},
            });
            ...
            AppSettings.TestSet.DynamicData.Add("VA0955B_V0SINISTROS", q2);

            #endregion

            #region VA0955B_C_SINISACO
            ...
            AppSettings.TestSet.DynamicData.Add("VA0955B_C_SINISACO", q3);
        ...
        [Theory]
        [InlineData("ARQSORT_FILE_NAME_P", "AUDTSINI_FILE_NAME_P")]
        public static void VA0955B_Tests_Theory(string ARQSORT_FILE_NAME_P, string AUDTSINI_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                var q1 = AppSettings.TestSet.DynamicData["R0100_00_SELECT_V0SISTEMA_DB_SELECT_1_Query1"].DynamicList;
                Assert.Empty(q1);

                var q2 = AppSettings.TestSet.DynamicData["R0200_00_SELECT_V0EMPRESA_DB_SELECT_1_Query1"].DynamicList;
                Assert.Empty(q2);

                var q3 = AppSettings.TestSet.DynamicData["VA0955B_V0SINISTROS"].DynamicList;
                Assert.Empty(q3);

                var q4 = AppSettings.TestSet.DynamicData["R1100_00_SELECT_V0MESTSINI_DB_SELECT_1_Query1"].DynamicList;
                Assert.Empty(q4);
        ...
        [Theory]
        [InlineData("ARQSORT_FILE_NAME_P", "AUDTSINI_FILE_NAME_P")]
        public static void VA0955B_Tests_SemDados(string ARQSORT_FILE_NAME_P, string AUDTSINI_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
