...
{
    [Collection("VG1706B_Tests_DB")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.DatabaseTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package03)]
    public class VG1706B_Tests_DB
    {

        [Fact]
        public static void VG1706B_Database()
        {
            ...
            try 
            { /*8*/
                program.ENDOSSOS.DCLENDOSSOS.ENDOSSOS_DATA_INIVIGENCIA.Value = "2025-01-28";
            ...
            try 
            { /*14*/ 
                program.COMISSOE.DCLCOMISSOES.COMISSOE_DATA_CALCULO.Value = "2025-01-28";
                program.COMISSOE.DCLCOMISSOES.COMISSOE_HORA_OPERACAO.Value = "00:00:00";
                program.COMISSOE.DCLCOMISSOES.COMISSOE_DATA_SELECAO.Value = "2025-01-28";
                program.COMISSOE.DCLCOMISSOES.COMISSOE_DATA_QUITACAO.Value = "2025-01-28";
            ...
            try 
            { /*17*/
                program.FUNCOMVA.DCLFUNDO_COMISSAO_VA.FUNCOMVA_DATA_QUITACAO.Value = "2025-01-28";
                program.FUNCOMVA.DCLFUNDO_COMISSAO_VA.FUNCOMVA_DATA_MOVIMENTO.Value = "2025-01-28";
