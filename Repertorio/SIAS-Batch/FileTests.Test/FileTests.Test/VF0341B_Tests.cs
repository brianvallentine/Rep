...
using Xunit;
using Code;
using static Code.VF0341B;
using System.IO;

namespace FileTests.Test
{
    [Collection("VF0341B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]

    public class VF0341B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VF0341B_DEBITO", q1);
            ...
            AppSettings.TestSet.DynamicData.Add("M_1000_PROCESSA_DEBITO_DB_UPDATE_2_Update1", q5);
            ...
            AppSettings.TestSet.DynamicData.Add("M_9000_FINALIZA_DB_UPDATE_1_Update1", q6);
            ...
            AppSettings.TestSet.DynamicData.Add("M_9000_FINALIZA_DB_INSERT_1_Insert1", q7);
        ...
        [Theory]
        [InlineData("VF0341B_OUTPUT_202504170000")]
        public static void VF0341B_Tests_Theory(string MOVIMENTO_FILE_NAME_P)
        {
            lock (AppSettings.TestSet._lock)
            {
                ...
                AppSettings.TestSet.DynamicData.Remove("VF0341B_DEBITO");
                AppSettings.TestSet.DynamicData.Add("VF0341B_DEBITO", q1);
                ...
                Assert.True(update1[1].TryGetValue("NRCERTIF", out string value1) && value1.Equals("000000000000000"));
                Assert.True(update1[1].TryGetValue("UpdateCheck", out string value2) && value2.Equals("UpdateCheck"));

                var update2 = AppSettings.TestSet.DynamicData["M_1000_PROCESSA_DEBITO_DB_UPDATE_2_Update1"].DynamicList;
                Assert.True(update2[1].TryGetValue("PARM_NSA", out string value3) && value3.Equals("0001"));
                ...
                Assert.True(update2[1].TryGetValue("PARM_NSA", out string value5) && value5.Equals("0001"));
                Assert.True(update2[1].TryGetValue("UpdateCheck", out string value6) && value6.Equals("UpdateCheck"));
        ...
        [Theory]
        [InlineData("VF0341B_OUTPUT_202504170001")]
        public static void VF0341B_Tests_ReturnCode99_Theory(string MOVIMENTO_FILE_NAME_P)
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
