...
{
    [Collection("VP5706B_Tests")]
    [Trait(IA_ConverterCommons.Utils.TestTraits.TestType.Name, IA_ConverterCommons.Utils.TestTraits.TestType.Values.UnitTesting)]
    [Trait(IA_ConverterCommons.Utils.TestTraits.Package.Name, IA_ConverterCommons.Utils.TestTraits.Package.Values.Package04)]

    public class VP5706B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("VP5706B_V0MOVIMENTO", q1);
        ...
        [Fact]
        public static void VP5706B_Tests_Fact()
        {
...
AppSettings.TestSet.DynamicData.Add("M_0000_INICIO_DB_SELECT_1_Query1", q0);
    ...
    var q1 = new DynamicData();
            q1.AddDynamic(new Dictionary<string, string>{
                ...
                { "SQL_COD_SUB" , "001" },
                { "SQL_COD_FONTE" , "002" },
                { "SQL_PROPOSTA" , "987654321" },
                { "SQL_TIPO_SEG" , "VIDA" },
                { "SQL_NUM_CERT" , "123456" },
                { "SQL_DAC_CERT" , "7" },
                { "SQL_COD_CLIE" , "000123456" },
                { "SQL_COD_AGEN" , "001234" },
                { "SQL_MATRICULA" , "654321" },
                { "SQL_PRM_VG" , "500000.00" },
                { "SQL_PRM_AP" , "100000.00" },
            ...
            AppSettings.TestSet.DynamicData.Remove("VP5706B_V0MOVIMENTO");
AppSettings.TestSet.DynamicData.Add("VP5706B_V0MOVIMENTO", q1);
...
AppSettings.TestSet.DynamicData.Add("M_1300_UPDATE_DB_UPDATE_1_Update1", q4);
    ...
    var q5 = new DynamicData();
            q5.AddDynamic(new Dictionary<string, string>{
                ...
                { "SQL_VLCOMIS" , "5000.00" },
                { "SQL_DTMOVABE" , "2023-12-01" },
                { "SQL_VALBAS" , "1000000.00" },
                { "SQL_PCT_AGENC" , "5.00" },
                { "SQL_COD_SUB" , "001" },
                { "SQL_HORAOPER" , "14:30:00" },
...
//para testes quando necessário alterar alguma variavel do loadParameter faça assim:
        ...
        [Fact]
        public static void VP5706B_Tests_Fact_ReturnCode99()
        {
            lock (AppSettings.TestSet._lock)
            {
                AppSettings.TestSet.IsTest = true;
