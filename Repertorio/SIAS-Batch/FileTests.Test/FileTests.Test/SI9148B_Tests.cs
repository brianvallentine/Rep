...
namespace FileTests.Test
{
    ...
    [Collection("SI9148B_Tests")]

    public class SI9148B_Tests
    {
        ...
        public static void Load_Parameters()
        {
            ...
            AppSettings.TestSet.DynamicData.Add("SI9148B_C01_SIARDEVC", q5);
            ...
            #region R1260_00_LE_LOTECHEQ_DB_SELECT_1_Query1

            var q8 = new DynamicData();
            q8.AddDynamic(new Dictionary<string, string>{
                { "LOTECHEQ_SERIE_CHEQUE" , ""}
            });
            AppSettings.TestSet.DynamicData.Add("R1260_00_LE_LOTECHEQ_DB_SELECT_1_Query1", q8);
            ...
            AppSettings.TestSet.DynamicData.Add("R1300_00_INCLUI_SIARREVC_DB_INSERT_1_Insert1", q9);
            ...
            AppSettings.TestSet.DynamicData.Add("R1400_00_ALTERA_SIARDEVC_DB_UPDATE_1_Update1", q10);
        ...
        [Theory]
        [InlineData("SI9148B_t1")]
        public static void SI9148B_Tests_Theory(string CVPAGSIN_FILE_NAME_P)
        {
            ...
            lock (AppSettings.TestSet._lock)
            {
                ...
                { "HOST_ANO_MOV_ABERTO" , "2020"},
                { "HOST_MES_MOV_ABERTO" , "1"},
                });
               ...
               var q5 = new DynamicData();               
               q5.AddDynamic(new Dictionary<string, string>{
                    { "SIARDEVC_NOM_ARQUIVO" , "arquivo"},
                    { "SIARDEVC_SEQ_GERACAO" , "001"},
                    { "SIARDEVC_TIPO_REGISTRO" , "C01"},
                    { "SIARDEVC_SEQ_REGISTRO" , "1"},
                    { "SIARDEVC_COD_OPERACAO" , "1"},
                    { "SINISHIS_COD_OPERACAO" , "2"},
                    { "SIARDEVC_OCORR_HISTORICO" , "HISTORICO EXEMPLO"},
                    { "SIARDEVC_NUM_SINISTRO_VC" , "1"},
                    { "SIARDEVC_NUM_EXPEDIENTE_VC" , "9"},
                    { "SIARDEVC_NUM_APOLICE" , "3"},
                    { "SIARDEVC_NUM_ENDOSSO" , "6"},
                    { "SIARDEVC_NUM_ITEM" , "01"},
                    { "SIARDEVC_COD_RAMO" , "1"},
                    { "SIARDEVC_COD_COBERTURA" , "2"},
                    { "SIARDEVC_COD_CAUSA" , "CAU999"},
                    { "SIARDEVC_DATA_COMUNICADO" , "2025-04-10"},
                    { "SIARDEVC_DATA_OCORRENCIA" , "2025-04-09"},
                    { "SIARDEVC_HORA_OCORRENCIA" , "134500"},
                    { "SIARDEVC_DATA_MOVIMENTO" , "2025-04-11"},
                    { "SIARDEVC_IND_FAVORECIDO" , "1"},
                    { "SIARDEVC_VAL_TOT_MOVIMENTO" , "1500"},
                    { "SIARDEVC_VAL_PECAS" , "50"},
                    { "SIARDEVC_VAL_MAO_OBRA" , "300"},
                    { "SIARDEVC_VAL_PARCELA_PEND" , "200"},
                    { "SIARDEVC_QTD_PARCELA_PEND" , "2"},
                    { "SIARDEVC_VAL_DESC_PARC_PEND" , "50"},
                    { "SIARDEVC_DATA_NEGOCIADA" , "2025-04-15"},
                    { "SIARDEVC_VAL_IRF" , "75"},
                    { "SIARDEVC_VAL_ISS" , "25"},
                    { "SIARDEVC_VAL_INSS" , "100"},
                    { "SIARDEVC_VAL_LIQUIDO_PAGTO" , "1300"},
                    { "SIARDEVC_CGCCPF" , "123"},
                    { "SIARDEVC_TIPO_PESSOA" , "F"},
                    { "SIARDEVC_NOM_FAVORECIDO" , "JOÃO SILVA"},
                    { "SIARDEVC_IND_DOC_FISCAL" , "1"},
                    { "SIARDEVC_NUM_DOC_FISCAL" , "NF123456"},
                    { "SIARDEVC_SERIE_DOC_FISCAL" , "A1"},
                    { "SIARDEVC_DATA_EMISSAO" , "2025-04-10"},
                    { "SIARDEVC_DES_ENDERECO" , "Rua Exemplo, 123"},
                    { "SIARDEVC_NOM_BAIRRO" , "Centro"},
                    { "SIARDEVC_NOM_CIDADE" , "São Paulo"},
                    { "SIARDEVC_COD_UF" , "SP"},
                    { "SIARDEVC_NUM_CEP" , "0100"},
                    { "SIARDEVC_NUM_DDD" , "11"},
                    { "SIARDEVC_NUM_TELEFONE" , "999"},
                    { "SIARDEVC_IND_FORMA_PAGTO" , "1"},
                    { "SIARDEVC_NUM_IDENTIFICADOR" , "123"},
                    { "SIARDEVC_NUM_CHEQUE_INTERNO" , "56"},
                    { "SIARDEVC_ORDEM_PAGAMENTO_VC" , "001"},
                    { "SIARDEVC_ORDEM_PAGAMENTO" , "789"},
                    { "SIARDEVC_COD_BANCO" , "3"},
                    { "SIARDEVC_COD_AGENCIA" , "12"},
                    { "SIARDEVC_OPERACAO_CONTA" , "1"},
                    { "SIARDEVC_COD_CONTA" , "98"},
                    { "SIARDEVC_DV_CONTA" , "2"},
                    { "SIARDEVC_COD_FAVORECIDO" , "1"},
                    { "SIARDEVC_NUM_APOL_SINISTRO" , "01"},
                    { "SIARDEVC_STA_PROCESSAMENTO" , "P"},
                    { "SIARDEVC_COD_ERRO" , "0"},
                    { "SIARDEVC_VAL_PISPASEP" , "10"},
                    { "SIARDEVC_VAL_COFINS" , "20"},
                    { "SIARDEVC_VAL_CSLL" , "30"},
                    { "SIARDEVC_COD_FONTE" , "01"},
                    { "SIARDEVC_NUM_RESSARC" , "123"},
                    { "SIARDEVC_IND_PESSOA_ACORDO" , "F"},
                    { "SIARDEVC_NUM_CPFCGC_ACORDO" , "210"},
                    { "SIARDEVC_NOM_RESP_ACORDO" , "MARIA OLIVEIRA"},
                    { "SIARDEVC_STA_ACORDO" , "1"},
                    { "SIARDEVC_DTH_INDENIZACAO" , "2025-04-12"},
                    { "SIARDEVC_VLR_INDENIZACAO" , "120"},
                    { "SIARDEVC_VLR_PART_TERCEIROS" , "200"},
                    { "SIARDEVC_VLR_DIVIDA" , "100"},
                    { "SIARDEVC_PCT_DESCONTO" , "10"},
                    { "SIARDEVC_VLR_TOTAL_DESCONTO" , "100"},
                    { "SIARDEVC_VLR_TOTAL_ACORDO" , "1100"},
                    { "SIARDEVC_COD_MOEDA_ACORDO" , "1"},
                    { "SIARDEVC_DTH_ACORDO" , "2025-04-13"},
                    { "SIARDEVC_QTD_PARCELAS_ACORDO" , "3"},
                    { "SIARDEVC_NUM_PARCELA_ACORDO" , "1"},
                    { "SIARDEVC_COD_AGENCIA_CEDENT" , "56"},
                    { "SIARDEVC_NUM_CEDENTE" , "78"},
                    { "SIARDEVC_NUM_CEDENTE_DV" , "3"},
                    { "SIARDEVC_DTH_VENCIMENTO" , "2025-05-01"},
                    { "SIARDEVC_NUM_NOSSO_TITULO" , "87"},
                    { "SIARDEVC_VLR_TITULO" , "15"},
                    { "SIARDEVC_NUM_CPFCGC_RECLAMANTE" , "1122"},
                    { "SIARDEVC_NOM_RECLAMANTE" , "ANTONIO FERREIRA"},
                    { "SIARDEVC_VLR_RECLAMADO" , "200"},
                    { "SIARDEVC_VLR_PROVISIONADO" , "180"},
                    });
               AppSettings.TestSet.DynamicData.Remove("SI9148B_C01_SIARDEVC");
               AppSettings.TestSet.DynamicData.Add("SI9148B_C01_SIARDEVC", q5);
                ...
                { "SINISMES_NUM_PROTOCOLO_SINI" , "123"},
                });
                ...
                var q8 = new DynamicData();
                q8.AddDynamic(new Dictionary<string, string>{
                { "LOTECHEQ_SERIE_CHEQUE" , "1"}
                });
                AppSettings.TestSet.DynamicData.Remove("R1260_00_LE_LOTECHEQ_DB_SELECT_1_Query1");
                AppSettings.TestSet.DynamicData.Add("R1260_00_LE_LOTECHEQ_DB_SELECT_1_Query1", q8);
                ...
                Assert.True(envList1[1].TryGetValue("GEARDETA_SEQ_GERACAO", out var GEARDETA_SEQ_GERACAO) && GEARDETA_SEQ_GERACAO == "000000002");
                Assert.True(envList1[1].TryGetValue("HOST_ANO_MOV_ABERTO", out var HOST_ANO_MOV_ABERTO) && HOST_ANO_MOV_ABERTO == "2020");
                ...
                Assert.True(envList2[1].TryGetValue("GEARDETA_NOM_ARQUIVO", out var GEARDETA_NOM_ARQUIVO2) && GEARDETA_NOM_ARQUIVO2 == "CVPAGSIN");
                Assert.True(envList2[1].TryGetValue("GEARDETA_SEQ_GERACAO", out var GEARDETA_SEQ_GERACAO2) && GEARDETA_SEQ_GERACAO2 == "000000002");
                ...
                Assert.True(envList2[1].TryGetValue("SIARVRCZ_STA_PROCESSAMENTO", out var SIARVRCZ_STA_PROCESSAMENTO) && SIARVRCZ_STA_PROCESSAMENTO == "1");
                ...
                Assert.True(envList3[1].TryGetValue("GEARDETA_QTD_REG_PROCESSADO", out var GEARDETA_QTD_REG_PROCESSADO3) && GEARDETA_QTD_REG_PROCESSADO3 == "000000003");
                Assert.True(envList3[1].TryGetValue("GEARDETA_NOM_ARQUIVO", out var GEARDETA_NOM_ARQUIVO3) && GEARDETA_NOM_ARQUIVO3 == "CVPAGSIN");
                Assert.True(envList3[1].TryGetValue("GEARDETA_SEQ_GERACAO", out var GEARDETA_SEQ_GERACAO3) && GEARDETA_SEQ_GERACAO3 == "000000002");
                ...
                Assert.True(envList4[1].TryGetValue("GEARDETA_NOM_ARQUIVO", out var GEARDETA_NOM_ARQUIVO4) && GEARDETA_NOM_ARQUIVO4 == "CVPAGSIN");
                Assert.True(envList4[1].TryGetValue("GEARDETA_SEQ_GERACAO", out var GEARDETA_SEQ_GERACAO4) && GEARDETA_SEQ_GERACAO4 == "000000002");
                ...
                Assert.True(envList4[1].TryGetValue("SIARDEVC_TIPO_REGISTRO", out var SIARDEVC_TIPO_REGISTRO) && SIARDEVC_TIPO_REGISTRO == "C");
                ...
                Assert.True(envList5[1].TryGetValue("SIARDEVC_TIPO_REGISTRO", out var SIARDEVC_TIPO_REGISTRO5) && SIARDEVC_TIPO_REGISTRO5 == "C");
                Assert.True(envList5[1].TryGetValue("SIARDEVC_SEQ_REGISTRO", out var SIARDEVC_SEQ_REGISTRO5) && SIARDEVC_SEQ_REGISTRO5 == "000000001");
                Assert.True(envList5[1].TryGetValue("SIARDEVC_NOM_ARQUIVO", out var SIARDEVC_NOM_ARQUIVO) && SIARDEVC_NOM_ARQUIVO == "arquivo ");
        ...
        [Theory]
        [InlineData("SI9148B_t2")]
        public static void SI9148B_Tests99_Theory(string CVPAGSIN_FILE_NAME_P)
        {
            string timestamp = DateTime.Now.ToString("yyyyMMdd_HHmmss");
