...
{
    public class GE0530S_C001 : QueryBasis<GE0530S_C001>
    {
        ...
        public GE0530S_C001() { IsCursor = true; }

        public GE0530S_C001(bool justACursor)
        {
        ...
        public override GE0530S_C001 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new GE0530S_C001();
            var i = 0;
