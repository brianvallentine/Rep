...
{
    public class R5000_00_GERA_PROXIMA_DB_INSERT_7_Insert1 : QueryBasis<R5000_00_GERA_PROXIMA_DB_INSERT_7_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string WHOST_VLPREMIO_ATR { get; set; }
        public string V0CONV_CODCONV { get; set; }

        public static void Execute(R5000_00_GERA_PROXIMA_DB_INSERT_7_Insert1 r5000_00_GERA_PROXIMA_DB_INSERT_7_Insert1)
        {
            var ths = r5000_00_GERA_PROXIMA_DB_INSERT_7_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5000_00_GERA_PROXIMA_DB_INSERT_7_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
