...
{
    public class R5540_10_OCORHIST_DB_UPDATE_1_Update1 : QueryBasis<R5540_10_OCORHIST_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R5540_10_OCORHIST_DB_UPDATE_1_Update1 r5540_10_OCORHIST_DB_UPDATE_1_Update1)
        {
            var ths = r5540_10_OCORHIST_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5540_10_OCORHIST_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
