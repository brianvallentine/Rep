...
{
    public class R7000_00_QUITA_ATRASADA_DB_INSERT_1_Insert1 : QueryBasis<R7000_00_QUITA_ATRASADA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R7000_00_QUITA_ATRASADA_DB_INSERT_1_Insert1 r7000_00_QUITA_ATRASADA_DB_INSERT_1_Insert1)
        {
            var ths = r7000_00_QUITA_ATRASADA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R7000_00_QUITA_ATRASADA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
