...
{
    public class R5000_00_GERA_PROXIMA_DB_SELECT_2_Query1 : QueryBasis<R5000_00_GERA_PROXIMA_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R5000_00_GERA_PROXIMA_DB_SELECT_2_Query1 Execute(R5000_00_GERA_PROXIMA_DB_SELECT_2_Query1 r5000_00_GERA_PROXIMA_DB_SELECT_2_Query1)
        {
            var ths = r5000_00_GERA_PROXIMA_DB_SELECT_2_Query1;
        ...
        public override R5000_00_GERA_PROXIMA_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R5000_00_GERA_PROXIMA_DB_SELECT_2_Query1();
            var i = 0;
