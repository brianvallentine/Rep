...
{
    public class R4000_20_LE_CDIFANT_DB_INSERT_1_Insert1 : QueryBasis<R4000_20_LE_CDIFANT_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4000_20_LE_CDIFANT_DB_INSERT_1_Insert1 r4000_20_LE_CDIFANT_DB_INSERT_1_Insert1)
        {
            var ths = r4000_20_LE_CDIFANT_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4000_20_LE_CDIFANT_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
