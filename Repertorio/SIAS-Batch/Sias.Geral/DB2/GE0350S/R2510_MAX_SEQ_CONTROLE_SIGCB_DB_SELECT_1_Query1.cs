...
{
    public class R2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1 : QueryBasis<R2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1 Execute(R2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1 r2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1)
        {
            var ths = r2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1;
        ...
        public override R2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2510_MAX_SEQ_CONTROLE_SIGCB_DB_SELECT_1_Query1();
            var i = 0;
