...
{
    public class R4920_INSERE_NN_HIST_DB_INSERT_1_Insert1 : QueryBasis<R4920_INSERE_NN_HIST_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4920_INSERE_NN_HIST_DB_INSERT_1_Insert1 r4920_INSERE_NN_HIST_DB_INSERT_1_Insert1)
        {
            var ths = r4920_INSERE_NN_HIST_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4920_INSERE_NN_HIST_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
