...
{
    public class R7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1 : QueryBasis<R7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            WHERE B.COD_CLIENTE = :CLIENTES-COD-CLIENTE)
            WITH UR
            END-EXEC.
            */
            #endregion
            var query = @$"
				SELECT ENDERECO 
							...
							, ' ' )
											...
											(SELECT MAX(B.OCORR_ENDERECO)
											FROM SEGUROS.ENDERECOS B
											WHERE B.COD_CLIENTE = '{this.CLIENTES_COD_CLIENTE}')
											WITH UR";
        ...
        public static R7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1 Execute(R7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1 r7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1)
        {
            var ths = r7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1;
        ...
        public override R7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R7300_00_SELECT_ENDERECOS_DB_SELECT_1_Query1();
            var i = 0;
