...
{
    public class R5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1 : QueryBasis<R5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            var query = @$"
				SELECT NUM_PROPOSTA 
							...
							,
											DATE(DTA_VENCIMENTO + QTD_DIAS_CUSTODIA DAYS)
											FROM SEGUROS.GE_CONTROLE_EMISSAO_SIGCB A
											WHERE A.NUM_IDLG = '{this.GE403_NUM_IDLG}'
											AND A.SEQ_CONTROLE_SIGCB =
											(SELECT MAX(B.SEQ_CONTROLE_SIGCB)
											FROM SEGUROS.GE_CONTROLE_EMISSAO_SIGCB B
											WHERE B.NUM_IDLG = '{this.GE403_NUM_IDLG}')
											WITH UR";
        ...
        public static R5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1 Execute(R5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1 r5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1)
        {
            var ths = r5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1;
        ...
        public override R5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R5000_CONSULTA_NN_NUM_IDLG_DB_SELECT_1_Query1();
            var i = 0;
