...
{
    public class GECPB100_C04 : QueryBasis<GECPB100_C04>
    {
        ...
        public GECPB100_C04() { IsCursor = true; }

        public GECPB100_C04(bool justACursor)
        {
        ...
        public string GE537_NOM_PROGRAMA { get; set; }
        public string C04_QTD { get; set; }
        ...
        public override GECPB100_C04 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new GECPB100_C04();
            var i = 0;
            ...
            dta.GE537_NOM_PROGRAMA = result[i++].Value?.ToString();
            dta.C04_QTD = result[i++].Value?.ToString();
