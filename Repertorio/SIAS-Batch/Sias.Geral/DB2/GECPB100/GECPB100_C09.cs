...
{
    public class GECPB100_C09 : QueryBasis<GECPB100_C09>
    {
        ...
        public GECPB100_C09() { IsCursor = true; }

        public GECPB100_C09(bool justACursor)
        {
        ...
        public string VIND_COD_LOTE_A { get; set; }
        ...
        public override GECPB100_C09 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new GECPB100_C09();
            var i = 0;
            ...
            dta.VIND_COD_LOTE_A = string.IsNullOrWhiteSpace(dta.GE537_COD_LOTE_A) ? "-1" : "0";
            ...
            dta.C09_QTD = result[i++].Value?.ToString();
