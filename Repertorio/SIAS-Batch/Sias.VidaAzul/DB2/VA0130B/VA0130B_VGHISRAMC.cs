...
{
    public class VA0130B_VGHISRAMC : QueryBasis<VA0130B_VGHISRAMC>
    {
        ...
        public VA0130B_VGHISRAMC() { IsCursor = true; }

        public VA0130B_VGHISRAMC(bool justACursor)
        {
        ...
        public override VA0130B_VGHISRAMC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0130B_VGHISRAMC();
            var i = 0;
