...
{
    public class VA0130B_VGPLAACES : QueryBasis<VA0130B_VGPLAACES>
    {
        ...
        public VA0130B_VGPLAACES() { IsCursor = true; }

        public VA0130B_VGPLAACES(bool justACursor)
        {
        ...
        public override VA0130B_VGPLAACES OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0130B_VGPLAACES();
            var i = 0;
