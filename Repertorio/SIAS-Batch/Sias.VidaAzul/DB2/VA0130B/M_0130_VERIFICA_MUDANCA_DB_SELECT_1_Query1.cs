...
{
    public class M_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1 : QueryBasis<M_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1 Execute(M_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1 m_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1)
        {
            var ths = m_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1;
        ...
        public override M_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_0130_VERIFICA_MUDANCA_DB_SELECT_1_Query1();
            var i = 0;
