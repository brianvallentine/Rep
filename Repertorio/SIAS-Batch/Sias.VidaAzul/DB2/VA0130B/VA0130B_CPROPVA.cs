...
{
    public class VA0130B_CPROPVA : QueryBasis<VA0130B_CPROPVA>
    {
        ...
        public VA0130B_CPROPVA() { IsCursor = true; }

        public VA0130B_CPROPVA(bool justACursor)
        {
            JustACursor = justACursor;
            IsCursor = true;
        }

        public string PROPVA_TEM_ANTECIP { get; set; }
        ...
        public string PROPVA_DTPROXVEN_1 { get; set; }
        ...
        public string PROPVA_STA_MUDANCA_PLANO { get; set; }
        ...
        public override VA0130B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0130B_CPROPVA();
            var i = 0;

            dta.PROPVA_TEM_ANTECIP = result[i++].Value?.ToString();
            ...
            dta.PROPVA_DTPROXVEN_1 = result[i++].Value?.ToString();
            ...
            dta.PROPVA_STA_MUDANCA_PLANO = result[i++].Value?.ToString();
