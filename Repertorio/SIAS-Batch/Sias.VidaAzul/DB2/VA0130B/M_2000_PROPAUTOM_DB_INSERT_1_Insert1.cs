...
{
    public class M_2000_PROPAUTOM_DB_INSERT_1_Insert1 : QueryBasis<M_2000_PROPAUTOM_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0MOVIMENTO VALUES ({FieldThreatment(this.PROPVA_NUM_APOLICE)}, {FieldThreatment(this.PROPVA_CODSUBES)}, {FieldThreatment(this.PROPVA_FONTE)}, {FieldThreatment(this.FONTE_PROPAUTOM)}, '1' , {FieldThreatment(this.PROPVA_NRCERTIF)}, ' ' , '4' , {FieldThreatment(this.PROPVA_CODCLIEN)}, 0, 0, 0, 0, {FieldThreatment(this.PLAVAVGA_FAIXA)}, 'S' , 'S' , {FieldThreatment(this.OPCAOP_PERIPGTO)}, 12, ' ' , {FieldThreatment(this.PROPVA_EST_CIV)}, {FieldThreatment(this.PROPVA_SEXO)}, 0, ' ' , 1, 1, 104, {FieldThreatment(this.PROPVA_AGECOBR)}, ' ' , 0, {FieldThreatment(this.MNUM_CTA_CORRENTE)}, {FieldThreatment(this.MDAC_CTA_CORRENTE)}, 0, ' ' , '1' , 0, 0, 0, 0, 0, {FieldThreatment(this.PLAVAVGA_TAXAAP)}, {FieldThreatment(this.WHOST_TXAPIP)}, {FieldThreatment(this.SEGURA_TXAPAMDS)}, {FieldThreatment(this.SEGURA_TXAPDH)}, {FieldThreatment(this.SEGURA_TXAPDIT)}, {FieldThreatment(this.SEGURA_TXVG)}, {FieldThreatment(this.COBERP_IMPMORNATU_ANT)}, {FieldThreatment(this.COBERP_IMPMORNATU_ATU)}, {FieldThreatment(this.COBERP_IMPMORACID_ANT)}, {FieldThreatment(this.COBERP_IMPMORACID_ATU)}, {FieldThreatment(this.COBERP_IMPINVPERM_ANT)}, {FieldThreatment(this.COBERP_IMPINVPERM_ATU)}, {FieldThreatment(this.COBERP_IMPAMDS_ANT)}, {FieldThreatment(this.COBERP_IMPAMDS_ATU)}, {FieldThreatment(this.COBERP_IMPDH_ANT)}, {FieldThreatment(this.COBERP_IMPDH_ATU)}, {FieldThreatment(this.COBERP_IMPDIT_ANT)}, {FieldThreatment(this.COBERP_IMPDIT_ATU)}, {FieldThreatment(this.COBERP_PRMVG_ANT)}, {FieldThreatment(this.COBERP_PRMVG_ATU)}, {FieldThreatment(this.COBERP_PRMAP_ANT)}, {FieldThreatment(this.COBERP_PRMAP_ATU)}, {FieldThreatment(this.COD_OPERACAO)}, {FieldThreatment(this.SISTEMA_DTMOVABE)}, 0, '1' , 'VA0130B' , {FieldThreatment(this.SISTEMA_DTMOVABE)}, NULL, NULL, {FieldThreatment(this.CLIENT_DTNASC)}, NULL, {FieldThreatment(this.SISTEMA_DTMOVABE)}, {FieldThreatment(this.DATA_MOVIMENTO)}, NULL, {FieldThreatment(this.SEGURA_LOT_EMP_SEGURADO)})";
        ...
        public string WHOST_TXAPIP { get; set; }
        ...
        public static void Execute(M_2000_PROPAUTOM_DB_INSERT_1_Insert1 m_2000_PROPAUTOM_DB_INSERT_1_Insert1)
        {
            var ths = m_2000_PROPAUTOM_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_2000_PROPAUTOM_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
