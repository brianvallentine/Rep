...
{
    public class VA0344B_DEBITO : QueryBasis<VA0344B_DEBITO>
    {
        ...
        public VA0344B_DEBITO() { IsCursor = true; }

        public VA0344B_DEBITO(bool justACursor)
        {
        ...
        public override VA0344B_DEBITO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0344B_DEBITO();
            var i = 0;
