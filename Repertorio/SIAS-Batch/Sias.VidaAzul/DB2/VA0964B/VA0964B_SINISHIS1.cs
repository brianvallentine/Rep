...
{
    public class VA0964B_SINISHIS1 : QueryBasis<VA0964B_SINISHIS1>
    {
        ...
        public VA0964B_SINISHIS1() { IsCursor = true; }

        public VA0964B_SINISHIS1(bool justACursor)
        {
        ...
        public override VA0964B_SINISHIS1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0964B_SINISHIS1();
            var i = 0;
