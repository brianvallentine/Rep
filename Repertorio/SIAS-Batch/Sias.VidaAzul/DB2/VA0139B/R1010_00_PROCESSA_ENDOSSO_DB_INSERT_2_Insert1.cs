...
{
    public class R1010_00_PROCESSA_ENDOSSO_DB_INSERT_2_Insert1 : QueryBasis<R1010_00_PROCESSA_ENDOSSO_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1010_00_PROCESSA_ENDOSSO_DB_INSERT_2_Insert1 r1010_00_PROCESSA_ENDOSSO_DB_INSERT_2_Insert1)
        {
            var ths = r1010_00_PROCESSA_ENDOSSO_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1010_00_PROCESSA_ENDOSSO_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
