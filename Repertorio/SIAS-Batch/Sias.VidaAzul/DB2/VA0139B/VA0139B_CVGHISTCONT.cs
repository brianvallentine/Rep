...
{
    public class VA0139B_CVGHISTCONT : QueryBasis<VA0139B_CVGHISTCONT>
    {
        ...
        public VA0139B_CVGHISTCONT() { IsCursor = true; }

        public VA0139B_CVGHISTCONT(bool justACursor)
        {
        ...
        public override VA0139B_CVGHISTCONT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0139B_CVGHISTCONT();
            var i = 0;
