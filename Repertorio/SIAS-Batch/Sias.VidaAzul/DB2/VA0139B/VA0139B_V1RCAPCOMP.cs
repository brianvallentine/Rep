...
{
    public class VA0139B_V1RCAPCOMP : QueryBasis<VA0139B_V1RCAPCOMP>
    {
        ...
        public VA0139B_V1RCAPCOMP() { IsCursor = true; }

        public VA0139B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VA0139B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0139B_V1RCAPCOMP();
            var i = 0;
