...
{
    public class VA0601B_VGPLAACES : QueryBasis<VA0601B_VGPLAACES>
    {
        ...
        public VA0601B_VGPLAACES() { IsCursor = true; }

        public VA0601B_VGPLAACES(bool justACursor)
        {
        ...
        public override VA0601B_VGPLAACES OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0601B_VGPLAACES();
            var i = 0;
