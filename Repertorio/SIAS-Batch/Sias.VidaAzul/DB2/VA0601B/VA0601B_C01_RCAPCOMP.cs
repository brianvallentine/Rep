...
{
    public class VA0601B_C01_RCAPCOMP : QueryBasis<VA0601B_C01_RCAPCOMP>
    {
        ...
        public VA0601B_C01_RCAPCOMP() { IsCursor = true; }

        public VA0601B_C01_RCAPCOMP(bool justACursor)
        {
        ...
        public override VA0601B_C01_RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0601B_C01_RCAPCOMP();
            var i = 0;
