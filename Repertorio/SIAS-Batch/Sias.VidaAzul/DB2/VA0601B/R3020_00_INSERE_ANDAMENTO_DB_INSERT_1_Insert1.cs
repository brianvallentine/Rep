...
{
    public class R3020_00_INSERE_ANDAMENTO_DB_INSERT_1_Insert1 : QueryBasis<R3020_00_INSERE_ANDAMENTO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3020_00_INSERE_ANDAMENTO_DB_INSERT_1_Insert1 r3020_00_INSERE_ANDAMENTO_DB_INSERT_1_Insert1)
        {
            var ths = r3020_00_INSERE_ANDAMENTO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3020_00_INSERE_ANDAMENTO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
