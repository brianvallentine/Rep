...
{
    public class VA0601B_CPESENDERR : QueryBasis<VA0601B_CPESENDERR>
    {
        ...
        public VA0601B_CPESENDERR() { IsCursor = true; }

        public VA0601B_CPESENDERR(bool justACursor)
        {
        ...
        public override VA0601B_CPESENDERR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0601B_CPESENDERR();
            var i = 0;
