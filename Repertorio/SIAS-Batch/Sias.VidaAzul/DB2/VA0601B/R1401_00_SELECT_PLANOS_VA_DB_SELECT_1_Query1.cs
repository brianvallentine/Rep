...
{
    public class R1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1 : QueryBasis<R1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            /*EXEC SQL
            SELECT VALUE (IMPMORNATU,0)
            INTO :WHOST-IMPMORNATU
        ...
        public string WHOST_IMPMORNATU { get; set; }
        ...
        public static R1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1 Execute(R1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1 r1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1)
        {
            var ths = r1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1;
        ...
        public override R1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1401_00_SELECT_PLANOS_VA_DB_SELECT_1_Query1();
            var i = 0;
            dta.WHOST_IMPMORNATU = result[i++].Value?.ToString();
            return dta;
        }
