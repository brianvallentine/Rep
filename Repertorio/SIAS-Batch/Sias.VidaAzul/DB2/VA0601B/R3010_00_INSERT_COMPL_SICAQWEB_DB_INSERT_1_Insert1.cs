    ...
    public class R3010_00_INSERT_COMPL_SICAQWEB_DB_INSERT_1_Insert1 : QueryBasis<R3010_00_INSERT_COMPL_SICAQWEB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.VG_COMPL_SICAQWEB ( NUM_CERTIFICADO , COD_OPERADOR , NUM_CORRESP_CX_AQUI , IND_TP_CORRESP_SICAQ , DTA_CONTRATACAO , HRA_CONTRATACAO , NUM_PROPOSTA_SICAQ , IND_ORIGEM_PROPOSTA , NOM_PROGRAMA , DTH_CADASTRAMENTO ) VALUES ( {FieldThreatment(this.PROPOFID_NUM_PROPOSTA_SIVPF)} ,{FieldThreatment(this.VG084_COD_OPERADOR)} ,{FieldThreatment(this.VG084_NUM_CORRESP_CX_AQUI)} ,{FieldThreatment(this.VG084_IND_TP_CORRESP_SICAQ)} ,{FieldThreatment(this.VG084_DTA_CONTRATACAO)} ,{FieldThreatment(this.VG084_HRA_CONTRATACAO)} ,{FieldThreatment(this.VG084_NUM_PROPOSTA_SICAQ)} ,{FieldThreatment(this.VG084_IND_ORIGEM_PROPOSTA)} ,{FieldThreatment(this.VG084_NOM_PROGRAMA)} , CURRENT TIMESTAMP )";
