...
{
    public class VA0601B_CPESENDER : QueryBasis<VA0601B_CPESENDER>
    {
        ...
        public VA0601B_CPESENDER() { IsCursor = true; }

        public VA0601B_CPESENDER(bool justACursor)
        {
        ...
        public override VA0601B_CPESENDER OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0601B_CPESENDER();
            var i = 0;
