...
{
    public class VA0601B_CVGRAMOCOMP : QueryBasis<VA0601B_CVGRAMOCOMP>
    {
        ...
        public VA0601B_CVGRAMOCOMP() { IsCursor = true; }

        public VA0601B_CVGRAMOCOMP(bool justACursor)
        {
        ...
        public override VA0601B_CVGRAMOCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0601B_CVGRAMOCOMP();
            var i = 0;
