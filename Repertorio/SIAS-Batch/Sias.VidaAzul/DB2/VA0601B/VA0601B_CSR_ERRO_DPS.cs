...
{
    public class VA0601B_CSR_ERRO_DPS : QueryBasis<VA0601B_CSR_ERRO_DPS>
    {
        ...
        public VA0601B_CSR_ERRO_DPS() { IsCursor = true; }

        public VA0601B_CSR_ERRO_DPS(bool justACursor)
        {
        ...
        public override VA0601B_CSR_ERRO_DPS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0601B_CSR_ERRO_DPS();
            var i = 0;
