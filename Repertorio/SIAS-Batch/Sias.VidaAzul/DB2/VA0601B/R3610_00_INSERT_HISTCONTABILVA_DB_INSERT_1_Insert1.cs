...
{
    public class R3610_00_INSERT_HISTCONTABILVA_DB_INSERT_1_Insert1 : QueryBasis<R3610_00_INSERT_HISTCONTABILVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3610_00_INSERT_HISTCONTABILVA_DB_INSERT_1_Insert1 r3610_00_INSERT_HISTCONTABILVA_DB_INSERT_1_Insert1)
        {
            var ths = r3610_00_INSERT_HISTCONTABILVA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3610_00_INSERT_HISTCONTABILVA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
