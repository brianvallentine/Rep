...
{
    public class VA0601B_C01_GECLIMOV : QueryBasis<VA0601B_C01_GECLIMOV>
    {
        ...
        public VA0601B_C01_GECLIMOV() { IsCursor = true; }

        public VA0601B_C01_GECLIMOV(bool justACursor)
        {
        ...
        public override VA0601B_C01_GECLIMOV OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0601B_C01_GECLIMOV();
            var i = 0;
