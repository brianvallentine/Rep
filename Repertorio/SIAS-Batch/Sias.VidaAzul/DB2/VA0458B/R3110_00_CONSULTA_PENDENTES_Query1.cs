...
{
    public class R3110_00_CONSULTA_PENDENTES_Query1 : QueryBasis<R3110_00_CONSULTA_PENDENTES_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3110_00_CONSULTA_PENDENTES_Query1 Execute(R3110_00_CONSULTA_PENDENTES_Query1 r3110_00_CONSULTA_PENDENTES_Query1)
        {
            var ths = r3110_00_CONSULTA_PENDENTES_Query1;
        ...
        public override R3110_00_CONSULTA_PENDENTES_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3110_00_CONSULTA_PENDENTES_Query1();
            var i = 0;
