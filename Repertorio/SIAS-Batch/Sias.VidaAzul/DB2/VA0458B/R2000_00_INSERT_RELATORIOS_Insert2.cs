...
{
    public class R2000_00_INSERT_RELATORIOS_Insert2 : QueryBasis<R2000_00_INSERT_RELATORIOS_Insert2>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2000_00_INSERT_RELATORIOS_Insert2 r2000_00_INSERT_RELATORIOS_Insert2)
        {
            var ths = r2000_00_INSERT_RELATORIOS_Insert2;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2000_00_INSERT_RELATORIOS_Insert2 OpenData(List<KeyValuePair<string, object>> result)
        {
