...
{
    public class VA3437B_CMSG : QueryBasis<VA3437B_CMSG>
    {
        ...
        public VA3437B_CMSG() { IsCursor = true; }

        public VA3437B_CMSG(bool justACursor)
        {
        ...
        public string COBMENVG_IDFORM { get; set; }
        ...
        public override VA3437B_CMSG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA3437B_CMSG();
            var i = 0;
            ...
            dta.COBMENVG_IDFORM = result[i++].Value?.ToString();
