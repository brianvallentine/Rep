...
{
    public class VA3437B_V1AGENCEF : QueryBasis<VA3437B_V1AGENCEF>
    {
        ...
        public VA3437B_V1AGENCEF() { IsCursor = true; }

        public VA3437B_V1AGENCEF(bool justACursor)
        {
        ...
        public override VA3437B_V1AGENCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA3437B_V1AGENCEF();
            var i = 0;
