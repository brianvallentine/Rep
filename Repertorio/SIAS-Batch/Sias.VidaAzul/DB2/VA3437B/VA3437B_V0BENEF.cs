...
{
    public class VA3437B_V0BENEF : QueryBasis<VA3437B_V0BENEF>
    {
        ...
        public VA3437B_V0BENEF() { IsCursor = true; }

        public VA3437B_V0BENEF(bool justACursor)
        {
        ...
        public override VA3437B_V0BENEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA3437B_V0BENEF();
            var i = 0;
