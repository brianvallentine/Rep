...
{
    public class VA3437B_CRELAT : QueryBasis<VA3437B_CRELAT>
    {
        ...
        public VA3437B_CRELAT() { IsCursor = true; }

        public VA3437B_CRELAT(bool justACursor)
        {
        ...
        public override VA3437B_CRELAT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA3437B_CRELAT();
            var i = 0;
