...
{
    public class VA3437B_CFAIXACEP : QueryBasis<VA3437B_CFAIXACEP>
    {
        ...
        public VA3437B_CFAIXACEP() { IsCursor = true; }

        public VA3437B_CFAIXACEP(bool justACursor)
        {
        ...
        public override VA3437B_CFAIXACEP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA3437B_CFAIXACEP();
            var i = 0;
