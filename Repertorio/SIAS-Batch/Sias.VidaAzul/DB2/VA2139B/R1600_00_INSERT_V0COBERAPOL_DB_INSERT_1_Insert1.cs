...
{
    public class R1600_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1 : QueryBasis<R1600_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string V0COBA_SITUACAO { get; set; }
        public string VIND_SITUACAO { get; set; }

        public static void Execute(R1600_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1 r1600_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1)
        {
            var ths = r1600_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1600_00_INSERT_V0COBERAPOL_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
