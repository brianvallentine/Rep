...
{
    public class VA2139B_CHISTCTBL : QueryBasis<VA2139B_CHISTCTBL>
    {
        ...
        public VA2139B_CHISTCTBL() { IsCursor = true; }

        public VA2139B_CHISTCTBL(bool justACursor)
        {
        ...
        public override VA2139B_CHISTCTBL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2139B_CHISTCTBL();
            var i = 0;
