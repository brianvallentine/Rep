...
{
    public class R1320_10_FETCH_V1APOLCOSCED_DB_INSERT_1_Insert1 : QueryBasis<R1320_10_FETCH_V1APOLCOSCED_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1320_10_FETCH_V1APOLCOSCED_DB_INSERT_1_Insert1 r1320_10_FETCH_V1APOLCOSCED_DB_INSERT_1_Insert1)
        {
            var ths = r1320_10_FETCH_V1APOLCOSCED_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1320_10_FETCH_V1APOLCOSCED_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
