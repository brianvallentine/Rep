...
{
    public class R1400_00_GRAVA_V0HISTOPARC_DB_INSERT_1_Insert1 : QueryBasis<R1400_00_GRAVA_V0HISTOPARC_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1400_00_GRAVA_V0HISTOPARC_DB_INSERT_1_Insert1 r1400_00_GRAVA_V0HISTOPARC_DB_INSERT_1_Insert1)
        {
            var ths = r1400_00_GRAVA_V0HISTOPARC_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1400_00_GRAVA_V0HISTOPARC_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
