...
{
    public class VA4648B_FUNDOCOMISVA : QueryBasis<VA4648B_FUNDOCOMISVA>
    {
        ...
        public VA4648B_FUNDOCOMISVA() { IsCursor = true; }

        public VA4648B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override VA4648B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA4648B_FUNDOCOMISVA();
            var i = 0;
