...
{
    public class R1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1 : QueryBasis<R1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND DATA_INIVIGENCIA <= :RELATORI-DATA-SOLICITACAO
            ...
            */
            ...
            var query = @$"
				SELECT OPCAO_PAGAMENTO
											...
											AND DATA_INIVIGENCIA <= '{this.RELATORI_DATA_SOLICITACAO}'
        ...
        public static R1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1 Execute(R1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1 r1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1)
        {
            var ths = r1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1;
        ...
        public override R1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1106_00_BUSCA_DADOS_VLN9A_DB_SELECT_1_Query1();
            var i = 0;
