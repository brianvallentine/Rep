...
{
    public class R0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1 : QueryBasis<R0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND DATA_INIVIGENCIA <= :FUNCOMVA-DATA-QUITACAO
            AND DATA_TERVIGENCIA >= :FUNCOMVA-DATA-QUITACAO
            ...
            */
            ...
            var query = @$"
				SELECT DATA_INIVIGENCIA
											...
											AND DATA_INIVIGENCIA <= '{this.FUNCOMVA_DATA_QUITACAO}'
											AND DATA_TERVIGENCIA >= '{this.FUNCOMVA_DATA_QUITACAO}'
											FETCH FIRST 1 ROWS ONLY
											WITH UR";
        ...
        public static R0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1 Execute(R0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1 r0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1)
        {
            var ths = r0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1;
        ...
        public override R0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0430_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1();
            var i = 0;
