...
{
    public class R3300_00_INSERT_COMISSOE_DB_INSERT_1_Insert1 : QueryBasis<R3300_00_INSERT_COMISSOE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3300_00_INSERT_COMISSOE_DB_INSERT_1_Insert1 r3300_00_INSERT_COMISSOE_DB_INSERT_1_Insert1)
        {
            var ths = r3300_00_INSERT_COMISSOE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3300_00_INSERT_COMISSOE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
