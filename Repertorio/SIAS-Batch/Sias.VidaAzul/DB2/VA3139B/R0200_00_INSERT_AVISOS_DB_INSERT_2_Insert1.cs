...
{
    public class R0200_00_INSERT_AVISOS_DB_INSERT_2_Insert1 : QueryBasis<R0200_00_INSERT_AVISOS_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0200_00_INSERT_AVISOS_DB_INSERT_2_Insert1 r0200_00_INSERT_AVISOS_DB_INSERT_2_Insert1)
        {
            var ths = r0200_00_INSERT_AVISOS_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0200_00_INSERT_AVISOS_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
