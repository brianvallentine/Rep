...
{
    public class R2520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1 : QueryBasis<R2520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1 r2520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1)
        {
            var ths = r2520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2520_00_INSERT_ENDOSSOS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
