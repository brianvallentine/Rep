...
{
    public class R2550_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1 : QueryBasis<R2550_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2550_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1 r2550_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1)
        {
            var ths = r2550_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2550_00_INSERT_PARCEHIS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
