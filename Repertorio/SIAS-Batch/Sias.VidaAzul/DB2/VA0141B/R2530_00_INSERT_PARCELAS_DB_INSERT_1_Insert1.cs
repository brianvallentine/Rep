...
{
    public class R2530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1 : QueryBasis<R2530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string VIND_SITCOB { get; set; }

        public static void Execute(R2530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1 r2530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1)
        {
            var ths = r2530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2530_00_INSERT_PARCELAS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
