...
{
    public class R9000_00_INSERT_RELATORI_DB_INSERT_1_Insert1 : QueryBasis<R9000_00_INSERT_RELATORI_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R9000_00_INSERT_RELATORI_DB_INSERT_1_Insert1 r9000_00_INSERT_RELATORI_DB_INSERT_1_Insert1)
        {
            var ths = r9000_00_INSERT_RELATORI_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R9000_00_INSERT_RELATORI_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
