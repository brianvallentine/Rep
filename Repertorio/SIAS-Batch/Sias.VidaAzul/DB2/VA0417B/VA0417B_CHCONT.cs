...
namespace Sias.VidaAzul.DB2.VA0417B
{
    public class VA0417B_CHCONT : QueryBasis<VA0417B_CHCONT>
    {
        ...
        public VA0417B_CHCONT() { IsCursor = true; }

        public VA0417B_CHCONT(bool justACursor)
        {
        ...
        public override VA0417B_CHCONT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0417B_CHCONT();
            var i = 0;
