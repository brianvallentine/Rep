...
{
    public class VA1139B_CHISTCTBL : QueryBasis<VA1139B_CHISTCTBL>
    {
        ...
        public VA1139B_CHISTCTBL() { IsCursor = true; }

        public VA1139B_CHISTCTBL(bool justACursor)
        {
        ...
        public override VA1139B_CHISTCTBL OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1139B_CHISTCTBL();
            var i = 0;
