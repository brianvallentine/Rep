...
{
    public class VA1139B_CPROPVA : QueryBasis<VA1139B_CPROPVA>
    {
        ...
        public VA1139B_CPROPVA() { IsCursor = true; }

        public VA1139B_CPROPVA(bool justACursor)
        {
        ...
        public override VA1139B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1139B_CPROPVA();
            var i = 0;
