...
{
    public class VA1139B_V1RCAPCOMP : QueryBasis<VA1139B_V1RCAPCOMP>
    {
        ...
        public VA1139B_V1RCAPCOMP() { IsCursor = true; }

        public VA1139B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VA1139B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1139B_V1RCAPCOMP();
            var i = 0;
