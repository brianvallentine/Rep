...
{
    public class VA0951B_CESCNEG : QueryBasis<VA0951B_CESCNEG>
    {
        ...
        public VA0951B_CESCNEG() { IsCursor = true; }

        public VA0951B_CESCNEG(bool justACursor)
        {
        ...
        public override VA0951B_CESCNEG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0951B_CESCNEG();
            var i = 0;
