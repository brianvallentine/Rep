...
{
    public class VA0118B_V1RCAPCOMP : QueryBasis<VA0118B_V1RCAPCOMP>
    {
        ...
        public VA0118B_V1RCAPCOMP() { IsCursor = true; }

        public VA0118B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VA0118B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0118B_V1RCAPCOMP();
            var i = 0;
