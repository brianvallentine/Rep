...
{
    public class M_8000_INTEGRA_VG_DB_SELECT_3_Query1 : QueryBasis<M_8000_INTEGRA_VG_DB_SELECT_3_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static M_8000_INTEGRA_VG_DB_SELECT_3_Query1 Execute(M_8000_INTEGRA_VG_DB_SELECT_3_Query1 m_8000_INTEGRA_VG_DB_SELECT_3_Query1)
        {
            var ths = m_8000_INTEGRA_VG_DB_SELECT_3_Query1;
        ...
        public override M_8000_INTEGRA_VG_DB_SELECT_3_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_8000_INTEGRA_VG_DB_SELECT_3_Query1();
            var i = 0;
