...
{
    public class VA0118B_CPROPVA : QueryBasis<VA0118B_CPROPVA>
    {
        ...
        public VA0118B_CPROPVA() { IsCursor = true; }

        public VA0118B_CPROPVA(bool justACursor)
        {
        ...
        public string PROPVA_SITUACAO_ORIGINAL { get; set; }
        public string PROPVA_ACATAMENTO { get; set; }
        ...
        public override VA0118B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0118B_CPROPVA();
            var i = 0;
            ...
            dta.PROPVA_SITUACAO_ORIGINAL = result[i++].Value?.ToString();
            dta.PROPVA_ACATAMENTO = result[i++].Value?.ToString();
