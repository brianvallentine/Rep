    ...
    public class M_0200_SOLICITA_CERTIFICADO_DB_INSERT_1_Insert1 : QueryBasis<M_0200_SOLICITA_CERTIFICADO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0RELATORIOS VALUES ( 'VA0118B' , CURRENT DATE, 'VA' , {FieldThreatment(this.RELATO_CODRELAT)}, 0, 0, CURRENT DATE, CURRENT DATE, CURRENT DATE, 0, 0, 0, 0, 0, 0, 0, 0, {FieldThreatment(this.PROPVA_NUM_APOLICE)}, 0, {FieldThreatment(this.RELATO_NRPARCEL)}, {FieldThreatment(this.PROPVA_NRCERTIF)}, 0, {FieldThreatment(this.PROPVA_CODSUBES)}, {FieldThreatment(this.RELATO_OPERACAO)}, 0, 0, ' ' , ' ' , 0, 0, ' ' , 0, 0, ' ' , '0' , ' ' , ' ' , NULL, 0, 0, CURRENT TIMESTAMP)";
