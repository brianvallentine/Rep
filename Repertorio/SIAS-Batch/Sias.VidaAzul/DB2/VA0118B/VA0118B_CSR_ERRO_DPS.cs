...
{
    public class VA0118B_CSR_ERRO_DPS : QueryBasis<VA0118B_CSR_ERRO_DPS>
    {
        ...
        public VA0118B_CSR_ERRO_DPS() { IsCursor = true; }

        public VA0118B_CSR_ERRO_DPS(bool justACursor)
        {
        ...
        public override VA0118B_CSR_ERRO_DPS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0118B_CSR_ERRO_DPS();
            var i = 0;
