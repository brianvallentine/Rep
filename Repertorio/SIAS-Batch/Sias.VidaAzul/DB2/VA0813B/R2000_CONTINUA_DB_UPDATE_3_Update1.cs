...
{
    public class R2000_CONTINUA_DB_UPDATE_3_Update1 : QueryBasis<R2000_CONTINUA_DB_UPDATE_3_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R2000_CONTINUA_DB_UPDATE_3_Update1 r2000_CONTINUA_DB_UPDATE_3_Update1)
        {
            var ths = r2000_CONTINUA_DB_UPDATE_3_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2000_CONTINUA_DB_UPDATE_3_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
