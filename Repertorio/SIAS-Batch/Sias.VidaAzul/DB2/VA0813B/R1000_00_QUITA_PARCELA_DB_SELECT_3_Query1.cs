...
{
    public class R1000_00_QUITA_PARCELA_DB_SELECT_3_Query1 : QueryBasis<R1000_00_QUITA_PARCELA_DB_SELECT_3_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1000_00_QUITA_PARCELA_DB_SELECT_3_Query1 Execute(R1000_00_QUITA_PARCELA_DB_SELECT_3_Query1 r1000_00_QUITA_PARCELA_DB_SELECT_3_Query1)
        {
            var ths = r1000_00_QUITA_PARCELA_DB_SELECT_3_Query1;
        ...
        public override R1000_00_QUITA_PARCELA_DB_SELECT_3_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1000_00_QUITA_PARCELA_DB_SELECT_3_Query1();
            var i = 0;
