...
{
    public class R0400_00_INSERT_COMISSAO_DB_INSERT_1_Insert1 : QueryBasis<R0400_00_INSERT_COMISSAO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0400_00_INSERT_COMISSAO_DB_INSERT_1_Insert1 r0400_00_INSERT_COMISSAO_DB_INSERT_1_Insert1)
        {
            var ths = r0400_00_INSERT_COMISSAO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0400_00_INSERT_COMISSAO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
