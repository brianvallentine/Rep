...
{
    public class VA0813B_CVGRAMOCOMP : QueryBasis<VA0813B_CVGRAMOCOMP>
    {
        ...
        public VA0813B_CVGRAMOCOMP() { IsCursor = true; }

        public VA0813B_CVGRAMOCOMP(bool justACursor)
        {
        ...
        public override VA0813B_CVGRAMOCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0813B_CVGRAMOCOMP();
            var i = 0;
