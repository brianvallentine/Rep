...
{
    public class R0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1 : QueryBasis<R0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            var query = @$"
				SELECT NRTIT
							...
							, '5' )
											...
											AND OCORHIST = '{this.V0HCOB_OCORHIST}'
											ORDER BY NRTIT
											FETCH FIRST 1 ROW ONLY
											WITH UR";
        ...
        public static R0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1 Execute(R0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1 r0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1)
        {
            var ths = r0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1;
        ...
        public override R0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0042_00_SEL_V0HISTCOBVA_DB_SELECT_2_Query1();
            var i = 0;
