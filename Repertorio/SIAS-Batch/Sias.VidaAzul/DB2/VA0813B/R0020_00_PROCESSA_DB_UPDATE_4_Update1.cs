...
{
    public class R0020_00_PROCESSA_DB_UPDATE_4_Update1 : QueryBasis<R0020_00_PROCESSA_DB_UPDATE_4_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R0020_00_PROCESSA_DB_UPDATE_4_Update1 r0020_00_PROCESSA_DB_UPDATE_4_Update1)
        {
            var ths = r0020_00_PROCESSA_DB_UPDATE_4_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0020_00_PROCESSA_DB_UPDATE_4_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
