...
{
    public class VA0813B_CHCONTA2 : QueryBasis<VA0813B_CHCONTA2>
    {
        ...
        public VA0813B_CHCONTA2() { IsCursor = true; }

        public VA0813B_CHCONTA2(bool justACursor)
        {
        ...
        public override VA0813B_CHCONTA2 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0813B_CHCONTA2();
            var i = 0;
