...
{
    public class R0100_00_INSERT_AVISOS_DB_INSERT_1_Insert1 : QueryBasis<R0100_00_INSERT_AVISOS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0100_00_INSERT_AVISOS_DB_INSERT_1_Insert1 r0100_00_INSERT_AVISOS_DB_INSERT_1_Insert1)
        {
            var ths = r0100_00_INSERT_AVISOS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0100_00_INSERT_AVISOS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
