...
{
    public class VA1417B_CHCONT : QueryBasis<VA1417B_CHCONT>
    {
        ...
        public VA1417B_CHCONT() { IsCursor = true; }

        public VA1417B_CHCONT(bool justACursor)
        {
        ...
        public override VA1417B_CHCONT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1417B_CHCONT();
            var i = 0;
