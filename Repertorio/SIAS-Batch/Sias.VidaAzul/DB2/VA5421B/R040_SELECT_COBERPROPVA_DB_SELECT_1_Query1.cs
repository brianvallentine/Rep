...
namespace Sias.VidaAzul.DB2.VA5421B
{
    public class R040_SELECT_COBERPROPVA_DB_SELECT_1_Query1 : QueryBasis<R040_SELECT_COBERPROPVA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            IMPSEGAUXF,
            VLCUSTAUXF
            INTO :V0COBV-IMPSEGCDG:V0COBV-IMPSEGCDG-I,
            :V0COBV-VLCUSTCDG:V0COBV-VLCUSTCDG-I,
        ...
        public string V0COBV_IMPSEGCDG_I { get; set; }
        public string V0COBV_VLCUSTCDG { get; set; }
        public string V0COBV_VLCUSTCDG_I { get; set; }
        ...
        public override R040_SELECT_COBERPROPVA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            dta.V0COBV_IMPSEGCDG_I = string.IsNullOrWhiteSpace(dta.V0COBV_IMPSEGCDG) ? "-1" : "0";
            dta.V0COBV_VLCUSTCDG = result[i++].Value?.ToString();
            dta.V0COBV_VLCUSTCDG_I = string.IsNullOrWhiteSpace(dta.V0COBV_VLCUSTCDG) ? "-1" : "0";
