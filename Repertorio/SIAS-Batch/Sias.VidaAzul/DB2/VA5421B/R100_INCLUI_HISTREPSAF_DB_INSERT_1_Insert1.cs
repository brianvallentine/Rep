...
{
    public class R100_INCLUI_HISTREPSAF_DB_INSERT_1_Insert1 : QueryBasis<R100_INCLUI_HISTREPSAF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R100_INCLUI_HISTREPSAF_DB_INSERT_1_Insert1 r100_INCLUI_HISTREPSAF_DB_INSERT_1_Insert1)
        {
            var ths = r100_INCLUI_HISTREPSAF_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R100_INCLUI_HISTREPSAF_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
