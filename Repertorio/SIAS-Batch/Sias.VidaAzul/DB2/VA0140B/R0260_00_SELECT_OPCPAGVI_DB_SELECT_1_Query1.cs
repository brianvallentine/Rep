...
namespace Sias.VidaAzul.DB2.VA0140B
{
    public class R0260_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1 : QueryBasis<R0260_00_SELECT_OPCPAGVI_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            ...
            AND DATA_INIVIGENCIA <= :WHOST-DATA-GEROU-PARCELA
            AND DATA_TERVIGENCIA >= :WHOST-DATA-GEROU-PARCELA
            ...
            */
            ...
            var query = @$"
				SELECT DATA_INIVIGENCIA
											...
											AND DATA_INIVIGENCIA <= '{this.WHOST_DATA_GEROU_PARCELA}'
											AND DATA_TERVIGENCIA >= '{this.WHOST_DATA_GEROU_PARCELA}'
											FETCH FIRST 1 ROWS ONLY
											WITH UR";
