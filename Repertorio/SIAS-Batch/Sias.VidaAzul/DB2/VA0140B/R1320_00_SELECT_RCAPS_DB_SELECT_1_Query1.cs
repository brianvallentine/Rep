...
{
    public class R1320_00_SELECT_RCAPS_DB_SELECT_1_Query1 : QueryBasis<R1320_00_SELECT_RCAPS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            WHERE A.NUM_TITULO = :RCAPS-NUM-TITULO
            ...
            */
            ...
            var query = @$"
				SELECT A.SIT_REGISTRO
											...
											FROM SEGUROS.RCAPS A
											,SEGUROS.RCAP_COMPLEMENTAR B
											WHERE A.NUM_TITULO = '{this.RCAPS_NUM_TITULO}'
											AND B.NUM_RCAP = A.NUM_RCAP
											AND B.COD_FONTE = A.COD_FONTE
											AND B.SIT_REGISTRO = '0'
											WITH UR";
        ...
        public static R1320_00_SELECT_RCAPS_DB_SELECT_1_Query1 Execute(R1320_00_SELECT_RCAPS_DB_SELECT_1_Query1 r1320_00_SELECT_RCAPS_DB_SELECT_1_Query1)
        {
            var ths = r1320_00_SELECT_RCAPS_DB_SELECT_1_Query1;
        ...
        public override R1320_00_SELECT_RCAPS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1320_00_SELECT_RCAPS_DB_SELECT_1_Query1();
            var i = 0;
