...
{
    public class R1100_00_GRAVA_DIFPARCEL_DB_DELETE_1_Delete1 : QueryBasis<R1100_00_GRAVA_DIFPARCEL_DB_DELETE_1_Delete1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1100_00_GRAVA_DIFPARCEL_DB_DELETE_1_Delete1 r1100_00_GRAVA_DIFPARCEL_DB_DELETE_1_Delete1)
        {
            var ths = r1100_00_GRAVA_DIFPARCEL_DB_DELETE_1_Delete1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1100_00_GRAVA_DIFPARCEL_DB_DELETE_1_Delete1 OpenData(List<KeyValuePair<string, object>> result)
        {
