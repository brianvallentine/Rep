...
{
    public class R0600_00_UPDATE_ENDOSSOS_DB_UPDATE_1_Update1 : QueryBasis<R0600_00_UPDATE_ENDOSSOS_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R0600_00_UPDATE_ENDOSSOS_DB_UPDATE_1_Update1 r0600_00_UPDATE_ENDOSSOS_DB_UPDATE_1_Update1)
        {
            var ths = r0600_00_UPDATE_ENDOSSOS_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0600_00_UPDATE_ENDOSSOS_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
