...
{
    public class VA0143B_V0HISCONPA : QueryBasis<VA0143B_V0HISCONPA>
    {
        ...
        public VA0143B_V0HISCONPA() { IsCursor = true; }

        public VA0143B_V0HISCONPA(bool justACursor)
        {
        ...
        public override VA0143B_V0HISCONPA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0143B_V0HISCONPA();
            var i = 0;
