...
{
    public class VA0952B_TCOMIS : QueryBasis<VA0952B_TCOMIS>
    {
        ...
        public VA0952B_TCOMIS() { IsCursor = true; }

        public VA0952B_TCOMIS(bool justACursor)
        {
        ...
        public override VA0952B_TCOMIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0952B_TCOMIS();
            var i = 0;
