...
{
    public class VA0126B_FUNDOCOMISVA : QueryBasis<VA0126B_FUNDOCOMISVA>
    {
        ...
        public VA0126B_FUNDOCOMISVA() { IsCursor = true; }

        public VA0126B_FUNDOCOMISVA(bool justACursor)
        {
        ...
        public override VA0126B_FUNDOCOMISVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0126B_FUNDOCOMISVA();
            var i = 0;
