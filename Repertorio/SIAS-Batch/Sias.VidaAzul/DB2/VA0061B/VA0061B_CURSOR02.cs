...
{
    public class VA0061B_CURSOR02 : QueryBasis<VA0061B_CURSOR02>
    {
        ...
        public VA0061B_CURSOR02() { IsCursor = true; }

        public VA0061B_CURSOR02(bool justACursor)
        {
        ...
        public override VA0061B_CURSOR02 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0061B_CURSOR02();
            var i = 0;
