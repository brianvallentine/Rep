...
{
    public class R3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 : QueryBasis<R3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 Execute(R3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 r3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1)
        {
            var ths = r3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1;
        ...
        public override R3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R3000_00_PESQUISA_FORMULARIO_DB_SELECT_1_Query1();
            var i = 0;
