...
{
    public class VA4437B_CMSG : QueryBasis<VA4437B_CMSG>
    {
        ...
        public VA4437B_CMSG() { IsCursor = true; }

        public VA4437B_CMSG(bool justACursor)
        {
        ...
        public override VA4437B_CMSG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA4437B_CMSG();
            var i = 0;
