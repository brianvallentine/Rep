...
{
    public class VA4437B_V0BENEF : QueryBasis<VA4437B_V0BENEF>
    {
        ...
        public VA4437B_V0BENEF() { IsCursor = true; }

        public VA4437B_V0BENEF(bool justACursor)
        {
        ...
        public override VA4437B_V0BENEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA4437B_V0BENEF();
            var i = 0;
