...
{
    public class VA4437B_CFAIXACEP : QueryBasis<VA4437B_CFAIXACEP>
    {
        ...
        public VA4437B_CFAIXACEP() { IsCursor = true; }

        public VA4437B_CFAIXACEP(bool justACursor)
        {
        ...
        public override VA4437B_CFAIXACEP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA4437B_CFAIXACEP();
            var i = 0;
