...
{
    public class R2910_00_OBTEM_NUMERACAO_Query1 : QueryBasis<R2910_00_OBTEM_NUMERACAO_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2910_00_OBTEM_NUMERACAO_Query1 Execute(R2910_00_OBTEM_NUMERACAO_Query1 r2910_00_OBTEM_NUMERACAO_Query1)
        {
            var ths = r2910_00_OBTEM_NUMERACAO_Query1;
        ...
        public override R2910_00_OBTEM_NUMERACAO_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2910_00_OBTEM_NUMERACAO_Query1();
            var i = 0;
