...
{
    public class R2750_00_SELECT_V0CONDTEC_Query1 : QueryBasis<R2750_00_SELECT_V0CONDTEC_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2750_00_SELECT_V0CONDTEC_Query1 Execute(R2750_00_SELECT_V0CONDTEC_Query1 r2750_00_SELECT_V0CONDTEC_Query1)
        {
            var ths = r2750_00_SELECT_V0CONDTEC_Query1;
        ...
        public override R2750_00_SELECT_V0CONDTEC_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2750_00_SELECT_V0CONDTEC_Query1();
            var i = 0;
