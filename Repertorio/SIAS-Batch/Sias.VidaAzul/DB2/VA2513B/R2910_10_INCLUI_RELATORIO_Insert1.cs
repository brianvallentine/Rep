...
{
    public class R2910_10_INCLUI_RELATORIO_Insert1 : QueryBasis<R2910_10_INCLUI_RELATORIO_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2910_10_INCLUI_RELATORIO_Insert1 r2910_10_INCLUI_RELATORIO_Insert1)
        {
            var ths = r2910_10_INCLUI_RELATORIO_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2910_10_INCLUI_RELATORIO_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
