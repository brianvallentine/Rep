...
{
    public class R2610_00_SELECT_V0MULTIMENS_Query1 : QueryBasis<R2610_00_SELECT_V0MULTIMENS_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R2610_00_SELECT_V0MULTIMENS_Query1 Execute(R2610_00_SELECT_V0MULTIMENS_Query1 r2610_00_SELECT_V0MULTIMENS_Query1)
        {
            var ths = r2610_00_SELECT_V0MULTIMENS_Query1;
        ...
        public override R2610_00_SELECT_V0MULTIMENS_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R2610_00_SELECT_V0MULTIMENS_Query1();
            var i = 0;
