...
{
    public class VA2513B_V1AGENCEF : QueryBasis<VA2513B_V1AGENCEF>
    {
        ...
        public VA2513B_V1AGENCEF() { IsCursor = true; }

        public VA2513B_V1AGENCEF(bool justACursor)
        {
        ...
        public override VA2513B_V1AGENCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2513B_V1AGENCEF();
            var i = 0;
