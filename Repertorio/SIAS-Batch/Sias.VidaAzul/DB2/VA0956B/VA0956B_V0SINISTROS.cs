...
{
    public class VA0956B_V0SINISTROS : QueryBasis<VA0956B_V0SINISTROS>
    {
        ...
        public VA0956B_V0SINISTROS() { IsCursor = true; }

        public VA0956B_V0SINISTROS(bool justACursor)
        {
        ...
        public override VA0956B_V0SINISTROS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0956B_V0SINISTROS();
            var i = 0;
