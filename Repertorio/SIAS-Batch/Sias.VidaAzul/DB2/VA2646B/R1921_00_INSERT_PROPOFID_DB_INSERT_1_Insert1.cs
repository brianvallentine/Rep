...
{
    public class R1921_00_INSERT_PROPOFID_DB_INSERT_1_Insert1 : QueryBasis<R1921_00_INSERT_PROPOFID_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :PROPOFID-DATA-NASC-CONJUGE :VIND-NULL-3,
        ...
        public string VIND_NULL_3 { get; set; }
        ...
        public static void Execute(R1921_00_INSERT_PROPOFID_DB_INSERT_1_Insert1 r1921_00_INSERT_PROPOFID_DB_INSERT_1_Insert1)
        {
            var ths = r1921_00_INSERT_PROPOFID_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1921_00_INSERT_PROPOFID_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
