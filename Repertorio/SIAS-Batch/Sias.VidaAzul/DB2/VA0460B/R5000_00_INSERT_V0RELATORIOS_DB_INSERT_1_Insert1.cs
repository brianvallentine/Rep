...
{
    public class R5000_00_INSERT_V0RELATORIOS_DB_INSERT_1_Insert1 : QueryBasis<R5000_00_INSERT_V0RELATORIOS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R5000_00_INSERT_V0RELATORIOS_DB_INSERT_1_Insert1 r5000_00_INSERT_V0RELATORIOS_DB_INSERT_1_Insert1)
        {
            var ths = r5000_00_INSERT_V0RELATORIOS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5000_00_INSERT_V0RELATORIOS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
