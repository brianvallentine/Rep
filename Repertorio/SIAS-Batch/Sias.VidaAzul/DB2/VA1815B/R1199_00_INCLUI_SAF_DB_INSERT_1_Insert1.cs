    ...
    public class R1199_00_INCLUI_SAF_DB_INSERT_1_Insert1 : QueryBasis<R1199_00_INCLUI_SAF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0SAFCOBER VALUES ({FieldThreatment(this.V0PROP_CODCLIEN)}, {FieldThreatment(this.V0RSAF_DTREFER)}, '9999-12-31' , {FieldThreatment(this.V0COBP_IMPSEGAUXF)}, {FieldThreatment(this.V0COBP_VLCUSTAUXF)}, {FieldThreatment(this.V0HCTA_NRCERTIF)}, 0, '0' , 'VA1815B' , CURRENT TIMESTAMP)";
