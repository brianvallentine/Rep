...
{
    public class R0023_00_ATUALIZA_ESTORNO_DB_UPDATE_1_Update1 : QueryBasis<R0023_00_ATUALIZA_ESTORNO_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R0023_00_ATUALIZA_ESTORNO_DB_UPDATE_1_Update1 r0023_00_ATUALIZA_ESTORNO_DB_UPDATE_1_Update1)
        {
            var ths = r0023_00_ATUALIZA_ESTORNO_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0023_00_ATUALIZA_ESTORNO_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
