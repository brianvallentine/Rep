...
{
    public class VA1815B_CHCONTA2 : QueryBasis<VA1815B_CHCONTA2>
    {
        ...
        public VA1815B_CHCONTA2() { IsCursor = true; }

        public VA1815B_CHCONTA2(bool justACursor)
        {
        ...
        public override VA1815B_CHCONTA2 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1815B_CHCONTA2();
            var i = 0;
