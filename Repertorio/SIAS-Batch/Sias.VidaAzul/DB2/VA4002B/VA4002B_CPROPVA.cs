...
{
    public class VA4002B_CPROPVA : QueryBasis<VA4002B_CPROPVA>
    {
        ...
        public VA4002B_CPROPVA() { IsCursor = true; }

        public VA4002B_CPROPVA(bool justACursor)
        {
        ...
        public string PROPVA_DT365DIAS { get; set; }
        public string PROPVA_DT015DIAS { get; set; }
        ...
        public string PROPVA_ORIGEM_PROPOSTA { get; set; }
        public string VIND_ORIGEM { get; set; }
        public string PROPVA_STA_ANTECIPACAO { get; set; }
        public string VIND_ANTECIP { get; set; }
        ...
        public override VA4002B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA4002B_CPROPVA();
            var i = 0;
            ...
            dta.PROPVA_DT365DIAS = result[i++].Value?.ToString();
            dta.PROPVA_DT015DIAS = result[i++].Value?.ToString();
            ...
            dta.PROPVA_DTINCLUS = result[i++].Value?.ToString();
            ...
            dta.PROPVA_ORIGEM_PROPOSTA = result[i++].Value?.ToString();
            dta.VIND_ORIGEM = string.IsNullOrWhiteSpace(dta.PROPVA_ORIGEM_PROPOSTA) ? "-1" : "0";
            dta.PROPVA_STA_ANTECIPACAO = result[i++].Value?.ToString();
            dta.VIND_ANTECIP = string.IsNullOrWhiteSpace(dta.PROPVA_STA_ANTECIPACAO) ? "-1" : "0";
