...
{
    public class VA4004B_TCOMIS : QueryBasis<VA4004B_TCOMIS>
    {
        ...
        public VA4004B_TCOMIS() { IsCursor = true; }

        public VA4004B_TCOMIS(bool justACursor)
        {
        ...
        public override VA4004B_TCOMIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA4004B_TCOMIS();
            var i = 0;
