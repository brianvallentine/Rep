...
{
    public class VA1466B_TCOMIS : QueryBasis<VA1466B_TCOMIS>
    {
        ...
        public VA1466B_TCOMIS() { IsCursor = true; }

        public VA1466B_TCOMIS(bool justACursor)
        {
        ...
        public override VA1466B_TCOMIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1466B_TCOMIS();
            var i = 0;
