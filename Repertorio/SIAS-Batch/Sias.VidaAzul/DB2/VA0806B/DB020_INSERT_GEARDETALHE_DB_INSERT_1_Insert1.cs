...
{
    public class DB020_INSERT_GEARDETALHE_DB_INSERT_1_Insert1 : QueryBasis<DB020_INSERT_GEARDETALHE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(DB020_INSERT_GEARDETALHE_DB_INSERT_1_Insert1 dB020_INSERT_GEARDETALHE_DB_INSERT_1_Insert1)
        {
            var ths = dB020_INSERT_GEARDETALHE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override DB020_INSERT_GEARDETALHE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
