...
{
    public class VA0127B_CPROPVA : QueryBasis<VA0127B_CPROPVA>
    {
        ...
        public VA0127B_CPROPVA() { IsCursor = true; }

        public VA0127B_CPROPVA(bool justACursor)
        {
        ...
        public override VA0127B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0127B_CPROPVA();
            var i = 0;
