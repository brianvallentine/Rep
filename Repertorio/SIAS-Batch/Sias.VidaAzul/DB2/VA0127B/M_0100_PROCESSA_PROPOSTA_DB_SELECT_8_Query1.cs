...
namespace Sias.VidaAzul.DB2.VA0127B
{
    public class M_0100_PROCESSA_PROPOSTA_DB_SELECT_8_Query1 : QueryBasis<M_0100_PROCESSA_PROPOSTA_DB_SELECT_8_Query1>
    {
        ...
        public string V0HCTB_PREMIO500VG { get; set; }
        public string V0HCTB_PREMIO500AP { get; set; }
        ...
        public override M_0100_PROCESSA_PROPOSTA_DB_SELECT_8_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            ...
            var i = 0;
            dta.V0HCTB_PREMIO500VG = result[i++].Value?.ToString();
            dta.V0HCTB_PREMIO500AP = result[i++].Value?.ToString();
            return dta;
        }
