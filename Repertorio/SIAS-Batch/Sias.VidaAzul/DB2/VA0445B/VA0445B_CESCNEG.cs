...
{
    public class VA0445B_CESCNEG : QueryBasis<VA0445B_CESCNEG>
    {
        ...
        public VA0445B_CESCNEG() { IsCursor = true; }

        public VA0445B_CESCNEG(bool justACursor)
        {
        ...
        public override VA0445B_CESCNEG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0445B_CESCNEG();
            var i = 0;
