...
{
    public class R2200_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 : QueryBasis<R2200_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R2200_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 r2200_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1)
        {
            var ths = r2200_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R2200_00_CONTROLAR_ARQ_ENVIADO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
