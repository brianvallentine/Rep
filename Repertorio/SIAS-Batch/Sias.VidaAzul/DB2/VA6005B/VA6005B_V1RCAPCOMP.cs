...
{
    public class VA6005B_V1RCAPCOMP : QueryBasis<VA6005B_V1RCAPCOMP>
    {
        ...
        public VA6005B_V1RCAPCOMP() { IsCursor = true; }

        public VA6005B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override VA6005B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA6005B_V1RCAPCOMP();
            var i = 0;
