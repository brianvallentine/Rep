...
{
    public class R1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1 : QueryBasis<R1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1 Execute(R1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1 r1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1)
        {
            var ths = r1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1;
        ...
        public override R1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1067_00_TRATA_CORRETOR_DB_SELECT_1_Query1();
            var i = 0;
