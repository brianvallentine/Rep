...
{
    public class R1068_00_INSERT_APOLCORRET_DB_INSERT_1_Insert1 : QueryBasis<R1068_00_INSERT_APOLCORRET_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1068_00_INSERT_APOLCORRET_DB_INSERT_1_Insert1 r1068_00_INSERT_APOLCORRET_DB_INSERT_1_Insert1)
        {
            var ths = r1068_00_INSERT_APOLCORRET_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1068_00_INSERT_APOLCORRET_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
