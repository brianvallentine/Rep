...
{
    public class VA6005B_V1COSSEGPROD : QueryBasis<VA6005B_V1COSSEGPROD>
    {
        ...
        public VA6005B_V1COSSEGPROD() { IsCursor = true; }

        public VA6005B_V1COSSEGPROD(bool justACursor)
        {
        ...
        public override VA6005B_V1COSSEGPROD OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA6005B_V1COSSEGPROD();
            var i = 0;
