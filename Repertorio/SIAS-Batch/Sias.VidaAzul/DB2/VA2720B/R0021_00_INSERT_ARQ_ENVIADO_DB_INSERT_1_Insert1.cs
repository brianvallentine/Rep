...
{
    public class R0021_00_INSERT_ARQ_ENVIADO_DB_INSERT_1_Insert1 : QueryBasis<R0021_00_INSERT_ARQ_ENVIADO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0021_00_INSERT_ARQ_ENVIADO_DB_INSERT_1_Insert1 r0021_00_INSERT_ARQ_ENVIADO_DB_INSERT_1_Insert1)
        {
            var ths = r0021_00_INSERT_ARQ_ENVIADO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0021_00_INSERT_ARQ_ENVIADO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
