...
{
    public class R1120_00_GRAVA_HISPROFI_DB_INSERT_1_Insert1 : QueryBasis<R1120_00_GRAVA_HISPROFI_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1120_00_GRAVA_HISPROFI_DB_INSERT_1_Insert1 r1120_00_GRAVA_HISPROFI_DB_INSERT_1_Insert1)
        {
            var ths = r1120_00_GRAVA_HISPROFI_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1120_00_GRAVA_HISPROFI_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
