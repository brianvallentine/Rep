...
{
    public class VA0953B_V0SINISTROS : QueryBasis<VA0953B_V0SINISTROS>
    {
        ...
        public VA0953B_V0SINISTROS() { IsCursor = true; }

        public VA0953B_V0SINISTROS(bool justACursor)
        {
        ...
        public override VA0953B_V0SINISTROS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0953B_V0SINISTROS();
            var i = 0;
