...
{
    public class VA1426B_CHCONT : QueryBasis<VA1426B_CHCONT>
    {
        ...
        public VA1426B_CHCONT() { IsCursor = true; }

        public VA1426B_CHCONT(bool justACursor)
        {
        ...
        public override VA1426B_CHCONT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1426B_CHCONT();
            var i = 0;
