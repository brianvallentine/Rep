...
{
    public class R8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1 : QueryBasis<R8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND IDADE_FINAL
            AND VLPREMIOTOT = :WHOST-PRM-TOTAL-MA
            END-EXEC
            */
            #endregion
            var query = @$"
				SELECT NUM_APOLICE 
							...
							,
											...
											AND IDADE_FINAL
											AND VLPREMIOTOT = '{this.WHOST_PRM_TOTAL_MA}'";
        ...
        public string WHOST_PRM_TOTAL_MA { get; set; }
        public string VG130_NUM_APOLICE { get; set; }
        public string WHOST_OPCAO_COBER { get; set; }
        public string WHOST_IDADE { get; set; }

        public static R8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1 Execute(R8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1 r8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1)
        {
            var ths = r8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1;
        ...
        public override R8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R8230_00_PLANO_SEM_DATA_DB_SELECT_1_Query1();
            var i = 0;
