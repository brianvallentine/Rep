...
{
    public class R77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1 : QueryBasis<R77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1 Execute(R77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1 r77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1)
        {
            var ths = r77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1;
        ...
        public override R77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R77210_00_OBTER_APO_SUB_VG130_DB_SELECT_1_Query1();
            var i = 0;
