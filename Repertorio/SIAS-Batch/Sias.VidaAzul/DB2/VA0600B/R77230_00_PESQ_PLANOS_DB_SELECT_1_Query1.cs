...
{
    public class R77230_00_PESQ_PLANOS_DB_SELECT_1_Query1 : QueryBasis<R77230_00_PESQ_PLANOS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R77230_00_PESQ_PLANOS_DB_SELECT_1_Query1 Execute(R77230_00_PESQ_PLANOS_DB_SELECT_1_Query1 r77230_00_PESQ_PLANOS_DB_SELECT_1_Query1)
        {
            var ths = r77230_00_PESQ_PLANOS_DB_SELECT_1_Query1;
        ...
        public override R77230_00_PESQ_PLANOS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R77230_00_PESQ_PLANOS_DB_SELECT_1_Query1();
            var i = 0;
