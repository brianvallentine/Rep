...
{
    public class VA0600B_CFONTES : QueryBasis<VA0600B_CFONTES>
    {
        ...
        public VA0600B_CFONTES() { IsCursor = true; }

        public VA0600B_CFONTES(bool justACursor)
        {
        ...
        public override VA0600B_CFONTES OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0600B_CFONTES();
            var i = 0;
