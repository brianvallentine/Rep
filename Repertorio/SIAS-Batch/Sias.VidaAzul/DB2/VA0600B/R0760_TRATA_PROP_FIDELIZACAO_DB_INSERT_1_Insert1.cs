...
{
    public class R0760_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1 : QueryBasis<R0760_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :DCLPROPOSTA-FIDELIZ.PROPOFID-IND-TP-PROPOSTA
            :VIND-TP-PROP,
        ...
        public string VIND_CBO_CONJ { get; set; }
        ...
        public string VIND_TP_PROP { get; set; }
        public string PROPOFID_IND_TIPO_CONTA { get; set; }

        public static void Execute(R0760_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1 r0760_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1)
        {
            var ths = r0760_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0760_TRATA_PROP_FIDELIZACAO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
