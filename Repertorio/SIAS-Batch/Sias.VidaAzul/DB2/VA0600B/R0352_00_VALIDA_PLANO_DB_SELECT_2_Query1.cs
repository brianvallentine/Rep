...
{
    public class R0352_00_VALIDA_PLANO_DB_SELECT_2_Query1 : QueryBasis<R0352_00_VALIDA_PLANO_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0352_00_VALIDA_PLANO_DB_SELECT_2_Query1 Execute(R0352_00_VALIDA_PLANO_DB_SELECT_2_Query1 r0352_00_VALIDA_PLANO_DB_SELECT_2_Query1)
        {
            var ths = r0352_00_VALIDA_PLANO_DB_SELECT_2_Query1;
        ...
        public override R0352_00_VALIDA_PLANO_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0352_00_VALIDA_PLANO_DB_SELECT_2_Query1();
            var i = 0;
