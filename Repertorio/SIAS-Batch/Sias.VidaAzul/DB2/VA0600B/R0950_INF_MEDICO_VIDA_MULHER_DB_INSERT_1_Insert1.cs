...
{
    public class R0950_INF_MEDICO_VIDA_MULHER_DB_INSERT_1_Insert1 : QueryBasis<R0950_INF_MEDICO_VIDA_MULHER_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0950_INF_MEDICO_VIDA_MULHER_DB_INSERT_1_Insert1 r0950_INF_MEDICO_VIDA_MULHER_DB_INSERT_1_Insert1)
        {
            var ths = r0950_INF_MEDICO_VIDA_MULHER_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0950_INF_MEDICO_VIDA_MULHER_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
