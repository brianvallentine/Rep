...
{
    public class VA0128B_VGHISTACE : QueryBasis<VA0128B_VGHISTACE>
    {
        ...
        public VA0128B_VGHISTACE() { IsCursor = true; }

        public VA0128B_VGHISTACE(bool justACursor)
        {
        ...
        public override VA0128B_VGHISTACE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0128B_VGHISTACE();
            var i = 0;
