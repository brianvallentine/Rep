    ...
    public class R1200_00_REPASSA_SAF_DB_INSERT_1_Insert1 : QueryBasis<R1200_00_REPASSA_SAF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0HISTREPSAF VALUES ({FieldThreatment(this.V0PROP_CODCLIEN)}, {FieldThreatment(this.V0RSAF_DTREFER)}, {FieldThreatment(this.V0HCTA_NRCERTIF)}, {FieldThreatment(this.V0HCTA_NRPARCEL)}, {FieldThreatment(this.V0PROP_NRMATRFUN)}, {FieldThreatment(this.V0SAFC_VLCUSTSAF)}, 1100, '0' , '0' , 0, 0, 'VA1813B' , CURRENT TIMESTAMP,  {FieldThreatment((this.VIND_DTMOVTO?.ToInt() == -1 ? null : this.V0PARC_DTVENCTO))})";
