...
{
    public class R0055_00_INSERT_FITACEF_DB_INSERT_1_Insert1 : QueryBasis<R0055_00_INSERT_FITACEF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R0055_00_INSERT_FITACEF_DB_INSERT_1_Insert1 r0055_00_INSERT_FITACEF_DB_INSERT_1_Insert1)
        {
            var ths = r0055_00_INSERT_FITACEF_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0055_00_INSERT_FITACEF_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
