...
{
    public class VA1813B_CHCONTA3 : QueryBasis<VA1813B_CHCONTA3>
    {
        ...
        public VA1813B_CHCONTA3() { IsCursor = true; }

        public VA1813B_CHCONTA3(bool justACursor)
        {
        ...
        public override VA1813B_CHCONTA3 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1813B_CHCONTA3();
            var i = 0;
