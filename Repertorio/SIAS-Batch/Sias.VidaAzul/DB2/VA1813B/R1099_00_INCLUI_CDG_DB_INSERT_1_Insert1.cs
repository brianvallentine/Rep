    ...
    public class R1099_00_INCLUI_CDG_DB_INSERT_1_Insert1 : QueryBasis<R1099_00_INCLUI_CDG_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0CDGCOBER VALUES ({FieldThreatment(this.V0PROP_CODCLIEN)}, {FieldThreatment(this.V0RCDG_DTREFER)}, '9999-12-31' , {FieldThreatment(this.V0COBP_IMPSEGCDG)}, {FieldThreatment(this.V0COBP_VLCUSTCDG)}, {FieldThreatment(this.V0HCTA_NRCERTIF)}, 0, '0' , 'VA1813B' , CURRENT TIMESTAMP)";
