...
{
    public class VA2601B_C01_RCAPCOMP : QueryBasis<VA2601B_C01_RCAPCOMP>
    {
        ...
        public VA2601B_C01_RCAPCOMP() { IsCursor = true; }

        public VA2601B_C01_RCAPCOMP(bool justACursor)
        {
        ...
        public override VA2601B_C01_RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2601B_C01_RCAPCOMP();
            var i = 0;
