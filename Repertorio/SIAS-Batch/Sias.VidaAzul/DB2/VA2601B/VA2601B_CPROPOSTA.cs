...
{
    public class VA2601B_CPROPOSTA : QueryBasis<VA2601B_CPROPOSTA>
    {
        ...
        public VA2601B_CPROPOSTA() { IsCursor = true; }

        public VA2601B_CPROPOSTA(bool justACursor)
        {
        ...
        public override VA2601B_CPROPOSTA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2601B_CPROPOSTA();
            var i = 0;
