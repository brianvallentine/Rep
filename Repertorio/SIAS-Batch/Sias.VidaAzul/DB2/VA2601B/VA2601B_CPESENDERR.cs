...
{
    public class VA2601B_CPESENDERR : QueryBasis<VA2601B_CPESENDERR>
    {
        ...
        public VA2601B_CPESENDERR() { IsCursor = true; }

        public VA2601B_CPESENDERR(bool justACursor)
        {
        ...
        public override VA2601B_CPESENDERR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2601B_CPESENDERR();
            var i = 0;
