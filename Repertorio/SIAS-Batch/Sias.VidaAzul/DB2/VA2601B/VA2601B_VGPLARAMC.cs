...
{
    public class VA2601B_VGPLARAMC : QueryBasis<VA2601B_VGPLARAMC>
    {
        ...
        public VA2601B_VGPLARAMC() { IsCursor = true; }

        public VA2601B_VGPLARAMC(bool justACursor)
        {
        ...
        public override VA2601B_VGPLARAMC OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2601B_VGPLARAMC();
            var i = 0;
