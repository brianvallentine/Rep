    ...
    public class R3500_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1 : QueryBasis<R3500_00_INSERT_HISTCOBVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.COBER_HIST_VIDAZUL VALUES ({FieldThreatment(this.PROPOFID_NUM_PROPOSTA_SIVPF)}, {FieldThreatment(this.NUM_PARCELA)}, {FieldThreatment(this.NUM_TITULO)}, {FieldThreatment(this.WHOST_DATA_AGENDAMENTO)}, {FieldThreatment(this.PROPOFID_VAL_PAGO)}, {FieldThreatment(this.WHOST_OPCAOPAG)}, {FieldThreatment(this.SIT_REGISTRO)}, {FieldThreatment(this.COD_OPERACAO)}, {FieldThreatment(this.OCORR_HISTORICO)}, {FieldThreatment(this.COD_DEVOLUCAO)}, {FieldThreatment(this.RCAPCOMP_BCO_AVISO)}, {FieldThreatment(this.RCAPCOMP_AGE_AVISO)}, {FieldThreatment(this.RCAPCOMP_NUM_AVISO_CREDITO)}, {FieldThreatment(this.NUM_TITULO_COMP)})";
