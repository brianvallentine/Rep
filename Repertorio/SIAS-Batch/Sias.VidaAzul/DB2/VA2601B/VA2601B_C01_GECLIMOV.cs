...
{
    public class VA2601B_C01_GECLIMOV : QueryBasis<VA2601B_C01_GECLIMOV>
    {
        ...
        public VA2601B_C01_GECLIMOV() { IsCursor = true; }

        public VA2601B_C01_GECLIMOV(bool justACursor)
        {
        ...
        public override VA2601B_C01_GECLIMOV OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2601B_C01_GECLIMOV();
            var i = 0;
