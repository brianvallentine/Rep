...
{
    public class VA2601B_CVGRAMOCOMP : QueryBasis<VA2601B_CVGRAMOCOMP>
    {
        ...
        public VA2601B_CVGRAMOCOMP() { IsCursor = true; }

        public VA2601B_CVGRAMOCOMP(bool justACursor)
        {
        ...
        public override VA2601B_CVGRAMOCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA2601B_CVGRAMOCOMP();
            var i = 0;
