...
{
    public class R3000_00_INSERT_PROPOSTAVA_DB_INSERT_1_Insert1 : QueryBasis<R3000_00_INSERT_PROPOSTAVA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            :WHOST-STA-ANTECIPACAO :VIND-STA-ANTECIPACAO,
            NULL,
            :DCLSISTEMAS.SISTEMAS-DATA-MOV-ABERTO
            :VIND-DATA-DECLINIO)
            END-EXEC.
        ...
        public string WHOST_STA_ANTECIPACAO { get; set; }
        public string VIND_STA_ANTECIPACAO { get; set; }
        public string VIND_DATA_DECLINIO { get; set; }

        public static void Execute(R3000_00_INSERT_PROPOSTAVA_DB_INSERT_1_Insert1 r3000_00_INSERT_PROPOSTAVA_DB_INSERT_1_Insert1)
        {
            var ths = r3000_00_INSERT_PROPOSTAVA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3000_00_INSERT_PROPOSTAVA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
