...
{
    public class R5600_00_INSERT_LT_SOLICITA_DB_INSERT_1_Insert1 : QueryBasis<R5600_00_INSERT_LT_SOLICITA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R5600_00_INSERT_LT_SOLICITA_DB_INSERT_1_Insert1 r5600_00_INSERT_LT_SOLICITA_DB_INSERT_1_Insert1)
        {
            var ths = r5600_00_INSERT_LT_SOLICITA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5600_00_INSERT_LT_SOLICITA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
