...
{
    public class VA0812B_CVGRAMOCOMP : QueryBasis<VA0812B_CVGRAMOCOMP>
    {
        ...
        public VA0812B_CVGRAMOCOMP() { IsCursor = true; }

        public VA0812B_CVGRAMOCOMP(bool justACursor)
        {
        ...
        public override VA0812B_CVGRAMOCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0812B_CVGRAMOCOMP();
            var i = 0;
