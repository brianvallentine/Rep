...
{
    public class M_1532_GERA_RETCOMIS_DB_INSERT_1_Insert1 : QueryBasis<M_1532_GERA_RETCOMIS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(M_1532_GERA_RETCOMIS_DB_INSERT_1_Insert1 m_1532_GERA_RETCOMIS_DB_INSERT_1_Insert1)
        {
            var ths = m_1532_GERA_RETCOMIS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_1532_GERA_RETCOMIS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
