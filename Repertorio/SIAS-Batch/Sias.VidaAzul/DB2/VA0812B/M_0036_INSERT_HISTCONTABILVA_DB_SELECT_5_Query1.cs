...
{
    public class M_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1 : QueryBasis<M_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND DTINIVIG <= :PROP-DTVENCTO
            AND DTTERVIG >= :PROP-DTVENCTO
            WITH UR
            END-EXEC.
            */
            #endregion
            var query = @$"
				SELECT VLPREMIO
							...
							,
											...
											AND DTINIVIG <= '{this.PROP_DTVENCTO}'
											AND DTTERVIG >= '{this.PROP_DTVENCTO}'
											WITH UR";
        ...
        public static M_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1 Execute(M_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1 m_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1)
        {
            var ths = m_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1;
        ...
        public override M_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_0036_INSERT_HISTCONTABILVA_DB_SELECT_5_Query1();
            var i = 0;
