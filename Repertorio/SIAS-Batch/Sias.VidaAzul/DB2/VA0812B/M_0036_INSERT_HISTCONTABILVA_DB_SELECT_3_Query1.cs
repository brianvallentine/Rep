...
{
    public class M_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1 : QueryBasis<M_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            var query = @$"
				SELECT VLPREMIO
							...
							,
											...
											AND OCORHIST ='{this.PROP_OCORHIST}'
											WITH UR";
        ...
        public static M_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1 Execute(M_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1 m_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1)
        {
            var ths = m_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1;
        ...
        public override M_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new M_0036_INSERT_HISTCONTABILVA_DB_SELECT_3_Query1();
            var i = 0;
