...
{
    public class M_0100_INSERT_AVISOS_DB_INSERT_2_Insert1 : QueryBasis<M_0100_INSERT_AVISOS_DB_INSERT_2_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(M_0100_INSERT_AVISOS_DB_INSERT_2_Insert1 m_0100_INSERT_AVISOS_DB_INSERT_2_Insert1)
        {
            var ths = m_0100_INSERT_AVISOS_DB_INSERT_2_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override M_0100_INSERT_AVISOS_DB_INSERT_2_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
