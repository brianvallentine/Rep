...
{
    public class R8700_00_INSERT_DESPESAS_DB_INSERT_1_Insert1 : QueryBasis<R8700_00_INSERT_DESPESAS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R8700_00_INSERT_DESPESAS_DB_INSERT_1_Insert1 r8700_00_INSERT_DESPESAS_DB_INSERT_1_Insert1)
        {
            var ths = r8700_00_INSERT_DESPESAS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R8700_00_INSERT_DESPESAS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
