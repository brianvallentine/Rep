...
namespace Sias.VidaAzul.DB2.VA0134B
{
    public class VA0134B_C01 : QueryBasis<VA0134B_C01>
    {
        ...
        public VA0134B_C01() { IsCursor = true; }

        public VA0134B_C01(bool justACursor)
        {
        ...
        public string DB2_SIT_COBRANCA { get; set; }
        ...
        public override VA0134B_C01 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0134B_C01();
            var i = 0;

            dta.SEGVGAPH_NUM_APOLICE = result[i++].Value?.ToString();
            dta.SEGVGAP_NUM_CERTIFICADO = result[i++].Value?.ToString();
            ...
            dta.DB2_SIT_COBRANCA = result[i++].Value?.ToString();
