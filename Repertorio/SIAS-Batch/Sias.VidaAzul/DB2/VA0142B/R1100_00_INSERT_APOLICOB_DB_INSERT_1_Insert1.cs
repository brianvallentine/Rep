...
{
    public class R1100_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 : QueryBasis<R1100_00_INSERT_APOLICOB_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1100_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 r1100_00_INSERT_APOLICOB_DB_INSERT_1_Insert1)
        {
            var ths = r1100_00_INSERT_APOLICOB_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1100_00_INSERT_APOLICOB_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
