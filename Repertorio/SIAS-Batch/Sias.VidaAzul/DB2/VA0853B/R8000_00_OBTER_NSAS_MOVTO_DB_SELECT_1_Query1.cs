...
{
    public class R8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1 : QueryBasis<R8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1 Execute(R8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1 r8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1)
        {
            var ths = r8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1;
        ...
        public override R8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R8000_00_OBTER_NSAS_MOVTO_DB_SELECT_1_Query1();
            var i = 0;
