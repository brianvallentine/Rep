...
{
    public class R8100_00_GERAR_ARQSIVPF_Insert1 : QueryBasis<R8100_00_GERAR_ARQSIVPF_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R8100_00_GERAR_ARQSIVPF_Insert1 r8100_00_GERAR_ARQSIVPF_Insert1)
        {
            var ths = r8100_00_GERAR_ARQSIVPF_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R8100_00_GERAR_ARQSIVPF_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
