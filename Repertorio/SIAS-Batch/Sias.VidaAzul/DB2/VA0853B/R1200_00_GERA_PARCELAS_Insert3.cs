...
{
    public class R1200_00_GERA_PARCELAS_Insert3 : QueryBasis<R1200_00_GERA_PARCELAS_Insert3>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1200_00_GERA_PARCELAS_Insert3 r1200_00_GERA_PARCELAS_Insert3)
        {
            var ths = r1200_00_GERA_PARCELAS_Insert3;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1200_00_GERA_PARCELAS_Insert3 OpenData(List<KeyValuePair<string, object>> result)
        {
