...
{
    public class R4500_00_SOLIC_RELAT_Query1 : QueryBasis<R4500_00_SOLIC_RELAT_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R4500_00_SOLIC_RELAT_Query1 Execute(R4500_00_SOLIC_RELAT_Query1 r4500_00_SOLIC_RELAT_Query1)
        {
            var ths = r4500_00_SOLIC_RELAT_Query1;
        ...
        public override R4500_00_SOLIC_RELAT_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R4500_00_SOLIC_RELAT_Query1();
            var i = 0;
