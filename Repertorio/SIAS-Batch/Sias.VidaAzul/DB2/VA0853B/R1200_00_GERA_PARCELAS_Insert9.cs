...
{
    public class R1200_00_GERA_PARCELAS_Insert9 : QueryBasis<R1200_00_GERA_PARCELAS_Insert9>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1200_00_GERA_PARCELAS_Insert9 r1200_00_GERA_PARCELAS_Insert9)
        {
            var ths = r1200_00_GERA_PARCELAS_Insert9;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1200_00_GERA_PARCELAS_Insert9 OpenData(List<KeyValuePair<string, object>> result)
        {
