...
{
    public class R1020_00_UPDATE_V0PROPOSTAVA_Update1 : QueryBasis<R1020_00_UPDATE_V0PROPOSTAVA_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R1020_00_UPDATE_V0PROPOSTAVA_Update1 r1020_00_UPDATE_V0PROPOSTAVA_Update1)
        {
            var ths = r1020_00_UPDATE_V0PROPOSTAVA_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1020_00_UPDATE_V0PROPOSTAVA_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
