...
{
    public class VA0853B_CPROPVAG : QueryBasis<VA0853B_CPROPVAG>
    {
        ...
        public VA0853B_CPROPVAG() { IsCursor = true; }

        public VA0853B_CPROPVAG(bool justACursor)
        {
        ...
        public override VA0853B_CPROPVAG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0853B_CPROPVAG();
            var i = 0;
