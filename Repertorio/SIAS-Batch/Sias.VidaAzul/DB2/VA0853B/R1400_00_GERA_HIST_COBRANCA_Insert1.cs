...
{
    public class R1400_00_GERA_HIST_COBRANCA_Insert1 : QueryBasis<R1400_00_GERA_HIST_COBRANCA_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string V0HICB_CODDEVOLV { get; set; }

        public static void Execute(R1400_00_GERA_HIST_COBRANCA_Insert1 r1400_00_GERA_HIST_COBRANCA_Insert1)
        {
            var ths = r1400_00_GERA_HIST_COBRANCA_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1400_00_GERA_HIST_COBRANCA_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
