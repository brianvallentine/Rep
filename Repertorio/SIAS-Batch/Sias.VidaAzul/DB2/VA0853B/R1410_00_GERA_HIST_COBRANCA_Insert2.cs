...
{
    public class R1410_00_GERA_HIST_COBRANCA_Insert2 : QueryBasis<R1410_00_GERA_HIST_COBRANCA_Insert2>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1410_00_GERA_HIST_COBRANCA_Insert2 r1410_00_GERA_HIST_COBRANCA_Insert2)
        {
            var ths = r1410_00_GERA_HIST_COBRANCA_Insert2;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1410_00_GERA_HIST_COBRANCA_Insert2 OpenData(List<KeyValuePair<string, object>> result)
        {
