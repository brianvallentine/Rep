...
{
    public class R1200_00_GERA_PARCELAS_Query2 : QueryBasis<R1200_00_GERA_PARCELAS_Query2>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1200_00_GERA_PARCELAS_Query2 Execute(R1200_00_GERA_PARCELAS_Query2 r1200_00_GERA_PARCELAS_Query2)
        {
            var ths = r1200_00_GERA_PARCELAS_Query2;
        ...
        public override R1200_00_GERA_PARCELAS_Query2 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1200_00_GERA_PARCELAS_Query2();
            var i = 0;
