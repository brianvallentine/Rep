...
{
    public class R1300_00_GERA_DEBITO_Insert1 : QueryBasis<R1300_00_GERA_DEBITO_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1300_00_GERA_DEBITO_Insert1 r1300_00_GERA_DEBITO_Insert1)
        {
            var ths = r1300_00_GERA_DEBITO_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1300_00_GERA_DEBITO_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
