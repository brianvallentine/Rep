...
{
    public class R1675_00_INSERT_V0HISTREPSAF_Insert1 : QueryBasis<R1675_00_INSERT_V0HISTREPSAF_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1675_00_INSERT_V0HISTREPSAF_Insert1 r1675_00_INSERT_V0HISTREPSAF_Insert1)
        {
            var ths = r1675_00_INSERT_V0HISTREPSAF_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1675_00_INSERT_V0HISTREPSAF_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
