...
{
    public class R8210_00_INSERT_CNTRLE_PROC_Insert1 : QueryBasis<R8210_00_INSERT_CNTRLE_PROC_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R8210_00_INSERT_CNTRLE_PROC_Insert1 r8210_00_INSERT_CNTRLE_PROC_Insert1)
        {
            var ths = r8210_00_INSERT_CNTRLE_PROC_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R8210_00_INSERT_CNTRLE_PROC_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
