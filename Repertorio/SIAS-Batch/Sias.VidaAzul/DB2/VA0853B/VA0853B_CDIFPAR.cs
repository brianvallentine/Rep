...
{
    public class VA0853B_CDIFPAR : QueryBasis<VA0853B_CDIFPAR>
    {
        ...
        public VA0853B_CDIFPAR() { IsCursor = true; }

        public VA0853B_CDIFPAR(bool justACursor)
        {
        ...
        public override VA0853B_CDIFPAR OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0853B_CDIFPAR();
            var i = 0;
