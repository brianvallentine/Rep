...
{
    public class R1025_00_VER_RETORNO_CARTAO_Query1 : QueryBasis<R1025_00_VER_RETORNO_CARTAO_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1025_00_VER_RETORNO_CARTAO_Query1 Execute(R1025_00_VER_RETORNO_CARTAO_Query1 r1025_00_VER_RETORNO_CARTAO_Query1)
        {
            var ths = r1025_00_VER_RETORNO_CARTAO_Query1;
        ...
        public override R1025_00_VER_RETORNO_CARTAO_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1025_00_VER_RETORNO_CARTAO_Query1();
            var i = 0;
