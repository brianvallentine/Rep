...
{
    public class R1200_00_GERA_PARCELAS_Insert7 : QueryBasis<R1200_00_GERA_PARCELAS_Insert7>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1200_00_GERA_PARCELAS_Insert7 r1200_00_GERA_PARCELAS_Insert7)
        {
            var ths = r1200_00_GERA_PARCELAS_Insert7;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1200_00_GERA_PARCELAS_Insert7 OpenData(List<KeyValuePair<string, object>> result)
        {
