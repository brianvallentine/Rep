...
{
    public class R0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1 : QueryBasis<R0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1 Execute(R0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1 r0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1)
        {
            var ths = r0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1;
        ...
        public override R0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0100_00_INICIALIZA_PGM_DB_SELECT_2_Query1();
            var i = 0;
