...
{
    public class R1018_00_CONS_OPCAOPAGVA_Query1 : QueryBasis<R1018_00_CONS_OPCAOPAGVA_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1018_00_CONS_OPCAOPAGVA_Query1 Execute(R1018_00_CONS_OPCAOPAGVA_Query1 r1018_00_CONS_OPCAOPAGVA_Query1)
        {
            var ths = r1018_00_CONS_OPCAOPAGVA_Query1;
        ...
        public override R1018_00_CONS_OPCAOPAGVA_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1018_00_CONS_OPCAOPAGVA_Query1();
            var i = 0;
