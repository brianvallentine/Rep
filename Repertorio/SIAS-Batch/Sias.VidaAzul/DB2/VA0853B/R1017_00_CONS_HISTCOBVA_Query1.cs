...
{
    public class R1017_00_CONS_HISTCOBVA_Query1 : QueryBasis<R1017_00_CONS_HISTCOBVA_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R1017_00_CONS_HISTCOBVA_Query1 Execute(R1017_00_CONS_HISTCOBVA_Query1 r1017_00_CONS_HISTCOBVA_Query1)
        {
            var ths = r1017_00_CONS_HISTCOBVA_Query1;
        ...
        public override R1017_00_CONS_HISTCOBVA_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1017_00_CONS_HISTCOBVA_Query1();
            var i = 0;
