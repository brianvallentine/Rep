...
{
    public class R1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1 : QueryBasis<R1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND DTINIVIG <= :PROPOVA-DATA-QUITACAO
            AND DTTERVIG >= :PROPOVA-DATA-QUITACAO
            WITH UR
            END-EXEC.
            */
            #endregion
            var query = @$"
				SELECT IMPMORNATU 
							...
							,
											...
											AND DTINIVIG <= '{this.PROPOVA_DATA_QUITACAO}'
											AND DTTERVIG >= '{this.PROPOVA_DATA_QUITACAO}'
											WITH UR";
        ...
        public static R1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1 Execute(R1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1 r1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1)
        {
            var ths = r1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1;
        ...
        public override R1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R1400_00_SELECT_PLAVAVGA_DB_SELECT_1_Query1();
            var i = 0;
