...
{
    public class R0005_00_UPDATE_ESTOQUE_DB_UPDATE_2_Update1 : QueryBasis<R0005_00_UPDATE_ESTOQUE_DB_UPDATE_2_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R0005_00_UPDATE_ESTOQUE_DB_UPDATE_2_Update1 r0005_00_UPDATE_ESTOQUE_DB_UPDATE_2_Update1)
        {
            var ths = r0005_00_UPDATE_ESTOQUE_DB_UPDATE_2_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0005_00_UPDATE_ESTOQUE_DB_UPDATE_2_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
