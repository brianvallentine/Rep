...
{
    public class R1750_00_INSERT_RELATO_PF10_DB_INSERT_1_Insert1 : QueryBasis<R1750_00_INSERT_RELATO_PF10_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1750_00_INSERT_RELATO_PF10_DB_INSERT_1_Insert1 r1750_00_INSERT_RELATO_PF10_DB_INSERT_1_Insert1)
        {
            var ths = r1750_00_INSERT_RELATO_PF10_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1750_00_INSERT_RELATO_PF10_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
