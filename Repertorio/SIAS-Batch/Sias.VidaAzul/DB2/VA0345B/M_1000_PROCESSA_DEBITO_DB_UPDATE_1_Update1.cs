...
namespace Sias.VidaAzul.DB2.VA0345B
{
    public class M_1000_PROCESSA_DEBITO_DB_UPDATE_1_Update1 : QueryBasis<M_1000_PROCESSA_DEBITO_DB_UPDATE_1_Update1>
    {
        ...
        private VA0345B_DEBITO CurrentOf { get; set; }

        public M_1000_PROCESSA_DEBITO_DB_UPDATE_1_Update1(VA0345B_DEBITO currentOf)
        {
            CurrentOf = currentOf;
        }
        ...
        string GetQuery()
        {
            var query = @$"
				...
				WHERE
				(
					CODCONV = 6090 AND SITUACAO = '0' AND NUMCTADEB > 0 AND TIPLANC = '5'
				)
