...
{
    public class VA5437B_V1AGENCEF : QueryBasis<VA5437B_V1AGENCEF>
    {
        ...
        public VA5437B_V1AGENCEF() { IsCursor = true; }

        public VA5437B_V1AGENCEF(bool justACursor)
        {
        ...
        public override VA5437B_V1AGENCEF OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA5437B_V1AGENCEF();
            var i = 0;
