...
{
    public class VA5437B_CMSG : QueryBasis<VA5437B_CMSG>
    {
        ...
        public VA5437B_CMSG() { IsCursor = true; }

        public VA5437B_CMSG(bool justACursor)
        {
        ...
        public override VA5437B_CMSG OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA5437B_CMSG();
            var i = 0;
