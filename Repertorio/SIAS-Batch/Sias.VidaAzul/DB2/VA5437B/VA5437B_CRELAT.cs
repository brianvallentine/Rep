...
{
    public class VA5437B_CRELAT : QueryBasis<VA5437B_CRELAT>
    {
        ...
        public VA5437B_CRELAT() { IsCursor = true; }

        public VA5437B_CRELAT(bool justACursor)
        {
        ...
        public override VA5437B_CRELAT OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA5437B_CRELAT();
            var i = 0;
