    ...
    public class R4200_00_INSERT_V0HISTCONTA_DB_INSERT_1_Insert1 : QueryBasis<R4200_00_INSERT_V0HISTCONTA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.V0HISTCONTABILVA VALUES ({FieldThreatment(this.V0HCOB_NRCERTIF)} , {FieldThreatment(this.V0HCOB_NRPARCEL)} , {FieldThreatment(this.V0HCOB_NRTIT)} , {FieldThreatment(this.V0HCOB_OCORHIST)} , {FieldThreatment(this.V0PROP_APOLICE)} , {FieldThreatment(this.V0PROP_CODSUBES)} , {FieldThreatment(this.V0PROP_FONTE)} , {FieldThreatment(this.V0HCTB_NRENDOS)} , {FieldThreatment(this.V0PARC_PRMVG)} , {FieldThreatment(this.V0PARC_PRMAP)} , {FieldThreatment(this.V0HCOB_DTVENCTO)} , ' ' , 1000 , CURRENT TIMESTAMP, {FieldThreatment(this.V0RELA_DTREFER)})";
