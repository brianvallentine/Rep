...
{
    public class VA0416B_CHISTCOB : QueryBasis<VA0416B_CHISTCOB>
    {
        ...
        public VA0416B_CHISTCOB() { IsCursor = true; }

        public VA0416B_CHISTCOB(bool justACursor)
        {
        ...
        public override VA0416B_CHISTCOB OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA0416B_CHISTCOB();
            var i = 0;
