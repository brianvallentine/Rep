    ...
    public class M_0200_INSERT_REPSAF_DB_INSERT_1_Insert1 : QueryBasis<M_0200_INSERT_REPSAF_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            ...
            */
            #endregion
            var query = @$"
				INSERT INTO SEGUROS.MOVIMENTO_EA VALUES ({FieldThreatment(this.PROPOVA_NUM_CERTIFICADO)}, {FieldThreatment(this.CONARQEA_NSAS)}, {FieldThreatment(this.MOVIMEA_TIPO_MOVIMENTO)}, 'VA1473B' , CURRENT TIMESTAMP)";
