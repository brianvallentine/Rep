...
{
    public class VA1473B_CPROPVA : QueryBasis<VA1473B_CPROPVA>
    {
        ...
        public VA1473B_CPROPVA() { IsCursor = true; }

        public VA1473B_CPROPVA(bool justACursor)
        {
        ...
        public override VA1473B_CPROPVA OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new VA1473B_CPROPVA();
            var i = 0;
