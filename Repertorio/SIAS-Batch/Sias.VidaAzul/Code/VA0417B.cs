...
using Dclgens;
using Copies;
using Sias.VidaAzul.DB2.VA0417B;

namespace Code
{
    public class VA0417B
    {
        ...
        /*"      ******************************************************************      */
        /*"      *                                                                *      */
        /*"      *   EMITE RELATORIO DA FATURA DOS PRODUTOS NA ESTRUTURA DO       *      */
        /*"      *   MULTIPREMIADO COM FATURAMENTO NO DIA 15 DE CADA MES          *      */
        /*"      ******************************************************************      */
        ...
        /*"      *     03     *  26/04/99  *   MESSIAS    *                       *      */
        /*"      *                                                                *      */
        /*"      *    NAO EMITE MAIS AS APOLICES DA FENAM NESTE PROGRAMA. SERA    *      */
        /*"      * FEITO POR OUTRA VERSAO (VA1417B). EMITIRA AS DEMAIS APLICES.   *      */
        /*"1     ******************************************************************      */
        /*"      *     04     *  24/06/99  *   TERCIO     *                       *      */
        /*"      *                                                                *      */
        /*"      *    NAO UTILIZA MAIS PRODUTO COMO ARGUMENTO DE SELECAO.         *      */
        /*"      *                            PROCURE TL9906                      *      */
        /*"      ******************************************************************      */
        /*"      *     05     *  01/04/03  *   FRED       *                       *      */
        /*"      *                                                                *      */
        /*"      *    NAO GERA MAIS RELATORIO PARA O PRODUTO EMPRESARIAL.         *      */
        /*"      *    SOLICITADO PELA GEPES - NAGLIATI.                           *      */
        /*"      *                            PROCURE FF0304                      *      */
        /*"      ******************************************************************      */
        /*"      *     06     *  04/12/2007                                       *      */
        /*"      *                                                                *      */
        /*"      *    CADMUS 6616 (CORRECAO DO ABEND OCORRIDO - SQLCODE = -811    *      */
        /*"      *    NA TABELA DE RELATORIOS                                     *      */
        /*"      *                                     PROCURAR POR V.06          *      */
        /*"      *                                                                *      */
        /*"      ******************************************************************      */
        /*"      * MELHORIA DE PERFORMANCE         PRODEXTER            SET/2000  *      */
        /*"      * (PROCURAR POR SA0800)                                          *      */
        /*"      ******************************************************************      */
        #endregion
        ...
        public FileBasis _RVA0417B { get; set; } = new FileBasis(new PIC("X", "132", "X(132)"));

        public FileBasis RVA0417B
        {
            get
            {
                _.Move(REG_IMPRESSAO, _RVA0417B); VarBasis.RedefinePassValue(REG_IMPRESSAO, _RVA0417B, REG_IMPRESSAO); return _RVA0417B;
            }
        }
        ...
        /*"01  WORK-AREA.*/
        public VA0417B_WORK_AREA WORK_AREA { get; set; } = new VA0417B_WORK_AREA();
        public class VA0417B_WORK_AREA : VarBasis
        {
            /*"    05        DATA-SQL.*/
            public VA0417B_DATA_SQL DATA_SQL { get; set; } = new VA0417B_DATA_SQL();
            public class VA0417B_DATA_SQL : VarBasis
            {
            ...
            public VA0417B_WHORA_CURR WHORA_CURR { get; set; } = new VA0417B_WHORA_CURR();
            public class VA0417B_WHORA_CURR : VarBasis
            {
            ...
            public VA0417B_DATA_MAQ DATA_MAQ { get; set; } = new VA0417B_DATA_MAQ();
            public class VA0417B_DATA_MAQ : VarBasis
            {
                /*"      10      MES                 PIC  9(002).*/
            ...
            private _REDEF_VA0417B_WS_TIME_R _ws_time_r { get; set; }
            public _REDEF_VA0417B_WS_TIME_R WS_TIME_R
            {
                get { _ws_time_r = new _REDEF_VA0417B_WS_TIME_R(); _.Move(WS_TIME, _ws_time_r); VarBasis.RedefinePassValue(WS_TIME, _ws_time_r, WS_TIME); _ws_time_r.ValueChanged += () => { _.Move(_ws_time_r, WS_TIME); }; return _ws_time_r; }
                set { VarBasis.RedefinePassValue(value, _ws_time_r, WS_TIME); }
            }  //Redefines
            public class _REDEF_VA0417B_WS_TIME_R : VarBasis
            {
                /*"      10      WS-HOR              PIC  9(002).*/
                ...
                public _REDEF_VA0417B_WS_TIME_R()
                {
            ...
            public VA0417B_WS_DATA WS_DATA { get; set; } = new VA0417B_WS_DATA();
            public class VA0417B_WS_DATA : VarBasis
            {
                /*"      10      WS-DIA              PIC  9(002).*/
            ...
            public VA0417B_WS_DTREFER WS_DTREFER { get; set; } = new VA0417B_WS_DTREFER();
            public class VA0417B_WS_DTREFER : VarBasis
            {
            ...
            /*"    05        DATA-AUX.*/
            public VA0417B_DATA_AUX DATA_AUX { get; set; } = new VA0417B_DATA_AUX();
            public class VA0417B_DATA_AUX : VarBasis
            {
            ...
            /*"    05        WABEND.*/
            public VA0417B_WABEND WABEND { get; set; } = new VA0417B_WABEND();
            public class VA0417B_WABEND : VarBasis
            {
                /*"      10      FILLER              PIC  X(010) VALUE             ' VA0417B'.*/
                public StringBasis FILLER_9 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" VA0417B");
            ...
            public VA0417B_TRACO TRACO { get; set; } = new VA0417B_TRACO();
            public class VA0417B_TRACO : VarBasis
            {
                /*"      10      FILLER              PIC  X(132) VALUE ALL '-'.*/
                public StringBasis FILLER_12 { get; set; } = new StringBasis(new PIC("X", "132", "X(132)"), @"ALL");
                /*"    05        BRANCO.*/
            }
            public VA0417B_BRANCO BRANCO { get; set; } = new VA0417B_BRANCO();
            public class VA0417B_BRANCO : VarBasis
            {
                /*"      10      FILLER              PIC  X(132) VALUE SPACES.*/
                public StringBasis FILLER_13 { get; set; } = new StringBasis(new PIC("X", "132", "X(132)"), @"");
                /*"    05        LC01.*/
            }
            public VA0417B_LC01 LC01 { get; set; } = new VA0417B_LC01();
            public class VA0417B_LC01 : VarBasis
            {
                /*"      10      FILLER              PIC  X(008) VALUE 'VA0417B'.*/
                public StringBasis FILLER_14 { get; set; } = new StringBasis(new PIC("X", "8", "X(008)"), @"VA0417B");
            ...
            public VA0417B_LC02 LC02 { get; set; } = new VA0417B_LC02();
            public class VA0417B_LC02 : VarBasis
            {
            ...
            public VA0417B_LC03 LC03 { get; set; } = new VA0417B_LC03();
            public class VA0417B_LC03 : VarBasis
            {
                /*"      10      FILLER              PIC  X(037) VALUE SPACES.*/
            ...
            public VA0417B_LC03_1 LC03_1 { get; set; } = new VA0417B_LC03_1();
            public class VA0417B_LC03_1 : VarBasis
            {
            ...
            public VA0417B_LC03_2 LC03_2 { get; set; } = new VA0417B_LC03_2();
            public class VA0417B_LC03_2 : VarBasis
            {
            ...
            public VA0417B_LC04 LC04 { get; set; } = new VA0417B_LC04();
            public class VA0417B_LC04 : VarBasis
            {
                ...
                /*"      10      LC04-CODSUBES       PIC 9(05) VALUE  ZEROS.*/
                public IntBasis LC04_CODSUBES { get; set; } = new IntBasis(new PIC("9", "5", "9(05)"));
                /*"      10      FILLER              PIC X(03) VALUE ' - '.*/
            ...
            public VA0417B_LC05 LC05 { get; set; } = new VA0417B_LC05();
            public class VA0417B_LC05 : VarBasis
            {
            ...
            public VA0417B_LC06 LC06 { get; set; } = new VA0417B_LC06();
            public class VA0417B_LC06 : VarBasis
            {
            ...
            public VA0417B_LC07 LC07 { get; set; } = new VA0417B_LC07();
            public class VA0417B_LC07 : VarBasis
            {
            ...
            public VA0417B_LD01 LD01 { get; set; } = new VA0417B_LD01();
            public class VA0417B_LD01 : VarBasis
            {
            ...
            public VA0417B_LD02 LD02 { get; set; } = new VA0417B_LD02();
            public class VA0417B_LD02 : VarBasis
            {
        ...
        public VA0417B_TABELA_MESES TABELA_MESES { get; set; } = new VA0417B_TABELA_MESES();
        public class VA0417B_TABELA_MESES : VarBasis
        {
        ...
        private _REDEF_VA0417B_TABELA_MESES_R _tabela_meses_r { get; set; }
        public _REDEF_VA0417B_TABELA_MESES_R TABELA_MESES_R
        {
            get { _tabela_meses_r = new _REDEF_VA0417B_TABELA_MESES_R(); _.Move(TABELA_MESES, _tabela_meses_r); VarBasis.RedefinePassValue(TABELA_MESES, _tabela_meses_r, TABELA_MESES); _tabela_meses_r.ValueChanged += () => { _.Move(_tabela_meses_r, TABELA_MESES); }; return _tabela_meses_r; }
            set { VarBasis.RedefinePassValue(value, _tabela_meses_r, TABELA_MESES); }
        }  //Redefines
        public class _REDEF_VA0417B_TABELA_MESES_R : VarBasis
        {
            ...
            public _REDEF_VA0417B_TABELA_MESES_R()
            {
        ...
        /*"01            CHAVE-ATU.*/
        public VA0417B_CHAVE_ATU CHAVE_ATU { get; set; } = new VA0417B_CHAVE_ATU();
        public class VA0417B_CHAVE_ATU : VarBasis
        {
            /*"  05          APOLICE-ATU          PIC 9(015)  VALUE ZEROS.*/
            public IntBasis APOLICE_ATU { get; set; } = new IntBasis(new PIC("9", "15", "9(015)"));
            /*"  05          CODSUBES-ATU         PIC 9(005)  VALUE ZEROS.*/
            public IntBasis CODSUBES_ATU { get; set; } = new IntBasis(new PIC("9", "5", "9(005)"));
            /*"01            CHAVE-ANT.*/
        }
        public VA0417B_CHAVE_ANT CHAVE_ANT { get; set; } = new VA0417B_CHAVE_ANT();
        public class VA0417B_CHAVE_ANT : VarBasis
        {
            /*"  05          APOLICE-ANT          PIC 9(015)  VALUE ZEROS.*/
            public IntBasis APOLICE_ANT { get; set; } = new IntBasis(new PIC("9", "15", "9(015)"));
            /*"  05          CODSUBES-ANT         PIC 9(005)  VALUE ZEROS.*/
            public IntBasis CODSUBES_ANT { get; set; } = new IntBasis(new PIC("9", "5", "9(005)"));
            /*"01            TOTAIS-FILIAIS.*/
        }
        public VA0417B_TOTAIS_FILIAIS TOTAIS_FILIAIS { get; set; } = new VA0417B_TOTAIS_FILIAIS();
        public class VA0417B_TOTAIS_FILIAIS : VarBasis
        {
        ...
        public VA0417B_TOTAIS_PRODUTOS TOTAIS_PRODUTOS { get; set; } = new VA0417B_TOTAIS_PRODUTOS();
        public class VA0417B_TOTAIS_PRODUTOS : VarBasis
        {
        ...
        public VA0417B_TOTAIS_GERAIS TOTAIS_GERAIS { get; set; } = new VA0417B_TOTAIS_GERAIS();
        public class VA0417B_TOTAIS_GERAIS : VarBasis
        {
        ...
        public VA0417B_CHCONT CHCONT { get; set; } = new VA0417B_CHCONT();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string RVA0417B_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                RVA0417B.SetFile(RVA0417B_FILE_NAME_P);
        ...
        {
            /*" -432- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

            /*" -435- EXEC SQL WHENEVER SQLERROR GO TO R9999-00-ROT-ERRO END-EXEC. */

            /*" -438- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

            /*" -439- PERFORM R0000-00-PRINCIPAL. */
        ...
        {
            /*" -449- MOVE ZEROS TO TOTAIS-FILIAIS TOTAIS-PRODUTOS TOTAIS-GERAIS. */
            _.Move(0, TOTAIS_FILIAIS, TOTAIS_PRODUTOS, TOTAIS_GERAIS);

            /*" -451- PERFORM R6000-00-ZERA-DETALHE. */

            R6000_00_ZERA_DETALHE_SECTION();

            /*" -453- PERFORM R0100-00-SELECT-V1SISTEMA. */

            R0100_00_SELECT_V1SISTEMA_SECTION();

            /*" -454- IF WFIM-SISTEMA NOT EQUAL SPACES */
            ...
            /*" -459- PERFORM R0200-00-SELECT-V0RELATORIOS. */

            R0200_00_SELECT_V0RELATORIOS_SECTION();

            /*" -460- IF WFIM-RELATORIO NOT EQUAL SPACES */
            ...
            /*" -465- OPEN OUTPUT RVA0417B. */
            RVA0417B.Open(REG_IMPRESSAO);

            /*" -467- PERFORM R0900-00-DECLARE-V0HCONTABILVA. */

            R0900_00_DECLARE_V0HCONTABILVA_SECTION();

            /*" -469- PERFORM R0910-00-FETCH-V0HCONTABILVA. */

            R0910_00_FETCH_V0HCONTABILVA_SECTION();

            /*" -470- IF WFIM-HCONTABILVA EQUAL 'S' */
            ...
            if (WORK_AREA.WFIM_HCONTABILVA == "S")
            {
                ...
                /*" -472- DISPLAY 'NENHUM REG. SELECIONADO NA V0HISTCONTABILVA' */
                _.Display($"NENHUM REG. SELECIONADO NA V0HISTCONTABILVA");

                /*" -473- MOVE ZEROS TO RETURN-CODE */
            ...
            /*" -479- PERFORM R1000-00-PROCESSA-REGISTRO UNTIL WFIM-HCONTABILVA EQUAL 'S' . */
            ...
            /*" -480- PERFORM R1200-00-VALOR-FATURADO */

            R1200_00_VALOR_FATURADO_SECTION();

            /*" -481- PERFORM R2000-00-IMPRIME-FILIAL */

            R2000_00_IMPRIME_FILIAL_SECTION();

            /*" -481- PERFORM R2100-00-IMP-TOT-PRODUTO. */
        ...
        {
            /*" -494- MOVE ZEROS TO RETURN-CODE. */
            _.Move(0, RETURN_CODE);

            /*" -494- EXEC SQL COMMIT WORK END-EXEC. */
            ...
            /*" -499- DISPLAY 'LIDOS V0HISTCONTABILVA   ' AC-LIDOS. */
            _.Display($"LIDOS V0HISTCONTABILVA   {WORK_AREA.AC_LIDOS}");

            /*" -501- DISPLAY '*** VA0417B - TERMINO NORMAL ***' */
            _.Display($"*** VA0417B - TERMINO NORMAL ***");
        ...
        {
            /*" -522- EXEC SQL SELECT DTMOVABE INTO :V1SIST-DTMOVABE FROM SEGUROS.V1SISTEMA WHERE IDSISTEM = 'VA' END-EXEC. */
        ...
        {
            /*" -551- MOVE '020' TO WNR-EXEC-SQL. */
            _.Move("020", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -552- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -560- PERFORM R0200_00_SELECT_V0RELATORIOS_DB_SELECT_1 */

            R0200_00_SELECT_V0RELATORIOS_DB_SELECT_1();

            /*" -564- IF SQLCODE NOT EQUAL ZEROS AND SQLCODE NOT EQUAL -811 */
            ...
            if (DB.SQLCODE != 00 && DB.SQLCODE != -811)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -566- DISPLAY 'REGISTRO NAO ENCONTRADO V0RELATORIOS' */
                    _.Display($"REGISTRO NAO ENCONTRADO V0RELATORIOS");

                    /*" -567- MOVE 'S' TO WFIM-RELATORIO */
                    _.Move("S", WORK_AREA.WFIM_RELATORIO);

                    /*" -569- GO TO R0200-99-SAIDA. */
        ...
        {
            /*" -560- EXEC SQL SELECT DATA_REFERENCIA INTO :V0RELA-DTREFER FROM SEGUROS.V0RELATORIOS WHERE CODRELAT = 'VA0417B' AND SITUACAO = '1' END-EXEC. */
        ...
        {
            /*" -588- MOVE '090' TO WNR-EXEC-SQL. */
            _.Move("090", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -630- PERFORM R0900_00_DECLARE_V0HCONTABILVA_DB_DECLARE_1 */

            R0900_00_DECLARE_V0HCONTABILVA_DB_DECLARE_1();

            /*" -632- PERFORM R0900_00_DECLARE_V0HCONTABILVA_DB_OPEN_1 */
        ...
        {
            /*" -630- EXEC SQL DECLARE CHCONT CURSOR FOR SELECT A.NUM_APOLICE , A.CODSUBES , A.FONTE , A.NRENDOS , A.NRPARCEL , A.CODOPER , B.NOMEFTE , C.NOMPRODU , SUM(A.PRMVG + A.PRMAP), COUNT(*) FROM SEGUROS.V0HISTCONTABILVA A, SEGUROS.V0FONTE B, SEGUROS.V0PRODUTOSVG C WHERE A.DTFATUR = :V0RELA-DTREFER AND A.SITUACAO IN ( ' ' , '1' ) AND A.FONTE = B.FONTE AND A.NUM_APOLICE = C.NUM_APOLICE AND A.CODSUBES = C.CODSUBES AND C.DIA_FATURA = 31 AND C.ESTR_COBR = 'MULT' AND C.ORIG_PRODU NOT IN ( 'EMPRE' , 'GLOBAL' ) GROUP BY A.NUM_APOLICE, A.CODSUBES , A.FONTE , A.NRENDOS , A.NRPARCEL , A.CODOPER , B.NOMEFTE , C.NOMPRODU ORDER BY A.NUM_APOLICE, A.CODSUBES , A.FONTE , A.NRENDOS , A.NRPARCEL , A.CODOPER , B.NOMEFTE , C.NOMPRODU END-EXEC. */
            CHCONT = new VA0417B_CHCONT(true);
        ...
        {
            /*" -632- EXEC SQL OPEN CHCONT END-EXEC. */
        ...
        {
            /*" -645- MOVE '091' TO WNR-EXEC-SQL. */
            _.Move("091", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -657- PERFORM R0910_00_FETCH_V0HCONTABILVA_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -661- MOVE 'S' TO WFIM-HCONTABILVA */
                _.Move("S", WORK_AREA.WFIM_HCONTABILVA);

                /*" -661- PERFORM R0910_00_FETCH_V0HCONTABILVA_DB_CLOSE_1 */

                R0910_00_FETCH_V0HCONTABILVA_DB_CLOSE_1();

                /*" -664- GO TO R0910-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R0910_99_SAIDA*/ //GOTO
                return;
            }


            /*" -665- MOVE V0HCON-APOLICE TO APOLICE-ATU. */
            _.Move(V0HCON_APOLICE, CHAVE_ATU.APOLICE_ATU);

            /*" -666- MOVE V0HCON-CODSUBES TO CODSUBES-ATU. */
            _.Move(V0HCON_CODSUBES, CHAVE_ATU.CODSUBES_ATU);

            /*" -668- MOVE V0HCON-FONTE TO FONTE-ATU. */
            _.Move(V0HCON_FONTE, FONTE_ATU);

            /*" -668- ADD 1 TO AC-LIDOS. */
        ...
        {
            /*" -657- EXEC SQL FETCH CHCONT INTO :V0HCON-APOLICE, :V0HCON-CODSUBES, :V0HCON-FONTE, :V0HCON-NRENDOS, :V0HCON-NRPARCEL, :V0HCON-CODOPER, :V0FONT-NOMEFTE, :V0PROD-NOMPRODU, :V0HCON-PRMTOTAL, :V0HCON-QTD END-EXEC. */
        ...
        {
            /*" -661- EXEC SQL CLOSE CHCONT END-EXEC */
        ...
        {
            /*" -680- IF CHAVE-ANT EQUAL ZEROES */

            if (CHAVE_ANT == 00)
            {

                /*" -681- MOVE V0HCON-APOLICE TO APOLICE-ANT */
                _.Move(V0HCON_APOLICE, CHAVE_ANT.APOLICE_ANT);

                /*" -682- MOVE V0HCON-CODSUBES TO CODSUBES-ANT */
                _.Move(V0HCON_CODSUBES, CHAVE_ANT.CODSUBES_ANT);

                /*" -683- PERFORM R3000-00-SELECT-V1APOLICE */

                R3000_00_SELECT_V1APOLICE_SECTION();

                /*" -685- PERFORM R5000-00-CABECALHOS. */

                R5000_00_CABECALHOS_SECTION();
            }


            /*" -686- IF CHAVE-ANT NOT EQUAL CHAVE-ATU */

            if (CHAVE_ANT != CHAVE_ATU)
            {

                /*" -687- PERFORM R1200-00-VALOR-FATURADO */

                R1200_00_VALOR_FATURADO_SECTION();

                /*" -688- PERFORM R2000-00-IMPRIME-FILIAL */

                R2000_00_IMPRIME_FILIAL_SECTION();

                /*" -690- MOVE V0HCON-FONTE TO FONTE-ANT LD01-FILIAL */
                _.Move(V0HCON_FONTE, FONTE_ANT, WORK_AREA.LD01.LD01_FILIAL);

                /*" -691- MOVE V0FONT-NOMEFTE TO LD01-NOMEFTE */
                _.Move(V0FONT_NOMEFTE, WORK_AREA.LD01.LD01_NOMEFTE);

                /*" -692- MOVE V0HCON-NRENDOS TO LD01-NRENDOS */
                _.Move(V0HCON_NRENDOS, WORK_AREA.LD01.LD01_NRENDOS);

                /*" -693- PERFORM R2100-00-IMP-TOT-PRODUTO */

                R2100_00_IMP_TOT_PRODUTO_SECTION();

                /*" -695- MOVE ZEROS TO TOTAIS-FILIAIS TOTAIS-PRODUTOS */
                _.Move(0, TOTAIS_FILIAIS, TOTAIS_PRODUTOS);

                /*" -696- MOVE V0HCON-APOLICE TO APOLICE-ANT */
                _.Move(V0HCON_APOLICE, CHAVE_ANT.APOLICE_ANT);

                /*" -697- MOVE V0HCON-CODSUBES TO CODSUBES-ANT */
                _.Move(V0HCON_CODSUBES, CHAVE_ANT.CODSUBES_ANT);

                /*" -698- PERFORM R3000-00-SELECT-V1APOLICE */

                R3000_00_SELECT_V1APOLICE_SECTION();

                /*" -700- PERFORM R5000-00-CABECALHOS. */

                R5000_00_CABECALHOS_SECTION();
            }


            /*" -701- IF FONTE-ANT EQUAL ZEROES */

            if (FONTE_ANT == 00)
            {

                /*" -703- MOVE V0HCON-FONTE TO FONTE-ANT LD01-FILIAL */
                _.Move(V0HCON_FONTE, FONTE_ANT, WORK_AREA.LD01.LD01_FILIAL);

                /*" -704- MOVE V0FONT-NOMEFTE TO LD01-NOMEFTE */
                _.Move(V0FONT_NOMEFTE, WORK_AREA.LD01.LD01_NOMEFTE);

                /*" -706- MOVE V0HCON-NRENDOS TO LD01-NRENDOS. */
                _.Move(V0HCON_NRENDOS, WORK_AREA.LD01.LD01_NRENDOS);
            }


            /*" -707- IF FONTE-ANT EQUAL FONTE-ATU */

            if (FONTE_ANT == FONTE_ATU)
            {

                /*" -708- MOVE V0HCON-NRENDOS TO LD01-NRENDOS */
                _.Move(V0HCON_NRENDOS, WORK_AREA.LD01.LD01_NRENDOS);

                /*" -709- PERFORM R1100-00-DEMAIS-VALORES */
            ...
            else
            {
                ...
                /*" -711- PERFORM R1200-00-VALOR-FATURADO */

                R1200_00_VALOR_FATURADO_SECTION();

                /*" -712- PERFORM R2000-00-IMPRIME-FILIAL */

                R2000_00_IMPRIME_FILIAL_SECTION();

                /*" -713- MOVE ZEROS TO TOTAIS-FILIAIS */
                _.Move(0, TOTAIS_FILIAIS);

                /*" -715- MOVE V0HCON-FONTE TO FONTE-ANT LD01-FILIAL */
                _.Move(V0HCON_FONTE, FONTE_ANT, WORK_AREA.LD01.LD01_FILIAL);

                /*" -716- MOVE V0FONT-NOMEFTE TO LD01-NOMEFTE */
                _.Move(V0FONT_NOMEFTE, WORK_AREA.LD01.LD01_NOMEFTE);

                /*" -717- MOVE V0HCON-NRENDOS TO LD01-NRENDOS */
                _.Move(V0HCON_NRENDOS, WORK_AREA.LD01.LD01_NRENDOS);

                /*" -717- PERFORM R1100-00-DEMAIS-VALORES. */
        ...
        {
            /*" -723- PERFORM R0910-00-FETCH-V0HCONTABILVA. */

            R0910_00_FETCH_V0HCONTABILVA_SECTION();

            /*" -724- IF AC-LINHA GREATER 57 */

            if (WORK_AREA.AC_LINHA > 57)
            {

                /*" -724- PERFORM R5000-00-CABECALHOS. */
        ...
        {
            /*" -847- MOVE '120' TO WNR-EXEC-SQL. */
            _.Move("120", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -852- COMPUTE TOTF-QTD-FATU = TOTF-QTD-VENDA + TOTF-QTD-DEMAIS - TOTF-QTD-CANC - TOTF-QTD-REST. */
            ...
            /*" -857- COMPUTE TOTF-VLR-FATU = TOTF-VLR-VENDA + TOTF-VLR-DEMAIS - TOTF-VLR-CANC - TOTF-VLR-REST. */
            ...
            /*" -862- COMPUTE TOTP-QTD-FATU = TOTP-QTD-VENDA + TOTP-QTD-DEMAIS - TOTP-QTD-CANC - TOTP-QTD-REST. */
            ...
            /*" -867- COMPUTE TOTP-VLR-FATU = TOTP-VLR-VENDA + TOTP-VLR-DEMAIS - TOTP-VLR-CANC - TOTP-VLR-REST. */
        ...
        {
            /*" -980- MOVE '300' TO WNR-EXEC-SQL. */
            _.Move("300", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -985- PERFORM R3000_00_SELECT_V1APOLICE_DB_SELECT_1 */

            R3000_00_SELECT_V1APOLICE_DB_SELECT_1();

            /*" -988- IF SQLCODE NOT EQUAL ZEROES */

            if (DB.SQLCODE != 00)
            {

                /*" -989- DISPLAY 'PROBLEMAS NO SELECT V1APOLICE ' */
        ...
        {
            /*" -985- EXEC SQL SELECT NOME INTO :V1APOL-NOMEAPOL FROM SEGUROS.V1APOLICE WHERE NUM_APOLICE = :V0HCON-APOLICE END-EXEC */
        ...
        {
            /*" -1002- MOVE '400' TO WNR-EXEC-SQL. */
            _.Move("400", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -1007- PERFORM R4000_00_UPDATE_RELATORIO_DB_UPDATE_1 */

            R4000_00_UPDATE_RELATORIO_DB_UPDATE_1();

            /*" -1010- IF SQLCODE NOT EQUAL ZEROES */

            if (DB.SQLCODE != 00)
            {

                /*" -1011- DISPLAY 'PROBLEMAS NO UPDATE V0RELATORIOS ' */
        ...
        {
            /*" -1007- EXEC SQL UPDATE SEGUROS.V0RELATORIOS SET SITUACAO = '2' WHERE CODRELAT = 'VA0417B' AND SITUACAO = '1' END-EXEC */
        ...
        {
            /*" -1024- MOVE '500' TO WNR-EXEC-SQL. */
            _.Move("500", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -1025- MOVE ZEROS TO AC-LINHA. */
            _.Move(0, WORK_AREA.AC_LINHA);

            /*" -1026- ADD 1 TO AC-PAGINA. */
            WORK_AREA.AC_PAGINA.Value = WORK_AREA.AC_PAGINA + 1;

            /*" -1027- MOVE AC-PAGINA TO LC01-PAGINA. */
            _.Move(WORK_AREA.AC_PAGINA, WORK_AREA.LC01.LC01_PAGINA);

            /*" -1028- WRITE REG-IMPRESSAO FROM LC01 AFTER PAGE. */
            _.Move(WORK_AREA.LC01.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1029- WRITE REG-IMPRESSAO FROM LC02. */
            _.Move(WORK_AREA.LC02.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1030- WRITE REG-IMPRESSAO FROM LC03. */
            _.Move(WORK_AREA.LC03.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1031- WRITE REG-IMPRESSAO FROM BRANCO. */
            _.Move(WORK_AREA.BRANCO.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1032- WRITE REG-IMPRESSAO FROM LC03-1. */
            _.Move(WORK_AREA.LC03_1.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1033- WRITE REG-IMPRESSAO FROM BRANCO. */
            _.Move(WORK_AREA.BRANCO.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1034- WRITE REG-IMPRESSAO FROM TRACO. */
            _.Move(WORK_AREA.TRACO.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1035- MOVE V0HCON-APOLICE TO LC03-APOLICE. */
            _.Move(V0HCON_APOLICE, WORK_AREA.LC03_2.LC03_APOLICE);

            /*" -1036- MOVE V1APOL-NOMEAPOL TO LC03-NOMEAPOL. */
            _.Move(V1APOL_NOMEAPOL, WORK_AREA.LC03_2.LC03_NOMEAPOL);

            /*" -1037- WRITE REG-IMPRESSAO FROM LC03-2. */
            _.Move(WORK_AREA.LC03_2.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1038- MOVE V0HCON-CODSUBES TO LC04-CODSUBES. */
            _.Move(V0HCON_CODSUBES, WORK_AREA.LC04.LC04_CODSUBES);

            /*" -1039- MOVE V0PROD-NOMPRODU TO LC04-NOMPRODU. */
            _.Move(V0PROD_NOMPRODU, WORK_AREA.LC04.LC04_NOMPRODU);

            /*" -1040- WRITE REG-IMPRESSAO FROM LC04. */
            _.Move(WORK_AREA.LC04.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1041- WRITE REG-IMPRESSAO FROM TRACO. */
            _.Move(WORK_AREA.TRACO.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1042- WRITE REG-IMPRESSAO FROM BRANCO. */
            _.Move(WORK_AREA.BRANCO.GetMoveValues(), REG_IMPRESSAO);

            RVA0417B.Write(REG_IMPRESSAO.GetMoveValues().ToString());

            /*" -1042- MOVE 11 TO AC-LINHA. */
        ...
        {
            /*" -1055- MOVE '600' TO WNR-EXEC-SQL. */
            _.Move("600", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -1056- MOVE SPACES TO LD02-TITULO. */
            _.Move("", WORK_AREA.LD02.LD02_TITULO);

            /*" -1067- MOVE ZEROS TO LD02-QTD-VENDA LD02-VLR-VENDA LD02-QTD-DEMAIS LD02-VLR-DEMAIS LD02-QTD-CANC LD02-VLR-CANC LD02-QTD-REST LD02-VLR-REST LD02-QTD-FATU LD02-VLR-FATU LD02-QTD-PEND LD02-VLR-PEND. */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -1083- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -1085- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1089- MOVE 99 TO RETURN-CODE. */
