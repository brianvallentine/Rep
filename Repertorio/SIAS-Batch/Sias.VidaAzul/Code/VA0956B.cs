...
using Dclgens;
using Copies;
using Sias.VidaAzul.DB2.VA0956B;

namespace Code
{
    public class VA0956B
    {
        ...
        /*"      *                            AS OPERACOES DOS SINISTROS CANCELADO*      */
        /*"      *                            NO MES PARA O RAMO VIDA.            *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      * ALTERACAO:  15/08/08   WELLINGTON VERAS (POLITEC)              *      */
        /*"      *    PROJETO FGV                                                 *      */
        ...
        public SortBasis<VA0956B_REG_ARQSORT> ARQSORT { get; set; } = new SortBasis<VA0956B_REG_ARQSORT>(new VA0956B_REG_ARQSORT());
        /*"01          REG-ARQSORT.*/
        public VA0956B_REG_ARQSORT REG_ARQSORT { get; set; } = new VA0956B_REG_ARQSORT();
        public class VA0956B_REG_ARQSORT : VarBasis
        {
        ...
        /*"    05        LD00.*/
        public VA0956B_LD00 LD00 { get; set; } = new VA0956B_LD00();
        public class VA0956B_LD00 : VarBasis
        {
            /*"      10      FILLER              PIC X(07)   VALUE 'VA0956B'.*/
            public StringBasis FILLER_0 { get; set; } = new StringBasis(new PIC("X", "7", "X(07)"), @"VA0956B");
            /*"      10      FILLER              PIC X(08)   VALUE  SPACES.*/
            public StringBasis FILLER_1 { get; set; } = new StringBasis(new PIC("X", "8", "X(08)"), @"");
            /*"      10      FILLER              PIC X(50)   VALUE            'SINISTROS CANCELADOS NO MES                       '*/
            public StringBasis FILLER_2 { get; set; } = new StringBasis(new PIC("X", "50", "X(50)"), @"SINISTROS CANCELADOS NO MES                       ");
        ...
        public VA0956B_WCAB_AUDTSINI WCAB_AUDTSINI { get; set; } = new VA0956B_WCAB_AUDTSINI();
        public class VA0956B_WCAB_AUDTSINI : VarBasis
        {
        ...
        public VA0956B_WREG_AUDTSINI WREG_AUDTSINI { get; set; } = new VA0956B_WREG_AUDTSINI();
        public class VA0956B_WREG_AUDTSINI : VarBasis
        {
        ...
        public VA0956B_W_TABELAS W_TABELAS { get; set; } = new VA0956B_W_TABELAS();
        public class VA0956B_W_TABELAS : VarBasis
        {
            /*"  05        TABELA-MESES.*/
            public VA0956B_TABELA_MESES TABELA_MESES { get; set; } = new VA0956B_TABELA_MESES();
            public class VA0956B_TABELA_MESES : VarBasis
            {
            ...
            public VA0956B_TABELA_SINI_PENDT TABELA_SINI_PENDT { get; set; } = new VA0956B_TABELA_SINI_PENDT();
            public class VA0956B_TABELA_SINI_PENDT : VarBasis
            {
                /*"    10      TAB-SINI-PEND       OCCURS   100   TIMES.*/
                public ListBasis<VA0956B_TAB_SINI_PEND> TAB_SINI_PEND { get; set; } = new ListBasis<VA0956B_TAB_SINI_PEND>(100);
                public class VA0956B_TAB_SINI_PEND : VarBasis
                {
                    /*"      15    W-RAMO              PIC  9(004).*/
        ...
        public VA0956B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new VA0956B_AREA_DE_WORK();
        public class VA0956B_AREA_DE_WORK : VarBasis
        {
            /*"  05 WS-CHAVE-ATU.*/
            public VA0956B_WS_CHAVE_ATU WS_CHAVE_ATU { get; set; } = new VA0956B_WS_CHAVE_ATU();
            public class VA0956B_WS_CHAVE_ATU : VarBasis
            {
            ...
            public VA0956B_WS_CHAVE_ANT WS_CHAVE_ANT { get; set; } = new VA0956B_WS_CHAVE_ANT();
            public class VA0956B_WS_CHAVE_ANT : VarBasis
            {
            ...
            private _REDEF_VA0956B_FILLER_138 _filler_138 { get; set; }
            public _REDEF_VA0956B_FILLER_138 FILLER_138
            {
                get { _filler_138 = new _REDEF_VA0956B_FILLER_138(); _.Move(WDATA_SIST, _filler_138); VarBasis.RedefinePassValue(WDATA_SIST, _filler_138, WDATA_SIST); _filler_138.ValueChanged += () => { _.Move(_filler_138, WDATA_SIST); }; return _filler_138; }
                set { VarBasis.RedefinePassValue(value, _filler_138, WDATA_SIST); }
            }  //Redefines
            public class _REDEF_VA0956B_FILLER_138 : VarBasis
            {
                ...
                public _REDEF_VA0956B_FILLER_138()
                {
            ...
            private _REDEF_VA0956B_FILLER_141 _filler_141 { get; set; }
            public _REDEF_VA0956B_FILLER_141 FILLER_141
            {
                get { _filler_141 = new _REDEF_VA0956B_FILLER_141(); _.Move(WDATA_CURR, _filler_141); VarBasis.RedefinePassValue(WDATA_CURR, _filler_141, WDATA_CURR); _filler_141.ValueChanged += () => { _.Move(_filler_141, WDATA_CURR); }; return _filler_141; }
                set { VarBasis.RedefinePassValue(value, _filler_141, WDATA_CURR); }
            }  //Redefines
            public class _REDEF_VA0956B_FILLER_141 : VarBasis
            {
                ...
                public _REDEF_VA0956B_FILLER_141()
                {
            ...
            public VA0956B_WDATA_EDIT WDATA_EDIT { get; set; } = new VA0956B_WDATA_EDIT();
            public class VA0956B_WDATA_EDIT : VarBasis
            {
            ...
            private _REDEF_VA0956B_FILLER_146 _filler_146 { get; set; }
            public _REDEF_VA0956B_FILLER_146 FILLER_146
            {
                get { _filler_146 = new _REDEF_VA0956B_FILLER_146(); _.Move(WDATA_REFER, _filler_146); VarBasis.RedefinePassValue(WDATA_REFER, _filler_146, WDATA_REFER); _filler_146.ValueChanged += () => { _.Move(_filler_146, WDATA_REFER); }; return _filler_146; }
                set { VarBasis.RedefinePassValue(value, _filler_146, WDATA_REFER); }
            }  //Redefines
            public class _REDEF_VA0956B_FILLER_146 : VarBasis
            {
                ...
                public _REDEF_VA0956B_FILLER_146()
                {
            ...
            public VA0956B_WHORA_CURR WHORA_CURR { get; set; } = new VA0956B_WHORA_CURR();
            public class VA0956B_WHORA_CURR : VarBasis
            {
            ...
            public VA0956B_WHORA_EDIT WHORA_EDIT { get; set; } = new VA0956B_WHORA_EDIT();
            public class VA0956B_WHORA_EDIT : VarBasis
            {
        ...
        public VA0956B_LK_LINK LK_LINK { get; set; } = new VA0956B_LK_LINK();
        public class VA0956B_LK_LINK : VarBasis
        {
        ...
        public VA0956B_PARAMETROS_DT PARAMETROS_DT { get; set; } = new VA0956B_PARAMETROS_DT();
        public class VA0956B_PARAMETROS_DT : VarBasis
        {
        ...
        public VA0956B_WABEND WABEND { get; set; } = new VA0956B_WABEND();
        public class VA0956B_WABEND : VarBasis
        {
            /*"  05     FILLER                 PIC  X(010) VALUE ' VA0956B'.*/
            public StringBasis FILLER_151 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" VA0956B");
        ...
        public VA0956B_V0SINISTROS V0SINISTROS { get; set; } = new VA0956B_V0SINISTROS();
        public VA0956B_C_SINISACO C_SINISACO { get; set; } = new VA0956B_C_SINISACO();
        ...
        {
            /*" -582- MOVE '0000' TO WNR-EXEC-SQL. */
            _.Move("0000", WABEND.WNR_EXEC_SQL);

            /*" -583- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

            /*" -586- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -589- EXEC SQL WHENEVER NOT FOUND CONTINUE END-EXEC. */

            /*" -593- OPEN OUTPUT AUDTSINI. */
            AUDTSINI.Open(REG_AUDTSINI, AREA_DE_WORK.W_STATUS);

            /*" -594- IF W-STATUS NOT EQUAL ZEROS */

            if (AREA_DE_WORK.W_STATUS != 00)
            {

                /*" -595- DISPLAY 'R0000 - ERRO NO OPEN DO ARQ AUDTSINI' */
                _.Display($"R0000 - ERRO NO OPEN DO ARQ AUDTSINI");

                /*" -596- DISPLAY 'STATUS  - ' W-STATUS */
            ...
            /*" -599- WRITE REG-AUDTSINI FROM LD00. */
            _.Move(LD00.GetMoveValues(), REG_AUDTSINI);

            AUDTSINI.Write(REG_AUDTSINI.GetMoveValues().ToString());

            /*" -601- WRITE REG-AUDTSINI FROM WCAB-AUDTSINI */
            _.Move(WCAB_AUDTSINI.GetMoveValues(), REG_AUDTSINI);

            AUDTSINI.Write(REG_AUDTSINI.GetMoveValues().ToString());

            /*" -603- PERFORM R0100-00-SELECT-V0SISTEMA. */

            R0100_00_SELECT_V0SISTEMA_SECTION();

            /*" -605- PERFORM R0200-00-SELECT-V0EMPRESA. */

            R0200_00_SELECT_V0EMPRESA_SECTION();

            /*" -607- MOVE +500000 TO SORT-FILE-SIZE. */
            _.Move(+500000, SORT_FILE_SIZE);

            /*" -615- SORT ARQSORT ON ASCENDING KEY SD-TIP-PEND SD-RAMO-CBT SD-NUM-SINI INPUT PROCEDURE R0400-00-INPUT-SORT THRU R0400-99-SAIDA OUTPUT PROCEDURE R0700-00-OUTPUT-SORT THRU R0700-99-SAIDA. */
            ...
            /*" -618- IF SORT-RETURN NOT EQUAL ZEROS */

            if (SORT_RETURN != 00)
            {

                /*" -619- DISPLAY 'VA0956B *** PROBLEMAS NO SORT ***' */
                _.Display($"VA0956B *** PROBLEMAS NO SORT ***");

                /*" -620- DISPLAY 'SORT-RETURN - ' SORT-RETURN */
            ...
            /*" -622- PERFORM R0300-00-DELETE-V0RELATORIOS. */
        ...
        {
            /*" -628- MOVE W-TOT-VAL-OPER TO W-VAL-OPER-TOT. */
            ...
            /*" -633- DISPLAY '*   DADOS DE CONTROLE DE PROCESSAMENTO       *' . */
            ...
            /*" -638- DISPLAY '* NUMERO DE REGISTROS LIDOS NA SINISTROS   = ' AC-L-SINISTROS. */
            _.Display($"* NUMERO DE REGISTROS LIDOS NA SINISTROS   = {AREA_DE_WORK.AC_L_SINISTROS}");

            /*" -640- DISPLAY '* NUMERO DE REGISTROS GRAVADOS NO ARQSORT  = ' AC-G-ARQSORT. */
            _.Display($"* NUMERO DE REGISTROS GRAVADOS NO ARQSORT  = {AREA_DE_WORK.AC_G_ARQSORT}");

            /*" -642- DISPLAY '* NUMERO DE REGISTROS LIDOS NO ARQSORT     = ' AC-L-ARQSORT. */
            _.Display($"* NUMERO DE REGISTROS LIDOS NO ARQSORT     = {AREA_DE_WORK.AC_L_ARQSORT}");

            /*" -644- DISPLAY '* NUM. DE REGISTROS GRAV. NO ARQ. AUDTSINI = ' AC-G-AUDTSINI. */
            _.Display($"* NUM. DE REGISTROS GRAV. NO ARQ. AUDTSINI = {AREA_DE_WORK.AC_G_AUDTSINI}");

            /*" -647- DISPLAY '* VALOR TOTAL DAS OPERACOES DE PENDENCIA   = ' W-VAL-OPER-TOT. */
            ...
            /*" -654- DISPLAY '*   TERMINO  ==> N O R M A L <==             *' . */
            ...
            /*" -657- EXEC SQL COMMIT WORK END-EXEC. */

            DatabaseConnection.Instance.CommitTransaction();

            /*" -661- MOVE ZEROS TO RETURN-CODE. */
        ...
        {
            /*" -674- MOVE '0100' TO WNR-EXEC-SQL. */
            _.Move("0100", WABEND.WNR_EXEC_SQL);

            /*" -684- PERFORM R0100_00_SELECT_V0SISTEMA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -688- DISPLAY 'R0100 - ERRO NO SELECT DA V0SISTEMA' */
        ...
        {
            /*" -684- EXEC SQL SELECT DTMOVABE - 1 YEAR, DTMOVABE, CURRENT DATE INTO :V0SIST-DTMOVABE-1, :V0SIST-DTMOVABE, :V0SIST-DTCURRENT FROM SEGUROS.V0SISTEMA WHERE IDSISTEM = 'VA' WITH UR END-EXEC. */
        ...
        {
            /*" -715- MOVE '0200' TO WNR-EXEC-SQL. */
            _.Move("0200", WABEND.WNR_EXEC_SQL);

            /*" -721- PERFORM R0200_00_SELECT_V0EMPRESA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -725- DISPLAY 'R0200 - ERRO NO SELECT DA V0EMPRESA' */
        ...
        {
            /*" -721- EXEC SQL SELECT NOME_EMPRESA INTO :V0EMPR-NOME-EMPR FROM SEGUROS.V0EMPRESA WHERE COD_EMPRESA = 0 WITH UR END-EXEC. */
        ...
        {
            /*" -773- MOVE '0400' TO WNR-EXEC-SQL. */
            _.Move("0400", WABEND.WNR_EXEC_SQL);

            /*" -775- PERFORM R0500-00-DECLARE-V0SINISTROS. */

            R0500_00_DECLARE_V0SINISTROS_SECTION();

            /*" -777- PERFORM R0550-00-FETCH-V0SINISTROS. */

            R0550_00_FETCH_V0SINISTROS_SECTION();

            /*" -778- IF WFIM-V0SINISTROS = 'S' */

            if (AREA_DE_WORK.WFIM_V0SINISTROS == "S")
            {

                /*" -779- PERFORM R9900-00-ENCERRA-SEM-MOVTO */
            ...
            else
            {
                ...
                /*" -782- PERFORM R0600-00-PROCESSA-SINISTROS UNTIL WFIM-V0SINISTROS NOT EQUAL SPACES. */
        ...
        {
            /*" -795- MOVE '0500' TO WNR-EXEC-SQL. */
            _.Move("0500", WABEND.WNR_EXEC_SQL);

            /*" -810- PERFORM R0500_00_DECLARE_V0SINISTROS_DB_DECLARE_1 */

            R0500_00_DECLARE_V0SINISTROS_DB_DECLARE_1();

            /*" -812- PERFORM R0500_00_DECLARE_V0SINISTROS_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -816- DISPLAY 'R0500 - ERRO NO DECLARE DA V0SINISTROS' */
            ...
            else
            {
                ...
                /*" -818- MOVE SPACES TO WFIM-V0SINISTROS. */
        ...
        {
            /*" -810- EXEC SQL DECLARE V0SINISTROS CURSOR FOR SELECT NUM_APOL_SINISTRO, COD_OPERACAO , OCORR_HISTORICO , NOME_FAVORECIDO , DATA_MOVIMENTO , SIT_CONTABIL , VAL_OPERACAO FROM SEGUROS.SINISTRO_HISTORICO WHERE DATA_MOVIMENTO BETWEEN :WHOST-DTH-INI AND :WHOST-DTH-FIM AND COD_OPERACAO IN (107, 108, 117, 117) ORDER BY DATA_MOVIMENTO WITH UR END-EXEC. */
            V0SINISTROS = new VA0956B_V0SINISTROS(true);
        ...
        {
            /*" -812- EXEC SQL OPEN V0SINISTROS END-EXEC. */
        ...
        {
            /*" -1768- EXEC SQL DECLARE C_SINISACO CURSOR FOR SELECT B.COD_OPERACAO , B.DESCR_OPERACAO FROM SEGUROS.SINISTRO_ACOMPANHA A, SEGUROS.CODIGO_OPERACAO B WHERE A.COD_FONTE = :V0MSIN-FONTE AND A.NUM_PROTOCOLO_SINI = :V0MSIN-PROTSINI AND B.COD_OPERACAO = A.COD_OPERACAO AND A.COD_OPERACAO IN (720, 1244, 1245, 1246, 1247, 1248, 675, 704, 1004, 1179, 1180) ORDER BY A.DATA_OPERACAO DESC WITH UR END-EXEC. */
            C_SINISACO = new VA0956B_C_SINISACO(true);
        ...
        {
            /*" -831- MOVE '0550' TO WNR-EXEC-SQL. */
            _.Move("0550", WABEND.WNR_EXEC_SQL);

            /*" -839- PERFORM R0550_00_FETCH_V0SINISTROS_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -843- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -844- MOVE 'S' TO WFIM-V0SINISTROS */
                    _.Move("S", AREA_DE_WORK.WFIM_V0SINISTROS);

                    /*" -844- PERFORM R0550_00_FETCH_V0SINISTROS_DB_CLOSE_1 */
                ...
                else
                {
                    ...
                    /*" -847- DISPLAY 'R0550 - ERRO NO FETCH DA V0SINISTROS' */
        ...
        {
            /*" -839- EXEC SQL FETCH V0SINISTROS INTO :SINISHIS-NUM-APOL-SINISTRO, :SINISHIS-COD-OPERACAO , :SINISHIS-OCORR-HISTORICO, :SINISHIS-NOME-FAVORECIDO, :SINISHIS-DATA-MOVIMENTO, :SINISHIS-SIT-CONTABIL, :SINISHIS-VAL-OPERACAO END-EXEC. */
        ...
        {
            /*" -844- EXEC SQL CLOSE V0SINISTROS END-EXEC */
        ...
        {
            /*" -878- PERFORM R0550-00-FETCH-V0SINISTROS. */
        ...
        {
            /*" -891- MOVE '0700' TO WNR-EXEC-SQL. */
            _.Move("0700", WABEND.WNR_EXEC_SQL);

            /*" -892- IF SORT-RETURN NOT EQUAL ZEROS */

            if (SORT_RETURN != 00)
            {

                /*" -893- DISPLAY 'R0700 - ERRO NO ARQUIVO DO SORT' */
                _.Display($"R0700 - ERRO NO ARQUIVO DO SORT");

                /*" -894- DISPLAY 'SORT-RETURN - ' SORT-RETURN */
                _.Display($"SORT-RETURN - {SORT_RETURN}");

                /*" -896- GO TO R9999-00-ROT-ERRO. */
            ...
            /*" -898- INITIALIZE TABELA-SINI-PENDT. */
            _.Initialize(
                W_TABELAS.TABELA_SINI_PENDT
            );

            /*" -900- PERFORM R0750-00-LER-ARQSORT. */

            R0750_00_LER_ARQSORT_SECTION();

            /*" -902- IF WFIM-ARQSORT NOT EQUAL SPACES NEXT SENTENCE */
            ...
            else
            {
                ...
                /*" -904- PERFORM R0800-00-PROCESSA-PENDENTE UNTIL WFIM-ARQSORT NOT EQUAL SPACES. */
        ...
        {
            /*" -916- MOVE '0750' TO WNR-EXEC-SQL. */
            _.Move("0750", WABEND.WNR_EXEC_SQL);

            /*" -918- RETURN ARQSORT AT END */
            try
            {
                ARQSORT.Return(REG_ARQSORT, () =>
                {

                    /*" -919- MOVE 'S' TO WFIM-ARQSORT */
                    _.Move("S", AREA_DE_WORK.WFIM_ARQSORT);

                    /*" -921- GO TO R0750-99-SAIDA. */
        ...
        {
            /*" -934- MOVE '0800' TO WNR-EXEC-SQL. */
            _.Move("0800", WABEND.WNR_EXEC_SQL);

            /*" -936- MOVE SD-TIP-PEND TO WTIP-PEND-ANT. */
            _.Move(REG_ARQSORT.SD_TIP_PEND, AREA_DE_WORK.WTIP_PEND_ANT);

            /*" -938- PERFORM R0900-00-PROCESSA-TIPO-PEND UNTIL WFIM-ARQSORT NOT EQUAL SPACES OR SD-TIP-PEND NOT EQUAL WTIP-PEND-ANT. */
        ...
        {
            /*" -951- MOVE '0900' TO WNR-EXEC-SQL. */
            _.Move("0900", WABEND.WNR_EXEC_SQL);

            /*" -953- MOVE SD-RAMO-CBT TO WCOD-RAMO-ANT. */
            _.Move(REG_ARQSORT.SD_RAMO_CBT, AREA_DE_WORK.WCOD_RAMO_ANT);

            /*" -956- PERFORM R1000-00-PROCESSA-RAMO-COBT UNTIL WFIM-ARQSORT NOT EQUAL SPACES OR SD-TIP-PEND NOT EQUAL WTIP-PEND-ANT OR SD-RAMO-CBT NOT EQUAL WCOD-RAMO-ANT. */
        ...
        {
            /*" -969- MOVE '1000' TO WNR-EXEC-SQL. */
            _.Move("1000", WABEND.WNR_EXEC_SQL);

            /*" -971- MOVE SD-NUM-SINI TO V0MSIN-NUM-SINI. */
            _.Move(REG_ARQSORT.SD_NUM_SINI, V0MSIN_NUM_SINI);

            /*" -973- PERFORM R1100-00-SELECT-V0MESTSINI. */

            R1100_00_SELECT_V0MESTSINI_SECTION();

            /*" -974- IF WTEM-SINISMES EQUAL 'NAO' */

            if (AREA_DE_WORK.WTEM_SINISMES == "NAO")
            {

                /*" -976- GO TO R1000-90-LER-REGISTRO. */
            ...
            /*" -978- PERFORM R1200-00-SELECT-V0HISTSINI. */

            R1200_00_SELECT_V0HISTSINI_SECTION();

            /*" -980- PERFORM R1205-00-SELECT-V0HISTSINI. */

            R1205_00_SELECT_V0HISTSINI_SECTION();

            /*" -982- PERFORM R1206-00-SELECT-V0HISTSINI. */

            R1206_00_SELECT_V0HISTSINI_SECTION();

            /*" -984- PERFORM R1207-00-SELECT-V0HISTSINI. */

            R1207_00_SELECT_V0HISTSINI_SECTION();

            /*" -985- IF V0MSIN-NRCERTIF > 0 */

            if (V0MSIN_NRCERTIF > 0)
            {

                /*" -986- PERFORM R1210-00-SELECT-SEGURVGA */

                R1210_00_SELECT_SEGURVGA_SECTION();

                /*" -987- IF WTEM-SEGURVGA EQUAL 'NAO' */

                if (AREA_DE_WORK.WTEM_SEGURVGA == "NAO")
                {

                    /*" -988- GO TO R1000-90-LER-REGISTRO */
            ...
            else
            {
                ...
                /*" -991- PERFORM R1215-00-SELECT-BILHETE */

                R1215_00_SELECT_BILHETE_SECTION();

                /*" -992- IF WTEM-BILHETE EQUAL 'NAO' */

                if (AREA_DE_WORK.WTEM_BILHETE == "NAO")
                {

                    /*" -993- GO TO R1000-90-LER-REGISTRO */
            ...
            /*" -998- PERFORM R1220-00-SELECT-ENDOSSOS */

            R1220_00_SELECT_ENDOSSOS_SECTION();

            /*" -998- PERFORM R1400-00-GRAVA-ARQV-AUDTSINI. */
        ...
        {
            /*" -1002- PERFORM R0750-00-LER-ARQSORT. */
        ...
        {
            /*" -1013- MOVE '1100' TO WNR-EXEC-SQL. */
            _.Move("1100", WABEND.WNR_EXEC_SQL);

            /*" -1016- MOVE 'SIM' TO WTEM-SINISMES */
            _.Move("SIM", AREA_DE_WORK.WTEM_SINISMES);

            /*" -1044- PERFORM R1100_00_SELECT_V0MESTSINI_DB_SELECT_1 */

            R1100_00_SELECT_V0MESTSINI_DB_SELECT_1();

            /*" -1047- IF SQLCODE NOT EQUAL ZEROS AND 100 */

            if (!DB.SQLCODE.In("00", "100"))
            {

                /*" -1048- DISPLAY 'R1100 - ERRO NO SELECT DA V0MESTSINI' */
                _.Display($"R1100 - ERRO NO SELECT DA V0MESTSINI");

                /*" -1049- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -1053- MOVE 'NAO' TO WTEM-SINISMES */
            ...
            /*" -1057- IF V0MSIN-RAMO = 77 OR 81 OR 82 OR 93 OR 97 NEXT SENTENCE */
            ...
            else
            {
                ...
                /*" -1059- MOVE 'NAO' TO WTEM-SINISMES */
                _.Move("NAO", AREA_DE_WORK.WTEM_SINISMES);
        ...
        {
            /*" -1072- MOVE '1200' TO WNR-EXEC-SQL. */
            _.Move("1200", WABEND.WNR_EXEC_SQL);

            /*" -1079- PERFORM R1200_00_SELECT_V0HISTSINI_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1084- MOVE ZEROS TO V0HSIN-VAL-OPERACAO */
                ...
                else
                {
                    ...
                    /*" -1086- DISPLAY 'R1200 - ERRO NO SELECT DA V0HISTSINI' */
                    _.Display($"R1200 - ERRO NO SELECT DA V0HISTSINI");

                    /*" -1087- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
        ...
        {
            /*" -1079- EXEC SQL SELECT VAL_OPERACAO INTO :V0HSIN-VAL-OPERACAO FROM SEGUROS.V0HISTSINI WHERE NUM_APOL_SINISTRO = :V0MSIN-NUM-SINI AND OPERACAO = 101 WITH UR END-EXEC. */
        ...
        private void R1205_00_SELECT_V0HISTSINI_SECTION()
        {
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                else
                {
                    ...
                    /*" -1118- DISPLAY 'R1205 - ERRO NO SELECT DA V0HISTSINI' */
                    _.Display($"R1205 - ERRO NO SELECT DA V0HISTSINI");

                    /*" -1119- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1122- IF VIND-CODUSU-PRE LESS +0 */

            if (VIND_CODUSU_PRE < +0)
            {

                /*" -1123- MOVE SPACES TO V0HSIN-CODUSU-PRE */
                _.Move("", V0HSIN_CODUSU_PRE);
        ...
        {
            /*" -1111- EXEC SQL SELECT MAX(CODUSU) INTO :V0HSIN-CODUSU-PRE:VIND-CODUSU-PRE FROM SEGUROS.V0HISTSINI WHERE NUM_APOL_SINISTRO = :SINISHIS-NUM-APOL-SINISTRO AND OCORHIST = :SINISHIS-OCORR-HISTORICO AND OPERACAO IN (1181, 1182, 1183) WITH UR END-EXEC. */
        ...
        {
            /*" -1136- MOVE '1206' TO WNR-EXEC-SQL. */
            _.Move("1206", WABEND.WNR_EXEC_SQL);

            /*" -1144- PERFORM R1206_00_SELECT_V0HISTSINI_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1149- MOVE SPACES TO V0HSIN-CODUSU-LIB */
                ...
                else
                {
                    ...
                    /*" -1151- DISPLAY 'R1206 - ERRO NO SELECT DA V0HISTSINI' */
                    _.Display($"R1206 - ERRO NO SELECT DA V0HISTSINI");

                    /*" -1152- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");

                    /*" -1154- GO TO R9999-00-ROT-ERRO. */
            ...
            /*" -1155- IF VIND-CODUSU-LIB LESS +0 */

            if (VIND_CODUSU_LIB < +0)
            {

                /*" -1156- MOVE SPACES TO V0HSIN-CODUSU-LIB */
                _.Move("", V0HSIN_CODUSU_LIB);
        ...
        {
            /*" -1144- EXEC SQL SELECT MAX(CODUSU) INTO :V0HSIN-CODUSU-LIB:VIND-CODUSU-LIB FROM SEGUROS.V0HISTSINI WHERE NUM_APOL_SINISTRO = :SINISHIS-NUM-APOL-SINISTRO AND OCORHIST = :SINISHIS-OCORR-HISTORICO AND OPERACAO IN (1081, 1082, 1083, 1084) WITH UR END-EXEC. */
        ...
        {
            /*" -1169- MOVE '1207' TO WNR-EXEC-SQL. */
            _.Move("1207", WABEND.WNR_EXEC_SQL);

            /*" -1171- MOVE SD-DTMOVTO TO SINISHIS-DATA-MOVIMENTO */
            _.Move(REG_ARQSORT.SD_DTMOVTO, SINISHIS.DCLSINISTRO_HISTORICO.SINISHIS_DATA_MOVIMENTO);

            /*" -1180- PERFORM R1207_00_SELECT_V0HISTSINI_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1184- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1185- MOVE ZEROS TO V0HSIN-VAL-JURO */
                ...
                else
                {
                    ...
                    /*" -1187- DISPLAY 'R1207 - ERRO NO SELECT V0HISTSINI   ' */
                    _.Display($"R1207 - ERRO NO SELECT V0HISTSINI   ");

                    /*" -1188- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1191- IF VIND-VAL-JURO LESS +0 */

            if (VIND_VAL_JURO < +0)
            {

                /*" -1192- MOVE ZEROS TO V0HSIN-VAL-JURO */
                _.Move(0, V0HSIN_VAL_JURO);
        ...
        {
            /*" -1180- EXEC SQL SELECT SUM(VAL_OPERACAO) INTO :V0HSIN-VAL-JURO:VIND-VAL-JURO FROM SEGUROS.V0HISTSINI WHERE NUM_APOL_SINISTRO = :SINISHIS-NUM-APOL-SINISTRO AND OCORHIST = :SINISHIS-OCORR-HISTORICO AND DTMOVTO = :SINISHIS-DATA-MOVIMENTO AND OPERACAO IN (1301, 1302) WITH UR END-EXEC. */
        ...
        {
            /*" -1204- MOVE '1210' TO WNR-EXEC-SQL. */
            _.Move("1210", WABEND.WNR_EXEC_SQL);

            /*" -1206- MOVE 'SIM' TO WTEM-SEGURVGA */
            _.Move("SIM", AREA_DE_WORK.WTEM_SEGURVGA);

            /*" -1231- PERFORM R1210_00_SELECT_SEGURVGA_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1236- MOVE 'NAO' TO WTEM-SEGURVGA */
                    _.Move("NAO", AREA_DE_WORK.WTEM_SEGURVGA);

                    /*" -1237- GO TO R1210-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -1239- DISPLAY 'R1210 - ERRO NO SELECT DA SEGURADOS_VGAP' */
                    _.Display($"R1210 - ERRO NO SELECT DA SEGURADOS_VGAP");

                    /*" -1240- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1245- MOVE '1211' TO WNR-EXEC-SQL. */
            _.Move("1211", WABEND.WNR_EXEC_SQL);

            /*" -1247- INITIALIZE DCLCLIENTES. */
            _.Initialize(
                CLIENTES.DCLCLIENTES
            );

            /*" -1255- PERFORM R1210_00_SELECT_SEGURVGA_DB_SELECT_2 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                else
                {
                    ...
                    /*" -1262- DISPLAY 'R1210 - ERRO NO SELECT DA CLIENTES      ' */
                    _.Display($"R1210 - ERRO NO SELECT DA CLIENTES      ");

                    /*" -1263- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1268- MOVE '1212' TO WNR-EXEC-SQL. */
            _.Move("1212", WABEND.WNR_EXEC_SQL);

            /*" -1270- INITIALIZE DCLENDERECOS. */
            _.Initialize(
                ENDERECO.DCLENDERECOS
            );

            /*" -1283- PERFORM R1210_00_SELECT_SEGURVGA_DB_SELECT_3 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1287- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1288- GO TO R1210-99-SAIDA */
                    /*Método Suprimido por falta de linha ou apenas EXIT nome: R1210_99_SAIDA*/ //GOTO
                    return;
                ...
                else
                {
                    ...
                    /*" -1290- DISPLAY 'R1210 - ERRO NO SELECT DA ENDERECO      ' */
                    _.Display($"R1210 - ERRO NO SELECT DA ENDERECO      ");

                    /*" -1291- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1296- MOVE '1213' TO WNR-EXEC-SQL. */
            _.Move("1213", WABEND.WNR_EXEC_SQL);

            /*" -1298- INITIALIZE DCLPROPOSTAS-VA. */
            _.Initialize(
                PROPOVA.DCLPROPOSTAS_VA
            );

            /*" -1300- MOVE 'SIM' TO WTEM-PROPOVA */
            _.Move("SIM", AREA_DE_WORK.WTEM_PROPOVA);

            /*" -1310- PERFORM R1210_00_SELECT_SEGURVGA_DB_SELECT_4 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1314- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1315- MOVE 'NAO' TO WTEM-PROPOVA */
                    _.Move("NAO", AREA_DE_WORK.WTEM_PROPOVA);

                    /*" -1316- GO TO R1210-99-SAIDA */
                    /*Método Suprimido por falta de linha ou apenas EXIT nome: R1210_99_SAIDA*/ //GOTO
                    return;
                ...
                else
                {
                    ...
                    /*" -1318- DISPLAY 'R1210 - ERRO NO SELECT DA ENDERECO      ' */
                    _.Display($"R1210 - ERRO NO SELECT DA ENDERECO      ");

                    /*" -1319- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
        ...
        {
            /*" -1255- EXEC SQL SELECT NOME_RAZAO, CGCCPF INTO :CLIENTES-NOME-RAZAO, :CLIENTES-CGCCPF FROM SEGUROS.CLIENTES WHERE COD_CLIENTE = :SEGURVGA-COD-CLIENTE WITH UR END-EXEC. */
        ...
        {
            /*" -1332- MOVE '1215' TO WNR-EXEC-SQL. */
            _.Move("1215", WABEND.WNR_EXEC_SQL);

            /*" -1334- MOVE 'SIM' TO WTEM-BILHETE */
            _.Move("SIM", AREA_DE_WORK.WTEM_BILHETE);

            /*" -1356- PERFORM R1215_00_SELECT_BILHETE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1361- MOVE 'NAO' TO WTEM-BILHETE */
                    _.Move("NAO", AREA_DE_WORK.WTEM_BILHETE);

                    /*" -1362- GO TO R1215-99-SAIDA */
                ...
                else
                {
                    ...
                    /*" -1364- DISPLAY 'R1215 - ERRO NO SELECT DA BILHETE       ' */
                    _.Display($"R1215 - ERRO NO SELECT DA BILHETE       ");

                    /*" -1365- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1370- MOVE '1216' TO WNR-EXEC-SQL. */
            _.Move("1216", WABEND.WNR_EXEC_SQL);

            /*" -1372- INITIALIZE DCLCLIENTES. */
            _.Initialize(
                CLIENTES.DCLCLIENTES
            );

            /*" -1380- PERFORM R1215_00_SELECT_BILHETE_DB_SELECT_2 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                else
                {
                    ...
                    /*" -1387- DISPLAY 'R1215 - ERRO NO SELECT DA CLIENTES      ' */
                    _.Display($"R1215 - ERRO NO SELECT DA CLIENTES      ");

                    /*" -1388- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");

                    /*" -1390- GO TO R9999-00-ROT-ERRO. */
            ...
            /*" -1393- MOVE '1217' TO WNR-EXEC-SQL. */
            _.Move("1217", WABEND.WNR_EXEC_SQL);

            /*" -1395- INITIALIZE DCLENDERECOS. */
            _.Initialize(
                ENDERECO.DCLENDERECOS
            );

            /*" -1408- PERFORM R1215_00_SELECT_BILHETE_DB_SELECT_3 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1412- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1413- GO TO R1215-99-SAIDA */
                    /*Método Suprimido por falta de linha ou apenas EXIT nome: R1215_99_SAIDA*/ //GOTO
                    return;
                ...
                else
                {
                    ...
                    /*" -1415- DISPLAY 'R1210 - ERRO NO SELECT DA ENDERECO      ' */
                    _.Display($"R1210 - ERRO NO SELECT DA ENDERECO      ");

                    /*" -1416- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
        ...
        {
            /*" -1283- EXEC SQL SELECT BAIRRO, CIDADE, SIGLA_UF, CEP INTO :ENDERECO-BAIRRO, :ENDERECO-CIDADE, :ENDERECO-SIGLA-UF, :ENDERECO-CEP FROM SEGUROS.ENDERECOS WHERE COD_CLIENTE = :SEGURVGA-COD-CLIENTE AND OCORR_ENDERECO = :SEGURVGA-OCORR-ENDERECO WITH UR END-EXEC. */
        ...
        {
            /*" -1380- EXEC SQL SELECT NOME_RAZAO, CGCCPF INTO :CLIENTES-NOME-RAZAO, :CLIENTES-CGCCPF FROM SEGUROS.CLIENTES WHERE COD_CLIENTE = :SEGURVGA-COD-CLIENTE WITH UR END-EXEC. */
        ...
        {
            /*" -1408- EXEC SQL SELECT BAIRRO, CIDADE, SIGLA_UF, CEP INTO :ENDERECO-BAIRRO, :ENDERECO-CIDADE, :ENDERECO-SIGLA-UF, :ENDERECO-CEP FROM SEGUROS.ENDERECOS WHERE COD_CLIENTE = :SEGURVGA-COD-CLIENTE AND OCORR_ENDERECO = :SEGURVGA-OCORR-ENDERECO WITH UR END-EXEC. */
        ...
        {
            /*" -1310- EXEC SQL SELECT NUM_MATRI_VENDEDOR, COD_PRODUTO, AGE_COBRANCA INTO :PROPOVA-NUM-MATRI-VENDEDOR, :PROPOVA-COD-PRODUTO, :PROPOVA-AGE-COBRANCA FROM SEGUROS.PROPOSTAS_VA WHERE NUM_CERTIFICADO = :SEGURVGA-NUM-CERTIFICADO WITH UR END-EXEC. */
        ...
        {
            /*" -1431- MOVE '1220' TO WNR-EXEC-SQL. */
            _.Move("1220", WABEND.WNR_EXEC_SQL);

            /*" -1440- PERFORM R1220_00_SELECT_ENDOSSOS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1444- DISPLAY 'R1220 - ERRO NO SELECT DA ENDOSSOS          ' */
                _.Display($"R1220 - ERRO NO SELECT DA ENDOSSOS          ");

                /*" -1445- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");

                /*" -1445- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -1440- EXEC SQL SELECT COD_PRODUTO , DATA_TERVIGENCIA INTO :ENDOSSOS-COD-PRODUTO , :ENDOSSOS-DATA-TERVIGENCIA FROM SEGUROS.ENDOSSOS WHERE NUM_APOLICE = :SEGURVGA-NUM-APOLICE AND NUM_ENDOSSO = 0 WITH UR END-EXEC. */
        ...
        {
            /*" -1458- MOVE '1400' TO WNR-EXEC-SQL. */
            _.Move("1400", WABEND.WNR_EXEC_SQL);

            /*" -1460- INITIALIZE WREG-AUDTSINI. */
            _.Initialize(
                WREG_AUDTSINI
            );

            /*" -1461- MOVE V0MSIN-FONTE TO REG-FONTE */
            _.Move(V0MSIN_FONTE, WREG_AUDTSINI.REG_FONTE);

            /*" -1462- PERFORM R1410-00-SELECT-FONTES */

            R1410_00_SELECT_FONTES_SECTION();

            /*" -1464- MOVE FONTES-NOME-FONTE TO REG-NOME-FONTE. */
            _.Move(FONTES.DCLFONTES.FONTES_NOME_FONTE, WREG_AUDTSINI.REG_NOME_FONTE);

            /*" -1465- IF WTEM-PROPOVA EQUAL 'SIM' */

            if (AREA_DE_WORK.WTEM_PROPOVA == "SIM")
            {

                /*" -1466- MOVE PROPOVA-AGE-COBRANCA TO WHOST-AGE-COBRANCA */
                _.Move(PROPOVA.DCLPROPOSTAS_VA.PROPOVA_AGE_COBRANCA, WHOST_AGE_COBRANCA);

                /*" -1468- MOVE PROPOVA-NUM-MATRI-VENDEDOR TO REG-NRMATRVEN */
            ...
            else
            {
                ...
                /*" -1470- MOVE SEGURVGA-AGE-COBRANCA TO WHOST-AGE-COBRANCA */
                _.Move(SEGURVGA.DCLSEGURADOS_VGAP.SEGURVGA_AGE_COBRANCA, WHOST_AGE_COBRANCA);

                /*" -1472- MOVE SEGURVGA-NUM-MATRICULA TO REG-NRMATRVEN */
            ...
            else
            {
                ...
                /*" -1528- MOVE ENDOSSOS-COD-PRODUTO TO REG-PRODUTO WHOST-COD-PRODUTO */
            ...
            if (REG_ARQSORT.SD_SIT_CONT == "1")
            {
                ...
                /*" -1555- PERFORM R1500-00-SELECT-SISINCHE */

                R1500_00_SELECT_SISINCHE_SECTION();

                /*" -1557- MOVE SISINCHE-NUM-CHEQUE-INTERNO TO REG-NUM-CHEQUE */
            ...
            else
            {
                ...
                else
                {
                    ...
                    /*" -1574- IF SD-SIT-CONT EQUAL '5' */

                    if (REG_ARQSORT.SD_SIT_CONT == "5")
                    {

                        /*" -1575- MOVE 'SIVAT ' TO REG-OPCAO-PAG */
                        _.Move("SIVAT ", WREG_AUDTSINI.REG_OPCAO_PAG);

                        /*" -1580- MOVE ZEROS TO REG-NUM-CHEQUE REG-COD-AGENCIA REG-COD-OPERACAO REG-NUM-CONTA REG-DIG-CONTA */
                    ...
                    else
                    {
                        ...
                        /*" -1582- MOVE 'OUTROS' TO REG-OPCAO-PAG */
                        _.Move("OUTROS", WREG_AUDTSINI.REG_OPCAO_PAG);

                        /*" -1587- MOVE ZEROS TO REG-NUM-CHEQUE REG-COD-AGENCIA REG-COD-OPERACAO REG-NUM-CONTA REG-DIG-CONTA */
                        _.Move(0, WREG_AUDTSINI.REG_NUM_CHEQUE, WREG_AUDTSINI.REG_COD_AGENCIA, WREG_AUDTSINI.REG_COD_OPERACAO, WREG_AUDTSINI.REG_NUM_CONTA, WREG_AUDTSINI.REG_DIG_CONTA);
            ...
            /*" -1592- WRITE REG-AUDTSINI FROM WREG-AUDTSINI */
            _.Move(WREG_AUDTSINI.GetMoveValues(), REG_AUDTSINI);

            AUDTSINI.Write(REG_AUDTSINI.GetMoveValues().ToString());

            /*" -1593- IF W-STATUS = ZEROS */

            if (AREA_DE_WORK.W_STATUS == 00)
            {

                /*" -1594- ADD 1 TO AC-G-AUDTSINI */
            ...
            else
            {
                ...
                /*" -1596- DISPLAY 'R1400 - ERRO NO WRITE DO ARQ AUDTSINI' */
                _.Display($"R1400 - ERRO NO WRITE DO ARQ AUDTSINI");

                /*" -1597- DISPLAY 'STATUS   - ' W-STATUS */
                _.Display($"STATUS   - {AREA_DE_WORK.W_STATUS}");

                /*" -1598- DISPLAY 'SINISTRO - ' REG-NUM-SINI */
                _.Display($"SINISTRO - {WREG_AUDTSINI.REG_NUM_SINI}");

                /*" -1599- DISPLAY 'APOLICE  - ' REG-NUM-APOL */
        ...
        {
            /*" -1612- MOVE '1410' TO WNR-EXEC-SQL. */
            _.Move("1410", WABEND.WNR_EXEC_SQL);

            /*" -1618- PERFORM R1410_00_SELECT_FONTES_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1622- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1623- MOVE SPACES TO FONTES-NOME-FONTE */
                ...
                else
                {
                    ...
                    /*" -1625- DISPLAY 'R1410 - ERRO NO SELECT DA FONTES            ' */
                    _.Display($"R1410 - ERRO NO SELECT DA FONTES            ");

                    /*" -1626- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI ' ' V0MSIN-FONTE */
        ...
        {
            /*" -1618- EXEC SQL SELECT NOME_FONTE INTO :FONTES-NOME-FONTE FROM SEGUROS.FONTES WHERE COD_FONTE = :V0MSIN-FONTE WITH UR END-EXEC. */
        ...
        {
            /*" -1639- MOVE '1420' TO WNR-EXEC-SQL. */
            _.Move("1420", WABEND.WNR_EXEC_SQL);

            /*" -1651- PERFORM R1420_00_SELECT_AGENCCEF_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1656- MOVE ZEROS TO AGENCCEF-COD-ESCNEG */
                    _.Move(0, AGENCCEF.DCLAGENCIAS_CEF.AGENCCEF_COD_ESCNEG);

                    /*" -1658- MOVE SPACES TO ESCRINEG-REGIAO-ESCNEG AGENCCEF-NOME-AGENCIA */
                ...
                else
                {
                    ...
                    /*" -1660- DISPLAY 'R1420 - ERRO NO SELECT DA AGENCCEF          ' */
                    _.Display($"R1420 - ERRO NO SELECT DA AGENCCEF          ");

                    /*" -1661- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI ' ' V0MSIN-FONTE */
        ...
        {
            /*" -1651- EXEC SQL SELECT A.NOME_AGENCIA, A.COD_ESCNEG, B.REGIAO_ESCNEG INTO :AGENCCEF-NOME-AGENCIA, :AGENCCEF-COD-ESCNEG, :ESCRINEG-REGIAO-ESCNEG FROM SEGUROS.AGENCIAS_CEF A, SEGUROS.ESCRITORIO_NEGOCIO B WHERE A.COD_AGENCIA = :WHOST-AGE-COBRANCA AND B.COD_ESCNEG = A.COD_ESCNEG WITH UR END-EXEC. */
        ...
        {
            /*" -1674- MOVE '1430' TO WNR-EXEC-SQL. */
            _.Move("1430", WABEND.WNR_EXEC_SQL);

            /*" -1681- PERFORM R1430_00_SELECT_SINISCAU_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1685- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1686- MOVE SPACES TO SINISCAU-DESCR-CAUSA */
                ...
                else
                {
                    ...
                    /*" -1688- DISPLAY 'R1430 - ERRO NO SELECT DA SINISCAU          ' */
                    _.Display($"R1430 - ERRO NO SELECT DA SINISCAU          ");

                    /*" -1689- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI ' ' V0MSIN-CODCAU */
        ...
        {
            /*" -1681- EXEC SQL SELECT DESCR_CAUSA INTO :SINISCAU-DESCR-CAUSA FROM SEGUROS.SINISTRO_CAUSA WHERE RAMO_EMISSOR = :V0MSIN-RAMO AND COD_CAUSA = :V0MSIN-CODCAU WITH UR END-EXEC. */
        ...
        {
            /*" -1702- MOVE '1440' TO WNR-EXEC-SQL. */
            _.Move("1440", WABEND.WNR_EXEC_SQL);

            /*" -1709- PERFORM R1440_00_SELECT_PRODUVG_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1713- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1719- PERFORM R1440_00_SELECT_PRODUVG_DB_SELECT_2 */
                    ...
                    if (DB.SQLCODE != 00)
                    {
                        ...
                        if (DB.SQLCODE == 100)
                        {
                            ...
                            /*" -1723- MOVE SPACES TO PRODUVG-NOME-PRODUTO */
                        ...
                        else
                        {
                            ...
                            /*" -1725- DISPLAY 'R1440 - ERRO NO SELECT DA PRODUTO 1 ' */
                            _.Display($"R1440 - ERRO NO SELECT DA PRODUTO 1 ");

                            /*" -1726- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                            _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
                ...
                else
                {
                    ...
                    /*" -1732- DISPLAY 'R1440 - ERRO NO SELECT DA PRODUTO           ' */
                    _.Display($"R1440 - ERRO NO SELECT DA PRODUTO           ");

                    /*" -1733- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
        ...
        {
            /*" -1709- EXEC SQL SELECT NOME_PRODUTO INTO :PRODUVG-NOME-PRODUTO FROM SEGUROS.PRODUTOS_VG WHERE NUM_APOLICE = :SEGURVGA-NUM-APOLICE AND COD_SUBGRUPO = :SEGURVGA-COD-SUBGRUPO WITH UR END-EXEC. */
        ...
        {
            /*" -1719- EXEC SQL SELECT DESCR_PRODUTO INTO :PRODUVG-NOME-PRODUTO FROM SEGUROS.PRODUTO WHERE COD_PRODUTO = :WHOST-COD-PRODUTO WITH UR END-EXEC */
        ...
        {
            /*" -1746- MOVE '1450' TO WNR-EXEC-SQL. */
            _.Move("1450", WABEND.WNR_EXEC_SQL);

            /*" -1768- PERFORM R1450_00_SELECT_SINISACO_DB_DECLARE_1 */

            R1450_00_SELECT_SINISACO_DB_DECLARE_1();

            /*" -1770- PERFORM R1450_00_SELECT_SINISACO_DB_OPEN_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1774- DISPLAY 'R1450 - ERRO NO OPEN C_SINISACO            ' */
                _.Display($"R1450 - ERRO NO OPEN C_SINISACO            ");

                /*" -1775- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1780- MOVE '1451' TO WNR-EXEC-SQL. */
            _.Move("1451", WABEND.WNR_EXEC_SQL);

            /*" -1783- PERFORM R1450_00_SELECT_SINISACO_DB_FETCH_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == 100)
                {
                    ...
                    /*" -1788- MOVE ZEROS TO CODIGOPE-COD-OPERACAO */
                    _.Move(0, CODIGOPE.DCLCODIGO_OPERACAO.CODIGOPE_COD_OPERACAO);

                    /*" -1789- MOVE SPACES TO CODIGOPE-DESCR-OPERACAO */
                ...
                else
                {
                    ...
                    /*" -1791- DISPLAY 'R1450 - ERRO NO SELECT DA SINISACO          ' */
                    _.Display($"R1450 - ERRO NO SELECT DA SINISACO          ");

                    /*" -1792- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1794- PERFORM R1450_00_SELECT_SINISACO_DB_CLOSE_1 */
        ...
        {
            /*" -1770- EXEC SQL OPEN C_SINISACO END-EXEC. */
        ...
        {
            /*" -1783- EXEC SQL FETCH C_SINISACO INTO :CODIGOPE-COD-OPERACAO, :CODIGOPE-DESCR-OPERACAO END-EXEC. */
        ...
        {
            /*" -1794- EXEC SQL CLOSE C_SINISACO END-EXEC. */
        ...
        {
            /*" -1807- MOVE '1500' TO WNR-EXEC-SQL. */
            _.Move("1500", WABEND.WNR_EXEC_SQL);

            /*" -1810- MOVE SD-NUM-SINI TO SINISHIS-NUM-APOL-SINISTRO */
            _.Move(REG_ARQSORT.SD_NUM_SINI, SINISHIS.DCLSINISTRO_HISTORICO.SINISHIS_NUM_APOL_SINISTRO);

            /*" -1813- MOVE SD-COD-OPER TO SINISHIS-COD-OPERACAO */
            _.Move(REG_ARQSORT.SD_COD_OPER, SINISHIS.DCLSINISTRO_HISTORICO.SINISHIS_COD_OPERACAO);

            /*" -1816- MOVE SD-OCORHIST TO SINISHIS-OCORR-HISTORICO */
            _.Move(REG_ARQSORT.SD_OCORHIST, SINISHIS.DCLSINISTRO_HISTORICO.SINISHIS_OCORR_HISTORICO);

            /*" -1824- PERFORM R1500_00_SELECT_SISINCHE_DB_SELECT_1 */

            R1500_00_SELECT_SISINCHE_DB_SELECT_1();

            /*" -1827- IF SQLCODE NOT EQUAL ZEROS */

            if (DB.SQLCODE != 00)
            {

                /*" -1828- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1829- MOVE ZEROS TO SISINCHE-NUM-CHEQUE-INTERNO */
                ...
                else
                {
                    ...
                    /*" -1831- DISPLAY 'R1500 - ERRO NO SELECT DA SISINCHE  ' */
                    _.Display($"R1500 - ERRO NO SELECT DA SISINCHE  ");

                    /*" -1832- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");

                    /*" -1832- GO TO R9999-00-ROT-ERRO. */
        ...
        {
            /*" -1824- EXEC SQL SELECT NUM_CHEQUE_INTERNO INTO :SISINCHE-NUM-CHEQUE-INTERNO FROM SEGUROS.SI_SINI_CHEQUE WHERE NUM_APOL_SINISTRO = :SINISHIS-NUM-APOL-SINISTRO AND COD_OPERACAO = :SINISHIS-COD-OPERACAO AND OCORR_HISTORICO = :SINISHIS-OCORR-HISTORICO WITH UR END-EXEC. */
        ...
        private void R1600_00_SELECT_MOVDEBCE_SECTION()
        {
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1875- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1876- PERFORM R1500-00-SELECT-SISINCHE */

                    R1500_00_SELECT_SISINCHE_SECTION();

                    /*" -1877- IF SISINCHE-NUM-CHEQUE-INTERNO GREATER 0 */

                    if (SISINCHE.DCLSI_SINI_CHEQUE.SISINCHE_NUM_CHEQUE_INTERNO > 0)
                    {

                        /*" -1878- PERFORM R1700-00-SELECT-MOVDEBCE */
                    ...
                    else
                    {
                        ...
                        /*" -1884- MOVE ZEROS TO MOVDEBCE-COD-AGENCIA-DEB MOVDEBCE-OPER-CONTA-DEB MOVDEBCE-NUM-CONTA-DEB MOVDEBCE-DIG-CONTA-DEB */
                        ...
                        /*" -1886- MOVE 55 TO MOVDEBCE-COD-RETORNO-CEF */
                ...
                else
                {
                    ...
                    /*" -1889- DISPLAY 'R1600 - ERRO NO SELECT DA MOVDEBCE  ' */
                    _.Display($"R1600 - ERRO NO SELECT DA MOVDEBCE  ");

                    /*" -1890- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1893- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 55 */

            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 55)
            {

                /*" -1894- MOVE SPACES TO REG-DES-RETORNO */
                _.Move("", WREG_AUDTSINI.REG_DES_RETORNO);

                /*" -1895- GO TO R1600-99-SAIDA */
            ...
            /*" -1898- IF VIND-COD-AGENCIA-DEB LESS +0 */

            if (VIND_COD_AGENCIA_DEB < +0)
            {

                /*" -1903- MOVE ZEROS TO MOVDEBCE-COD-AGENCIA-DEB MOVDEBCE-OPER-CONTA-DEB MOVDEBCE-NUM-CONTA-DEB MOVDEBCE-DIG-CONTA-DEB */
                _.Move(0, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_AGENCIA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_OPER_CONTA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_NUM_CONTA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_DIG_CONTA_DEB);

                /*" -1905- MOVE 55 TO MOVDEBCE-COD-RETORNO-CEF */
                _.Move(55, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF);
            ...
            /*" -1908- IF VIND-COD-RETORNO-CEF LESS +0 */

            if (VIND_COD_RETORNO_CEF < +0)
            {

                /*" -1909- MOVE SPACES TO REG-DES-RETORNO */
                _.Move("", WREG_AUDTSINI.REG_DES_RETORNO);
            ...
            else
            {
                ...
                /*" -1911- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 02 */

                if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 02)
                {

                    /*" -1912- MOVE 'CONTA NAO CADASTRADA' TO REG-DES-RETORNO */
                ...
                else
                {
                    ...
                    /*" -1914- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 04 */

                    if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 04)
                    {

                        /*" -1915- MOVE 'OUTRAS RESTRICOES   ' TO REG-DES-RETORNO */
                    ...
                    else
                    {
                        ...
                        /*" -1917- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 10 */

                        if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 10)
                        {

                            /*" -1918- MOVE 'AGENCIA ENCERRADA   ' TO REG-DES-RETORNO */
                        ...
                        else
                        {
                            ...
                            /*" -1920- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 12 */

                            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 12)
                            {

                                /*" -1921- MOVE 'VALOR INVALIDO      ' TO REG-DES-RETORNO */
                            ...
                            else
                            {
                                ...
                                /*" -1923- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 14 */

                                if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 14)
                                {

                                    /*" -1924- MOVE 'AGENCIA INVALIDA    ' TO REG-DES-RETORNO */
                                ...
                                else
                                {
                                    ...
                                    /*" -1926- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 15 */

                                    if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 15)
                                    {

                                        /*" -1927- MOVE 'DV CONTA INVALIDO   ' TO REG-DES-RETORNO */
                                    ...
                                    else
                                    {
                                        ...
                                        /*" -1929- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 18 */

                                        if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 18)
                                        {

                                            /*" -1930- MOVE 'DATA INVALIDA       ' TO REG-DES-RETORNO */
                                        ...
                                        else
                                        {
                                            ...
                                            /*" -1932- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 30 */

                                            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 30)
                                            {

                                                /*" -1933- MOVE 'SEM CONTRATO        ' TO REG-DES-RETORNO */
                                            ...
                                            else
                                            {
                                                ...
                                                /*" -1935- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 96 */

                                                if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 96)
                                                {

                                                    /*" -1936- MOVE 'VALOR ZERADO        ' TO REG-DES-RETORNO */
                                                ...
                                                else
                                                {
                                                    ...
                                                    /*" -1938- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 97 OR 98 */

                                                    if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF.In("97", "98"))
                                                    {

                                                        /*" -1939- MOVE 'CANCELADO           ' TO REG-DES-RETORNO */
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        /*" -1941- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 99 */

                                                        if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 99)
                                                        {

                                                            /*" -1942- MOVE 'ESTORNADO           ' TO REG-DES-RETORNO */
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            /*" -1944- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 99 */

                                                            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 99)
                                                            {

                                                                /*" -1944- MOVE 'OUTROS              ' TO REG-DES-RETORNO. */
        ...
        {
            /*" -1871- EXEC SQL SELECT COD_AGENCIA_DEB, OPER_CONTA_DEB, NUM_CONTA_DEB, DIG_CONTA_DEB, COD_RETORNO_CEF INTO :MOVDEBCE-COD-AGENCIA-DEB:VIND-COD-AGENCIA-DEB, :MOVDEBCE-OPER-CONTA-DEB :VIND-OPER-CONTA-DEB, :MOVDEBCE-NUM-CONTA-DEB :VIND-NUM-CONTA-DEB, :MOVDEBCE-DIG-CONTA-DEB :VIND-DIG-CONTA-DEB, :MOVDEBCE-COD-RETORNO-CEF:VIND-COD-RETORNO-CEF FROM SEGUROS.MOVTO_DEBITOCC_CEF WHERE NUM_APOLICE = :MOVDEBCE-NUM-APOLICE AND NUM_ENDOSSO = :MOVDEBCE-NUM-ENDOSSO AND NUM_PARCELA = :MOVDEBCE-NUM-PARCELA WITH UR END-EXEC. */
        ...
        {
            /*" -1957- MOVE '1600' TO WNR-EXEC-SQL. */
            _.Move("1600", WABEND.WNR_EXEC_SQL);

            /*" -1960- MOVE SISINCHE-NUM-CHEQUE-INTERNO TO MOVDEBCE-NUM-APOLICE */
            _.Move(SISINCHE.DCLSI_SINI_CHEQUE.SISINCHE_NUM_CHEQUE_INTERNO, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_NUM_APOLICE);

            /*" -1964- MOVE ZEROS TO MOVDEBCE-NUM-ENDOSSO MOVDEBCE-NUM-PARCELA */
            _.Move(0, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_NUM_ENDOSSO, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_NUM_PARCELA);

            /*" -1981- PERFORM R1700_00_SELECT_MOVDEBCE_DB_SELECT_1 */

            R1700_00_SELECT_MOVDEBCE_DB_SELECT_1();

            /*" -1984- IF SQLCODE NOT EQUAL ZEROS */

            if (DB.SQLCODE != 00)
            {

                /*" -1985- IF SQLCODE EQUAL 100 */

                if (DB.SQLCODE == 100)
                {

                    /*" -1990- MOVE ZEROS TO MOVDEBCE-COD-AGENCIA-DEB MOVDEBCE-OPER-CONTA-DEB MOVDEBCE-NUM-CONTA-DEB MOVDEBCE-DIG-CONTA-DEB */
                    _.Move(0, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_AGENCIA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_OPER_CONTA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_NUM_CONTA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_DIG_CONTA_DEB);

                    /*" -1992- MOVE 55 TO MOVDEBCE-COD-RETORNO-CEF */
                    _.Move(55, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF);
                ...
                else
                {
                    ...
                    /*" -1994- DISPLAY 'R1600 - ERRO NO SELECT DA MOVDEBCE  ' */
                    _.Display($"R1600 - ERRO NO SELECT DA MOVDEBCE  ");

                    /*" -1995- DISPLAY 'SINISTRO - ' V0MSIN-NUM-SINI */
                    _.Display($"SINISTRO - {V0MSIN_NUM_SINI}");
            ...
            /*" -1998- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 55 */

            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 55)
            {

                /*" -1999- MOVE SPACES TO REG-DES-RETORNO */
                _.Move("", WREG_AUDTSINI.REG_DES_RETORNO);

                /*" -2000- GO TO R1700-99-SAIDA */
            ...
            /*" -2003- IF VIND-COD-AGENCIA-DEB LESS +0 */

            if (VIND_COD_AGENCIA_DEB < +0)
            {

                /*" -2008- MOVE ZEROS TO MOVDEBCE-COD-AGENCIA-DEB MOVDEBCE-OPER-CONTA-DEB MOVDEBCE-NUM-CONTA-DEB MOVDEBCE-DIG-CONTA-DEB */
                _.Move(0, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_AGENCIA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_OPER_CONTA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_NUM_CONTA_DEB, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_DIG_CONTA_DEB);

                /*" -2010- MOVE 55 TO MOVDEBCE-COD-RETORNO-CEF */
                _.Move(55, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF);
            ...
            /*" -2013- IF VIND-COD-RETORNO-CEF LESS +0 */

            if (VIND_COD_RETORNO_CEF < +0)
            {

                /*" -2015- MOVE 55 TO MOVDEBCE-COD-RETORNO-CEF */
                _.Move(55, MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF);
        ...
        {
            /*" -1981- EXEC SQL SELECT COD_AGENCIA_DEB, OPER_CONTA_DEB, NUM_CONTA_DEB, DIG_CONTA_DEB, COD_RETORNO_CEF INTO :MOVDEBCE-COD-AGENCIA-DEB:VIND-COD-AGENCIA-DEB, :MOVDEBCE-OPER-CONTA-DEB :VIND-OPER-CONTA-DEB, :MOVDEBCE-NUM-CONTA-DEB :VIND-NUM-CONTA-DEB, :MOVDEBCE-DIG-CONTA-DEB :VIND-DIG-CONTA-DEB, :MOVDEBCE-COD-RETORNO-CEF:VIND-COD-RETORNO-CEF FROM SEGUROS.MOVTO_DEBITOCC_CEF WHERE NUM_APOLICE = :MOVDEBCE-NUM-APOLICE AND NUM_ENDOSSO = :MOVDEBCE-NUM-ENDOSSO AND NUM_PARCELA = :MOVDEBCE-NUM-PARCELA WITH UR END-EXEC. */
        ...
        {
            /*" -2027- IF VIND-COD-RETORNO-CEF LESS +0 */

            if (VIND_COD_RETORNO_CEF < +0)
            {

                /*" -2028- MOVE SPACES TO REG-DES-RETORNO */
                _.Move("", WREG_AUDTSINI.REG_DES_RETORNO);
            ...
            else
            {
                ...
                /*" -2030- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 00 */

                if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 00)
                {

                    /*" -2031- MOVE 'EFETUADO            ' TO REG-DES-RETORNO */
                ...
                else
                {
                    ...
                    /*" -2033- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 02 */

                    if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 02)
                    {

                        /*" -2034- MOVE 'CONTA NAO CADASTRADA' TO REG-DES-RETORNO */
                        _.Move("CONTA NAO CADASTRADA", WREG_AUDTSINI.REG_DES_RETORNO);
                    ...
                    else
                    {
                        ...
                        /*" -2036- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 04 */

                        if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 04)
                        {

                            /*" -2037- MOVE 'OUTRAS RESTRICOES   ' TO REG-DES-RETORNO */
                            _.Move("OUTRAS RESTRICOES   ", WREG_AUDTSINI.REG_DES_RETORNO);
                        ...
                        else
                        {
                            ...
                            /*" -2039- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 10 */

                            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 10)
                            {

                                /*" -2040- MOVE 'AGENCIA ENCERRADA   ' TO REG-DES-RETORNO */
                                _.Move("AGENCIA ENCERRADA   ", WREG_AUDTSINI.REG_DES_RETORNO);
                            ...
                            else
                            {
                                ...
                                /*" -2042- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 12 */

                                if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 12)
                                {

                                    /*" -2043- MOVE 'VALOR INVALIDO      ' TO REG-DES-RETORNO */
                                    _.Move("VALOR INVALIDO      ", WREG_AUDTSINI.REG_DES_RETORNO);
                                ...
                                else
                                {
                                    ...
                                    /*" -2045- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 14 */

                                    if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 14)
                                    {

                                        /*" -2046- MOVE 'AGENCIA INVALIDA    ' TO REG-DES-RETORNO */
                                        _.Move("AGENCIA INVALIDA    ", WREG_AUDTSINI.REG_DES_RETORNO);
                                    ...
                                    else
                                    {
                                        ...
                                        /*" -2048- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 15 */

                                        if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 15)
                                        {

                                            /*" -2049- MOVE 'DV CONTA INVALIDO   ' TO REG-DES-RETORNO */
                                            _.Move("DV CONTA INVALIDO   ", WREG_AUDTSINI.REG_DES_RETORNO);
                                        ...
                                        else
                                        {
                                            ...
                                            /*" -2051- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 18 */

                                            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 18)
                                            {

                                                /*" -2052- MOVE 'DATA INVALIDA       ' TO REG-DES-RETORNO */
                                                _.Move("DATA INVALIDA       ", WREG_AUDTSINI.REG_DES_RETORNO);
                                            ...
                                            else
                                            {
                                                ...
                                                /*" -2054- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 30 */

                                                if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 30)
                                                {

                                                    /*" -2055- MOVE 'SEM CONTRATO        ' TO REG-DES-RETORNO */
                                                    _.Move("SEM CONTRATO        ", WREG_AUDTSINI.REG_DES_RETORNO);
                                                ...
                                                else
                                                {
                                                    ...
                                                    /*" -2057- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 96 */

                                                    if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 96)
                                                    {

                                                        /*" -2058- MOVE 'VALOR ZERADO        ' TO REG-DES-RETORNO */
                                                        _.Move("VALOR ZERADO        ", WREG_AUDTSINI.REG_DES_RETORNO);
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        /*" -2060- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 97 OR 98 */

                                                        if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF.In("97", "98"))
                                                        {

                                                            /*" -2061- MOVE 'CANCELADO           ' TO REG-DES-RETORNO */
                                                            _.Move("CANCELADO           ", WREG_AUDTSINI.REG_DES_RETORNO);
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            /*" -2063- IF MOVDEBCE-COD-RETORNO-CEF EQUAL 99 */

                                                            if (MOVDEBCE.DCLMOVTO_DEBITOCC_CEF.MOVDEBCE_COD_RETORNO_CEF == 99)
                                                            {

                                                                /*" -2064- MOVE 'ESTORNADO           ' TO REG-DES-RETORNO */
                                                                _.Move("ESTORNADO           ", WREG_AUDTSINI.REG_DES_RETORNO);
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                /*" -2065- MOVE 'OUTROS              ' TO REG-DES-RETORNO. */
                                                                _.Move("OUTROS              ", WREG_AUDTSINI.REG_DES_RETORNO);
                                                            }
        ...
        private void R9900_00_ENCERRA_SEM_MOVTO_SECTION()
        {
            ...
            /*" -2081- DISPLAY '* VA0956B - NAO FOI ENCONTRADO MOVIMENTO     *' . */
            _.Display($"* VA0956B - NAO FOI ENCONTRADO MOVIMENTO     *");

            /*" -2082- DISPLAY '*           NO MES/ANO DE REFERENCIA PARA    *' . */
            _.Display($"*           NO MES/ANO DE REFERENCIA PARA    *");

            /*" -2083- DISPLAY '*           EXECUTAR O PROGRAMA DA AUDITORIA *' . */
            _.Display($"*           EXECUTAR O PROGRAMA DA AUDITORIA *");

            /*" -2084- DISPLAY '*                                            *' . */
            _.Display($"*                                            *");

            /*" -2085- DISPLAY '*       TERMINO ==> A N O R M A L <==        *' . */
        ...
        private void R9999_00_ROT_ERRO_SECTION()
        {
            ...
            /*" -2102- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, WABEND.WSQLCODE);

            /*" -2104- DISPLAY WABEND. */
            _.Display(WABEND);

            /*" -2104- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -2108- MOVE 99 TO RETURN-CODE. */
