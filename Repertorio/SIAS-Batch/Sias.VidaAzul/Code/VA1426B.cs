...
using Dclgens;
using Copies;
using Sias.VidaAzul.DB2.VA1426B;

namespace Code
{
    public class VA1426B
    {
        ...
        /*"      * PARA AS APOLICE FENAM 109700000025,109700000027 E 109300000027)*      */
        /*"      ******************************************************************      */
        ...
        public FileBasis _RVA1426B { get; set; } = new FileBasis(new PIC("X", "132", "X(132)"));

        public FileBasis RVA1426B
        {
            get
            {
                _.Move(REG_RVA1426B, _RVA1426B); VarBasis.RedefinePassValue(REG_RVA1426B, _RVA1426B, REG_RVA1426B); return _RVA1426B;
            }
        }
        public SortBasis<VA1426B_REG_SORT> SVA1426B { get; set; } = new SortBasis<VA1426B_REG_SORT>(new VA1426B_REG_SORT());
        /*"01                REG-RVA1426B     PIC  X(132).*/
        public StringBasis REG_RVA1426B { get; set; } = new StringBasis(new PIC("X", "132", "X(132)."), @"");
        /*"01                REG-SORT.*/
        public VA1426B_REG_SORT REG_SORT { get; set; } = new VA1426B_REG_SORT();
        public class VA1426B_REG_SORT : VarBasis
        {
        ...
        /*"01                WORK-AREA.*/
        public VA1426B_WORK_AREA WORK_AREA { get; set; } = new VA1426B_WORK_AREA();
        public class VA1426B_WORK_AREA : VarBasis
        {
            /*"    05            WDATA-REL        PIC  X(010)    VALUE SPACES.*/
            public StringBasis WDATA_REL { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @"");
            /*"    05            FILLER           REDEFINES      WDATA-REL.*/
            private _REDEF_VA1426B_FILLER_0 _filler_0 { get; set; }
            public _REDEF_VA1426B_FILLER_0 FILLER_0
            {
                get { _filler_0 = new _REDEF_VA1426B_FILLER_0(); _.Move(WDATA_REL, _filler_0); VarBasis.RedefinePassValue(WDATA_REL, _filler_0, WDATA_REL); _filler_0.ValueChanged += () => { _.Move(_filler_0, WDATA_REL); }; return _filler_0; }
                set { VarBasis.RedefinePassValue(value, _filler_0, WDATA_REL); }
            }  //Redefines
            public class _REDEF_VA1426B_FILLER_0 : VarBasis
            {
                ...
                public _REDEF_VA1426B_FILLER_0()
                {
            ...
            public VA1426B_WDAT_REL_LIT WDAT_REL_LIT { get; set; } = new VA1426B_WDAT_REL_LIT();
            public class VA1426B_WDAT_REL_LIT : VarBasis
            {
            ...
            private _REDEF_VA1426B_FILLER_5 _filler_5 { get; set; }
            public _REDEF_VA1426B_FILLER_5 FILLER_5
            {
                get { _filler_5 = new _REDEF_VA1426B_FILLER_5(); _.Move(WREFE_DATA_INI, _filler_5); VarBasis.RedefinePassValue(WREFE_DATA_INI, _filler_5, WREFE_DATA_INI); _filler_5.ValueChanged += () => { _.Move(_filler_5, WREFE_DATA_INI); }; return _filler_5; }
                set { VarBasis.RedefinePassValue(value, _filler_5, WREFE_DATA_INI); }
            }  //Redefines
            public class _REDEF_VA1426B_FILLER_5 : VarBasis
            {
                ...
                public _REDEF_VA1426B_FILLER_5()
                {
            ...
            private _REDEF_VA1426B_FILLER_6 _filler_6 { get; set; }
            public _REDEF_VA1426B_FILLER_6 FILLER_6
            {
                get { _filler_6 = new _REDEF_VA1426B_FILLER_6(); _.Move(WREFE_DATA_TER, _filler_6); VarBasis.RedefinePassValue(WREFE_DATA_TER, _filler_6, WREFE_DATA_TER); _filler_6.ValueChanged += () => { _.Move(_filler_6, WREFE_DATA_TER); }; return _filler_6; }
                set { VarBasis.RedefinePassValue(value, _filler_6, WREFE_DATA_TER); }
            }  //Redefines
            public class _REDEF_VA1426B_FILLER_6 : VarBasis
            {
                ...
                public _REDEF_VA1426B_FILLER_6()
                {
            ...
            public VA1426B_WHORA_CURR WHORA_CURR { get; set; } = new VA1426B_WHORA_CURR();
            public class VA1426B_WHORA_CURR : VarBasis
            {
            ...
            public VA1426B_WHORA_CABEC WHORA_CABEC { get; set; } = new VA1426B_WHORA_CABEC();
            public class VA1426B_WHORA_CABEC : VarBasis
            {
            ...
            public VA1426B_DATA_MAQ DATA_MAQ { get; set; } = new VA1426B_DATA_MAQ();
            public class VA1426B_DATA_MAQ : VarBasis
            {
                /*"      10          MES              PIC  9(002).*/
            ...
            public VA1426B_WNUM_FATURA WNUM_FATURA { get; set; } = new VA1426B_WNUM_FATURA();
            public class VA1426B_WNUM_FATURA : VarBasis
            {
            ...
            /*"    05            LC00.*/
            public VA1426B_LC00 LC00 { get; set; } = new VA1426B_LC00();
            public class VA1426B_LC00 : VarBasis
            {
                /*"      10          FILLER           PIC  X(132)    VALUE SPACES.*/
                public StringBasis FILLER_11 { get; set; } = new StringBasis(new PIC("X", "132", "X(132)"), @"");
                /*"    05            LC01.*/
            }
            public VA1426B_LC01 LC01 { get; set; } = new VA1426B_LC01();
            public class VA1426B_LC01 : VarBasis
            {
                /*"      10          FILLER           PIC  X(132)    VALUE ALL '-'.*/
                public StringBasis FILLER_12 { get; set; } = new StringBasis(new PIC("X", "132", "X(132)"), @"ALL");
                /*"    05            LC02.*/
            }
            public VA1426B_LC02 LC02 { get; set; } = new VA1426B_LC02();
            public class VA1426B_LC02 : VarBasis
            {
                /*"      10          FILLER           PIC  X(001)    VALUE '*'.*/
            ...
            public VA1426B_LC03 LC03 { get; set; } = new VA1426B_LC03();
            public class VA1426B_LC03 : VarBasis
            {
                /*"      10          FILLER           PIC  X(044)    VALUE                                                 '* VA1426B'.*/
                public StringBasis FILLER_16 { get; set; } = new StringBasis(new PIC("X", "44", "X(044)"), @"* VA1426B");
            ...
            public VA1426B_LC04 LC04 { get; set; } = new VA1426B_LC04();
            public class VA1426B_LC04 : VarBasis
            {
            ...
            public VA1426B_LC05 LC05 { get; set; } = new VA1426B_LC05();
            public class VA1426B_LC05 : VarBasis
            {
                /*"      10          FILLER           PIC  X(001)    VALUE '*'.*/
            ...
            public VA1426B_LC06 LC06 { get; set; } = new VA1426B_LC06();
            public class VA1426B_LC06 : VarBasis
            {
                /*"      10          FILLER           PIC  X(001)    VALUE '*'.*/
            ...
            public VA1426B_LC07 LC07 { get; set; } = new VA1426B_LC07();
            public class VA1426B_LC07 : VarBasis
            {
                /*"      10          FILLER           PIC  X(001)    VALUE '*'.*/
            ...
            public VA1426B_LC08 LC08 { get; set; } = new VA1426B_LC08();
            public class VA1426B_LC08 : VarBasis
            {
                /*"      10          FILLER           PIC  X(001)    VALUE '*'.*/
            ...
            public VA1426B_LC09 LC09 { get; set; } = new VA1426B_LC09();
            public class VA1426B_LC09 : VarBasis
            {
            ...
            public VA1426B_DET_1 DET_1 { get; set; } = new VA1426B_DET_1();
            public class VA1426B_DET_1 : VarBasis
            {
            ...
            public VA1426B_TOT_CAB_1 TOT_CAB_1 { get; set; } = new VA1426B_TOT_CAB_1();
            public class VA1426B_TOT_CAB_1 : VarBasis
            {
                /*"      10          FILLER           PIC  X(032)    VALUE SPACES.*/
            ...
            public VA1426B_LK_LINK LK_LINK { get; set; } = new VA1426B_LK_LINK();
            public class VA1426B_LK_LINK : VarBasis
            {
            ...
            public VA1426B_WABEND WABEND { get; set; } = new VA1426B_WABEND();
            public class VA1426B_WABEND : VarBasis
            {
                /*"      10          FILLER           PIC  X(010)    VALUE                 ' VA1426B'.*/
                public StringBasis FILLER_59 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" VA1426B");
        ...
        public VA1426B_CHCONT CHCONT { get; set; } = new VA1426B_CHCONT();
        ...
        [StopWatch]
        /*" Execute */
        public dynamic Execute(string RVA1426B_FILE_NAME_P, string SVA1426B_FILE_NAME_P) //PROCEDURE DIVISION 
        /**/
        {
            try
            {
                RVA1426B.SetFile(RVA1426B_FILE_NAME_P);
                SVA1426B.SetFile(SVA1426B_FILE_NAME_P);
        ...
        private void M_0000_PRINCIPAL(bool isPerform = false)
        {
            ...
            /*" -353- SORT SVA1426B ON ASCENDING KEY SOR-NOMPRODU SOR-TIPOREG SOR-DTMOVTO INPUT PROCEDURE R0010-00-INPUT THRU R0010-99-SAIDA OUTPUT PROCEDURE R0020-00-OUTPUT THRU R0020-99-SAIDA. */
            SORT_RETURN.Value = SVA1426B.Sort("SOR-NOMPRODU,SOR-TIPOREG,SOR-DTMOVTO", () => R0010_00_INPUT_SECTION(), () => R0020_00_OUTPUT_SECTION());
        ...
        private void R0000_90_FINALIZA(bool isPerform = false)
        {
            ...
            /*" -369- DISPLAY '*** VA1426B - TERMINO NORMAL ***' */
            _.Display($"*** VA1426B - TERMINO NORMAL ***");
        ...
        private void R0100_00_SELECT_V1SISTEMA_SECTION()
        {
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -465- DISPLAY 'VA1426B - SISTEMA VA NAO ESTA CADASTRADO' */
                _.Display($"VA1426B - SISTEMA VA NAO ESTA CADASTRADO");
        ...
        private void R0150_00_MONTA_EMPRESA_SECTION()
        {
            ...
            else
            {
                ...
                /*" -506- DISPLAY 'VA1426B - PROBLEMA CALL V1EMPRESA' */
                _.Display($"VA1426B - PROBLEMA CALL V1EMPRESA");
        ...
        {
            /*" -519- MOVE '0200' TO WNR-EXEC-SQL. */
            _.Move("0200", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -525- PERFORM R0200_00_SELECT_V0RELATORIOS_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -529- DISPLAY 'VA1426B - PROBLEMAS NA ULTIMA DA REFERENCIA ' */
                _.Display($"VA1426B - PROBLEMAS NA ULTIMA DA REFERENCIA ");

                /*" -530- MOVE 'S' TO WFIM-RELATORIO */
                _.Move("S", WORK_AREA.WFIM_RELATORIO);

                /*" -532- GO TO R0200-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R0200_99_SAIDA*/ //GOTO
                return;
            }


            /*" -533- MOVE V0RELA-DTMAXIM TO WREFE-DATA-INI. */
            _.Move(V0RELA_DTMAXIM, WORK_AREA.WREFE_DATA_INI);

            /*" -534- MOVE WREFE-DIA-INI TO LC07-DIA-INI */
            _.Move(WORK_AREA.FILLER_5.WREFE_DIA_INI, WORK_AREA.LC07.LC07_DIA_INI);

            /*" -535- MOVE WREFE-MES-INI TO LC07-MES-INI */
            _.Move(WORK_AREA.FILLER_5.WREFE_MES_INI, WORK_AREA.LC07.LC07_MES_INI);

            /*" -537- MOVE WREFE-ANO-INI TO LC07-ANO-INI. */
            _.Move(WORK_AREA.FILLER_5.WREFE_ANO_INI, WORK_AREA.LC07.LC07_ANO_INI);

            /*" -543- PERFORM R0200_00_SELECT_V0RELATORIOS_DB_SELECT_2 */

            R0200_00_SELECT_V0RELATORIOS_DB_SELECT_2();
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -547- DISPLAY 'VA1426B - REGISTRO NAO ENCONTRADO V0RELATORIOS' */
                _.Display($"VA1426B - REGISTRO NAO ENCONTRADO V0RELATORIOS");

                /*" -548- MOVE 'S' TO WFIM-RELATORIO */
                _.Move("S", WORK_AREA.WFIM_RELATORIO);

                /*" -550- GO TO R0200-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R0200_99_SAIDA*/ //GOTO
                return;
            }


            /*" -551- MOVE V0RELA-DTREFER TO WREFE-DATA-TER */
            _.Move(V0RELA_DTREFER, WORK_AREA.WREFE_DATA_TER);

            /*" -552- MOVE WREFE-DIA-TER TO LC07-DIA-TER */
            _.Move(WORK_AREA.FILLER_6.WREFE_DIA_TER, WORK_AREA.LC07.LC07_DIA_TER);

            /*" -553- MOVE WREFE-MES-TER TO LC07-MES-TER */
            _.Move(WORK_AREA.FILLER_6.WREFE_MES_TER, WORK_AREA.LC07.LC07_MES_TER);

            /*" -555- MOVE WREFE-ANO-TER TO LC07-ANO-TER. */
            _.Move(WORK_AREA.FILLER_6.WREFE_ANO_TER, WORK_AREA.LC07.LC07_ANO_TER);

            /*" -556- MOVE WREFE-ANO-TER TO WANO-FATURA. */
            _.Move(WORK_AREA.FILLER_6.WREFE_ANO_TER, WORK_AREA.WNUM_FATURA.WANO_FATURA);

            /*" -556- MOVE WREFE-MES-TER TO WMES-FATURA. */
        ...
        {
            /*" -525- EXEC SQL SELECT MAX(DATA_REFERENCIA) INTO :V0RELA-DTMAXIM FROM SEGUROS.V0RELATORIOS WHERE CODRELAT = 'VA1417B' AND SITUACAO = '2' END-EXEC. */
            ...
            if (executed_1 != null)
            {
                _.Move(executed_1.V0RELA_DTMAXIM, V0RELA_DTMAXIM);
            }
        ...
        [StopWatch]
        /*" R0200-00-SELECT-V0RELATORIOS-DB-SELECT-2 */
        public void R0200_00_SELECT_V0RELATORIOS_DB_SELECT_2()
        {
            /*" -543- EXEC SQL SELECT DATA_REFERENCIA INTO :V0RELA-DTREFER FROM SEGUROS.V0RELATORIOS WHERE CODRELAT = 'VA1417B' AND SITUACAO = '1' END-EXEC. */

            var r0200_00_SELECT_V0RELATORIOS_DB_SELECT_2_Query1 = new R0200_00_SELECT_V0RELATORIOS_DB_SELECT_2_Query1()
            {
            };

            var executed_1 = R0200_00_SELECT_V0RELATORIOS_DB_SELECT_2_Query1.Execute(r0200_00_SELECT_V0RELATORIOS_DB_SELECT_2_Query1);
            if (executed_1 != null)
            {
        ...
        {
            /*" -569- MOVE '0900' TO WNR-EXEC-SQL. */
            _.Move("0900", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -593- PERFORM R0900_00_DECLARE_V0HCONTABILVA_DB_DECLARE_1 */

            R0900_00_DECLARE_V0HCONTABILVA_DB_DECLARE_1();

            /*" -595- PERFORM R0900_00_DECLARE_V0HCONTABILVA_DB_OPEN_1 */
        ...
        {
            /*" -593- EXEC SQL DECLARE CHCONT CURSOR FOR SELECT A.NUM_APOLICE , A.CODSUBES , B.NOMPRODU , A.NRPARCEL , A.CODOPER , A.DTMOVTO , A.PRMVG + A.PRMAP FROM SEGUROS.V0HISTCONTABILVA A, SEGUROS.V0PRODUTOSVG B WHERE A.DTFATUR = :V0RELA-DTREFER AND A.SITUACAO IN ( ' ' , '1' ) AND A.NUM_APOLICE = B.NUM_APOLICE AND A.CODSUBES = B.CODSUBES AND A.CODOPER �= 1000 AND B.DIA_FATURA = 31 AND B.ESTR_COBR = 'MULT' AND B.ORIG_PRODU IN ( 'FENAM' , 'CAAES' , 'VIDAZUL' ) ORDER BY A.NUM_APOLICE , A.CODSUBES , A.NRPARCEL , A.CODOPER END-EXEC. */
            CHCONT = new VA1426B_CHCONT(true);
        ...
        {
            /*" -595- EXEC SQL OPEN CHCONT END-EXEC. */
        ...
        {
            /*" -608- MOVE '0910' TO WNR-EXEC-SQL. */
            _.Move("0910", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -616- PERFORM R0910_00_FETCH_V0HCONTABILVA_DB_FETCH_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -620- MOVE 'S' TO WFIM-HCONTABILVA */
                _.Move("S", WORK_AREA.WFIM_HCONTABILVA);

                /*" -620- PERFORM R0910_00_FETCH_V0HCONTABILVA_DB_CLOSE_1 */

                R0910_00_FETCH_V0HCONTABILVA_DB_CLOSE_1();

                /*" -623- GO TO R0910-99-SAIDA. */
                /*Método Suprimido por falta de linha ou apenas EXIT nome: R0910_99_SAIDA*/ //GOTO
                return;
            }


            /*" -623- ADD 1 TO AC-LIDOS. */
        ...
        {
            /*" -616- EXEC SQL FETCH CHCONT INTO :V0HCON-APOLICE , :V0HCON-CODSUBES , :V0PROD-NOMPRODU , :V0HCON-NRPARCEL , :V0HCON-CODOPER , :V0HCON-DTMOVTO , :V0HCON-PRMTOTAL END-EXEC. */
        ...
        {
            /*" -620- EXEC SQL CLOSE CHCONT END-EXEC */
        ...
        {
            /*" -635- MOVE V0HCON-APOLICE TO SOR-APOLICE. */
            _.Move(V0HCON_APOLICE, REG_SORT.SOR_APOLICE);

            /*" -636- MOVE V0HCON-CODSUBES TO SOR-CODSUBES. */
            _.Move(V0HCON_CODSUBES, REG_SORT.SOR_CODSUBES);

            /*" -637- MOVE V0PROD-NOMPRODU TO SOR-NOMPRODU. */
            _.Move(V0PROD_NOMPRODU, REG_SORT.SOR_NOMPRODU);

            /*" -638- MOVE V0HCON-NRPARCEL TO SOR-PARCELA. */
            _.Move(V0HCON_NRPARCEL, REG_SORT.SOR_PARCELA);

            /*" -639- MOVE V0HCON-CODOPER TO SOR-CODOPER. */
            _.Move(V0HCON_CODOPER, REG_SORT.SOR_CODOPER);

            /*" -640- MOVE V0HCON-DTMOVTO TO SOR-DTMOVTO. */
            _.Move(V0HCON_DTMOVTO, REG_SORT.SOR_DTMOVTO);

            /*" -642- MOVE V0HCON-PRMTOTAL TO SOR-PREMIO. */
            _.Move(V0HCON_PRMTOTAL, REG_SORT.SOR_PREMIO);

            /*" -645- IF V0HCON-CODOPER > 199 AND V0HCON-CODOPER < 300 AND V0HCON-NRPARCEL = 1 */

            if (V0HCON_CODOPER > 199 && V0HCON_CODOPER < 300 && V0HCON_NRPARCEL == 1)
            {

                /*" -647- MOVE 1 TO SOR-TIPOREG. */
                _.Move(1, REG_SORT.SOR_TIPOREG);
            }


            /*" -650- IF V0HCON-CODOPER > 199 AND V0HCON-CODOPER < 300 AND V0HCON-NRPARCEL > 1 */

            if (V0HCON_CODOPER > 199 && V0HCON_CODOPER < 300 && V0HCON_NRPARCEL > 1)
            {

                /*" -652- MOVE 2 TO SOR-TIPOREG. */
                _.Move(2, REG_SORT.SOR_TIPOREG);
            }


            /*" -654- IF V0HCON-CODOPER > 399 AND V0HCON-CODOPER < 500 */

            if (V0HCON_CODOPER > 399 && V0HCON_CODOPER < 500)
            {

                /*" -656- MOVE 3 TO SOR-TIPOREG. */
                _.Move(3, REG_SORT.SOR_TIPOREG);
            }


            /*" -658- IF V0HCON-CODOPER > 499 AND V0HCON-CODOPER < 600 */

            if (V0HCON_CODOPER > 499 && V0HCON_CODOPER < 600)
            {

                /*" -660- MOVE 4 TO SOR-TIPOREG. */
                _.Move(4, REG_SORT.SOR_TIPOREG);
            }


            /*" -660- RELEASE REG-SORT. */
            SVA1426B.Release(REG_SORT);
        ...
        {
            /*" -664- PERFORM R0910-00-FETCH-V0HCONTABILVA. */
        ...
        {
            /*" -678- MOVE SOR-NOMPRODU TO LC06-TIPO PRODUTO-ANT. */
            _.Move(REG_SORT.SOR_NOMPRODU, WORK_AREA.LC06.LC06_TIPO, WORK_AREA.PRODUTO_ANT);

            /*" -680- PERFORM R3000-00-CABECALHOS. */

            R3000_00_CABECALHOS_SECTION();

            /*" -684- PERFORM R2200-00-QUEBRA-PRODUTO UNTIL WFIM-SORT EQUAL 'S' OR SOR-NOMPRODU NOT EQUAL PRODUTO-ANT. */
            ...
            /*" -685- MOVE 'PRODUTO ' TO CAB-1-TIPO. */
            _.Move("PRODUTO ", WORK_AREA.TOT_CAB_1.CAB_1_TIPO);

            /*" -687- MOVE WS-VLOPER-TOT TO CAB-1-TOTAL. */
            _.Move(WORK_AREA.WS_VLOPER_TOT, WORK_AREA.TOT_CAB_1.CAB_1_TOTAL);

            /*" -690- WRITE REG-RVA1426B FROM TOT-CAB-1 AFTER 2. */
            _.Move(WORK_AREA.TOT_CAB_1.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -692- MOVE ZEROS TO WS-VLOPER-TOT. */
            _.Move(0, WORK_AREA.WS_VLOPER_TOT);

            /*" -693- IF WFIM-SORT NOT EQUAL 'S' */

            if (WORK_AREA.WFIM_SORT != "S")
            {

                /*" -694- IF SOR-TIPOREG EQUAL 1 */

                if (REG_SORT.SOR_TIPOREG == 1)
                {

                    /*" -695- MOVE 'VENDAS NOVAS    (+)' TO LC09-OPERACAO */
                    _.Move("VENDAS NOVAS    (+)", WORK_AREA.LC09.LC09_OPERACAO);
                ...
                else
                {
                    ...
                    /*" -697- IF SOR-TIPOREG EQUAL 2 */

                    if (REG_SORT.SOR_TIPOREG == 2)
                    {

                        /*" -698- MOVE 'DEMAIS PARCELAS (+)' TO LC09-OPERACAO */
                        _.Move("DEMAIS PARCELAS (+)", WORK_AREA.LC09.LC09_OPERACAO);
                    ...
                    else
                    {
                        ...
                        /*" -700- IF SOR-TIPOREG EQUAL 3 */

                        if (REG_SORT.SOR_TIPOREG == 3)
                        {

                            /*" -701- MOVE 'CANCELAMENTOS   (-)' TO LC09-OPERACAO */
                            _.Move("CANCELAMENTOS   (-)", WORK_AREA.LC09.LC09_OPERACAO);
                        ...
                        else
                        {
                            ...
                            /*" -703- IF SOR-TIPOREG EQUAL 4 */

                            if (REG_SORT.SOR_TIPOREG == 4)
                            {

                                /*" -703- MOVE 'RESTITUICOES    (-)' TO LC09-OPERACAO. */
                                _.Move("RESTITUICOES    (-)", WORK_AREA.LC09.LC09_OPERACAO);
                            }
        ...
        {
            /*" -716- MOVE '2100' TO WNR-EXEC-SQL. */
            _.Move("2100", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -718- RETURN SVA1426B AT END */
            try
            {
                SVA1426B.Return(REG_SORT, () =>
                {

                    /*" -719- MOVE 'S' TO WFIM-SORT */
                    _.Move("S", WORK_AREA.WFIM_SORT);

                    /*" -719- GO TO R2100-99-SAIDA. */
        ...
        {
            /*" -732- MOVE '2200' TO WNR-EXEC-SQL. */
            _.Move("2200", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -734- MOVE SOR-TIPOREG TO TIPOREG-ANT. */
            _.Move(REG_SORT.SOR_TIPOREG, WORK_AREA.TIPOREG_ANT);

            /*" -739- PERFORM R2300-00-QUEBRA-TIPOREG UNTIL WFIM-SORT EQUAL 'S' OR SOR-NOMPRODU NOT EQUAL PRODUTO-ANT OR SOR-TIPOREG NOT EQUAL TIPOREG-ANT. */
            ...
            /*" -740- IF TIPOREG-ANT EQUAL 1 */

            if (WORK_AREA.TIPOREG_ANT == 1)
            {

                /*" -742- ADD AC-PREMIO TO WS-VLOPER-OPER WS-VLOPER-TOT */
            ...
            else
            {
                ...
                /*" -744- IF TIPOREG-ANT EQUAL 2 */

                if (WORK_AREA.TIPOREG_ANT == 2)
                {

                    /*" -746- ADD AC-PREMIO TO WS-VLOPER-OPER WS-VLOPER-TOT */
                    WORK_AREA.WS_VLOPER_OPER.Value = WORK_AREA.WS_VLOPER_OPER + WORK_AREA.AC_PREMIO;
                    WORK_AREA.WS_VLOPER_TOT.Value = WORK_AREA.WS_VLOPER_TOT + WORK_AREA.AC_PREMIO;
                ...
                else
                {
                    ...
                    /*" -748- IF TIPOREG-ANT EQUAL 3 */

                    if (WORK_AREA.TIPOREG_ANT == 3)
                    {

                        /*" -749- ADD AC-PREMIO TO WS-VLOPER-OPER */
                        WORK_AREA.WS_VLOPER_OPER.Value = WORK_AREA.WS_VLOPER_OPER + WORK_AREA.AC_PREMIO;

                        /*" -750- SUBTRACT AC-PREMIO FROM WS-VLOPER-TOT */
                        WORK_AREA.WS_VLOPER_TOT.Value = WORK_AREA.WS_VLOPER_TOT - WORK_AREA.AC_PREMIO;
                    ...
                    else
                    {
                        ...
                        /*" -752- IF TIPOREG-ANT EQUAL 4 */

                        if (WORK_AREA.TIPOREG_ANT == 4)
                        {

                            /*" -753- ADD AC-PREMIO TO WS-VLOPER-OPER */
                            WORK_AREA.WS_VLOPER_OPER.Value = WORK_AREA.WS_VLOPER_OPER + WORK_AREA.AC_PREMIO;

                            /*" -755- SUBTRACT AC-PREMIO FROM WS-VLOPER-TOT. */
                            WORK_AREA.WS_VLOPER_TOT.Value = WORK_AREA.WS_VLOPER_TOT - WORK_AREA.AC_PREMIO;
                        }
            ...
            /*" -757- MOVE ZEROS TO AC-PREMIO. */
            _.Move(0, WORK_AREA.AC_PREMIO);

            /*" -758- MOVE 'OPERACAO' TO CAB-1-TIPO. */
            _.Move("OPERACAO", WORK_AREA.TOT_CAB_1.CAB_1_TIPO);

            /*" -760- MOVE WS-VLOPER-OPER TO CAB-1-TOTAL. */
            _.Move(WORK_AREA.WS_VLOPER_OPER, WORK_AREA.TOT_CAB_1.CAB_1_TOTAL);

            /*" -762- ADD +4 TO AC-LINHAS. */
            WORK_AREA.AC_LINHAS.Value = WORK_AREA.AC_LINHAS + +4;

            /*" -763- IF AC-LINHAS GREATER +55 */

            if (WORK_AREA.AC_LINHAS > +55)
            {

                /*" -765- PERFORM R3000-00-CABECALHOS. */

                R3000_00_CABECALHOS_SECTION();
            }


            /*" -768- WRITE REG-RVA1426B FROM TOT-CAB-1 AFTER 2. */
            _.Move(WORK_AREA.TOT_CAB_1.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -770- MOVE ZEROS TO WS-VLOPER-OPER. */
            _.Move(0, WORK_AREA.WS_VLOPER_OPER);

            /*" -772- IF WFIM-SORT NOT EQUAL 'S' AND SOR-NOMPRODU EQUAL PRODUTO-ANT */

            if (WORK_AREA.WFIM_SORT != "S" && REG_SORT.SOR_NOMPRODU == WORK_AREA.PRODUTO_ANT)
            {

                /*" -773- IF SOR-TIPOREG EQUAL 1 */

                if (REG_SORT.SOR_TIPOREG == 1)
                {

                    /*" -774- MOVE 'VENDAS NOVAS    (+)' TO LC09-OPERACAO */
                    _.Move("VENDAS NOVAS    (+)", WORK_AREA.LC09.LC09_OPERACAO);

                    /*" -775- WRITE REG-RVA1426B FROM LC09 AFTER 1 */
                    _.Move(WORK_AREA.LC09.GetMoveValues(), REG_RVA1426B);
                ...
                else
                {
                    ...
                    /*" -777- IF SOR-TIPOREG EQUAL 2 */

                    if (REG_SORT.SOR_TIPOREG == 2)
                    {

                        /*" -778- MOVE 'DEMAIS PARCELAS (+)' TO LC09-OPERACAO */
                        _.Move("DEMAIS PARCELAS (+)", WORK_AREA.LC09.LC09_OPERACAO);

                        /*" -779- WRITE REG-RVA1426B FROM LC09 AFTER 1 */
                        _.Move(WORK_AREA.LC09.GetMoveValues(), REG_RVA1426B);
                    ...
                    else
                    {
                        ...
                        /*" -781- IF SOR-TIPOREG EQUAL 3 */

                        if (REG_SORT.SOR_TIPOREG == 3)
                        {

                            /*" -782- MOVE 'CANCELAMENTOS   (-)' TO LC09-OPERACAO */
                            _.Move("CANCELAMENTOS   (-)", WORK_AREA.LC09.LC09_OPERACAO);

                            /*" -783- WRITE REG-RVA1426B FROM LC09 AFTER 1 */
                            _.Move(WORK_AREA.LC09.GetMoveValues(), REG_RVA1426B);
                        ...
                        else
                        {
                            ...
                            /*" -785- IF SOR-TIPOREG EQUAL 4 */

                            if (REG_SORT.SOR_TIPOREG == 4)
                            {

                                /*" -786- MOVE 'RESTITUICOES    (-)' TO LC09-OPERACAO */
                                _.Move("RESTITUICOES    (-)", WORK_AREA.LC09.LC09_OPERACAO);

                                /*" -786- WRITE REG-RVA1426B FROM LC09 AFTER 1. */
                                _.Move(WORK_AREA.LC09.GetMoveValues(), REG_RVA1426B);
        ...
        {
            /*" -799- MOVE '2300' TO WNR-EXEC-SQL. */
            _.Move("2300", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -801- MOVE SOR-DTMOVTO TO DATA-ANT. */
            _.Move(REG_SORT.SOR_DTMOVTO, WORK_AREA.DATA_ANT);

            /*" -807- PERFORM R2400-00-QUEBRA-DATA UNTIL WFIM-SORT EQUAL 'S' OR SOR-NOMPRODU NOT EQUAL PRODUTO-ANT OR SOR-TIPOREG NOT EQUAL TIPOREG-ANT OR SOR-DTMOVTO NOT EQUAL DATA-ANT. */
        ...
        {
            /*" -821- ADD SOR-PREMIO TO AC-PREMIO WS-PREMIO. */
        ...
        {
            /*" -834- MOVE '2500' TO WNR-EXEC-SQL. */
            _.Move("2500", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -835- MOVE DATA-ANT TO WDATA-REL. */
            _.Move(WORK_AREA.DATA_ANT, WORK_AREA.WDATA_REL);

            /*" -836- MOVE WDAT-REL-ANO TO DET1-ANO-MOV. */
            _.Move(WORK_AREA.FILLER_0.WDAT_REL_ANO, WORK_AREA.DET_1.DET1_ANO_MOV);

            /*" -837- MOVE WDAT-REL-MES TO DET1-MES-MOV. */
            _.Move(WORK_AREA.FILLER_0.WDAT_REL_MES, WORK_AREA.DET_1.DET1_MES_MOV);

            /*" -839- MOVE WDAT-REL-DIA TO DET1-DIA-MOV. */
            _.Move(WORK_AREA.FILLER_0.WDAT_REL_DIA, WORK_AREA.DET_1.DET1_DIA_MOV);

            /*" -841- MOVE WS-PREMIO TO DET1-VALOR. */
            _.Move(WORK_AREA.WS_PREMIO, WORK_AREA.DET_1.DET1_VALOR);

            /*" -843- ADD +1 TO AC-LINHAS. */
            WORK_AREA.AC_LINHAS.Value = WORK_AREA.AC_LINHAS + +1;

            /*" -844- IF AC-LINHAS GREATER +55 */

            if (WORK_AREA.AC_LINHAS > +55)
            {

                /*" -846- PERFORM R3000-00-CABECALHOS. */

                R3000_00_CABECALHOS_SECTION();
            }


            /*" -848- WRITE REG-RVA1426B FROM DET-1 AFTER 1. */
            _.Move(WORK_AREA.DET_1.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -848- MOVE ZEROS TO WS-PREMIO. */
        ...
        {
            /*" -861- MOVE '3000' TO WNR-EXEC-SQL. */
            _.Move("3000", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -863- MOVE WNUM-FATURA TO LC07-FATURA. */
            _.Move(WORK_AREA.WNUM_FATURA, WORK_AREA.LC07.LC07_FATURA);

            /*" -864- ADD +1 TO AC-PAGINA. */
            WORK_AREA.AC_PAGINA.Value = WORK_AREA.AC_PAGINA + +1;

            /*" -865- MOVE AC-PAGINA TO LC03-PAGINA. */
            _.Move(WORK_AREA.AC_PAGINA, WORK_AREA.LC03.LC03_PAGINA);

            /*" -867- MOVE 11 TO AC-LINHAS. */
            _.Move(11, WORK_AREA.AC_LINHAS);

            /*" -868- WRITE REG-RVA1426B FROM LC01 AFTER PAGE */
            _.Move(WORK_AREA.LC01.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -869- WRITE REG-RVA1426B FROM LC02 AFTER 1 */
            _.Move(WORK_AREA.LC02.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -870- WRITE REG-RVA1426B FROM LC03 AFTER 1 */
            _.Move(WORK_AREA.LC03.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -871- WRITE REG-RVA1426B FROM LC04 AFTER 1 */
            _.Move(WORK_AREA.LC04.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -872- WRITE REG-RVA1426B FROM LC05 AFTER 1 */
            _.Move(WORK_AREA.LC05.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -873- WRITE REG-RVA1426B FROM LC06 AFTER 1 */
            _.Move(WORK_AREA.LC06.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -874- WRITE REG-RVA1426B FROM LC07 AFTER 1 */
            _.Move(WORK_AREA.LC07.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -875- WRITE REG-RVA1426B FROM LC01 AFTER 1 */
            _.Move(WORK_AREA.LC01.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -876- WRITE REG-RVA1426B FROM LC08 AFTER 2 */
            _.Move(WORK_AREA.LC08.GetMoveValues(), REG_RVA1426B);

            RVA1426B.Write(REG_RVA1426B.GetMoveValues().ToString());

            /*" -876- WRITE REG-RVA1426B FROM LC09 AFTER 1. */
            _.Move(WORK_AREA.LC09.GetMoveValues(), REG_RVA1426B);
        ...
        {
            /*" -889- MOVE '400' TO WNR-EXEC-SQL. */
            _.Move("400", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -894- PERFORM R4000_00_UPDATE_RELATORIO_DB_UPDATE_1 */

            R4000_00_UPDATE_RELATORIO_DB_UPDATE_1();

            /*" -897- IF SQLCODE NOT EQUAL ZEROES */

            if (DB.SQLCODE != 00)
            {

                /*" -898- DISPLAY 'PROBLEMAS NO UPDATE V0RELATORIOS ' */
        ...
        {
            /*" -894- EXEC SQL UPDATE SEGUROS.V0RELATORIOS SET SITUACAO = '2' WHERE CODRELAT = 'VA1417B' AND SITUACAO = '1' END-EXEC */
        ...
        {
            /*" -911- MOVE '8000' TO WNR-EXEC-SQL. */
            _.Move("8000", WORK_AREA.WABEND.WNR_EXEC_SQL);

            /*" -911- OPEN OUTPUT RVA1426B. */
            RVA1426B.Open(REG_RVA1426B);
        ...
        {
            /*" -938- MOVE SQLCODE TO WSQLCODE. */
            _.Move(DB.SQLCODE, WORK_AREA.WABEND.WSQLCODE);

            /*" -940- DISPLAY WABEND */
            _.Display(WORK_AREA.WABEND);

            /*" -940- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -942- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -946- MOVE 99 TO RETURN-CODE. */
