...
{
    public class R3214_UPDATE_HIST_LANC_CTA_DB_UPDATE_1_Update1 : QueryBasis<R3214_UPDATE_HIST_LANC_CTA_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R3214_UPDATE_HIST_LANC_CTA_DB_UPDATE_1_Update1 r3214_UPDATE_HIST_LANC_CTA_DB_UPDATE_1_Update1)
        {
            var ths = r3214_UPDATE_HIST_LANC_CTA_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3214_UPDATE_HIST_LANC_CTA_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
