...
{
    public class R0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1 : QueryBasis<R0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1 Execute(R0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1 r0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1)
        {
            var ths = r0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1;
        ...
        public override R0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0324_00_RECUPERA_NUM_CARTAO_DB_SELECT_1_Query1();
            var i = 0;
