...
{
    public class R0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1 : QueryBasis<R0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1 Execute(R0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1 r0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1)
        {
            var ths = r0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1;
        ...
        public override R0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0322_00_CONSULTA_NUM_CARTAO_DB_SELECT_1_Query1();
            var i = 0;
