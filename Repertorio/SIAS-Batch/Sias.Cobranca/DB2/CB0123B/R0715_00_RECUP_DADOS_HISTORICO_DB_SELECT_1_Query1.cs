...
{
    public class R0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1 : QueryBasis<R0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1 Execute(R0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1 r0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1)
        {
            var ths = r0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1;
        ...
        public override R0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R0715_00_RECUP_DADOS_HISTORICO_DB_SELECT_1_Query1();
            var i = 0;
