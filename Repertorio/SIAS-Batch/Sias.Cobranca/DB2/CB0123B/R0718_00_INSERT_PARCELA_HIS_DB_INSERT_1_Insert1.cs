...
{
    public class R0718_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1 : QueryBasis<R0718_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            , :PARCEHIS-DATA-QUITACAO:VIND-DTQITBCO
        ...
        public static void Execute(R0718_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1 r0718_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1)
        {
            var ths = r0718_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R0718_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
