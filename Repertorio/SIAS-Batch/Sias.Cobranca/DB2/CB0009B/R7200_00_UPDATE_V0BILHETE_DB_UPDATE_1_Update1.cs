...
{
    public class R7200_00_UPDATE_V0BILHETE_DB_UPDATE_1_Update1 : QueryBasis<R7200_00_UPDATE_V0BILHETE_DB_UPDATE_1_Update1>
    {

        private CB0009B_V1BILHETE CurrentOf { get; set; }

        public R7200_00_UPDATE_V0BILHETE_DB_UPDATE_1_Update1(CB0009B_V1BILHETE currentOf)
        {
            CurrentOf = currentOf;
        }
        ...
        public static void Execute(R7200_00_UPDATE_V0BILHETE_DB_UPDATE_1_Update1 r7200_00_UPDATE_V0BILHETE_DB_UPDATE_1_Update1)
        {
            var ths = r7200_00_UPDATE_V0BILHETE_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R7200_00_UPDATE_V0BILHETE_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
