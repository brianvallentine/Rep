...
{
    public class CB2005B_V1RCAPCOMP : QueryBasis<CB2005B_V1RCAPCOMP>
    {
        ...
        public CB2005B_V1RCAPCOMP() { IsCursor = true; }

        public CB2005B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override CB2005B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB2005B_V1RCAPCOMP();
            var i = 0;
