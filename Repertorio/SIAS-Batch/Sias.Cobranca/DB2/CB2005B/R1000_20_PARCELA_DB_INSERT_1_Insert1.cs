...
{
    public class R1000_20_PARCELA_DB_INSERT_1_Insert1 : QueryBasis<R1000_20_PARCELA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1000_20_PARCELA_DB_INSERT_1_Insert1 r1000_20_PARCELA_DB_INSERT_1_Insert1)
        {
            var ths = r1000_20_PARCELA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1000_20_PARCELA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
