...
{
    public class R1030_00_TRATA_FENAE_DB_INSERT_1_Insert1 : QueryBasis<R1030_00_TRATA_FENAE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1030_00_TRATA_FENAE_DB_INSERT_1_Insert1 r1030_00_TRATA_FENAE_DB_INSERT_1_Insert1)
        {
            var ths = r1030_00_TRATA_FENAE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1030_00_TRATA_FENAE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
