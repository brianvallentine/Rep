...
{
    public class R3000_00_ACUMULA_BILHETE_DB_INSERT_1_Insert1 : QueryBasis<R3000_00_ACUMULA_BILHETE_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R3000_00_ACUMULA_BILHETE_DB_INSERT_1_Insert1 r3000_00_ACUMULA_BILHETE_DB_INSERT_1_Insert1)
        {
            var ths = r3000_00_ACUMULA_BILHETE_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R3000_00_ACUMULA_BILHETE_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
