...
{
    public class R5000_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 : QueryBasis<R5000_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public string V0HISP_COD_USUR { get; set; }
        public string V0HISP_RNUDOC { get; set; }
        public string V0HISP_DTQITBCO { get; set; }
        public string VIND_DTQITBCO { get; set; }
        public string V0HISP_COD_EMPR { get; set; }

        public static void Execute(R5000_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 r5000_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1)
        {
            var ths = r5000_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5000_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
