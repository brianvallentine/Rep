...
{
    public class R4800_00_TRATA_AVISO_SALDOS_DB_INSERT_1_Insert1 : QueryBasis<R4800_00_TRATA_AVISO_SALDOS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4800_00_TRATA_AVISO_SALDOS_DB_INSERT_1_Insert1 r4800_00_TRATA_AVISO_SALDOS_DB_INSERT_1_Insert1)
        {
            var ths = r4800_00_TRATA_AVISO_SALDOS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4800_00_TRATA_AVISO_SALDOS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
