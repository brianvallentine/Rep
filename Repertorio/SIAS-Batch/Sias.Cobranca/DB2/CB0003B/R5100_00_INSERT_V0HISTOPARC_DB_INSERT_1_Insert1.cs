...
{
    public class R5100_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 : QueryBasis<R5100_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R5100_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 r5100_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1)
        {
            var ths = r5100_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5100_00_INSERT_V0HISTOPARC_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
