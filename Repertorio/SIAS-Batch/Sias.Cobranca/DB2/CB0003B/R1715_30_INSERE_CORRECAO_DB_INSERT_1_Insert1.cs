...
{
    public class R1715_30_INSERE_CORRECAO_DB_INSERT_1_Insert1 : QueryBasis<R1715_30_INSERE_CORRECAO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R1715_30_INSERE_CORRECAO_DB_INSERT_1_Insert1 r1715_30_INSERE_CORRECAO_DB_INSERT_1_Insert1)
        {
            var ths = r1715_30_INSERE_CORRECAO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R1715_30_INSERE_CORRECAO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
