...
{
    public class R6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1 : QueryBasis<R6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1 Execute(R6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1 r6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1)
        {
            var ths = r6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1;
        ...
        public override R6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R6110_00_INCLUI_AUTO_COMPL_DB_SELECT_1_Query1();
            var i = 0;
