...
{
    public class R7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1 : QueryBasis<R7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static R7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1 Execute(R7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1 r7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1)
        {
            var ths = r7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1;
        ...
        public override R7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R7540_00_RECUPERA_CORRETOR_DB_SELECT_1_Query1();
            var i = 0;
