...
{
    public class CB0005B_V1RCAPCOMP : QueryBasis<CB0005B_V1RCAPCOMP>
    {
        ...
        public CB0005B_V1RCAPCOMP() { IsCursor = true; }

        public CB0005B_V1RCAPCOMP(bool justACursor)
        {
        ...
        public override CB0005B_V1RCAPCOMP OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB0005B_V1RCAPCOMP();
            var i = 0;
