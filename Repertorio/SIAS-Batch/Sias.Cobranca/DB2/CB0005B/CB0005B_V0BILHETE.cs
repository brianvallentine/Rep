...
{
    public class CB0005B_V0BILHETE : QueryBasis<CB0005B_V0BILHETE>
    {
        ...
        public CB0005B_V0BILHETE() { IsCursor = true; }

        public CB0005B_V0BILHETE(bool justACursor)
        {
        ...
        public string V0BILH_DTVENCTO { get; set; }
        ...
        public string WSGER36_DATA_TERVIGENCIA { get; set; }
        public string WSGER60_DATA_TERVIGENCIA { get; set; }
        ...
        public override CB0005B_V0BILHETE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB0005B_V0BILHETE();
            var i = 0;
            ...
            dta.V0BILH_DTVENCTO = result[i++].Value?.ToString();
            ...
            dta.WSGER36_DATA_TERVIGENCIA = result[i++].Value?.ToString();
            dta.WSGER60_DATA_TERVIGENCIA = result[i++].Value?.ToString();
