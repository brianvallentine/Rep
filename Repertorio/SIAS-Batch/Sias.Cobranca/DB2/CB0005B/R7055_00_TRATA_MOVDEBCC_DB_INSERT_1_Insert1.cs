...
{
    public class R7055_00_TRATA_MOVDEBCC_DB_INSERT_1_Insert1 : QueryBasis<R7055_00_TRATA_MOVDEBCC_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R7055_00_TRATA_MOVDEBCC_DB_INSERT_1_Insert1 r7055_00_TRATA_MOVDEBCC_DB_INSERT_1_Insert1)
        {
            var ths = r7055_00_TRATA_MOVDEBCC_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R7055_00_TRATA_MOVDEBCC_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
