...
{
    public class R5010_00_INSERE_PARCELA_DB_INSERT_1_Insert1 : QueryBasis<R5010_00_INSERE_PARCELA_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R5010_00_INSERE_PARCELA_DB_INSERT_1_Insert1 r5010_00_INSERE_PARCELA_DB_INSERT_1_Insert1)
        {
            var ths = r5010_00_INSERE_PARCELA_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5010_00_INSERE_PARCELA_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
