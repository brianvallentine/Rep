...
{
    public class R5020_00_INSERE_COBER_APOL_DB_INSERT_1_Insert1 : QueryBasis<R5020_00_INSERE_COBER_APOL_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R5020_00_INSERE_COBER_APOL_DB_INSERT_1_Insert1 r5020_00_INSERE_COBER_APOL_DB_INSERT_1_Insert1)
        {
            var ths = r5020_00_INSERE_COBER_APOL_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5020_00_INSERE_COBER_APOL_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
