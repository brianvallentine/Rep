...
{
    public class CB1262B_C1PARCEHIS : QueryBasis<CB1262B_C1PARCEHIS>
    {
        ...
        public CB1262B_C1PARCEHIS() { IsCursor = true; }

        public CB1262B_C1PARCEHIS(bool justACursor)
        {
        ...
        public override CB1262B_C1PARCEHIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB1262B_C1PARCEHIS();
            var i = 0;
            ...
            dta.CBMALPAR_DATA_MOVIMENTO = result[i++].Value?.ToString();
            dta.CBMALPAR_NUM_TITULO = result[i++].Value?.ToString();
