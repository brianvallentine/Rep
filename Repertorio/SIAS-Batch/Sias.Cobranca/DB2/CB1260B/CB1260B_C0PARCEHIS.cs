...
{
    public class CB1260B_C0PARCEHIS : QueryBasis<CB1260B_C0PARCEHIS>
    {
        ...
        public CB1260B_C0PARCEHIS() { IsCursor = true; }

        public CB1260B_C0PARCEHIS(bool justACursor)
        {
        ...
        public override CB1260B_C0PARCEHIS OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB1260B_C0PARCEHIS();
            var i = 0;
