...
{
    public class CB1260B_C1CALENDARIO : QueryBasis<CB1260B_C1CALENDARIO>
    {
        ...
        public CB1260B_C1CALENDARIO() { IsCursor = true; }

        public CB1260B_C1CALENDARIO(bool justACursor)
        {
        ...
        public override CB1260B_C1CALENDARIO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB1260B_C1CALENDARIO();
            var i = 0;
