...
{
    public class CB1260B_C0CALENDARIO : QueryBasis<CB1260B_C0CALENDARIO>
    {
        ...
        public CB1260B_C0CALENDARIO() { IsCursor = true; }

        public CB1260B_C0CALENDARIO(bool justACursor)
        {
        ...
        public override CB1260B_C0CALENDARIO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB1260B_C0CALENDARIO();
            var i = 0;
