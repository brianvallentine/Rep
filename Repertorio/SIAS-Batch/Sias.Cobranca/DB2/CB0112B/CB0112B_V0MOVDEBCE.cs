...
{
    public class CB0112B_V0MOVDEBCE : QueryBasis<CB0112B_V0MOVDEBCE>
    {
        ...
        public CB0112B_V0MOVDEBCE() { IsCursor = true; }

        public CB0112B_V0MOVDEBCE(bool justACursor)
        {
        ...
        public override CB0112B_V0MOVDEBCE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB0112B_V0MOVDEBCE();
            var i = 0;
