...
{
    public class CB0065B_V0CALENDARIO : QueryBasis<CB0065B_V0CALENDARIO>
    {
        ...
        public CB0065B_V0CALENDARIO() { IsCursor = true; }

        public CB0065B_V0CALENDARIO(bool justACursor)
        {
        ...
        public override CB0065B_V0CALENDARIO OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB0065B_V0CALENDARIO();
            var i = 0;
