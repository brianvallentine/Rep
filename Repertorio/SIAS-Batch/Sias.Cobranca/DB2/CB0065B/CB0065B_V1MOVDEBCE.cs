...
{
    public class CB0065B_V1MOVDEBCE : QueryBasis<CB0065B_V1MOVDEBCE>
    {
        ...
        public CB0065B_V1MOVDEBCE() { IsCursor = true; }

        public CB0065B_V1MOVDEBCE(bool justACursor)
        {
        ...
        public override CB0065B_V1MOVDEBCE OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new CB0065B_V1MOVDEBCE();
            var i = 0;
