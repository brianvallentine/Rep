...
{
    public class R4220_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1 : QueryBasis<R4220_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4220_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1 r4220_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1)
        {
            var ths = r4220_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4220_00_INSERT_PARCELA_HIS_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
