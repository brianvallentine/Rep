...
{
    public class R4025_00_INSERT_MOV_COBR_DB_INSERT_1_Insert1 : QueryBasis<R4025_00_INSERT_MOV_COBR_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R4025_00_INSERT_MOV_COBR_DB_INSERT_1_Insert1 r4025_00_INSERT_MOV_COBR_DB_INSERT_1_Insert1)
        {
            var ths = r4025_00_INSERT_MOV_COBR_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4025_00_INSERT_MOV_COBR_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
