...
{
    public class R4030_UPD_COBER_HIST_VIDAZUL_DB_UPDATE_1_Update1 : QueryBasis<R4030_UPD_COBER_HIST_VIDAZUL_DB_UPDATE_1_Update1>
    {
        string GetQuery()
        {
            var query = @$"
        ...
        public static void Execute(R4030_UPD_COBER_HIST_VIDAZUL_DB_UPDATE_1_Update1 r4030_UPD_COBER_HIST_VIDAZUL_DB_UPDATE_1_Update1)
        {
            var ths = r4030_UPD_COBER_HIST_VIDAZUL_DB_UPDATE_1_Update1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R4030_UPD_COBER_HIST_VIDAZUL_DB_UPDATE_1_Update1 OpenData(List<KeyValuePair<string, object>> result)
        {
