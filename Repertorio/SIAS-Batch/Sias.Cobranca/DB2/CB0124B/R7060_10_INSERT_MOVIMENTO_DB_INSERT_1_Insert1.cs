...
{
    public class R7060_10_INSERT_MOVIMENTO_DB_INSERT_1_Insert1 : QueryBasis<R7060_10_INSERT_MOVIMENTO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
        ...
        public static void Execute(R7060_10_INSERT_MOVIMENTO_DB_INSERT_1_Insert1 r7060_10_INSERT_MOVIMENTO_DB_INSERT_1_Insert1)
        {
            var ths = r7060_10_INSERT_MOVIMENTO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R7060_10_INSERT_MOVIMENTO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
