...
{
    public class R4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1 : QueryBasis<R4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            AND A.OCORR_HISTORICO = :HISCONPA-OCORR-HISTORICO
            ...
            */
            ...
            var query = @$"
				SELECT A.NUM_CERTIFICADO
											...
											AND A.COD_OPERACAO BETWEEN 200 AND 299
											AND A.OCORR_HISTORICO = '{this.HISCONPA_OCORR_HISTORICO}'
											AND A.NUM_CERTIFICADO = B.NUM_CERTIFICADO
											AND A.NUM_APOLICE = C.NUM_APOLICE
											AND A.NUM_ENDOSSO = C.NUM_ENDOSSO
											AND A.NUM_APOLICE = D.NUM_APOLICE
        ...
        public static R4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1 Execute(R4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1 r4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1)
        {
            var ths = r4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1;
        ...
        public override R4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1 OpenData(List<KeyValuePair<string, object>> result)
        {
            var dta = new R4010_00_SELECT_PARCELAS_DB_SELECT_1_Query1();
            var i = 0;
