...
{
    public class R5010_00_INSERT_AVISO_CREDITO_DB_INSERT_1_Insert1 : QueryBasis<R5010_00_INSERT_AVISO_CREDITO_DB_INSERT_1_Insert1>
    {
        string GetQuery()
        {
            #region SQL_SOURCE
            ...
            , :AVISOCRE-COD-EMPRESA:VIND-CODEMP
            , CURRENT TIMESTAMP
            , :AVISOCRE-ORIGEM-AVISO:VIND-ORIGEM
            , :AVISOCRE-VAL-ADIANTAMENTO:VIND-VALADT
        ...
        public static void Execute(R5010_00_INSERT_AVISO_CREDITO_DB_INSERT_1_Insert1 r5010_00_INSERT_AVISO_CREDITO_DB_INSERT_1_Insert1)
        {
            var ths = r5010_00_INSERT_AVISO_CREDITO_DB_INSERT_1_Insert1;
            ths.SetQuery(ths.GetQuery());
            ths.ExecuteQuery();
        }

        public override R5010_00_INSERT_AVISO_CREDITO_DB_INSERT_1_Insert1 OpenData(List<KeyValuePair<string, object>> result)
        {
