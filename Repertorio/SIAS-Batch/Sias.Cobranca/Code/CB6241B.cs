...
using Dclgens;
using Copies;
using Sias.Cobranca.DB2.CB6241B;

namespace Code
{
    public class CB6241B
    {
        ...
        /*"      *                             CAIXA SEGURADORA - 911241.         *      */
        /*"      *                             SAF LOTERICO - 8105                *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *                         ALTERACAO                              *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *   VERSAO 08 - DEMANDA 297458/TAREFA 303659                     *      */
        /*"      *             - ABENDAR PROGRAMA QUANDO SEQUENCIA FOR DUPLICADA  *      */
        /*"      *   EM 03/08/2021 - HUSNI ALI HUSNI                              *      */
        /*"      *                                       PROCURE POR V.08         *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *   VERSAO 07 - DEMANDA 256.877                                  *      */
        /*"      *             - AJUSTE PARA JV1, AUTOMATIZAR TRATAMENTO          *      */
        /*"      *               CEDENTE.                                         *      */
        /*"      *   EM 08/09/2020 - HERVAL SOUZA                                 *      */
        /*"      *                                       PROCURE POR V.07         *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *   VERSAO 06 - DEMANDA 255354                                   *      */
        /*"      *             - AJUSTE PARA PROCESSAMENTO DO CONVENIO 912085     *      */
        /*"      *                                                                *      */
        /*"      *   EM 27/08/2020 - FELIPE TOGAWA                                *      */
        /*"      *                                       PROCURE POR V.06         *      */
        /*"      *----------------------------------------------------------------*      */
        ...
        /*"      *                                                                *      */
        /*"      *   EM 15/10/2014 - COREON                                       *      */
        /*"      *                                                                *      */
        /*"      *                                       PROCURE POR V.04         *      */
        /*"      *                                                                *      */
        /*"      *   RECOMPILADO EM 14/09/2015                                    *      */
        /*"      *----------------------------------------------------------------*      */
        /*"      *                                                                       */
        /*"      *   ALTERACAO ..............  FAST   EM 23/09/2010    V.03       *      */
        /*"      *                             CADMUS 48152.                      *      */
        /*"      *                             TRATA DESLOCAMENTO DO NUMERO       *      */
        /*"      *                             DA PROPOSTA NO CODIGO DE BARRAS    *      */
        /*"      *                                                                *      */
        /*"      *----------------------------------------------------------------*      */
        ...
        /*"01        MOVCC-REGISTRO.*/
        public CB6241B_MOVCC_REGISTRO MOVCC_REGISTRO { get; set; } = new CB6241B_MOVCC_REGISTRO();
        public class CB6241B_MOVCC_REGISTRO : VarBasis
        {
            ...
            public CB6241B_MOVCC_CTACOBRANCA MOVCC_CTACOBRANCA { get; set; } = new CB6241B_MOVCC_CTACOBRANCA();
            public class CB6241B_MOVCC_CTACOBRANCA : VarBasis
            {
            ...
            public CB6241B_MOVCC_DTPAGTO MOVCC_DTPAGTO { get; set; } = new CB6241B_MOVCC_DTPAGTO();
            public class CB6241B_MOVCC_DTPAGTO : VarBasis
            {
            ...
            public CB6241B_MOVCC_DTCREDITO MOVCC_DTCREDITO { get; set; } = new CB6241B_MOVCC_DTCREDITO();
            public class CB6241B_MOVCC_DTCREDITO : VarBasis
            {
            ...
            public CB6241B_MOVCC_CODBARRA MOVCC_CODBARRA { get; set; } = new CB6241B_MOVCC_CODBARRA();
            public class CB6241B_MOVCC_CODBARRA : VarBasis
            {
        ...
        /*"01        HEADER-REGISTRO.*/
        public CB6241B_HEADER_REGISTRO HEADER_REGISTRO { get; set; } = new CB6241B_HEADER_REGISTRO();
        public class CB6241B_HEADER_REGISTRO : VarBasis
        {
            ...
            public CB6241B_HEADER_DATGERACAO HEADER_DATGERACAO { get; set; } = new CB6241B_HEADER_DATGERACAO();
            public class CB6241B_HEADER_DATGERACAO : VarBasis
            {
        ...
        public CB6241B_TRAILL_REGISTRO TRAILL_REGISTRO { get; set; } = new CB6241B_TRAILL_REGISTRO();
        public class CB6241B_TRAILL_REGISTRO : VarBasis
        {
        ...
        public CB6241B_AREA_DE_WORK AREA_DE_WORK { get; set; } = new CB6241B_AREA_DE_WORK();
        public class CB6241B_AREA_DE_WORK : VarBasis
        {
            ...
            private _REDEF_CB6241B_FILLER_6 _filler_6 { get; set; }
            public _REDEF_CB6241B_FILLER_6 FILLER_6
            {
                get { _filler_6 = new _REDEF_CB6241B_FILLER_6(); _.Move(WDATA_REL, _filler_6); VarBasis.RedefinePassValue(WDATA_REL, _filler_6, WDATA_REL); _filler_6.ValueChanged += () => { _.Move(_filler_6, WDATA_REL); }; return _filler_6; }
                set { VarBasis.RedefinePassValue(value, _filler_6, WDATA_REL); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_6 : VarBasis
            {
                ...
                public _REDEF_CB6241B_FILLER_6()
                {
            ...
            private _REDEF_CB6241B_FILLER_9 _filler_9 { get; set; }
            public _REDEF_CB6241B_FILLER_9 FILLER_9
            {
                get { _filler_9 = new _REDEF_CB6241B_FILLER_9(); _.Move(WS_NRAVISO, _filler_9); VarBasis.RedefinePassValue(WS_NRAVISO, _filler_9, WS_NRAVISO); _filler_9.ValueChanged += () => { _.Move(_filler_9, WS_NRAVISO); }; return _filler_9; }
                set { VarBasis.RedefinePassValue(value, _filler_9, WS_NRAVISO); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_9 : VarBasis
            {
                ...
                public _REDEF_CB6241B_FILLER_9()
                {
            ...
            private _REDEF_CB6241B_FILLER_10 _filler_10 { get; set; }
            public _REDEF_CB6241B_FILLER_10 FILLER_10
            {
                get { _filler_10 = new _REDEF_CB6241B_FILLER_10(); _.Move(WS_NRTIT, _filler_10); VarBasis.RedefinePassValue(WS_NRTIT, _filler_10, WS_NRTIT); _filler_10.ValueChanged += () => { _.Move(_filler_10, WS_NRTIT); }; return _filler_10; }
                set { VarBasis.RedefinePassValue(value, _filler_10, WS_NRTIT); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_10 : VarBasis
            {
                ...
                public _REDEF_CB6241B_FILLER_10()
                {
            ...
            private _REDEF_CB6241B_FILLER_11 _filler_11 { get; set; }
            public _REDEF_CB6241B_FILLER_11 FILLER_11
            {
                get { _filler_11 = new _REDEF_CB6241B_FILLER_11(); _.Move(WWORK_MIN_NRTIT, _filler_11); VarBasis.RedefinePassValue(WWORK_MIN_NRTIT, _filler_11, WWORK_MIN_NRTIT); _filler_11.ValueChanged += () => { _.Move(_filler_11, WWORK_MIN_NRTIT); }; return _filler_11; }
                set { VarBasis.RedefinePassValue(value, _filler_11, WWORK_MIN_NRTIT); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_11 : VarBasis
            {
                ...
                public _REDEF_CB6241B_FILLER_11()
                {
            ...
            private _REDEF_CB6241B_FILLER_12 _filler_12 { get; set; }
            public _REDEF_CB6241B_FILLER_12 FILLER_12
            {
                get { _filler_12 = new _REDEF_CB6241B_FILLER_12(); _.Move(WWORK_MAX_NRTIT, _filler_12); VarBasis.RedefinePassValue(WWORK_MAX_NRTIT, _filler_12, WWORK_MAX_NRTIT); _filler_12.ValueChanged += () => { _.Move(_filler_12, WWORK_MAX_NRTIT); }; return _filler_12; }
                set { VarBasis.RedefinePassValue(value, _filler_12, WWORK_MAX_NRTIT); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_12 : VarBasis
            {
                ...
                public _REDEF_CB6241B_FILLER_12()
                {
        ...
        public CB6241B_JV1 JV1 { get; set; } = new CB6241B_JV1();
        public class CB6241B_JV1 : VarBasis
        {
            /*"  03         WS-JV1-CEDENTE    PIC  9(006)   VALUE   ZEROS.*/
            public IntBasis WS_JV1_CEDENTE { get; set; } = new IntBasis(new PIC("9", "6", "9(006)"));
            /*"  03         FILLER            REDEFINES WS-JV1-CEDENTE.*/
            private _REDEF_CB6241B_FILLER_13 _filler_13 { get; set; }
            public _REDEF_CB6241B_FILLER_13 FILLER_13
            {
                get { _filler_13 = new _REDEF_CB6241B_FILLER_13(); _.Move(WS_JV1_CEDENTE, _filler_13); VarBasis.RedefinePassValue(WS_JV1_CEDENTE, _filler_13, WS_JV1_CEDENTE); _filler_13.ValueChanged += () => { _.Move(_filler_13, WS_JV1_CEDENTE); }; return _filler_13; }
                set { VarBasis.RedefinePassValue(value, _filler_13, WS_JV1_CEDENTE); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_13 : VarBasis
            {
                /*"   10        WS-JV1-CODIGO     PIC  9(003).*/
                public IntBasis WS_JV1_CODIGO { get; set; } = new IntBasis(new PIC("9", "3", "9(003)."));
                /*"   10        WS-JV1-ID-CLOVIS  PIC  9(003).*/
                public IntBasis WS_JV1_ID_CLOVIS { get; set; } = new IntBasis(new PIC("9", "3", "9(003)."));
                /*"  03        WABEND.*/

                public _REDEF_CB6241B_FILLER_13()
                {
                    WS_JV1_CODIGO.ValueChanged += OnValueChanged;
                    WS_JV1_ID_CLOVIS.ValueChanged += OnValueChanged;
                }

            }
            public CB6241B_WABEND WABEND { get; set; } = new CB6241B_WABEND();
            public class CB6241B_WABEND : VarBasis
            {
                /*"    10      FILLER              PIC  X(010) VALUE           ' CB6241B'.*/
                public StringBasis FILLER_14 { get; set; } = new StringBasis(new PIC("X", "10", "X(010)"), @" CB6241B");
                /*"    05      FILLER              PIC  X(028) VALUE           ' *** ERRO  EXEC SQL  NUMERO '.*/
                public StringBasis FILLER_15 { get; set; } = new StringBasis(new PIC("X", "28", "X(028)"), @" *** ERRO  EXEC SQL  NUMERO ");
            ...
            public CB6241B_WSQLERR WSQLERR { get; set; } = new CB6241B_WSQLERR();
            public class CB6241B_WSQLERR : VarBasis
            {
        ...
        public CB6241B_LPARM11X LPARM11X { get; set; } = new CB6241B_LPARM11X();
        public class CB6241B_LPARM11X : VarBasis
        {
            /*"  03           LPARM11            PIC  9(010).*/
            public IntBasis LPARM11 { get; set; } = new IntBasis(new PIC("9", "10", "9(010)."));
            /*"  03           FILLER             REDEFINES   LPARM11.*/
            private _REDEF_CB6241B_FILLER_20 _filler_20 { get; set; }
            public _REDEF_CB6241B_FILLER_20 FILLER_20
            {
                get { _filler_20 = new _REDEF_CB6241B_FILLER_20(); _.Move(LPARM11, _filler_20); VarBasis.RedefinePassValue(LPARM11, _filler_20, LPARM11); _filler_20.ValueChanged += () => { _.Move(_filler_20, LPARM11); }; return _filler_20; }
                set { VarBasis.RedefinePassValue(value, _filler_20, LPARM11); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_20 : VarBasis
            {
                ...
                public _REDEF_CB6241B_FILLER_20()
                {
        ...
        public CB6241B_LPARM13X LPARM13X { get; set; } = new CB6241B_LPARM13X();
        public class CB6241B_LPARM13X : VarBasis
        {
            /*"  03           LPARM13            PIC  9(013).*/
            public IntBasis LPARM13 { get; set; } = new IntBasis(new PIC("9", "13", "9(013)."));
            /*"  03           FILLER             REDEFINES   LPARM13.*/
            private _REDEF_CB6241B_FILLER_21 _filler_21 { get; set; }
            public _REDEF_CB6241B_FILLER_21 FILLER_21
            {
                get { _filler_21 = new _REDEF_CB6241B_FILLER_21(); _.Move(LPARM13, _filler_21); VarBasis.RedefinePassValue(LPARM13, _filler_21, LPARM13); _filler_21.ValueChanged += () => { _.Move(_filler_21, LPARM13); }; return _filler_21; }
                set { VarBasis.RedefinePassValue(value, _filler_21, LPARM13); }
            }  //Redefines
            public class _REDEF_CB6241B_FILLER_21 : VarBasis
            {
                ...
                public _REDEF_CB6241B_FILLER_21()
                {
        ...
        private void R0000_00_PRINCIPAL_SECTION()
        {
            ...
            /*" -332- EXEC SQL WHENEVER SQLWARNING CONTINUE END-EXEC. */

            /*" -335- EXEC SQL WHENEVER SQLERROR CONTINUE END-EXEC. */

            /*" -338- DISPLAY '--------------------------------' */
            _.Display($"--------------------------------");

            /*" -339- DISPLAY 'PROGRAMA EM EXECUCAO CB6241B    ' */
            _.Display($"PROGRAMA EM EXECUCAO CB6241B    ");

            /*" -340- DISPLAY '                                ' */
            _.Display($"                                ");

            /*" -344- DISPLAY 'VERSAO V.07 256.877  08/09/2020 ' */
            _.Display($"VERSAO V.07 256.877  08/09/2020 ");
            ...
            /*" -351- PERFORM R0050-00-INICIO. */

            R0050_00_INICIO_SECTION();

            /*" -351- PERFORM R0300-00-SELECIONA. */
        ...
        private void R0050_00_INICIO_SECTION()
        {
            ...
            _.Move("0050", JV1.WABEND.WNR_EXEC_SQL);
        ...
        private void R0100_00_SELECT_V0SISTEMA_SECTION()
        {
            ...
            _.Move("0100", JV1.WABEND.WNR_EXEC_SQL);
        ...
        {
            /*" -427- MOVE '0300' TO WNR-EXEC-SQL. */
            _.Move("0300", JV1.WABEND.WNR_EXEC_SQL);

            /*" -428- DISPLAY ' CONVENIO 911241/912085 (C.E.F. -SICAP)- RETORNO' */
            _.Display($" CONVENIO 911241/912085 (C.E.F. -SICAP)- RETORNO");

            /*" -431- DISPLAY ' ' . */
            _.Display($" ");

            /*" -433- MOVE SPACES TO WFIM-MOVIMENTO. */
            _.Move("", AREA_DE_WORK.WFIM_MOVIMENTO);

            /*" -435- PERFORM R0310-00-LER-ENTRADA. */

            R0310_00_LER_ENTRADA_SECTION();

            /*" -436- PERFORM R0320-00-PROCESSA-ENTRADA UNTIL WFIM-MOVIMENTO NOT EQUAL SPACES. */
        ...
        {
            /*" -449- MOVE '0310' TO WNR-EXEC-SQL. */
            _.Move("0310", JV1.WABEND.WNR_EXEC_SQL);

            /*" -449- READ MOVIMENTO AT END */
            try
            {
                MOVIMENTO.Read(() =>
                {

                    /*" -451- MOVE 'S' TO WFIM-MOVIMENTO */
                    _.Move("S", AREA_DE_WORK.WFIM_MOVIMENTO);

                    /*" -454- GO TO R0310-99-SAIDA. */
        ...
        {
            /*" -467- MOVE '0320' TO WNR-EXEC-SQL. */
            _.Move("0320", JV1.WABEND.WNR_EXEC_SQL);

            /*" -468- IF MOVCC-CODREGISTRO EQUAL 'A' */

            if (MOVCC_REGISTRO.MOVCC_CODREGISTRO == "A")
            {

                /*" -469- ADD 1 TO LD-HEADER */
                AREA_DE_WORK.LD_HEADER.Value = AREA_DE_WORK.LD_HEADER + 1;

                /*" -470- MOVE MOVCC-REGISTRO TO HEADER-REGISTRO */
                _.Move(MOVIMENTO?.Value, HEADER_REGISTRO);

                /*" -471- PERFORM R0330-00-TRATA-HEADER */
            ...
            /*" -475- IF MOVCC-CODREGISTRO EQUAL 'Z' */

            if (MOVCC_REGISTRO.MOVCC_CODREGISTRO == "Z")
            {

                /*" -476- ADD 1 TO LD-TRAILLER */
                AREA_DE_WORK.LD_TRAILLER.Value = AREA_DE_WORK.LD_TRAILLER + 1;

                /*" -477- MOVE MOVCC-REGISTRO TO TRAILL-REGISTRO */
                _.Move(MOVIMENTO?.Value, TRAILL_REGISTRO);

                /*" -478- PERFORM R0350-00-TRATA-TRAILLER */
            ...
            /*" -488- PERFORM R0400-00-PROCESSA-DETALHE. */
        ...
        {
            /*" -493- PERFORM R0310-00-LER-ENTRADA. */
        ...
        {
            /*" -505- MOVE '0330' TO WNR-EXEC-SQL. */
            _.Move("0330", JV1.WABEND.WNR_EXEC_SQL);

            /*" -508- IF HEADER-CODCONVENIO NOT EQUAL 911241 AND CVPCV-911241 AND JV1CV-911241 */

            if (!HEADER_REGISTRO.HEADER_CODCONVENIO.In("911241", JVBKINCL.JV_CONVENIOS.CVPCV_911241.ToString(), JVBKINCL.JV_CONVENIOS.JV1CV_911241.ToString()))
            {

                /*" -510- DISPLAY 'R0330-00 - CONVENIO NAO PREVISTO         ' HEADER-REGISTRO */
            ...
            /*" -515- IF HEADER-CODREMESSA NOT EQUAL 2 */

            if (HEADER_REGISTRO.HEADER_CODREMESSA != 2)
            {

                /*" -517- DISPLAY 'R0330-00 - CODIGO REMESSA INVALIDO       ' HEADER-REGISTRO */
            ...
            /*" -521- IF HEADER-CODBANCO NOT EQUAL 104 */

            if (HEADER_REGISTRO.HEADER_CODBANCO != 104)
            {

                /*" -523- DISPLAY 'R0330-00 - CODIGO BANCO   INVALIDO       ' HEADER-REGISTRO */
            ...
            /*" -530- MOVE ZEROS TO WS-NRAVISO. */
            _.Move(0, AREA_DE_WORK.WS_NRAVISO);

            /*" -531- MOVE HEADER-NSA TO WS-AUXNSAS. */
            _.Move(HEADER_REGISTRO.HEADER_NSA, AREA_DE_WORK.FILLER_9.WS_AUXNSAS);

            /*" -536- MOVE HEADER-CODCONVENIO TO WS-JV1-CEDENTE. */
            _.Move(HEADER_REGISTRO.HEADER_CODCONVENIO, JV1.WS_JV1_CEDENTE);

            /*" -546- COMPUTE WS-AUXAVISO = 9000 + WS-JV1-ID-CLOVIS. */
            AREA_DE_WORK.FILLER_9.WS_AUXAVISO.Value = 9000 + JV1.FILLER_13.WS_JV1_ID_CLOVIS;

            /*" -547- DISPLAY ' SEQUENCIA ARQUIVO ..... ' HEADER-NSA. */
            _.Display($" SEQUENCIA ARQUIVO ..... {HEADER_REGISTRO.HEADER_NSA}");

            /*" -550- DISPLAY ' CONVENIO ............. ' HEADER-CODCONVENIO. */
            _.Display($" CONVENIO ............. {HEADER_REGISTRO.HEADER_CODCONVENIO}");

            /*" -552- PERFORM R0340-00-SELECT-MOVIMCOB. */

            R0340_00_SELECT_MOVIMCOB_SECTION();

            /*" -553- IF WSHOST-COUNT NOT EQUAL ZEROS */

            if (WSHOST_COUNT != 00)
            {

                /*" -554- DISPLAY '*   SEQUENCIA DE ARQUIVO JA PROCESSADO   *' */
                _.Display($"*   SEQUENCIA DE ARQUIVO JA PROCESSADO   *");

                /*" -555- DISPLAY '*   SEQUENCIA DE ARQUIVO JA PROCESSADO   *' */
                _.Display($"*   SEQUENCIA DE ARQUIVO JA PROCESSADO   *");

                /*" -556- DISPLAY '* ATENCAO - ATENCAO  - ATENCAO - ATENCAO *' */
                _.Display($"* ATENCAO - ATENCAO  - ATENCAO - ATENCAO *");

                /*" -557- DISPLAY '*    VERIFICAR SE PROGRAMA CB6242B DA    *' */
                _.Display($"*    VERIFICAR SE PROGRAMA CB6242B DA    *");

                /*" -559- DISPLAY '*       DIARIA ANTERIOR TERMINOU OK      *' */
                _.Display($"*       DIARIA ANTERIOR TERMINOU OK      *");
        ...
        {
            /*" -572- MOVE '0340' TO WNR-EXEC-SQL. */
            _.Move("0340", JV1.WABEND.WNR_EXEC_SQL);

            /*" -574- MOVE 104 TO MOVIMCOB-COD-BANCO. */
            _.Move(104, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_COD_BANCO);

            /*" -576- MOVE 8010 TO MOVIMCOB-COD-AGENCIA. */
            _.Move(8010, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_COD_AGENCIA);

            /*" -579- MOVE WS-NRAVISO TO MOVIMCOB-NUM-AVISO. */
            _.Move(AREA_DE_WORK.WS_NRAVISO, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NUM_AVISO);

            /*" -590- PERFORM R0340_00_SELECT_MOVIMCOB_DB_SELECT_1 */
            ...
            if (DB.SQLCODE == 100)
            {
                ...
                /*" -596- MOVE ZEROS TO WSHOST-COUNT */
            ...
            else
            {
                ...
                else
                {
                    ...
                    /*" -602- IF VIND-NULL02 LESS ZEROS */

                    if (VIND_NULL02 < 00)
                    {

                        /*" -605- MOVE ZEROS TO WSHOST-COUNT. */
                        _.Move(0, WSHOST_COUNT);
                    }
        ...
        {
            /*" -590- EXEC SQL SELECT COUNT(*) INTO :WSHOST-COUNT:VIND-NULL02 FROM SEGUROS.MOVIMENTO_COBRANCA WHERE COD_BANCO = :MOVIMCOB-COD-BANCO AND COD_AGENCIA = :MOVIMCOB-COD-AGENCIA AND NUM_AVISO = :MOVIMCOB-NUM-AVISO WITH UR END-EXEC. */
        ...
        {
            /*" -616- MOVE '0350' TO WNR-EXEC-SQL. */
            _.Move("0350", JV1.WABEND.WNR_EXEC_SQL);

            /*" -617- DISPLAY ' ' . */
            _.Display($" ");

            /*" -618- DISPLAY ' LIDOS    ENTRADA ...... ' LD-ENTRADA. */
            _.Display($" LIDOS    ENTRADA ...... {AREA_DE_WORK.LD_ENTRADA}");

            /*" -619- DISPLAY ' LIDOS    HEADER ....... ' LD-HEADER. */
            _.Display($" LIDOS    HEADER ....... {AREA_DE_WORK.LD_HEADER}");

            /*" -620- DISPLAY ' LIDOS    TRAILLER ..... ' LD-TRAILLER. */
            _.Display($" LIDOS    TRAILLER ..... {AREA_DE_WORK.LD_TRAILLER}");

            /*" -621- DISPLAY ' DESPREZA ENTRADA ...... ' DP-ENTRADA. */
            _.Display($" DESPREZA ENTRADA ...... {AREA_DE_WORK.DP_ENTRADA}");

            /*" -622- DISPLAY ' ' . */
            _.Display($" ");

            /*" -623- DISPLAY ' LIDOS DETALHE ......... ' LD-DETALHE. */
            _.Display($" LIDOS DETALHE ......... {AREA_DE_WORK.LD_DETALHE}");

            /*" -624- DISPLAY ' BILHETE NAO CADASTRADO. ' NT-BILHETE. */
            _.Display($" BILHETE NAO CADASTRADO. {AREA_DE_WORK.NT_BILHETE}");

            /*" -625- DISPLAY ' CADASTRA CONVERSAO .... ' AC-CONVERSI. */
            _.Display($" CADASTRA CONVERSAO .... {AREA_DE_WORK.AC_CONVERSI}");

            /*" -626- DISPLAY ' ' . */
            _.Display($" ");

            /*" -627- DISPLAY ' CADASTRADOS MOVIMENTO . ' AC-MOVIMCOB. */
            _.Display($" CADASTRADOS MOVIMENTO . {AREA_DE_WORK.AC_MOVIMCOB}");

            /*" -630- DISPLAY ' ' . */
            _.Display($" ");

            /*" -638- MOVE ZEROS TO LD-ENTRADA LD-HEADER LD-TRAILLER LD-DETALHE DP-ENTRADA NT-BILHETE AC-CONVERSI AC-MOVIMCOB. */
        ...
        {
            /*" -652- MOVE '0400' TO WNR-EXEC-SQL. */
            _.Move("0400", JV1.WABEND.WNR_EXEC_SQL);

            /*" -655- ADD 1 TO LD-DETALHE. */
            AREA_DE_WORK.LD_DETALHE.Value = AREA_DE_WORK.LD_DETALHE + 1;

            /*" -661- PERFORM R0410-00-MONTA-MOVIMCOB. */

            R0410_00_MONTA_MOVIMCOB_SECTION();

            /*" -667- PERFORM R0420-00-SELECT-CONVERSI. */

            R0420_00_SELECT_CONVERSI_SECTION();

            /*" -673- PERFORM R0450-00-SELECT-MOVIMCOB. */

            R0450_00_SELECT_MOVIMCOB_SECTION();

            /*" -674- IF MOVIMCOB-SIT-REGISTRO NOT EQUAL SPACES */

            if (!MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_SIT_REGISTRO.IsEmpty())
            {

                /*" -676- DISPLAY ' REGISTRO JA CADASTRADO MOVIMCOB         ' MOVCC-REGISTRO */
                _.Display($" REGISTRO JA CADASTRADO MOVIMCOB         {MOVCC_REGISTRO}");

                /*" -681- MOVE SPACES TO MOVIMCOB-SIT-REGISTRO. */
                _.Move("", MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_SIT_REGISTRO);
            }


            /*" -681- PERFORM R4000-00-INSERT-MOVIMCOB. */
        ...
        {
            /*" -694- MOVE '0410' TO WNR-EXEC-SQL. */
            _.Move("0410", JV1.WABEND.WNR_EXEC_SQL);

            /*" -696- MOVE ZEROS TO MOVIMCOB-COD-EMPRESA. */
            _.Move(0, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_COD_EMPRESA);

            /*" -698- MOVE MOVCC-NRSEQREG TO MOVIMCOB-COD-MOVIMENTO. */
            _.Move(MOVCC_REGISTRO.MOVCC_NRSEQREG, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_COD_MOVIMENTO);

            /*" -700- MOVE 104 TO MOVIMCOB-COD-BANCO. */
            _.Move(104, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_COD_BANCO);

            /*" -702- MOVE 8010 TO MOVIMCOB-COD-AGENCIA. */
            _.Move(8010, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_COD_AGENCIA);

            /*" -704- MOVE WS-NRAVISO TO MOVIMCOB-NUM-AVISO. */
            _.Move(AREA_DE_WORK.WS_NRAVISO, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NUM_AVISO);

            /*" -706- MOVE WS-AUXNSAS TO MOVIMCOB-NUM-FITA. */
            _.Move(AREA_DE_WORK.FILLER_9.WS_AUXNSAS, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NUM_FITA);

            /*" -708- MOVE ZEROS TO MOVIMCOB-VAL-IOCC. */
            _.Move(0, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_VAL_IOCC);

            /*" -710- MOVE SPACES TO MOVIMCOB-SIT-REGISTRO. */
            _.Move("", MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_SIT_REGISTRO);

            /*" -713- MOVE 'L' TO MOVIMCOB-TIPO-MOVIMENTO. */
            _.Move("L", MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_TIPO_MOVIMENTO);

            /*" -715- MOVE MOVCC-VLRPAGO TO MOVIMCOB-VAL-TITULO. */
            _.Move(MOVCC_REGISTRO.MOVCC_VLRPAGO, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_VAL_TITULO);

            /*" -718- MOVE MOVCC-VLRTARIFA TO MOVIMCOB-VAL-CREDITO. */
            _.Move(MOVCC_REGISTRO.MOVCC_VLRTARIFA, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_VAL_CREDITO);

            /*" -722- COMPUTE MOVIMCOB-VAL-CREDITO EQUAL (MOVIMCOB-VAL-TITULO - MOVIMCOB-VAL-CREDITO). */
            ...
            /*" -746- MOVE SPACES TO MOVIMCOB-NOME-SEGURADO. */
            _.Move("", MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NOME_SEGURADO);

            /*" -747- MOVE MOVCC-BARRA01 TO MOVIMCOB-NOME-SEGURADO. */
        ...
        {
            /*" -767- MOVE '0420' TO WNR-EXEC-SQL. */
            _.Move("0420", JV1.WABEND.WNR_EXEC_SQL);

            /*" -771- MOVE MOVCC-NUMSIVPF TO CONVERSI-NUM-PROPOSTA-SIVPF */
            _.Move(MOVCC_REGISTRO.MOVCC_CODBARRA.MOVCC_NUMSIVPF, CONVERSI.DCLCONVERSAO_SICOB.CONVERSI_NUM_PROPOSTA_SIVPF);

            /*" -789- PERFORM R0420_00_SELECT_CONVERSI_DB_SELECT_1 */
        ...
        {
            /*" -789- EXEC SQL SELECT A.NUM_PROPOSTA_SIVPF , B.NUM_BILHETE , B.NUM_APOLICE INTO :CONVERSI-NUM-PROPOSTA-SIVPF , :BILHETE-NUM-BILHETE , :BILHETE-NUM-APOLICE FROM SEGUROS.CONVERSAO_SICOB A , SEGUROS.BILHETE B WHERE A.NUM_PROPOSTA_SIVPF = :CONVERSI-NUM-PROPOSTA-SIVPF AND A.NUM_SICOB = B.NUM_BILHETE WITH UR END-EXEC. */
        ...
        {
            /*" -815- MOVE '0430' TO WNR-EXEC-SQL. */
            _.Move("0430", JV1.WABEND.WNR_EXEC_SQL);

            /*" -888- PERFORM R0430_00_SELECT_BILHETE_DB_SELECT_1 */
        ...
        {
            /*" -940- MOVE '0440' TO WNR-EXEC-SQL. */
            _.Move("0440", JV1.WABEND.WNR_EXEC_SQL);

            /*" -944- MOVE MOVCC-NUMSIVPF TO MOVIMCOB-NUM-NOSSO-TITULO. */
            _.Move(MOVCC_REGISTRO.MOVCC_CODBARRA.MOVCC_NUMSIVPF, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NUM_NOSSO_TITULO);

            /*" -944- ADD 1 TO NT-BILHETE. */
        ...
        {
            /*" -957- MOVE '0450' TO WNR-EXEC-SQL. */
            _.Move("0450", JV1.WABEND.WNR_EXEC_SQL);

            /*" -978- PERFORM R0450_00_SELECT_MOVIMCOB_DB_SELECT_1 */

            R0450_00_SELECT_MOVIMCOB_DB_SELECT_1();

            /*" -982- IF SQLCODE EQUAL ZEROS */

            if (DB.SQLCODE == 00)
            {

                /*" -984- MOVE '*' TO MOVIMCOB-SIT-REGISTRO */
                _.Move("*", MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_SIT_REGISTRO);
            ...
            else
            {
                ...
                /*" -986- MOVE SPACES TO MOVIMCOB-SIT-REGISTRO. */
                _.Move("", MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_SIT_REGISTRO);
            }
        ...
        {
            /*" -999- MOVE '0500' TO WNR-EXEC-SQL. */
            _.Move("0500", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1002- PERFORM R0510-00-SELECT-V0CEDENTE. */

            R0510_00_SELECT_V0CEDENTE_SECTION();

            /*" -1005- PERFORM R0530-00-CALCULA-TITULO. */

            R0530_00_CALCULA_TITULO_SECTION();

            /*" -1008- PERFORM R0550-00-UPDATE-V0CEDENTE. */

            R0550_00_UPDATE_V0CEDENTE_SECTION();

            /*" -1011- PERFORM R1000-00-DELETE-BILHETE. */

            R1000_00_DELETE_BILHETE_SECTION();

            /*" -1014- PERFORM R1100-00-INSERT-CONVERSI. */

            R1100_00_INSERT_CONVERSI_SECTION();

            /*" -1017- PERFORM R1200-00-INSERT-BILHETE. */

            R1200_00_INSERT_BILHETE_SECTION();

            /*" -1019- MOVE BILHETE-NUM-BILHETE TO MOVIMCOB-NUM-TITULO */
            _.Move(BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NUM_TITULO);

            /*" -1021- MOVE BILHETE-NUM-APOLICE TO MOVIMCOB-NUM-APOLICE */
            _.Move(BILHETE.DCLBILHETE.BILHETE_NUM_APOLICE, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NUM_APOLICE);

            /*" -1025- MOVE CONVERSI-NUM-PROPOSTA-SIVPF TO MOVIMCOB-NUM-NOSSO-TITULO. */
            _.Move(CONVERSI.DCLCONVERSAO_SICOB.CONVERSI_NUM_PROPOSTA_SIVPF, MOVIMCOB.DCLMOVIMENTO_COBRANCA.MOVIMCOB_NUM_NOSSO_TITULO);

            /*" -1025- ADD 1 TO AC-CONVERSI. */
        ...
        {
            /*" -1038- MOVE '0510' TO WNR-EXEC-SQL. */
            _.Move("0510", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1045- PERFORM R0510_00_SELECT_V0CEDENTE_DB_SELECT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1050- DISPLAY 'R0510-00 - PROBLEMAS NO SELECT(V0CEDENTE)' */
            ...
            /*" -1055- MOVE CEDENTE-NUM-TITULO TO WWORK-MIN-NRTIT. */
            _.Move(CEDENTE.DCLCEDENTE.CEDENTE_NUM_TITULO, AREA_DE_WORK.WWORK_MIN_NRTIT);

            /*" -1056- MOVE CEDENTE-NUM-TITULO-MAX TO WWORK-MAX-NRTIT. */
        ...
        {
            /*" -1045- EXEC SQL SELECT NUM_TITULO , NUM_TITULO_MAX INTO :CEDENTE-NUM-TITULO , :CEDENTE-NUM-TITULO-MAX FROM SEGUROS.CEDENTE WHERE COD_CEDENTE = 26 END-EXEC. */
        ...
        {
            /*" -1069- MOVE '0530' TO WNR-EXEC-SQL. */
            _.Move("0530", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1070- ADD 1 TO WWORK-MINNRO */
            AREA_DE_WORK.FILLER_11.WWORK_MINNRO.Value = AREA_DE_WORK.FILLER_11.WWORK_MINNRO + 1;

            /*" -1073- MOVE WWORK-MINNRO TO LPARM11. */
            _.Move(AREA_DE_WORK.FILLER_11.WWORK_MINNRO, LPARM11X.LPARM11);

            /*" -1084- COMPUTE WPARM11-AUX = LPARM11-1 * 3 + LPARM11-2 * 2 + LPARM11-3 * 9 + LPARM11-4 * 8 + LPARM11-5 * 7 + LPARM11-6 * 6 + LPARM11-7 * 5 + LPARM11-8 * 4 + LPARM11-9 * 3 + LPARM11-10 * 2. */
            AREA_DE_WORK.WPARM11_AUX.Value = LPARM11X.FILLER_20.LPARM11_1 * 3 + LPARM11X.FILLER_20.LPARM11_2 * 2 + LPARM11X.FILLER_20.LPARM11_3 * 9 + LPARM11X.FILLER_20.LPARM11_4 * 8 + LPARM11X.FILLER_20.LPARM11_5 * 7 + LPARM11X.FILLER_20.LPARM11_6 * 6 + LPARM11X.FILLER_20.LPARM11_7 * 5 + LPARM11X.FILLER_20.LPARM11_8 * 4 + LPARM11X.FILLER_20.LPARM11_9 * 3 + LPARM11X.FILLER_20.LPARM11_10 * 2;

            /*" -1087- DIVIDE WPARM11-AUX BY 11 GIVING WS-RESULT REMAINDER WS-RESTO. */
            _.Divide(AREA_DE_WORK.WPARM11_AUX, 11, AREA_DE_WORK.WS_RESULT, AREA_DE_WORK.WS_RESTO);

            /*" -1088- IF WS-RESTO EQUAL ZEROS */

            if (AREA_DE_WORK.WS_RESTO == 00)
            {

                /*" -1089- MOVE 0 TO WWORK-MINDIG */
            ...
            else
            {
                ...
                /*" -1094- SUBTRACT WS-RESTO FROM 11 GIVING WWORK-MINDIG. */
                AREA_DE_WORK.FILLER_11.WWORK_MINDIG.Value = 11 - AREA_DE_WORK.WS_RESTO;
            }


            /*" -1095- IF WWORK-MIN-NRTIT GREATER WWORK-MAX-NRTIT */

            if (AREA_DE_WORK.WWORK_MIN_NRTIT > AREA_DE_WORK.WWORK_MAX_NRTIT)
            {

                /*" -1096- DISPLAY 'R0530-00 - ABEND CONTROLADO                ' */
                _.Display($"R0530-00 - ABEND CONTROLADO                ");

                /*" -1097- DISPLAY '*  ESTOURO FAIXA NUMERACAO CEDENTE = 26    ' */
                _.Display($"*  ESTOURO FAIXA NUMERACAO CEDENTE = 26    ");

                /*" -1098- DISPLAY '    ' WWORK-MIN-NRTIT */
        ...
        {
            /*" -1111- MOVE '0550' TO WNR-EXEC-SQL. */
            _.Move("0550", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1114- MOVE WWORK-MIN-NRTIT TO CEDENTE-NUM-TITULO. */
            _.Move(AREA_DE_WORK.WWORK_MIN_NRTIT, CEDENTE.DCLCEDENTE.CEDENTE_NUM_TITULO);

            /*" -1118- PERFORM R0550_00_UPDATE_V0CEDENTE_DB_UPDATE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1122- DISPLAY 'R0550-00 - PROBLEMAS UPDATE (V0CEDENTE)   ' */
        ...
        {
            /*" -1118- EXEC SQL UPDATE SEGUROS.CEDENTE SET NUM_TITULO = :CEDENTE-NUM-TITULO WHERE COD_CEDENTE = 26 END-EXEC. */
        ...
        {
            /*" -1135- MOVE '1000' TO WNR-EXEC-SQL. */
            _.Move("1000", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1139- PERFORM R1000_00_DELETE_BILHETE_DB_DELETE_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1144- DISPLAY 'R1000-00 - PROBLEMAS DELETE (BILHETE)     ' */
        ...
        {
            /*" -1139- EXEC SQL DELETE FROM SEGUROS.BILHETE WHERE NUM_BILHETE = :BILHETE-NUM-BILHETE END-EXEC. */
        ...
        private void R1100_00_INSERT_CONVERSI_SECTION()
        {
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                if (DB.SQLCODE == -803)
                {
                    ...
                    /*" -1207- PERFORM R1150-00-TRATA-DUPLICI-SICOB */
                ...
                else
                {
                    ...
                    /*" -1211- DISPLAY 'R1100-00 - PROBLEMAS NO INSERT(CONVERSI) ' '   ' CONVERSI-NUM-PROPOSTA-SIVPF '   ' CONVERSI-NUM-SICOB */
        ...
        {
            /*" -1223- MOVE '1150' TO WNR-EXEC-SQL. */
            _.Move("1150", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1224- PERFORM R0530-00-CALCULA-TITULO */

            R0530_00_CALCULA_TITULO_SECTION();

            /*" -1225- PERFORM R0550-00-UPDATE-V0CEDENTE */

            R0550_00_UPDATE_V0CEDENTE_SECTION();

            /*" -1226- PERFORM R1100-00-INSERT-CONVERSI. */
        ...
        {
            /*" -1237- MOVE '1200' TO WNR-EXEC-SQL. */
            _.Move("1200", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1240- MOVE WWORK-MIN-NRTIT TO BILHETE-NUM-BILHETE. */
            _.Move(AREA_DE_WORK.WWORK_MIN_NRTIT, BILHETE.DCLBILHETE.BILHETE_NUM_BILHETE);

            /*" -1309- PERFORM R1200_00_INSERT_BILHETE_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1315- DISPLAY 'R1200-00 - PROBLEMAS NO INSERT(BILHETE)   ' '   ' BILHETE-NUM-BILHETE */
        ...
        {
            /*" -1327- MOVE '4000' TO WNR-EXEC-SQL. */
            _.Move("4000", JV1.WABEND.WNR_EXEC_SQL);

            /*" -1370- PERFORM R4000_00_INSERT_MOVIMCOB_DB_INSERT_1 */
            ...
            if (DB.SQLCODE != 00)
            {
                ...
                /*" -1379- DISPLAY 'R4000-00 - PROBLEMAS NO INSERT(CBCONDEV)   ' '   ' MOVCC-REGISTRO '   ' MOVIMCOB-NUM-AVISO '   ' MOVIMCOB-NUM-TITULO '   ' MOVIMCOB-NUM-NOSSO-TITULO */
        ...
        {
            /*" -1393- MOVE SQLCODE TO WSQLCODE */
            _.Move(DB.SQLCODE, JV1.WABEND.WSQLCODE);

            /*" -1394- MOVE SQLERRD(1) TO WSQLERRD1 */
            _.Move(DB.SQLERRD[1], JV1.WABEND.WSQLERRD1);

            /*" -1395- MOVE SQLERRD(2) TO WSQLERRD2 */
            _.Move(DB.SQLERRD[2], JV1.WABEND.WSQLERRD2);

            /*" -1397- MOVE SQLERRMC TO WSQLERRMC. */
            _.Move(DB.SQLERRMC, JV1.WSQLERR.WSQLERRMC);

            /*" -1398- DISPLAY WABEND. */
            _.Display(JV1.WABEND);

            /*" -1400- DISPLAY WSQLERR. */
            _.Display(JV1.WSQLERR);

            /*" -1400- EXEC SQL ROLLBACK WORK END-EXEC. */

            DatabaseConnection.Instance.RollbackTransaction();

            /*" -1404- CLOSE MOVIMENTO. */
            MOVIMENTO.Close();

            /*" -1406- MOVE 99 TO RETURN-CODE. */
