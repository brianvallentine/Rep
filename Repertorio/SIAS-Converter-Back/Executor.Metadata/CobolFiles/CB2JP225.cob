  ...
  STATUS-CARTAO
    VLR-CREDITO.
      ...
      *--------------*                                                          
       0000-PRINCIPAL.                                                          
      *--------------*                                                       
               EXEC SQL DECLARE CUR1 WITH RETURN WITH HOLD FOR INSERT INTO seguros.v0movdebcc_cef (COD_EMPRESA, NUM_APOLICE, NRENDOS, NRPARCEL, SIT_COBRANCA, DTVENCTO, VLR_DEBITO, DTMOVTO, DIA_DEBITO, COD_AGENCIA_DEB, OPER_CONTA_DEB, NUM_CONTA_DEB, DIG_CONTA_DEB, COD_CONVENIO, DTENVIO, DTRETORNO, COD_RETORNO_CEF, NSAS, COD_USUARIO, NUM_REQUISICAO, NUM_CARTAO, SEQUENCIA, NUM_LOTE, DTCREDITO, STATUS_CARTAO, VLR_CREDITO) VALUES (:COD_EMPRESA, :NUM_APOLICE, :NRENDOS, :NRPARCEL, :SIT_COBRANCA, :DTVENCTO, :VLR_DEBITO, :DTMOVTO, :DIA_DEBITO, :COD_AGENCIA_DEB, :OPER_CONTA_DEB, :NUM_CONTA_DEB, :DIG_CONTA_DEB, :COD_CONVENIO, :DTENVIO, :DTRETORNO, :COD_RETORNO_CEF, :NSAS, :COD_USUARIO, :NUM_REQUISICAO, :NUM_CARTAO, :SEQUENCIA, :NUM_LOTE, :DTCREDITO, :STATUS_CARTAO, :VLR_CREDITO) END-EXEC                                                              
      *    
           OPEN CUR1.	  
           STOP RUN.                                                            
