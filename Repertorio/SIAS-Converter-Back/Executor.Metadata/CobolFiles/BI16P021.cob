  ...
  DATA-QUITACAO
    COD-EMPRESA.
      ...
      *--------------*                                                          
       0000-PRINCIPAL.                                                          
      *--------------*                                                       
               EXEC SQL DECLARE CUR1 WITH RETURN WITH HOLD FOR INSERT INTO seguros.parcela_historico(NUM_APOLICE, NUM_ENDOSSO, NUM_PARCELA, DAC_PARCELA, DATA_MOVIMENTO, COD_OPERACAO, HORA_OPERACAO, OCORR_HISTORICO, PRM_TARIFARIO, VAL_DESCONTO, PRM_LIQUIDO, ADICIONAL_FRACIO, VAL_CUSTO_EMISSAO, VAL_IOCC, PRM_TOTAL, VAL_OPERACAO, DATA_VENCIMENTO, BCO_COBRANCA, AGE_COBRANCA, NUM_AVISO_CREDITO, ENDOS_CANCELA, SIT_CONTABIL, COD_USUARIO, RENUM_DOCUMENTO, DATA_QUITACAO, COD_EMPRESA, TIMESTAMP) VALUES (:NUM_APOLICE, :NUM_ENDOSSO, :NUM_PARCELA, :DAC_PARCELA, :DATA_MOVIMENTO, :COD_OPERACAO, :HORA_OPERACAO, :OCORR_HISTORICO, :PRM_TARIFARIO, :VAL_DESCONTO, :PRM_LIQUIDO, :ADICIONAL_FRACIO, :VAL_CUSTO_EMISSAO, :VAL_IOCC, :PRM_TOTAL, :VAL_OPERACAO, :DATA_VENCIMENTO, :BCO_COBRANCA, :AGE_COBRANCA, :NUM_AVISO_CREDITO, :ENDOS_CANCELA, :SIT_CONTABIL, :COD_USUARIO, :RENUM_DOCUMENTO, :DATA_QUITACAO, :COD_EMPRESA, CURRENT TIMESTAMP) END-EXEC                                                              
      *    
           OPEN CUR1.	  
           STOP RUN.                                                            
