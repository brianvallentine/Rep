   ...
   VAL-DESCONTO
    ...
    COD-EMPRESA.
      ...
      *--------------*                                                          
       0000-PRINCIPAL.                                                          
      *--------------*                                                       
               EXEC SQL DECLARE CUR1 WITH RETURN WITH HOLD FOR INSERT INTO seguros.v1histoparc(NUM_APOLICE, NRENDOS, NRPARCEL, DACPARC, DTMOVTO, OPERACAO, HORAOPER, OCORHIST, PRM_TARIFARIO, VAL_DESCONTO, VLPRMLIQ, VLADIFRA, VLCUSEMI, VLIOCC, VLPRMTOT, VLPREMIO, DTVENCTO, BCOCOBR, AGECOBR, NRAVISO, NRENDOCA, SITCONTB, COD_USUARIO, RNUDOC, DTQITBCO, COD_EMPRESA) VALUES (:NUM_APOLICE, :NRENDOS, :NRPARCEL, :DACPARC, :DTMOVTO, :OPERACAO, :HORAOPER, :OCORHIST, :PRM_TARIFARIO, :VAL_DESCONTO, :VLPRMLIQ, :VLADIFRA, :VLCUSEMI, :VLIOCC, :VLPRMTOT, :VLPREMIO, :DTVENCTO, :BCOCOBR, :AGECOBR, :NRAVISO, :NRENDOCA, :SITCONTB, :COD_USUARIO, :RNUDOC, :DTQITBCO, :COD_EMPRESA, CURRENT TIMESTAMP) END-EXEC                                                              
      *    
           OPEN CUR1.	  
           STOP RUN.                                                            
