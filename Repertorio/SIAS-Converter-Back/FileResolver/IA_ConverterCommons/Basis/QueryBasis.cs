...
public abstract class QueryBasis<T> : DatabaseBasis where T : class
{
    ...
    public void ExecuteQuery()
    {
        ...
        SQLCA_Internal.SQLWARN.SetValue("");
        ...
        finally
        {
            ...
            DatabaseBasis.SQLCAID = SQLCA_Internal.SQLCAID;
            DatabaseBasis.SQLCABC = SQLCA_Internal.SQLCABC;
            DatabaseBasis.SQLWARN = SQLCA_Internal.SQLWARN;
    ...
    public void Open(dynamic? procParams = null)
    {
        ...
        finally
        {
            ...
            DatabaseBasis.SQLCAID = SQLCA_Internal.SQLCAID;
            DatabaseBasis.SQLCABC = SQLCA_Internal.SQLCABC;
            DatabaseBasis.SQLERRP = SQLCA_Internal.SQLERRP;
            DatabaseBasis.SQLWARN = SQLCA_Internal.SQLWARN;
    ...
    public bool Fetch()
    {
        ...
        else if (SQLCA_Internal.SQLCODE != 0)
        {
